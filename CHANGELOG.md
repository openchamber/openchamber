...
- **Desktop Linux packages:** releases now include `.deb` installers for x64 and arm64 Debian-based systems alongside the existing AppImages. AppImage installations retain the in-app update flow; `.deb` installations use the system package manager for updates.
