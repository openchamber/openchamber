...
- Terminal/Chat: clicking into the terminal no longer overwrites the clipboard with a single character, and shell-output copy keeps the rendered terminal text (thanks to @bashrusakh).
