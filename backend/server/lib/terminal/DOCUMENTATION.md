...
- `backend/server/lib/terminal/`: Terminal module directory.
...
- `backend/server/lib/terminal/terminal-ws-protocol.test.js`: Test file for protocol utilities.
- `backend/server/lib/terminal/output-replay-buffer.test.js`: Test file for replay buffer helpers.

Public API entry point: imported by `backend/server/index.js` from `./lib/terminal/index.js`.
...
## Usage in web server
The terminal helpers are used by `backend/server/index.js` for:
...
- Run `bun test backend/server/lib/terminal/terminal-ws-protocol.test.js`
- Run `bun test backend/server/lib/terminal/output-replay-buffer.test.js`
