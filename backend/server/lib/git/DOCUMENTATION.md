...
- `backend/server/lib/git/`: Git module directory containing all Git-related functionality.
  - `index.js`: Public API entry point imported by `backend/server/index.js`.
...
1. Add the function to `backend/server/lib/git/service.js`.
