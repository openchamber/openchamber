...
- `backend/server/lib/skills-catalog/`: Skills catalog module directory containing all skill-related functionality.
...
1. Create a new subdirectory under `backend/server/lib/skills-catalog/` (e.g., `newsource/`).
...
5. Update `backend/server/index.js` to import and wire up the new source.
