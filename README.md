...
Linux Desktop ships as AppImage and `deb` packages, with in-app window controls, system tray, and launch-at-login support. AppImage auto-update requires the AppImage to be stored in a writable location.
