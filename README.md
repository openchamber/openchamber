> **OpenChamber Teams** — a fork of [openchamber/openchamber](https://github.com/openchamber/openchamber)
> that layers GitHub-native workflows for individuals and teams on top of the
> original web, desktop, and VS Code runtimes. See [`docs/TEAMS_OVERVIEW.md`](docs/TEAMS_OVERVIEW.md)
> for the three-mode plan (Individual, GitHub Team, Local Team) and roadmap.
>
> The upstream README content is preserved below unchanged.
