...
ALIAS ADE supports user-defined themes. Drop a JSON file into the themes directory and reload — no app restart required.
...
3. In ALIAS ADE: **Settings → Theme → Reload themes**.
...
```json
{
  "metadata": {
    ...
    "description": "A custom theme for ALIAS ADE",
    "version": "1.0.0",
    "variant": "dark",
    "tags": ["dark", "custom"]
  },
