...
export const OPENCHAMBER_CONTROL_ACTION_DEFINITIONS = Object.freeze([
  ...
  { action: 'git.push', title: 'Push through OpenChamber', description: 'Push the current branch to its upstream using the repository binding, so the transfer runs as the bound account. Use this instead of git push in the shell. Optional remote; scope with directory' },
  { action: 'git.pull', title: 'Pull through OpenChamber', description: 'Pull the tracked branch into the checked out one using the repository binding. Use this instead of git pull in the shell. Optional remote; scope with directory' },
  { action: 'git.fetch', title: 'Fetch through OpenChamber', description: 'Fetch a bound remote using the repository binding. Use this instead of git fetch in the shell. Optional remote; scope with directory' },
