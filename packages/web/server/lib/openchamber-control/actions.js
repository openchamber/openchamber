export const OPENCHAMBER_CONTROL_ACTION_DEFINITIONS = Object.freeze([
  ...
  { action: 'vision.run', title: 'Describe an image', description: 'Describe an image file using the user-configured vision model, so you can work with images even when your model cannot see them. Use for screenshots, photos, diagrams, UI mockups, scanned documents, or any image you need to understand. Requires imagePath — an absolute or directory-relative path to an image file (PNG, JPEG, GIF, or WebP, up to 20 MB); optional question focuses the description. Returns a detailed description covering content, layout, spatial arrangement, style, colors, and every visible text, produced by the configured vision model. If the description mentions truncated or cropped content, ask a focused follow-up question rather than guessing.' },
