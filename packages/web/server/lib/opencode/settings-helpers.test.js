...
describe('settings registry gate', () => {
  ...
  const validValues = {
    ...
    codeBlockLineWrap: true, showTurnChangedFiles: true, showExpandedBashTools: true, showExpandedEditTools: true, showExpandedTodoTools: true, toolJsonViewMode: 'raw',
