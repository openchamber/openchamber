...
describe('settings registry gate', () => {
  ...
  const validValues = {
    ...
    notifyOnPermission: true, notificationSoundEnabled: true, notificationSoundVolume: 0.5,
    notificationSoundEventSounds: { completion: 'bip-bop' }, notificationSoundFocusOnly: true,
