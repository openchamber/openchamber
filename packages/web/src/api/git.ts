...
export const createWebGitAPI = (): GitAPI => ({
  ...
  abortCherryPick: gitApiHttp.abortCherryPick,
  continueCherryPick: gitApiHttp.continueCherryPick,
  revertCommit: gitApiHttp.revertCommit,
  abortRevert: gitApiHttp.abortRevert,
  continueRevert: gitApiHttp.continueRevert,
