...
Los recorridos se escriben en el idioma de tu interfaz por defecto. El selector de idioma de la cabecera del panel arranca ahí, y puedes elegir cualquier otro idioma al que esté traducido Sharpie para una sola revisión: una explicación guiada solo sirve en un idioma que leas con soltura.
...
La generación se ejecuta en el servidor de Sharpie, no en la pestaña del navegador. Recarga la página o cierra el panel y continúa; al volver, el resultado te espera. Solo **Cancelar** la detiene.
