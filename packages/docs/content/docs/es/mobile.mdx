...
description: Instala la app de Sharpie en iOS o Android y conéctala a tu servidor.
---

# Apps móviles y PWA

Sharpie tiene apps nativas para iPhone y Android, para que puedas seguir sesiones, responder a los agentes y gestionar el trabajo desde tu teléfono, en casa por Wi-Fi o desde cualquier lugar a través del [Private Relay](/es/private-relay/).
...
1. En la computadora donde se ejecuta Sharpie, abre **Settings → Remote Instances → Conectarse a este servidor** y pulsa **Añadir un dispositivo**.
...
En **Settings → Sharpie**, unas cuantas opciones ajustan la experiencia móvil e instalada: el nombre de la app instalada, la orientación de la pantalla y el comportamiento del teclado en pantalla.
