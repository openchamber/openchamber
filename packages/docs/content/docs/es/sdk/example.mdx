...
Compílala desde la carpeta con `bunx openchamber-guest-bundle panel/main.ts panel/main.js` y luego añade la carpeta en Ajustes → Extensiones. Hay cuatro ejemplos más (todos los controles de UI, una lista de tareas con sesiones y prompts, un servicio local, una integración con token) en [github.com/openchamber/openchamber/tree/main/packages/sdk/examples](https://github.com/openchamber/openchamber/tree/main/packages/sdk/examples).
