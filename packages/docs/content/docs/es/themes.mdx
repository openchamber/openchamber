---
title: Temas
description: Personaliza Sharpie con temas integrados y definidos por el usuario.
---

# Temas

Sharpie admite temas integrados y archivos JSON de tema personalizados.
...
3. Abre Sharpie y ve a **Settings -> Theme -> Reload themes**.
