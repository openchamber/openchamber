...
OpenChamber no se conecta a ciegas a un servidor ajeno en el puerto predeterminado; solo adopta
un hijo guardian existente cuando coinciden su propietario y la identidad de proceso persistidos.
