...
description: Install the Sharpie app on iOS or Android and connect it to your server.
---

# Mobile Apps & PWA

Sharpie has native apps for iPhone and Android, so you can watch sessions, reply to agents, and manage work from your phone — at home over Wi-Fi or from anywhere over the [Private Relay](/private-relay/).
...
1. On the computer running Sharpie, open **Settings → Remote Instances → Connect to this server** and press **Add a device**.
...
Under **Settings → Sharpie**, a few options tune the mobile and installed experience — the app's installed name, screen orientation, and how the on-screen keyboard behaves.
