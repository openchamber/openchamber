---
title: Quickstart
description: Start Sharpie quickly and pick the right app for the task.
---
...
2. Install the Sharpie CLI (see [Install](/install/) for the one-line command).
...
You should see the Sharpie session list in your browser. If it loads, you're up and running.
