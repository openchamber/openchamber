...
OpenChamber ne se connecte pas aveuglément à un serveur sans rapport sur le port par défaut ;
un enfant guardian existant n’est adopté que si son propriétaire et son identité de processus
persistés correspondent à cette instance OpenChamber.
