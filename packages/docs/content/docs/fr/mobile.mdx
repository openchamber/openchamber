...
description: Installez l’application Sharpie sur iOS ou Android et connectez-la à votre serveur.
---

# Applications mobiles et PWA

Sharpie a des applications natives pour iPhone et Android : suivez les sessions, répondez aux agents et gérez votre travail depuis votre téléphone — à la maison en Wi-Fi ou depuis n’importe où via le [Relais privé](/private-relay/).
...
1. Sur l’ordinateur qui exécute Sharpie, ouvrez **Paramètres → Instances distantes → Se connecter à ce serveur** et pressez **Ajouter un appareil**.
...
Dans **Paramètres → Sharpie**, quelques options ajustent l’expérience mobile et installée — le nom de l’application installée, l’orientation de l’écran et le comportement du clavier à l’écran.
