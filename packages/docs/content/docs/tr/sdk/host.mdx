...
## Projeler, worktree'ler ve canlı oturumlar
...
Ek izin gerekmez. Depolama, bağlı sunucuda bu uzantıya aittir, yeniden yüklemelerde korunur ve kaldırma işleminde silinir. `get`, olmayan anahtar için `undefined` döndürür; kaydedilmiş JSON null değeri null kalır. Anahtarlar 1 ile 128 karakter arasındadır. Serileştirilmiş her JSON değeri en fazla 64 KiB UTF-8, toplam 2 MiB ve 2.000 anahtardır. Projeye özel veriler için anahtarda proje kimliği kullanın. Yazmalar sıralı ve atomiktir; hatalar mevcut veriyi korur.
