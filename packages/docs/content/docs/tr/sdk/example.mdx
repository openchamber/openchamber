...
Klasörün içinden `bunx openchamber-guest-bundle panel/main.ts panel/main.js` ile derleyin, sonra klasörü Ayarlar → Uzantılar içinde ekleyin. Dört örnek daha (her UI denetimi, oturumlar ve istemlerle bir görev listesi, yerel bir servis, bir token entegrasyonu) [github.com/openchamber/openchamber/tree/main/packages/sdk/examples](https://github.com/openchamber/openchamber/tree/main/packages/sdk/examples) adresinde.
