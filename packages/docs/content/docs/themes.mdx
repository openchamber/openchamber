---
title: Themes
description: Customize Sharpie with built-in and user-defined themes.
---

# Themes

Sharpie supports built-in themes and custom theme JSON files.
...
3. Open Sharpie, then go to **Settings -> Theme -> Reload themes**.
