...
Build it from the folder with `bunx openchamber-guest-bundle panel/main.ts panel/main.js`, then add the folder at Settings → Extensions. Four more examples (every UI control, a task list with sessions and prompts, a local service, a token integration) are at [github.com/openchamber/openchamber/tree/main/packages/sdk/examples](https://github.com/openchamber/openchamber/tree/main/packages/sdk/examples).
