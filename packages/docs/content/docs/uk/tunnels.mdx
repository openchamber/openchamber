---
title: Тунелі
description: Безпечно відкрийте Sharpie для віддаленого та мобільного доступу.
---

# Тунелі

Тунель — це публічне посилання на ваш Sharpie, щоб дістатися до нього зі звичайного браузера в іншій мережі. Скористайтеся `openchamber tunnel`, щоб створити його для запущеного інстансу.
...
Sharpie запускає CLI провайдера тунелю на вашій машині. Спочатку встановіть провайдера, який хочете використовувати:
...
Коли тунель піднято, `status` показує публічний URL. Відкрийте його або відскануйте QR-код, щоб дістатися до Sharpie звідусіль.

Типово Sharpie виводить QR-код в інтерактивних TTY-сесіях. Використовуйте `--qr`, щоб примусово вивести QR, або `--no-qr`, щоб вимкнути його.
...
- один активний тунель на інстанс Sharpie (порт)
...
- [PWA та мобільний доступ](/uk/mobile/) — відкривайте Sharpie з телефона
