---
title: Теми
description: Налаштуйте Sharpie за допомогою вбудованих і власних тем.
---

# Теми

Sharpie підтримує вбудовані теми та власні JSON-файли тем.
...
3. Відкрийте Sharpie, потім перейдіть до **Settings -> Theme -> Reload themes**.
