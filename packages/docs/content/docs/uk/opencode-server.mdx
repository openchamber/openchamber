...
3. інакше — запускає й керує власним

Якщо нічого не налаштовано, крок 3 відбувається автоматично, і все працює. OpenChamber
не підключається навмання до стороннього сервера на стандартному порту; наявний дочірній
процес guardian приймається лише за збігу збережених власника та ідентичності процесу.
