---
title: Motywy
description: Dostosuj Sharpie za pomocą wbudowanych i własnych motywów.
---

# Motywy

Sharpie obsługuje wbudowane motywy oraz własne pliki JSON z motywami.
...
3. Otwórz Sharpie, a następnie przejdź do **Settings -> Theme -> Reload themes**.
