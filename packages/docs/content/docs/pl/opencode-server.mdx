...
OpenChamber nie łączy się w ciemno z niezależnym serwerem na domyślnym porcie; istniejący proces
guardian jest adoptowany tylko wtedy, gdy zapisany właściciel i tożsamość procesu pasują do tej instancji OpenChamber.
