...
Zbuduj je z folderu poleceniem `bunx openchamber-guest-bundle panel/main.ts panel/main.js`, a potem dodaj folder w Ustawienia → Rozszerzenia. Cztery kolejne przykłady (każdy element UI, lista zadań z sesjami i promptami, usługa lokalna, integracja tokenowa) znajdziesz na [github.com/openchamber/openchamber/tree/main/packages/sdk/examples](https://github.com/openchamber/openchamber/tree/main/packages/sdk/examples).
