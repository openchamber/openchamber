...
description: Zainstaluj aplikację Sharpie na iOS lub Androidzie i połącz ją ze swoim serwerem.
---

# Aplikacje mobilne i PWA

Sharpie ma natywne aplikacje na iPhone'a i Androida, więc możesz obserwować sesje, odpowiadać agentom i zarządzać pracą z telefonu — w domu przez Wi-Fi lub z dowolnego miejsca przez [Private Relay](/pl/private-relay/).
...
1. Na komputerze z uruchomionym Sharpie otwórz **Settings → Remote Instances → Połącz z tym serwerem** i naciśnij **Dodaj urządzenie**.
...
W **Settings → Sharpie** kilka opcji dostraja działanie na telefonie i zainstalowanej aplikacji — nazwę zainstalowanej aplikacji, orientację ekranu i zachowanie klawiatury ekranowej.
