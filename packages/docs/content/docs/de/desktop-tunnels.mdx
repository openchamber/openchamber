...
Die Desktop-App kann unter **Settings → Sharpie → Tunnel** einen öffentlichen Tunnel erstellen. Für diesen Weg musst du Sharpie nicht per CLI starten.

## Anbieter installieren

Sharpie startet das Provider-CLI auf deinem Rechner. Installiere zuerst den Anbieter, den du verwenden möchtest:
...
1. Öffne **Settings → Sharpie → Tunnel**.
