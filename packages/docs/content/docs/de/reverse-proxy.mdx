---
title: Reverse Proxy
description: Konfigurieren Sie Sharpie korrekt hinter Nginx, Nginx Proxy Manager oder einem anderen Reverse Proxy.
---

# Reverse Proxy

Nutzen Sie diese Seite, wenn Sharpie hinter Nginx, Nginx Proxy Manager, Caddy, Cloudflare oder einem anderen Reverse Proxy läuft.

## Bevor Sie es proxyen

1. Bestätigen Sie zuerst, dass Sharpie direkt funktioniert.
...
- Deaktivieren Sie gzip auf dem Proxy, wenn Sharpie Antworten bereits komprimiert.
...
- Sharpie direkt im LAN erreichbar
...
- Sharpie komprimiert HTTP-Antworten mit gzip (Schwelle 1 KB).
...
SSE-Streaming-Routen sind von Sharpie von der Komprimierung ausgeschlossen, das CDN kann sie aber trotzdem puffern. Prüfen Sie in der CDN-Dokumentation, wie sich Buffering auf SSE-Pfaden deaktivieren lässt.
