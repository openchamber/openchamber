---
title: Schnellstart
description: Starte Sharpie schnell und wähle die richtige App für die Aufgabe.
---
...
2. Installiere das Sharpie-CLI (siehe [Installieren](/install/) für den Einzeilenbefehl).
...
Du solltest die Sharpie-Session-Liste in deinem Browser sehen. Wenn sie geladen wird, bist du startklar.
