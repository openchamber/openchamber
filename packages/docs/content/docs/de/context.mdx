...
Jedes Modell kann immer nur so viel von einer Unterhaltung gleichzeitig halten — seinen Kontext. Sharpie zeigt dir, wie voll er ist, damit du erkennst, wenn eine Session an die Grenze kommt und eine Antwort vielleicht ältere Details fallen lässt.
