...
Aktionen liegen in einem Menü im App-Header. Klicke auf eine und Sharpie führt sie in einem Terminal in deinem Projektordner aus und wechselt dich in die Terminalansicht, damit du die Ausgabe verfolgen kannst. Stoppe sie über dasselbe Menü.

## Einen Entwicklungsserver automatisch öffnen

Aktiviere **auto-open URL** für eine Aktion, die einen Server startet. Sharpie überwacht die Ausgabe auf eine lokale Adresse und bietet an, sie zu öffnen — siehe [Vorschau & Entwicklungsserver](/preview/). Auf dem Desktop kannst du sie außerdem über einen SSH-Port-Forward leiten.

## Verwandt

- [Vorschau & Entwicklungsserver](/preview/) — einen laufenden Entwicklungsserver in Sharpie öffnen
