...
description: Kopple dein Telefon, deinen Desktop oder einen anderen Browser mit deinem Sharpie-Server über einen einmaligen QR-Code.
---

# Ein Gerät verbinden

Kopple ein weiteres Gerät — die Mobile App, die Desktop-App oder einen Browser auf einem anderen Rechner — mit deinem Sharpie-Server, indem du einen einmaligen QR-Code scannst. Das ist der empfohlene Weg, Geräte zu verbinden; du musst keine Ports öffnen und keine Adressen eintippen.

## Gerät koppeln

1. Öffne auf dem Rechner mit Sharpie **Settings → Remote Instances → Connect to this server** und drücke **Add a device**.
...
5. Scanne den Code auf dem anderen Gerät:
   ...
   - **desktop app** — kopiere stattdessen den Verbindungslink und füge ihn unter **Settings → Remote Instances → Other Sharpie servers → Import Link** ein
