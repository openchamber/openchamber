...
description: Öffne einen laufenden Entwicklungsserver direkt in Sharpie.
---

# Vorschau & Entwicklungsserver

Wenn du einen Entwicklungsserver startest, kann Sharpie ihn direkt in der App öffnen statt in einem separaten Browser-Tab — so kannst du deine Seite neben dem Chat sehen, ihre Konsole aufzeichnen und Elemente anstupsen, um Fragen dazu zu stellen.

## Eine Vorschau öffnen

Sharpie überwacht die Terminalausgabe auf eine lokale Adresse (die `Local:`-Zeile, die Werkzeuge wie Vite, Next.js oder Astro ausgeben). Sobald es eine findet:
