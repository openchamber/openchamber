...
description: Installiere die Sharpie-App auf iOS oder Android und verbinde sie mit deinem Server.
---

# Mobile Apps & PWA

Sharpie hat native Apps für iPhone und Android, damit du Sitzungen verfolgen, auf Agenten antworten und Arbeiten von deinem Telefon aus verwalten kannst — zu Hause über WLAN oder von überall über das [Private Relay](/private-relay/).
...
1. Öffne auf dem Computer mit Sharpie **Settings → Remote Instances → Connect to this server** und drücke **Add a device**.
...
Unter **Settings → Sharpie** passen ein paar Optionen die mobile und installierte Nutzung an — der Installationsname der App, die Bildschirmausrichtung und das Verhalten der Bildschirmtastatur.
