...
Usage works for the providers that publish a quota, including Claude, Codex, Fireworks AI, GitHub Copilot, Google, OpenRouter, Kimi, NanoGPT, z.ai, Zhipu, MiniMax, Ollama Cloud, and Wafer.
