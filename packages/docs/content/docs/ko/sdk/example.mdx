...
폴더에서 `bunx openchamber-guest-bundle panel/main.ts panel/main.js`로 빌드한 다음, 설정 → 확장 에서 그 폴더를 추가하세요. 예제 네 개(모든 UI 컨트롤, 세션과 프롬프트가 있는 작업 목록, 로컬 서비스, 토큰 통합)가 [github.com/openchamber/openchamber/tree/main/packages/sdk/examples](https://github.com/openchamber/openchamber/tree/main/packages/sdk/examples)에 더 있습니다.
