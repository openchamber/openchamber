...
Download the latest desktop build from the GitHub releases page or the OpenChamber download page. Linux users can choose an AppImage or Debian package. Open the app and sign into your usual OpenCode workflow. Debian package installations are updated through the system package manager.
