...
description: Instale o app do Sharpie no iOS ou Android e conecte-o ao seu servidor.
---

# Apps Móveis e PWA

O Sharpie tem apps nativos para iPhone e Android, então você pode acompanhar sessões, responder aos agentes e gerenciar o trabalho pelo celular — em casa pelo Wi-Fi ou de qualquer lugar pelo [Private Relay](/pt-br/private-relay/).
...
1. No computador que executa o Sharpie, abra **Settings → Remote Instances → Conectar a este servidor** e pressione **Adicionar um dispositivo**.
...
Em **Settings → Sharpie**, algumas opções ajustam a experiência móvel e instalada — o nome instalado do app, a orientação da tela e como o teclado na tela se comporta.
