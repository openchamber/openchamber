...
O OpenChamber não se conecta cegamente a um servidor não relacionado na porta padrão; um filho
guardian existente só é adotado quando o proprietário e a identidade do processo persistidos correspondem a esta instância.
