...
Compile a partir da pasta com `bunx openchamber-guest-bundle panel/main.ts panel/main.js` e depois adicione a pasta em Configurações → Extensões. Mais quatro exemplos (todos os controles de UI, uma lista de tarefas com sessões e prompts, um serviço local, uma integração com token) estão em [github.com/openchamber/openchamber/tree/main/packages/sdk/examples](https://github.com/openchamber/openchamber/tree/main/packages/sdk/examples).
