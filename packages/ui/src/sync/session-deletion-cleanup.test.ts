...
describe('cleanupPersistedSessionState', () => {
  ...
  test('blocks a late merged-send restoration after scoped deletion cleanup', async () => {
    ...
    useMessageQueueStore.setState({
      queuedMessages: {
        [getMessageQueueKey(deleted)]: [
          { id: 'merged-one', content: 'merged one', text: 'merged one', createdAt: 1 },
          { id: 'merged-two', content: 'merged two', text: 'merged two', createdAt: 2 },
        ],
        [getMessageQueueKey(retained)]: [
          { id: 'retained', content: 'retained', text: 'retained', createdAt: 3 },
        ],
      },
    });
