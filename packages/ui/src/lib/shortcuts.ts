...
const SHORTCUT_ACTIONS: ReadonlyArray<ShortcutAction> = [
  ...
  {
    id: 'cycle_session_previous',
    defaultCombo: 'mod+alt+up',
    label: 'Previous session',
    description: 'Switch to the previous recent session in the current instance',
    customizable: true,
  },
  {
    id: 'cycle_session_next',
    defaultCombo: 'mod+alt+down',
    label: 'Next session',
    description: 'Switch to the next recent session in the current instance',
    customizable: true,
  },
  {
    id: 'cycle_instance_previous',
    defaultCombo: 'mod+alt+left',
    label: 'Previous instance',
    description: 'Switch to the previous connected instance',
    customizable: true,
  },
  {
    id: 'cycle_instance_next',
    defaultCombo: 'mod+alt+right',
    label: 'Next instance',
    description: 'Switch to the next connected instance',
    customizable: true,
  },
  {
    id: 'switch_recent_session_1',
    defaultCombo: 'alt+1',
    label: 'Switch to recent session 1',
    description: 'Jump to the most recent session',
    customizable: true,
  },
  {
    id: 'switch_recent_session_2',
    defaultCombo: 'alt+2',
    label: 'Switch to recent session 2',
    description: 'Jump to the 2nd most recent session',
    customizable: true,
  },
  {
    id: 'switch_recent_session_3',
    defaultCombo: 'alt+3',
    label: 'Switch to recent session 3',
    description: 'Jump to the 3rd most recent session',
    customizable: true,
  },
  {
    id: 'switch_recent_session_4',
    defaultCombo: 'alt+4',
    label: 'Switch to recent session 4',
    description: 'Jump to the 4th most recent session',
    customizable: true,
  },
  {
    id: 'switch_recent_session_5',
    defaultCombo: 'alt+5',
    label: 'Switch to recent session 5',
    description: 'Jump to the 5th most recent session',
    customizable: true,
  },
  {
    id: 'switch_recent_session_6',
    defaultCombo: 'alt+6',
    label: 'Switch to recent session 6',
    description: 'Jump to the 6th most recent session',
    customizable: true,
  },
  {
    id: 'switch_recent_session_7',
    defaultCombo: 'alt+7',
    label: 'Switch to recent session 7',
    description: 'Jump to the 7th most recent session',
    customizable: true,
  },
  {
    id: 'switch_recent_session_8',
    defaultCombo: 'alt+8',
    label: 'Switch to recent session 8',
    description: 'Jump to the 8th most recent session',
    customizable: true,
  },
  {
    id: 'switch_recent_session_9',
    defaultCombo: 'alt+9',
    label: 'Switch to recent session 9',
    description: 'Jump to the 9th most recent session',
    customizable: true,
  },
  {
    id: 'switch_instance_1',
    defaultCombo: 'mod+shift+1',
    label: 'Switch to instance 1',
    description: 'Jump to the first connected instance',
    customizable: true,
  },
  {
    id: 'switch_instance_2',
    defaultCombo: 'mod+shift+2',
    label: 'Switch to instance 2',
    description: 'Jump to the second connected instance',
    customizable: true,
  },
  {
    id: 'switch_instance_3',
    defaultCombo: 'mod+shift+3',
    label: 'Switch to instance 3',
    description: 'Jump to the third connected instance',
    customizable: true,
  },
  {
    id: 'switch_instance_4',
    defaultCombo: 'mod+shift+4',
    label: 'Switch to instance 4',
    description: 'Jump to the fourth connected instance',
    customizable: true,
  },
  {
    id: 'switch_instance_5',
    defaultCombo: 'mod+shift+5',
    label: 'Switch to instance 5',
    description: 'Jump to the fifth connected instance',
    customizable: true,
  },
  {
    id: 'switch_instance_6',
    defaultCombo: 'mod+shift+6',
    label: 'Switch to instance 6',
    description: 'Jump to the sixth connected instance',
    customizable: true,
  },
  {
    id: 'switch_instance_7',
    defaultCombo: 'mod+shift+7',
    label: 'Switch to instance 7',
    description: 'Jump to the seventh connected instance',
    customizable: true,
  },
  {
    id: 'switch_instance_8',
    defaultCombo: 'mod+shift+8',
    label: 'Switch to instance 8',
    description: 'Jump to the eighth connected instance',
    customizable: true,
  },
  {
    id: 'switch_instance_9',
    defaultCombo: 'mod+shift+9',
    label: 'Switch to instance 9',
    description: 'Jump to the ninth connected instance',
    customizable: true,
  },
] as const;
