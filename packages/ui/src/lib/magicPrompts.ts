...
export type MagicPromptId =
  ...
  | 'gitea.pr.review.visible'
  | 'gitea.pr.review.instructions'
  | 'gitea.issue.review.visible'
  | 'gitea.issue.review.instructions'
  | 'plan.todo.visible'
...
Do not implement changes until I confirm; end with: "Next actions: <1 sentence>".`,
  ...
  {
    id: 'gitea.pr.review.visible',
    title: 'PR Review Visible Prompt',
    group: 'Gitea',
    description: 'Visible user message when creating pull request review requests from Gitea context.',
    placeholders: [
      { key: 'pr_number', description: 'Pull request number.' },
    ],
    template: 'Review this pull request !{{pr_number}} using the provided PR context',
  },
  {
    ...
    title: 'PR Review Instructions',
    group: 'Gitea',
    description: 'Hidden instructions attached when generating a Gitea pull request review response.',
    template: `You are drafting a pull request review comment that will be posted back to the PR author. You are not the implementer; do not propose to write code or run commands.
...
- None`,
  ...
  {
    id: 'gitea.issue.review.visible',
    title: 'Issue Review Visible Prompt',
    group: 'Gitea',
    description: 'Visible user message when creating issue review requests from Gitea context.',
    placeholders: [
      { key: 'issue_number', description: 'Issue number.' },
    ],
    template: 'Review this issue #{{issue_number}} using the provided issue context',
  ...
  {
    id: 'gitea.issue.review.instructions',
    title: 'Issue Review Instructions',
    group: 'Gitea',
    description: 'Hidden instructions attached when generating a Gitea issue review response.',
    template: `Review this Gitea issue using the provided issue context.
