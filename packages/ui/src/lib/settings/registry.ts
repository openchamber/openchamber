...
export const SETTINGS_REGISTRY = {
  ...
  recentSessionCyclingEnabled: field({ scope: 'profile', parse: parseBoolean, ui: uiStore('recentSessionCyclingEnabled', (v) => useUIStore.getState().setRecentSessionCyclingEnabled(v)) }),
