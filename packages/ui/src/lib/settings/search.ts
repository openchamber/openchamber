...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  {
    id: 'integrations.discord.connect',
    page: 'integrations',
    titleKey: 'settings.integrations.discord.connect',
    descriptionKey: 'settings.integrations.discord.connectHint',
    keywords: ['discord', 'bot', 'connect', 'add', 'messenger'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
  ...
  {
    id: 'integrations.discord.fallback-channel',
    page: 'integrations',
    titleKey: 'settings.integrations.discord.advanced.fallbackChannel.title',
    descriptionKey: 'settings.integrations.discord.advanced.fallbackChannel.description',
    keywords: ['discord', 'channel', 'fallback', 'default', 'test', 'history'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
