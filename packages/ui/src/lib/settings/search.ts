...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    id: 'harness.opencode',
    page: 'harness',
    titleKey: 'settings.harness.opencode.title',
    descriptionKey: 'settings.harness.opencode.description',
    keywords: ['opencode', 'default harness', 'providers', 'agents'],
  },
  {
    id: 'harness.claude-code',
    page: 'harness',
    titleKey: 'settings.harness.claudeCode.title',
    descriptionKey: 'settings.harness.claudeCode.description',
    keywords: ['claude', 'claude code', 'subscription', 'cli', 'detect'],
  },
  {
    id: 'harness.claude-code.warn-handoff',
    page: 'harness',
    titleKey: 'settings.harness.claudeCode.warnHandoff.label',
    descriptionKey: 'settings.harness.claudeCode.warnHandoff.info',
    keywords: ['handoff', 'billing', 'warning', 'subscription', 'switch harness'],
  },
  {
    id: 'harness.claude-code.agents-mode',
    page: 'harness',
    titleKey: 'settings.harness.claudeCode.agentsMode.label',
    descriptionKey: 'settings.harness.claudeCode.agentsMode.info',
    keywords: ['agents', 'claude', 'opencode', 'openchamber', 'system prompt', 'permissions'],
  },
  {
    id: 'harness.claude-code.import',
    page: 'harness',
    titleKey: 'settings.harness.claudeCode.section.import',
    descriptionKey: 'settings.harness.claudeCode.import.note',
