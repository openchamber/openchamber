...
export const thirdPartyIntegrationI18n = {
  ...
  tr: {
    ...
    'settings.integrations.messengers.title': 'Mesajlaşma uygulamaları',
    'settings.integrations.messengers.info': 'Discord veya Telegram üzerinden OpenChamber ile sohbet edin. Bu köprüler henüz kullanıma açık değil.',
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'OpenChamber ile sohbet etmek için bir Discord botu bağlayın.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'OpenChamber ile sohbet etmek için bir Telegram botu bağlayın.',
    ...
    'settings.integrations.thirdParty.opencodeCommandcode.name': 'Command Code',
    'settings.integrations.thirdParty.opencodeCommandcode.description': '$1 Go Plan: sınırsız Laguna S 2.1 + $40 DeepSeek V4 Pro. Oturum açın, CLI gerekmez.',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
