...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.defaults.backgroundAutoAccept.label": "Автоматичне схвалення у фоновому режимі",
  "settings.openchamber.defaults.backgroundAutoAccept.description": "Зберігає чинними наявні правила автоматичного схвалення дозволів, коли жоден клієнт інтерфейсу не підключений.",
  "settings.openchamber.defaults.backgroundAutoAccept.warning": "Попередження: OpenChamber автоматично схвалюватиме відповідні дозволи, доки цю опцію ввімкнено.",
  "settings.openchamber.defaults.backgroundAutoAccept.saveFailed": "Не вдалося зберегти налаштування автоматичного схвалення у фоновому режимі",
