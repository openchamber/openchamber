...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.agents.sidebar.error.title": "Не вдалося завантажити агентів",
  "settings.agents.sidebar.error.description": "Бекенд OpenCode недоступний. Перевірте з'єднання і спробуйте ще раз.",
  "settings.agents.sidebar.error.retry": "Повторити",
