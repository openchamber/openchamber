export const settingsDict = {
  ...
  "settings.openchamber.tunnel.field.tailscaleHttpsPort": "HTTPS-порт Tailscale",
  "settings.openchamber.tunnel.field.tailscaleHttpsPortDescription": "Порт фронтенду Tailscale. Serve приймає будь-який порт від 1 до 65535; Funnel підтримує 443, 8443 або 10000.",
  "settings.openchamber.tunnel.field.tailscaleServeHttpsPortDescription": "Serve приймає будь-яке ціле число від 1 до 65535.",
  "settings.openchamber.tunnel.field.tailscaleFunnelHttpsPortDescription": "Funnel підтримує лише 443, 8443 або 10000.",
  "settings.openchamber.tunnel.field.tailscaleHttpsPortError": "Введіть ціле число від 1 до 65535.",
  ...
  "settings.openchamber.tunnel.notAvailable.tailscaleInstallHint": "Перед запуском установіть Tailscale і ввійдіть у нього на цьому пристрої:",
  "settings.openchamber.tunnel.option.mode.privateNetwork.label": "Лише tailnet (Serve)",
  "settings.openchamber.tunnel.option.mode.privateNetwork.tooltip": "Tailscale Serve обмежує доступ межами вашої мережі tailnet.",
  "settings.openchamber.tunnel.option.mode.tailscaleQuick.label": "Публічний (Funnel)",
  "settings.openchamber.tunnel.option.mode.tailscaleQuick.tooltip": "Tailscale Funnel робить цей екземпляр доступним із публічного інтернету.",
  "settings.openchamber.tunnel.warning.tailscaleFunnelPublic": "Tailscale Funnel відкриває цей екземпляр у публічний інтернет. Використовуйте його лише тоді, коли публічний доступ справді потрібен.",
  "settings.openchamber.tunnel.badge.privateNetwork": "Tailnet",
  "settings.openchamber.tunnel.toast.startedButNoUrl": "Тунель запущено, але він не повернув URL-адресу доступу.",
  "settings.openchamber.tunnel.field.tailnetUrlHint": "URL-адреса tailnet",
