export const settingsDict = {
  ...
  "settings.page.vision.title": "Зір",
  "settings.page.vision.description": "Дозволяє моделям, які не бачать зображень, описувати їх через налаштовану модель зору.",
  "settings.vision.section.title": "Інструмент зору",
  "settings.vision.section.info": "Коли поточна модель не бачить зображень, агент може викликати інструмент зору, який читає файл зображення та просить налаштовану модель зору описати його — вміст, компонування, стиль і весь видимий текст. Опис повертається вашій моделі, щоб вона могла міркувати про зображення, не бачачи його. Кожен виклик тарифікується на обрану тут модель зору.",
  "settings.vision.model.label": "Модель зору",
  "settings.vision.model.info": "Модель, яка описує зображення для інструмента зору. Перелічено лише моделі, що приймають вхідні зображення; моделі, які каталог не може оцінити, залишаються видимими, і сервер повторно перевіряє їх перед кожним запуском.",
  "settings.vision.model.notSelected": "Вибрати модель зору",
  "settings.vision.model.required": "Виберіть модель зору, щоб увімкнути інструмент зору.",
  "settings.vision.prompt.label": "Підказка опису",
  "settings.vision.prompt.info": "Підказка, що надсилається з кожним зображенням моделі зору. Гарна підказка запитує вміст, компонування, стиль, кольори та дослівний текст, щоб модель отримала повну картину. Залиште порожнім, щоб використовувати вбудований стандарт.",
  "settings.vision.prompt.placeholder": "Залиште порожнім, щоб використовувати стандартну підказку.",
  "settings.vision.prompt.save": "Зберегти",
  "settings.vision.prompt.reset": "Скинути до стандартного",
  "settings.vision.toast.saved": "Налаштування зору збережено",
  "settings.vision.toast.saveFailed": "Не вдалося зберегти налаштування зору",
  "settings.vision.toast.loadFailed": "Не вдалося завантажити налаштування зору",
