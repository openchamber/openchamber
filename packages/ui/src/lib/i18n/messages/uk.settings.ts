...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.providers.copilotGhe.clientIdPlaceholder": "Залиште порожнім, щоб використати значення за замовчуванням",
  "settings.providers.copilotGhe.clientIdHint": "Залиште Client ID порожнім, щоб використати значення OpenChamber за замовчуванням ({clientId}).",
  "settings.providers.copilotGhe.status.authorizationPending": "Авторизація все ще очікується. Завершіть device flow у браузері, а потім знову натисніть «Завершити».",
  "settings.providers.copilotGhe.status.slowDown": "GitHub Enterprise Server попросив зменшити частоту опитування. Зачекайте трохи, а потім знову натисніть «Завершити».",
  "settings.providers.copilotGhe.toast.serverUrlRequired": "URL сервера є обов’язковим",
  "settings.providers.copilotGhe.toast.startFirst": "Спочатку запустіть device flow",
  "settings.providers.copilotGhe.toast.startFailed": "Не вдалося запустити потік автентифікації GitHub Enterprise Server",
  "settings.providers.copilotGhe.toast.completeFailed": "Не вдалося завершити потік автентифікації GitHub Enterprise Server",
  "settings.providers.copilotGhe.toast.authorizationPending": "Авторизація все ще очікується",
  "settings.providers.copilotGhe.toast.slowDown": "GitHub Enterprise Server запросив зниження швидкості",
  "settings.providers.copilotGhe.toast.connected": "GitHub Enterprise Server підключено",
