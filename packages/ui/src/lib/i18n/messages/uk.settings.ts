...
export const settingsDict = {
  ...
  "settings.magicPrompts.sidebar.group.composer": "Композитор",
  ...
  "settings.magicPrompts.sidebar.item.composerEnhance": "Покращення запитів",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.magicPrompts.page.group.composerEnhance.title": "Покращення запитів",
  ...
  "settings.magicPrompts.page.group.composerEnhance.description": "Промпт, який використовує дія «Покращити запит» у композиторі: приховані інструкції, що переписують вашу чернетку малою моделлю перед надсиланням.",
