...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.agentBrowser.title": "Браузер агента",
  "settings.openchamber.agentBrowser.status.loading": "Перевірка браузера…",
  "settings.openchamber.agentBrowser.status.unknown": "Статус браузера недоступний.",
  "settings.openchamber.agentBrowser.status.ready": "Готово: {path}",
  "settings.openchamber.agentBrowser.status.missing": "На цьому хості не знайдено браузер, сумісний із Chrome.",
  "settings.openchamber.agentBrowser.status.missingPath": "Указаний шлях до браузера не існує.",
  "settings.openchamber.agentBrowser.status.host": "Хост: {platform}/{arch}",
  "settings.openchamber.agentBrowser.field.binaryPath": "Виконуваний файл браузера",
  "settings.openchamber.agentBrowser.field.binaryPathPlaceholder": "/usr/bin/google-chrome-stable",
  "settings.openchamber.agentBrowser.field.binaryPathInfo": "Абсолютний шлях до Chrome, Chromium, Edge або Brave. Залиште порожнім, щоб використати кероване встановлення, OPENCHAMBER_BROWSER_PATH або автопошук. Застосовується після Зберегти.",
  "settings.openchamber.agentBrowser.field.noSandbox": "Вимкнути sandbox браузера",
  "settings.openchamber.agentBrowser.field.noSandboxAria": "Вимкнути Chromium sandbox для headless-хостів",
  "settings.openchamber.agentBrowser.field.noSandboxInfo": "Потрібно на багатьох headless-серверах, у контейнерах і під root, де sandbox Chromium недоступний. Еквівалент OPENCHAMBER_BROWSER_NO_SANDBOX=true.",
  "settings.openchamber.agentBrowser.field.noSandboxRecommended": "Рекомендовано на цьому хості (контейнер або root).",
  "settings.openchamber.agentBrowser.actions.browseAria": "Обрати виконуваний файл браузера",
  "settings.openchamber.agentBrowser.actions.save": "Зберегти",
  "settings.openchamber.agentBrowser.actions.saving": "Збереження…",
  "settings.openchamber.agentBrowser.actions.install": "Установити Chrome",
  "settings.openchamber.agentBrowser.actions.installing": "Установлення…",
  "settings.openchamber.agentBrowser.actions.installUnsupported": "Кероване встановлення недоступне на цій платформі.",
