...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.providers.sidebar.section.customProviders": "Власні провайдери",
  ...
  "settings.providers.page.connect.availableProvidersSection": "Доступні провайдери",
  "settings.providers.page.connect.configureCustomProvider": "Налаштувати власного провайдера",
  ...
  "settings.providers.page.custom.description": "Додайте провайдера з протоколом API, базовою URL-адресою, обліковими даними та списком моделей. Він зберігається в конфігурації OpenCode й працює в чаті як будь-який інший провайдер.",
  ...
  "settings.providers.page.custom.protocol.label": "Протокол API",
  "settings.providers.page.custom.protocol.info": "Виберіть формат запитів і відповідей, який підтримує цей провайдер. Адаптер додає endpoint протоколу до базової URL-адреси.",
  ...
  "settings.providers.page.custom.field.baseURL.info": "Базова URL-адреса API без endpoint протоколу. Має починатися з http:// або https://.",
  ...
  "settings.providers.page.custom.models.contextLimitLabel": "Вікно контексту",
  "settings.providers.page.custom.models.contextLimitInfo": "Максимальна кількість токенів, які модель може врахувати в одному запиті.",
  "settings.providers.page.custom.models.contextLimitPlaceholder": "128000",
  "settings.providers.page.custom.models.inputLimitLabel": "Максимальне введення",
  "settings.providers.page.custom.models.inputLimitInfo": "Необов’язкове обмеження токенів промпту, якщо воно відрізняється від загального вікна контексту.",
  "settings.providers.page.custom.models.inputLimitPlaceholder": "Необов’язково",
  "settings.providers.page.custom.models.outputLimitLabel": "Максимальне виведення",
  "settings.providers.page.custom.models.outputLimitInfo": "Максимальна кількість токенів, які модель може згенерувати в одній відповіді.",
  "settings.providers.page.custom.models.outputLimitPlaceholder": "8192",
  "settings.providers.page.custom.models.imageInputLabel": "Введення зображень",
  ...
  "settings.providers.page.custom.models.capability.unsupported": "Не підтримується",
  ...
  "settings.providers.page.custom.error.positiveInteger": "Введіть додатне ціле число",
  ...
  "settings.providers.page.models.capability.imageInputUnsupported": "Без введення зображень",
  "settings.providers.page.models.thinkingLevels": "Рівні мислення",
  "settings.providers.page.models.tokenBadge.context": "контекст",
  "settings.providers.page.models.tokenBadge.output": "макс. виведення",
