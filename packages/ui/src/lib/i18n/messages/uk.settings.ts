...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.visual.section.updates": "Оновлення",
  "settings.openchamber.visual.field.updateChannel": "Канал оновлень",
  "settings.openchamber.visual.field.updateChannelHint": "Оберіть Stable для офіційних релізів або Beta для бета-версій",
  "settings.openchamber.visual.toast.switchedChannel": "Канал оновлень змінено на {channel}.",
  "settings.openchamber.visual.toast.latestVersionForChannel": "Ви використовуєте актуальну версію для каналу {channel}.",
