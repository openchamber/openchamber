...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.visual.field.messageTimestampFormat": "Message time",
  "settings.openchamber.visual.field.selectMessageTimestampFormatAria": "Select message time format",
  "settings.openchamber.visual.option.messageTimestampFormat.hidden.label": "Hidden",
  "settings.openchamber.visual.option.messageTimestampFormat.hidden.description": "Do not show a date/time on messages.",
  "settings.openchamber.visual.option.messageTimestampFormat.relative.label": "Relative",
  "settings.openchamber.visual.option.messageTimestampFormat.relative.description": "Show elapsed time, e.g. \"2h 15m ago\".",
  "settings.openchamber.visual.option.messageTimestampFormat.absolute.label": "Absolute",
  "settings.openchamber.visual.option.messageTimestampFormat.absolute.description": "Show the exact timestamp.",
  "settings.openchamber.visual.option.messageTimestampFormat.hybrid.label": "Hybrid",
  "settings.openchamber.visual.option.messageTimestampFormat.hybrid.description": "Relative until the message reaches the threshold age, then absolute.",
  "settings.openchamber.visual.field.messageTimestampHybridThreshold": "Duration before switching to absolute (e.g. 1d 2h 30m)",
  "settings.openchamber.visual.field.messageTimestampHybridThresholdDays": "days",
  "settings.openchamber.visual.field.messageTimestampHybridThresholdHours": "hours",
  "settings.openchamber.visual.field.messageTimestampHybridThresholdMinutes": "min",
