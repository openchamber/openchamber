...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.visual.field.messageSpeedMetrics": "Показувати метрики швидкості відповіді",
  "settings.openchamber.visual.field.messageSpeedMetricsAria": "Показувати метрики швидкості під завершеними відповідями",
  "settings.openchamber.visual.field.messageSpeedMetricsInfo": "Показує TTFT (час до першого токена) та вихідні токени за секунду під завершеними відповідями. Корисно для порівняння провайдерів і релеїв.",
