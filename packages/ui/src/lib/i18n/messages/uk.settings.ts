...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.notifications.page.delivery.info": "Це системні сповіщення поза застосунком. На комп'ютері це нативні сповіщення ОС. У браузері чи встановленій програмі це веб-push, вони приходять і коли вкладка у фоні. Історія під дзвіночком окрема.",
  ...
  "settings.notifications.page.inbox.title": "Історія в застосунку",
  "settings.notifications.page.inbox.info": "Вимкніть список, щоб сховати всі рядки і значок. Зніміть позначку з типу, щоб сховати лише його. Рядки лишаються збереженими, тож повторне ввімкнення їх повертає.",
  "settings.notifications.page.inbox.enableLabel": "Увімкнути історію в застосунку",
  ...
  "settings.notifications.page.inbox.soundInfo": "Короткий сигнал, коли рядок з'являється в списку, навіть якщо це вікно у фоні. Якщо вже звучить системний банер, сигнал мовчить.",
  ...
  "settings.notifications.page.inbox.sessionErrorAria": "Показувати помилки сесії в історії застосунку",
  "settings.notifications.page.inbox.sessionSubtaskLabel": "Підзадачі",
  "settings.notifications.page.inbox.sessionSubtaskAria": "Показувати сповіщення підзадач в історії застосунку",
  "settings.notifications.page.inbox.permissionQuestionLabel": "Дозволи та питання",
  "settings.notifications.page.inbox.permissionQuestionAria": "Показувати сповіщення про дозволи та питання в історії застосунку",
  "settings.notifications.page.inbox.appErrorWarningLabel": "Помилки та попередження застосунку",
  "settings.notifications.page.inbox.appErrorWarningAria": "Показувати помилки та попередження застосунку в історії застосунку",
  "settings.notifications.page.inbox.infoLabel": "Інформація",
  "settings.notifications.page.inbox.infoAria": "Показувати інформаційні сповіщення в історії застосунку",
  "settings.notifications.page.inbox.successLabel": "Успіх",
  "settings.notifications.page.inbox.successAria": "Показувати сповіщення про успіх в історії застосунку",
