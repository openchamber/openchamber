...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.remoteInstances.clientAuth.relayEndpoint.title": "Сервер Relay",
  "settings.remoteInstances.clientAuth.relayEndpoint.info": "Адреса, що використовується для посилань прив’язки «З будь-якого місця» та доступу через Relay. Вкажіть власний самостійно розміщений Relay, щоб цей трафік залишався у вашій інфраструктурі; запущений хост Relay негайно перепід’єднається. Раніше створені посилання прив’язки зберігають початкову адресу.",
  "settings.remoteInstances.clientAuth.relayEndpoint.option.default": "Типовий",
  "settings.remoteInstances.clientAuth.relayEndpoint.option.custom": "Власний",
  "settings.remoteInstances.clientAuth.relayEndpoint.field.placeholder": "wss://vash-relay.example/ws",
  "settings.remoteInstances.clientAuth.relayEndpoint.actions.save": "Зберегти",
  "settings.remoteInstances.clientAuth.relayEndpoint.locked": "Закріплено змінною середовища OPENCHAMBER_RELAY_URL:",
