...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'Вставте cookie сесії з ollama.com (знайдіть session=... в інструментах розробника браузера). Це не ваш локальний API-ключ або кінцева точка Ollama. OpenChamber ніколи не сканує сховище cookie браузера.',
