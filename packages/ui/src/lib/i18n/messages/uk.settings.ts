export const settingsDict = {
  ...
  "settings.workspaces.reauth.prompt": "Підтвердьте цю привілейовану дію з робочим простором паролем OpenChamber. Залиште поле порожнім, якщо цей хост не має пароля.",
  ...
  "settings.workspaces.export.review": "Переглянути зміни",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.workspaces.status.connected": "Підключено",
  "settings.workspaces.status.connecting": "Підключення",
  "settings.workspaces.status.disconnected": "Відключено",
  "settings.workspaces.status.error": "Помилка",
  "settings.workspaces.status.unknown": "Невідомий стан",
  ...
  "settings.workspaces.handoff.title": "Перевірити передавання контексту",
  "settings.workspaces.handoff.description": "Перевірте й відредагуйте текст, з якого почнеться нова цільова сесія.",
