...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.defaults.field.defaultDirectory": "Каталог за замовчуванням",
  "settings.openchamber.defaults.field.defaultDirectoryHint": "Нові сесії починаються в цьому каталозі, коли жоден не вибрано. Залиште порожнім, щоб зберегти поточну поведінку.",
  "settings.openchamber.defaults.field.defaultDirectoryPlaceholder": "Залиште порожнім для поточного каталогу",
  "settings.openchamber.defaults.actions.browseDirectory": "Огляд",
  "settings.openchamber.defaults.actions.browseDirectoryAria": "Огляд каталогу",
