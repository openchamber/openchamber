...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.commands.page.field.subtask": "Виконати як підзавдання",
  "settings.commands.page.field.subtaskDescription": "Примусово виконати команду як сесію субагента",
  "settings.commands.page.field.subtaskAria": "Перемкнути режим підзавдання для цієї команди",
