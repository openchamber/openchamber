export const settingsDict = {
  ...
  "settings.openchamber.tunnel.readOnly.title": "Статус тунелю лише для читання",
  "settings.openchamber.tunnel.readOnly.description": "Керування тунелем доступне з робочого столу хоста або автентифікованого сеансу браузера.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.remoteInstances.clientAuth.state.viaManagedDirectE2ee": "Керований прямий E2EE",
  "settings.remoteInstances.clientAuth.state.connectedManagedDirectE2ee": "Підключено · Керований прямий E2EE",
  "settings.remoteInstances.clientAuth.addDevice.transport.managedE2ee": "Керований прямий E2EE",
  "settings.remoteInstances.clientAuth.addDevice.transport.managedE2eeHint": "Наскрізний зашифрований тунель, керований цим сервером. Керуйте з робочого столу хоста або автентифікованого сеансу браузера.",
  ...
  'settings.openchamber.tunnel.field.directE2eeLabel': 'Наскрізне шифрування нативного додатка',
  'settings.openchamber.tunnel.field.directE2eeDescription': 'Трафік через Cloudflare шифрується між нативним додатком і цим хостом OpenChamber.',
  'settings.openchamber.tunnel.field.directE2eeUnsupported': 'Потрібна версія клієнта, яка підтримує пряме E2EE.',
  'settings.openchamber.tunnel.field.nativePairingLabel': 'Сполучення нативного додатка',
  'settings.openchamber.tunnel.field.nativePairingDescription': 'Сполучіть нативний мобільний або десктопний додаток за допомогою наскрізного шифрування.',
  'settings.openchamber.tunnel.actions.openAddDevice': 'Додати пристрій',
  'settings.openchamber.tunnel.field.browserAccessLabel': 'Доступ через браузер',
  'settings.openchamber.tunnel.field.browserQrAlt': 'QR-код доступу через браузер',
  'settings.openchamber.tunnel.note.scanQrToConnectBrowser': 'Відскануйте цей QR-код у мобільному браузері, щоб підключитися.',
  'settings.openchamber.tunnel.toast.directE2eeSaved': 'Налаштування прямого E2EE збережено',
  'settings.openchamber.tunnel.toast.directE2eeSaveFailed': 'Не вдалося зберегти налаштування прямого E2EE',
  'settings.remoteInstances.transport.managedE2ee.label': 'Керований тунель (E2EE)',
  'settings.remoteInstances.transport.managedE2ee.description': 'Безпечно підключайтеся через керований тунель Cloudflare.',
  'settings.remoteInstances.transport.managedE2ee.note': 'Це підключення використовує наскрізне шифрування через ваш керований тунель.',
} as const;
