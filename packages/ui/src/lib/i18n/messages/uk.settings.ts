...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  'settings.openchamber.visual.field.activityColorCoding': 'Кольорове кодування інструментів і активності',
  'settings.openchamber.visual.field.activityColorCodingAria': 'Кольорове кодування рядків інструментів і активності',
  'settings.openchamber.visual.field.activityColorCodingHint': 'Задає кожному типу рядка інструмента та активності власний акцентний колір теми — зміни файлів, команди оболонки, пошук, роздуми тощо. Вимкніть, щоб використовувати один нейтральний відтінок.',
