...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.visual.field.showMessageSpeedMetricsAria": "Показати метрики швидкості повідомлення",
  "settings.openchamber.visual.field.showMessageSpeedMetrics": "Показати метрики швидкості повідомлення",
  "settings.openchamber.visual.field.showMessageSpeedMetricsInfo": "Показує час до першого токена, пропускну здатність виводу та розбиття некешований / кеш / вивід на кожному повідомленні асистента. Час до першого токена вимірюється на сервері OpenCode від початку повідомлення до першої частини міркування або тексту.",
