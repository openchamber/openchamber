...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.voice.page.field.ttsChunkedMode": "Режим TTS окремими реченнями",
  "settings.voice.page.field.ttsChunkedModeAria": "Режим TTS окремими реченнями",
  "settings.voice.page.tooltip.ttsChunked": "Розділяє довгий текст на речення та відтворює кожне щойно воно синтезоване, тому відтворення починається значно раніше. Вимкніть, щоб синтезувати весь текст одним запитом.",
