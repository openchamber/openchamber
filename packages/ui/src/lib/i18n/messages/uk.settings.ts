...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.visual.section.chatMessageWidth": "Ширина повідомлень",
  "settings.openchamber.visual.section.chatMessageWidthAria": "Ширина повідомлень",
  "settings.openchamber.visual.field.chatMessageWidthAria": "Ширина повідомлень: {option}",
  "settings.openchamber.visual.option.chatMessageWidth.narrow.label": "Вузька",
  "settings.openchamber.visual.option.chatMessageWidth.wide.label": "Широка",
  "settings.openchamber.visual.option.chatMessageWidth.fluid.label": "На всю ширину",
