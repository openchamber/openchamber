...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.tools.field.serverBrowser": "Браузер сервера",
  "settings.openchamber.tools.field.serverBrowserAria": "Увімкнути браузер сервера",
  "settings.openchamber.tools.field.serverBrowserInfo": "Запускає браузер Chrome на цьому сервері, щоб агенти могли переглядати сторінки, навіть коли жодне під’єднане вікно не може відповісти, і щоб ви могли переглядати й керувати тими самими сторінками з будь-якого пристрою. Типово вимкнено, застосовується одразу; після вимкнення Chrome зупиняється, а його сесії та глядачі закриваються.",
  "settings.openchamber.tools.browserDebugPort.label": "Порт CDP браузера",
  "settings.openchamber.tools.browserDebugPort.info": "Виберіть порт для локальних підключень MCP. Збережені налаштування застосуються під час наступного запуску Chrome, а поточні вкладки залишаться відкритими.",
  "settings.openchamber.tools.browserDebugPort.automatic": "Автоматично",
  "settings.openchamber.tools.browserDebugPort.fixed": "Фіксований порт",
  "settings.openchamber.tools.browserDebugPort.input": "Фіксований порт CDP",
  "settings.openchamber.tools.browserDebugPort.invalid": "Введіть ціле число від 1 до 65535.",
  "settings.openchamber.tools.browserDebugPort.save": "Зберегти порт",
  "settings.openchamber.tools.browserDebugPort.configuredAutomatic": "Налаштований порт: автоматично",
  "settings.openchamber.tools.browserDebugPort.configuredFixed": "Налаштований порт: {port}",
  "settings.openchamber.tools.browserDebugPort.loading": "Перевірка стану браузера…",
  "settings.openchamber.tools.browserDebugPort.unavailable": "Не вдалося отримати стан браузера.",
  "settings.openchamber.tools.browserDebugPort.stopped": "Chrome не запущено.",
  "settings.openchamber.tools.browserDebugPort.active": "Активний порт: {port}",
  "settings.openchamber.tools.browserDebugPort.pending": "Збережений порт застосовується під час наступного запуску Chrome.",
  "settings.openchamber.tools.browserDebugPort.refresh": "Оновити стан",
  "settings.openchamber.tools.browserDebugPort.copy": "Копіювати URL браузера",
  "settings.openchamber.tools.browserDebugPort.copied": "URL браузера скопійовано",
  "settings.openchamber.tools.browserDebugPort.copyFailed": "Не вдалося скопіювати URL браузера.",
  "settings.openchamber.tools.browserDebugPort.connectionInfo": "Ця адреса зворотного зв'язку належить комп'ютеру сервера. Запустіть MCP на ньому з параметром --browserUrl або скористайтеся власним SSH-тунелем. Прямі підключення MCP не використовують функцію \"Перебрати керування\".",
