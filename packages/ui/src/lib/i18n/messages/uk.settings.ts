...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'Скопіюйте повний заголовок Cookie із заголовків запиту в інструментах розробника браузера на ollama.com і вставте його сюди. Зберігається й надсилається лише cookie сесії: wos-session=... (старі облікові записи можуть використовувати __Secure-session=...). Інші cookie із заголовка не передаються. Це не локальний API-ключ і не локальна кінцева точка Ollama. OpenChamber ніколи не сканує сховище cookie браузера.',
  'settings.providers.page.ollamaCloud.cookie': 'Заголовок Cookie',
