export const settingsDict = {
  ...
  "settings.workspaces.export.review": "Переглянути patch",
  "settings.workspaces.export.summary": "{files} файлів, +{additions} -{deletions}",
  "settings.workspaces.export.patch": "Patch workspace",
  "settings.workspaces.export.check": "Перевірити patch",
  "settings.workspaces.export.apply": "Застосувати patch",
