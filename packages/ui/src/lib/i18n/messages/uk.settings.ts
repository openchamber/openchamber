...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.voice.page.field.browserMicrophonePermission": "Коли натиснете мікрофон у чаті, дозвольте доступ до нього, якщо браузер запитає. Якщо запит не з’являється або доступ заблоковано, відкрийте налаштування сайту біля адресного рядка, дозвольте мікрофон, перезавантажте сторінку та спробуйте ще раз.",
