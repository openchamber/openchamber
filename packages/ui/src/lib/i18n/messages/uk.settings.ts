...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.projects.codexImport.action": "Імпортувати розмови Codex",
  "settings.projects.codexImport.title": "Імпорт із Codex",
  "settings.projects.codexImport.description": "Додає проєкти Codex і зберігає кожну розмову як читабельний запис OpenCode. Початкові дані Codex не змінюються.",
  "settings.projects.codexImport.loading": "Зчитування проєктів і розмов Codex...",
  "settings.projects.codexImport.error.inspect": "Не вдалося прочитати дані Codex.",
  "settings.projects.codexImport.error.apply": "Не вдалося імпортувати дані Codex.",
  "settings.projects.codexImport.config.model": "Модель: {model}",
  "settings.projects.codexImport.config.provider": "Постачальник: {provider}",
  "settings.projects.codexImport.config.unset": "Не задано",
  "settings.projects.codexImport.projects.title": "Проєкти для імпорту",
  "settings.projects.codexImport.projects.conversations": "Розмови: {count}",
  "settings.projects.codexImport.projects.missing": "Каталог більше недоступний",
  "settings.projects.codexImport.empty": "Проєктів або розмов Codex не знайдено.",
  "settings.projects.codexImport.actions.retry": "Спробувати знову",
  "settings.projects.codexImport.actions.selectAll": "Вибрати все",
  "settings.projects.codexImport.actions.selectNone": "Зняти вибір",
  "settings.projects.codexImport.actions.importing": "Імпортування...",
  "settings.projects.codexImport.result.summary": "Імпортовано: {imported}; пропущено: {skipped}; помилок: {failed}.",
  "settings.projects.codexImport.toast.partial": "Імпорт Codex завершено: імпортовано {imported}, пропущено {skipped}, помилок {failed}.",
  "settings.projects.codexImport.toast.complete": "Імпорт Codex завершено: імпортовано {imported}, уже існує {skipped}.",
