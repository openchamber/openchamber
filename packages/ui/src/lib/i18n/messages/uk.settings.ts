export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Скопіюйте ID робочого простору з URL панелі, а cookie auth з інструментів розробника браузера. Sharpie ніколи не сканує сховище cookie браузера.',
  ...
  "settings.window.description": "Вікно налаштувань Sharpie.",
  ...
  "settings.page.appearance.description": "Налаштуйте вигляд і відчуття Sharpie.",
  ...
  "settings.remoteInstances.direct.title": "Інші сервери Sharpie",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Додайте інший сервер Sharpie за URL. Використовуйте це, коли сервер уже запущений і у вас є токен підключення.",
  ...
  "settings.remoteInstances.direct.import.description": "Вставте посилання для підключення з іншого сервера Sharpie.",
  ...
  "settings.remoteInstances.direct.error.invalidConnectLink": "Недійсне посилання підключення Sharpie.",
  ...
  "settings.remoteInstances.clientAuth.description": "Створіть безпечне посилання або токен, щоб Sharpie Desktop міг підключитися до цього сервера.",
  ...
  "settings.remoteInstances.clientAuth.qrAlt": "QR-код підключення Sharpie",
  "settings.remoteInstances.clientAuth.qrEnlarge": "Збільшити QR-код",
  "settings.remoteInstances.clientAuth.qrScanHint": "Скануй це застосунком Sharpie на іншому пристрої. Одноразовий і має термін дії.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Працює вдома і поза домом. Поза домом трафік іде через Sharpie Private Relay — наскрізно зашифрований тунель. Нічого налаштовувати не треба.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Відскануйте цей QR-код застосунком Sharpie на іншому пристрої.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Виберіть, чи Sharpie має запустити сервер для вас, чи підключитися до вже запущеного.",
  ...
  "settings.remoteInstances.page.field.keepServerRunningHint": "Залишати Sharpie запущеним на віддаленій машині після відключення.",
  ...
  "settings.openchamber.about.title": "Про Sharpie",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Додати репозиторій Git як нове джерело каталогу. Sharpie просканує його на наявність папок, що містять",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Запускати Sharpie під час входу в систему",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Запускати Sharpie під час входу в систему",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Показувати Sharpie у смузі меню macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Показувати Sharpie у смузі меню",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Потребує перезапуску застосунку. Якщо вимкнено, Sharpie не створює елемент смуги меню та не запускає пов’язані оновлення сесій, запитів на підтвердження й використання.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Згортати й закривати Sharpie у системний трей",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Згортати й закривати в системний трей",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Залишає Sharpie запущеним у системному треї, коли головне вікно згорнуто або закрито.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Не давати комп’ютеру засинати, поки Sharpie запущено",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Не давати комп’ютеру засинати, поки Sharpie запущено",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "Sharpie попросить пароль після перезапуску, а потім коли сесія логіну спливе: через 12 годин або через 7 днів із «Довіряти цьому пристрою». Залиште порожнім, щоб вимкнути логін.",
  ...
  "settings.remoteInstances.page.description": "Підключіться до іншої машини через SSH і відкрийте там Sharpie.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "Sharpie на віддаленій машині",
  "settings.remoteInstances.page.section.remoteServerDescription": "Виберіть, як Sharpie має працювати після SSH-підключення.",
  "settings.remoteInstances.page.section.mainTunnel": "Локальний доступ",
  "settings.remoteInstances.page.section.mainTunnelDescription": "Виберіть локальну адресу, через яку відкриватиметься цей віддалений сервер Sharpie.",
  "settings.remoteInstances.page.section.authentication": "Аутентифікація",
  "settings.remoteInstances.page.section.authenticationDescription": "Додаткові облікові дані для SSH та віддаленого інтерфейсу користувача Sharpie.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Як розмістити Sharpie на віддаленій машині, коли цей застосунок запускає його для вас.",
  ...
  "settings.remoteInstances.page.phase.installingOpenChamber": "Встановлення Sharpie",
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Оновлення Sharpie",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Зберігається в автентифікації OpenCode, не Sharpie. Використовуйте {env:VAR_NAME}, щоб читати ключ зі змінної середовища.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Ключі надсилаються безпосередньо до OpenCode і ніколи не зберігаються в Sharpie.",
  ...
  "settings.github.page.flow.title": "Авторизувати Sharpie",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Доступно як резервний варіант, якщо автентифікацію Sharpie видалено",
  ...
  "settings.notifications.page.testNotification.body": "Це тестове сповіщення від Sharpie.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Локальна розшифровка на сервері Sharpie. Моделі завантажуються автоматично; ключ API не потрібен.",
  "settings.voice.page.tooltip.localTts": "Локальний синтез на сервері Sharpie (Kokoro, англійська). Модель завантажується автоматично; ключ API не потрібен.",
