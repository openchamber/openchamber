...
export const settingsDict = {
  'settings.sourceControl.ssh.title': 'Керовані облікові дані SSH',
  'settings.sourceControl.ssh.load': 'Завантажити ключі сервера',
  'settings.sourceControl.ssh.discover': 'Знайти ключі хоста',
  'settings.sourceControl.ssh.empty': 'На цьому сервері немає налаштованих керованих ключів SSH.',
  'settings.sourceControl.ssh.hostSetup': 'Пошук перевіряє лише файли приватних ключів безпосередньо в каталозі ~/.ssh користувача підключеного сервера. Він не перевіряє підкаталоги, символічні посилання, конфігурацію SSH або агенти. Імпортовані копії залишаються в каталозі даних сервера. Для ключів із парольною фразою або доступних лише через агент явно виберіть системний транспорт; його облікові дані не перевіряються.',
  'settings.sourceControl.ssh.unreadable': 'Не вдалося прочитати ключ на сервері. Виправте налаштування хоста або виберіть системний транспорт.',
  'settings.sourceControl.ssh.changed': 'Відбиток ключа змінився. Виправте налаштування хоста або виберіть системний транспорт.',
  'settings.sourceControl.ssh.unverifiable': 'Ключ зашифрований або його неможливо перевірити. Виправте налаштування хоста або виберіть системний транспорт.',
  'settings.sourceControl.ssh.insecurePermissions': 'Дозволи ключа надають доступ іншим користувачам. Обмежте дозволи файлу на хості перед імпортом.',
  'settings.sourceControl.ssh.discoveredEmpty': 'У схваленому каталозі сервера не знайдено приватних ключів, які можна імпортувати.',
  'settings.sourceControl.ssh.discoveryTruncated': 'У каталозі більше записів, ніж дозволяє ліміт пошуку. Деякі файли не перевірено.',
  'settings.sourceControl.ssh.confirmFingerprint': 'Я перевірив цей відбиток: {fingerprint}',
  'settings.sourceControl.ssh.import': 'Імпортувати ключ',
  'settings.sourceControl.ssh.imported': 'Ключ скопійовано до керованого сховища сервера. Прив’язку репозиторію не змінено.',
  'settings.sourceControl.ssh.candidateExpired': 'Термін дії цього результату пошуку минув. Знайдіть ключі хоста ще раз.',
  'settings.sourceControl.ssh.candidateChanged': 'Ключ хоста змінився після пошуку. Знайдіть його ще раз перед імпортом.',
  'settings.sourceControl.ssh.confirmationMismatch': 'Підтверджений відбиток не відповідає цьому результату пошуку.',
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.gitIdentities.editor.field.account": "Обліковий запис керування кодом",
  "settings.gitIdentities.editor.field.accountNone": "Без облікового запису",
  'settings.gitIdentities.editor.auth.label': 'Автентифікація',
  'settings.gitIdentities.editor.auth.oauth': 'OAuth',
  'settings.gitIdentities.editor.auth.token': 'Токен',
  'settings.gitIdentities.editor.auth.anonymous': 'Анонімно',
  'settings.gitIdentities.editor.auth.ssh': 'SSH',
  'settings.gitIdentities.editor.auth.oauthHint': 'Push і pull через OAuth-вхід акаунта.',
  'settings.gitIdentities.editor.auth.tokenHint': 'Push і pull через персональний токен доступу акаунта.',
  ...
  'settings.openchamber.git.agentAuthority': 'Застосовувати ідентичності в шелах агента',
  'settings.openchamber.git.agentAuthorityAria': 'Застосовувати ідентичності в шелах агента',
  'settings.openchamber.git.agentAuthorityInfo': 'Git, який агент запускає сам, отримує ідентичність репозиторія замість налаштувань цього комп\'ютера, а агента просять користуватися тулом OpenChamber замість прямої передачі. Репозиторії на системному git лишаються з налаштуваннями цього комп\'ютера. Діє з наступного перезапуску OpenCode і ніколи не стосується твого власного термінала.',
  ...
  'settings.gitlab.info': 'Підключіть GitLab.com або власний екземпляр GitLab для merge requests, issues та CI.',
  'settings.gitlab.instance.customLabel': 'Екземпляр GitLab',
  'settings.gitlab.instance.customInfo': 'Використовуйте HTTPS-адресу. HTTP дозволено лише для локальних адрес.',
  ...
  'settings.gitlab.device.label': 'Код пристрою',
  'settings.gitlab.cli.label': 'glab CLI',
  'settings.gitlab.cli.info': 'Використовувати облікові дані glab, коли немає активного збереженого облікового запису.',
  'settings.gitlab.actions.enableCli': 'Увімкнути glab',
  'settings.gitlab.actions.disableCli': 'Вимкнути glab',
  'settings.gitlab.instances.title': 'Інстанси',
  ...
  'settings.sourceControl.binding.accountLabel': 'Обліковий запис керування кодом',
  'settings.sourceControl.agentAuthority.title': 'Шел агента',
  'settings.sourceControl.agentAuthority.label': 'Застосовувати ідентичність цього репозиторія в шелі агента',
  'settings.sourceControl.agentAuthority.info': 'Вимкнено означає, що git, який агент запускає тут, лишається з налаштуваннями цього комп\'ютера, а прямі передачі в шелі не відхиляються. Діє з наступного перезапуску OpenCode.',
  'settings.sourceControl.agentAuthority.machineOff': 'Ідентичності не застосовуються в шелах агента на цьому комп\'ютері. Увімкни це в Налаштуваннях → Git.',
  'settings.sourceControl.binding.accountAriaLabel': 'Обліковий запис керування кодом для активного репозиторію',
  'settings.sourceControl.binding.noAccounts': 'Немає відповідних облікових записів',
  'settings.sourceControl.binding.noRepository': 'Відкрийте Git-репозиторій, щоб налаштувати його обліковий запис керування кодом.',
  'settings.sourceControl.binding.loading': 'Завантаження прив’язки репозиторію…',
  'settings.sourceControl.binding.suggested': 'Підтвердьте запропонований обліковий запис, перш ніж OpenChamber використає його для цього репозиторію.',
  'settings.sourceControl.binding.configured': 'Цей обліковий запис використовується для API-дій керування кодом в активному репозиторії.',
  'settings.sourceControl.binding.confirm': 'Підтвердити обліковий запис',
  'settings.sourceControl.transport.credentialAccount': 'Обліковий запис для автентифікації HTTPS',
  'settings.sourceControl.transport.retry': 'Перезавантажити й повторити спробу',
  'settings.sourceControl.transport.unverifiedConfirmation': 'Я розумію, що системний Git використовує облікові дані на підключеному Git-хості. OpenChamber не може перевірити, якому обліковому запису вони належать.',
  'settings.sourceControl.transport.info': 'Прив’яжіть віддалений репозиторій до системного Git або облікових даних, якими керує хост. Облікові записи API провайдерів залишаються окремими.',
  ...
  'settings.sourceControl.transport.anonymous': 'Анонімний HTTPS, лише читання',
  'settings.sourceControl.transport.https': 'Керований HTTPS',
  'settings.sourceControl.transport.ssh': 'Керований SSH-ключ',
  'settings.sourceControl.transport.bind': 'Прив’язати репозиторій',
  'settings.sourceControl.transport.noRepository': 'Відкрийте Git-репозиторій, щоб налаштувати його транспорт.',
  'settings.sourceControl.transport.loading': 'Завантаження транспорту репозиторію…',
  'settings.sourceControl.transport.missing': 'Виберіть віддалений репозиторій і транспорт, щоб створити прив’язку.',
  'settings.sourceControl.transport.needsAttention': 'Конфігурація Git змінилася. Перевірте й повторно збережіть прив’язку транспорту.',
  'settings.sourceControl.transport.configured': 'Вибраний віддалений репозиторій має явну прив’язку Git-транспорту.',
  'settings.sourceControl.transport.remove': 'Видалити дозвіл транспорту',
  ...
  'settings.page.integrations.description': 'Підключіть GitHub, GitLab і Linear, щоб OpenChamber міг працювати з вашими задачами, pull request-ами та merge request-ами.',
} as const;
