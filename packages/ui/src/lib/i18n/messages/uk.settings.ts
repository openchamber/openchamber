export const settingsDict = {
  ...
  "settings.page.sessions.description": "Налаштуйте типові параметри сеансів, обробку дозволів і зберігання.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.permissionAutoAccept.title": "Автоматичне прийняття дозволів",
  "settings.openchamber.permissionAutoAccept.info": "Застосовується до всіх сеансів у цьому середовищі виконання, якщо окремий сеанс явно не ввімкне або не вимкне власну політику дозволів. Увімкнення також одразу обробить уже наявні запити дозволів.",
  "settings.openchamber.permissionAutoAccept.field.globalLabel": "Автоматично схвалювати запити дозволів для всіх сеансів у цьому середовищі виконання",
  "settings.openchamber.permissionAutoAccept.field.globalAria": "Автоматично схвалювати запити дозволів для всіх сеансів у цьому середовищі виконання",
  "settings.openchamber.permissionAutoAccept.field.globalWarning": "Безпека: OpenChamber схвалюватиме наявні й майбутні запити дозволів без запиту, доки сеанс явно не перевизначить цю політику.",
  "settings.openchamber.permissionAutoAccept.dialog.title": "Увімкнути автоматичне прийняття дозволів для всіх сеансів?",
  "settings.openchamber.permissionAutoAccept.dialog.description": "OpenChamber негайно схвалить запити дозволів, які вже очікують, і продовжить схвалювати нові в цьому середовищі виконання, доки сеанс явно не перевизначить політику. Увімкнюйте це лише в довіреному середовищі.",
  "settings.openchamber.permissionAutoAccept.dialog.confirm": "Увімкнути автоприйняття",
