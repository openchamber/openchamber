...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.scrollBehavior.title": "Позиція прокручування",
  "settings.openchamber.scrollBehavior.description": "Виберіть, де сеанс відкривається повторно під час повернення до нього. За замовчуванням відновлюється попередня позиція.",
  "settings.openchamber.scrollBehavior.option.restore.label": "Відновити попередню позицію",
  "settings.openchamber.scrollBehavior.option.jumpToEnd.label": "Завжди переходити в кінець",
  "settings.openchamber.scrollBehavior.sectionAria": "Поведінка прокручування сеансу під час перемикання",
  "settings.openchamber.scrollBehavior.field.modeAria": "Поведінка прокручування: {option}",
