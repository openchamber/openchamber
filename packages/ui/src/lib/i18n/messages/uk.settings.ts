...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.visual.field.contextPanelDock": "Розташування контекстної панелі",
  "settings.openchamber.visual.field.contextPanelDockAria": "Розташування контекстної панелі",
  "settings.openchamber.visual.field.contextPanelDockHint": "Переміщує всю контекстну панель, а не лише термінал: усі поверхні (термінал, зміни, порівняння, файли, нотатки) закріплюються біля вибраного краю колонки чату.",
  "settings.openchamber.visual.option.contextPanelDock.right": "Праворуч",
  "settings.openchamber.visual.option.contextPanelDock.bottom": "Знизу",
