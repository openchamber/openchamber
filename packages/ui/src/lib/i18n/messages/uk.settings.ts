...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  'settings.plugins.registry.badge.missingPackage.tooltip': 'Пакет {name} не знайдено в реєстрі',
  ...
  'settings.plugins.registry.badge.network.tooltip': 'Не вдалося підключитися до реєстру пакетів',
  ...
  'settings.plugins.registry.banner.invalid.missingPackage': 'Пакет не знайдено в реєстрі',
  ...
  "settings.voice.page.tooltip.sttBrowser": "Вбудоване розпізнавання в підтримуваних браузерах. Безкоштовно, без налаштування.",
  "settings.voice.page.browserTest.title": "Перевірити мікрофон",
  "settings.voice.page.browserTest.stop": "Зупинити перевірку",
  "settings.voice.page.browserTest.transcript": "Розпізнаний текст з’явиться тут.",
  "settings.voice.page.browserTest.description": "Говоріть, щоб перевірити розпізнавання та гучність мікрофона. Текст залишається в цьому перегляді й не надсилається до чату. Браузер може надсилати аудіо до своєї служби розпізнавання мовлення.",
  "settings.voice.page.browserTest.unavailable": "Розпізнавання мовлення браузером тут недоступне. Відкрийте сайт через HTTPS у підтримуваному браузері або виберіть Локально чи Сервер. Настільні й нативні мобільні застосунки не підтримуються.",
  "settings.voice.page.browserFallback": "Розпізнавання браузера вибрано на іншому пристрої. Цей пристрій його не підтримує, тому тут використовується локальне.",
  "settings.voice.page.browserTest.error": "Розпізнавання мовлення зупинено ({code}). Перевірте дозволи мікрофона та з’єднання й повторіть спробу. Розпізнаний текст збережено.",
  "settings.voice.page.browserTest.error.busy": "На цій сторінці вже триває інше диктування. Спочатку зупиніть його, а потім спробуйте знову.",
  "settings.voice.page.browserTest.error.network": "Не вдалося з’єднатися зі службою розпізнавання. Перевірте з’єднання й спробуйте знову. Розпізнаний текст збережено.",
  "settings.voice.page.browserTest.error.noSpeech": "Мовлення не почуто. Підійдіть ближче до мікрофона й спробуйте знову.",
  "settings.voice.page.browserTest.error.audioCapture": "Індикатор гучності мікрофона недоступний. Запис триває без нього.",
  "settings.voice.page.browserTest.error.timeout": "Служба розпізнавання не встигла відповісти. Розпізнаний текст збережено.",
  "settings.voice.page.browserTest.error.startFailed": "Не вдалося запустити розпізнавання. Перезавантажте сторінку й спробуйте знову.",
  "settings.voice.page.browserTest.error.permission": "У доступі до мікрофона відмовлено. Дозвольте мікрофон у налаштуваннях сайту біля адресного рядка, перезавантажте сторінку й спробуйте знову.",
  "settings.voice.page.field.browserMicrophonePermission": "Коли натискаєте мікрофон у чаті або запускаєте тест нижче, дозвольте доступ до нього, якщо браузер запитає. Якщо запит не з’являється або доступ заблоковано, відкрийте налаштування сайту біля адресного рядка, дозвольте мікрофон, перезавантажте сторінку та спробуйте ще раз.",
