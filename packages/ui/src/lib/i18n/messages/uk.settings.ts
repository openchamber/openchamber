...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.projects.shellEnv.title": "Середовище оболонки",
  "settings.projects.shellEnv.state.loading": "Завантаження...",
  "settings.projects.shellEnv.state.loadFailed": "Не вдалося прочитати конфігурацію цього проєкту. Нічого не буде змінено, доки вона не завантажиться.",
  "settings.projects.shellEnv.description": "Завантажує середовище розробки цього проєкту (devenv, direnv, скрипт оболонки) і застосовує його до Git, термінала та дій проєкту.",
  "settings.projects.shellEnv.enabled": "Увімкнути для цього проєкту",
  "settings.projects.shellEnv.disabledWarning": "Збережено, але вимкнено: команда не запускатиметься, доки ви її не увімкнете.",
  "settings.projects.shellEnv.command.label": "Команда середовища",
  "settings.projects.shellEnv.command.placeholder": "devenv print-dev-env --json",
  "settings.projects.shellEnv.command.info": "Команда, вивід якої описує середовище. Підтримуються: devenv print-dev-env --json, direnv export json або рядки export/NAME=value. Виконується з кореня проєкту.",
  "settings.projects.shellEnv.mode.label": "Обробка PATH",
  "settings.projects.shellEnv.mode.overlay": "Додати перед системним PATH",
  "settings.projects.shellEnv.mode.replace": "Замінити системний PATH",
  "settings.projects.shellEnv.mode.info": "Додавання спереду зберігає доступ до системних інструментів і ставить інструменти проєкту першими. Заміна використовує PATH проєкту точно.",
  "settings.projects.shellEnv.vars.label": "Додаткові змінні",
  "settings.projects.shellEnv.vars.info": "Необов’язкові пари NAME=value, по одній у рядку, накладаються поверх виводу команди. Вони мають пріоритет над розібраними значеннями.",
  "settings.projects.shellEnv.vars.placeholder": "GOFLAGS=-mod=vendor",
  "settings.projects.shellEnv.vars.invalid": "Це не коректний рядок NAME=value: {names}",
  "settings.projects.shellEnv.trustInfo": "Команда виконується локально з ваших власних налаштувань, ніколи з репозиторію. Нічого не запускається, доки ви не увімкнете її тут.",
  "settings.projects.shellEnv.toast.saveFailed": "Не вдалося зберегти середовище оболонки проєкту",
