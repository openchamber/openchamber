...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.git.reviewLayoutTitle": "Макет перегляду",
  "settings.openchamber.git.reviewLayoutAria": "Макет перегляду",
  "settings.openchamber.git.reviewLayout.option.separate": "Окремі подання",
  "settings.openchamber.git.reviewLayout.option.combined": "Поєднані Git і зміни",
  "settings.openchamber.git.reviewLayout.optionAria": "Макет перегляду: {option}",
