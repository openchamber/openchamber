...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.voice.page.localTts.availableToDownload": "Доступні для завантаження",
  "settings.voice.page.localTts.filterPlaceholder": "Фільтр за мовою або описом",
  "settings.voice.page.localTts.filterNoMatch": "Жодна модель не відповідає фільтру",
