export const settingsDict = {
  ...
  "settings.page.harness.title": "Харнеси",
  "settings.page.harness.description": "Обирайте та керуйте харнесами виконання.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.harness.sidebar.title": "Харнеси",
  "settings.harness.sidebar.subtitle": "Бекенди виконання для чат-сесій",
  "settings.harness.sidebar.harness.opencode": "OpenCode",
  "settings.harness.sidebar.harness.claudeCode": "Claude Code",
  "settings.harness.sidebar.status.ready": "Готово",
  "settings.harness.sidebar.status.needsLogin": "Потрібен вхід",
  "settings.harness.sidebar.status.missingCli": "Немає CLI",
  "settings.harness.sidebar.status.unsupportedHost": "Недоступно тут",
  "settings.harness.sidebar.status.error": "Помилка",
  "settings.harness.sidebar.status.unknown": "Невідомо",
  "settings.harness.sidebar.status.loading": "Перевірка…",
  "settings.harness.page.empty.selectHarness": "Виберіть харнес на бічній панелі",
  "settings.harness.page.loadError": "Не вдалося завантажити стан харнеса",
  "settings.harness.opencode.title": "OpenCode",
  "settings.harness.opencode.description": "Типовий харнес. Використовує провайдери та агентів OpenCode.",
  "settings.harness.opencode.section.about": "Про харнес",
  "settings.harness.opencode.about.body": "OpenCode запускає моделі через налаштовані провайдери. Керуйте API-ключами в розділі «Провайдери», а агентами — в «Агенти».",
  "settings.harness.opencode.link.providers": "Відкрити «Провайдери»",
  "settings.harness.opencode.link.agents": "Відкрити «Агенти»",
  "settings.harness.claudeCode.title": "Claude Code",
  "settings.harness.claudeCode.description": "Нативний Claude Code CLI з лімітами підписки.",
  "settings.harness.claudeCode.section.status": "Статус",
  "settings.harness.claudeCode.field.status": "Статус",
  "settings.harness.claudeCode.field.version": "Версія",
  "settings.harness.claudeCode.status.version": "{version}",
  "settings.harness.claudeCode.status.versionUnknown": "Невідома",
  "settings.harness.claudeCode.actions.redetect": "Перевірити знову",
  "settings.harness.claudeCode.actions.redetectAria": "Повторно визначити статус Claude Code",
  "settings.harness.claudeCode.actions.openDocs": "Відкрити документацію",
  "settings.harness.claudeCode.actions.openDocsAria": "Відкрити документацію Claude Code",
  "settings.harness.claudeCode.login.title": "Увійдіть у Claude",
  "settings.harness.claudeCode.login.body": "Встановіть Claude CLI і виконайте claude login на цьому хості, щоб OpenChamber використовував вашу підписку Claude.",
  "settings.harness.claudeCode.section.capabilities": "Можливості",
  "settings.harness.claudeCode.capabilities.empty": "Можливості з’являться після успішного визначення.",
  "settings.harness.claudeCode.capability.full": "Повністю",
  "settings.harness.claudeCode.capability.partial": "Частково",
  "settings.harness.claudeCode.capability.none": "Недоступно",
  "settings.harness.claudeCode.section.agents": "Агенти",
  "settings.harness.claudeCode.agentsMode.label": "Якими агентами користуватися",
  "settings.harness.claudeCode.agentsMode.aria": "Оберіть агентів Claude або OpenCode для сесій Claude Code",
  "settings.harness.claudeCode.agentsMode.info": "Claude використовує власних агентів, промпти та налаштування дозволів. Натомість OpenCode змушує сесії Claude виконуватися від імені вибраного агента OpenCode: його правила дозволів вирішують кожен виклик інструмента, його промпт додається до промпту Claude, а ваші власні субагенти OpenCode стають доступними для Claude. Селектор агента в полі вводу перемикається відповідно.",
  "settings.harness.claudeCode.agentsMode.claude": "Claude",
  "settings.harness.claudeCode.agentsMode.opencode": "OpenCode",
  "settings.harness.claudeCode.section.warnings": "Попередження",
"settings.harness.claudeCode.warnHandoff.label": "Підтверджувати перемикання харнесу",
"settings.harness.claudeCode.warnHandoff.aria": "Підтверджувати перемикання харнесу",
"settings.harness.claudeCode.warnHandoff.info": "Показує діалог перед створенням нової сесії при перемиканні харнесу. Якщо вимкнено, перемикання застосовується тихо з наступним повідомленням.",
  "settings.harness.claudeCode.section.import": "Імпорт",
  "settings.harness.claudeCode.import.note": "Імпортуйте локальні проєкти та чати Claude Code в OpenChamber. Чати відновлюються в Claude Code; транскрипти не копіюються в історію OpenCode.",
  "settings.harness.claudeCode.import.actions.open": "Імпортувати з Claude Code",
  "settings.harness.claudeCode.import.actions.openAria": "Відкрити діалог імпорту Claude Code",
  "settings.harness.claudeCode.import.dialog.title": "Імпорт з Claude Code",
  "settings.harness.claudeCode.import.dialog.description": "Виберіть чати з папки проєктів Claude Code на цьому хості. Вже імпортовані чати буде пропущено.",
  "settings.harness.claudeCode.import.dialog.loading": "Сканування проєктів Claude Code…",
  "settings.harness.claudeCode.import.dialog.empty": "На цьому хості не знайдено чатів Claude Code.",
  "settings.harness.claudeCode.import.dialog.selectAll": "Вибрати всі",
  "settings.harness.claudeCode.import.dialog.selectAllAria": "Вибрати всі чати Claude Code, доступні для імпорту",
  "settings.harness.claudeCode.import.dialog.selectedCount": "Вибрано: {count}",
  "settings.harness.claudeCode.import.dialog.projectAria": "Вибрати всі чати в {name}",
  "settings.harness.claudeCode.import.dialog.sessionAria": "Вибрати чат {title}",
  "settings.harness.claudeCode.import.dialog.sessionCount": "Чатів: {count}",
  "settings.harness.claudeCode.import.dialog.directoryMissing": "Папку не знайдено",
  "settings.harness.claudeCode.import.dialog.alreadyImported": "Уже імпортовано",
  "settings.harness.claudeCode.import.dialog.untitled": "Чат без назви",
  "settings.harness.claudeCode.import.dialog.cancel": "Скасувати",
  "settings.harness.claudeCode.import.dialog.import": "Імпортувати ({count})",
  "settings.harness.claudeCode.import.dialog.importing": "Імпортування…",
  "settings.harness.claudeCode.import.error.load": "Не вдалося просканувати проєкти Claude Code.",
  "settings.harness.claudeCode.import.error.import": "Імпорт не вдався.",
  "settings.harness.claudeCode.import.toast.success": "Імпортовано чатів Claude Code: {count}.",
  "settings.harness.claudeCode.import.toast.skippedOnly": "Пропущено вже імпортованих чатів: {count}.",
  "settings.harness.claudeCode.import.toast.partialFail": "Імпортовано: {imported}; помилок: {failed}.",
  "settings.harness.claudeCode.import.toast.none": "Нічого не імпортовано.",
  "settings.harness.claudeCode.section.apiKeys": "API-ключі",
  "settings.harness.claudeCode.apiKeys.note": "API-ключі Anthropic залишаються в «Провайдерах» OpenCode. Claude Code використовує вхід за підпискою Claude на хості.",
  "settings.harness.capability.prompt": "Запит",
  "settings.harness.capability.abort": "Переривання",
  "settings.harness.capability.resume": "Продовження",
  "settings.harness.capability.streaming-text": "Потоковий текст",
  "settings.harness.capability.streaming-tools": "Потокові інструменти",
  "settings.harness.capability.permissions": "Дозволи",
  "settings.harness.capability.images": "Зображення",
  "settings.harness.capability.file-attachments": "Файлові вкладення",
  "settings.harness.capability.shell": "Shell",
  "settings.harness.capability.slash-commands": "Slash-команди",
  "settings.harness.capability.mcp": "MCP",
  "settings.harness.capability.subagents": "Субагенти",
  "settings.harness.capability.multirun": "MultiRun",
  "settings.harness.capability.goal": "Режим Goal",
  "settings.harness.capability.openchamber-tool": "Інструмент OpenChamber",
