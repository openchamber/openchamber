...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.worktrees.start.label": "Команди запуску",
  "settings.openchamber.worktrees.start.commandPlaceholder": "напр., ./scripts/run.sh",
  "settings.openchamber.worktrees.start.addCommand": "Додати команду",
  "settings.openchamber.worktrees.start.removeCommandAria": "Видалити команду",
  "settings.openchamber.worktrees.start.toast.saveFailed": "Не вдалося зберегти команди запуску",
  "settings.openchamber.worktrees.shutdown.label": "Команди завершення",
  "settings.openchamber.worktrees.shutdown.commandPlaceholder": "напр., ./scripts/stop.sh",
  "settings.openchamber.worktrees.shutdown.addCommand": "Додати команду",
  "settings.openchamber.worktrees.shutdown.removeCommandAria": "Видалити команду",
  "settings.openchamber.worktrees.shutdown.toast.saveFailed": "Не вдалося зберегти команди завершення",
  "settings.openchamber.worktrees.commands.runStartAria": "Запустити команди запуску для {name}",
  "settings.openchamber.worktrees.commands.runShutdownAria": "Запустити команди завершення для {name}",
  "settings.openchamber.worktrees.commands.viewSetupLogAria": "Переглянути вивід налаштування для {name}",
  "settings.openchamber.worktrees.commands.noCommands": "Для цього проєкту не налаштовано {kind}.",
  "settings.openchamber.worktrees.commands.dialogTitleStart": "Команди запуску — {name}",
  "settings.openchamber.worktrees.commands.dialogTitleShutdown": "Команди завершення — {name}",
  "settings.openchamber.worktrees.commands.dialogTitleSetup": "Вивід налаштування — {name}",
  "settings.openchamber.worktrees.commands.dialogRunning": "Виконання...",
  "settings.openchamber.worktrees.commands.dialogFailed": "Команда завершилася помилкою",
  "settings.openchamber.worktrees.commands.dialogTimedOut": "Команда перевищила ліміт часу — показано частковий вивід.",
  "settings.openchamber.worktrees.commands.dialogEmptyOutput": "Немає виводу.",
  "settings.openchamber.worktrees.commands.dialogClose": "Закрити",
