...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.messageSpeedMetrics': 'Afficher les métriques de vitesse de réponse',
  'settings.openchamber.visual.field.messageSpeedMetricsAria': 'Afficher les métriques de vitesse sous les réponses terminées',
  'settings.openchamber.visual.field.messageSpeedMetricsInfo': 'Affiche le TTFT (temps jusqu’au premier token) et les tokens de sortie par seconde sous les réponses terminées. Utile pour comparer les fournisseurs et les relais.',
