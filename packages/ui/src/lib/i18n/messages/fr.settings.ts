...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Ajouter un appareil',
  ...
  'settings.voice.page.field.ttsChunkedMode': 'Mode TTS par morceaux',
  'settings.voice.page.field.ttsChunkedModeAria': 'Mode TTS par morceaux',
  'settings.voice.page.tooltip.ttsChunked': 'Découpe les textes longs en phrases et lit chacune dès qu’elle est synthétisée, pour que la lecture démarre bien plus tôt. Désactivez pour synthétiser tout le texte en une seule requête.',
