...
export const settingsDict = {
  ...
  'settings.providers.sidebar.actions.reorderProviderTitle': 'Glisser pour réordonner les fournisseurs',
  'settings.providers.sidebar.actions.reorderProviderAria': 'Réordonner le fournisseur',
  'settings.providers.sidebar.actions.enableProvider': 'Activer',
  'settings.providers.sidebar.section.disabled': 'Désactivés',
  ...
  'settings.providers.page.actions.disableProvider': 'Désactiver',
  'settings.providers.page.actions.enableProvider': 'Activer',
  'settings.providers.page.badge.disabled': 'Désactivé',
  'settings.providers.page.badge.disabledHint': 'Masqué des sélecteurs de modèles jusqu’à activation.',
