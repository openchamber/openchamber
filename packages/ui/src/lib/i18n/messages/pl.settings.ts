export const settingsDict = {
  ...
  'settings.agents.sidebar.error.description': 'Backend OpenCode niedostępny. Sprawdź połączenie i spróbuj ponownie.',
  'settings.agents.sidebar.error.retry': 'Spróbuj ponownie',
  'settings.agents.sidebar.error.title': 'Nie udało się wczytać agentów',
