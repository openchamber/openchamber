export const settingsDict = {
  ...
  'settings.openchamber.visual.field.showMessageSpeedMetrics': 'Pokaż metryki szybkości wiadomości',
  'settings.openchamber.visual.field.showMessageSpeedMetricsAria': 'Pokaż metryki szybkości wiadomości',
  'settings.openchamber.visual.field.showMessageSpeedMetricsInfo': 'Pokazuje czas do pierwszego tokena, przepustowość wyjścia oraz podział wejście bez pamięci podręcznej / cache / wyjście przy każdej wiadomości asystenta. Czas do pierwszego tokena jest mierzony na serwerze OpenCode od początku wiadomości do pierwszej części rozumowania lub tekstu.',
