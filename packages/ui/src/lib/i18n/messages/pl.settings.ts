export const settingsDict = {
  ...
  'settings.view.home.cards.agents.description': 'Prompt'y, narzędzia, uprawnienia',
  'settings.view.home.cards.skillsCatalog.title': 'Katalog Skills',
  ...
  'settings.page.skillsCatalog.title': 'Katalog Skills',
