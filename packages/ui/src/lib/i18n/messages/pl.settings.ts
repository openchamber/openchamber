...
export const settingsDict = {
  ...
  'settings.page.fusion.title': 'Fuzja',
  'settings.page.fusion.description': 'Kuratorowane panele modeli dla fuzji modeli.',
  'settings.fusion.empty': 'Brak presetów. Dodaj pierwszy.',
  'settings.fusion.add': 'Dodaj preset',
  'settings.fusion.edit': 'Edytuj',
  'settings.fusion.delete': 'Usuń',
  'settings.fusion.deleteTitle': 'Usuń preset fuzji',
  'settings.fusion.deleteConfirm': 'Usunąć preset {name}?',
  'settings.fusion.dialogTitleNew': 'Nowy preset fuzji',
  'settings.fusion.dialogTitleEdit': 'Edytuj preset fuzji',
  'settings.fusion.dialogDescription': 'Nazwany panel 2-4 modeli.',
  'settings.fusion.nameLabel': 'Nazwa',
  'settings.fusion.descriptionLabel': 'Opis',
  'settings.fusion.modelsLabel': 'Modele ({count}/4)',
  'settings.fusion.modelsHint': 'Wybierz 2-4 modele.',
  'settings.fusion.searchModels': 'Szukaj modeli',
  'settings.fusion.noModelResults': 'Brak modeli pasujących do wyszukiwania.',
  'settings.fusion.save': 'Zapisz',
  'settings.fusion.cancel': 'Anuluj',
  'settings.fusion.loading': 'Wczytywanie…',
  'settings.fusion.loadError': 'Nie udało się wczytać presetów: {error}',
  'settings.fusion.noModels': 'Brak skonfigurowanych modeli dla tego katalogu.',
  'settings.fusion.required': 'Wymagana nazwa + 2-4 modele.',
