...
export const settingsDict = {
  ...
  'settings.gitea.page.title': 'Osobisty token dostępu Gitea / Forgejo',
  'settings.gitea.page.description': 'Wklej osobisty token dostępu Gitea lub Forgejo, aby się połączyć. Ustaw podstawowy adres URL, gdy używasz własnej instancji Gitea lub Forgejo.',
  'settings.gitea.page.tooltip.connectAccount': 'Połącz konto Gitea lub Forgejo, aby korzystać z przepływów pracy dla Issues i Pull Requestów w aplikacji.',
  'settings.gitea.page.accessToken.label': 'Osobisty token dostępu',
  'settings.gitea.page.accessToken.placeholder': 'Wklej swój osobisty token dostępu Gitea',
  'settings.gitea.page.baseUrl.label': 'Podstawowy URL (opcjonalnie)',
  'settings.gitea.page.baseUrl.placeholder': 'https://gitea.example.com',
  'settings.gitea.page.actions.connect': 'Połącz Gitea',
  'settings.gitea.page.actions.disconnect': 'Odłącz',
  'settings.gitea.page.actions.switch': 'Przełącz na',
  'settings.gitea.page.status.notConnected': 'Brak połączenia',
  'settings.gitea.page.label.unknownUser': 'nieznany',
  'settings.gitea.page.label.otherAccounts': 'Inne konta',
  'settings.gitea.page.avatarAlt.withLogin': 'Awatar {login}',
  'settings.gitea.page.avatarAlt.fallback': 'Awatar Gitea',
  'settings.gitea.page.connectedAs': 'Połączono jako',
  'settings.gitea.page.errors.invalidToken': 'Wprowadź prawidłowy osobisty token dostępu Gitea',
  'settings.gitea.page.errors.failed': 'Nie udało się połączyć z Gitea',
  'settings.gitea.page.toast.connected': 'Połączono z Gitea',
  'settings.gitea.page.toast.disconnected': 'Odłączono od Gitea',
  ...
  'settings.magicPrompts.page.group.gitlabPrReview.title': 'Przegląd MR',
  'settings.magicPrompts.page.group.gitlabPrReview.description': 'Prompty używane w przepływie przeglądu MR GitLab: widoczna wiadomość użytkownika + ukryty ładunek instrukcji.',
  'settings.magicPrompts.page.group.gitlabIssueReview.title': 'Przegląd Issue',
  'settings.magicPrompts.page.group.gitlabIssueReview.description': 'Prompty używane w przepływie przeglądu Issue GitLab: widoczna wiadomość użytkownika + ukryty ładunek instrukcji.',
  'settings.magicPrompts.page.group.giteaPrReview.title': 'Przegląd PR',
  'settings.magicPrompts.page.group.giteaPrReview.description': 'Prompty używane w przepływie przeglądu PR Gitea: widoczna wiadomość użytkownika + ukryty ładunek instrukcji.',
  'settings.magicPrompts.page.group.giteaIssueReview.title': 'Przegląd Issue',
  'settings.magicPrompts.page.group.giteaIssueReview.description': 'Prompty używane w przepływie przeglądu Issue Gitea: widoczna wiadomość użytkownika + ukryty ładunek instrukcji.',
  ...
  'settings.magicPrompts.sidebar.item.gitlabPrReview': 'Przegląd MR',
  'settings.magicPrompts.sidebar.item.gitlabIssueReview': 'Przegląd Issue',
  'settings.magicPrompts.sidebar.item.giteaPrReview': 'Przegląd PR',
  'settings.magicPrompts.sidebar.item.giteaIssueReview': 'Przegląd Issue',
