export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Skopiuj ID z adresu panelu i cookie auth z narzędzi deweloperskich przeglądarki. Sharpie nigdy nie skanuje plików cookie przeglądarki.',
  ...
  'settings.github.page.flow.title': 'Autoryzuj Sharpie',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Dostępne jako rezerwa, jeśli uwierzytelnienie Sharpie zostanie usunięte',
  ...
  'settings.notifications.page.testNotification.body': 'To jest powiadomienie testowe z Sharpie.',
  ...
  'settings.openchamber.about.title': 'O Sharpie',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Uruchamiaj Sharpie przy logowaniu',
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Uruchamiaj Sharpie przy logowaniu',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Pokazuj Sharpie na pasku menu macOS',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Pokazuj Sharpie na pasku menu',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Wymaga ponownego uruchomienia aplikacji. Po wyłączeniu Sharpie nie tworzy elementu paska menu ani nie uruchamia aktualizacji sesji, zatwierdzeń i użycia.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Minimalizuj i zamykaj Sharpie do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Minimalizuj i zamykaj do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Utrzymuje Sharpie w zasobniku systemowym, gdy główne okno jest zminimalizowane lub zamknięte.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Utrzymuj komputer aktywny, gdy Sharpie jest uruchomiony',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Utrzymuj komputer aktywny, gdy Sharpie jest uruchomiony',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Sharpie pyta po restarcie, a potem po wygaśnięciu sesji logowania: po 12 godzinach albo po 7 dniach z opcją Zaufaj temu urządzeniu. Zostaw puste, aby wyłączyć logowanie.',
  ...
  'settings.page.appearance.description': 'Dostosuj wygląd i odczucie Sharpie.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Klucze są wysyłane bezpośrednio do OpenCode i nigdy nie są przechowywane przez Sharpie.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Przechowywany w auth OpenCode, nie przez Sharpie. Użyj {env:VAR_NAME}, aby odczytać klucz ze zmiennej środowiskowej.',
  ...
  'settings.remoteInstances.page.description': 'Połącz się z inną maszyną przez SSH i otwórz tam Sharpie.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'Jak Sharpie ma zostać umieszczony na zdalnej maszynie, gdy aplikacja uruchamia go za Ciebie.',
  ...
  'settings.remoteInstances.page.field.keepServerRunningHint': 'Pozostaw Sharpie uruchomiony na zdalnej maszynie po rozłączeniu.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Wybierz, czy Sharpie ma uruchomić serwer za Ciebie, czy połączyć się z już działającym.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Instalowanie Sharpie',
  ...
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Aktualizowanie Sharpie',
  ...
  'settings.remoteInstances.page.section.authenticationDescription': 'Opcjonalne dane logowania dla SSH i zdalnego interfejsu Sharpie.',
  ...
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Wybierz lokalny adres używany do otwierania tego zdalnego serwera Sharpie.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'Sharpie na zdalnej maszynie',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Wybierz, jak Sharpie ma działać po połączeniu SSH.',
  ...
  'settings.remoteInstances.direct.title': 'Inne serwery Sharpie',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Dodaj inny serwer Sharpie przez URL. Użyj tego, gdy serwer już działa i masz token połączenia.',
  ...
  'settings.remoteInstances.direct.import.description': 'Wklej link połączenia z innego serwera Sharpie.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Nieprawidłowy link połączenia Sharpie.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Utwórz bezpieczny link lub token, aby Sharpie Desktop mógł połączyć się z tym serwerem.',
  ...
  'settings.remoteInstances.clientAuth.qrAlt': 'Kod QR połączenia Sharpie',
  'settings.remoteInstances.clientAuth.qrEnlarge': 'Powiększ kod QR',
  'settings.remoteInstances.clientAuth.qrScanHint': 'Zeskanuj to aplikacją Sharpie na drugim urządzeniu. Jednorazowy i wygasa.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Działa w domu i poza nim. Poza domem ruch przechodzi przez Sharpie Private Relay — szyfrowany end-to-end tunel. Bez konfiguracji.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Zeskanuj ten kod QR aplikacją Sharpie na drugim urządzeniu.',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Dodaj repozytorium Git jako nowe źródło katalogu. Sharpie przeskanuje je w poszukiwaniu folderów zawierających',
  ...
  'settings.voice.page.tooltip.sttLocal': 'Transkrypcja lokalna na serwerze Sharpie. Modele pobierają się automatycznie; klucz API nie jest potrzebny.',
  'settings.voice.page.tooltip.localTts': 'Lokalna synteza na serwerze Sharpie (Kokoro, angielski). Model pobiera się automatycznie; klucz API nie jest potrzebny.',
  ...
  'settings.window.description': 'Okno ustawień Sharpie.',
