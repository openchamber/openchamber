...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  "settings.page.analytics.title": "Analityka",
  "settings.analytics.scope.project": "Ten projekt",
  "settings.analytics.scope.all": "Wszystkie projekty",
  "settings.analytics.period.groupLabel": "Zakres czasu",
  "settings.analytics.period.7d": "7 dni",
  "settings.analytics.period.30d": "30 dni",
  "settings.analytics.period.90d": "90 dni",
  "settings.analytics.period.all": "Cały okres",
  "settings.analytics.action.refresh": "Odśwież",
  "settings.analytics.state.errorTitle": "Nie udało się załadować analityki",
  "settings.analytics.state.empty": "Brak danych sesji dla wybranego zakresu",
  "settings.analytics.kpi.sectionTitle": "Przegląd",
  "settings.analytics.kpi.tokens": "Tokeny",
  "settings.analytics.kpi.cost": "Koszt",
  "settings.analytics.kpi.sessions": "Sesje",
  "settings.analytics.kpi.activeDays": "Aktywne dni",
  "settings.analytics.kpi.streak": "Seria dni",
  "settings.analytics.quota.title": "Limity dostawców",
  "settings.analytics.quota.none": "Brak skonfigurowanych dostawców",
  "settings.analytics.quota.manage": "Zarządzaj limitami",
  "settings.analytics.topSessions.title": "Największe sesje",
  "settings.analytics.topSessions.open": "Otwórz sesję",
  "settings.analytics.topSessions.empty": "Brak sesji w wybranym zakresie",
  "settings.analytics.tab.trends": "Trendy",
  "settings.analytics.kpi.deltaUp": "↑ {value}% vs poprzedni okres",
  "settings.analytics.kpi.deltaDown": "↓ {value}% vs poprzedni okres",
  "settings.analytics.kpi.deltaNew": "Nowe",
  "settings.analytics.kpi.deltaFlat": "—",
  "settings.analytics.kpi.cacheHitRate": "Skuteczność pamięci podręcznej",
  "settings.analytics.trends.metric.tokens": "Tokeny",
  "settings.analytics.trends.metric.cost": "Koszt",
  "settings.analytics.trends.metric.sessions": "Sesje",
  "settings.analytics.trends.tokenBreakdown.title": "Podział tokenów",
  "settings.analytics.trends.tokenBreakdown.ariaLabel":
      "Podział tokenów w czasie",
  "settings.analytics.trends.tokenBreakdown.prompt": "Prompt",
  "settings.analytics.trends.tokenBreakdown.completion": "Uzupełnienie",
  "settings.analytics.trends.tokenBreakdown.reasoning": "Rozumowanie",
  "settings.analytics.trends.tokenBreakdown.cached": "Z pamięci podręcznej",
  "settings.analytics.trends.cache.title": "Pamięć podręczna promptów",
  "settings.analytics.trends.cache.ariaLabel":
      "Pamięć podręczna promptów w czasie",
  "settings.analytics.trends.cache.cached": "Z pamięci podręcznej",
  "settings.analytics.trends.cache.uncached": "Bez pamięci podręcznej",
  "settings.analytics.trends.byModel.other": "Inne",
  "settings.analytics.yearHeatmap.title": "Aktywność",
  "settings.analytics.yearHeatmap.less": "Mniej",
  "settings.analytics.yearHeatmap.more": "Więcej",
  "settings.analytics.summary.title": "Podsumowanie użycia",
  "settings.analytics.summary.dailyByModel": "Dziennie · wg modelu",
  "settings.analytics.summary.topModels": "Najpopularniejsze modele",
  "settings.analytics.summary.view.daily": "Dziennie",
  "settings.analytics.summary.view.total": "Razem",
  "settings.analytics.summary.view.aria": "Widok",
  "settings.analytics.summary.chartToggleAria": "Przełącz między wykresem słupkowym a liniowym",
  "settings.analytics.summary.chartType.bar": "Wykres słupkowy",
  "settings.analytics.summary.chartType.line": "Wykres liniowy",
  "settings.analytics.activity.longestStreak": "Najdłuższa seria",
  "settings.analytics.activity.avgPerDay": "Śr. / dzień",
  "settings.analytics.activity.avgPerWeek": "Śr. / tydzień",
  "settings.analytics.activity.total": "Razem",
  "settings.analytics.activity.days": "dni",
  "settings.analytics.chart.sessionsPerDay": "Sesje dziennie",
  "settings.analytics.chart.costPerDay": "Koszt dziennie",
  "settings.analytics.efficiency.title": "Wydajność",
  "settings.analytics.efficiency.costPerMillion": "$ / 1 mln tokenów",
  "settings.analytics.efficiency.costPerSession": "Koszt / sesja",
  "settings.analytics.efficiency.tokensPerSession": "Tokeny / sesja",
  "settings.analytics.efficiency.reasoningShare": "Udział rozumowania",
  "settings.analytics.efficiency.avgDuration": "Śr. czas trwania",
  "settings.analytics.efficiency.medianDuration": "Mediana czasu trwania",
  "settings.analytics.efficiency.longestDuration": "Najdłuższy czas trwania",
  "settings.analytics.agents.title": "Użycie agentów",
  "settings.analytics.agents.empty": "Brak danych agentów",
  "settings.analytics.rhythm.title": "Rytm aktywności",
  "settings.analytics.rhythm.hoursAria": "Aktywność wg godziny",
};
