export const settingsDict = {
  ...
  'settings.workspaces.export.review': 'Przejrzyj łatkę',
  'settings.workspaces.export.summary': '{files} plików, +{additions} -{deletions}',
  'settings.workspaces.export.patch': 'Łatka obszaru roboczego',
  'settings.workspaces.export.check': 'Sprawdź łatkę',
  'settings.workspaces.export.apply': 'Zastosuj łatkę',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transportLabel': 'Jak łączy się to urządzenie',
  'settings.remoteInstances.clientAuth.addDevice.transport.local': 'Ten komputer',
  'settings.remoteInstances.clientAuth.addDevice.transport.lan': 'Sieć lokalna',
  'settings.remoteInstances.clientAuth.addDevice.transport.relay': 'Prywatny relay',
  'settings.remoteInstances.clientAuth.addDevice.fallback.relay': 'Łącz też przez relay poza tą siecią',
  'settings.remoteInstances.clientAuth.addDevice.fallback.preferLocal': 'Preferuj sieć lokalną, gdy dostępna',
  'settings.remoteInstances.clientAuth.addDevice.create': 'Utwórz link',
