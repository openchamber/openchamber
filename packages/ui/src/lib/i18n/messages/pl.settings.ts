export const settingsDict = {
  ...
  'settings.page.harness.title': 'Harnessy',
  'settings.page.harness.description': 'Wybieraj i zarządzaj harnessami wykonawczymi.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.harness.sidebar.title': 'Harnessy',
  'settings.harness.sidebar.subtitle': 'Backendy wykonania dla sesji czatu',
  'settings.harness.sidebar.harness.opencode': 'OpenCode',
  'settings.harness.sidebar.harness.claudeCode': 'Claude Code',
  'settings.harness.sidebar.status.ready': 'Gotowy',
  'settings.harness.sidebar.status.needsLogin': 'Wymagane logowanie',
  'settings.harness.sidebar.status.missingCli': 'Brak CLI',
  'settings.harness.sidebar.status.unsupportedHost': 'Niedostępny tutaj',
  'settings.harness.sidebar.status.error': 'Błąd',
  'settings.harness.sidebar.status.unknown': 'Nieznany',
  'settings.harness.sidebar.status.loading': 'Sprawdzanie…',
  'settings.harness.page.empty.selectHarness': 'Wybierz harness na pasku bocznym',
  'settings.harness.page.loadError': 'Nie udało się wczytać stanu harnessa',
  'settings.harness.opencode.title': 'OpenCode',
  'settings.harness.opencode.description': 'Domyślny harness. Korzysta z dostawców i agentów OpenCode.',
  'settings.harness.opencode.section.about': 'Informacje',
  'settings.harness.opencode.about.body': 'OpenCode uruchamia modele przez skonfigurowanych dostawców. Kluczami API zarządzaj w Dostawcach, a ustawieniami agentów w Agentach.',
  'settings.harness.opencode.link.providers': 'Otwórz Dostawców',
  'settings.harness.opencode.link.agents': 'Otwórz Agentów',
  'settings.harness.claudeCode.title': 'Claude Code',
  'settings.harness.claudeCode.description': 'Natywne Claude Code CLI z limitami subskrypcji.',
  'settings.harness.claudeCode.section.status': 'Status',
  'settings.harness.claudeCode.field.status': 'Status',
  'settings.harness.claudeCode.field.version': 'Wersja',
  'settings.harness.claudeCode.status.version': '{version}',
  'settings.harness.claudeCode.status.versionUnknown': 'Nieznana',
  'settings.harness.claudeCode.actions.redetect': 'Wykryj ponownie',
  'settings.harness.claudeCode.actions.redetectAria': 'Ponownie wykryj status Claude Code',
  'settings.harness.claudeCode.actions.openDocs': 'Otwórz dokumentację',
  'settings.harness.claudeCode.actions.openDocsAria': 'Otwórz dokumentację Claude Code',
  'settings.harness.claudeCode.login.title': 'Zaloguj się do Claude',
  'settings.harness.claudeCode.login.body': 'Zainstaluj Claude CLI i uruchom claude login na tym hoście, aby OpenChamber korzystał z Twojej subskrypcji Claude.',
  'settings.harness.claudeCode.section.capabilities': 'Możliwości',
  'settings.harness.claudeCode.capabilities.empty': 'Możliwości pojawią się po udanym wykryciu.',
  'settings.harness.claudeCode.capability.full': 'Pełne',
  'settings.harness.claudeCode.capability.partial': 'Częściowe',
  'settings.harness.claudeCode.capability.none': 'Niedostępne',
...
'settings.harness.claudeCode.warnHandoff.label': 'Potwierdzaj przy zmianie harnessu',
'settings.harness.claudeCode.warnHandoff.aria': 'Potwierdzaj przy zmianie harnessu',
'settings.harness.claudeCode.warnHandoff.info': 'Pokazuje okno dialogowe przed rozpoczęciem nowej sesji przy zmianie harnessu. Gdy wyłączone, zmiana stosowana jest po cichu przy następnej wiadomości.',
  'settings.harness.claudeCode.section.import': 'Import',
  'settings.harness.claudeCode.import.note': 'Importuj lokalne projekty i czaty Claude Code do OpenChamber. Czaty są wznawiane w Claude Code; transkrypty nie są kopiowane do historii OpenCode.',
  'settings.harness.claudeCode.import.actions.open': 'Importuj z Claude Code',
  'settings.harness.claudeCode.import.actions.openAria': 'Otwórz okno importu Claude Code',
  'settings.harness.claudeCode.import.dialog.title': 'Importuj z Claude Code',
  'settings.harness.claudeCode.import.dialog.description': 'Wybierz czaty zapisane w folderze projektów Claude Code na tym hoście. Już zaimportowane czaty zostaną pominięte.',
  'settings.harness.claudeCode.import.dialog.loading': 'Skanowanie projektów Claude Code…',
  'settings.harness.claudeCode.import.dialog.empty': 'Nie znaleziono czatów Claude Code na tym hoście.',
  'settings.harness.claudeCode.import.dialog.selectAll': 'Zaznacz wszystko',
  'settings.harness.claudeCode.import.dialog.selectAllAria': 'Zaznacz wszystkie importowalne czaty Claude Code',
  'settings.harness.claudeCode.import.dialog.selectedCount': 'Zaznaczono: {count}',
  'settings.harness.claudeCode.import.dialog.projectAria': 'Zaznacz wszystkie czaty w {name}',
  'settings.harness.claudeCode.import.dialog.sessionAria': 'Zaznacz czat {title}',
  'settings.harness.claudeCode.import.dialog.sessionCount': 'Czaty: {count}',
  'settings.harness.claudeCode.import.dialog.directoryMissing': 'Brak folderu',
  'settings.harness.claudeCode.import.dialog.alreadyImported': 'Już zaimportowano',
  'settings.harness.claudeCode.import.dialog.untitled': 'Czat bez tytułu',
  'settings.harness.claudeCode.import.dialog.cancel': 'Anuluj',
  'settings.harness.claudeCode.import.dialog.import': 'Importuj ({count})',
  'settings.harness.claudeCode.import.dialog.importing': 'Importowanie…',
  'settings.harness.claudeCode.import.error.load': 'Nie udało się zeskanować projektów Claude Code.',
  'settings.harness.claudeCode.import.error.import': 'Import nie powiódł się.',
  'settings.harness.claudeCode.import.toast.success': 'Zaimportowano {count} czatów Claude Code.',
  'settings.harness.claudeCode.import.toast.skippedOnly': 'Pominięto {count} już zaimportowanych czatów.',
  'settings.harness.claudeCode.import.toast.partialFail': 'Zaimportowano: {imported}; nieudane: {failed}.',
  'settings.harness.claudeCode.import.toast.none': 'Nic nie zostało zaimportowane.',
  'settings.harness.claudeCode.section.apiKeys': 'Klucze API',
  'settings.harness.claudeCode.apiKeys.note': 'Klucze API Anthropic pozostają w Dostawcach OpenCode. Claude Code używa logowania subskrypcji Claude na hoście.',
  'settings.harness.capability.prompt': 'Prompt',
  'settings.harness.capability.abort': 'Przerwanie',
  'settings.harness.capability.resume': 'Wznawianie',
  'settings.harness.capability.streaming-text': 'Strumieniowanie tekstu',
  'settings.harness.capability.streaming-tools': 'Strumieniowanie narzędzi',
  'settings.harness.capability.permissions': 'Uprawnienia',
  'settings.harness.capability.images': 'Obrazy',
  'settings.harness.capability.file-attachments': 'Załączniki plików',
  'settings.harness.capability.shell': 'Shell',
  'settings.harness.capability.slash-commands': 'Polecenia slash',
  'settings.harness.capability.mcp': 'MCP',
  'settings.harness.capability.subagents': 'Subagenci',
  'settings.harness.capability.multirun': 'MultiRun',
  'settings.harness.capability.goal': 'Tryb Goal',
