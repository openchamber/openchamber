...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.remoteInstances.clientAuth.relayEndpoint.title': 'Serwer Relay',
  'settings.remoteInstances.clientAuth.relayEndpoint.info': 'Punkt końcowy używany dla linków parowania „Z dowolnego miejsca” i dostępu przez Relay. Wskaż samodzielnie hostowany Relay, aby ten ruch pozostawał w Twojej infrastrukturze; działający host Relay natychmiast łączy się ponownie. Wcześniej utworzone linki parowania zachowują pierwotny punkt końcowy.',
  'settings.remoteInstances.clientAuth.relayEndpoint.option.default': 'Domyślny',
  'settings.remoteInstances.clientAuth.relayEndpoint.option.custom': 'Własny',
  'settings.remoteInstances.clientAuth.relayEndpoint.field.placeholder': 'wss://twoj-relay.example/ws',
  'settings.remoteInstances.clientAuth.relayEndpoint.actions.save': 'Zapisz',
  'settings.remoteInstances.clientAuth.relayEndpoint.locked': 'Przypięte przez zmienną środowiskową OPENCHAMBER_RELAY_URL:',
  'settings.remoteInstances.clientAuth.relayEndpoint.error.invalid': 'Wprowadź prawidłowy adres URL WebSocket ws:// lub wss://.',
  'settings.remoteInstances.clientAuth.relayEndpoint.error.saveFailed': 'Nie udało się zapisać adresu URL serwera Relay.',
  'settings.remoteInstances.clientAuth.relayEndpoint.error.loadFailed': 'Nie udało się wczytać konfiguracji serwera Relay.',
  'settings.remoteInstances.clientAuth.relayEndpoint.state.loading': 'Sprawdzanie serwera Relay…',
  'settings.remoteInstances.clientAuth.relayEndpoint.error.locked': 'Punkt końcowy Relay jest przypięty na serwerze przez zmienną środowiskową OPENCHAMBER_RELAY_URL i nie można go tutaj zmienić.',
