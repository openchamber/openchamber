export const settingsDict = {
  ...
  'settings.openchamber.permissionAutoAccept.title': 'Automatyczna akceptacja uprawnień',
  'settings.openchamber.permissionAutoAccept.info': 'Dotyczy wszystkich sesji w tym środowisku uruchomieniowym, chyba że dana sesja jawnie włączy lub wyłączy własną politykę uprawnień. Włączenie od razu obsłuży też oczekujące prośby o uprawnienia.',
  'settings.openchamber.permissionAutoAccept.field.globalLabel': 'Automatycznie zatwierdzaj prośby o uprawnienia dla wszystkich sesji w tym środowisku uruchomieniowym',
  'settings.openchamber.permissionAutoAccept.field.globalAria': 'Automatycznie zatwierdzaj prośby o uprawnienia dla wszystkich sesji w tym środowisku uruchomieniowym',
  'settings.openchamber.permissionAutoAccept.field.globalWarning': 'Bezpieczeństwo: OpenChamber będzie zatwierdzał oczekujące i przyszłe prośby o uprawnienia bez pytania, dopóki sesja jawnie nie nadpisze tej polityki.',
  'settings.openchamber.permissionAutoAccept.dialog.title': 'Włączyć automatyczną akceptację uprawnień dla wszystkich sesji?',
  'settings.openchamber.permissionAutoAccept.dialog.description': 'OpenChamber natychmiast zatwierdzi już oczekujące prośby o uprawnienia i będzie dalej zatwierdzał nowe w tym środowisku uruchomieniowym, dopóki sesja jawnie nie nadpisze tej polityki. Włączaj to tylko w zaufanym środowisku.',
  'settings.openchamber.permissionAutoAccept.dialog.confirm': 'Włącz automatyczną akceptację',
  ...
  'settings.page.sessions.description': 'Ustaw domyślne opcje sesji, obsługę uprawnień i retencję.',
