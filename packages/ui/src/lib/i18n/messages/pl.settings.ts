...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.messageSpeedMetrics': 'Pokazuj metryki szybkości odpowiedzi',
  'settings.openchamber.visual.field.messageSpeedMetricsAria': 'Pokazuj metryki szybkości pod ukończonymi odpowiedziami',
  'settings.openchamber.visual.field.messageSpeedMetricsInfo': 'Pokazuje TTFT (czas do pierwszego tokena) i tokeny wyjściowe na sekundę pod ukończonymi odpowiedziami. Przydatne do porównywania dostawców i relayów.',
