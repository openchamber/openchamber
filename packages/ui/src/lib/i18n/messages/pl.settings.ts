...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.engines.claudeCode.section.agents': 'Agenci',
  'settings.engines.claudeCode.agentsMode.label': 'Agenci do użycia',
  'settings.engines.claudeCode.agentsMode.aria': 'Wybierz agentów Claude lub OpenCode dla sesji Claude Code',
  'settings.engines.claudeCode.agentsMode.info': 'Claude używa natywnych promptów systemowych i uprawnień Claude Code. OpenCode używa agentów OpenChamber do uprawnień i promptów systemowych w sesjach Claude.',
  ...
  'settings.engines.claudeCode.import.note': 'Importuj lokalne projekty i czaty Claude Code do OpenChamber. Czaty są wznawiane w Claude Code; transkrypty nie są kopiowane do historii OpenCode.',
  'settings.engines.claudeCode.import.actions.open': 'Importuj z Claude Code',
  'settings.engines.claudeCode.import.actions.openAria': 'Otwórz okno importu Claude Code',
  'settings.engines.claudeCode.import.dialog.title': 'Importuj z Claude Code',
  'settings.engines.claudeCode.import.dialog.description': 'Wybierz czaty zapisane w folderze projektów Claude Code na tym hoście. Już zaimportowane czaty zostaną pominięte.',
  'settings.engines.claudeCode.import.dialog.loading': 'Skanowanie projektów Claude Code…',
  'settings.engines.claudeCode.import.dialog.empty': 'Nie znaleziono czatów Claude Code na tym hoście.',
  'settings.engines.claudeCode.import.dialog.selectAll': 'Zaznacz wszystko',
  'settings.engines.claudeCode.import.dialog.selectAllAria': 'Zaznacz wszystkie importowalne czaty Claude Code',
  'settings.engines.claudeCode.import.dialog.selectedCount': 'Zaznaczono: {count}',
  'settings.engines.claudeCode.import.dialog.projectAria': 'Zaznacz wszystkie czaty w {name}',
  'settings.engines.claudeCode.import.dialog.sessionAria': 'Zaznacz czat {title}',
  'settings.engines.claudeCode.import.dialog.sessionCount': 'Czaty: {count}',
  'settings.engines.claudeCode.import.dialog.directoryMissing': 'Brak folderu',
  'settings.engines.claudeCode.import.dialog.alreadyImported': 'Już zaimportowano',
  'settings.engines.claudeCode.import.dialog.untitled': 'Czat bez tytułu',
  'settings.engines.claudeCode.import.dialog.cancel': 'Anuluj',
  'settings.engines.claudeCode.import.dialog.import': 'Importuj ({count})',
  'settings.engines.claudeCode.import.dialog.importing': 'Importowanie…',
  'settings.engines.claudeCode.import.error.load': 'Nie udało się zeskanować projektów Claude Code.',
  'settings.engines.claudeCode.import.error.import': 'Import nie powiódł się.',
  'settings.engines.claudeCode.import.toast.success': 'Zaimportowano {count} czatów Claude Code.',
  'settings.engines.claudeCode.import.toast.skippedOnly': 'Pominięto {count} już zaimportowanych czatów.',
  'settings.engines.claudeCode.import.toast.partialFail': 'Zaimportowano: {imported}; nieudane: {failed}.',
  'settings.engines.claudeCode.import.toast.none': 'Nic nie zostało zaimportowane.',
