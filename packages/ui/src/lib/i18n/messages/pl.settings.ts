export const settingsDict = {
  ...
  'settings.projects.codexImport.action': 'Importuj rozmowy Codex',
  'settings.projects.codexImport.title': 'Import z Codex',
  'settings.projects.codexImport.description': 'Dodaje projekty Codex i zapisuje każdą rozmowę jako czytelny zapis OpenCode. Dane źródłowe Codex nie zostaną zmienione.',
  'settings.projects.codexImport.loading': 'Odczytywanie projektów i rozmów Codex...',
  'settings.projects.codexImport.error.inspect': 'Nie udało się odczytać danych Codex.',
  'settings.projects.codexImport.error.apply': 'Nie udało się zaimportować danych Codex.',
  'settings.projects.codexImport.config.model': 'Model: {model}',
  'settings.projects.codexImport.config.provider': 'Dostawca: {provider}',
  'settings.projects.codexImport.config.unset': 'Nie ustawiono',
  'settings.projects.codexImport.projects.title': 'Projekty do zaimportowania',
  'settings.projects.codexImport.projects.conversations': 'Rozmowy: {count}',
  'settings.projects.codexImport.projects.missing': 'Katalog nie jest już dostępny',
  'settings.projects.codexImport.empty': 'Nie znaleziono projektów ani rozmów Codex.',
  'settings.projects.codexImport.actions.retry': 'Spróbuj ponownie',
  'settings.projects.codexImport.actions.selectAll': 'Zaznacz wszystko',
  'settings.projects.codexImport.actions.selectNone': 'Odznacz wszystko',
  'settings.projects.codexImport.actions.importing': 'Importowanie...',
  'settings.projects.codexImport.result.summary': 'Zaimportowano: {imported}, pominięto: {skipped}, błędy: {failed}.',
  'settings.projects.codexImport.toast.partial': 'Import Codex zakończony: zaimportowano {imported}, pominięto {skipped}, błędy {failed}.',
  'settings.projects.codexImport.toast.complete': 'Import Codex zakończony: zaimportowano {imported}, już istnieje {skipped}.',
