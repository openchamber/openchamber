export const settingsDict = {
  ...
  'settings.openchamber.tunnel.field.tailscaleHttpsPort': 'Port HTTPS Tailscale',
  'settings.openchamber.tunnel.field.tailscaleHttpsPortDescription': 'Port frontendu Tailscale. Serve akceptuje dowolny port od 1 do 65535; Funnel obsługuje 443, 8443 lub 10000.',
  'settings.openchamber.tunnel.field.tailscaleServeHttpsPortDescription': 'Serve akceptuje każdą liczbę całkowitą od 1 do 65535.',
  'settings.openchamber.tunnel.field.tailscaleFunnelHttpsPortDescription': 'Funnel obsługuje tylko 443, 8443 lub 10000.',
  'settings.openchamber.tunnel.field.tailscaleHttpsPortError': 'Wpisz liczbę całkowitą od 1 do 65535.',
  ...
  'settings.openchamber.tunnel.notAvailable.tailscaleInstallHint': 'Przed uruchomieniem zainstaluj Tailscale i zaloguj się na tym urządzeniu:',
  'settings.openchamber.tunnel.option.mode.privateNetwork.label': 'Tylko tailnet (Serve)',
  'settings.openchamber.tunnel.option.mode.privateNetwork.tooltip': 'Tailscale Serve ogranicza dostęp do Twojego tailnetu.',
  'settings.openchamber.tunnel.option.mode.tailscaleQuick.label': 'Publiczny (Funnel)',
  'settings.openchamber.tunnel.option.mode.tailscaleQuick.tooltip': 'Tailscale Funnel udostępnia tę instancję w publicznym internecie.',
  'settings.openchamber.tunnel.warning.tailscaleFunnelPublic': 'Tailscale Funnel wystawia tę instancję w publicznym internecie. Używaj go tylko wtedy, gdy dostęp publiczny jest zamierzony.',
  'settings.openchamber.tunnel.badge.privateNetwork': 'Tailnet',
  'settings.openchamber.tunnel.toast.startedButNoUrl': 'Tunel został uruchomiony, ale nie zwrócił adresu URL dostępu.',
  'settings.openchamber.tunnel.field.tailnetUrlHint': 'Adres URL tailnetu',
