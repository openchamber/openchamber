export const settingsDict = {
  ...
  'settings.openchamber.worktrees.start.label': 'Polecenia startowe',
  'settings.openchamber.worktrees.start.commandPlaceholder': 'np. ./scripts/run.sh',
  'settings.openchamber.worktrees.start.addCommand': 'Dodaj polecenie',
  'settings.openchamber.worktrees.start.removeCommandAria': 'Usuń polecenie',
  'settings.openchamber.worktrees.start.toast.saveFailed': 'Nie udało się zapisać poleceń startowych',
  'settings.openchamber.worktrees.shutdown.label': 'Polecenia zamykania',
  'settings.openchamber.worktrees.shutdown.commandPlaceholder': 'np. ./scripts/stop.sh',
  'settings.openchamber.worktrees.shutdown.addCommand': 'Dodaj polecenie',
  'settings.openchamber.worktrees.shutdown.removeCommandAria': 'Usuń polecenie',
  'settings.openchamber.worktrees.shutdown.toast.saveFailed': 'Nie udało się zapisać poleceń zamykania',
  'settings.openchamber.worktrees.commands.runStartAria': 'Uruchom polecenia startowe dla {name}',
  'settings.openchamber.worktrees.commands.runShutdownAria': 'Uruchom polecenia zamykania dla {name}',
  'settings.openchamber.worktrees.commands.viewSetupLogAria': 'Zobacz dane wyjściowe konfiguracji dla {name}',
  'settings.openchamber.worktrees.commands.noCommands': 'Brak skonfigurowanych {kind} dla tego projektu.',
  'settings.openchamber.worktrees.commands.dialogTitleStart': 'Polecenia startowe — {name}',
  'settings.openchamber.worktrees.commands.dialogTitleShutdown': 'Polecenia zamykania — {name}',
  'settings.openchamber.worktrees.commands.dialogTitleSetup': 'Dane wyjściowe konfiguracji — {name}',
  'settings.openchamber.worktrees.commands.dialogRunning': 'Uruchamianie...',
  'settings.openchamber.worktrees.commands.dialogFailed': 'Polecenie nie powiodło się',
  'settings.openchamber.worktrees.commands.dialogTimedOut': 'Polecenie przekroczyło limit czasu — pokazano dotychczasowe dane wyjściowe.',
  'settings.openchamber.worktrees.commands.dialogEmptyOutput': 'Brak danych wyjściowych.',
  'settings.openchamber.worktrees.commands.dialogClose': 'Zamknij',
