...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.voice.page.field.ttsChunkedMode': 'Tryb TTS zdanie po zdaniu',
  'settings.voice.page.field.ttsChunkedModeAria': 'Tryb TTS zdanie po zdaniu',
  'settings.voice.page.tooltip.ttsChunked': 'Dzieli długi tekst na zdania i odtwarza każde zaraz po zsyntetyzowaniu, dzięki czemu odtwarzanie zaczyna się znacznie szybciej. Wyłącz, aby zsyntetyzować cały tekst w jednym żądaniu.',
