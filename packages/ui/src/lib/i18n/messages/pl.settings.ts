...
export const settingsDict = {
  ...
  'settings.openchamber.defaults.field.defaultDirectory': 'Domyślny katalog',
  'settings.openchamber.defaults.field.defaultDirectoryHint': 'Nowe sesje startują w tym katalogu, gdy żaden nie został wybrany. Pozostaw puste, aby zachować obecne zachowanie.',
  'settings.openchamber.defaults.field.defaultDirectoryPlaceholder': 'Pozostaw puste, aby użyć bieżącego katalogu',
  'settings.openchamber.defaults.actions.browseDirectory': 'Przeglądaj',
  'settings.openchamber.defaults.actions.browseDirectoryAria': 'Przeglądaj katalog',
