...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'Wklej cookie sesji z ollama.com (poszukaj __Secure-session=... w narzędziach deweloperskich przeglądarki). To nie jest Twój lokalny klucz API ani endpoint Ollama. OpenChamber nigdy nie skanuje plików cookie przeglądarki.',
