...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.contextPanelDock': 'Pozycja panelu kontekstu',
  'settings.openchamber.visual.field.contextPanelDockAria': 'Pozycja panelu kontekstu',
  'settings.openchamber.visual.field.contextPanelDockHint': 'Przenosi cały panel kontekstu, nie tylko terminal: wszystkie powierzchnie (terminal, zmiany, różnice, pliki, notatki) przypinają się do wybranej krawędzi kolumny czatu.',
  'settings.openchamber.visual.option.contextPanelDock.right': 'Prawa',
  'settings.openchamber.visual.option.contextPanelDock.bottom': 'Dół',
