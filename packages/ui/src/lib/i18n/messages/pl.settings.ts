export const settingsDict = {
  ...
  'settings.page.vision.title': 'Wizja',
  'settings.page.vision.description': 'Pozwala modelom, które nie widzą obrazów, opisywać je za pomocą skonfigurowanego modelu wizji.',
  'settings.vision.section.title': 'Narzędzie wizji',
  'settings.vision.section.info': 'Gdy bieżący model nie widzi obrazów, agent może wywołać narzędzie wizji, które odczytuje plik obrazu i prosi skonfigurowany model wizji o jego opis — treść, układ, styl i widoczny tekst. Opis wraca do modelu, aby mógł rozumować o obrazie bez jego widzenia. Każde wywołanie jest rozliczane na wybrany tutaj model wizji.',
  'settings.vision.model.label': 'Model wizji',
  'settings.vision.model.info': 'Model opisujący obrazy dla narzędzia wizji. Na liście znajdują się tylko modele obsługujące dane wejściowe obrazu; modele, których katalog nie może ocenić, pozostają widoczne i są ponownie weryfikowane przez serwer przed każdym uruchomieniem.',
  'settings.vision.model.notSelected': 'Wybierz model wizji',
  'settings.vision.model.required': 'Wybierz model wizji, aby włączyć narzędzie wizji.',
  'settings.vision.prompt.label': 'Prompt opisu',
  'settings.vision.prompt.info': 'Prompt wysyłany z każdym obrazem do modelu wizji. Dobry prompt pyta o treść, układ, styl, kolory i dosłowny tekst, aby model uzyskał pełny obraz. Pozostaw puste, aby użyć wbudowanego domyślnego.',
  'settings.vision.prompt.placeholder': 'Pozostaw puste, aby użyć domyślnego promptu.',
  'settings.vision.prompt.save': 'Zapisz',
  'settings.vision.prompt.reset': 'Przywróć domyślny',
  'settings.vision.toast.saved': 'Zapisano ustawienia wizji',
  'settings.vision.toast.saveFailed': 'Nie udało się zapisać ustawień wizji',
  'settings.vision.toast.loadFailed': 'Nie udało się wczytać ustawień wizji',
