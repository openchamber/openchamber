export const settingsDict = {
  ...
  'settings.providers.copilotGhe.clientIdPlaceholder': 'Pozostaw puste, aby użyć wartości domyślnej',
  'settings.providers.copilotGhe.clientIdHint': 'Pozostaw Client ID puste, aby użyć domyślnej wartości OpenChamber ({clientId}).',
  'settings.providers.copilotGhe.status.authorizationPending': 'Autoryzacja jest nadal oczekująca. Dokończ flow urządzenia w przeglądarce, a następnie ponownie kliknij Zakończ.',
  'settings.providers.copilotGhe.status.slowDown': 'GitHub Enterprise Server poprosił o wolniejsze odpytywanie. Odczekaj chwilę i ponownie kliknij Zakończ.',
  'settings.providers.copilotGhe.toast.serverUrlRequired': 'URL serwera jest wymagany',
  'settings.providers.copilotGhe.toast.startFirst': 'Najpierw uruchom flow urządzenia',
  'settings.providers.copilotGhe.toast.startFailed': 'Nie udało się uruchomić flow uwierzytelniania GitHub Enterprise Server',
  'settings.providers.copilotGhe.toast.completeFailed': 'Nie udało się ukończyć flow uwierzytelniania GitHub Enterprise Server',
  'settings.providers.copilotGhe.toast.authorizationPending': 'Autoryzacja jest nadal oczekująca',
  'settings.providers.copilotGhe.toast.slowDown': 'GitHub Enterprise Server zażądał spowolnienia',
  'settings.providers.copilotGhe.toast.connected': 'Połączono z GitHub Enterprise Server',
