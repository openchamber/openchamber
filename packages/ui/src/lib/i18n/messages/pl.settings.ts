export const settingsDict = {
  ...
  'settings.openchamber.scrollBehavior.title': 'Pozycja przewijania',
  'settings.openchamber.scrollBehavior.description': 'Wybierz, gdzie sesja zostanie ponownie otwarta po powrocie do niej. Wartość domyślna to przywrócenie poprzedniej pozycji.',
  'settings.openchamber.scrollBehavior.option.restore.label': 'Przywróć poprzednią pozycję',
  'settings.openchamber.scrollBehavior.option.jumpToEnd.label': 'Zawsze przewiń na koniec',
  'settings.openchamber.scrollBehavior.sectionAria': 'Zachowanie przewijania sesji przy przełączaniu',
  'settings.openchamber.scrollBehavior.field.modeAria': 'Zachowanie przewijania: {option}',
