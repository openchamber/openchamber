...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.worktreeDiscovery': 'Automatycznie wykrywaj worktree Git',
  'settings.openchamber.visual.field.worktreeDiscoveryAria': 'Przełącz automatyczne wykrywanie worktree Git',
  'settings.openchamber.visual.field.worktreeDiscoveryInfo': 'Po włączeniu pasek boczny wykrywa worktree Git dla aktywnego projektu i projektów z aktywnymi sesjami.',
  'settings.openchamber.visual.field.worktreeDiscoveryInterval': 'Interwał odświeżania wykrywania worktree',
  'settings.openchamber.visual.field.worktreeDiscoveryIntervalAria': 'Wybierz interwał odświeżania wykrywania worktree',
  'settings.openchamber.visual.field.worktreeDiscoveryIntervalInfo': 'Minimalny czas między automatycznymi wykryciami.',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.0': 'Natychmiast',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.30000': '30 sekund',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.60000': '1 minuta',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.300000': '5 minut',
  'settings.openchamber.visual.field.backgroundProjectSessionLoading': 'Ładuj sesje wszystkich projektów w tle',
  'settings.openchamber.visual.field.backgroundProjectSessionLoadingAria': 'Przełącz ładowanie sesji wszystkich projektów w tle',
  'settings.openchamber.visual.field.backgroundProjectSessionLoadingInfo': 'Po włączeniu OpenChamber ładuje dane sesji dla każdego projektu na pasku bocznym.',
