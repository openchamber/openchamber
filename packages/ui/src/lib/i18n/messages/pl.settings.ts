export const settingsDict = {
  ...
  'settings.openchamber.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz linię czasu konwersacji',
  ...
  'settings.openchamber.tunnel.readOnly.title': 'Status tunelu tylko do odczytu',
  'settings.openchamber.tunnel.readOnly.description': 'Zarządzanie tunelem jest dostępne z pulpitu hosta lub uwierzytelnionej sesji przeglądarki.',
  ...
  'settings.openchamber.visual.field.mobileKeyboardModeAria': 'Zachowanie klawiatury mobilnej',
  'settings.openchamber.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz zachowanie klawiatury',
  'settings.openchamber.visual.actions.resetMobileKeyboardModeAria': 'Resetuj zachowanie klawiatury mobilnej',
  ...
  'settings.openchamber.visual.option.mobileKeyboardMode.native.label': 'Podążaj za przeglądarką',
  'settings.openchamber.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki dla przesuwania i zmian rzutni po otwarciu klawiatury.',
  'settings.openchamber.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.openchamber.visual.option.mobileKeyboardMode.resizeContent.description': 'Poproś wspierane przeglądarki o zmniejszenie układu aplikacji zamiast polegania tylko na przesuwaniu.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.remoteInstances.clientAuth.state.viaManagedDirectE2ee': 'Zarządzane bezpośrednie E2EE',
  'settings.remoteInstances.clientAuth.state.connectedManagedDirectE2ee': 'Połączono · Zarządzane bezpośrednie E2EE',
  'settings.remoteInstances.clientAuth.addDevice.transport.managedE2ee': 'Zarządzane bezpośrednie E2EE',
  'settings.remoteInstances.clientAuth.addDevice.transport.managedE2eeHint': 'Zaszyfrowany tunel end-to-end zarządzany przez ten serwer. Administruj z pulpitu hosta lub uwierzytelnionej sesji przeglądarki.',
  ...
  'settings.openchamber.tunnel.field.directE2eeLabel': 'Szyfrowanie end-to-end natywnej aplikacji',
  'settings.openchamber.tunnel.field.directE2eeDescription': 'Ruch przez Cloudflare jest szyfrowany między natywną aplikacją a tym hostem OpenChamber.',
  'settings.openchamber.tunnel.field.directE2eeUnsupported': 'Wymaga wersji klienta obsługującej bezpośrednie E2EE.',
  'settings.openchamber.tunnel.field.nativePairingLabel': 'Parowanie natywnej aplikacji',
  'settings.openchamber.tunnel.field.nativePairingDescription': 'Sparuj natywną aplikację mobilną lub komputerową za pomocą szyfrowania end-to-end.',
  'settings.openchamber.tunnel.actions.openAddDevice': 'Dodaj urządzenie',
  'settings.openchamber.tunnel.field.browserAccessLabel': 'Dostęp przez przeglądarkę',
  'settings.openchamber.tunnel.field.browserQrAlt': 'Kod QR dostępu przez przeglądarkę',
  'settings.openchamber.tunnel.note.scanQrToConnectBrowser': 'Zeskanuj ten kod QR w przeglądarce mobilnej, aby się połączyć.',
  'settings.openchamber.tunnel.toast.directE2eeSaved': 'Zapisano ustawienie bezpośredniego E2EE',
  'settings.openchamber.tunnel.toast.directE2eeSaveFailed': 'Nie udało się zapisać ustawienia bezpośredniego E2EE',
  'settings.remoteInstances.transport.managedE2ee.label': 'Zarządzany tunel (E2EE)',
  'settings.remoteInstances.transport.managedE2ee.description': 'Połącz się bezpiecznie przez zarządzany tunel Cloudflare.',
  'settings.remoteInstances.transport.managedE2ee.note': 'To połączenie wykorzystuje szyfrowanie end-to-end w zarządzanym tunelu.',
};
