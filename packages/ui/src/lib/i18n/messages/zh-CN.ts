...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 Sharpie 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'Sharpie 已安装',
  ...
  'mobile.connect.welcome.title': '连接到 Sharpie',
  ...
  'mobile.connect.password.placeholder': 'Sharpie 密码',
  ...
  'mobile.connect.error.unreachable': '无法连接到该 Sharpie 服务器。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '关于 Sharpie',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此应用连接的 Sharpie 服务器没有响应 walkthrough API，说明它比应用更旧。请将服务器升级到 1.18 或更高版本后刷新。',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 Sharpie 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此文件为二进制文件，无法在 Sharpie 中编辑。请下载后使用其他应用打开。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Sharpie 需要访问此文件夹。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Sharpie 状态、OpenCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 Sharpie',
  ...
  'header.actions.openAppMenu': 'Sharpie 菜单',
  'header.actions.openAppMenuAria': '打开 Sharpie 菜单',
  ...
  'sessionAuth.error.networkDescription': '无法验证 UI 会话。如果你是从本地网络中的另一台设备打开 Sharpie，请在桌面端应用中启用 Desktop Network Access，并使用设置中显示的 LAN 地址。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 Sharpie',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 Sharpie 服务器之间切换',
  ...
  'multiRun.window.description': 'Sharpie 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 Sharpie',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Sharpie 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 Sharpie 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 Sharpie 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 Sharpie 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 Sharpie 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 Sharpie。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 Sharpie，但与此应用版本不兼容。请更新服务器上的 Sharpie 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 Sharpie。请确认地址是否指向 Sharpie 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 Sharpie。请确认地址是否指向 Sharpie 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 Sharpie 服务器与此应用版本不兼容。请更新服务器上的 Sharpie 后重试。',
  ...
  'startup.initRecovery.description': 'Sharpie 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 Sharpie 打开。',
  ...
  'openChamberLogo.aria.logo': 'Sharpie 标志',
