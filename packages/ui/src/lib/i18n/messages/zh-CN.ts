...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'contextPanel.mode.agentBrowser': '代理浏览器',
  'contextRail.surface.agentBrowser.description': '由代理驱动的实时浏览器',
  'agentBrowser.viewport.desktop': '桌面',
  'agentBrowser.viewport.laptop': '笔记本',
  'agentBrowser.viewport.tablet': '平板',
  'agentBrowser.viewport.mobile': '手机',
  'agentBrowser.actions.newTab': '新建标签页',
  'agentBrowser.actions.reload': '重新加载',
  'agentBrowser.actions.go': '前往',
  'agentBrowser.actions.screenshot': '截取屏幕截图',
  'agentBrowser.actions.startRecording': '开始录制',
  'agentBrowser.actions.stopRecording': '停止录制',
  'agentBrowser.recording.active': '录制中',
  'agentBrowser.urlBar.placeholder': '输入要打开的网址',
  'agentBrowser.tab.untitled': '新建标签页',
  'agentBrowser.tab.close': '关闭标签页',
  'agentBrowser.preview.aria': '实时浏览器预览',
  'agentBrowser.preview.waitingFrame': '正在等待第一帧…',
  'agentBrowser.preview.connecting': '正在连接浏览器…',
  'agentBrowser.empty.noTabs': '没有打开的标签页',
  ...
  'agentBrowser.takeover.title': '要接管浏览器吗？',
  'agentBrowser.takeover.description': '代理正在使用浏览器。接管后将停止该代理。',
