...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.mode.stagedDiff': '已暂存差异',
  ...
  'diffView.reviewDialog.description': '为当前更改启动独立的审查会话。',
  'diffView.reviewDialog.generateHandoff': '生成交接内容',
  'diffView.reviewDialog.autoReview': '运行自动审查循环',
  'diffView.reviewDialog.info': '此流程最好在实现更改的会话中启动。',
  'diffView.reviewDialog.actions.cancel': '取消',
  'diffView.reviewDialog.actions.start': '审查',
  'diffView.reviewDialog.actions.starting': '启动中...',
  'diffView.reviewDialog.toast.noSessionDirectory': '会话目录不可用',
  'diffView.reviewDialog.toast.startFailed': '启动审查流程失败',
  ...
  'desktopHostSwitcher.instance.local': '本地',
  ...
  'contextFileOpen.failure.missing': '文件未找到',
  'contextFileOpen.failure.unreadable': '打开文件失败',
  'quota.window.5h': '5 小时',
  'quota.window.7d': '7 天限制',
  'quota.window.7dSonnet': '7 天 Sonnet 限制',
  'quota.window.7dOpus': '7 天 Opus 限制',
  'quota.window.weekly': '每周限制',
  'quota.window.daily': '每日',
  'quota.window.monthly': '每月限制',
  'quota.window.credits': '积分',
  'quota.window.creditsBalance': '积分余额',
