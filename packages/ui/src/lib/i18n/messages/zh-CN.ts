...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.pr.field.headBranch': '源分支',
  ...
  'contextPanel.gitlabMr.createMr.titleLabel': '标题',
  'contextPanel.gitlabMr.createMr.titlePlaceholder': '合并请求标题',
  ...
  'contextPanel.gitlabMr.updateMr.toast.updated': '合并请求已更新',
  'contextPanel.gitlabMr.updateMr.toast.updateFailed': '更新合并请求失败',
  'contextPanel.gitlabMr.mergeMr.action': '合并',
  'contextPanel.gitlabMr.mergeMr.squash': '压缩提交',
  'contextPanel.gitlabMr.mergeMr.merging': '合并中...',
  'contextPanel.gitlabMr.mergeMr.toast.merged': '合并请求已合并',
  'contextPanel.gitlabMr.mergeMr.toast.mergeFailed': '合并请求合并失败',
  ...
  'contextPanel.giteaPr.branchSectionTitle': '当前分支',
  'contextPanel.giteaPr.openPrTitle': '打开的Pull Request',
  'contextPanel.giteaPr.listSectionTitle': '在此仓库中',
  'contextPanel.giteaPr.openPrEmpty': '没有打开的Pull Request',
  'contextPanel.giteaPr.noPrForBranch': '此分支没有Pull Request',
  'contextPanel.giteaPr.loadContext': '加载上下文',
  'contextPanel.giteaPr.hideContext': '隐藏上下文',
  'contextPanel.giteaPr.openInGitea': '在 Gitea 中打开',
  'contextPanel.giteaPr.draft': '草稿',
  'contextPanel.giteaPr.state.opened': '已打开',
  'contextPanel.giteaPr.state.merged': '已合并',
  'contextPanel.giteaPr.state.closed': '已关闭',
  'contextPanel.giteaPr.loadMore': '加载更多',
  'contextPanel.giteaPr.loading': '加载中...',
  'contextPanel.giteaPr.error.loadFailed': '加载Pull Request失败',
  'contextPanel.giteaPr.error.notConnected': 'Gitea 未连接',
  'contextPanel.giteaPr.empty.noActiveProject': '没有活动的项目',
  'contextPanel.giteaPr.actions.openSettings': '打开设置',
  'contextPanel.giteaPr.issues.detail.back': '返回 Issue 列表',
  'contextPanel.giteaPr.issues.detail.commentsEmpty': '暂无评论',
  'contextPanel.giteaPr.issues.empty': '没有打开的 Issue',
  'contextPanel.giteaPr.issues.error.loadFailed': '加载 Issue 失败',
  'contextPanel.giteaPr.issues.listSectionTitle': '打开的 Issue',
  'contextPanel.giteaPr.createPr.title': '新建Pull Request',
  'contextPanel.giteaPr.createPr.sourceBranch': '源分支',
  'contextPanel.giteaPr.createPr.targetBranch': '目标分支',
  'contextPanel.giteaPr.createPr.titleLabel': '标题',
  'contextPanel.giteaPr.createPr.titlePlaceholder': 'Pull Request标题',
  'contextPanel.giteaPr.createPr.descriptionLabel': '描述',
  'contextPanel.giteaPr.createPr.removeSourceBranch': '合并后删除源分支',
  'contextPanel.giteaPr.createPr.submit': '创建Pull Request',
  'contextPanel.giteaPr.createPr.submitting': '创建中...',
  'contextPanel.giteaPr.createPr.branchesLoading': '正在加载分支...',
  'contextPanel.giteaPr.createPr.toast.created': 'Pull Request已创建',
  'contextPanel.giteaPr.createPr.toast.createFailed': '创建Pull Request失败',
  'contextPanel.giteaPr.updatePr.toggle': '编辑标题和描述',
  ...
  'contextPanel.giteaPr.updatePr.toast.updateFailed': '更新Pull Request失败',
  'contextPanel.giteaPr.mergePr.action': '合并',
  'contextPanel.giteaPr.mergePr.squash': '压缩提交',
  'contextPanel.giteaPr.mergePr.merging': '合并中...',
  'contextPanel.giteaPr.mergePr.toast.merged': 'Pull Request已合并',
  'contextPanel.giteaPr.mergePr.toast.mergeFailed': 'Pull Request合并失败',
  ...
  'contextRail.surface.mr.description': '创建、审查并合并当前分支的合并请求',
  ...
  'session.gitlabIssuePicker.searchPlaceholder': '按标题搜索，或粘贴 Issue URL',
  ...
  'session.giteaIssuePicker.error.noActiveProject': '没有活动项目',
  'session.giteaIssuePicker.error.runtimeUnavailable': 'Gitea 运行时 API 不可用',
  'session.giteaIssuePicker.error.notConnected': 'Gitea 未连接',
  'session.giteaIssuePicker.error.repoNotResolvable': '无法解析仓库',
  'session.giteaIssuePicker.error.repoMustBeGitea': 'origin 远程仓库必须是 Gitea URL',
  'session.giteaIssuePicker.error.issueNotFound': '未找到 Issue',
  'session.giteaIssuePicker.error.noModelSelected': '未选择模型',
  'session.giteaIssuePicker.toast.loadMoreFailed': '加载更多 Issue 失败',
  'session.giteaIssuePicker.toast.loadIssueDetailsFailed': '加载 Issue 详情失败',
  'session.giteaIssuePicker.toast.sendContextFailed': '发送 Issue 上下文失败',
  'session.giteaIssuePicker.toast.sessionCreated': '已从 Issue 创建会话',
  'session.giteaIssuePicker.toast.startSessionFailed': '启动会话失败',
  'session.giteaIssuePicker.title.select': '关联 Gitea Issue',
  'session.giteaIssuePicker.title.createSession': '从 Gitea Issue 新建会话',
  'session.giteaIssuePicker.description.select': '选择一个 Issue 关联到当前会话。',
  'session.giteaIssuePicker.description.createSession': '使用隐藏的 Issue 上下文（标题/正文/标签/评论）初始化新会话。',
  'session.giteaIssuePicker.searchPlaceholder': '按标题搜索，或粘贴 Issue URL',
  'session.giteaIssuePicker.empty.noActiveProject': '未选择活动项目。',
  'session.giteaIssuePicker.empty.runtimeUnavailable': 'Gitea 运行时 API 不可用。',
  'session.giteaIssuePicker.empty.notConnected': 'Gitea 未连接。请在设置中连接 Gitea 账号。',
  'session.giteaIssuePicker.empty.noIssuesFound': '未找到 Issue',
  'session.giteaIssuePicker.empty.noOpenIssuesFound': '没有未关闭的 Issue',
  'session.giteaIssuePicker.loading.issues': '正在加载 Issue...',
  'session.giteaIssuePicker.loading.more': '加载中...',
  'session.giteaIssuePicker.actions.openSettings': '打开设置',
  'session.giteaIssuePicker.actions.useIssue': '使用 Issue #{number}',
  'session.giteaIssuePicker.actions.openInGiteaAria': '在 Gitea 中打开',
  'session.giteaIssuePicker.actions.loadMore': '加载更多',
  'session.giteaIssuePicker.actions.sectionTitle': '操作',
  'session.giteaIssuePicker.actions.toggleWorktreeAria': '切换工作树',
  'session.giteaIssuePicker.actions.createInWorktree': '在工作树中创建',
  'session.giteaIssuePicker.actions.openRepo': '打开仓库',
  'session.giteaIssuePicker.actions.refresh': '刷新',
  ...
  'session.gitlabMrPicker.error.mrNotFound': '未找到 Merge Request',
  ...
  'session.gitlabMrPicker.searchPlaceholder': '按标题搜索，或粘贴 Merge Request URL',
  ...
  'session.gitlabMrPicker.empty.noMergeRequestsFound': '未找到 Merge Request',
  'session.gitlabMrPicker.empty.noOpenMergeRequestsFound': '没有未关闭的 Merge Request',
  'session.gitlabMrPicker.loading.mergeRequests': '正在加载 Merge Request...',
  ...
  'session.giteaPrPicker.error.noActiveProject': '没有活动项目',
  'session.giteaPrPicker.error.runtimeUnavailable': 'Gitea 运行时 API 不可用',
  'session.giteaPrPicker.error.notConnected': 'Gitea 未连接',
  'session.giteaPrPicker.error.prNotFound': '未找到 Pull Request',
  'session.giteaPrPicker.error.repoNotResolvable': '无法解析仓库',
  'session.giteaPrPicker.error.repoMustBeGitea': 'origin 远程仓库必须是 Gitea URL',
  'session.giteaPrPicker.toast.loadMoreFailed': '加载更多 Pull Request 失败',
  'session.giteaPrPicker.toast.loadDetailsFailed': '加载 Pull Request 详情失败',
  'session.giteaPrPicker.title': '关联 Gitea Pull Request',
  'session.giteaPrPicker.description': '选择一个 Pull Request，将审查上下文附加到此消息。',
  'session.giteaPrPicker.searchPlaceholder': '按标题搜索，或粘贴 Pull Request URL',
  'session.giteaPrPicker.includeDiffAria': '在附加上下文中包含 PR 差异',
  'session.giteaPrPicker.includeDiff': '包含 PR 差异',
  'session.giteaPrPicker.empty.noActiveProject': '未选择活动项目。',
  'session.giteaPrPicker.empty.runtimeUnavailable': 'Gitea 运行时 API 不可用。',
  'session.giteaPrPicker.empty.notConnected': 'Gitea 未连接。请在设置中连接 Gitea 账号。',
  'session.giteaPrPicker.empty.noPullRequestsFound': '未找到 Pull Request',
  'session.giteaPrPicker.empty.noOpenPullRequestsFound': '没有未关闭的 Pull Request',
  'session.giteaPrPicker.loading.pullRequests': '正在加载 Pull Request...',
  'session.giteaPrPicker.loading.more': '加载中...',
  'session.giteaPrPicker.actions.openSettings': '打开设置',
  'session.giteaPrPicker.actions.usePullRequest': '使用 Pull Request #{number}',
  'session.giteaPrPicker.actions.openInGiteaAria': '在 Gitea 中打开',
  'session.giteaPrPicker.actions.loadMore': '加载更多',
  ...
  'session.newWorktree.actions.startFromGitLabIssueMr': '从 GitLab Issue/MR 开始',
  ...
  'session.newWorktree.toast.sessionFromMr': '已从 Merge Request 创建会话',
  ...
  'session.gitlabIntegration.search.issuesPlaceholder': '搜索 GitLab Issue',
  'session.gitlabIntegration.search.mrsPlaceholder': '搜索 GitLab Merge Request',
  'session.gitlabIntegration.empty.noIssuesFound': '未找到 Issue',
  'session.gitlabIntegration.empty.noMergeRequestsFound': '未找到 Merge Request',
  ...
  'session.giteaIntegration.title': '从 Gitea 选择',
  'session.giteaIntegration.tabs.issues': 'Issues',
  'session.giteaIntegration.tabs.pullRequests': 'Pull Requests',
  'session.giteaIntegration.connect.title': '连接到 Gitea',
  'session.giteaIntegration.connect.description': '关联 Issue 或 Pull Request 以自动填充工作树详情',
  'session.giteaIntegration.connect.action': '连接 Gitea',
  'session.giteaIntegration.search.issuesPlaceholder': '搜索 Gitea Issue',
  'session.giteaIntegration.search.prsPlaceholder': '搜索 Gitea Pull Request',
  'session.giteaIntegration.empty.noIssuesFound': '未找到 Issue',
  'session.giteaIntegration.empty.noPullRequestsFound': '未找到 Pull Request',
  'session.giteaIntegration.actions.loadMore': '加载更多',
  'session.giteaIntegration.actions.cancel': '取消',
  'session.giteaIntegration.actions.select': '选择',
  'session.giteaIntegration.selected.issueNumber': 'Issue #{number}',
  'session.giteaIntegration.selected.prNumber': 'PR #{number}',
  'session.giteaIntegration.includeDiffAria': '在会话上下文中包含 PR 差异',
  'session.giteaIntegration.includeDiff': '包含 PR 差异',
  'session.giteaIntegration.error.notConnected': 'Gitea 未连接',
  'session.giteaIntegration.error.loadDataFailed': '加载数据失败',
  'session.giteaIntegration.validation.branchAlreadyCheckedOut': '该分支已在某个工作树中检出',
  'session.giteaIntegration.validation.branchAlreadyExists': '该分支已在本地存在',
  'session.giteaIntegration.validation.failed': '校验失败',
  ...
  'chat.chatInput.actions.linkGiteaIssue': '关联 Gitea Issue',
  'chat.chatInput.actions.linkGiteaPr': '关联 Gitea PR',
