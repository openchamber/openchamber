...
export const dict: Record<I18nKey, string> = {
  ...
  'desktopHostSwitcher.actions.removeServerAria': '移除服务器',
  'desktopHostSwitcher.actions.removeServer': '移除服务器',
  ...
  'desktopHostSwitcher.toast.sshDisconnected': 'SSH 实例"{host}"已断开',
  'desktopHostSwitcher.toast.instanceUnreachable': '实例“{host}”不可达',
  'server.sidebar.status.connectionError': '连接错误',
  'server.sidebar.status.disconnected': '已断开',
  'server.sidebar.search.searchingServers': '正在搜索 {count} 个服务器',
  'server.sidebar.localLabel': '本地',
