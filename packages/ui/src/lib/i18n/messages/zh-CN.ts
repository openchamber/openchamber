...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.operation.recovery.storage': 'Git 恢复存储不可用。请恢复浏览器存储并刷新。新的修改操作已被阻止。',
  'gitView.operation.recovery.capacity': 'Git 恢复存储已满。请先处理已保存的操作，再开始新操作。',
  'gitView.operation.recovery.reconciling': '正在检查已保存的 Git 操作引用…',
  'gitView.operation.recovery.repository': '无法验证仓库。请在开始其他 Git 操作前刷新。',
  'gitView.operation.recovery.inspect': '如果服务器不再识别此 ID，请在 OpenChamber 外检查本地仓库和远程仓库。保存的引用仍会阻止新操作；状态缺失绝不意味着可以重复传输。',
  'gitView.operation.localCommit': '本地提交已创建并保留。',
  'gitView.operation.unknownHint': '结果未知。开始另一次传输前，请刷新此操作的状态。系统不会自动重复执行。',
  'gitView.operation.refresh': '刷新操作',
  'gitView.operation.cancel': '取消操作',
  'gitView.operation.state.unavailable': '操作状态不可用',
  'gitView.operation.state.planned': '已计划',
  'gitView.operation.state.running': '执行中',
  'gitView.operation.state.succeeded': '成功',
  'gitView.operation.state.partial': '部分完成',
  'gitView.operation.state.failed': '失败',
  'gitView.operation.state.cancelled': '已取消',
  'gitView.operation.state.outcome-unknown': '结果未知',
  'gitView.operation.state.conflicted': '冲突',
  'gitView.operation.state.skipped': '已跳过',
  'gitView.operation.completed.validated': '仓库和目标已验证',
  'gitView.operation.completed.authenticated': '身份验证已完成',
  'gitView.operation.completed.transferred': '传输已完成',
  'gitView.operation.completed.updated-local-repository': '本地仓库已更新',
  'gitView.operation.completed.checked-out': '检出已完成',
  'gitView.operation.completed.cleaned-up': '清理已完成',
  'gitView.remotes.title': '其他远端',
  'gitView.remotes.description': '除了应用身份的那个地址之外，这个仓库还有的地址。在授权之前，OpenChamber 既不从它拉取，也不向它推送。',
  'gitView.remotes.grant': '以 {identity} 的身份应答',
  'gitView.hydration.title': '补全检出内容',
  'gitView.hydration.description': '为每个端点单独授权，以初始化子模块并获取 Git LFS 内容。',
  ...
  'gitView.hydration.kind.submodule': '子模块',
  'gitView.hydration.kind.lfs': 'Git LFS',
  'gitView.hydration.status.succeeded': '已完成',
  'gitView.hydration.status.failed': '失败',
  'gitView.hydration.status.cancelled': '已取消',
  'gitView.hydration.status.authorization-required': '需要授权',
  'gitView.hydration.status.invalid': '配置无效',
  'gitView.hydration.status.client-missing': '缺少客户端',
  'gitView.hydration.status.not-needed': '无需处理',
  'gitView.publish.title': '发布',
  'gitView.publish.commitKept': '本地提交已创建并保留。发布未成功完成。',
  'gitView.publish.syncTitle': '选择同步目标',
  'gitView.publish.description': '将 {branch} 发布到指定的 Git 目标。提供商账户不会决定发布目标。',
  'gitView.publish.fetchSource': '获取来源远程仓库',
  'gitView.publish.sourceBranch': '来源分支',
  'gitView.publish.fetchFirst': '此远程仓库没有缓存的分支。请取消并先执行获取。',
  'gitView.publish.pushDestination': '推送目标远程仓库',
  'gitView.publish.selectRemote': '选择已绑定的远程仓库',
  'gitView.publish.destinationBranch': '目标分支',
  'gitView.publish.noGrants': '发布前请配置 Git 传输绑定。',
  'gitView.publish.contributorCommitFirst': '此贡献者工作树需要在提交后批准目标。是否继续？稍后取消发布仍会保留本地提交。',
  'gitView.publish.detached': '不支持发布游离的 HEAD。请先检出本地分支。',
  'gitView.publish.stale': '分支或 Git 授权已更改。未进行任何重试。请重新选择目标。',
  'gitView.publish.cancelled': '已取消发布。未启动 Git 传输。',
  'gitView.publish.succeeded': '已发布到所选目标',
  ...
  'chat.shellBoundary.status': '未验证 · 在受管边界之外',
  'chat.shellBoundary.agentAria': '代理的 Shell 执行未经验证，且位于受管 Git 边界之外',
  'chat.shellBoundary.userAria': '用户的 Shell 执行未经验证，且位于受管 Git 边界之外',
  ...
  'gitView.context.description': '单靠身份定不下来的事：代理的 shell、仓库的其他地址，以及子模块和 Git LFS 需要的单独授权。身份在 Git 设置里管理。',
  'gitView.context.needsAttention': '需要处理',
  'gitView.identity.system': '系统身份',
  'gitView.identity.systemNoAuthor': '本机未配置提交作者',
  'gitView.identity.configChanged': '应用这个身份之后，仓库的 Git 配置发生了变化。再选一次该身份即可更新。',
  ...
  'gitView.identity.unavailableScheme': '需要 {scheme} 远程仓库',
  ...
  'worktree.bootstrap.toast.authorizationRequired': '请授权检出仓库及其子模块，然后重试。',
  ...
  'gitView.pr.actions.openOnProvider': '在 {provider} 中打开',
  'gitView.pr.actions.openOnProviderAria': '在 {provider} 中打开拉取请求',
  ...
  'gitView.pr.providerNotConnected': '{provider} 未连接',
  ...
  'gitView.pr.capabilitiesUnavailable': '无法加载提供商功能',
  ...
  'gitView.contributor.chooseDestination': '选择此贡献者分支的确切推送目标。',
  'gitView.contributor.destination.contributor-fork': '贡献者分支仓库',
  'gitView.contributor.destination.own-fork': '你的分支仓库',
  'gitView.contributor.destination.bound-repository': '已绑定仓库',
  'gitView.contributor.destination.other': '其他远程仓库',
  'gitView.toast.contributorPublishCancelled': '已取消发布。未更改任何远程仓库。',
  'gitView.toast.contributorPublishCancelledAfterUpdate': '更改已在本地更新，但发布已取消。',
  'gitView.toast.unstageFileFailed': '取消暂存更改失败',
  'gitView.confirm.systemTransport': '系统 Git 可能会使用此计算机上配置的凭据。是否继续此 Git 操作？',
  ...
  'session.changeRequestPicker.error.noProvider': '未找到受支持的源代码管理远程仓库',
  'session.changeRequestPicker.title': '关联变更请求',
  'session.changeRequestPicker.description': '选择一个 Pull Request 或 Merge Request，将审查上下文附加到此消息。',
  'session.changeRequestPicker.searchPlaceholder': '按标题或编号搜索，或粘贴变更请求 URL',
  'session.changeRequestPicker.includeDiffAria': '在附加上下文中包含变更请求差异',
  'session.changeRequestPicker.includeDiff': '包含差异',
  'session.changeRequestPicker.loading.changeRequests': '正在加载变更请求...',
  'session.changeRequestPicker.actions.useChangeRequest': '使用变更请求 {reference}',
  'session.changeRequestPicker.empty.noneFound': '未找到变更请求',
  'session.changeRequestPicker.empty.noneOpen': '没有未关闭的变更请求',
  'session.issuePicker.title': '关联议题',
  'session.issuePicker.description': '选择一个议题，将其上下文附加到此消息。',
  'session.issuePicker.searchPlaceholder': '按标题或编号搜索，或粘贴议题 URL',
  'session.issuePicker.loading.issues': '正在加载议题...',
  'session.issuePicker.actions.useIssue': '使用议题 #{number}',
  'session.issuePicker.empty.noneFound': '未找到议题',
  'session.issuePicker.empty.noneOpen': '没有未关闭的议题',
  ...
  'session.newWorktree.error.changeRequestAuthorityMissing': '变更请求授权已不可用。请重新选择。',
  'session.newWorktree.trust.confirmation': '此检出包含可执行操作：\n\n{actions}\n\n现在运行吗？取消将保留可供 Git 使用的检出，并且不会运行这些操作。',
