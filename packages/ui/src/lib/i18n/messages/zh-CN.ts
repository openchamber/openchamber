...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.actions.enhancePromptAria': '优化提示词',
  'chat.chatInput.actions.enhancePromptCancel': '取消提示词优化',
  ...
  'chat.chatInput.toast.enhanceUnavailable': '没有可用于优化提示词的小型模型。请在 设置 → 会话 → 小型模型 中选择一个。',
  'chat.chatInput.toast.enhanceContextTooSmall': '提示词超出了小型模型的上下文。请缩短它，或改为附加为文件。',
  'chat.chatInput.toast.enhanceEmptyResult': '小型模型返回了空提示词。请重试。',
  'chat.chatInput.toast.enhanceInvalidResult': '优化后的提示词会更改你的 @、/ 或 # 引用。草稿未做更改。',
  'chat.chatInput.toast.enhanceTimedOut': '提示词优化超时。请重试。',
