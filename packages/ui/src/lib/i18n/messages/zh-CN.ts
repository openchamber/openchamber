...
export const dict: Record<I18nKey, string> = {
  ...
  'diffView.state.noBranchChanges': '没有可显示的分支变更',
  'diffView.state.noLastTurnChanges': '没有可显示的上一轮更改',
  'diffView.state.failedToLoadDiff': '加载差异失败',
  'diffView.state.failedToLoadBranchChanges': '加载分支变更失败',
  'diffView.state.loadingDiff': '正在加载差异...',
  'diffView.state.loadingChanges': '正在加载变更...',
  'diffView.state.loadingBranchChanges': '正在加载分支变更...',
  'diffView.state.branchPatchUnavailable': '此文件的分支补丁不可用。',
