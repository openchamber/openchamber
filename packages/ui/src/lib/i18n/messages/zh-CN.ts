...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.toolGroup.context.title.failed': '探索失败',
  'chat.toolGroup.context.summary.readSingle': '{count} 次读取',
  'chat.toolGroup.context.summary.searchSingle': '{count} 次搜索',
  'chat.toolGroup.context.summary.listSingle': '{count} 个目录',
  'chat.toolGroup.context.summary.readPluralFew': '{count} 次读取',
  'chat.toolGroup.context.summary.readPluralMany': '{count} 次读取',
  'chat.toolGroup.context.summary.searchPluralFew': '{count} 次搜索',
  'chat.toolGroup.context.summary.searchPluralMany': '{count} 次搜索',
  'chat.toolGroup.context.summary.listPluralFew': '{count} 个目录',
  'chat.toolGroup.context.summary.listPluralMany': '{count} 个目录',
  'chat.toolGroup.context.child.active': '进行中',
  'chat.toolGroup.context.child.error': '错误',
  'chat.toolGroup.context.child.read': '读取',
  'chat.toolGroup.context.child.search': '搜索',
  'chat.toolGroup.context.child.list': '列表',
  'chat.toolGroup.context.actions.expandWithSummary': '展开上下文工具详情：{summary}',
  'chat.toolGroup.context.actions.collapseWithSummary': '折叠上下文工具详情：{summary}',
  'chat.todo.total': '总计',
