...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.sendMode.queue': '本条消息排队发送',
  'chat.chatInput.sendMode.steer': '本条消息立即发送',
  'chat.chatInput.sendMode.switchToQueue': '将本条消息切换为排队发送',
  'chat.chatInput.sendMode.switchToSteer': '将本条消息切换为立即发送',
