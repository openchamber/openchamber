...
export const dict: Record<I18nKey, string> = {
  ...
  'updateDialog.header.updatingRemote': '正在更新远程实例...',
  'updateDialog.target.desktop.title': '更新 OpenChamber 桌面应用',
  'updateDialog.target.desktop.description': '仅更新此 Windows 应用。WSL 请使用远程实例更新。',
  'updateDialog.target.remote.title': '更新远程实例',
  'updateDialog.target.remote.description': '更新所选的远程实例。',
  ...
  'updateDialog.status.downloadingDesktopPayload': '正在下载桌面应用更新...',
  'updateDialog.actions.downloadUpdate': '下载更新',
  'updateDialog.actions.downloadDesktopUpdate': '下载桌面应用更新',
  'updateDialog.status.downloading': '下载中...',
  'updateDialog.status.downloadingDesktop': '正在下载桌面应用更新...',
  'updateDialog.actions.restartToUpdate': '重启以更新',
  'updateDialog.actions.restartDesktopToUpdate': '重启桌面应用以更新',
