...
export const dict: Record<I18nKey, string> = {
  ...
  'filesView.tree.actions.uploadTitle': '上传文件',
  'filesView.tree.drop.uploadHint': '拖放文件以上传',
  'filesView.toast.uploadSuccess': '已上传 {count} 个文件',
  'filesView.toast.uploadSuccessSingle': '已上传 {name}',
  'filesView.toast.uploadFailed': '上传 {count} 个文件失败',
  'filesView.toast.uploadFailedSingle': '上传 {name} 失败',
