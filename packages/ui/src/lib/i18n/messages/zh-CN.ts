...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.messageBody.footer.totalTime': '总耗时',
  'chat.messageBody.footer.totalTimeAria': '总耗时：{{value}}',
  'chat.messageBody.footer.tps': '每秒令牌数',
  'chat.messageBody.footer.tpsAria': '每秒令牌数：{{value}}',
  'chat.messageBody.footer.ttft': '首个令牌时间',
  'chat.messageBody.footer.ttftAria': '首个令牌时间：{{value}}',
  'chat.messageBody.footer.completedAt': '完成时间',
  'chat.messageBody.footer.completedAtAria': '完成时间：{{value}}',
