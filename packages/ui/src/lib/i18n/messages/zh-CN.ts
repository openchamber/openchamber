...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.engines.capability.goalUnsupported': '目标仅在 OpenCode 上可用。请将此会话切换到 OpenCode 以使用目标。',
  'chat.engines.capability.multirunUnsupported': 'MultiRun 仅在 OpenCode 上可用。请将此会话切换到 OpenCode 以启动 MultiRun。',
