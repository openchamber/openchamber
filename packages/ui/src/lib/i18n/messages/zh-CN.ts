...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.engine.claudeCodeTooltip': '正在 Claude Code 上运行',
  ...
  'gitView.pr.comments.addAll': '全部添加到聊天',
  ...
  'chat.engines.slashUnsupported': '此 OpenCode 斜杠命令在 Claude Code 上不可用。请使用 Claude 原生 /命令，或发送普通消息。',
  'chat.engines.effort.label': '思考强度',
  'chat.engines.effort.default': '默认',
  ...
  'chat.engines.effort.aria': '思考强度：{level}',
  'chat.engines.effort.tooltip': '思考强度：{level}',
  'chat.engines.capability.goalUnsupported': '目标在此引擎上不可用。',
  ...
  'chat.handoff.billingDialog.title': '要在 Claude Code 中继续吗？',
  'chat.handoff.billingDialog.body': '这将使用你的 Claude 订阅用量限额新建一个 Claude Code 会话。OpenCode 的 API 提供方保持不变。对话文本会作为上下文复制；原会话保持不变。',
  'chat.handoff.billingDialog.continue': '继续',
  'chat.handoff.billingDialog.cancel': '取消',
  'chat.handoff.billingDialog.dontShowAgain': '不再显示',
  'chat.handoff.billingDialog.dontShowAgainAria': '不再显示此交接计费提示',
