...
export const dict: Record<I18nKey, string> = {
  ...
  'header.connection.status.connected': '已连接',
  'header.connection.status.connecting': '连接中…',
  'header.connection.status.reconnecting': '重新连接中…',
  'header.connection.actions.retry': '点击重试',
