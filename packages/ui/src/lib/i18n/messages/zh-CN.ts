...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.search.findPlaceholder': '查找',
  'chat.search.findAria': '在聊天中查找',
  'chat.search.replacePlaceholder': '替换',
  'chat.search.replaceAria': '替换文本（聊天中不可用）',
  ...
  'chat.search.nextAria': '下一个匹配项',
  'chat.search.close': '关闭 (Escape)',
  'chat.search.closeAria': '关闭搜索',
  'chat.search.selectAllUnavailable': '聊天搜索中不能选择所有匹配项',
  'chat.search.replaceUnavailable': '聊天搜索中不能替换',
  'chat.search.replaceAllUnavailable': '聊天搜索中不能全部替换',
