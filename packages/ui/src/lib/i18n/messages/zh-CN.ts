...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.toast.messageSendFailed': '消息发送失败，消息和附件已恢复。',
  'chat.chatInput.toast.messageSendMaybeFailed': '消息可能未发送。您的消息已保留 — 请在重试前检查。',
  'chat.chatInput.toast.messageRestoredToInput': '您的消息已恢复到输入框。',
