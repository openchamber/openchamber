...
export const dict: Record<I18nKey, string> = {
  ...
  'dockerInstances.title': 'Docker 实例',
  'dockerInstances.description': '在本机的 Docker 容器中创建并管理 OpenCode 实例。',
  'dockerInstances.state.creating': '创建中',
  'dockerInstances.state.starting': '启动中',
  'dockerInstances.state.probing': '等待就绪',
  'dockerInstances.state.running': '运行中',
  'dockerInstances.state.stopped': '已停止',
  'dockerInstances.state.error': '错误',
  'dockerInstances.state.removing': '移除中',
  'dockerInstances.state.removalFailed': '清理失败',
  'dockerInstances.state.empty': '还没有 Docker 实例。',
  'dockerInstances.state.loadFailed': '无法加载 Docker 实例。',
  'dockerInstances.actions.addDocker': '添加 Docker 实例',
  'dockerInstances.actions.switchAria': '切换到 {name}',
  'dockerInstances.actions.stop': '停止',
  'dockerInstances.actions.start': '启动',
  'dockerInstances.actions.cleanup': '重试清理',
  'dockerInstances.actions.remove': '移除',
  'dockerInstances.actions.confirmRemove': '确认移除',
  'dockerInstances.actions.openAria': '打开 Docker 实例',
  'dockerInstances.create.title': '新建 Docker 实例',
  'dockerInstances.create.description': 'OpenChamber 会创建容器，在容器内启动 OpenCode 并等待其就绪。',
  'dockerInstances.create.field.label': '名称',
  'dockerInstances.create.field.labelPlaceholder': '可选的显示名称',
  'dockerInstances.create.field.image': '镜像',
  'dockerInstances.create.field.workspace': '工作区路径',
  ...
  'dockerInstances.create.sharing.credentialsTitle': '共享凭据',
  'dockerInstances.create.sharing.credentialsHint': '只读，默认关闭。提供方的登录数据在容器内可见。',
  'dockerInstances.create.sharing.neverShared': '绝不共享：Docker socket、SSH 密钥、git 凭据。端口仅绑定到本机。',
  'dockerInstances.create.actions.buildImage': '构建 {image}',
  'dockerInstances.create.actions.cancel': '取消',
  'dockerInstances.create.actions.create': '创建实例',
  'dockerInstances.create.actions.creating': '创建中…',
  'dockerInstances.create.error.generic': '无法创建该实例。',
  'dockerInstances.create.toast.created': 'Docker 实例已创建。',
  'dockerInstances.create.toast.imageBuilt': '镜像 {image} 已就绪。',
  'dockerInstances.toast.activated': '已切换到 {name}。',
  'dockerInstances.toast.deactivated': '已返回本地实例。',
