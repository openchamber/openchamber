...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.message.speed.input': '输入 {value}',
  'chat.message.speed.cacheRead': '缓存 {value}',
  'chat.message.speed.cacheWrite': '缓存写入 {value}',
  'chat.message.speed.output': '输出 {value}',
  'chat.message.speed.reasoning': '推理 {value}',
  'chat.message.speed.aria': '消息速度：首个 token {ttft}，每秒 {throughput} 个 token，未缓存输入 {input}，缓存读取 {cache}，输出 {output}',
