...
export const dict: Record<I18nKey, string> = {
  ...
  'sideChat.label': '一次性',
  'sideChat.promote': '保留',
  'sideChat.promotion.error': '无法保留侧边聊天',
  'sideChat.cleanup.error': '无法删除侧边聊天',
  'sideChat.discard.title': '放弃此侧边聊天？',
  'sideChat.discard.description': '正在进行的工作将停止，此对话将被永久删除。',
  'sideChat.discard.sideEffects': '文件更改、命令和其他工具副作用将会保留。',
  'sideChat.discard.cancel': '保留聊天',
  'sideChat.discard.confirm': '停止并删除',
  'sideChat.recovery.title': '恢复侧边聊天？',
  'sideChat.recovery.description': 'OpenChamber 发现了清理中断后遗留的一次性侧边聊天。',
  'sideChat.recovery.sessionLabel': '侧边聊天 {sessionID}',
  'sideChat.recovery.recover': '恢复',
  'sideChat.recovery.delete': '删除',
  ...
  'chat.commandAutocomplete.command.sideDescription': '打开一次性侧边聊天。除非选择保留，否则关闭时会将其删除。',
  'chat.commandAutocomplete.command.btwDescription': '/side 的别名。在当前对话旁打开一次性聊天。',
