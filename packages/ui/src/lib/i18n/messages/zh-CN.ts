...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 ALIAS ADE 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'ALIAS ADE 已安装',
  ...
  'sessions.sidebar.footer.actions.aboutAliasAde': '关于 ALIAS ADE',
  ...
  'header.services.shutdownDev': '停止 ALIAS ADE',
  ...
  'aboutDialog.diagnosticsDescription': '包含 ALIAS ADE 状态、OpenCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 ALIAS ADE',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 ALIAS ADE',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 ALIAS ADE 服务器之间切换',
  ...
  'multiRun.window.description': 'ALIAS ADE 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 ALIAS ADE',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 ALIAS ADE 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 ALIAS ADE 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 ALIAS ADE 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 ALIAS ADE 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 ALIAS ADE 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 ALIAS ADE。请确认地址是否指向 ALIAS ADE 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 ALIAS ADE。请确认地址是否指向 ALIAS ADE 服务器。',
  ...
  'startup.initRecovery.description': 'ALIAS ADE 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.header.updating': '正在更新 ALIAS ADE...',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：alias-ade update',
  ...
  'aliasAdeLogo.aria.logo': 'ALIAS ADE 标志',
