...
export const dict: Record<I18nKey, string> = {
  ...
  'sidebarFilesTree.toast.searchFailed': '文件搜索失败',
  'sidebarFilesTree.toast.searchTimedOut': '搜索超时；请尝试缩小搜索范围',
  'sidebarFilesTree.search.placeholder': '搜索文件...',
  'sidebarFilesTree.filter.expandTooltip': '切换筛选选项',
  'sidebarFilesTree.filter.showHidden': '显示隐藏文件',
  'sidebarFilesTree.filter.hideHidden': '隐藏隐藏文件',
  'sidebarFilesTree.filter.showGitignored': '包含 Git 忽略的文件',
  'sidebarFilesTree.filter.hideGitignored': '排除 Git 忽略的文件',
  'sidebarFilesTree.filter.extChipRemoveAria': '移除 {ext} 筛选器',
  'sidebarFilesTree.filter.pathChipRemoveAria': '移除 {path} 路径筛选器',
  'sidebarFilesTree.filter.extAutocompleteLabel': '扩展名',
  ...
  'filesView.tree.filter.expandTooltip': '切换筛选选项',
  'filesView.tree.filter.showHidden': '显示隐藏文件',
  'filesView.tree.filter.hideHidden': '隐藏隐藏文件',
  'filesView.tree.filter.showGitignored': '包含 Git 忽略的文件',
  'filesView.tree.filter.hideGitignored': '排除 Git 忽略的文件',
  'filesView.tree.filter.searchFailed': '文件搜索失败',
  'filesView.tree.filter.searchTimedOut': '搜索超时；请尝试缩小搜索范围',
  'filesView.tree.filter.extChipRemoveAria': '移除 {ext} 筛选器',
  'filesView.tree.filter.pathChipRemoveAria': '移除 {path} 路径筛选器',
  'filesView.tree.filter.extAutocompleteLabel': '扩展名',
