...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.modelControls.projectDefaultSaved': '已更新此项目的默认模型',
  'chat.modelControls.projectDefaultSavedDescription': '此项目未来的新聊天将以 {model} 开始。',
  'chat.modelControls.projectDefaultSaveFailed': '更新项目默认模型失败',
  'chat.modelControls.projectDefaultOpenSettings': '项目设置',
  'chat.modelControls.projectDefaultAction': '用于此聊天和此项目未来的新聊天',
  'chat.modelControls.projectDefaultCurrent': '用于此项目的新聊天',
