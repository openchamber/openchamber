...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.group.pagination.prev': '上一页',
  'sessions.sidebar.group.pagination.next': '下一页',
  'sessions.sidebar.group.pagination.page': '第 {current} / {total} 页',
  'sessions.sidebar.group.pagination.subagents': '子代理 {current}/{total}',
  'sessions.sidebar.searching': '正在搜索会话...',
