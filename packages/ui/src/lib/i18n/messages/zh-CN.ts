...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.header.upstreamFetchAria': '获取 {target}',
  'gitView.header.upstreamFetchTooltip': '获取 {target}',
  'gitView.header.upstreamSyncAria': '从 {target} 同步',
  'gitView.header.upstreamSyncTooltip': '先获取，再从 {target} 拉取',
  ...
  'gitView.sync.fetchTrackingTooltip': '获取跟踪分支 {tracking}',
  'gitView.sync.pull': '拉取',
  'gitView.sync.pullTooltip': '拉取更改',
  'gitView.sync.pullTooltipBehind': '拉取更改（落后 {count}）',
  'gitView.sync.pullTrackingTooltip': '从跟踪分支 {tracking} 拉取',
  'gitView.sync.pullTrackingTooltipBehind': '从跟踪分支 {tracking} 拉取（落后 {count}）',
  'gitView.sync.push': '推送',
  'gitView.sync.pushTooltip': '推送更改',
  'gitView.sync.pushTooltipAhead': '推送更改（领先 {count}）',
  'gitView.sync.pushTrackingTooltip': '推送到跟踪分支 {tracking}',
  'gitView.sync.pushTrackingTooltipAhead': '推送到跟踪分支 {tracking}（领先 {count}）',
  'gitView.sync.upstreamFetch': '获取 upstream',
  'gitView.sync.upstreamSync': '同步 upstream',
