...
export const dict: Record<I18nKey, string> = {
  ...
  'header.actions.unstickLatestQuestion': '取消固定最新问题',
  'header.actions.unstickLatestQuestionAria': '从聊天屏幕取消固定最新问题',
  'header.actions.stickLatestQuestion': '固定最新问题',
  'header.actions.stickLatestQuestionAria': '将最新问题固定到聊天屏幕',
  ...
  'chat.mobileStatus.expandPanelAria': '展开会话面板',
  'chat.mobileStatus.collapsePanelAria': '折叠会话面板',
