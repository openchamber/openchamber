...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.pr.actions.reply': '回复',
  'gitView.pr.actions.replyAria': '回复评论',
  ...
  'gitView.pr.actions.addComment': '添加评论',
  ...
  'gitView.pr.placeholder.comment': '为此拉取请求添加评论...',
  ...
  'gitView.pr.toast.commentAdded': '评论已添加',
  ...
  'gitView.pr.toast.replyAdded': '回复已添加',
  'gitView.pr.toast.replyFailed': '添加回复失败',
