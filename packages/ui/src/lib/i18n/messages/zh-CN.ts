...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.notifications.empty': '还没有通知',
  'layout.notifications.emptyFiltered': '没有符合当前筛选的通知',
  'layout.notifications.markAllRead': '全部标为已读',
  'layout.notifications.clearAll': '全部清除',
  'layout.notifications.remove': '移除通知',
  'layout.notifications.sessionSubtaskFinished': '子任务已完成',
  'layout.notifications.sessionSubtaskError': '子任务出错',
  'layout.notifications.openSettings': '通知设置',
  'layout.notifications.unreadCountAria': '{count} 条未读通知',
  'layout.notifications.sessionFinished': '会话已结束',
  'layout.notifications.sessionError': '会话出错',
  'layout.notifications.permissionNeeded': '需要许可',
  'layout.notifications.permissionFallback': '智能体需要你的批准',
  'layout.notifications.inputNeeded': '需要回复',
  'layout.notifications.questionFallback': '智能体正在等待你的回复',
  'layout.notifications.openSession': '打开会话',
  'layout.notifications.occurrenceCount': '×{count}',
  'layout.notifications.time.justNow': '刚刚',
  'layout.notifications.time.minutesAgo': '{count} 分钟',
  'layout.notifications.time.hoursAgo': '{count} 小时',
  'layout.notifications.time.daysAgo': '{count} 天',
  'toast.action.ok': '确定',
  'toast.action.copy': '复制',
