...
export const dict: Record<I18nKey, string> = {
  ...
  'contextSidebar.breakdown.estimateHint': '各段令牌用量为估算值,精确数值由服务端计量。',
  'contextSidebar.breakdown.segment.systemTools': '系统工具',
  'contextSidebar.breakdown.segment.mcpTools': 'MCP 工具',
  'contextSidebar.breakdown.segment.systemPrompt': '系统提示词',
  'contextSidebar.breakdown.segment.skills': '技能',
  'contextSidebar.breakdown.segment.messages': '消息',
  'contextSidebar.breakdown.segment.other': '其他',
  'contextSidebar.section.breakdown': '上下文分解',
