...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.agentCapabilities.fusion.pickerLoadError': '无法加载融合预设。',
  'chat.agentCapabilities.fusion.pickerEmpty': '没有融合预设。请在设置 → 融合中创建一个。',
  'chat.agentCapabilities.fusion.keyboardHint': '↑↓ 导航 • Enter 选择 • Esc 关闭',
  'chat.agentCapabilities.inline.waitingChildren': '正在等待子会话启动…',
