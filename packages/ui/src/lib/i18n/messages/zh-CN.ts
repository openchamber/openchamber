...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.server-browser.description': '在服务器上运行的 Chrome',
  ...
  'contextPanel.browser.newServerTab': '新建服务器浏览器标签页',
  'contextPanel.browser.remote.tabLabel': '服务器浏览器',
  'contextPanel.browser.remote.sessionsMenu': '浏览器会话',
  'contextPanel.browser.remote.savedSessions': '已保存的会话',
  'contextPanel.browser.remote.availableSessions': '运行中的会话',
  'contextPanel.browser.remote.openDevTools': '打开 Chrome DevTools',
  'contextPanel.browser.remote.contextMenuUnavailable': '此次点击无法使用浏览器操作。请使用工具栏或剪贴板按钮。',
  'contextPanel.browser.remote.devTools': 'Chrome DevTools',
  'contextPanel.browser.remote.simpleInspector': '控制台和网络',
  'contextPanel.browser.remote.inspectMode': '检查模式',
  'contextPanel.browser.remote.maximizeInspector': '最大化检查器',
  'contextPanel.browser.remote.restoreInspector': '恢复页面和检查器',
  'contextPanel.browser.remote.resizeInspector': '调整检查器大小',
  'contextPanel.browser.remote.devtoolsLoading': '正在连接 Chrome DevTools…',
  'contextPanel.browser.remote.devtoolsLoadFailed': '无法加载 Chrome DevTools。',
  'contextPanel.browser.remote.devtoolsRetry': '重新连接 DevTools',
  'contextPanel.browser.remote.devtoolsControlLost': '其他查看器已接管控制权。请重新连接以继续检查。',
  'contextPanel.browser.remote.devtoolsConnectionClosed': 'DevTools 连接已关闭。',
  'contextPanel.browser.remote.devtoolsMessageTooLarge': '一条 DevTools 消息超出了大小限制。',
  'contextPanel.browser.remote.devtoolsBackpressure': 'DevTools 无法跟上连接的数据传输速度。请重新连接以继续。',
  'contextPanel.browser.remote.devtoolsInvalidRequest': 'DevTools 连接收到了无效消息。',
  'contextPanel.browser.remote.devtoolsProtocolRejected': '此页面不支持此 DevTools 操作。',
  'contextPanel.browser.remote.devtoolsExclusive': '录制性能数据时，此会话必须是唯一运行中的浏览器会话。',
  'contextPanel.browser.remote.devtoolsStartFailed': '无法为此页面打开 DevTools。',
  'contextPanel.browser.remote.connecting': '正在连接服务器浏览器…',
  'contextPanel.browser.remote.reconnecting': '连接已断开。正在重新连接…',
  'contextPanel.browser.remote.chooseTitle': '服务器浏览器会话',
  'contextPanel.browser.remote.chooseHint': '附加到正在运行的会话，或启动新会话。',
  'contextPanel.browser.remote.newSession': '新会话',
  'contextPanel.browser.remote.noSessions': '此项目没有正在运行的服务器会话。',
  'contextPanel.browser.remote.sessionEphemeral': '代理会话',
  'contextPanel.browser.remote.sessionProject': '项目会话',
  'contextPanel.browser.remote.errorTitle': '服务器浏览器不可用',
  'contextPanel.browser.remote.endedTitle': '此服务器浏览器会话已结束',
  'contextPanel.browser.remote.retry': '重试',
  'contextPanel.browser.remote.canvasAria': '远程页面视图',
  'contextPanel.browser.remote.keyboard': '在页面中输入',
  'contextPanel.browser.remote.textInputAria': '远程页面文本输入',
  'contextPanel.browser.remote.clipboard.copy': '复制',
  'contextPanel.browser.remote.clipboard.paste': '粘贴',
  'contextPanel.browser.remote.clipboard.copied': '已复制到剪贴板',
  'contextPanel.browser.remote.clipboard.pasted': '已粘贴到页面',
  'contextPanel.browser.remote.clipboard.noSelection': '请在页面上选择要复制的文本。',
  'contextPanel.browser.remote.clipboard.copyFailed': '无法复制所选文本。请重试。',
  'contextPanel.browser.remote.clipboard.pasteFailed': '无法粘贴到页面。请重试。',
  'contextPanel.browser.remote.clipboard.tooLarge': '文本过大，无法传输。',
  'contextPanel.browser.remote.clipboard.copyFallbackTitle': '复制所选文本',
  'contextPanel.browser.remote.clipboard.copyFallbackDescription': '无法访问剪贴板。请选择并复制下方文本。',
  'contextPanel.browser.remote.clipboard.copyTextAria': '页面上选中的文本',
  'contextPanel.browser.remote.clipboard.pasteFallbackTitle': '粘贴到页面',
  'contextPanel.browser.remote.clipboard.pasteFallbackDescription': '请在下方粘贴纯文本，然后发送到页面。',
  'contextPanel.browser.remote.clipboard.pasteTextAria': '要粘贴到页面的文本',
  'contextPanel.browser.remote.clipboard.emptyClipboard': '剪贴板中没有纯文本。',
  'contextPanel.browser.remote.clipboard.cancel': '取消',
  'contextPanel.browser.remote.viewport.auto': '自动',
  'contextPanel.browser.remote.viewport.preset': '视口预设',
  'contextPanel.browser.remote.viewport.custom': '自定义',
  'contextPanel.browser.remote.viewport.width': '宽度',
  'contextPanel.browser.remote.viewport.height': '高度',
  'contextPanel.browser.remote.viewport.rotate': '旋转',
  'contextPanel.browser.remote.viewport.mobile': '模拟移动设备',
  'contextPanel.browser.remote.viewport.scale': '显示比例',
  'contextPanel.browser.remote.viewport.pending': '正在应用视口…',
  'contextPanel.browser.remote.viewport.error': '调整视口大小失败：{code}',
  'contextPanel.browser.remote.viewport.agentControlled': '智能体正在控制此视口',
  'contextPanel.browser.remote.viewport.external': '外部 DevTools 正在控制此视口',
  'contextPanel.browser.remote.viewport.dimensionsConfirmed': '已确认：{width} × {height}',
  'contextPanel.browser.remote.inspector.title': '页面检查器',
  'contextPanel.browser.remote.inspector.open': '打开页面检查器',
  'contextPanel.browser.remote.inspector.close': '关闭检查器',
  'contextPanel.browser.remote.inspector.console': '控制台',
  'contextPanel.browser.remote.inspector.network': '网络',
  'contextPanel.browser.remote.inspector.clear': '清空',
  'contextPanel.browser.remote.inspector.filterPlaceholder': '筛选消息或请求',
  'contextPanel.browser.remote.inspector.filterAria': '筛选检查器条目',
  'contextPanel.browser.remote.inspector.capturing': '正在捕获此标签页',
  'contextPanel.browser.remote.inspector.starting': '正在开始捕获',
  'contextPanel.browser.remote.inspector.captureHint': '打开检查器时开始捕获。关闭检查器会清空已捕获的数据。',
  'contextPanel.browser.remote.inspector.dropped': '已省略条目：{count}',
  'contextPanel.browser.remote.inspector.emptyConsole': '控制台消息将显示在这里。',
  'contextPanel.browser.remote.inspector.filteredEmpty': '没有匹配的条目。',
  'contextPanel.browser.remote.inspector.expressionAria': '要在页面中运行的 JavaScript',
  'contextPanel.browser.remote.inspector.expressionPlaceholder': '在页面中运行 JavaScript',
  'contextPanel.browser.remote.inspector.run': '运行',
  'contextPanel.browser.remote.inspector.running': '正在运行',
  'contextPanel.browser.remote.inspector.previousCommand': '上一条命令',
  'contextPanel.browser.remote.inspector.nextCommand': '下一条命令',
  'contextPanel.browser.remote.inspector.shortcutHint': '按 Ctrl/Cmd+Enter 运行。按 Enter 换行。',
  'contextPanel.browser.remote.inspector.truncated': '已截断',
  'contextPanel.browser.remote.inspector.errorUnavailable': '页面检查器不可用。请重新打开后重试。',
  'contextPanel.browser.remote.inspector.errorInvalid': '请输入最多 16,000 个字符的 JavaScript。',
  'contextPanel.browser.remote.inspector.errorCaptureGone': '捕获已结束。请重新打开检查器以重新开始。',
  'contextPanel.browser.remote.inspector.errorEvaluation': '无法运行 JavaScript。请重试。',
  'contextPanel.browser.remote.inspector.errorTimeout': 'JavaScript 已超时。页面可能仍在运行它。',
  'contextPanel.browser.remote.inspector.errorRequestGone': '此请求已不可用。',
  'contextPanel.browser.remote.inspector.errorRequest': '无法加载此请求。请重试。',
  'contextPanel.browser.remote.inspector.errorCapture': '无法开始捕获。请重新打开检查器后重试。',
  'contextPanel.browser.remote.inspector.resultAria': 'JavaScript 结果',
  'contextPanel.browser.remote.inspector.commandAria': '已执行的 JavaScript',
  'contextPanel.browser.remote.inspector.level.debug': '调试',
  'contextPanel.browser.remote.inspector.level.info': '信息',
  'contextPanel.browser.remote.inspector.level.log': '日志',
  'contextPanel.browser.remote.inspector.level.warning': '警告',
  'contextPanel.browser.remote.inspector.level.error': '错误',
  'contextPanel.browser.remote.inspector.network.empty': '尚未捕获请求。',
  'contextPanel.browser.remote.inspector.network.noMatches': '没有请求匹配此筛选条件。',
  'contextPanel.browser.remote.inspector.network.selectRequest': '请选择一个请求以查看详情。',
  'contextPanel.browser.remote.inspector.network.details': '请求详情',
  'contextPanel.browser.remote.inspector.network.closeDetails': '关闭请求详情',
  'contextPanel.browser.remote.inspector.network.loading': '正在加载请求详情',
  'contextPanel.browser.remote.inspector.network.loadBodies': '加载正文',
  'contextPanel.browser.remote.inspector.network.requestHeaders': '请求标头',
  'contextPanel.browser.remote.inspector.network.responseHeaders': '响应标头',
  'contextPanel.browser.remote.inspector.network.requestBody': '请求正文',
  'contextPanel.browser.remote.inspector.network.responseBody': '响应正文',
  'contextPanel.browser.remote.inspector.network.noHeaders': '没有可用的标头。',
  'contextPanel.browser.remote.inspector.network.noBody': '没有可用的正文。',
  'contextPanel.browser.remote.inspector.network.bodiesNotRequested': '正文仅在你请求时加载。',
  'contextPanel.browser.remote.inspector.network.bodiesUnavailable': '此请求的正文已不可用。',
  'contextPanel.browser.remote.inspector.network.bodiesUnsupported': '此响应不支持正文预览。',
  'contextPanel.browser.remote.inspector.network.truncated': '预览已截断。',
  'contextPanel.browser.remote.inspector.network.method': '方法',
  'contextPanel.browser.remote.inspector.network.url': 'URL',
  'contextPanel.browser.remote.inspector.network.status': '状态码',
  'contextPanel.browser.remote.inspector.network.duration': '耗时',
  'contextPanel.browser.remote.inspector.network.size': '已传输',
  'contextPanel.browser.remote.inspector.network.state': '状态',
  'contextPanel.browser.remote.inspector.network.cached': '来自缓存',
  'contextPanel.browser.remote.inspector.network.failure': '错误',
  'contextPanel.browser.remote.inspector.network.resourceType': '类型',
  'contextPanel.browser.remote.inspector.network.mimeType': '内容类型',
  'contextPanel.browser.remote.inspector.network.pending': '等待中',
  'contextPanel.browser.remote.inspector.network.complete': '已完成',
  'contextPanel.browser.remote.inspector.network.failed': '已失败',
  'contextPanel.browser.remote.inspector.network.unknown': '不可用',
  'contextPanel.browser.remote.inspector.network.yes': '是',
  'contextPanel.browser.remote.inspector.network.no': '否',
  'contextPanel.browser.remote.inspector.network.failedDetails': '无法加载请求详情。请重试。',
  'contextPanel.browser.remote.inspector.network.requestGone': '此请求已不可用。',
  'contextPanel.browser.remote.inspector.network.captureGone': '此次捕获已结束。',
  ...
  'contextPanel.browser.agentControlling': '代理正在控制',
