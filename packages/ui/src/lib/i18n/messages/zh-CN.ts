...
export const dict: Record<I18nKey, string> = {
  ...
  'workspace.move.left': '移到左侧',
  'workspace.move.center': '移到中间',
  'workspace.move.right': '移到右侧',
  'workspace.move.bottom': '移到底部',
  'workspace.zone.collapse': '折叠区域',
  'workspace.zone.label.left': '左侧区域',
  'workspace.zone.label.center': '中间区域',
  'workspace.zone.label.right': '右侧区域',
  'workspace.zone.label.bottom': '底部区域',
  'workspace.zone.resize.left': '调整左侧区域大小',
  'workspace.zone.resize.bottom': '调整底部区域大小',
  'workspace.preset.title': '布局',
  'workspace.preset.default': '默认',
  'workspace.preset.developer': '开发者',
  'workspace.preset.codeAgent': '代码 + 智能体',
  'workspace.preset.reset': '重置布局',
};
