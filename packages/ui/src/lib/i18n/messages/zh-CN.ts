...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.dialogs.worktreeDelete.disposition.label': '关联会话',
  'sessions.sidebar.dialogs.worktreeDelete.disposition.archive': '归档关联会话',
  'sessions.sidebar.dialogs.worktreeDelete.disposition.delete': '永久删除关联会话',
  'sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionOneLinked': '这将移除所选工作树并永久删除 {count} 个关联会话。',
  'sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionManyLinked': '这将移除所选工作树并永久删除 {count} 个关联会话。',
