...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.scheduledTasks.dialog.actions.lastRunAria': '打开 {taskName} 的上次运行会话',
  ...
  'sessions.scheduledTasks.editor.lifecycle.title': '生命周期',
  'sessions.scheduledTasks.editor.archiveOnSuccess.label': '归档成功的运行',
  'sessions.scheduledTasks.editor.archiveOnSuccess.aria': '在运行成功后归档会话',
