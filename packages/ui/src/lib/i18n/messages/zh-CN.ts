...
export const dict: Record<I18nKey, string> = {
  ...
  'usage.status.quotaExhausted': '额度已用尽',
  'usage.status.expired': 'API 密钥已过期',
  'usage.statistics.title': '用量统计',
  'usage.statistics.info': '模型统计覆盖最近 30 天。',
  'usage.statistics.requests': '请求数',
  'usage.statistics.inputTokens': '输入 Token',
  'usage.statistics.outputTokens': '输出 Token',
  'usage.statistics.cacheReadTokens': '缓存读取 Token',
  'usage.statistics.totalTokens': '总 Token',
  'usage.statistics.actualCost': '费用',
  'usage.statistics.today': '今日',
  'usage.statistics.total': '总计',
  'usage.statistics.empty': '未上报用量统计。',
