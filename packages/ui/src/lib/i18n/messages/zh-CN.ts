...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.reviewCommentEdit': '编辑评论',
  'chat.chatInput.reviewCommentEditPlaceholder': '编辑你的评论…',
  'chat.chatInput.reviewCommentSave': '保存',
  'chat.message.inlineComment.expand': '显示代码',
  'chat.message.inlineComment.collapse': '隐藏代码',
