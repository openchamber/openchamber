...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.queuedMessage.title': '队列中的消息',
  ...
  'chat.queuedMessage.admissionPending': '正在发送到服务器…',
  'chat.queuedMessage.admitted': '已加入服务器队列 · 可以安全关闭',
  'chat.queuedMessage.localFallback': '本地队列 · 请保持客户端打开',
  'chat.queuedMessage.admissionFailed': '加入队列失败',
  'chat.queuedMessage.admissionUnknown': '结果未知 · 可能造成重复，请勿重试',
  'chat.queuedMessage.retryAdmission': '重试加入队列',
  'chat.queuedMessage.restore': '移至编辑器',
  'chat.queuedMessage.copy': '复制文本',
  'chat.queuedMessage.dismiss': '关闭',
  'chat.queuedMessage.copyFailed': '无法复制消息文本',
  'chat.queuedMessage.selectionLimitation': '服务器入队使用会话当前的模型、代理和变体设置',
