...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.browser.agent.handOff': '将控制权交给智能体',
  'contextPanel.browser.agent.stop': '停止智能体控制',
  'contextPanel.browser.agent.controlling': '智能体正在控制',
  'contextPanel.browser.agent.ready': '已共享给智能体',
  'contextPanel.browser.agent.popOut': '在单独窗口中打开',
  'contextPanel.browser.agent.lastAction': '最近操作：{op}',
  'contextPanel.browser.poppedOut.title': '已在单独窗口中打开浏览器',
  'contextPanel.browser.poppedOut.bringBack': '收回',
  'contextPanel.browser.poppedOut.focus': '聚焦窗口',
