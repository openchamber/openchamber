...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.harness.claudeCodeTooltip': '正在 Claude Code 上运行',
  ...
  'chat.statusRow.retrying': '有可用容量时将重试',
  'chat.statusRow.retryingIn': '将在 {countdown} 后重试',
  'chat.statusRow.retryAttempt': '（第 {attempt} 次尝试）',
  'chat.statusRow.recoveryBlocked': '自动恢复已被阻止。请停止此会话以取消恢复。',
  'chat.chatInput.toast.queueFull': '此会话的后续消息队列已满。你的草稿已保留。',
  'chat.chatInput.toast.queueTargetsFull': '有后续消息排队的会话过多。你的草稿已保留。',
  ...
  'chat.commandAutocomplete.command.claudeNativeDescription': 'Claude Code 命令：/{name}',
  ...
  'chat.modelControls.cacheRead': '缓存读取',
  'chat.modelControls.cacheWrite': '缓存写入',
  'chat.modelControls.costInOutShort': '输入 {input} · 输出 {output}',
  'chat.modelControls.modalityInputAria': '{modality}（输入）',
  'chat.modelControls.modalityOutputAria': '{modality}（输出）',
  ...
  'chat.modelControls.noAgentsFound': '未找到智能体',
  'chat.modelControls.claudeAgents.defaultAgent': 'Claude 默认',
  'chat.modelControls.claudeAgents.empty': '未找到 Claude 智能体',
  ...
  'chat.harness.effort.aria': '思考强度：{level}',
  'chat.harness.effort.tooltip': '思考强度：{level}',
  'chat.harness.capability.goalUnsupported': '目标在此 Harness 上不可用。',
  ...
  'chat.harness.switch.title': '切换到 {harness}？',
  'chat.harness.switch.body': '切换 Harness 将开始一个新会话。当前会话保持不变。',
  'chat.harness.switch.billing': '新会话使用您的 Claude 订阅，而不是 API 计费。',
  'chat.harness.switch.duplicate.title': '复制会话数据',
  'chat.harness.switch.duplicate.description': '将最近的对话作为可见的上下文消息复制到新会话中。',
  'chat.harness.switch.summarize.title': '总结会话',
  'chat.harness.switch.summarize.description': '总结此会话并仅携带摘要。当前会话将被压缩。',
  'chat.harness.switch.optionsAria': '要带入新会话的内容',
  'chat.harness.switch.dontShowAgain': '不再显示',
  'chat.harness.switch.dontShowAgainAria': '不再显示 Harness 切换对话框',
  'chat.harness.switch.cancel': '取消',
  'chat.harness.switch.confirm': '切换 Harness',
  'chat.harness.switch.working': '正在切换…',
  'chat.harness.contextCard.title': '来自上一个会话的上下文',
  'chat.harness.contextCard.expandAria': '展开已转移的上下文',
  'chat.harness.contextCard.collapseAria': '收起已转移的上下文',
