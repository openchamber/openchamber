...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.history.actions.conflictToastDescription': '冲突文件：{files}。请手动解决并提交，或使用操作横幅中的中止按钮。',
  'gitView.history.actions.conflictToastTitle': '冲突',
  'gitView.history.actions.unknownFiles': '未知文件',
  ...
  'gitView.history.actions.resetHard': '重置（硬）',
  'gitView.history.actions.resetHardConfirmButton': '丢弃更改',
  'gitView.history.actions.resetHardDirtyTitle': '丢弃未提交的更改？',
  'gitView.history.actions.resetHardDirtyDescription': '工作树有未提交的更改。硬重置会永久丢弃它们。',
  'gitView.history.actions.resetHardDirtyConfirmButton': '丢弃并重置',
  'gitView.history.actions.resetMixed': '重置（混合）',
  'gitView.history.actions.resetSoft': '重置（软）',
  ...
  'gitView.graph.localBranches': '本地分支',
  'gitView.graph.tags': '标签',
  'gitView.graph.manualSelection': '选择要包含在图谱中的引用。',
  'gitView.graph.incomingChanges': '传入更改',
  'gitView.graph.outgoingChanges': '传出更改',
  'gitView.graph.outdated': '图谱历史已过期，请刷新。',
  'gitView.graph.mergeBaseLookupFailed': '无法比较此图谱的传入和传出更改。',
  'gitView.graph.resizeAria': '调整图谱面板大小',
  'gitView.preview.overlayAnnouncement': '差异预览已打开。按 Escape 关闭。',
  'gitView.preview.resizeAria': '调整差异预览大小',
  'gitView.preview.submodulePointer': '子模块指针',
  'gitView.preview.tooLargeDescription': '此差异为 {totalSize}，已超过 {maxSize} 预览限制。',
  ...
  'gitView.operation.cherryPickInProgress': '精选进行中',
  'gitView.operation.revertInProgress': '还原进行中',
  ...
  'gitView.toast.cherryPickCompleted': '精选完成',
  'gitView.toast.cherryPickAborted': '精选已中止',
  'gitView.toast.cherryPickConflictsDetected': '检测到精选冲突',
  'gitView.toast.revertCompleted': '还原完成',
  'gitView.toast.revertAborted': '还原已中止',
  'gitView.toast.revertConflictsDetected': '检测到还原冲突',
  ...
  'diffView.state.fileUnchangedInScope': '此文件在所选范围内没有更改',
  ...
  'diffView.actions.backToChat': '返回聊天',
  ...
  'gitView.history.actions.createBranchEllipsis': '创建分支…',
  'gitView.history.actions.createTagConfirm': '创建',
  'gitView.history.actions.createTagEllipsis': '创建标签…',
  'gitView.history.actions.createTagPlaceholder': '标签名',
  'gitView.history.actions.checkoutDetached': '检出（分离）',
  'gitView.history.actions.compareWithMergeBase': '与合并基准比较',
  'gitView.history.actions.compareWithRef': '比较…',
  'gitView.history.actions.compareWithRemote': '与远程比较',
  'gitView.history.actions.comparingWith': '正在与 {name} 比较',
  'gitView.history.actions.copyMessage': '复制提交信息',
  'gitView.history.actions.clearComparison': '清除比较',
  'gitView.history.actions.openChanges': '打开更改',
  'gitView.toast.commitMessageCopied': '提交信息已复制',
  'gitView.toast.tagCreated': '已创建标签 {name}',
  'gitView.graph.mergeBaseLabel': '合并基准',
};
