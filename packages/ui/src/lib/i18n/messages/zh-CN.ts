...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.branch.actions.delete': '删除分支',
  'gitView.branch.actions.rename': '重命名分支',
  ...
  'gitView.branch.deleteConfirm': '删除分支',
  'gitView.branch.deleteDialogDescription': '删除本地分支 {branch}？此操作无法撤销。',
  'gitView.branch.deleteDialogTitle': '删除分支',
  'gitView.branch.deleting': '正在删除…',
  ...
  'gitView.branch.renameConfirm': '重命名分支',
  'gitView.branch.renameDialogDescription': '为 {branch} 输入新名称。',
  'gitView.branch.renameDialogTitle': '重命名分支',
  ...
  'gitView.toast.cannotDeleteBranch': '无法删除分支：{reason}',
  ...
  'gitView.toast.deletedBranch': '已删除分支 {branch}',
  'gitView.toast.deleteBranchFailed': '删除 {branch} 失败',
