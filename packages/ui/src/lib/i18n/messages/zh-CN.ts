...
export const dict: Record<I18nKey, string> = {
  ...
  'session.githubIssuePicker.error.searchTimedOut': '搜索超时。请尝试更具体的查询。',
  ...
  'session.githubPrPicker.error.searchTimedOut': '搜索超时。请尝试更具体的查询。',
  ...
  'session.githubIntegration.error.searchTimedOut': '搜索超时。请尝试更具体的查询。',
  'session.githubIntegration.error.repoNotResolvable': '无法解析仓库',
