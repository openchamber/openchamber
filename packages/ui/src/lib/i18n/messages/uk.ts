...
export const dict: Record<I18nKey, string> = {
  ...
  "header.connection.status.connected": "Підключено",
  "header.connection.status.connecting": "Підключення…",
  "header.connection.status.reconnecting": "Повторне підключення…",
  "header.connection.actions.retry": "Натисніть, щоб повторити",
