...
export const dict: Record<I18nKey, string> = {
  ...
  "gitView.sync.pullRebase": "Pull (перебазування)",
  "gitView.sync.pullRebaseBlocked": "Закомітьте або сховайте зміни перед pull",
  ...
  "diffView.change.conflicted": "Файл із конфліктом",
