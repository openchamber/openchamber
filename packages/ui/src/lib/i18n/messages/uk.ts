...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.message.speed.input": "вх {value}",
  "chat.message.speed.cacheRead": "кеш {value}",
  "chat.message.speed.cacheWrite": "запис кешу {value}",
  "chat.message.speed.output": "вих {value}",
  "chat.message.speed.reasoning": "міркування {value}",
  "chat.message.speed.aria": "Швидкість повідомлення: {ttft} до першого токена, {throughput} токенів на секунду, {input} некешованого вводу, {cache} читання кешу, {output} виводу",
