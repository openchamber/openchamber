...
export const dict: Record<I18nKey, string> = {
  ...
  "desktopHostSwitcher.actions.removeServerAria": "Видалити сервер",
  "desktopHostSwitcher.actions.removeServer": "Видалити сервер",
  ...
  "desktopHostSwitcher.toast.sshDisconnected": "Інстанс SSH \"{host}\" відключено",
  "desktopHostSwitcher.toast.instanceUnreachable": "Інстанс \"{host}\" недоступний",
  "server.sidebar.status.connectionError": "Помилка з'єднання",
  "server.sidebar.status.disconnected": "Відключено",
  "server.sidebar.search.searchingServers": "Пошук на {count} серверах",
  "server.sidebar.localLabel": "Локальний",
