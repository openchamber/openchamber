...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.notifications.openAria': 'Сповіщення',
  'layout.notifications.openTitle': 'Сповіщення',
  'layout.notifications.title': 'Сповіщення',
  'layout.notifications.empty': 'Поки немає сповіщень',
  'layout.notifications.emptyFiltered': 'Нічого не підходить під поточні фільтри',
  'layout.notifications.markAllRead': 'Позначити все прочитаним',
  'layout.notifications.clearAll': 'Очистити все',
  'layout.notifications.remove': 'Прибрати сповіщення',
  'layout.notifications.sessionSubtaskFinished': 'Підзадачу завершено',
  'layout.notifications.sessionSubtaskError': 'Помилка підзадачі',
  'layout.notifications.openSettings': 'Налаштування сповіщень',
  'layout.notifications.unreadCountAria': '{count} непрочитаних сповіщень',
  'layout.notifications.sessionFinished': 'Сесію завершено',
  'layout.notifications.sessionError': 'Помилка сесії',
  'layout.notifications.permissionNeeded': 'Потрібен дозвіл',
  'layout.notifications.permissionFallback': 'Агенту потрібне ваше схвалення',
  'layout.notifications.inputNeeded': 'Потрібна відповідь',
  'layout.notifications.questionFallback': 'Агент чекає на вашу відповідь',
  'layout.notifications.openSession': 'Відкрити сесію',
  'layout.notifications.occurrenceCount': '×{count}',
  'layout.notifications.time.justNow': 'Щойно',
  'layout.notifications.time.minutesAgo': '{count} хв',
  'layout.notifications.time.hoursAgo': '{count} год',
  'layout.notifications.time.daysAgo': '{count} д',
  'toast.action.ok': 'OK',
  'toast.action.copy': 'Копіювати',
