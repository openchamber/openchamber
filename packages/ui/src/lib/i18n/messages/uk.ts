...
export const dict: Record<I18nKey, string> = {
  ...
  "gitView.header.upstreamFetchAria": "Отримати з {target}",
  "gitView.header.upstreamFetchTooltip": "Отримати з {target}",
  "gitView.header.upstreamSyncAria": "Синхронізувати з {target}",
  "gitView.header.upstreamSyncTooltip": "Fetch, потім pull з {target}",
  ...
  "gitView.sync.fetchTrackingTooltip": "Fetch відстежуваної гілки {tracking}",
  "gitView.sync.pull": "Pull",
  "gitView.sync.pullTooltip": "Отримати зміни",
  "gitView.sync.pullTooltipBehind": "Pull змін ({count} позаду)",
  "gitView.sync.pullTrackingTooltip": "Pull з відстежуваної гілки {tracking}",
  "gitView.sync.pullTrackingTooltipBehind": "Pull з відстежуваної гілки {tracking} ({count} позаду)",
  "gitView.sync.push": "Push",
  "gitView.sync.pushTooltip": "Push змін",
  "gitView.sync.pushTooltipAhead": "Push змін ({count} попереду)",
  "gitView.sync.pushTrackingTooltip": "Push до відстежуваної гілки {tracking}",
  "gitView.sync.pushTrackingTooltipAhead": "Push до відстежуваної гілки {tracking} ({count} попереду)",
  "gitView.sync.upstreamFetch": "Fetch upstream",
  "gitView.sync.upstreamSync": "Синхронізувати upstream",
