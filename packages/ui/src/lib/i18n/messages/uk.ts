...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.agentCapabilities.fusion.pickerLoadError": "Не вдалося завантажити пресети фʼюжн.",
  "chat.agentCapabilities.fusion.pickerEmpty": "Немає пресетів фʼюжн. Створіть один у Налаштування → Фʼюжн.",
  "chat.agentCapabilities.fusion.keyboardHint": "↑↓ навігація • Enter вибрати • Esc закрити",
  "chat.agentCapabilities.inline.waitingChildren": "Очікування запуску дочірніх сесій…",
