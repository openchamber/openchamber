...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.chatInput.reviewCommentEdit": "Редагувати коментар",
  "chat.chatInput.reviewCommentEditPlaceholder": "Відредагуйте свій коментар…",
  "chat.chatInput.reviewCommentSave": "Зберегти",
  "chat.message.inlineComment.expand": "Показати код",
  "chat.message.inlineComment.collapse": "Сховати код",
  "chat.message.inlineComment.lineSingle": "Рядок {line}",
  "chat.message.inlineComment.lineRange": "Рядки {start}–{end}",
  "chat.message.inlineComment.lineSingleOfFile": "Рядок {line} у {file}",
  "chat.message.inlineComment.lineRangeOfFile": "Рядки {start}–{end} у {file}",
  "chat.chatInput.reviewCommentCancel": "Скасувати",
