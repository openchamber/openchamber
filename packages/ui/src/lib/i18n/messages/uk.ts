...
export const dict: Record<I18nKey, string> = {
  ...
  "contextRail.surface.git.description": "Перегляд змін, коміт і синхронізація",
  ...
  "contextPanel.actions.backToChanges": "Назад до змін",
  ...
  "helpDialog.item.openRightSidebarGitTab": 'Відкрити поверхню Зміни',
