...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'contextPanel.mode.agentBrowser': 'Браузер агента',
  'contextRail.surface.agentBrowser.description': 'Браузер у реальному часі, яким керує агент',
  'agentBrowser.viewport.desktop': 'Комп’ютер',
  'agentBrowser.viewport.laptop': 'Ноутбук',
  'agentBrowser.viewport.tablet': 'Планшет',
  'agentBrowser.viewport.mobile': 'Мобільний',
  'agentBrowser.actions.newTab': 'Нова вкладка',
  'agentBrowser.actions.reload': 'Перезавантажити',
  'agentBrowser.actions.go': 'Перейти',
  'agentBrowser.actions.screenshot': 'Зробити знімок екрана',
  'agentBrowser.actions.startRecording': 'Почати запис',
  'agentBrowser.actions.stopRecording': 'Зупинити запис',
  'agentBrowser.recording.active': 'Запис',
  'agentBrowser.urlBar.placeholder': 'Введіть URL для відкриття',
  'agentBrowser.tab.untitled': 'Нова вкладка',
  'agentBrowser.tab.close': 'Закрити вкладку',
  'agentBrowser.preview.aria': 'Перегляд браузера в реальному часі',
  'agentBrowser.preview.waitingFrame': 'Очікування першого кадру…',
  'agentBrowser.preview.connecting': 'Підключення до браузера…',
  'agentBrowser.empty.noTabs': 'Немає відкритих вкладок',
  ...
  'agentBrowser.control.agentActive': 'Агент керує браузером',
  'agentBrowser.takeover.title': 'Перехопити керування браузером?',
  'agentBrowser.takeover.description': 'Зараз браузером користується агент. Якщо перехопити керування, цього агента буде зупинено.',
  'agentBrowser.takeover.confirm': 'Перехопити',
  'agentBrowser.takeover.cancel': 'Скасувати',
