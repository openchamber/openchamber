...
export const dict: Record<I18nKey, string> = {
  ...
  "usage.status.quotaExhausted": "Ліміт вичерпано",
  "usage.status.expired": "Ключ API закінчився",
  "usage.statistics.title": "Статистика використання",
  "usage.statistics.info": "Статистика моделей охоплює останні 30 днів.",
  "usage.statistics.requests": "Запити",
  "usage.statistics.inputTokens": "Вхідні токени",
  "usage.statistics.outputTokens": "Вихідні токени",
  "usage.statistics.cacheReadTokens": "Токени читання з кешу",
  "usage.statistics.totalTokens": "Усього токенів",
  "usage.statistics.actualCost": "Вартість",
  "usage.statistics.today": "Сьогодні",
  "usage.statistics.total": "Усього",
  "usage.statistics.empty": "Статистику використання не повідомлено.",
