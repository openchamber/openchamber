...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.chatInput.actions.enhancePromptAria": "Покращити запит",
  "chat.chatInput.actions.enhancePromptCancel": "Скасувати покращення запиту",
  ...
  "chat.chatInput.toast.enhanceUnavailable": "Малої моделі для покращення запиту немає. Виберіть її у Налаштуваннях → Сесії → Мала модель.",
  "chat.chatInput.toast.enhanceContextTooSmall": "Запит завеликий для контексту малої моделі. Скоротіть його або додайте як файл.",
  "chat.chatInput.toast.enhanceEmptyResult": "Мала модель повернула порожній запит. Спробуйте ще раз.",
  "chat.chatInput.toast.enhanceInvalidResult": "Покращений запит змінив би ваші посилання @, / або #. Чернетку не змінено.",
  "chat.chatInput.toast.enhanceTimedOut": "Покращення запиту перевищило час очікування. Спробуйте ще раз.",
