...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.engine.claudeCodeAria": "Рушій Claude Code",
  "sessions.sidebar.session.engine.claudeCodeTooltip": "Працює на Claude Code",
  ...
  "gitView.pr.comments.addAll": "Додати все в чат",
  ...
  "chat.engines.slashUnsupported": "Ця slash-команда OpenCode недоступна в Claude Code. Використайте нативну Claude /команду або надішліть звичайне повідомлення.",
  "chat.engines.effort.label": "Рівень зусиль",
  "chat.engines.effort.default": "Типовий",
  "chat.engines.effort.low": "Низький",
  "chat.engines.effort.medium": "Середній",
  "chat.engines.effort.high": "Високий",
  "chat.engines.effort.xhigh": "Дуже високий",
  "chat.engines.effort.max": "Максимальний",
  "chat.engines.effort.aria": "Рівень зусиль: {level}",
  "chat.engines.effort.tooltip": "Рівень зусиль: {level}",
  "chat.engines.capability.goalUnsupported": "Цілі доступні лише в OpenCode. Перемкніть цю сесію на OpenCode, щоб використовувати цілі.",
  "chat.engines.capability.multirunUnsupported": "MultiRun доступний лише в OpenCode. Перемкніть цю сесію на OpenCode, щоб запустити MultiRun.",
  "chat.handoff.billingDialog.title": "Продовжити в Claude Code?",
  "chat.handoff.billingDialog.body": "Це створить нову сесію в Claude Code з лімітами використання вашої підписки Claude. Постачальники API OpenCode залишаються без змін. Текст розмови копіюється як контекст; початкова сесія залишається недоторканою.",
  "chat.handoff.billingDialog.continue": "Продовжити",
  "chat.handoff.billingDialog.cancel": "Скасувати",
  "chat.handoff.billingDialog.dontShowAgain": "Більше не показувати",
  "chat.handoff.billingDialog.dontShowAgainAria": "Більше не показувати це попередження про тарифікацію під час передачі",
