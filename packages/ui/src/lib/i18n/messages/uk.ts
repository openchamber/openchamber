...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Установіть ALIAS ADE для швидшого доступу",
  "pwa.installPrompt.action": "Установити",
  "pwa.installPrompt.started": "Установлення розпочато",
  "pwa.installPrompt.installed": "ALIAS ADE встановлено",
  ...
  "sessions.sidebar.footer.actions.aboutAliasAde": "Про ALIAS ADE",
  ...
  "header.services.shutdownDev": "Зупинити ALIAS ADE",
  ...
  "aboutDialog.diagnosticsDescription": "Містить стан ALIAS ADE, стан OpenCode, каталоги та проєкти.",
  ...
  "helpDialog.description": "Використовуйте ці комбінації клавіш для ефективної навігації ALIAS ADE",
  ...
  "sessionAuth.locked.unlockTitle": "Розблокувати ALIAS ADE",
  ...
  "desktopHostSwitcher.description": "Перемикання між Local і віддаленими ALIAS ADE серверами",
  ...
  "multiRun.window.description": "Вікно мультизапуску ALIAS ADE.",
  ...
  "onboarding.chooser.title": "Ласкаво просимо до ALIAS ADE",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Якщо ALIAS ADE не визначає OpenCode автоматично, укажіть шлях до виконуваного файла нижче.",
  "onboarding.localSetup.intro": "OpenCode — серце ALIAS ADE. Встановіть його, щоб почати.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Зберігає налаштування в ALIAS ADE і перезавантажує конфігурацію OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Введіть адресу сервера ALIAS ADE для підключення.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Пропозиції: переконайтеся, що URL вказує на сервер ALIAS ADE або зверніться до адміністратора сервера.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "Сервер відповів, але не працює ALIAS ADE. Перевірте, чи адреса вказує на сервер ALIAS ADE.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "На сервері \"{host}\" не запущено ALIAS ADE. Перевірте, чи адреса вказує на сервер ALIAS ADE.",
  ...
  "startup.initRecovery.description": "ALIAS ADE не зміг завершити ініціалізацію. Перевірте, що сервер запущений, і повторіть спробу.",
  ...
  "updateDialog.header.updating": "Оновлення ALIAS ADE...",
  ...
  "updateDialog.error.takingLonger": "Оновлення триває довше, ніж очікувалося. Зачекайте трохи та оновіть або запустіть: alias-ade update",
  ...
  "aliasAdeLogo.aria.logo": "Логотип ALIAS ADE",
