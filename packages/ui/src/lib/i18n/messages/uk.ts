...
export const dict: Record<I18nKey, string> = {
  ...
  'workspace.move.left': 'Перемістити ліворуч',
  ...
  'workspace.zone.label.right': 'Права зона',
  'workspace.zone.label.bottom': 'Нижня зона',
  'workspace.zone.resize.left': 'Змінити розмір лівої зони',
  'workspace.zone.resize.bottom': 'Змінити розмір нижньої зони',
  'workspace.preset.title': 'Макет',
  'workspace.preset.default': 'Типовий',
  'workspace.preset.developer': 'Розробник',
  'workspace.preset.codeAgent': 'Код + агент',
  'workspace.preset.reset': 'Скинути макет',
};
