...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.search.findPlaceholder": "Знайти",
  "chat.search.findAria": "Знайти в чаті",
  "chat.search.replacePlaceholder": "Замінити",
  "chat.search.replaceAria": "Замінити текст (недоступно в чаті)",
  ...
  "chat.search.nextAria": "Наступний збіг",
  "chat.search.close": "Закрити (Escape)",
  "chat.search.closeAria": "Закрити пошук",
  "chat.search.selectAllUnavailable": "Вибір усіх збігів недоступний у пошуку чату",
  "chat.search.replaceUnavailable": "Заміна недоступна в пошуку чату",
  "chat.search.replaceAllUnavailable": "Замінити все недоступно в пошуку чату",
  "chat.search.noResults": "Немає результатів",
  "chat.search.loading": "Завантаження…",
