...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.context.description': 'Те, чого сама ідентичність не вирішує: оболонка агента, інші адреси репозиторію та окремі доступи, потрібні підмодулям і Git LFS. Ідентичностями керують у налаштуваннях Git.',
  ...
  'gitView.identity.unavailableScheme': 'Потрібен віддалений репозиторій {scheme}',
  'gitView.context.settings': 'Відкрити налаштування Git',
  'gitView.operation.title': 'Операція Git',
  'gitView.operation.recovery.storage': 'Сховище відновлення Git недоступне. Відновіть сховище браузера й оновіть стан. Нові зміни заблоковано.',
  'gitView.operation.recovery.capacity': 'Сховище відновлення Git заповнене. З\'ясуйте стан збережених операцій перед початком нової.',
  'gitView.operation.recovery.reconciling': 'Перевірка збережених посилань на операції Git…',
  'gitView.operation.recovery.repository': 'Не вдалося перевірити репозиторій. Оновіть стан перед початком іншої операції Git.',
  'gitView.operation.recovery.inspect': 'Якщо сервер більше не розпізнає цей ID, перевірте локальний репозиторій і віддалений репозиторій поза OpenChamber. Збережене посилання залишається заблокованим; відсутність стану ніколи не дозволяє повторне передавання.',
  'gitView.operation.localCommit': 'Локальний коміт створено та збережено.',
  'gitView.operation.unknownHint': 'Результат невідомий. Оновіть стан цієї операції перед новим передаванням. Нічого не буде повторено автоматично.',
  'gitView.operation.refresh': 'Оновити операцію',
  'gitView.operation.cancel': 'Скасувати операцію',
  'gitView.operation.state.unavailable': 'Стан операції недоступний',
  'gitView.operation.state.planned': 'Заплановано',
  'gitView.operation.state.running': 'Виконується',
  'gitView.operation.state.succeeded': 'Успішно',
  'gitView.operation.state.partial': 'Частково завершено',
  'gitView.operation.state.failed': 'Помилка',
  'gitView.operation.state.cancelled': 'Скасовано',
  'gitView.operation.state.outcome-unknown': 'Результат невідомий',
  'gitView.operation.state.conflicted': 'Конфлікт',
  'gitView.operation.state.skipped': 'Пропущено',
  'gitView.operation.completed.validated': 'Репозиторій і ціль перевірено',
  'gitView.operation.completed.authenticated': 'Автентифікацію завершено',
  'gitView.operation.completed.transferred': 'Передавання завершено',
  'gitView.operation.completed.updated-local-repository': 'Локальний репозиторій оновлено',
  'gitView.operation.completed.checked-out': 'Перемикання завершено',
  'gitView.operation.completed.cleaned-up': 'Очищення завершено',
  'gitView.remotes.title': 'Інші ремоути',
  'gitView.remotes.description': 'Адреси, які має цей репозиторій, окрім тієї, до якої застосували його ідентичність. Поки адресі не надано доступ, OpenChamber ні тягне з неї, ні пушить у неї.',
  'gitView.remotes.grant': 'Відповідати як {identity}',
  'gitView.hydration.title': 'Підготовка робочої копії',
  'gitView.hydration.description': 'Ініціалізуйте підмодулі та завантажте вміст Git LFS з окремою авторизацією для кожної адреси.',
  ...
  'gitView.hydration.kind.submodule': 'Підмодуль',
  'gitView.hydration.kind.lfs': 'Git LFS',
  'gitView.hydration.status.succeeded': 'Завершено',
  'gitView.hydration.status.failed': 'Помилка',
  'gitView.hydration.status.cancelled': 'Скасовано',
  'gitView.hydration.status.authorization-required': 'Потрібна авторизація',
  'gitView.hydration.status.invalid': 'Некоректна конфігурація',
  'gitView.hydration.status.client-missing': 'Клієнт відсутній',
  'gitView.hydration.status.not-needed': 'Не потрібно',
  'gitView.publish.title': 'Опублікувати',
  'gitView.publish.commitKept': 'Локальний коміт створено та збережено. Публікацію не завершено успішно.',
  'gitView.publish.syncTitle': 'Вибрати цілі синхронізації',
  'gitView.publish.description': 'Опублікуйте {branch} у точно вказаному місці призначення Git. Облікові записи провайдера не визначають ціль.',
  'gitView.publish.fetchSource': 'Віддалений репозиторій для отримання',
  'gitView.publish.sourceBranch': 'Вихідна гілка',
  'gitView.publish.fetchFirst': 'Для цього віддаленого репозиторію немає кешованих гілок. Скасуйте дію та спочатку отримайте зміни.',
  'gitView.publish.pushDestination': 'Віддалений репозиторій для надсилання',
  'gitView.publish.selectRemote': 'Виберіть прив’язаний віддалений репозиторій',
  'gitView.publish.destinationBranch': 'Цільова гілка',
  'gitView.publish.noGrants': 'Перед публікацією налаштуйте прив’язку транспорту Git.',
  'gitView.publish.contributorCommitFirst': 'Це робоче дерево учасника потребує підтвердження цілі після коміту. Продовжити? Скасування публікації пізніше збереже локальний коміт.',
  'gitView.publish.detached': 'Публікація від’єднаного HEAD не підтримується. Спочатку перейдіть на локальну гілку.',
  'gitView.publish.stale': 'Гілка або дозволи Git змінилися. Повторної спроби не було. Виберіть ціль знову.',
  'gitView.publish.cancelled': 'Публікацію скасовано. Передавання Git не розпочато.',
  'gitView.publish.succeeded': 'Опубліковано у вибраному місці призначення',
  ...
  'chat.shellBoundary.status': 'Не перевірено · поза керованою межею',
  'chat.shellBoundary.agentAria': 'Виконання shell-команди агентом не перевірено й воно перебуває поза керованою межею Git',
  'chat.shellBoundary.userAria': 'Виконання shell-команди користувачем не перевірено й воно перебуває поза керованою межею Git',
  ...
  "worktree.bootstrap.toast.authorizationRequired": "Авторизуйте репозиторій для checkout і його підмодулі, а потім повторіть спробу.",
  ...
  "gitView.pr.actions.openOnProvider": "Відкрити на {provider}",
  "gitView.pr.actions.openOnProviderAria": "Відкрити PR на {provider}",
  ...
  "gitView.pr.providerNotConnected": "{provider} не підключено",
  ...
  "gitView.pr.capabilitiesUnavailable": "Не вдалося завантажити можливості провайдера",
  ...
  'gitView.contributor.chooseDestination': 'Виберіть точне призначення для цієї гілки учасника.',
  'gitView.contributor.destination.contributor-fork': 'Форк учасника',
  'gitView.contributor.destination.own-fork': 'Ваш форк',
  'gitView.contributor.destination.bound-repository': 'Прив’язаний репозиторій',
  'gitView.contributor.destination.other': 'Інший віддалений репозиторій',
  'gitView.toast.contributorPublishCancelled': 'Публікацію скасовано. Жоден віддалений репозиторій не змінено.',
  'gitView.toast.contributorPublishCancelledAfterUpdate': 'Зміни оновлено локально, але публікацію скасовано.',
  "gitView.toast.unstageFileFailed": "Не вдалося прибрати зміни з індексу",
  "gitView.confirm.systemTransport": "Системний Git може використати облікові дані, налаштовані на цьому комп’ютері. Продовжити цю Git-операцію?",
  ...
  "session.changeRequestPicker.error.noProvider": "Не знайдено підтримуваного remote системи контролю версій",
  "session.changeRequestPicker.title": "Пов’язати запит на зміни",
  "session.changeRequestPicker.description": "Виберіть pull request або merge request, щоб додати контекст рев’ю до цього повідомлення.",
  "session.changeRequestPicker.searchPlaceholder": "Шукайте за назвою чи номером або вставте URL запиту на зміни",
  "session.changeRequestPicker.includeDiffAria": "Додати diff запиту на зміни до прикріпленого контексту",
  "session.changeRequestPicker.includeDiff": "Додати diff",
  "session.changeRequestPicker.loading.changeRequests": "Завантаження запитів на зміни...",
  "session.changeRequestPicker.actions.useChangeRequest": "Використати запит на зміни {reference}",
  "session.changeRequestPicker.empty.noneFound": "Запитів на зміни не знайдено",
  "session.changeRequestPicker.empty.noneOpen": "Відкритих запитів на зміни не знайдено",
  "session.issuePicker.title": "Пов’язати issue",
  "session.issuePicker.description": "Виберіть issue, щоб додати її контекст до цього повідомлення.",
  "session.issuePicker.searchPlaceholder": "Шукайте за назвою чи номером або вставте URL issue",
  "session.issuePicker.loading.issues": "Завантаження issues...",
  "session.issuePicker.actions.useIssue": "Використати issue #{number}",
  "session.issuePicker.empty.noneFound": "Issues не знайдено",
  "session.issuePicker.empty.noneOpen": "Відкритих issues не знайдено",
  ...
  'session.newWorktree.error.changeRequestAuthorityMissing': 'Дані авторизації запиту на зміни більше недоступні. Виберіть його знову.',
  'session.newWorktree.trust.confirmation': 'Цей checkout містить виконувані дії:\n\n{actions}\n\nЗапустити їх зараз? Скасування залишить checkout готовим до роботи з Git без їх запуску.',
