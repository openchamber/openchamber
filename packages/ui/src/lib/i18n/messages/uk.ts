...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.messageBody.metrics.ttftInfo": "Час до першого токена: скільки минуло від запиту до початку відповіді моделі.",
  "chat.messageBody.metrics.tokensPerSecond": "{rate} tok/s",
  "chat.messageBody.metrics.tokensPerSecondInfo": "Вихідні токени за секунду потокового декодування, без урахування виконання інструментів.",
