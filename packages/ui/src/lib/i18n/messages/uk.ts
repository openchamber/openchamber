...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.messageBody.footer.totalTime": "Загальний час",
  "chat.messageBody.footer.totalTimeAria": "Загальний час: {{value}}",
  "chat.messageBody.footer.tps": "Токенів на секунду",
  "chat.messageBody.footer.tpsAria": "Токенів на секунду: {{value}}",
  "chat.messageBody.footer.ttft": "Час до першого токена",
  "chat.messageBody.footer.ttftAria": "Час до першого токена: {{value}}",
  "chat.messageBody.footer.completedAt": "Завершено о",
  "chat.messageBody.footer.completedAtAria": "Завершено о: {{value}}",
