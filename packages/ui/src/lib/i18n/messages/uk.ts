...
export const dict: Record<I18nKey, string> = {
  ...
  'dockerInstances.title': 'Docker-інстанси',
  'dockerInstances.description': 'Створюйте інстанси OpenCode в Docker-контейнерах на цій машині та керуйте ними.',
  'dockerInstances.state.creating': 'Створення',
  'dockerInstances.state.starting': 'Запуск',
  'dockerInstances.state.probing': 'Очікування готовності',
  'dockerInstances.state.running': 'Працює',
  'dockerInstances.state.stopped': 'Зупинено',
  'dockerInstances.state.error': 'Помилка',
  'dockerInstances.state.removing': 'Видалення',
  'dockerInstances.state.removalFailed': 'Не вдалося очистити',
  'dockerInstances.state.empty': 'Ще немає Docker-інстансів.',
  'dockerInstances.state.loadFailed': 'Не вдалося завантажити Docker-інстанси.',
  'dockerInstances.actions.addDocker': 'Додати Docker-інстанс',
  'dockerInstances.actions.switchAria': 'Перейти до {name}',
  'dockerInstances.actions.stop': 'Зупинити',
  'dockerInstances.actions.start': 'Запустити',
  'dockerInstances.actions.cleanup': 'Повторити очищення',
  'dockerInstances.actions.remove': 'Видалити',
  'dockerInstances.actions.confirmRemove': 'Підтвердьте видалення',
  'dockerInstances.actions.openAria': 'Відкрити Docker-інстанси',
  'dockerInstances.create.title': 'Новий Docker-інстанс',
  'dockerInstances.create.description': 'OpenChamber створює контейнер, запускає в ньому OpenCode і чекає готовності.',
  'dockerInstances.create.field.label': 'Назва',
  'dockerInstances.create.field.labelPlaceholder': 'Необов\'язкова назва',
  'dockerInstances.create.field.image': 'Образ',
  'dockerInstances.create.field.workspace': 'Шлях до робочого простору',
  ...
  'dockerInstances.create.sharing.credentialsTitle': 'Спільний доступ до облікових даних',
  'dockerInstances.create.sharing.credentialsHint': 'Тільки читання, типово вимкнено. Дані входу провайдерів стають видимими в контейнері.',
  'dockerInstances.create.sharing.neverShared': 'Ніколи не надаються: Docker-сокет, SSH-ключі, облікові дані git. Порти прив\'язуються лише до цієї машини.',
  'dockerInstances.create.actions.buildImage': 'Зібрати {image}',
  'dockerInstances.create.actions.cancel': 'Скасувати',
  'dockerInstances.create.actions.create': 'Створити інстанс',
  'dockerInstances.create.actions.creating': 'Створення…',
  'dockerInstances.create.error.generic': 'Не вдалося створити інстанс.',
  'dockerInstances.create.toast.created': 'Docker-інстанс створено.',
  'dockerInstances.create.toast.imageBuilt': 'Образ {image} готовий.',
  'dockerInstances.toast.activated': 'Перейдено до {name}.',
  'dockerInstances.toast.deactivated': 'Повернулися до локального інстансу.',
