...
export const dict: Record<I18nKey, string> = {
  ...
  "gitView.pr.field.headBranch": "Вихідна гілка",
  ...
  "contextPanel.mode.mr": "Запит на злиття",
  ...
  "contextPanel.gitlabMr.createMr.titleLabel": "Назва",
  "contextPanel.gitlabMr.createMr.titlePlaceholder": "Назва запиту на злиття",
  "contextPanel.gitlabMr.createMr.descriptionLabel": "Опис",
  ...
  "contextPanel.gitlabMr.updateMr.save": "Зберегти",
  "contextPanel.gitlabMr.updateMr.saving": "Збереження...",
  "contextPanel.gitlabMr.updateMr.toast.updated": "Запит на злиття оновлено",
  "contextPanel.gitlabMr.updateMr.toast.updateFailed": "Не вдалося оновити запит на злиття",
  "contextPanel.gitlabMr.mergeMr.action": "Злити",
  "contextPanel.gitlabMr.mergeMr.squash": "Сквошити коміти",
  "contextPanel.gitlabMr.mergeMr.merging": "Злиття...",
  "contextPanel.gitlabMr.mergeMr.toast.merged": "Запит на злиття злито",
  "contextPanel.gitlabMr.mergeMr.toast.mergeFailed": "Не вдалося злити запит на злиття",
  "contextPanel.giteaPr.title": "PR",
  "contextPanel.giteaPr.tabs.pullRequests": "PR",
  "contextPanel.giteaPr.tabs.issues": "Issue",
  "contextPanel.giteaPr.branchSectionTitle": "Поточна гілка",
  "contextPanel.giteaPr.openPrTitle": "Відкриті PR",
  "contextPanel.giteaPr.listSectionTitle": "У цьому репозиторії",
  "contextPanel.giteaPr.openPrEmpty": "Немає відкритих PR",
  "contextPanel.giteaPr.noPrForBranch": "Немає PR для цієї гілки",
  "contextPanel.giteaPr.loadContext": "Завантажити контекст",
  "contextPanel.giteaPr.hideContext": "Приховати контекст",
  "contextPanel.giteaPr.openInGitea": "Відкрити в Gitea",
  "contextPanel.giteaPr.draft": "Чернетка",
  "contextPanel.giteaPr.state.opened": "Відкритий",
  "contextPanel.giteaPr.state.merged": "Злитий",
  "contextPanel.giteaPr.state.closed": "Закритий",
  "contextPanel.giteaPr.loadMore": "Завантажити ще",
  "contextPanel.giteaPr.loading": "Завантаження...",
  "contextPanel.giteaPr.error.loadFailed": "Не вдалося завантажити PR",
  "contextPanel.giteaPr.error.notConnected": "Gitea не підключено",
  "contextPanel.giteaPr.empty.noActiveProject": "Немає активного проєкту",
  "contextPanel.giteaPr.actions.openSettings": "Відкрити налаштування",
  "contextPanel.giteaPr.issues.detail.back": "Назад до issue",
  "contextPanel.giteaPr.issues.detail.commentsEmpty": "Немає коментарів",
  "contextPanel.giteaPr.issues.empty": "Немає відкритих issue",
  "contextPanel.giteaPr.issues.error.loadFailed": "Не вдалося завантажити issue",
  "contextPanel.giteaPr.issues.listSectionTitle": "Відкриті issue",
  "contextPanel.giteaPr.createPr.title": "Новий PR",
  "contextPanel.giteaPr.createPr.sourceBranch": "Вихідна гілка",
  "contextPanel.giteaPr.createPr.targetBranch": "Цільова гілка",
  "contextPanel.giteaPr.createPr.titleLabel": "Назва",
  "contextPanel.giteaPr.createPr.titlePlaceholder": "Назва PR",
  "contextPanel.giteaPr.createPr.descriptionLabel": "Опис",
  "contextPanel.giteaPr.createPr.removeSourceBranch": "Видалити вихідну гілку після злиття",
  "contextPanel.giteaPr.createPr.submit": "Створити PR",
  "contextPanel.giteaPr.createPr.submitting": "Створення...",
  "contextPanel.giteaPr.createPr.branchesLoading": "Завантаження гілок...",
  "contextPanel.giteaPr.createPr.toast.created": "PR створено",
  "contextPanel.giteaPr.createPr.toast.createFailed": "Не вдалося створити PR",
  "contextPanel.giteaPr.updatePr.toggle": "Редагувати назву та опис",
  "contextPanel.giteaPr.updatePr.save": "Зберегти",
  "contextPanel.giteaPr.updatePr.saving": "Збереження...",
  "contextPanel.giteaPr.updatePr.toast.updated": "PR оновлено",
  "contextPanel.giteaPr.updatePr.toast.updateFailed": "Не вдалося оновити PR",
  "contextPanel.giteaPr.mergePr.action": "Злити",
  "contextPanel.giteaPr.mergePr.squash": "Сквошити коміти",
  "contextPanel.giteaPr.mergePr.merging": "Злиття...",
  "contextPanel.giteaPr.mergePr.toast.merged": "PR злито",
  "contextPanel.giteaPr.mergePr.toast.mergeFailed": "Не вдалося злити PR",
  ...
  "contextRail.surface.mr.description": "Створюйте, переглядайте та зливайте запит на злиття поточної гілки",
  ...
  "session.gitlabIssuePicker.searchPlaceholder": "Пошук за назвою або вставте URL issue",
  ...
  "session.giteaIssuePicker.error.noActiveProject": "Немає активного проєкту",
  "session.giteaIssuePicker.error.runtimeUnavailable": "Gitea API недоступний",
  "session.giteaIssuePicker.error.notConnected": "Gitea не підключено",
  "session.giteaIssuePicker.error.repoNotResolvable": "Не вдалося визначити репозиторій",
  "session.giteaIssuePicker.error.repoMustBeGitea": "remote origin має бути Gitea URL",
  "session.giteaIssuePicker.error.issueNotFound": "Issue не знайдено",
  "session.giteaIssuePicker.error.noModelSelected": "Модель не вибрано",
  "session.giteaIssuePicker.toast.loadMoreFailed": "Не вдалося завантажити додаткові issue",
  "session.giteaIssuePicker.toast.loadIssueDetailsFailed": "Не вдалося завантажити деталі issue",
  "session.giteaIssuePicker.toast.sendContextFailed": "Не вдалося надіслати контекст issue",
  "session.giteaIssuePicker.toast.sessionCreated": "Сесію створено з issue",
  "session.giteaIssuePicker.toast.startSessionFailed": "Не вдалося почати сесію",
  "session.giteaIssuePicker.title.select": "Пов’язати Gitea issue",
  "session.giteaIssuePicker.title.createSession": "Нова сесія з Gitea issue",
  "session.giteaIssuePicker.description.select": "Виберіть issue, щоб пов’язати її з цією сесією.",
  "session.giteaIssuePicker.description.createSession": "Запускає нову сесію із прихованим контекстом issue: заголовком, текстом, мітками й коментарями.",
  "session.giteaIssuePicker.searchPlaceholder": "Пошук за назвою або вставте URL issue",
  "session.giteaIssuePicker.empty.noActiveProject": "Не вибрано жодного активного проєкту.",
  "session.giteaIssuePicker.empty.runtimeUnavailable": "Gitea API недоступний.",
  "session.giteaIssuePicker.empty.notConnected": "Gitea не підключено. Підключіть обліковий запис Gitea у налаштуваннях.",
  "session.giteaIssuePicker.empty.noIssuesFound": "Issue не знайдено",
  "session.giteaIssuePicker.empty.noOpenIssuesFound": "Відкритих issue не знайдено",
  "session.giteaIssuePicker.loading.issues": "Завантаження issue...",
  "session.giteaIssuePicker.loading.more": "Завантаження...",
  "session.giteaIssuePicker.actions.openSettings": "Відкрити налаштування",
  "session.giteaIssuePicker.actions.useIssue": "Використовувати issue №{number}",
  "session.giteaIssuePicker.actions.openInGiteaAria": "Відкрити в Gitea",
  "session.giteaIssuePicker.actions.loadMore": "Завантажити ще",
  "session.giteaIssuePicker.actions.sectionTitle": "Дії",
  "session.giteaIssuePicker.actions.toggleWorktreeAria": "Перемкнути worktree",
  "session.giteaIssuePicker.actions.createInWorktree": "Створити в worktree",
  "session.giteaIssuePicker.actions.openRepo": "Відкрити репозиторій",
  "session.giteaIssuePicker.actions.refresh": "Оновити",
  ...
  "session.gitlabMrPicker.error.mrNotFound": "MR не знайдено",
  ...
  "session.gitlabMrPicker.searchPlaceholder": "Пошук за назвою або вставте URL MR",
  ...
  "session.gitlabMrPicker.empty.noMergeRequestsFound": "MR не знайдено",
  "session.gitlabMrPicker.empty.noOpenMergeRequestsFound": "Не знайдено відкритих MR",
  "session.gitlabMrPicker.loading.mergeRequests": "Завантаження MR...",
  "session.gitlabMrPicker.loading.more": "Завантаження...",
  "session.gitlabMrPicker.actions.openSettings": "Відкрити налаштування",
  "session.gitlabMrPicker.actions.useMergeRequest": "Використовувати MR !{number}",
  "session.gitlabMrPicker.actions.openInGitLabAria": "Відкрити в GitLab",
  "session.gitlabMrPicker.actions.loadMore": "Завантажити ще",
  "session.giteaPrPicker.error.noActiveProject": "Немає активного проєкту",
  "session.giteaPrPicker.error.runtimeUnavailable": "Gitea API недоступний",
  "session.giteaPrPicker.error.notConnected": "Gitea не підключено",
  "session.giteaPrPicker.error.prNotFound": "PR не знайдено",
  "session.giteaPrPicker.error.repoNotResolvable": "Не вдалося визначити репозиторій",
  "session.giteaPrPicker.error.repoMustBeGitea": "remote origin має бути Gitea URL",
  "session.giteaPrPicker.toast.loadMoreFailed": "Не вдалося завантажити додаткові PR",
  "session.giteaPrPicker.toast.loadDetailsFailed": "Не вдалося завантажити деталі PR",
  "session.giteaPrPicker.title": "Пов’язати Gitea PR",
  "session.giteaPrPicker.description": "Виберіть PR, щоб додати контекст рев’ю до цього повідомлення.",
  "session.giteaPrPicker.searchPlaceholder": "Пошук за назвою або вставте URL PR",
  "session.giteaPrPicker.includeDiffAria": "Додати diff PR у вкладений контекст",
  "session.giteaPrPicker.includeDiff": "Додати diff PR",
  "session.giteaPrPicker.empty.noActiveProject": "Не вибрано жодного активного проєкту.",
  "session.giteaPrPicker.empty.runtimeUnavailable": "Gitea API недоступний.",
  "session.giteaPrPicker.empty.notConnected": "Gitea не підключено. Підключіть обліковий запис Gitea у налаштуваннях.",
  "session.giteaPrPicker.empty.noPullRequestsFound": "PR не знайдено",
  "session.giteaPrPicker.empty.noOpenPullRequestsFound": "Не знайдено відкритих PR",
  "session.giteaPrPicker.loading.pullRequests": "Завантаження PR...",
  "session.giteaPrPicker.loading.more": "Завантаження...",
  "session.giteaPrPicker.actions.openSettings": "Відкрити налаштування",
  "session.giteaPrPicker.actions.usePullRequest": "Використовувати PR #{number}",
  "session.giteaPrPicker.actions.openInGiteaAria": "Відкрити в Gitea",
  "session.giteaPrPicker.actions.loadMore": "Завантажити ще",
  ...
  "session.newWorktree.actions.startFromGitLabIssueMr": "Почати з GitLab issue/MR",
  "session.newWorktree.usingPrBranch": "Використовується PR-гілка: {branch}",
  "session.newWorktree.usingMrBranch": "Використовується MR-гілка: {branch}",
  ...
  "session.newWorktree.toast.sessionFromMr": "Сесію створено з merge request",
  ...
  "session.gitlabIntegration.tabs.mergeRequests": "Merge Request",
  "session.gitlabIntegration.connect.title": "Підключитися до GitLab",
  "session.gitlabIntegration.connect.description": "Пов’яжіть issue або merge request, щоб автоматично заповнити деталі worktree",
  "session.gitlabIntegration.connect.action": "Підключити GitLab",
  "session.gitlabIntegration.search.issuesPlaceholder": "Шукати issue в GitLab",
  "session.gitlabIntegration.search.mrsPlaceholder": "Шукати merge request у GitLab",
  "session.gitlabIntegration.empty.noIssuesFound": "Issue не знайдено",
  "session.gitlabIntegration.empty.noMergeRequestsFound": "Merge request не знайдено",
  ...
  "session.gitlabIntegration.draftBadge": "Чернетка",
  "session.giteaIntegration.title": "Виберіть із Gitea",
  "session.giteaIntegration.tabs.issues": "Issue",
  "session.giteaIntegration.tabs.pullRequests": "PR",
  "session.giteaIntegration.connect.title": "Підключитися до Gitea",
  "session.giteaIntegration.connect.description": "Пов’яжіть issue або PR, щоб автоматично заповнити деталі worktree",
  "session.giteaIntegration.connect.action": "Підключити Gitea",
  "session.giteaIntegration.search.issuesPlaceholder": "Шукати issue в Gitea",
  "session.giteaIntegration.search.prsPlaceholder": "Шукати PR у Gitea",
  "session.giteaIntegration.empty.noIssuesFound": "Issue не знайдено",
  "session.giteaIntegration.empty.noPullRequestsFound": "PR не знайдено",
  "session.giteaIntegration.actions.loadMore": "Завантажити ще",
  "session.giteaIntegration.actions.cancel": "Скасувати",
  "session.giteaIntegration.actions.select": "Вибрати",
  "session.giteaIntegration.selected.issueNumber": "issue №{number}",
  "session.giteaIntegration.selected.prNumber": "PR #{number}",
  "session.giteaIntegration.includeDiffAria": "Додати diff PR у контекст сесії",
  "session.giteaIntegration.includeDiff": "Додати diff PR",
  "session.giteaIntegration.error.notConnected": "Gitea не підключено",
  "session.giteaIntegration.error.loadDataFailed": "Не вдалося завантажити дані",
  "session.giteaIntegration.validation.branchAlreadyCheckedOut": "Гілку вже відкрито в worktree",
  "session.giteaIntegration.validation.branchAlreadyExists": "Гілка вже існує локально",
  "session.giteaIntegration.validation.failed": "Помилка перевірки",
  "session.giteaIntegration.draftBadge": "Чернетка",
  ...
  "chat.chatInput.actions.linkGiteaIssue": "Пов’язати Gitea issue",
  "chat.chatInput.actions.linkGiteaPr": "Пов’язати Gitea PR",
