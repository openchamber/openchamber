...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.queuedMessage.admissionPending": "Надсилання на сервер…",
  "chat.queuedMessage.admitted": "Додано до черги сервера · можна безпечно закрити",
  "chat.queuedMessage.localFallback": "Локальна черга · залиште клієнт відкритим",
  "chat.queuedMessage.admissionFailed": "Не вдалося додати до черги",
  "chat.queuedMessage.admissionUnknown": "Результат невідомий · не повторюйте, щоб уникнути дублювання",
  "chat.queuedMessage.retryAdmission": "Повторити додавання до черги",
  "chat.queuedMessage.restore": "Перемістити до редактора",
  "chat.queuedMessage.copy": "Копіювати текст",
  "chat.queuedMessage.dismiss": "Закрити",
  "chat.queuedMessage.copyFailed": "Не вдалося скопіювати текст повідомлення",
  "chat.queuedMessage.selectionLimitation": "Додавання на сервер використовує поточні налаштування моделі, агента й варіанта сесії",
