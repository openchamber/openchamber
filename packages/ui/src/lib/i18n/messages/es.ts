...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.messageBody.metrics.ttftInfo": "Tiempo hasta el primer token: cuánto tardó el modelo en empezar a responder tras la solicitud.",
  "chat.messageBody.metrics.tokensPerSecond": "{rate} tok/s",
  "chat.messageBody.metrics.tokensPerSecondInfo": "Tokens de salida por segundo de decodificación en streaming, sin incluir la ejecución de herramientas.",
