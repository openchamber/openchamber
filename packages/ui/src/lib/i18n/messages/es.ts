...
export const dict: Record<I18nKey, string> = {
  ...
  "contextRail.surface.server-browser.description": "Chrome ejecutándose en el servidor",
  ...
  "contextPanel.browser.newServerTab": "Nueva pestaña del navegador del servidor",
  "contextPanel.browser.remote.tabLabel": "Navegador del servidor",
  "contextPanel.browser.remote.sessionsMenu": "Sesiones del navegador",
  "contextPanel.browser.remote.savedSessions": "Sesiones guardadas",
  "contextPanel.browser.remote.availableSessions": "Sesiones en ejecución",
  "contextPanel.browser.remote.openDevTools": "Abrir Chrome DevTools",
  'contextPanel.browser.remote.contextMenuUnavailable': 'Las acciones del navegador no están disponibles para este clic. Usa la barra de herramientas o los botones del portapapeles.',
  "contextPanel.browser.remote.devTools": "Chrome DevTools",
  "contextPanel.browser.remote.simpleInspector": "Consola y red",
  "contextPanel.browser.remote.inspectMode": "Modo de inspección",
  "contextPanel.browser.remote.maximizeInspector": "Maximizar el inspector",
  "contextPanel.browser.remote.restoreInspector": "Restaurar la página y el inspector",
  "contextPanel.browser.remote.resizeInspector": "Cambiar el tamaño del inspector",
  "contextPanel.browser.remote.devtoolsLoading": "Conectando Chrome DevTools…",
  "contextPanel.browser.remote.devtoolsLoadFailed": "No se pudo cargar Chrome DevTools.",
  "contextPanel.browser.remote.devtoolsRetry": "Volver a conectar DevTools",
  "contextPanel.browser.remote.devtoolsControlLost": "Otro visor tomó el control. Vuelve a conectarte para continuar inspeccionando.",
  "contextPanel.browser.remote.devtoolsConnectionClosed": "La conexión de DevTools se cerró.",
  "contextPanel.browser.remote.devtoolsMessageTooLarge": "Un mensaje de DevTools superó el límite de tamaño.",
  "contextPanel.browser.remote.devtoolsBackpressure": "DevTools no pudo procesar los datos al ritmo de la conexión. Vuelve a conectarte para continuar.",
  "contextPanel.browser.remote.devtoolsInvalidRequest": "La conexión de DevTools recibió un mensaje no válido.",
  "contextPanel.browser.remote.devtoolsProtocolRejected": "Esta acción de DevTools no está disponible para esta página.",
  "contextPanel.browser.remote.devtoolsExclusive": "Para grabar el rendimiento, esta debe ser la única sesión del navegador en ejecución.",
  "contextPanel.browser.remote.devtoolsStartFailed": "No se pudo abrir DevTools para esta página.",
  "contextPanel.browser.remote.connecting": "Conectando con el navegador del servidor…",
  "contextPanel.browser.remote.reconnecting": "Conexión perdida. Reconectando…",
  "contextPanel.browser.remote.chooseTitle": "Sesiones del navegador del servidor",
  "contextPanel.browser.remote.chooseHint": "Conéctate a una sesión en ejecución o inicia una nueva.",
  "contextPanel.browser.remote.newSession": "Nueva sesión",
  "contextPanel.browser.remote.noSessions": "No hay sesiones del servidor en ejecución para este proyecto.",
  "contextPanel.browser.remote.sessionEphemeral": "Sesión del agente",
  "contextPanel.browser.remote.sessionProject": "Sesión del proyecto",
  "contextPanel.browser.remote.errorTitle": "El navegador del servidor no está disponible",
  "contextPanel.browser.remote.endedTitle": "Esta sesión del navegador del servidor ha finalizado",
  "contextPanel.browser.remote.retry": "Reintentar",
  "contextPanel.browser.remote.canvasAria": "Vista de la página remota",
  "contextPanel.browser.remote.keyboard": "Escribir en la página",
  "contextPanel.browser.remote.textInputAria": "Entrada de texto para la página remota",
  "contextPanel.browser.remote.clipboard.copy": "Copiar",
  "contextPanel.browser.remote.clipboard.paste": "Pegar",
  "contextPanel.browser.remote.clipboard.copied": "Copiado a tu portapapeles",
  "contextPanel.browser.remote.clipboard.pasted": "Pegado en la página",
  "contextPanel.browser.remote.clipboard.noSelection": "Selecciona texto en la página para copiarlo.",
  "contextPanel.browser.remote.clipboard.copyFailed": "No se pudo copiar la selección. Inténtalo de nuevo.",
  "contextPanel.browser.remote.clipboard.pasteFailed": "No se pudo pegar en la página. Inténtalo de nuevo.",
  "contextPanel.browser.remote.clipboard.tooLarge": "Este texto es demasiado grande para transferirlo.",
  "contextPanel.browser.remote.clipboard.copyFallbackTitle": "Copiar el texto seleccionado",
  "contextPanel.browser.remote.clipboard.copyFallbackDescription": "No se puede acceder al portapapeles. Selecciona y copia el texto de abajo.",
  "contextPanel.browser.remote.clipboard.copyTextAria": "Texto seleccionado de la página",
  "contextPanel.browser.remote.clipboard.pasteFallbackTitle": "Pegar en la página",
  "contextPanel.browser.remote.clipboard.pasteFallbackDescription": "Pega texto sin formato abajo y envíalo a la página.",
  "contextPanel.browser.remote.clipboard.pasteTextAria": "Texto para pegar en la página",
  "contextPanel.browser.remote.clipboard.emptyClipboard": "Tu portapapeles no contiene texto sin formato.",
  "contextPanel.browser.remote.clipboard.cancel": "Cancelar",
  "contextPanel.browser.remote.viewport.auto": "Automático",
  "contextPanel.browser.remote.viewport.preset": "Tamaño de vista predefinido",
  "contextPanel.browser.remote.viewport.custom": "Personalizado",
  "contextPanel.browser.remote.viewport.width": "Anchura",
  "contextPanel.browser.remote.viewport.height": "Altura",
  "contextPanel.browser.remote.viewport.rotate": "Girar",
  "contextPanel.browser.remote.viewport.mobile": "Emular dispositivo móvil",
  "contextPanel.browser.remote.viewport.scale": "Escala de visualización",
  "contextPanel.browser.remote.viewport.pending": "Aplicando tamaño de vista…",
  "contextPanel.browser.remote.viewport.error": "No se pudo cambiar el tamaño de vista: {code}",
  "contextPanel.browser.remote.viewport.agentControlled": "El agente controla esta vista",
  "contextPanel.browser.remote.viewport.external": "DevTools externo controla esta vista",
  "contextPanel.browser.remote.viewport.dimensionsConfirmed": "Confirmado: {width} × {height}",
  "contextPanel.browser.remote.inspector.title": "Inspector de página",
  "contextPanel.browser.remote.inspector.open": "Abrir el inspector de página",
  "contextPanel.browser.remote.inspector.close": "Cerrar el inspector",
  "contextPanel.browser.remote.inspector.console": "Consola",
  "contextPanel.browser.remote.inspector.network": "Red",
  "contextPanel.browser.remote.inspector.clear": "Limpiar",
  "contextPanel.browser.remote.inspector.filterPlaceholder": "Filtrar mensajes o solicitudes",
  "contextPanel.browser.remote.inspector.filterAria": "Filtrar entradas del inspector",
  "contextPanel.browser.remote.inspector.capturing": "Capturando esta pestaña",
  "contextPanel.browser.remote.inspector.starting": "Iniciando captura",
  "contextPanel.browser.remote.inspector.captureHint": "La captura comienza al abrir el inspector. Al cerrarlo se borran los datos capturados.",
  "contextPanel.browser.remote.inspector.dropped": "Entradas omitidas: {count}",
  "contextPanel.browser.remote.inspector.emptyConsole": "Los mensajes de la consola aparecerán aquí.",
  "contextPanel.browser.remote.inspector.filteredEmpty": "No hay entradas coincidentes.",
  "contextPanel.browser.remote.inspector.expressionAria": "JavaScript para ejecutar en la página",
  "contextPanel.browser.remote.inspector.expressionPlaceholder": "Ejecutar JavaScript en la página",
  "contextPanel.browser.remote.inspector.run": "Ejecutar",
  "contextPanel.browser.remote.inspector.running": "Ejecutando",
  "contextPanel.browser.remote.inspector.previousCommand": "Comando anterior",
  "contextPanel.browser.remote.inspector.nextCommand": "Comando siguiente",
  "contextPanel.browser.remote.inspector.shortcutHint": "Ctrl/Cmd+Enter para ejecutar. Enter añade una línea nueva.",
  "contextPanel.browser.remote.inspector.truncated": "Truncado",
  "contextPanel.browser.remote.inspector.errorUnavailable": "El inspector de página no está disponible. Vuelve a abrirlo para intentarlo de nuevo.",
  "contextPanel.browser.remote.inspector.errorInvalid": "Introduce JavaScript de hasta 16.000 caracteres.",
  "contextPanel.browser.remote.inspector.errorCaptureGone": "La captura ha finalizado. Vuelve a abrir el inspector para empezar de nuevo.",
  "contextPanel.browser.remote.inspector.errorEvaluation": "No se pudo ejecutar el JavaScript. Inténtalo de nuevo.",
  "contextPanel.browser.remote.inspector.errorTimeout": "JavaScript superó el tiempo límite. Es posible que la página siga ejecutándolo.",
  "contextPanel.browser.remote.inspector.errorRequestGone": "Esta solicitud ya no está disponible.",
  "contextPanel.browser.remote.inspector.errorRequest": "No se pudo cargar esta solicitud. Inténtalo de nuevo.",
  "contextPanel.browser.remote.inspector.errorCapture": "No se pudo iniciar la captura. Vuelve a abrir el inspector para intentarlo de nuevo.",
  "contextPanel.browser.remote.inspector.resultAria": "Resultado de JavaScript",
  "contextPanel.browser.remote.inspector.commandAria": "JavaScript ejecutado",
  "contextPanel.browser.remote.inspector.level.debug": "Depuración",
  "contextPanel.browser.remote.inspector.level.info": "Información",
  "contextPanel.browser.remote.inspector.level.log": "Registro",
  "contextPanel.browser.remote.inspector.level.warning": "Advertencia",
  "contextPanel.browser.remote.inspector.level.error": "Error",
  "contextPanel.browser.remote.inspector.network.empty": "Todavía no se han capturado solicitudes.",
  "contextPanel.browser.remote.inspector.network.noMatches": "Ninguna solicitud coincide con este filtro.",
  "contextPanel.browser.remote.inspector.network.selectRequest": "Selecciona una solicitud para inspeccionarla.",
  "contextPanel.browser.remote.inspector.network.details": "Detalles de la solicitud",
  "contextPanel.browser.remote.inspector.network.closeDetails": "Cerrar los detalles de la solicitud",
  "contextPanel.browser.remote.inspector.network.loading": "Cargando los detalles de la solicitud",
  "contextPanel.browser.remote.inspector.network.loadBodies": "Cargar cuerpos",
  "contextPanel.browser.remote.inspector.network.requestHeaders": "Cabeceras de la solicitud",
  "contextPanel.browser.remote.inspector.network.responseHeaders": "Cabeceras de la respuesta",
  "contextPanel.browser.remote.inspector.network.requestBody": "Cuerpo de la solicitud",
  "contextPanel.browser.remote.inspector.network.responseBody": "Cuerpo de la respuesta",
  "contextPanel.browser.remote.inspector.network.noHeaders": "No hay cabeceras disponibles.",
  "contextPanel.browser.remote.inspector.network.noBody": "No hay cuerpo disponible.",
  "contextPanel.browser.remote.inspector.network.bodiesNotRequested": "Los cuerpos solo se cargan cuando los solicitas.",
  "contextPanel.browser.remote.inspector.network.bodiesUnavailable": "Los cuerpos de esta solicitud ya no están disponibles.",
  "contextPanel.browser.remote.inspector.network.bodiesUnsupported": "La vista previa del cuerpo no es compatible con esta respuesta.",
  "contextPanel.browser.remote.inspector.network.truncated": "Vista previa truncada.",
  "contextPanel.browser.remote.inspector.network.method": "Método",
  "contextPanel.browser.remote.inspector.network.url": "URL",
  "contextPanel.browser.remote.inspector.network.status": "Estado HTTP",
  "contextPanel.browser.remote.inspector.network.duration": "Duración",
  "contextPanel.browser.remote.inspector.network.size": "Transferido",
  "contextPanel.browser.remote.inspector.network.state": "Estado",
  "contextPanel.browser.remote.inspector.network.cached": "Desde la caché",
  "contextPanel.browser.remote.inspector.network.failure": "Fallo",
  "contextPanel.browser.remote.inspector.network.resourceType": "Tipo",
  "contextPanel.browser.remote.inspector.network.mimeType": "Tipo de contenido",
  "contextPanel.browser.remote.inspector.network.pending": "Pendiente",
  "contextPanel.browser.remote.inspector.network.complete": "Completada",
  "contextPanel.browser.remote.inspector.network.failed": "Fallida",
  "contextPanel.browser.remote.inspector.network.unknown": "No disponible",
  "contextPanel.browser.remote.inspector.network.yes": "Sí",
  "contextPanel.browser.remote.inspector.network.no": "No",
  "contextPanel.browser.remote.inspector.network.failedDetails": "No se pudieron cargar los detalles de la solicitud. Inténtalo de nuevo.",
  "contextPanel.browser.remote.inspector.network.requestGone": "Esta solicitud ya no está disponible.",
  "contextPanel.browser.remote.inspector.network.captureGone": "Esta captura ha finalizado.",
  ...
  "contextPanel.browser.agentControlling": "Agente en control",
