...
export const dict: Record<I18nKey, string> = {
  ...
  "walkthrough.scope.basePickerTitle": "Selecciona una rama base",
  "walkthrough.scope.basePickerDescription": "Recorre los cambios de esta rama en comparación con una base que elijas.",
  "walkthrough.scope.changeBase": "Cambiar la rama base...",
