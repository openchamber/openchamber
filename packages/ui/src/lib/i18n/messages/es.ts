...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.notifications.openAria': 'Notificaciones',
  'layout.notifications.openTitle': 'Notificaciones',
  'layout.notifications.title': 'Notificaciones',
  'layout.notifications.empty': 'Aún no hay notificaciones',
  'layout.notifications.emptyFiltered': 'Nada coincide con los filtros actuales',
  'layout.notifications.markAllRead': 'Marcar todo como leído',
  'layout.notifications.clearAll': 'Borrar todo',
  'layout.notifications.remove': 'Quitar notificación',
  'layout.notifications.sessionSubtaskFinished': 'Subtarea terminada',
  'layout.notifications.sessionSubtaskError': 'Error de subtarea',
  'layout.notifications.openSettings': 'Ajustes de notificaciones',
  'layout.notifications.unreadCountAria': '{count} notificaciones sin leer',
  'layout.notifications.sessionFinished': 'Sesión terminada',
  'layout.notifications.sessionError': 'Error de sesión',
  'layout.notifications.permissionNeeded': 'Se necesita permiso',
  'layout.notifications.permissionFallback': 'El agente necesita tu aprobación',
  'layout.notifications.inputNeeded': 'Se necesita una respuesta',
  'layout.notifications.questionFallback': 'El agente espera tu respuesta',
  'layout.notifications.openSession': 'Abrir sesión',
  'layout.notifications.occurrenceCount': '×{count}',
  'layout.notifications.time.justNow': 'Ahora',
