...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.chatInput.toast.messageSendFailed": "El mensaje no se pudo enviar. Tu mensaje y adjuntos han sido restaurados.",
  "chat.chatInput.toast.messageSendMaybeFailed": "El mensaje podría no haberse enviado. Tu mensaje se ha conservado — revísalo antes de reintentar.",
  "chat.chatInput.toast.messageRestoredToInput": "Tu mensaje ha sido restaurado al campo de entrada.",
