...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.context.description': 'Lo que una identidad no resuelve por sí sola: el shell del agente, las demás direcciones del repositorio y los permisos aparte que necesitan los submódulos y Git LFS. Las identidades se gestionan en Ajustes de Git.',
  ...
  'gitView.identity.unavailableScheme': 'Necesita un remoto {scheme}',
  'gitView.context.settings': 'Abrir ajustes de Git',
  'gitView.operation.title': 'Operación de Git',
  'gitView.operation.recovery.storage': 'El almacenamiento de recuperación de Git no está disponible. Restablece el almacenamiento del navegador y actualiza. Las nuevas modificaciones están bloqueadas.',
  'gitView.operation.recovery.capacity': 'El almacenamiento de recuperación de Git está lleno. Resuelve las operaciones guardadas antes de iniciar otra.',
  'gitView.operation.recovery.reconciling': 'Comprobando las referencias de operaciones de Git guardadas…',
  'gitView.operation.recovery.repository': 'No se pudo verificar el repositorio. Actualiza antes de iniciar otra operación de Git.',
  'gitView.operation.recovery.inspect': 'Si el servidor ya no reconoce este ID, inspecciona el repositorio local y el remoto fuera de OpenChamber. La referencia guardada sigue bloqueada; la falta de estado nunca autoriza repetir una transferencia.',
  'gitView.operation.localCommit': 'El commit local se ha creado y se conserva.',
  'gitView.operation.unknownHint': 'El resultado es desconocido. Actualiza esta operación antes de iniciar otra transferencia. No se repetirá nada automáticamente.',
  'gitView.operation.refresh': 'Actualizar operación',
  'gitView.operation.cancel': 'Cancelar operación',
  'gitView.operation.state.unavailable': 'Estado de la operación no disponible',
  'gitView.operation.state.planned': 'Planificada',
  'gitView.operation.state.running': 'En curso',
  'gitView.operation.state.succeeded': 'Completada',
  'gitView.operation.state.partial': 'Completada parcialmente',
  'gitView.operation.state.failed': 'Fallida',
  'gitView.operation.state.cancelled': 'Cancelada',
  'gitView.operation.state.outcome-unknown': 'Resultado desconocido',
  'gitView.operation.state.conflicted': 'Conflicto',
  'gitView.operation.state.skipped': 'Omitida',
  'gitView.operation.completed.validated': 'Repositorio y destino validados',
  'gitView.operation.completed.authenticated': 'Autenticación completada',
  'gitView.operation.completed.transferred': 'Transferencia completada',
  'gitView.operation.completed.updated-local-repository': 'Repositorio local actualizado',
  'gitView.operation.completed.checked-out': 'Checkout completado',
  'gitView.operation.completed.cleaned-up': 'Limpieza completada',
  'gitView.remotes.title': 'Otros remotos',
  'gitView.remotes.description': 'Direcciones que este repositorio tiene además de aquella a la que se aplicó su identidad. Mientras no se conceda una, OpenChamber ni descarga de ella ni envía a ella.',
  'gitView.remotes.grant': 'Responder como {identity}',
  'gitView.hydration.title': 'Completar el checkout',
  'gitView.hydration.description': 'Inicializa submódulos y descarga contenido de Git LFS con autorización independiente para cada destino.',
  ...
  'gitView.hydration.kind.submodule': 'Submódulo',
  'gitView.hydration.kind.lfs': 'Git LFS',
  'gitView.hydration.status.succeeded': 'Completado',
  'gitView.hydration.status.failed': 'Error',
  'gitView.hydration.status.cancelled': 'Cancelado',
  'gitView.hydration.status.authorization-required': 'Autorización necesaria',
  'gitView.hydration.status.invalid': 'Configuración no válida',
  'gitView.hydration.status.client-missing': 'Falta el cliente',
  'gitView.hydration.status.not-needed': 'No es necesario',
  'gitView.publish.title': 'Publicar',
  'gitView.publish.commitKept': 'El commit local se creó y se ha conservado. La publicación no se completó correctamente.',
  'gitView.publish.syncTitle': 'Elegir destinos de sincronización',
  'gitView.publish.description': 'Publica {branch} en un destino Git exacto. Las cuentas del proveedor no seleccionan el destino.',
  'gitView.publish.fetchSource': 'Remoto de origen para obtener cambios',
  'gitView.publish.sourceBranch': 'Rama de origen',
  'gitView.publish.fetchFirst': 'No hay ramas en caché para este remoto. Cancela y obtén los cambios primero.',
  'gitView.publish.pushDestination': 'Remoto de destino para enviar cambios',
  'gitView.publish.selectRemote': 'Selecciona un remoto vinculado',
  'gitView.publish.destinationBranch': 'Rama de destino',
  'gitView.publish.noGrants': 'Configura un vínculo de transporte Git antes de publicar.',
  'gitView.publish.contributorCommitFirst': 'Este árbol de trabajo de colaborador requiere aprobar el destino después del commit. ¿Continuar? Si cancelas la publicación después, se conservará el commit local.',
  'gitView.publish.detached': 'No se admite publicar con HEAD separado. Cambia primero a una rama local.',
  'gitView.publish.stale': 'La rama o la autorización de Git ha cambiado. No se ha reintentado nada. Elige el destino de nuevo.',
  'gitView.publish.cancelled': 'Publicación cancelada. No se inició ninguna transferencia Git.',
  'gitView.publish.succeeded': 'Publicado en el destino seleccionado',
  ...
  'chat.shellBoundary.status': 'Sin verificar · fuera del límite gestionado',
  'chat.shellBoundary.agentAria': 'La ejecución de shell del agente no está verificada y está fuera del límite de Git administrado',
  'chat.shellBoundary.userAria': 'La ejecución de shell del usuario no está verificada y está fuera del límite de Git administrado',
  ...
  "worktree.bootstrap.toast.authorizationRequired": "Autoriza el repositorio del checkout y sus submódulos, y vuelve a intentarlo.",
  ...
  "gitView.pr.actions.openOnProvider": "Abrir en {provider}",
  "gitView.pr.actions.openOnProviderAria": "Abrir la solicitud de cambios en {provider}",
  ...
  "gitView.pr.providerNotConnected": "{provider} no está conectado",
  ...
  "gitView.pr.capabilitiesUnavailable": "No se pudieron cargar las funciones del proveedor",
  ...
  'gitView.contributor.chooseDestination': 'Selecciona el destino exacto para esta rama de colaborador.',
  'gitView.contributor.destination.contributor-fork': 'Bifurcación del colaborador',
  'gitView.contributor.destination.own-fork': 'Tu bifurcación',
  'gitView.contributor.destination.bound-repository': 'Repositorio vinculado',
  'gitView.contributor.destination.other': 'Otro remoto',
  'gitView.toast.contributorPublishCancelled': 'Se canceló la publicación. No se modificó ningún remoto.',
  'gitView.toast.contributorPublishCancelledAfterUpdate': 'Los cambios se actualizaron localmente, pero se canceló la publicación.',
  "gitView.toast.unstageFileFailed": "No se pudieron quitar los cambios del área preparada",
  "gitView.confirm.systemTransport": "Git del sistema puede usar credenciales configuradas en este equipo. ¿Continuar con esta operación de Git?",
  ...
  "directoryExplorerDialog.clone.setupRequired": "Se conservó la copia de trabajo y se añadió el proyecto. Completa la vinculación del transporte en el panel Git. No vuelvas a clonar.",
  "directoryExplorerDialog.clone.identityMismatch": "Esta identidad no puede alcanzar esa dirección. Elige una cuyo transporte coincida.",
  "directoryExplorerDialog.clone.unsupported": "La clonación no está disponible en el entorno de VS Code.",
  "directoryExplorerDialog.existing.bindFailed": "Proyecto añadido. No se pudo vincular la cuenta de control de código; configúrala en el panel de Git.",
  ...
  "session.changeRequestPicker.error.noProvider": "No se encontró un remoto de control de código compatible",
  "session.changeRequestPicker.title": "Vincular solicitud de cambios",
  "session.changeRequestPicker.description": "Selecciona un pull request o merge request para adjuntar contexto de revisión a este mensaje.",
  "session.changeRequestPicker.searchPlaceholder": "Busca por título o número, o pega la URL de una solicitud de cambios",
  "session.changeRequestPicker.includeDiffAria": "Incluir el diff de la solicitud de cambios en el contexto adjunto",
  "session.changeRequestPicker.includeDiff": "Incluir diff",
  "session.changeRequestPicker.loading.changeRequests": "Cargando solicitudes de cambios...",
  "session.changeRequestPicker.actions.useChangeRequest": "Usar solicitud de cambios {reference}",
  "session.changeRequestPicker.empty.noneFound": "No se encontraron solicitudes de cambios",
  "session.changeRequestPicker.empty.noneOpen": "No se encontraron solicitudes de cambios abiertas",
  "session.issuePicker.title": "Vincular incidencia",
  "session.issuePicker.description": "Selecciona una incidencia para adjuntar su contexto a este mensaje.",
  "session.issuePicker.searchPlaceholder": "Busca por título o número, o pega la URL de una incidencia",
  "session.issuePicker.loading.issues": "Cargando incidencias...",
  "session.issuePicker.actions.useIssue": "Usar incidencia #{number}",
  "session.issuePicker.empty.noneFound": "No se encontraron incidencias",
  "session.issuePicker.empty.noneOpen": "No se encontraron incidencias abiertas",
  ...
  'session.newWorktree.error.changeRequestAuthorityMissing': 'La autorización de la solicitud de cambios ya no está disponible. Vuelve a seleccionarla.',
  'session.newWorktree.trust.confirmation': 'Este checkout contiene acciones ejecutables:\n\n{actions}\n\n¿Ejecutarlas ahora? Cancelar deja el checkout listo para Git sin ejecutarlas.',
