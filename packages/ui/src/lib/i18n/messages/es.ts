...
export const dict: Record<I18nKey, string> = {
  ...
  "gitView.header.upstreamFetchAria": "Fetch de {target}",
  "gitView.header.upstreamFetchTooltip": "Fetch de {target}",
  "gitView.header.upstreamSyncAria": "Sincronizar desde {target}",
  "gitView.header.upstreamSyncTooltip": "Fetch y luego pull desde {target}",
  ...
  "gitView.sync.fetchTrackingTooltip": "Fetch de la rama rastreada {tracking}",
  "gitView.sync.pull": "Pull",
  "gitView.sync.pullTooltip": "Hacer pull",
  "gitView.sync.pullTooltipBehind": "Hacer pull ({count} detrás)",
  "gitView.sync.pullTrackingTooltip": "Pull desde la rama rastreada {tracking}",
  "gitView.sync.pullTrackingTooltipBehind": "Pull desde la rama rastreada {tracking} ({count} detrás)",
  "gitView.sync.push": "Push",
  "gitView.sync.pushTooltip": "Hacer push",
  "gitView.sync.pushTooltipAhead": "Hacer push ({count} por delante)",
  "gitView.sync.pushTrackingTooltip": "Push a la rama rastreada {tracking}",
  "gitView.sync.pushTrackingTooltipAhead": "Push a la rama rastreada {tracking} ({count} por delante)",
  "gitView.sync.upstreamFetch": "Fetch de upstream",
  "gitView.sync.upstreamSync": "Sincronizar upstream",
