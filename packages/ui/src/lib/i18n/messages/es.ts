...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.fork.toast.pinsDropped": "La sesión se bifurcó, pero no se copiaron todos los mensajes fijados",
  "sessions.fork.toast.error": "No se pudo bifurcar la sesión",
  "sessions.fork.toast.leftover": "Falló la configuración de la bifurcación, pero la nueva sesión aún existe",
  ...
  "chat.messageBody.startFromAnswerDialog.createWorktree": "Crear worktree",
