...
export const dict: Record<I18nKey, string> = {
  ...
  "contextPanel.mode.mr": "Solicitud de fusión",
  ...
  "contextPanel.gitlabMr.createMr.titleLabel": "Título",
  "contextPanel.gitlabMr.createMr.titlePlaceholder": "Título de la solicitud de fusión",
  "contextPanel.gitlabMr.createMr.descriptionLabel": "Descripción",
  ...
  "contextPanel.gitlabMr.updateMr.save": "Guardar",
  "contextPanel.gitlabMr.updateMr.saving": "Guardando...",
  "contextPanel.gitlabMr.updateMr.toast.updated": "Solicitud de fusión actualizada",
  "contextPanel.gitlabMr.updateMr.toast.updateFailed": "No se pudo actualizar la solicitud de fusión",
  "contextPanel.gitlabMr.mergeMr.action": "Fusionar",
  "contextPanel.gitlabMr.mergeMr.squash": "Combinar commits",
  "contextPanel.gitlabMr.mergeMr.merging": "Fusionando...",
  "contextPanel.gitlabMr.mergeMr.toast.merged": "La solicitud de fusión se fusionó",
  "contextPanel.gitlabMr.mergeMr.toast.mergeFailed": "No se pudo fusionar la solicitud de fusión",
  "contextPanel.giteaPr.title": "PR",
  "contextPanel.giteaPr.tabs.pullRequests": "PR",
  "contextPanel.giteaPr.tabs.issues": "Issues",
  "contextPanel.giteaPr.branchSectionTitle": "Rama actual",
  "contextPanel.giteaPr.openPrTitle": "PR abiertas",
  "contextPanel.giteaPr.listSectionTitle": "En este repositorio",
  "contextPanel.giteaPr.openPrEmpty": "No hay PR abiertas",
  "contextPanel.giteaPr.noPrForBranch": "No hay PR para esta rama",
  "contextPanel.giteaPr.loadContext": "Cargar contexto",
  "contextPanel.giteaPr.hideContext": "Ocultar contexto",
  "contextPanel.giteaPr.openInGitea": "Abrir en Gitea",
  "contextPanel.giteaPr.draft": "Borrador",
  "contextPanel.giteaPr.state.opened": "Abierta",
  "contextPanel.giteaPr.state.merged": "Fusionada",
  "contextPanel.giteaPr.state.closed": "Cerrada",
  "contextPanel.giteaPr.loadMore": "Cargar más",
  "contextPanel.giteaPr.loading": "Cargando...",
  "contextPanel.giteaPr.error.loadFailed": "No se pudieron cargar las PR",
  "contextPanel.giteaPr.error.notConnected": "Gitea no está conectado",
  "contextPanel.giteaPr.empty.noActiveProject": "Sin proyecto activo",
  "contextPanel.giteaPr.actions.openSettings": "Abrir ajustes",
  "contextPanel.giteaPr.issues.detail.back": "Volver a issues",
  "contextPanel.giteaPr.issues.detail.commentsEmpty": "Sin comentarios",
  "contextPanel.giteaPr.issues.empty": "No hay issues abiertos",
  "contextPanel.giteaPr.issues.error.loadFailed": "Error al cargar los issues",
  "contextPanel.giteaPr.issues.listSectionTitle": "Issues abiertos",
  "contextPanel.giteaPr.createPr.title": "Nueva PR",
  "contextPanel.giteaPr.createPr.sourceBranch": "Rama de origen",
  "contextPanel.giteaPr.createPr.targetBranch": "Rama de destino",
  "contextPanel.giteaPr.createPr.titleLabel": "Título",
  "contextPanel.giteaPr.createPr.titlePlaceholder": "Título de la PR",
  "contextPanel.giteaPr.createPr.descriptionLabel": "Descripción",
  "contextPanel.giteaPr.createPr.removeSourceBranch": "Eliminar la rama de origen al fusionar",
  "contextPanel.giteaPr.createPr.submit": "Crear PR",
  "contextPanel.giteaPr.createPr.submitting": "Creando...",
  "contextPanel.giteaPr.createPr.branchesLoading": "Cargando ramas...",
  "contextPanel.giteaPr.createPr.toast.created": "PR creada",
  "contextPanel.giteaPr.createPr.toast.createFailed": "No se pudo crear la PR",
  "contextPanel.giteaPr.updatePr.toggle": "Editar título y descripción",
  "contextPanel.giteaPr.updatePr.save": "Guardar",
  "contextPanel.giteaPr.updatePr.saving": "Guardando...",
  "contextPanel.giteaPr.updatePr.toast.updated": "PR actualizada",
  "contextPanel.giteaPr.updatePr.toast.updateFailed": "No se pudo actualizar la PR",
  "contextPanel.giteaPr.mergePr.action": "Fusionar",
  "contextPanel.giteaPr.mergePr.squash": "Combinar commits",
  "contextPanel.giteaPr.mergePr.merging": "Fusionando...",
  "contextPanel.giteaPr.mergePr.toast.merged": "La PR se fusionó",
  "contextPanel.giteaPr.mergePr.toast.mergeFailed": "No se pudo fusionar la PR",
  ...
  "contextRail.surface.mr.description": "Crea, revisa y fusiona la solicitud de fusión de la rama actual",
  ...
  "session.gitlabIssuePicker.searchPlaceholder": "Buscar por título o pega la URL del issue",
  ...
  "session.giteaIssuePicker.error.noActiveProject": "No hay ningún proyecto activo",
  "session.giteaIssuePicker.error.runtimeUnavailable": "API de runtime de Gitea no disponible",
  "session.giteaIssuePicker.error.notConnected": "Gitea no está conectado",
  "session.giteaIssuePicker.error.repoNotResolvable": "No se pudo resolver el repositorio",
  "session.giteaIssuePicker.error.repoMustBeGitea": "El remoto origin debe ser una URL de Gitea",
  "session.giteaIssuePicker.error.issueNotFound": "No se encontró el issue",
  "session.giteaIssuePicker.error.noModelSelected": "No hay ningún modelo seleccionado",
  "session.giteaIssuePicker.toast.loadMoreFailed": "No se pudo cargar más issues",
  "session.giteaIssuePicker.toast.loadIssueDetailsFailed": "No se pudieron cargar los detalles del issue",
  "session.giteaIssuePicker.toast.sendContextFailed": "No se pudo enviar el contexto del issue",
  "session.giteaIssuePicker.toast.sessionCreated": "Sesión creada desde el issue",
  "session.giteaIssuePicker.toast.startSessionFailed": "No se pudo iniciar la sesión",
  "session.giteaIssuePicker.title.select": "Vincular issue de Gitea",
  "session.giteaIssuePicker.title.createSession": "Nueva sesión desde issue de Gitea",
  "session.giteaIssuePicker.description.select": "Selecciona un issue para vincularlo a esta sesión.",
  "session.giteaIssuePicker.description.createSession": "Inicia una nueva sesión con contexto oculto del issue (título/cuerpo/etiquetas/comentarios).",
  "session.giteaIssuePicker.searchPlaceholder": "Buscar por título o pega la URL del issue",
  "session.giteaIssuePicker.empty.noActiveProject": "No hay ningún proyecto activo seleccionado.",
  "session.giteaIssuePicker.empty.runtimeUnavailable": "API de runtime de Gitea no disponible.",
  "session.giteaIssuePicker.empty.notConnected": "Gitea no está conectado. Conecta tu cuenta de Gitea en configuración.",
  "session.giteaIssuePicker.empty.noIssuesFound": "No se encontraron issues",
  "session.giteaIssuePicker.empty.noOpenIssuesFound": "No se encontraron issues abiertos",
  "session.giteaIssuePicker.loading.issues": "Cargando issues...",
  "session.giteaIssuePicker.loading.more": "Cargando...",
  "session.giteaIssuePicker.actions.openSettings": "Abrir configuración",
  "session.giteaIssuePicker.actions.useIssue": "Usar issue #{number}",
  "session.giteaIssuePicker.actions.openInGiteaAria": "Abrir en Gitea",
  "session.giteaIssuePicker.actions.loadMore": "Cargar más",
  "session.giteaIssuePicker.actions.sectionTitle": "Acciones",
  "session.giteaIssuePicker.actions.toggleWorktreeAria": "Activar worktree",
  "session.giteaIssuePicker.actions.createInWorktree": "Crear en worktree",
  "session.giteaIssuePicker.actions.openRepo": "Abrir repositorio",
  "session.giteaIssuePicker.actions.refresh": "Actualizar",
  ...
  "session.gitlabMrPicker.error.mrNotFound": "No se encontró el MR",
  ...
  "session.gitlabMrPicker.toast.loadDetailsFailed": "No se pudieron cargar los detalles del MR",
  "session.gitlabMrPicker.title": "Vincular MR de GitLab",
  "session.gitlabMrPicker.description": "Selecciona un MR para adjuntar contexto de revisión a este mensaje.",
  "session.gitlabMrPicker.searchPlaceholder": "Buscar por título o pega la URL del MR",
  "session.gitlabMrPicker.includeDiffAria": "Incluir diff del MR en el contexto adjunto",
  "session.gitlabMrPicker.includeDiff": "Incluir diff del MR",
  ...
  "session.gitlabMrPicker.empty.noMergeRequestsFound": "No se encontraron MR",
  "session.gitlabMrPicker.empty.noOpenMergeRequestsFound": "No se encontraron MR abiertos",
  "session.gitlabMrPicker.loading.mergeRequests": "Cargando MR...",
  "session.gitlabMrPicker.loading.more": "Cargando...",
  "session.gitlabMrPicker.actions.openSettings": "Abrir configuración",
  "session.gitlabMrPicker.actions.useMergeRequest": "Usar MR !{number}",
  "session.gitlabMrPicker.actions.openInGitLabAria": "Abrir en GitLab",
  "session.gitlabMrPicker.actions.loadMore": "Cargar más",
  "session.giteaPrPicker.error.noActiveProject": "No hay ningún proyecto activo",
  "session.giteaPrPicker.error.runtimeUnavailable": "API de runtime de Gitea no disponible",
  "session.giteaPrPicker.error.notConnected": "Gitea no está conectado",
  "session.giteaPrPicker.error.prNotFound": "No se encontró la PR",
  "session.giteaPrPicker.error.repoNotResolvable": "No se pudo resolver el repositorio",
  "session.giteaPrPicker.error.repoMustBeGitea": "El remoto origin debe ser una URL de Gitea",
  "session.giteaPrPicker.toast.loadMoreFailed": "No se pudieron cargar más PR",
  "session.giteaPrPicker.toast.loadDetailsFailed": "No se pudieron cargar los detalles de la PR",
  "session.giteaPrPicker.title": "Vincular PR de Gitea",
  "session.giteaPrPicker.description": "Selecciona una PR para adjuntar contexto de revisión a este mensaje.",
  "session.giteaPrPicker.searchPlaceholder": "Buscar por título o pega la URL de la PR",
  "session.giteaPrPicker.includeDiffAria": "Incluir diff de la PR en el contexto adjunto",
  "session.giteaPrPicker.includeDiff": "Incluir diff de la PR",
  "session.giteaPrPicker.empty.noActiveProject": "No hay ningún proyecto activo seleccionado.",
  "session.giteaPrPicker.empty.runtimeUnavailable": "API de runtime de Gitea no disponible.",
  "session.giteaPrPicker.empty.notConnected": "Gitea no está conectado. Conecta tu cuenta de Gitea en configuración.",
  "session.giteaPrPicker.empty.noPullRequestsFound": "No se encontraron PR",
  "session.giteaPrPicker.empty.noOpenPullRequestsFound": "No se encontraron PR abiertas",
  "session.giteaPrPicker.loading.pullRequests": "Cargando PR...",
  "session.giteaPrPicker.loading.more": "Cargando...",
  "session.giteaPrPicker.actions.openSettings": "Abrir configuración",
  "session.giteaPrPicker.actions.usePullRequest": "Usar PR #{number}",
  "session.giteaPrPicker.actions.openInGiteaAria": "Abrir en Gitea",
  "session.giteaPrPicker.actions.loadMore": "Cargar más",
  ...
  "session.newWorktree.actions.startFromGitLabIssueMr": "Iniciar desde Issue/MR de GitLab",
  "session.newWorktree.usingPrBranch": "Usando rama de la PR: {branch}",
  "session.newWorktree.usingMrBranch": "Usando rama del MR: {branch}",
  ...
  "session.newWorktree.toast.sessionFromMr": "Sesión creada desde merge request",
  ...
  "session.gitlabIntegration.connect.description": "Vincula issues o merge requests para rellenar automáticamente los detalles del worktree",
  "session.gitlabIntegration.connect.action": "Conectar a GitLab",
  "session.gitlabIntegration.search.issuesPlaceholder": "Buscar issues de GitLab",
  "session.gitlabIntegration.search.mrsPlaceholder": "Buscar merge requests de GitLab",
  "session.gitlabIntegration.empty.noIssuesFound": "No se encontraron issues",
  "session.gitlabIntegration.empty.noMergeRequestsFound": "No se encontraron merge requests",
  ...
  "session.gitlabIntegration.draftBadge": "Borrador",
  "session.giteaIntegration.title": "Seleccionar desde Gitea",
  "session.giteaIntegration.tabs.issues": "Issues",
  "session.giteaIntegration.tabs.pullRequests": "PR",
  "session.giteaIntegration.connect.title": "Conectar a Gitea",
  "session.giteaIntegration.connect.description": "Vincula issues o PR para rellenar automáticamente los detalles del worktree",
  "session.giteaIntegration.connect.action": "Conectar a Gitea",
  "session.giteaIntegration.search.issuesPlaceholder": "Buscar issues de Gitea",
  "session.giteaIntegration.search.prsPlaceholder": "Buscar PR de Gitea",
  "session.giteaIntegration.empty.noIssuesFound": "No se encontraron issues",
  "session.giteaIntegration.empty.noPullRequestsFound": "No se encontraron PR",
  "session.giteaIntegration.actions.loadMore": "Cargar más",
  "session.giteaIntegration.actions.cancel": "Cancelar",
  "session.giteaIntegration.actions.select": "Seleccionar",
  "session.giteaIntegration.selected.issueNumber": "Issue #{number}",
  "session.giteaIntegration.selected.prNumber": "PR #{number}",
  "session.giteaIntegration.includeDiffAria": "Incluir diff de la PR en el contexto de la sesión",
  "session.giteaIntegration.includeDiff": "Incluir diff de la PR",
  "session.giteaIntegration.error.notConnected": "Gitea no está conectado",
  "session.giteaIntegration.error.loadDataFailed": "No se pudieron cargar los datos",
  "session.giteaIntegration.validation.branchAlreadyCheckedOut": "La rama ya está en uso en un worktree",
  "session.giteaIntegration.validation.branchAlreadyExists": "La rama ya existe localmente",
  "session.giteaIntegration.validation.failed": "No se pudo validar",
  "session.giteaIntegration.draftBadge": "Borrador",
  ...
  "chat.chatInput.actions.linkGiteaIssue": "Vincular issue de Gitea",
  "chat.chatInput.actions.linkGiteaPr": "Vincular PR de Gitea",
