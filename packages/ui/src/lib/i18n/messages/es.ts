...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.messageBody.actions.forkSessionWithContext": "Bifurcar la sesión aquí con todo el contexto",
  ...
  "chat.messageBody.toast.forkSessionFailed": "No se pudo bifurcar la sesión",
