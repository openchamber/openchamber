...
export const dict: Record<I18nKey, string> = {
  ...
  "sideChat.label": "Desechable",
  "sideChat.promote": "Conservar",
  "sideChat.promotion.error": "No se pudo conservar el chat lateral",
  "sideChat.cleanup.error": "No se pudo eliminar el chat lateral",
  "sideChat.discard.title": "¿Descartar este chat lateral?",
  "sideChat.discard.description": "El trabajo activo se detendrá y esta conversación se eliminará permanentemente.",
  "sideChat.discard.sideEffects": "Los cambios en archivos, los comandos y otros efectos de las herramientas permanecerán.",
  "sideChat.discard.cancel": "Conservar chat",
  "sideChat.discard.confirm": "Detener y eliminar",
  "sideChat.recovery.title": "¿Recuperar chat lateral?",
  "sideChat.recovery.description": "OpenChamber encontró un chat lateral desechable dejado por una limpieza interrumpida.",
  "sideChat.recovery.sessionLabel": "Chat lateral {sessionID}",
  "sideChat.recovery.recover": "Recuperar",
  "sideChat.recovery.delete": "Eliminar",
  ...
  "chat.commandAutocomplete.command.sideDescription": "Abre un chat lateral desechable. Se elimina al cerrarlo, salvo que lo conserves.",
  "chat.commandAutocomplete.command.btwDescription": "Alias de /side. Abre un chat desechable junto a esta conversación.",
