...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.dialogs.worktreeDelete.disposition.label": "Sesiones vinculadas",
  "sessions.sidebar.dialogs.worktreeDelete.disposition.archive": "Archivar sesiones vinculadas",
  "sessions.sidebar.dialogs.worktreeDelete.disposition.delete": "Eliminar sesiones vinculadas permanentemente",
  "sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionOneLinked": "Esta acción elimina el worktree seleccionado y borra permanentemente {count} sesión vinculada.",
  "sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionManyLinked": "Esta acción elimina el worktree seleccionado y borra permanentemente {count} sesiones vinculadas.",
