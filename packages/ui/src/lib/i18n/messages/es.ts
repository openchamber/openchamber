...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala ALIAS ADE para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "ALIAS ADE se instaló",
  ...
  "sessions.sidebar.footer.actions.aboutAliasAde": "Acerca de ALIAS ADE",
  ...
  "header.services.shutdownDev": "Detener ALIAS ADE",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de ALIAS ADE, el estado de OpenCode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por ALIAS ADE de manera eficiente",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear ALIAS ADE",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de ALIAS ADE",
  ...
  "multiRun.window.description": "Ventana de ALIAS ADE Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a ALIAS ADE",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si ALIAS ADE no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de ALIAS ADE. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de ALIAS ADE y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de ALIAS ADE para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor ALIAS ADE o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando ALIAS ADE. Verifica que la dirección apunte a un servidor ALIAS ADE.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando ALIAS ADE. Verifica que la dirección apunte a un servidor ALIAS ADE.",
  ...
  "startup.initRecovery.description": "ALIAS ADE no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando ALIAS ADE...",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: alias-ade update",
  ...
  "aliasAdeLogo.aria.logo": "Logo de ALIAS ADE",
