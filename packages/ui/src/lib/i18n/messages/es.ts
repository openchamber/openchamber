...
export const dict: Record<I18nKey, string> = {
  ...
  "session.githubIssuePicker.overridesHelper": "Estas selecciones se aplican a esta sesión (no a tus valores guardados)",
  ...
  "session.newWorktree.overridesHelper": "Estas selecciones se aplican a esta sesión (no a tus valores guardados)",
