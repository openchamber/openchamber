...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.engines.capability.goalUnsupported": "Los objetivos solo están disponibles en OpenCode. Cambia esta sesión a OpenCode para usar objetivos.",
  "chat.engines.capability.multirunUnsupported": "MultiRun solo está disponible en OpenCode. Cambia esta sesión a OpenCode para iniciar un MultiRun.",
