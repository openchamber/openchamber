...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.engine.claudeCodeAria": "Motor Claude Code",
  "sessions.sidebar.session.engine.claudeCodeTooltip": "Ejecutándose en Claude Code",
  ...
  "gitView.pr.comments.addAll": "Añadir todo al chat",
  ...
  "chat.engines.slashUnsupported": "Este comando slash de OpenCode no está disponible en Claude Code. Usa un /comando nativo de Claude o envía un mensaje normal.",
  "chat.engines.effort.label": "Esfuerzo",
  "chat.engines.effort.default": "Predeterminado",
  "chat.engines.effort.low": "Bajo",
  "chat.engines.effort.medium": "Medio",
  "chat.engines.effort.high": "Alto",
  "chat.engines.effort.xhigh": "Muy alto",
  "chat.engines.effort.max": "Máximo",
  "chat.engines.effort.aria": "Esfuerzo: {level}",
  "chat.engines.effort.tooltip": "Esfuerzo: {level}",
  'chat.engines.capability.goalUnsupported': 'Los objetivos no están disponibles en este motor.',
  'chat.engines.capability.multirunUnsupported': 'MultiRun no está disponible en este motor.',
  'chat.engines.capability.openchamberToolUnsupported': 'La herramienta OpenChamber no está disponible en este motor.',
  "chat.handoff.billingDialog.title": "¿Continuar en Claude Code?",
  "chat.handoff.billingDialog.body": "Esto inicia una sesión nueva en Claude Code con los límites de uso de tu suscripción de Claude. Los proveedores de API de OpenCode no cambian. El texto de la conversación se copia como contexto; la sesión original permanece intacta.",
  "chat.handoff.billingDialog.continue": "Continuar",
  "chat.handoff.billingDialog.cancel": "Cancelar",
  "chat.handoff.billingDialog.dontShowAgain": "No volver a mostrar",
  "chat.handoff.billingDialog.dontShowAgainAria": "No volver a mostrar este aviso de facturación al cambiar de motor",
