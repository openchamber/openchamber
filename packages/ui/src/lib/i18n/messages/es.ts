...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.agentCapabilities.fusion.pickerLoadError": "No se pudieron cargar los presets de fusión.",
  "chat.agentCapabilities.fusion.pickerEmpty": "No hay presets de fusión. Crea uno en Configuración → Fusión.",
  "chat.agentCapabilities.fusion.keyboardHint": "↑↓ navegar • Enter seleccionar • Esc cerrar",
  "chat.agentCapabilities.inline.waitingChildren": "Esperando a que inicien las sesiones secundarias…",
