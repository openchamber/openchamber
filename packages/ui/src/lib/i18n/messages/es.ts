...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.message.speed.cacheRead": "caché {value}",
  "chat.message.speed.cacheWrite": "escritura de caché {value}",
  "chat.message.speed.output": "sal {value}",
  "chat.message.speed.reasoning": "razonamiento {value}",
  "chat.message.speed.aria": "Velocidad del mensaje: {ttft} hasta el primer token, {throughput} tokens por segundo, {input} entrada no cacheada, {cache} lectura de caché, {output} salida",
