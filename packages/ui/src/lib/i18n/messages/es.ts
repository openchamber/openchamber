...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.queuedMessage.title": "Mensajes en cola",
  ...
  "chat.queuedMessage.admissionPending": "Enviando al servidor…",
  "chat.queuedMessage.admitted": "En cola en el servidor · puedes cerrar",
  "chat.queuedMessage.localFallback": "Cola local · mantén abierto el cliente",
  "chat.queuedMessage.admissionFailed": "Error al admitir",
  "chat.queuedMessage.admissionUnknown": "Resultado desconocido · podría duplicarse, no reintentes",
  "chat.queuedMessage.retryAdmission": "Reintentar admisión",
  "chat.queuedMessage.restore": "Mover al compositor",
  "chat.queuedMessage.copy": "Copiar texto",
  "chat.queuedMessage.dismiss": "Descartar",
  "chat.queuedMessage.copyFailed": "No se pudo copiar el texto del mensaje",
  "chat.queuedMessage.selectionLimitation": "La admisión del servidor usa la configuración actual de modelo, agente y variante de la sesión",
