...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.telemetry.speed': 'Velocidad de generación',
  'chat.workStatus.telemetry.llmDuration': 'Duración de LLM',
  'chat.workStatus.telemetry.toolDuration': 'Duración de herramientas',
  'chat.workStatus.telemetry.ttft': 'Tiempo hasta el primer token',
  'chat.workStatus.telemetry.steps': 'Pasos en el turno',
  'chat.workStatus.telemetry.tokens': 'Tokens',
  'chat.workStatus.telemetry.cacheHit': 'Tasa de aciertos de caché',
  'chat.workStatus.telemetry.cost': 'Costo del turno',
