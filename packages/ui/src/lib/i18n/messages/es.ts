...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.chatInput.actions.enhancePromptAria": "Mejorar el prompt",
  "chat.chatInput.actions.enhancePromptCancel": "Cancelar la mejora del prompt",
  ...
  "chat.chatInput.toast.enhanceUnavailable": "No hay un modelo pequeño disponible para mejorar el prompt. Elige uno en Ajustes → Sesiones → Modelo pequeño.",
  "chat.chatInput.toast.enhanceContextTooSmall": "El prompt es demasiado grande para el contexto del modelo pequeño. Acórtalo o adjúntalo como archivo.",
  "chat.chatInput.toast.enhanceEmptyResult": "El modelo pequeño devolvió un prompt vacío. Inténtalo de nuevo.",
  "chat.chatInput.toast.enhanceInvalidResult": "El prompt mejorado cambiaría tus referencias @, / o #. El borrador se dejó sin cambios.",
  "chat.chatInput.toast.enhanceTimedOut": "La mejora del prompt agotó el tiempo de espera. Inténtalo de nuevo.",
