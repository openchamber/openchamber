...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.search.findPlaceholder": "Buscar",
  "chat.search.findAria": "Buscar en el chat",
  "chat.search.replacePlaceholder": "Reemplazar",
  "chat.search.replaceAria": "Reemplazar texto (no disponible en el chat)",
  "chat.search.matchCase": "Coincidir mayúsculas/minúsculas",
  "chat.search.useRegex": "Usar expresión regular",
  "chat.search.matchWholeWord": "Coincidir palabra completa",
  "chat.search.includeThinking": "Incluir partes de razonamiento en la búsqueda",
  "chat.search.previous": "Coincidencia anterior (Mayús+Intro)",
  "chat.search.previousAria": "Coincidencia anterior",
  "chat.search.next": "Siguiente coincidencia (Intro)",
  "chat.search.nextAria": "Siguiente coincidencia",
  "chat.search.close": "Cerrar (Escape)",
  "chat.search.closeAria": "Cerrar búsqueda",
  "chat.search.selectAllUnavailable": "Seleccionar todas las coincidencias no está disponible en la búsqueda del chat",
  "chat.search.replaceUnavailable": "Reemplazar no está disponible en la búsqueda del chat",
  "chat.search.replaceAllUnavailable": "Reemplazar todo no está disponible en la búsqueda del chat",
  "chat.search.noResults": "Sin resultados",
  "chat.search.loading": "Cargando…",
