...
export const dict: Record<I18nKey, string> = {
  ...
  'workspace.move.left': 'Mover a la izquierda',
  'workspace.move.center': 'Mover al centro',
  'workspace.move.right': 'Mover a la derecha',
  'workspace.move.bottom': 'Mover abajo',
  'workspace.zone.collapse': 'Contraer zona',
  'workspace.zone.label.left': 'Zona izquierda',
  'workspace.zone.label.center': 'Zona central',
  'workspace.zone.label.right': 'Zona derecha',
  'workspace.zone.label.bottom': 'Zona inferior',
  'workspace.zone.resize.left': 'Redimensionar la zona izquierda',
  'workspace.zone.resize.bottom': 'Redimensionar la zona inferior',
  'workspace.preset.title': 'Disposición',
  'workspace.preset.default': 'Predeterminada',
  'workspace.preset.developer': 'Desarrollador',
  'workspace.preset.codeAgent': 'Código + agente',
  'workspace.preset.reset': 'Restablecer la disposición',
};
