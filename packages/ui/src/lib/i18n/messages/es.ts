...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.harness.claudeCodeTooltip": "Ejecutándose en Claude Code",
  ...
  'chat.statusRow.retrying': 'Se reintentará cuando haya capacidad disponible',
  'chat.statusRow.retryingIn': 'Nuevo intento en {countdown}',
  'chat.statusRow.retryAttempt': '(intento {attempt})',
  'chat.statusRow.recoveryBlocked': 'La recuperación automática está bloqueada. Detén esta sesión para cancelar la recuperación.',
  'chat.chatInput.toast.queueFull': 'La cola de mensajes de seguimiento de esta sesión está llena. Se conservó tu borrador.',
  'chat.chatInput.toast.queueTargetsFull': 'Hay demasiadas sesiones con mensajes de seguimiento en cola. Se conservó tu borrador.',
  ...
  "chat.commandAutocomplete.command.claudeNativeDescription": "Comando de Claude Code: /{name}",
  ...
  "chat.modelControls.cacheRead": "Lectura de caché",
  "chat.modelControls.cacheWrite": "Escritura de caché",
  "chat.modelControls.costInOutShort": "Ent. {input} · Sal. {output}",
  "chat.modelControls.modalityInputAria": "{modality} de entrada",
  "chat.modelControls.modalityOutputAria": "{modality} de salida",
  ...
  "chat.modelControls.thinkingValue": "Pensando: {value}",
  ...
  "chat.modelControls.noAgentsFound": "No se encontraron agentes",
  "chat.modelControls.claudeAgents.defaultAgent": "Claude predeterminado",
  "chat.modelControls.claudeAgents.empty": "No se encontraron agentes de Claude",
  ...
  "chat.harness.manageHarnesses": "Administrar harnesses…",
  "chat.harness.chip.claude": "Claude · {model}",
  "chat.harness.notReady": "Claude Code no está listo. Abre Ajustes → Harnesses para instalar, iniciar sesión o volver a detectar.",
  "chat.harness.commandTranslationFailed": "No se pudo ejecutar este comando de OpenCode en Claude Code.",
  "chat.harness.effort.label": "Esfuerzo",
  "chat.harness.effort.default": "Predeterminado",
  "chat.harness.effort.low": "Bajo",
  "chat.harness.effort.medium": "Medio",
  "chat.harness.effort.high": "Alto",
  "chat.harness.effort.xhigh": "Muy alto",
  "chat.harness.effort.max": "Máximo",
  "chat.harness.effort.aria": "Esfuerzo: {level}",
  "chat.harness.effort.tooltip": "Esfuerzo: {level}",
  'chat.harness.capability.goalUnsupported': 'Los objetivos no están disponibles en este harness.',
  'chat.harness.capability.multirunUnsupported': 'MultiRun no está disponible en este harness.',
  'chat.harness.capability.openchamberToolUnsupported': 'La herramienta OpenChamber no está disponible en este harness.',
  "chat.harness.switch.title": "¿Cambiar a {harness}?",
  "chat.harness.switch.body": "Cambiar de harness inicia una nueva sesión. Tu sesión actual no se modifica.",
  "chat.harness.switch.billing": "La nueva sesión usa tu suscripción de Claude, no la facturación por API.",
  "chat.harness.switch.duplicate.title": "Duplicar datos de la sesión",
  "chat.harness.switch.duplicate.description": "Copia la conversación reciente en la nueva sesión como un mensaje de contexto visible.",
  "chat.harness.switch.summarize.title": "Resumir sesión",
  "chat.harness.switch.summarize.description": "Resume esta sesión y transfiere solo el resumen. La sesión actual se compactará.",
  "chat.harness.switch.optionsAria": "Qué transferir a la nueva sesión",
  "chat.harness.switch.dontShowAgain": "No volver a mostrar",
  "chat.harness.switch.dontShowAgainAria": "No volver a mostrar el diálogo de cambio de harness",
  "chat.harness.switch.cancel": "Cancelar",
  "chat.harness.switch.confirm": "Cambiar de harness",
  "chat.harness.switch.working": "Cambiando…",
  "chat.harness.contextCard.title": "Contexto de la sesión anterior",
  "chat.harness.contextCard.expandAria": "Expandir el contexto transferido",
  "chat.harness.contextCard.collapseAria": "Contraer el contexto transferido",
