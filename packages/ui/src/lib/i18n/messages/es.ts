...
export const dict: Record<I18nKey, string> = {
  ...
  'sidebarFilesTree.toast.searchFailed': 'Error al buscar archivos',
  'sidebarFilesTree.toast.searchTimedOut': 'Búsqueda agotada; intente reducir su alcance',
  "sidebarFilesTree.search.placeholder": "Buscar archivos...",
  'sidebarFilesTree.filter.expandTooltip': 'Alternar opciones de filtro',
  'sidebarFilesTree.filter.showHidden': 'Mostrar archivos ocultos',
  'sidebarFilesTree.filter.hideHidden': 'Ocultar archivos ocultos',
  'sidebarFilesTree.filter.showGitignored': 'Incluir archivos ignorados por Git',
  'sidebarFilesTree.filter.hideGitignored': 'Excluir archivos ignorados por Git',
  'sidebarFilesTree.filter.extChipRemoveAria': 'Quitar filtro {ext}',
  'sidebarFilesTree.filter.pathChipRemoveAria': 'Quitar filtro de ruta {path}',
  'sidebarFilesTree.filter.extAutocompleteLabel': 'Extensiones',
  ...
  'filesView.tree.filter.expandTooltip': 'Alternar opciones de filtro',
  'filesView.tree.filter.showHidden': 'Mostrar archivos ocultos',
  'filesView.tree.filter.hideHidden': 'Ocultar archivos ocultos',
  'filesView.tree.filter.showGitignored': 'Incluir archivos ignorados por Git',
  'filesView.tree.filter.hideGitignored': 'Excluir archivos ignorados por Git',
  'filesView.tree.filter.searchFailed': 'Error al buscar archivos',
  'filesView.tree.filter.searchTimedOut': 'Búsqueda agotada; intente reducir su alcance',
  'filesView.tree.filter.extChipRemoveAria': 'Quitar filtro {ext}',
  'filesView.tree.filter.pathChipRemoveAria': 'Quitar filtro de ruta {path}',
  'filesView.tree.filter.extAutocompleteLabel': 'Extensiones',
