...
export const dict: Record<I18nKey, string> = {
  ...
  "filesView.tree.actions.uploadTitle": "Subir archivos",
  "filesView.tree.drop.uploadHint": "Suelta archivos para subirlos",
  "filesView.toast.uploadSuccess": "Se subieron {count} archivos",
  "filesView.toast.uploadSuccessSingle": "Se subió {name}",
  "filesView.toast.uploadFailed": "No se pudieron subir {count} archivos",
  "filesView.toast.uploadFailedSingle": "No se pudo subir {name}",
