...
export const dict: Record<I18nKey, string> = {
  ...
  "gitView.history.actions.conflictToastDescription": "Conflictos en: {files}. Resuélvelos manualmente y haz commit, o usa el botón Abortar en el banner de operación.",
  "gitView.history.actions.conflictToastTitle": "Conflicto",
  "gitView.history.actions.unknownFiles": "archivos desconocidos",
  ...
  "gitView.history.actions.resetHard": "Reset (duro)",
   "gitView.history.actions.resetHardConfirmButton": "Descartar cambios",
   "gitView.history.actions.resetHardDirtyTitle": "¿Descartar cambios sin commit?",
   "gitView.history.actions.resetHardDirtyDescription": "El árbol de trabajo tiene cambios sin commit. Reset hard los descartará permanentemente.",
   "gitView.history.actions.resetHardDirtyConfirmButton": "Descartar y hacer reset",
  "gitView.history.actions.resetMixed": "Reset (mixto)",
  "gitView.history.actions.resetSoft": "Reset (suave)",
  ...
  "gitView.graph.localBranches": "Ramas locales",
  "gitView.graph.tags": "Etiquetas",
  "gitView.graph.manualSelection": "Selecciona las referencias que se incluirán en el grafo.",
  "gitView.graph.incomingChanges": "Cambios entrantes",
  "gitView.graph.outgoingChanges": "Cambios salientes",
  "gitView.graph.outdated": "El historial del grafo está desactualizado. Actualízalo para ver los cambios.",
  "gitView.graph.mergeBaseLookupFailed": "No se pudieron comparar los cambios entrantes y salientes de este grafo.",
  "gitView.graph.resizeAria": "Redimensionar el panel del grafo",
  "gitView.preview.overlayAnnouncement": "Vista previa del diff abierta. Presiona Escape para cerrarla.",
  "gitView.preview.resizeAria": "Redimensionar la vista previa del diff",
  "gitView.preview.submodulePointer": "Puntero de submódulo",
  "gitView.preview.tooLargeDescription": "Este diff ocupa {totalSize} y supera el límite de vista previa de {maxSize}.",
  ...
  "gitView.operation.mergingMessage": "Haciendo merge: {message}",
   ...
   "gitView.operation.cherryPickInProgress": "Cherry-pick en progreso",
   "gitView.operation.revertInProgress": "Revert en progreso",
  ...
  "gitView.toast.generateCommitMessageFailed": "No se pudo generar el mensaje de commit",
   ...
   "gitView.toast.cherryPickCompleted": "Cherry-pick completado",
   "gitView.toast.cherryPickAborted": "Cherry-pick abortado",
   "gitView.toast.cherryPickConflictsDetected": "Conflictos de cherry-pick detectados",
   "gitView.toast.revertCompleted": "Revert completado",
   "gitView.toast.revertAborted": "Revert abortado",
   "gitView.toast.revertConflictsDetected": "Conflictos de revert detectados",
  ...
  'diffView.actions.backToChat': 'Volver al chat',
  ...
  'gitView.history.actions.createBranchEllipsis': 'Crear rama…',
  'gitView.history.actions.createTagConfirm': 'Crear',
  'gitView.history.actions.createTagEllipsis': 'Crear etiqueta…',
  'gitView.history.actions.createTagPlaceholder': 'Nombre de etiqueta',
  'gitView.history.actions.checkoutDetached': 'Checkout (separado)',
  'gitView.history.actions.compareWithMergeBase': 'Comparar con base de fusión',
  'gitView.history.actions.compareWithRef': 'Comparar con…',
  'gitView.history.actions.compareWithRemote': 'Comparar con remoto',
  'gitView.history.actions.comparingWith': 'Comparando con {name}',
  'gitView.history.actions.copyMessage': 'Copiar mensaje del commit',
  'gitView.history.actions.clearComparison': 'Limpiar comparación',
  'gitView.history.actions.openChanges': 'Abrir cambios',
  'gitView.toast.commitMessageCopied': 'Mensaje del commit copiado',
  'gitView.toast.tagCreated': 'Etiqueta {name} creada',
  'gitView.graph.mergeBaseLabel': 'base de fusión',
};
