...
export const dict: Record<I18nKey, string> = {
  ...
  "desktopHostSwitcher.actions.removeServerAria": "Eliminar servidor",
  "desktopHostSwitcher.actions.removeServer": "Eliminar servidor",
  ...
  "desktopHostSwitcher.toast.sshDisconnected": "Instancia SSH \"{host}\" desconectada",
  "desktopHostSwitcher.toast.instanceUnreachable": "Instancia \"{host}\" no está disponible",
  "server.sidebar.status.connectionError": "Error de conexión",
  "server.sidebar.status.disconnected": "Desconectado",
  "server.sidebar.search.searchingServers": "Buscando en {count} servidores",
  "server.sidebar.localLabel": "Local",
