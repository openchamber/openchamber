...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.messageBody.footer.totalTime": "Tiempo total",
  "chat.messageBody.footer.totalTimeAria": "Tiempo total: {{value}}",
  "chat.messageBody.footer.tps": "Tokens por segundo",
  "chat.messageBody.footer.tpsAria": "Tokens por segundo: {{value}}",
  "chat.messageBody.footer.ttft": "Tiempo hasta el primer token",
  "chat.messageBody.footer.ttftAria": "Tiempo hasta el primer token: {{value}}",
  "chat.messageBody.footer.completedAt": "Completado a",
  "chat.messageBody.footer.completedAtAria": "Completado a: {{value}}",
