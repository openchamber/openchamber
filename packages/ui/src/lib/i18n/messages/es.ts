...
export const dict: Record<I18nKey, string> = {
  ...
  'dockerInstances.title': 'Instancias Docker',
  'dockerInstances.description': 'Crea y gestiona instancias de OpenCode que se ejecutan en contenedores Docker de esta máquina.',
  'dockerInstances.state.creating': 'Creando',
  'dockerInstances.state.starting': 'Iniciando',
  'dockerInstances.state.probing': 'Esperando disponibilidad',
  'dockerInstances.state.running': 'En ejecución',
  'dockerInstances.state.stopped': 'Detenida',
  'dockerInstances.state.error': 'Error',
  'dockerInstances.state.removing': 'Eliminando',
  'dockerInstances.state.removalFailed': 'La limpieza falló',
  'dockerInstances.state.empty': 'Aún no hay instancias Docker.',
  'dockerInstances.state.loadFailed': 'No se pudieron cargar las instancias Docker.',
  'dockerInstances.actions.addDocker': 'Añadir instancia Docker',
  'dockerInstances.actions.switchAria': 'Cambiar a {name}',
  'dockerInstances.actions.stop': 'Detener',
  'dockerInstances.actions.start': 'Iniciar',
  'dockerInstances.actions.cleanup': 'Reintentar limpieza',
  'dockerInstances.actions.remove': 'Eliminar',
  'dockerInstances.actions.confirmRemove': 'Confirmar eliminación',
  'dockerInstances.actions.openAria': 'Abrir instancias Docker',
  'dockerInstances.create.title': 'Nueva instancia Docker',
  'dockerInstances.create.description': 'OpenChamber crea un contenedor, inicia OpenCode dentro y espera a que esté listo.',
  'dockerInstances.create.field.label': 'Nombre',
  'dockerInstances.create.field.labelPlaceholder': 'Nombre opcional',
  'dockerInstances.create.field.image': 'Imagen',
  'dockerInstances.create.field.workspace': 'Ruta del espacio de trabajo',
  ...
  'dockerInstances.create.sharing.credentialsTitle': 'Compartir credenciales',
  'dockerInstances.create.sharing.credentialsHint': 'Solo lectura, desactivado por defecto. Los datos de inicio de sesión de proveedores se vuelven visibles dentro del contenedor.',
  'dockerInstances.create.sharing.neverShared': 'Nunca se comparten: socket de Docker, claves SSH, credenciales de git. Los puertos se enlazan solo a esta máquina.',
  'dockerInstances.create.actions.buildImage': 'Compilar {image}',
  'dockerInstances.create.actions.cancel': 'Cancelar',
  'dockerInstances.create.actions.create': 'Crear instancia',
  'dockerInstances.create.actions.creating': 'Creando…',
  'dockerInstances.create.error.generic': 'No se pudo crear la instancia.',
  'dockerInstances.create.toast.created': 'Instancia Docker creada.',
  'dockerInstances.create.toast.imageBuilt': 'La imagen {image} está lista.',
  'dockerInstances.toast.activated': 'Cambiado a {name}.',
  'dockerInstances.toast.deactivated': 'De vuelta a la instancia local.',
