...
export const dict: Record<I18nKey, string> = {
  ...
  "header.connection.status.connected": "Conectado",
  "header.connection.status.connecting": "Conectando…",
  "header.connection.status.reconnecting": "Reconectando…",
  "header.connection.actions.retry": "Haz clic para reintentar",
