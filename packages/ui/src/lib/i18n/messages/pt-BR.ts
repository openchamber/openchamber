...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.agentCapabilities.fusion.pickerLoadError": "Falha ao carregar presets de fusão.",
  "chat.agentCapabilities.fusion.pickerEmpty": "Nenhum preset de fusão. Crie um em Configurações → Fusão.",
  "chat.agentCapabilities.fusion.keyboardHint": "↑↓ navegar • Enter selecionar • Esc fechar",
  "chat.agentCapabilities.inline.waitingChildren": "Aguardando as sessões filhas iniciarem…",
