...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.harness.claudeCodeTooltip": "Em execução no Claude Code",
  ...
  'chat.statusRow.retrying': 'Nova tentativa quando houver capacidade disponível',
  'chat.statusRow.retryingIn': 'Nova tentativa em {countdown}',
  'chat.statusRow.retryAttempt': '(tentativa {attempt})',
  'chat.statusRow.recoveryBlocked': 'A recuperação automática está bloqueada. Pare esta sessão para cancelar a recuperação.',
  'chat.chatInput.toast.queueFull': 'A fila de mensagens de acompanhamento desta sessão está cheia. Seu rascunho foi mantido.',
  'chat.chatInput.toast.queueTargetsFull': 'Há sessões demais com mensagens de acompanhamento na fila. Seu rascunho foi mantido.',
  ...
  "chat.commandAutocomplete.command.claudeNativeDescription": "Comando do Claude Code: /{name}",
  ...
  "chat.modelControls.noAgentsFound": "Nenhum agente encontrado",
  "chat.modelControls.claudeAgents.defaultAgent": "Claude padrão",
  "chat.modelControls.claudeAgents.empty": "Nenhum agente do Claude encontrado",
  ...
  "chat.harness.manageHarnesses": "Gerenciar harnesses…",
  "chat.harness.chip.claude": "Claude · {model}",
  "chat.harness.notReady": "O Claude Code não está pronto. Abra Configurações → Harnesses para instalar, entrar ou detectar novamente.",
  "chat.harness.commandTranslationFailed": "Não foi possível executar este comando do OpenCode no Claude Code.",
  "chat.harness.effort.label": "Esforço",
  "chat.harness.effort.default": "Padrão",
  "chat.harness.effort.low": "Baixo",
  "chat.harness.effort.medium": "Médio",
  "chat.harness.effort.high": "Alto",
  "chat.harness.effort.xhigh": "Muito alto",
  "chat.harness.effort.max": "Máximo",
  "chat.harness.effort.aria": "Esforço: {level}",
  "chat.harness.effort.tooltip": "Esforço: {level}",
  'chat.harness.capability.goalUnsupported': 'Metas não estão disponíveis neste motor.',
  'chat.harness.capability.multirunUnsupported': 'MultiRun não está disponível neste motor.',
  'chat.harness.capability.openchamberToolUnsupported': 'A ferramenta OpenChamber não está disponível neste motor.',
  "chat.harness.switch.title": "Mudar para {harness}?",
  "chat.harness.switch.body": "Mudar de harness inicia uma nova sessão. Sua sessão atual permanece intacta.",
  "chat.harness.switch.billing": "A nova sessão usa sua assinatura do Claude, não a cobrança por API.",
  "chat.harness.switch.duplicate.title": "Duplicar dados da sessão",
  "chat.harness.switch.duplicate.description": "Copia a conversa recente para a nova sessão como uma mensagem de contexto visível.",
  "chat.harness.switch.summarize.title": "Resumir sessão",
  "chat.harness.switch.summarize.description": "Resume esta sessão e transfere apenas o resumo. A sessão atual será compactada.",
  "chat.harness.switch.optionsAria": "O que transferir para a nova sessão",
  "chat.harness.switch.dontShowAgain": "Não mostrar novamente",
  "chat.harness.switch.dontShowAgainAria": "Não mostrar novamente o diálogo de mudança de harness",
  "chat.harness.switch.cancel": "Cancelar",
  "chat.harness.switch.confirm": "Mudar de harness",
  "chat.harness.switch.working": "Mudando…",
  "chat.harness.contextCard.title": "Contexto da sessão anterior",
  "chat.harness.contextCard.expandAria": "Expandir o contexto transferido",
  "chat.harness.contextCard.collapseAria": "Recolher o contexto transferido",
