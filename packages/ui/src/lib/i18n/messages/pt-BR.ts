...
export const dict: Record<I18nKey, string> = {
  ...
  "gitView.pr.field.headBranch": "Branch de origem",
  ...
  "contextPanel.mode.mr": "Solicitação de merge",
  ...
  "contextPanel.gitlabMr.createMr.titlePlaceholder": "Título da solicitação de merge",
  "contextPanel.gitlabMr.createMr.descriptionLabel": "Descrição",
  ...
  "contextPanel.gitlabMr.updateMr.save": "Salvar",
  "contextPanel.gitlabMr.updateMr.saving": "Salvando...",
  "contextPanel.gitlabMr.updateMr.toast.updated": "Solicitação de merge atualizada",
  "contextPanel.gitlabMr.updateMr.toast.updateFailed": "Falha ao atualizar solicitação de merge",
  "contextPanel.gitlabMr.mergeMr.action": "Mesclar",
  "contextPanel.gitlabMr.mergeMr.squash": "Combinar commits",
  "contextPanel.gitlabMr.mergeMr.merging": "Mesclando...",
  "contextPanel.gitlabMr.mergeMr.toast.merged": "Solicitação de merge mesclada",
  "contextPanel.gitlabMr.mergeMr.toast.mergeFailed": "Falha ao mesclar solicitação de merge",
  "contextPanel.giteaPr.title": "PR",
  "contextPanel.giteaPr.tabs.pullRequests": "PR",
  "contextPanel.giteaPr.tabs.issues": "Issues",
  "contextPanel.giteaPr.branchSectionTitle": "Branch atual",
  "contextPanel.giteaPr.openPrTitle": "PR abertas",
  "contextPanel.giteaPr.listSectionTitle": "Neste repositório",
  "contextPanel.giteaPr.openPrEmpty": "Nenhuma PR aberta",
  "contextPanel.giteaPr.noPrForBranch": "Nenhuma PR para esta branch",
  "contextPanel.giteaPr.loadContext": "Carregar contexto",
  "contextPanel.giteaPr.hideContext": "Ocultar contexto",
  "contextPanel.giteaPr.openInGitea": "Abrir no Gitea",
  "contextPanel.giteaPr.draft": "Rascunho",
  "contextPanel.giteaPr.state.opened": "Aberta",
  "contextPanel.giteaPr.state.merged": "Mesclada",
  "contextPanel.giteaPr.state.closed": "Fechada",
  "contextPanel.giteaPr.loadMore": "Carregar mais",
  "contextPanel.giteaPr.loading": "Carregando...",
  "contextPanel.giteaPr.error.loadFailed": "Falha ao carregar PR",
  "contextPanel.giteaPr.error.notConnected": "Gitea não está conectado",
  "contextPanel.giteaPr.empty.noActiveProject": "Nenhum projeto ativo",
  "contextPanel.giteaPr.actions.openSettings": "Abrir configurações",
  "contextPanel.giteaPr.issues.detail.back": "Voltar para issues",
  "contextPanel.giteaPr.issues.detail.commentsEmpty": "Sem comentários",
  "contextPanel.giteaPr.issues.empty": "Nenhuma issue aberta",
  "contextPanel.giteaPr.issues.error.loadFailed": "Falha ao carregar issues",
  "contextPanel.giteaPr.issues.listSectionTitle": "Issues abertas",
  "contextPanel.giteaPr.createPr.title": "Nova PR",
  "contextPanel.giteaPr.createPr.sourceBranch": "Branch de origem",
  "contextPanel.giteaPr.createPr.targetBranch": "Branch de destino",
  "contextPanel.giteaPr.createPr.titleLabel": "Título",
  "contextPanel.giteaPr.createPr.titlePlaceholder": "Título da PR",
  "contextPanel.giteaPr.createPr.descriptionLabel": "Descrição",
  "contextPanel.giteaPr.createPr.removeSourceBranch": "Remover branch de origem ao mesclar",
  "contextPanel.giteaPr.createPr.submit": "Criar PR",
  "contextPanel.giteaPr.createPr.submitting": "Criando...",
  "contextPanel.giteaPr.createPr.branchesLoading": "Carregando branches...",
  "contextPanel.giteaPr.createPr.toast.created": "PR criada",
  "contextPanel.giteaPr.createPr.toast.createFailed": "Falha ao criar PR",
  "contextPanel.giteaPr.updatePr.toggle": "Editar título e descrição",
  "contextPanel.giteaPr.updatePr.save": "Salvar",
  "contextPanel.giteaPr.updatePr.saving": "Salvando...",
  "contextPanel.giteaPr.updatePr.toast.updated": "PR atualizada",
  "contextPanel.giteaPr.updatePr.toast.updateFailed": "Falha ao atualizar PR",
  "contextPanel.giteaPr.mergePr.action": "Mesclar",
  "contextPanel.giteaPr.mergePr.squash": "Combinar commits",
  "contextPanel.giteaPr.mergePr.merging": "Mesclando...",
  "contextPanel.giteaPr.mergePr.toast.merged": "PR mesclada",
  "contextPanel.giteaPr.mergePr.toast.mergeFailed": "Falha ao mesclar PR",
  ...
  "contextRail.surface.mr.description": "Crie, revise e faça merge da solicitação de merge do branch atual",
  ...
  "session.gitlabIssuePicker.searchPlaceholder": "Pesquisar por título ou cole a URL da issue",
  ...
  "session.giteaIssuePicker.error.noActiveProject": "Não há nenhum projeto ativo",
  "session.giteaIssuePicker.error.runtimeUnavailable": "API de runtime de Gitea não disponível",
  "session.giteaIssuePicker.error.notConnected": "Gitea não está conectado",
  "session.giteaIssuePicker.error.repoNotResolvable": "Não foi possível resolver o repositório",
  "session.giteaIssuePicker.error.repoMustBeGitea": "O remoto origin deve ser uma URL de Gitea",
  "session.giteaIssuePicker.error.issueNotFound": "Issue não encontrada",
  "session.giteaIssuePicker.error.noModelSelected": "Não há nenhum modelo selecionado",
  "session.giteaIssuePicker.toast.loadMoreFailed": "Não foi possível carregar mais issues",
  "session.giteaIssuePicker.toast.loadIssueDetailsFailed": "Não foi possível carregar os detalhes da issue",
  "session.giteaIssuePicker.toast.sendContextFailed": "Não foi possível enviar o contexto da issue",
  "session.giteaIssuePicker.toast.sessionCreated": "Sessão criada a partir da issue",
  "session.giteaIssuePicker.toast.startSessionFailed": "Não foi possível iniciar a sessão",
  "session.giteaIssuePicker.title.select": "Vincular issue de Gitea",
  "session.giteaIssuePicker.title.createSession": "Nova sessão de issue de Gitea",
  "session.giteaIssuePicker.description.select": "Selecione uma issue para vinculá-la a esta sessão.",
  "session.giteaIssuePicker.description.createSession": "Inicie uma nova sessão com contexto oculto do issue (título/corpo/etiquetas/comentários).",
  "session.giteaIssuePicker.searchPlaceholder": "Pesquisar por título ou cole a URL da issue",
  "session.giteaIssuePicker.empty.noActiveProject": "Não há nenhum projeto ativo selecionado.",
  "session.giteaIssuePicker.empty.runtimeUnavailable": "API de runtime de Gitea não disponível.",
  "session.giteaIssuePicker.empty.notConnected": "Gitea não está conectado. Conecte sua conta do Gitea nas configurações.",
  "session.giteaIssuePicker.empty.noIssuesFound": "Nenhuma issue encontrada",
  "session.giteaIssuePicker.empty.noOpenIssuesFound": "Nenhuma issue aberta encontrada",
  "session.giteaIssuePicker.loading.issues": "Carregando issues...",
  "session.giteaIssuePicker.loading.more": "Carregando...",
  "session.giteaIssuePicker.actions.openSettings": "Abrir configurações",
  "session.giteaIssuePicker.actions.useIssue": "Usar issue #{number}",
  "session.giteaIssuePicker.actions.openInGiteaAria": "Abrir em Gitea",
  "session.giteaIssuePicker.actions.loadMore": "Carregar mais",
  "session.giteaIssuePicker.actions.sectionTitle": "Ações",
  "session.giteaIssuePicker.actions.toggleWorktreeAria": "Ativar worktree",
  "session.giteaIssuePicker.actions.createInWorktree": "Criar em worktree",
  "session.giteaIssuePicker.actions.openRepo": "Abrir repositório",
  "session.giteaIssuePicker.actions.refresh": "Atualizar",
  ...
  "session.gitlabMrPicker.error.mrNotFound": "MR não encontrado",
  ...
  "session.gitlabMrPicker.toast.loadMoreFailed": "Não foi possível carregar mais MRs",
  "session.gitlabMrPicker.toast.loadDetailsFailed": "Não foi possível carregar os detalhes do MR",
  "session.gitlabMrPicker.title": "Vincular MR de GitLab",
  "session.gitlabMrPicker.description": "Selecione um MR para anexar contexto de revisão a esta mensagem.",
  "session.gitlabMrPicker.searchPlaceholder": "Pesquisar por título ou cole a URL do MR",
  "session.gitlabMrPicker.includeDiffAria": "Incluir diff do MR no contexto adjunto",
  "session.gitlabMrPicker.includeDiff": "Incluir diff do MR",
  ...
  "session.gitlabMrPicker.empty.noMergeRequestsFound": "Nenhum MR encontrado",
  "session.gitlabMrPicker.empty.noOpenMergeRequestsFound": "Nenhum MR aberto encontrado",
  "session.gitlabMrPicker.loading.mergeRequests": "Carregando MRs...",
  ...
  "session.giteaPrPicker.error.noActiveProject": "Não há nenhum projeto ativo",
  "session.giteaPrPicker.error.runtimeUnavailable": "API de runtime de Gitea não disponível",
  "session.giteaPrPicker.error.notConnected": "Gitea não está conectado",
  "session.giteaPrPicker.error.prNotFound": "PR não encontrada",
  "session.giteaPrPicker.error.repoNotResolvable": "Não foi possível resolver o repositório",
  "session.giteaPrPicker.error.repoMustBeGitea": "O remoto origin deve ser uma URL de Gitea",
  "session.giteaPrPicker.toast.loadMoreFailed": "Não foi possível carregar mais PRs",
  "session.giteaPrPicker.toast.loadDetailsFailed": "Não foi possível carregar os detalhes da PR",
  "session.giteaPrPicker.title": "Vincular PR de Gitea",
  "session.giteaPrPicker.description": "Selecione uma PR para anexar contexto de revisão a esta mensagem.",
  "session.giteaPrPicker.searchPlaceholder": "Pesquisar por título ou cole a URL da PR",
  "session.giteaPrPicker.includeDiffAria": "Incluir diff da PR no contexto adjunto",
  "session.giteaPrPicker.includeDiff": "Incluir diff da PR",
  "session.giteaPrPicker.empty.noActiveProject": "Não há nenhum projeto ativo selecionado.",
  "session.giteaPrPicker.empty.runtimeUnavailable": "API de runtime de Gitea não disponível.",
  "session.giteaPrPicker.empty.notConnected": "Gitea não está conectado. Conecte sua conta do Gitea nas configurações.",
  "session.giteaPrPicker.empty.noPullRequestsFound": "Nenhuma PR encontrado",
  "session.giteaPrPicker.empty.noOpenPullRequestsFound": "Nenhuma PR aberta encontrado",
  "session.giteaPrPicker.loading.pullRequests": "Carregando PRs...",
  "session.giteaPrPicker.loading.more": "Carregando...",
  "session.giteaPrPicker.actions.openSettings": "Abrir configurações",
  "session.giteaPrPicker.actions.usePullRequest": "Usar PR #{number}",
  "session.giteaPrPicker.actions.openInGiteaAria": "Abrir em Gitea",
  "session.giteaPrPicker.actions.loadMore": "Carregar mais",
  ...
  "session.newWorktree.actions.startFromGitLabIssueMr": "Iniciar de Issue/MR de GitLab",
  "session.newWorktree.usingPrBranch": "Usando branch da PR: {branch}",
  "session.newWorktree.usingMrBranch": "Usando branch do MR: {branch}",
  ...
  "session.newWorktree.toast.sessionFromMr": "Sessão criada a partir do merge request",
  ...
  "session.gitlabIntegration.connect.description": "Vincule issues ou merge requests para preencher automaticamente os detalhes do worktree",
  "session.gitlabIntegration.connect.action": "Conectar a GitLab",
  "session.gitlabIntegration.search.issuesPlaceholder": "Pesquisar issues do GitLab",
  "session.gitlabIntegration.search.mrsPlaceholder": "Pesquisar merge requests do GitLab",
  "session.gitlabIntegration.empty.noIssuesFound": "Nenhuma issue encontrada",
  "session.gitlabIntegration.empty.noMergeRequestsFound": "Nenhum merge request encontrado",
  ...
  "session.gitlabIntegration.draftBadge": "Rascunho",
  "session.giteaIntegration.title": "Selecionar de Gitea",
  ...
  "session.giteaIntegration.connect.description": "Vincule issues ou PRs para preencher automaticamente os detalhes do worktree",
  "session.giteaIntegration.connect.action": "Conectar a Gitea",
  "session.giteaIntegration.search.issuesPlaceholder": "Pesquisar issues do Gitea",
  "session.giteaIntegration.search.prsPlaceholder": "Pesquisar PRs do Gitea",
  "session.giteaIntegration.empty.noIssuesFound": "Nenhuma issue encontrada",
  "session.giteaIntegration.empty.noPullRequestsFound": "Nenhum PR encontrado",
  "session.giteaIntegration.actions.loadMore": "Carregar mais",
  "session.giteaIntegration.actions.cancel": "Cancelar",
  "session.giteaIntegration.actions.select": "Selecionar",
  "session.giteaIntegration.selected.issueNumber": "Issue #{number}",
  "session.giteaIntegration.selected.prNumber": "PR #{number}",
  "session.giteaIntegration.includeDiffAria": "Incluir diff da PR no contexto da sessão",
  "session.giteaIntegration.includeDiff": "Incluir diff da PR",
  "session.giteaIntegration.error.notConnected": "Gitea não está conectado",
  "session.giteaIntegration.error.loadDataFailed": "Não foi possível carregar os dados",
  "session.giteaIntegration.validation.branchAlreadyCheckedOut": "A branch já está em uso em um worktree",
  "session.giteaIntegration.validation.branchAlreadyExists": "A branch já existe localmente",
  "session.giteaIntegration.validation.failed": "Não foi possível validar",
  "session.giteaIntegration.draftBadge": "Rascunho",
