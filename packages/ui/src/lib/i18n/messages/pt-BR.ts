...
export const dict: Record<I18nKey, string> = {
  ...
  "updateDialog.header.updatingRemote": "Atualizando a instância remota...",
  "updateDialog.target.desktop.title": "Atualizar o aplicativo de desktop OpenChamber",
  "updateDialog.target.desktop.description": "Atualiza apenas este aplicativo do Windows. Use Atualizar instância remota para WSL.",
  "updateDialog.target.remote.title": "Atualizar instância remota",
  "updateDialog.target.remote.description": "Atualiza a instância remota selecionada.",
  ...
  "updateDialog.status.downloadingDesktopPayload": "Baixando a atualização de desktop...",
  "updateDialog.actions.downloadUpdate": "Baixar atualização",
  "updateDialog.actions.downloadDesktopUpdate": "Baixar atualização de desktop",
  "updateDialog.status.downloading": "Baixando...",
  "updateDialog.status.downloadingDesktop": "Baixando a atualização de desktop...",
  "updateDialog.actions.restartToUpdate": "Reiniciar para atualizar",
  "updateDialog.actions.restartDesktopToUpdate": "Reiniciar o aplicativo de desktop para atualizar",
