...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "chat.permissionAudit.title": "Solicitação de permissão",
  "chat.permissionAudit.status.requested": "Solicitada",
  "chat.permissionAudit.status.approvedOnce": "Aprovada uma vez",
