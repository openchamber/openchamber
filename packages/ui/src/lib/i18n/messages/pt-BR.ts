...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.messageBody.metrics.ttftInfo": "Tempo até o primeiro token: quanto o modelo levou para começar a responder após a solicitação.",
  "chat.messageBody.metrics.tokensPerSecond": "{rate} tok/s",
  "chat.messageBody.metrics.tokensPerSecondInfo": "Tokens de saída por segundo de decodificação em streaming, excluindo a execução de ferramentas.",
