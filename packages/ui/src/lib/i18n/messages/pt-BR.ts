...
export const dict: Record<I18nKey, string> = {
  ...
  "diffView.state.noBranchChanges": "Não há alterações da branch para exibir",
  ...
  "diffView.state.failedToLoadBranchChanges": "Não foi possível carregar as alterações da branch",
  ...
  "diffView.state.branchPatchUnavailable": "O patch da branch não está disponível para este arquivo.",
