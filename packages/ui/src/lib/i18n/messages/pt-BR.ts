...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.telemetry.speed': 'Velocidade de geração',
  'chat.workStatus.telemetry.llmDuration': 'Duração do LLM',
  'chat.workStatus.telemetry.toolDuration': 'Duração das ferramentas',
  'chat.workStatus.telemetry.ttft': 'Tempo até o primeiro token',
  'chat.workStatus.telemetry.steps': 'Etapas no turno',
  'chat.workStatus.telemetry.tokens': 'Tokens',
  'chat.workStatus.telemetry.cacheHit': 'Taxa de acertos de cache',
  'chat.workStatus.telemetry.cost': 'Custo do turno',
