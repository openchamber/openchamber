...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "chat.modelControls.projectDefaultSaved": "O modelo padrão deste projeto foi atualizado",
  "chat.modelControls.projectDefaultSavedDescription": "As futuras conversas neste projeto começarão com {model}.",
  "chat.modelControls.projectDefaultSaveFailed": "Não foi possível atualizar o modelo padrão do projeto",
  "chat.modelControls.projectDefaultOpenSettings": "Configurações do projeto",
  "chat.modelControls.projectDefaultAction": "Usar nesta conversa e em conversas futuras neste projeto",
  "chat.modelControls.projectDefaultCurrent": "Usado para novas conversas neste projeto",
