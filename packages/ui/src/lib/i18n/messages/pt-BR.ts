...
export const dict: Record<I18nKey, string> = {
  ...
  "usage.status.quotaExhausted": "Cota esgotada",
  "usage.status.expired": "Chave de API expirada",
  "usage.statistics.title": "Estatísticas de uso",
  "usage.statistics.info": "As estatísticas de modelos cobrem os últimos 30 dias.",
  "usage.statistics.requests": "Solicitações",
  "usage.statistics.inputTokens": "Tokens de entrada",
  "usage.statistics.outputTokens": "Tokens de saída",
  "usage.statistics.cacheReadTokens": "Tokens de cache lidos",
  "usage.statistics.totalTokens": "Tokens totais",
  "usage.statistics.actualCost": "Custo",
  "usage.statistics.today": "Hoje",
  "usage.statistics.total": "Total",
  "usage.statistics.empty": "Nenhuma estatística de uso relatada.",
