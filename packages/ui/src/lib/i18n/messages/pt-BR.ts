...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.message.speed.cacheWrite": "gravação de cache {value}",
  "chat.message.speed.output": "saí {value}",
  "chat.message.speed.reasoning": "raciocínio {value}",
  "chat.message.speed.aria": "Velocidade da mensagem: {ttft} até o primeiro token, {throughput} tokens por segundo, {input} entrada sem cache, {cache} leitura de cache, {output} saída",
