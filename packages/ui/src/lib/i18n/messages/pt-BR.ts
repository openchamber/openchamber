...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.messageBody.actions.forkSessionWithContext": "Bifurcar a sessão aqui com todo o contexto",
  ...
  "chat.messageBody.toast.forkSessionFailed": "Não foi possível bifurcar a sessão",
