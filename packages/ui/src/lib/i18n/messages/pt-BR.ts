...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instale o Sharpie para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "Sharpie instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao Sharpie",
  ...
  "mobile.connect.password.placeholder": "Senha do Sharpie",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do Sharpie.",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor Sharpie.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Sobre o Sharpie",
  ...
  "walkthrough.blocked.serverUnsupported.description": "O servidor Sharpie ao qual este app está conectado não respondeu à API de walkthrough, ou seja, é mais antigo que o app. Atualize o servidor para 1.18 ou mais recente e atualize a visualização.",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao Sharpie — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "filesView.editor.binaryFileDescription": "Este arquivo é binário e não pode ser editado no Sharpie. Baixe-o para abrir em outro aplicativo.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "Sharpie precisa acessar esta pasta.",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do Sharpie {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do Sharpie, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo Sharpie com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do Sharpie",
  "header.actions.openAppMenuAria": "Abrir menu do Sharpie",
  ...
  "sessionAuth.error.networkDescription": "Não foi possível verificar a sessão da interface. Se você estiver abrindo o Sharpie de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do Sharpie",
  ...
  "multiRun.window.description": "Janela do Sharpie Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao Sharpie",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o Sharpie não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do Sharpie. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do Sharpie e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do Sharpie para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor Sharpie ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do Sharpie. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando Sharpie, mas não é compatível com esta versão do app. Atualize o Sharpie no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando Sharpie. Verifique se o endereço aponta para um servidor Sharpie.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando Sharpie. Verifique se o endereço aponta para um servidor Sharpie.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor Sharpie em \"{host}\" não é compatível com esta versão do app. Atualize o Sharpie no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O Sharpie não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando Sharpie...",
  ...
  "mobileUpdate.toast.available.title": "Atualização do Sharpie disponível",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o Sharpie aberto.",
  ...
  "openChamberLogo.aria.logo": "Logo do Sharpie",
