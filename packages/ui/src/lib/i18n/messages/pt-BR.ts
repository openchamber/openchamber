...
export const dict: Record<I18nKey, string> = {
  ...
  "filesView.tree.actions.uploadTitle": "Enviar arquivos",
  "filesView.tree.drop.uploadHint": "Solte arquivos para enviar",
  "filesView.toast.uploadSuccess": "{count} arquivos enviados",
  "filesView.toast.uploadSuccessSingle": "{name} enviado",
  "filesView.toast.uploadFailed": "Falha ao enviar {count} arquivos",
  "filesView.toast.uploadFailedSingle": "Falha ao enviar {name}",
