...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "pwa.installPrompt.description": "Instale o ALIAS ADE para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "ALIAS ADE instalado",
  ...
  "sessions.sidebar.footer.actions.aboutAliasAde": "Sobre o ALIAS ADE",
  ...
  "header.services.shutdownDev": "Parar ALIAS ADE",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do ALIAS ADE, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo ALIAS ADE com eficiência",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do ALIAS ADE",
  ...
  "multiRun.window.description": "Janela do ALIAS ADE Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao ALIAS ADE",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o ALIAS ADE não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do ALIAS ADE. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do ALIAS ADE e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do ALIAS ADE para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor ALIAS ADE ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando ALIAS ADE. Verifique se o endereço aponta para um servidor ALIAS ADE.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando ALIAS ADE. Verifique se o endereço aponta para um servidor ALIAS ADE.",
  ...
  "startup.initRecovery.description": "O ALIAS ADE não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando ALIAS ADE...",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: alias-ade update",
  ...
  "aliasAdeLogo.aria.logo": "Logo do ALIAS ADE",
