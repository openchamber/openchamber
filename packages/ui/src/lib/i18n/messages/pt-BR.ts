...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.scheduledTasks.dialog.actions.lastRunAria": "Abrir a sessão da última execução de {taskName}",
  ...
  "sessions.scheduledTasks.editor.archiveOnSuccess.label": "Arquivar execuções bem-sucedidas",
  "sessions.scheduledTasks.editor.archiveOnSuccess.aria": "Arquivar a sessão após uma execução bem-sucedida",
