...
export const dict: Record<I18nKey, string> = {
  ...
  "contextRail.surface.git.description": "Revisar alterações, fazer commit e sincronizar",
  ...
  "contextPanel.actions.backToChanges": "Voltar às alterações",
  ...
  "helpDialog.item.openRightSidebarGitTab": 'Abrir superfície de Alterações',
