...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  'sidebarFilesTree.toast.searchFailed': 'Falha ao pesquisar arquivos',
  'sidebarFilesTree.toast.searchTimedOut': 'Pesquisa expirou; tente restringir o escopo',
  "sidebarFilesTree.search.placeholder": "Pesquisar arquivos...",
  'sidebarFilesTree.filter.expandTooltip': 'Alternar opções de filtro',
  'sidebarFilesTree.filter.showHidden': 'Mostrar arquivos ocultos',
  'sidebarFilesTree.filter.hideHidden': 'Ocultar arquivos ocultos',
  'sidebarFilesTree.filter.showGitignored': 'Incluir arquivos ignorados pelo Git',
  'sidebarFilesTree.filter.hideGitignored': 'Excluir arquivos ignorados pelo Git',
  'sidebarFilesTree.filter.extChipRemoveAria': 'Remover filtro {ext}',
  'sidebarFilesTree.filter.pathChipRemoveAria': 'Remover filtro de caminho {path}',
  'sidebarFilesTree.filter.extAutocompleteLabel': 'Extensões',
  ...
  'filesView.tree.filter.expandTooltip': 'Alternar opções de filtro',
  'filesView.tree.filter.showHidden': 'Mostrar arquivos ocultos',
  'filesView.tree.filter.hideHidden': 'Ocultar arquivos ocultos',
  'filesView.tree.filter.showGitignored': 'Incluir arquivos ignorados pelo Git',
  'filesView.tree.filter.hideGitignored': 'Excluir arquivos ignorados pelo Git',
  'filesView.tree.filter.searchFailed': 'Falha ao pesquisar arquivos',
  'filesView.tree.filter.searchTimedOut': 'Pesquisa expirou; tente restringir o escopo',
  'filesView.tree.filter.extChipRemoveAria': 'Remover filtro {ext}',
  'filesView.tree.filter.pathChipRemoveAria': 'Remover filtro de caminho {path}',
  'filesView.tree.filter.extAutocompleteLabel': 'Extensões',
