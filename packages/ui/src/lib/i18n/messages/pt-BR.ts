...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.engines.slashUnsupported": "Este comando slash do OpenCode não está disponível no Claude Code. Use um /comando nativo do Claude ou envie uma mensagem normal.",
  ...
  'chat.engines.capability.goalUnsupported': 'Metas não estão disponíveis neste motor.',
  'chat.engines.capability.multirunUnsupported': 'MultiRun não está disponível neste motor.',
  'chat.engines.capability.openchamberToolUnsupported': 'A ferramenta OpenChamber não está disponível neste motor.',
