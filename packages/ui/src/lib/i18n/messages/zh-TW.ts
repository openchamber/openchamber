...
export const dict: Record<I18nKey, string> = {
  ...
  'sideChat.label': '一次性',
  'sideChat.promote': '保留',
  'sideChat.promotion.error': '無法保留側邊聊天',
  'sideChat.cleanup.error': '無法刪除側邊聊天',
  'sideChat.discard.title': '捨棄此側邊聊天？',
  'sideChat.discard.description': '進行中的工作將停止，此對話將被永久刪除。',
  'sideChat.discard.sideEffects': '檔案變更、命令和其他工具副作用將會保留。',
  'sideChat.discard.cancel': '保留聊天',
  'sideChat.discard.confirm': '停止並刪除',
  'sideChat.recovery.title': '復原側邊聊天？',
  'sideChat.recovery.description': 'OpenChamber 發現了清理中斷後遺留的一次性側邊聊天。',
  'sideChat.recovery.sessionLabel': '側邊聊天 {sessionID}',
  'sideChat.recovery.recover': '復原',
  'sideChat.recovery.delete': '刪除',
  ...
  'chat.commandAutocomplete.command.sideDescription': '開啟一次性側邊聊天。除非選擇保留，否則關閉時會將其刪除。',
  'chat.commandAutocomplete.command.btwDescription': '/side 的別名。在目前對話旁開啟一次性聊天。',
