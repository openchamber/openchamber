...
export const dict: Record<I18nKey, string> = {
  ...
  'sidebarFilesTree.toast.searchFailed': '檔案搜尋失敗',
  'sidebarFilesTree.toast.searchTimedOut': '搜尋超時；請嘗試縮小搜尋範圍',
  'sidebarFilesTree.search.placeholder': '搜尋檔案...',
  'sidebarFilesTree.filter.expandTooltip': '切換篩選選項',
  'sidebarFilesTree.filter.showHidden': '顯示隱藏檔案',
  'sidebarFilesTree.filter.hideHidden': '隱藏隱藏檔案',
  'sidebarFilesTree.filter.showGitignored': '包含 Git 忽略的檔案',
  'sidebarFilesTree.filter.hideGitignored': '排除 Git 忽略的檔案',
  'sidebarFilesTree.filter.extChipRemoveAria': '移除 {ext} 篩選器',
  'sidebarFilesTree.filter.pathChipRemoveAria': '移除 {path} 路徑篩選器',
  'sidebarFilesTree.filter.extAutocompleteLabel': '副檔名',
  ...
  'filesView.tree.filter.expandTooltip': '切換篩選選項',
  'filesView.tree.filter.showHidden': '顯示隱藏檔案',
  'filesView.tree.filter.hideHidden': '隱藏隱藏檔案',
  'filesView.tree.filter.showGitignored': '包含 Git 忽略的檔案',
  'filesView.tree.filter.hideGitignored': '排除 Git 忽略的檔案',
  'filesView.tree.filter.searchFailed': '檔案搜尋失敗',
  'filesView.tree.filter.searchTimedOut': '搜尋超時；請嘗試縮小搜尋範圍',
  'filesView.tree.filter.extChipRemoveAria': '移除 {ext} 篩選器',
  'filesView.tree.filter.pathChipRemoveAria': '移除 {path} 路徑篩選器',
  'filesView.tree.filter.extAutocompleteLabel': '副檔名',
