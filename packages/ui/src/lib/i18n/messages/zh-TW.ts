...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.messageBody.footer.totalTime': '總耗時',
  'chat.messageBody.footer.totalTimeAria': '總耗時：{{value}}',
  'chat.messageBody.footer.tps': '每秒令牌數',
  'chat.messageBody.footer.tpsAria': '每秒令牌數：{{value}}',
  'chat.messageBody.footer.ttft': '首個令牌時間',
  'chat.messageBody.footer.ttftAria': '首個令牌時間：{{value}}',
  'chat.messageBody.footer.completedAt': '完成時間',
  'chat.messageBody.footer.completedAtAria': '完成時間：{{value}}',
