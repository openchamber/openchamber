...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.engines.capability.goalUnsupported': '目標僅在 OpenCode 上可用。請將此工作階段切換到 OpenCode 以使用目標。',
  'chat.engines.capability.multirunUnsupported': 'MultiRun 僅在 OpenCode 上可用。請將此工作階段切換到 OpenCode 以啟動 MultiRun。',
