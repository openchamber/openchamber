...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.sendMode.queue': '本則訊息排隊傳送',
  'chat.chatInput.sendMode.steer': '本則訊息立即傳送',
  'chat.chatInput.sendMode.switchToQueue': '將本則訊息切換為排隊傳送',
  'chat.chatInput.sendMode.switchToSteer': '將本則訊息切換為立即傳送',
