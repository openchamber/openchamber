...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.reviewCommentEdit': '編輯留言',
  'chat.chatInput.reviewCommentEditPlaceholder': '編輯你的留言…',
  'chat.chatInput.reviewCommentSave': '儲存',
  'chat.message.inlineComment.expand': '顯示程式碼',
  'chat.message.inlineComment.collapse': '隱藏程式碼',
  'chat.message.inlineComment.lineSingle': '第 {line} 行',
  'chat.message.inlineComment.lineRange': '第 {start}–{end} 行',
  'chat.message.inlineComment.lineSingleOfFile': '{file} 第 {line} 行',
  'chat.message.inlineComment.lineRangeOfFile': '{file} 第 {start}–{end} 行',
  'chat.chatInput.reviewCommentCancel': '取消',
