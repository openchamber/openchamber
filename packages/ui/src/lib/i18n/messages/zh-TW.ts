...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.pr.actions.addComment': '新增留言',
  ...
  'gitView.pr.placeholder.comment': '為這個 Pull Request 新增留言...',
  ...
  'gitView.pr.toast.commentAdded': '留言已新增',
  ...
  'gitView.pr.toast.replyAdded': '回覆已新增',
  'gitView.pr.toast.replyFailed': '新增回覆失敗',
