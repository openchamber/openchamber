...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.engine.claudeCodeAria': 'Claude Code 引擎',
  'sessions.sidebar.session.engine.claudeCodeTooltip': '正在 Claude Code 上執行',
  ...
  'gitView.pr.comments.addAll': '全部加入聊天',
  ...
  'chat.engines.slashUnsupported': '此 OpenCode 斜線指令在 Claude Code 上不可用。請使用 Claude 原生 /指令，或傳送一般訊息。',
  'chat.engines.effort.label': '思考強度',
  'chat.engines.effort.default': '預設',
  'chat.engines.effort.low': '低',
  'chat.engines.effort.medium': '中',
  'chat.engines.effort.high': '高',
  'chat.engines.effort.xhigh': '很高',
  'chat.engines.effort.max': '最大',
  'chat.engines.effort.aria': '思考強度：{level}',
  'chat.engines.effort.tooltip': '思考強度：{level}',
  'chat.engines.capability.goalUnsupported': '目標在此引擎上不可用。',
  'chat.engines.capability.multirunUnsupported': 'MultiRun 在此引擎上不可用。',
  'chat.engines.capability.openchamberToolUnsupported': 'OpenChamber 工具在此引擎上不可用。',
  'chat.handoff.billingDialog.title': '要在 Claude Code 繼續嗎？',
  'chat.handoff.billingDialog.body': '這會使用你的 Claude 訂閱用量上限建立新的 Claude Code 工作階段。OpenCode 的 API 供應商維持不變。對話文字會複製為上下文；原始工作階段保持不變。',
  'chat.handoff.billingDialog.continue': '繼續',
  'chat.handoff.billingDialog.cancel': '取消',
  'chat.handoff.billingDialog.dontShowAgain': '不要再顯示',
  'chat.handoff.billingDialog.dontShowAgainAria': '不要再顯示此交接計費提示',
