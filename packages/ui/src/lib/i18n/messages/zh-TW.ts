...
export const dict: Record<I18nKey, string> = {
  ...
  'diffView.state.noBranchChanges': '沒有可顯示的分支變更',
  'diffView.state.noLastTurnChanges': '沒有可顯示的上一輪變更',
  'diffView.state.failedToLoadDiff': '載入差異失敗',
  'diffView.state.failedToLoadBranchChanges': '載入分支變更失敗',
  'diffView.state.loadingDiff': '正在載入差異...',
  'diffView.state.loadingChanges': '正在載入變更...',
  'diffView.state.loadingBranchChanges': '正在載入分支變更...',
  'diffView.state.branchPatchUnavailable': '此檔案的分支修補程式無法使用。',
