...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.server-browser.description': '在伺服器上執行的 Chrome',
  ...
  'contextPanel.browser.newServerTab': '新增伺服器瀏覽器分頁',
  'contextPanel.browser.remote.tabLabel': '伺服器瀏覽器',
  'contextPanel.browser.remote.sessionsMenu': '瀏覽器工作階段',
  'contextPanel.browser.remote.savedSessions': '已儲存的工作階段',
  'contextPanel.browser.remote.availableSessions': '執行中的工作階段',
  'contextPanel.browser.remote.openDevTools': '開啟 Chrome DevTools',
  'contextPanel.browser.remote.contextMenuUnavailable': '此次點擊無法使用瀏覽器操作。請使用工具列或剪貼簿按鈕。',
  'contextPanel.browser.remote.devTools': 'Chrome DevTools',
  'contextPanel.browser.remote.simpleInspector': '主控台與網路',
  'contextPanel.browser.remote.inspectMode': '檢查模式',
  'contextPanel.browser.remote.maximizeInspector': '最大化檢查器',
  'contextPanel.browser.remote.restoreInspector': '還原頁面與檢查器',
  'contextPanel.browser.remote.resizeInspector': '調整檢查器大小',
  'contextPanel.browser.remote.devtoolsLoading': '正在連線至 Chrome DevTools…',
  'contextPanel.browser.remote.devtoolsLoadFailed': '無法載入 Chrome DevTools。',
  'contextPanel.browser.remote.devtoolsRetry': '重新連線至 DevTools',
  'contextPanel.browser.remote.devtoolsControlLost': '其他檢視器已接管控制權。請重新連線以繼續檢查。',
  'contextPanel.browser.remote.devtoolsConnectionClosed': 'DevTools 連線已關閉。',
  'contextPanel.browser.remote.devtoolsMessageTooLarge': '一則 DevTools 訊息超過了大小限制。',
  'contextPanel.browser.remote.devtoolsBackpressure': 'DevTools 無法跟上連線的資料傳輸速度。請重新連線以繼續。',
  'contextPanel.browser.remote.devtoolsInvalidRequest': 'DevTools 連線收到無效的訊息。',
  'contextPanel.browser.remote.devtoolsProtocolRejected': '此頁面不支援此 DevTools 操作。',
  'contextPanel.browser.remote.devtoolsExclusive': '錄製效能資料時，此工作階段必須是唯一執行中的瀏覽器工作階段。',
  'contextPanel.browser.remote.devtoolsStartFailed': '無法為此頁面開啟 DevTools。',
  'contextPanel.browser.remote.connecting': '正在連線伺服器瀏覽器…',
  'contextPanel.browser.remote.reconnecting': '連線已中斷。正在重新連線…',
  'contextPanel.browser.remote.chooseTitle': '伺服器瀏覽器工作階段',
  'contextPanel.browser.remote.chooseHint': '附加到執行中的工作階段，或啟動新的工作階段。',
  'contextPanel.browser.remote.newSession': '新工作階段',
  'contextPanel.browser.remote.noSessions': '此專案沒有執行中的伺服器工作階段。',
  'contextPanel.browser.remote.sessionEphemeral': '代理程式工作階段',
  'contextPanel.browser.remote.sessionProject': '專案工作階段',
  'contextPanel.browser.remote.errorTitle': '伺服器瀏覽器無法使用',
  'contextPanel.browser.remote.endedTitle': '此伺服器瀏覽器工作階段已結束',
  'contextPanel.browser.remote.retry': '重試',
  'contextPanel.browser.remote.canvasAria': '遠端頁面檢視',
  'contextPanel.browser.remote.keyboard': '在頁面中輸入',
  'contextPanel.browser.remote.textInputAria': '遠端頁面文字輸入',
  'contextPanel.browser.remote.clipboard.copy': '複製',
  'contextPanel.browser.remote.clipboard.paste': '貼上',
  'contextPanel.browser.remote.clipboard.copied': '已複製到剪貼簿',
  'contextPanel.browser.remote.clipboard.pasted': '已貼上至頁面',
  'contextPanel.browser.remote.clipboard.noSelection': '請在頁面上選取要複製的文字。',
  'contextPanel.browser.remote.clipboard.copyFailed': '無法複製選取的文字。請再試一次。',
  'contextPanel.browser.remote.clipboard.pasteFailed': '無法貼上至頁面。請再試一次。',
  'contextPanel.browser.remote.clipboard.tooLarge': '文字過大，無法傳輸。',
  'contextPanel.browser.remote.clipboard.copyFallbackTitle': '複製選取的文字',
  'contextPanel.browser.remote.clipboard.copyFallbackDescription': '無法存取剪貼簿。請選取並複製下方文字。',
  'contextPanel.browser.remote.clipboard.copyTextAria': '頁面上選取的文字',
  'contextPanel.browser.remote.clipboard.pasteFallbackTitle': '貼上至頁面',
  'contextPanel.browser.remote.clipboard.pasteFallbackDescription': '請在下方貼上純文字，再傳送至頁面。',
  'contextPanel.browser.remote.clipboard.pasteTextAria': '要貼上至頁面的文字',
  'contextPanel.browser.remote.clipboard.emptyClipboard': '剪貼簿中沒有純文字。',
  'contextPanel.browser.remote.clipboard.cancel': '取消',
  'contextPanel.browser.remote.viewport.auto': '自動',
  'contextPanel.browser.remote.viewport.preset': '檢視區預設',
  'contextPanel.browser.remote.viewport.custom': '自訂',
  'contextPanel.browser.remote.viewport.width': '寬度',
  'contextPanel.browser.remote.viewport.height': '高度',
  'contextPanel.browser.remote.viewport.rotate': '旋轉',
  'contextPanel.browser.remote.viewport.mobile': '模擬行動裝置',
  'contextPanel.browser.remote.viewport.scale': '顯示比例',
  'contextPanel.browser.remote.viewport.pending': '正在套用檢視區…',
  'contextPanel.browser.remote.viewport.error': '調整檢視區大小失敗：{code}',
  'contextPanel.browser.remote.viewport.agentControlled': '代理正在控制此檢視區',
  'contextPanel.browser.remote.viewport.external': '外部 DevTools 正在控制此檢視區',
  'contextPanel.browser.remote.viewport.dimensionsConfirmed': '已確認：{width} × {height}',
  'contextPanel.browser.remote.inspector.title': '頁面檢查器',
  'contextPanel.browser.remote.inspector.open': '開啟頁面檢查器',
  'contextPanel.browser.remote.inspector.close': '關閉檢查器',
  'contextPanel.browser.remote.inspector.console': '主控台',
  'contextPanel.browser.remote.inspector.network': '網路',
  'contextPanel.browser.remote.inspector.clear': '清除',
  'contextPanel.browser.remote.inspector.filterPlaceholder': '篩選訊息或請求',
  'contextPanel.browser.remote.inspector.filterAria': '篩選檢查器項目',
  'contextPanel.browser.remote.inspector.capturing': '正在擷取此分頁',
  'contextPanel.browser.remote.inspector.starting': '正在開始擷取',
  'contextPanel.browser.remote.inspector.captureHint': '開啟檢查器時會開始擷取。關閉檢查器會清除已擷取的資料。',
  'contextPanel.browser.remote.inspector.dropped': '已省略項目：{count}',
  'contextPanel.browser.remote.inspector.emptyConsole': '主控台訊息將顯示在這裡。',
  'contextPanel.browser.remote.inspector.filteredEmpty': '沒有符合的項目。',
  'contextPanel.browser.remote.inspector.expressionAria': '要在頁面中執行的 JavaScript',
  'contextPanel.browser.remote.inspector.expressionPlaceholder': '在頁面中執行 JavaScript',
  'contextPanel.browser.remote.inspector.run': '執行',
  'contextPanel.browser.remote.inspector.running': '執行中',
  'contextPanel.browser.remote.inspector.previousCommand': '上一個指令',
  'contextPanel.browser.remote.inspector.nextCommand': '下一個指令',
  'contextPanel.browser.remote.inspector.shortcutHint': '按 Ctrl/Cmd+Enter 執行。按 Enter 換行。',
  'contextPanel.browser.remote.inspector.truncated': '已截斷',
  'contextPanel.browser.remote.inspector.errorUnavailable': '頁面檢查器無法使用。請重新開啟後再試一次。',
  'contextPanel.browser.remote.inspector.errorInvalid': '請輸入最多 16,000 個字元的 JavaScript。',
  'contextPanel.browser.remote.inspector.errorCaptureGone': '擷取已結束。請重新開啟檢查器以再次開始。',
  'contextPanel.browser.remote.inspector.errorEvaluation': '無法執行 JavaScript。請再試一次。',
  'contextPanel.browser.remote.inspector.errorTimeout': 'JavaScript 已逾時。頁面可能仍在執行它。',
  'contextPanel.browser.remote.inspector.errorRequestGone': '此請求已無法使用。',
  'contextPanel.browser.remote.inspector.errorRequest': '無法載入此請求。請再試一次。',
  'contextPanel.browser.remote.inspector.errorCapture': '無法開始擷取。請重新開啟檢查器後再試一次。',
  'contextPanel.browser.remote.inspector.resultAria': 'JavaScript 結果',
  'contextPanel.browser.remote.inspector.commandAria': '已執行的 JavaScript',
  'contextPanel.browser.remote.inspector.level.debug': '偵錯',
  'contextPanel.browser.remote.inspector.level.info': '資訊',
  'contextPanel.browser.remote.inspector.level.log': '日誌',
  'contextPanel.browser.remote.inspector.level.warning': '警告',
  'contextPanel.browser.remote.inspector.level.error': '錯誤',
  'contextPanel.browser.remote.inspector.network.empty': '尚未擷取任何請求。',
  'contextPanel.browser.remote.inspector.network.noMatches': '沒有符合此篩選條件的請求。',
  'contextPanel.browser.remote.inspector.network.selectRequest': '請選取一個請求以查看詳細資料。',
  'contextPanel.browser.remote.inspector.network.details': '請求詳細資料',
  'contextPanel.browser.remote.inspector.network.closeDetails': '關閉請求詳細資料',
  'contextPanel.browser.remote.inspector.network.loading': '正在載入請求詳細資料',
  'contextPanel.browser.remote.inspector.network.loadBodies': '載入內文',
  'contextPanel.browser.remote.inspector.network.requestHeaders': '請求標頭',
  'contextPanel.browser.remote.inspector.network.responseHeaders': '回應標頭',
  'contextPanel.browser.remote.inspector.network.requestBody': '請求內文',
  'contextPanel.browser.remote.inspector.network.responseBody': '回應內文',
  'contextPanel.browser.remote.inspector.network.noHeaders': '沒有可用的標頭。',
  'contextPanel.browser.remote.inspector.network.noBody': '沒有可用的內文。',
  'contextPanel.browser.remote.inspector.network.bodiesNotRequested': '內文只會在你要求時載入。',
  'contextPanel.browser.remote.inspector.network.bodiesUnavailable': '此請求的內文已無法使用。',
  'contextPanel.browser.remote.inspector.network.bodiesUnsupported': '此回應不支援內文預覽。',
  'contextPanel.browser.remote.inspector.network.truncated': '預覽已截斷。',
  'contextPanel.browser.remote.inspector.network.method': '方法',
  'contextPanel.browser.remote.inspector.network.url': 'URL',
  'contextPanel.browser.remote.inspector.network.status': '狀態碼',
  'contextPanel.browser.remote.inspector.network.duration': '耗時',
  'contextPanel.browser.remote.inspector.network.size': '已傳輸',
  'contextPanel.browser.remote.inspector.network.state': '狀態',
  'contextPanel.browser.remote.inspector.network.cached': '來自快取',
  'contextPanel.browser.remote.inspector.network.failure': '錯誤',
  'contextPanel.browser.remote.inspector.network.resourceType': '類型',
  'contextPanel.browser.remote.inspector.network.mimeType': '內容類型',
  'contextPanel.browser.remote.inspector.network.pending': '等待中',
  'contextPanel.browser.remote.inspector.network.complete': '已完成',
  'contextPanel.browser.remote.inspector.network.failed': '失敗',
  'contextPanel.browser.remote.inspector.network.unknown': '無法使用',
  'contextPanel.browser.remote.inspector.network.yes': '是',
  'contextPanel.browser.remote.inspector.network.no': '否',
  'contextPanel.browser.remote.inspector.network.failedDetails': '無法載入請求詳細資料。請再試一次。',
  'contextPanel.browser.remote.inspector.network.requestGone': '此請求已無法使用。',
  'contextPanel.browser.remote.inspector.network.captureGone': '此次擷取已結束。',
  ...
  'contextPanel.browser.agentControlling': '代理程式控制中',
