...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.integrate.moreFiles': '+{count} 個更多',
  ...
  'chat.chatInput.placeholder.chat': '@ 用於檔案/Agent；/ 用於命令；! 用於 shell',
  ...
  'opencodeUpdate.toast.available.description': '版本 {version} 已可安裝。',
  ...
  'opencodeUpdate.toast.updated.description': '重新載入 OpenCode 以開始使用更新後的版本。',
  'opencodeUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安裝。重新載入 OpenCode 後即可使用。',
