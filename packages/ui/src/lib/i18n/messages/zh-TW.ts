...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.queuedMessage.title': '佇列中的訊息',
  ...
  'chat.queuedMessage.admissionPending': '正在傳送至伺服器…',
  'chat.queuedMessage.admitted': '已加入伺服器佇列 · 可安全關閉',
  'chat.queuedMessage.localFallback': '本機佇列 · 請保持用戶端開啟',
  'chat.queuedMessage.admissionFailed': '加入佇列失敗',
  'chat.queuedMessage.admissionUnknown': '結果未知 · 可能造成重複，請勿重試',
  'chat.queuedMessage.retryAdmission': '重試加入佇列',
  'chat.queuedMessage.restore': '移至編輯器',
  'chat.queuedMessage.copy': '複製文字',
  'chat.queuedMessage.dismiss': '關閉',
  'chat.queuedMessage.copyFailed': '無法複製訊息文字',
  'chat.queuedMessage.selectionLimitation': '伺服器入列會使用工作階段目前的模型、代理與變體設定',
