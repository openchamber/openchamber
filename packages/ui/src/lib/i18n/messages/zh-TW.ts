...
export const dict: Record<I18nKey, string> = {
  ...
  'filesView.tree.actions.uploadTitle': '上傳檔案',
  'filesView.tree.drop.uploadHint': '拖放檔案以上傳',
  'filesView.toast.uploadSuccess': '已上傳 {count} 個檔案',
  'filesView.toast.uploadSuccessSingle': '已上傳 {name}',
  'filesView.toast.uploadFailed': '上傳 {count} 個檔案失敗',
  'filesView.toast.uploadFailedSingle': '上傳 {name} 失敗',
