...
export const dict: Record<I18nKey, string> = {
  ...
  'desktopHostSwitcher.actions.removeServerAria': '移除伺服器',
  'desktopHostSwitcher.actions.removeServer': '移除伺服器',
  ...
  'desktopHostSwitcher.toast.sshDisconnected': 'SSH 實例「{host}」已斷線',
  'desktopHostSwitcher.toast.instanceUnreachable': '實例「{host}」無法連線',
  'server.sidebar.status.connectionError': '連線錯誤',
  'server.sidebar.status.disconnected': '已中斷連線',
  'server.sidebar.search.searchingServers': '正在搜尋 {count} 個伺服器',
  'server.sidebar.localLabel': '本機',
