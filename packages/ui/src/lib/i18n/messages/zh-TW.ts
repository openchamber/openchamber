...
export const dict: Record<I18nKey, string> = {
  ...
  'updateDialog.header.updatingRemote': '正在更新遠端執行個體...',
  'updateDialog.target.desktop.title': '更新 OpenChamber 桌面應用程式',
  'updateDialog.target.desktop.description': '僅更新此 Windows 應用程式。WSL 請使用遠端執行個體更新。',
  'updateDialog.target.remote.title': '更新遠端執行個體',
  'updateDialog.target.remote.description': '更新所選的遠端執行個體。',
  ...
  'updateDialog.status.downloadingDesktopPayload': '正在下載桌面應用程式更新...',
  'updateDialog.actions.downloadUpdate': '下載更新',
  'updateDialog.actions.downloadDesktopUpdate': '下載桌面應用程式更新',
  'updateDialog.status.downloading': '下載中...',
  'updateDialog.status.downloadingDesktop': '正在下載桌面應用程式更新...',
  'updateDialog.actions.restartToUpdate': '重新啟動以更新',
  'updateDialog.actions.restartDesktopToUpdate': '重新啟動桌面應用程式以更新',
