...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.modelControls.projectDefaultSaved': '已更新此專案的預設模型',
  'chat.modelControls.projectDefaultSavedDescription': '此專案未來的新聊天將以 {model} 開始。',
  'chat.modelControls.projectDefaultSaveFailed': '更新專案預設模型失敗',
  'chat.modelControls.projectDefaultOpenSettings': '專案設定',
  'chat.modelControls.projectDefaultAction': '用於此聊天和此專案未來的新聊天',
  'chat.modelControls.projectDefaultCurrent': '用於此專案的新聊天',
