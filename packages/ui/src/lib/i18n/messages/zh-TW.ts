...
export const dict: Record<I18nKey, string> = {
  ...
  'dockerInstances.title': 'Docker 執行個體',
  'dockerInstances.description': '在本機的 Docker 容器中建立並管理 OpenCode 執行個體。',
  'dockerInstances.state.creating': '建立中',
  'dockerInstances.state.starting': '啟動中',
  'dockerInstances.state.probing': '等待就緒',
  'dockerInstances.state.running': '執行中',
  'dockerInstances.state.stopped': '已停止',
  'dockerInstances.state.error': '錯誤',
  'dockerInstances.state.removing': '移除中',
  'dockerInstances.state.removalFailed': '清理失敗',
  'dockerInstances.state.empty': '還沒有 Docker 執行個體。',
  'dockerInstances.state.loadFailed': '無法載入 Docker 執行個體。',
  'dockerInstances.actions.addDocker': '新增 Docker 執行個體',
  'dockerInstances.actions.switchAria': '切換到 {name}',
  'dockerInstances.actions.stop': '停止',
  'dockerInstances.actions.start': '啟動',
  'dockerInstances.actions.cleanup': '重試清理',
  'dockerInstances.actions.remove': '移除',
  'dockerInstances.actions.confirmRemove': '確認移除',
  'dockerInstances.actions.openAria': '開啟 Docker 執行個體',
  'dockerInstances.create.title': '新建 Docker 執行個體',
  'dockerInstances.create.description': 'OpenChamber 會建立容器，在容器內啟動 OpenCode 並等待其就緒。',
  'dockerInstances.create.field.label': '名稱',
  'dockerInstances.create.field.labelPlaceholder': '選填的顯示名稱',
  'dockerInstances.create.field.image': '映像',
  'dockerInstances.create.field.workspace': '工作區路徑',
  ...
  'dockerInstances.create.sharing.credentialsTitle': '共享憑證',
  'dockerInstances.create.sharing.credentialsHint': '唯讀，預設關閉。提供者的登入資料在容器內可見。',
  'dockerInstances.create.sharing.neverShared': '絕不共享：Docker socket、SSH 金鑰、git 憑證。連接埠僅綁定到本機。',
  'dockerInstances.create.actions.buildImage': '建置 {image}',
  'dockerInstances.create.actions.cancel': '取消',
  'dockerInstances.create.actions.create': '建立執行個體',
  'dockerInstances.create.actions.creating': '建立中…',
  'dockerInstances.create.error.generic': '無法建立該執行個體。',
  'dockerInstances.create.toast.created': 'Docker 執行個體已建立。',
  'dockerInstances.create.toast.imageBuilt': '映像 {image} 已就緒。',
  'dockerInstances.toast.activated': '已切換到 {name}。',
  'dockerInstances.toast.deactivated': '已返回本機執行個體。',
