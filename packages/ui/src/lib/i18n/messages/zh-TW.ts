...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.toast.messageSendFailed': '訊息傳送失敗，訊息和附件已恢復。',
  'chat.chatInput.toast.messageSendMaybeFailed': '訊息可能未傳送。您的訊息已保留 — 請在重試前檢查。',
  'chat.chatInput.toast.messageRestoredToInput': '您的訊息已恢復到輸入框。',
