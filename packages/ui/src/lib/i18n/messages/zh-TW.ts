...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.search.findPlaceholder': '尋找',
  'chat.search.findAria': '在聊天中尋找',
  'chat.search.replacePlaceholder': '取代',
  'chat.search.replaceAria': '取代文字（聊天中不可用）',
  'chat.search.matchCase': '區分大小寫',
  'chat.search.useRegex': '使用正規運算式',
  'chat.search.matchWholeWord': '全字相符',
  'chat.search.includeThinking': '在搜尋中包含思考/推理內容',
  'chat.search.previous': '上一個相符項目 (Shift+Enter)',
  'chat.search.previousAria': '上一個相符項目',
  'chat.search.next': '下一個相符項目 (Enter)',
  'chat.search.nextAria': '下一個相符項目',
  'chat.search.close': '關閉 (Escape)',
  'chat.search.closeAria': '關閉搜尋',
  'chat.search.selectAllUnavailable': '聊天搜尋中無法選取所有相符項目',
  'chat.search.replaceUnavailable': '聊天搜尋中無法取代',
  'chat.search.replaceAllUnavailable': '聊天搜尋中無法全部取代',
  'chat.search.noResults': '無結果',
  'chat.search.loading': '載入中…',
