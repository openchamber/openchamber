...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.agentCapabilities.fusion.pickerLoadError': '無法載入融合預設。',
  'chat.agentCapabilities.fusion.pickerEmpty': '沒有融合預設。請在設定 → 融合中建立一個。',
  'chat.agentCapabilities.fusion.keyboardHint': '↑↓ 導覽 • Enter 選擇 • Esc 關閉',
  'chat.agentCapabilities.inline.waitingChildren': '正在等待子工作階段啟動…',
