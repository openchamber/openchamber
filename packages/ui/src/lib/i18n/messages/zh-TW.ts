...
export const dict: Record<I18nKey, string> = {
  ...
  "tiling.splitAnchor.left": "向左拆分面板",
  "tiling.splitAnchor.right": "向右拆分面板",
  "tiling.splitAnchor.top": "向上拆分面板",
  "tiling.splitAnchor.bottom": "向下拆分面板",
  "tiling.region.moveTarget": "將並排移動到此區域",
