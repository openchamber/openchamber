...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.browser.agent.handOff': '將控制權交給代理',
  'contextPanel.browser.agent.stop': '停止代理控制',
  'contextPanel.browser.agent.controlling': '代理正在控制',
  'contextPanel.browser.agent.ready': '已分享給代理',
  'contextPanel.browser.agent.popOut': '在獨立視窗中開啟',
  'contextPanel.browser.agent.lastAction': '最近操作：{op}',
  'contextPanel.browser.poppedOut.title': '已在獨立視窗中開啟瀏覽器',
  'contextPanel.browser.poppedOut.bringBack': '收回',
  'contextPanel.browser.poppedOut.focus': '聚焦視窗',
