...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.actions.enhancePromptAria': '最佳化提示詞',
  'chat.chatInput.actions.enhancePromptCancel': '取消提示詞最佳化',
  ...
  'chat.chatInput.toast.enhanceUnavailable': '沒有可用於最佳化提示詞的小型模型。請在 設定 → 會話 → 小型模型 中選擇一個。',
  'chat.chatInput.toast.enhanceContextTooSmall': '提示詞超出小型模型的上下文。請縮短它，或改為附加為檔案。',
  'chat.chatInput.toast.enhanceEmptyResult': '小型模型傳回了空提示詞。請再試一次。',
  'chat.chatInput.toast.enhanceInvalidResult': '最佳化後的提示詞會變更你的 @、/ 或 # 參照。草稿未做變更。',
  'chat.chatInput.toast.enhanceTimedOut': '提示詞最佳化逾時。請再試一次。',
