...
export const dict: Record<I18nKey, string> = {
  ...
  'usage.status.quotaExhausted': '額度已用盡',
  'usage.status.expired': 'API 金鑰已過期',
  'usage.statistics.title': '用量統計',
  'usage.statistics.info': '模型統計涵蓋最近 30 天。',
  'usage.statistics.requests': '請求數',
  'usage.statistics.inputTokens': '輸入 Token',
  'usage.statistics.outputTokens': '輸出 Token',
  'usage.statistics.cacheReadTokens': '快取讀取 Token',
  'usage.statistics.totalTokens': '總 Token',
  'usage.statistics.actualCost': '費用',
  'usage.statistics.today': '今日',
  'usage.statistics.total': '總計',
  'usage.statistics.empty': '未回報用量統計。',
