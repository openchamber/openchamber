...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.harness.claudeCodeTooltip': '正在 Claude Code 上執行',
  ...
  'chat.statusRow.retrying': '有可用容量時將重試',
  'chat.statusRow.retryingIn': '將在 {countdown} 後重試',
  'chat.statusRow.retryAttempt': '（第 {attempt} 次嘗試）',
  'chat.statusRow.recoveryBlocked': '自動復原已被阻止。請停止此工作階段以取消復原。',
  'chat.chatInput.toast.queueFull': '此工作階段的後續訊息佇列已滿。你的草稿已保留。',
  'chat.chatInput.toast.queueTargetsFull': '有後續訊息排隊的工作階段過多。你的草稿已保留。',
  ...
  'chat.commandAutocomplete.command.claudeNativeDescription': 'Claude Code 指令：/{name}',
  ...
  'chat.modelControls.contextAbbr': '上下文',
  'chat.modelControls.cacheRead': '快取讀取',
  'chat.modelControls.cacheWrite': '快取寫入',
  'chat.modelControls.costInOutShort': '輸入 {input} · 輸出 {output}',
  'chat.modelControls.modalityInputAria': '{modality}（輸入）',
  'chat.modelControls.modalityOutputAria': '{modality}（輸出）',
  ...
  'chat.modelControls.noAgentsFound': '找不到 Agent',
  'chat.modelControls.claudeAgents.defaultAgent': 'Claude 預設',
  'chat.modelControls.claudeAgents.empty': '找不到 Claude Agent',
  ...
  'chat.harness.notReady': 'Claude Code 尚未就緒。請開啟設定 → Harness以安裝、登入或重新偵測。',
  'chat.harness.commandTranslationFailed': '無法在 Claude Code 上執行此 OpenCode 指令。',
  'chat.harness.effort.label': '思考強度',
  'chat.harness.effort.default': '預設',
  'chat.harness.effort.low': '低',
  'chat.harness.effort.medium': '中',
  'chat.harness.effort.high': '高',
  'chat.harness.effort.xhigh': '很高',
  'chat.harness.effort.max': '最大',
  'chat.harness.effort.aria': '思考強度：{level}',
  'chat.harness.effort.tooltip': '思考強度：{level}',
  'chat.harness.capability.goalUnsupported': '目標在此 Harness 上不可用。',
  'chat.harness.capability.multirunUnsupported': 'MultiRun 在此 Harness 上不可用。',
  'chat.harness.capability.openchamberToolUnsupported': 'OpenChamber 工具在此 Harness 上不可用。',
  'chat.harness.switch.title': '切換到 {harness}？',
  'chat.harness.switch.body': '切換 Harness 會開始一個新工作階段。目前的工作階段保持不變。',
  'chat.harness.switch.billing': '新工作階段使用您的 Claude 訂閱，而非 API 計費。',
  'chat.harness.switch.duplicate.title': '複製工作階段資料',
  'chat.harness.switch.duplicate.description': '將最近的對話作為可見的內容訊息複製到新工作階段。',
  'chat.harness.switch.summarize.title': '摘要工作階段',
  'chat.harness.switch.summarize.description': '摘要此工作階段並僅攜帶摘要。目前的工作階段將被壓縮。',
  'chat.harness.switch.optionsAria': '要帶入新工作階段的內容',
  'chat.harness.switch.dontShowAgain': '不再顯示',
  'chat.harness.switch.dontShowAgainAria': '不再顯示 Harness 切換對話框',
  'chat.harness.switch.cancel': '取消',
  'chat.harness.switch.confirm': '切換 Harness',
  'chat.harness.switch.working': '正在切換…',
  'chat.harness.contextCard.title': '來自上一個工作階段的內容',
  'chat.harness.contextCard.expandAria': '展開已轉移的內容',
  'chat.harness.contextCard.collapseAria': '收合已轉移的內容',
