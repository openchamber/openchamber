...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.dialogs.worktreeDelete.disposition.label': '關聯會話',
  'sessions.sidebar.dialogs.worktreeDelete.disposition.archive': '封存關聯會話',
  'sessions.sidebar.dialogs.worktreeDelete.disposition.delete': '永久刪除關聯會話',
  'sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionOneLinked': '這將移除所選 worktree 並永久刪除 {count} 個關聯會話。',
  'sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionManyLinked': '這將移除所選 worktree 並永久刪除 {count} 個關聯會話。',
