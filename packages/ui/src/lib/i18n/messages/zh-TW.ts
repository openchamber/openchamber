...
export const dict: Record<I18nKey, string> = {
  ...
  'workspace.zone.label.right': '右側區域',
  'workspace.zone.label.bottom': '底部區域',
  'workspace.zone.resize.left': '調整左側區域大小',
  'workspace.zone.resize.bottom': '調整底部區域大小',
  'workspace.preset.title': '版面配置',
  'workspace.preset.default': '預設',
  'workspace.preset.developer': '開發者',
  'workspace.preset.codeAgent': '程式碼 + 代理',
  'workspace.preset.reset': '重設版面配置',
};
