...
export const dict: Record<I18nKey, string> = {
  ...
  'header.connection.status.connected': '已連線',
  'header.connection.status.connecting': '連線中…',
  'header.connection.status.reconnecting': '重新連線中…',
  'header.connection.actions.retry': '點擊重試',
