...
export const dict: Record<I18nKey, string> = {
  ...
  'session.githubIssuePicker.error.searchTimedOut': '搜尋逾時。請嘗試更精確的查詢。',
  ...
  'session.githubPrPicker.error.searchTimedOut': '搜尋逾時。請嘗試更精確的查詢。',
  ...
  'session.githubIntegration.error.searchTimedOut': '搜尋逾時。請嘗試更精確的查詢。',
  'session.githubIntegration.error.repoNotResolvable': '無法解析儲存庫',
