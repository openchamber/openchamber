...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.branch.actions.delete': '刪除分支',
  'gitView.branch.actions.rename': '重新命名分支',
  'gitView.branch.actionsAria': '{branch} 的操作',
  ...
  'gitView.branch.deleteConfirm': '刪除分支',
  'gitView.branch.deleteDialogDescription': '刪除本地分支 {branch}？此操作無法復原。',
  'gitView.branch.deleteDialogTitle': '刪除分支',
  'gitView.branch.deleting': '正在刪除…',
  ...
  'gitView.branch.renameConfirm': '重新命名分支',
  'gitView.branch.renameDialogDescription': '為 {branch} 輸入新名稱。',
  'gitView.branch.renameDialogTitle': '重新命名分支',
  ...
  'gitView.toast.cannotDeleteBranch': '無法刪除分支：{reason}',
  ...
  'gitView.toast.deletedBranch': '已刪除分支 {branch}',
  'gitView.toast.deleteBranchFailed': '刪除 {branch} 失敗',
