...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.message.speed.input': '輸入 {value}',
  'chat.message.speed.cacheRead': '快取 {value}',
  'chat.message.speed.cacheWrite': '快取寫入 {value}',
  'chat.message.speed.output': '輸出 {value}',
  'chat.message.speed.reasoning': '推理 {value}',
  'chat.message.speed.aria': '訊息速度：第一個 token {ttft}，每秒 {throughput} 個 token，未快取輸入 {input}，快取讀取 {cache}，輸出 {output}',
