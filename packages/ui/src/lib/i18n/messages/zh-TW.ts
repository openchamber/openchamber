...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.gitlabMr.createMr.titleLabel': '標題',
  'contextPanel.gitlabMr.createMr.titlePlaceholder': '合併請求標題',
  'contextPanel.gitlabMr.createMr.descriptionLabel': '描述',
  ...
  'contextPanel.gitlabMr.updateMr.save': '儲存',
  'contextPanel.gitlabMr.updateMr.saving': '儲存中...',
  'contextPanel.gitlabMr.updateMr.toast.updated': '合併請求已更新',
  'contextPanel.gitlabMr.updateMr.toast.updateFailed': '更新合併請求失敗',
  'contextPanel.gitlabMr.mergeMr.action': '合併',
  'contextPanel.gitlabMr.mergeMr.squash': '壓縮提交',
  'contextPanel.gitlabMr.mergeMr.merging': '合併中...',
  'contextPanel.gitlabMr.mergeMr.toast.merged': '合併請求已合併',
  'contextPanel.gitlabMr.mergeMr.toast.mergeFailed': '合併請求合併失敗',
  'contextPanel.giteaPr.title': 'Pull Request',
  'contextPanel.giteaPr.tabs.pullRequests': 'Pull Request',
  'contextPanel.giteaPr.tabs.issues': 'Issue',
  'contextPanel.giteaPr.branchSectionTitle': '目前分支',
  'contextPanel.giteaPr.openPrTitle': '已開啟的Pull Request',
  'contextPanel.giteaPr.listSectionTitle': '在此存放庫中',
  'contextPanel.giteaPr.openPrEmpty': '沒有已開啟的Pull Request',
  'contextPanel.giteaPr.noPrForBranch': '此分支沒有Pull Request',
  'contextPanel.giteaPr.loadContext': '載入內容',
  'contextPanel.giteaPr.hideContext': '隱藏內容',
  'contextPanel.giteaPr.openInGitea': '在 Gitea 中開啟',
  'contextPanel.giteaPr.draft': '草稿',
  'contextPanel.giteaPr.state.opened': '已開啟',
  'contextPanel.giteaPr.state.merged': '已合併',
  'contextPanel.giteaPr.state.closed': '已關閉',
  'contextPanel.giteaPr.loadMore': '載入更多',
  'contextPanel.giteaPr.loading': '載入中...',
  'contextPanel.giteaPr.error.loadFailed': '載入Pull Request失敗',
  'contextPanel.giteaPr.error.notConnected': 'Gitea 未連線',
  'contextPanel.giteaPr.empty.noActiveProject': '沒有使用中的專案',
  'contextPanel.giteaPr.actions.openSettings': '開啟設定',
  'contextPanel.giteaPr.issues.detail.back': '返回 Issue 列表',
  'contextPanel.giteaPr.issues.detail.commentsEmpty': '沒有留言',
  'contextPanel.giteaPr.issues.empty': '沒有開啟的 Issue',
  'contextPanel.giteaPr.issues.error.loadFailed': '載入 Issue 失敗',
  'contextPanel.giteaPr.issues.listSectionTitle': '開啟的 Issue',
  'contextPanel.giteaPr.createPr.title': '新增Pull Request',
  'contextPanel.giteaPr.createPr.sourceBranch': '來源分支',
  'contextPanel.giteaPr.createPr.targetBranch': '目標分支',
  'contextPanel.giteaPr.createPr.titleLabel': '標題',
  'contextPanel.giteaPr.createPr.titlePlaceholder': 'Pull Request標題',
  'contextPanel.giteaPr.createPr.descriptionLabel': '描述',
  'contextPanel.giteaPr.createPr.removeSourceBranch': '合併後刪除來源分支',
  'contextPanel.giteaPr.createPr.submit': '建立Pull Request',
  'contextPanel.giteaPr.createPr.submitting': '建立中...',
  'contextPanel.giteaPr.createPr.branchesLoading': '正在載入分支...',
  'contextPanel.giteaPr.createPr.toast.created': 'Pull Request已建立',
  'contextPanel.giteaPr.createPr.toast.createFailed': '建立Pull Request失敗',
  'contextPanel.giteaPr.updatePr.toggle': '編輯標題與描述',
  'contextPanel.giteaPr.updatePr.save': '儲存',
  'contextPanel.giteaPr.updatePr.saving': '儲存中...',
  'contextPanel.giteaPr.updatePr.toast.updated': 'Pull Request已更新',
  'contextPanel.giteaPr.updatePr.toast.updateFailed': '更新Pull Request失敗',
  'contextPanel.giteaPr.mergePr.action': '合併',
  'contextPanel.giteaPr.mergePr.squash': '壓縮提交',
  'contextPanel.giteaPr.mergePr.merging': '合併中...',
  'contextPanel.giteaPr.mergePr.toast.merged': 'Pull Request已合併',
  'contextPanel.giteaPr.mergePr.toast.mergeFailed': 'Pull Request合併失敗',
  ...
  'contextRail.surface.mr.description': '建立、審查並合併目前分支的合併請求',
  ...
  'session.gitlabIssuePicker.searchPlaceholder': '按標題搜尋，或貼上 Issue URL',
  ...
  'session.giteaIssuePicker.error.noActiveProject': '沒有活動專案',
  'session.giteaIssuePicker.error.runtimeUnavailable': 'Gitea 執行時 API 無法使用',
  'session.giteaIssuePicker.error.notConnected': 'Gitea 未連線',
  'session.giteaIssuePicker.error.repoNotResolvable': '無法解析儲存庫',
  'session.giteaIssuePicker.error.repoMustBeGitea': 'origin 遠端儲存庫必須是 Gitea URL',
  'session.giteaIssuePicker.error.issueNotFound': '找不到 Issue',
  'session.giteaIssuePicker.error.noModelSelected': '未選擇模型',
  'session.giteaIssuePicker.toast.loadMoreFailed': '載入更多 Issue 失敗',
  'session.giteaIssuePicker.toast.loadIssueDetailsFailed': '載入 Issue 詳情失敗',
  'session.giteaIssuePicker.toast.sendContextFailed': '傳送 Issue 上下文失敗',
  'session.giteaIssuePicker.toast.sessionCreated': '已從 Issue 建立會話',
  'session.giteaIssuePicker.toast.startSessionFailed': '啟動會話失敗',
  'session.giteaIssuePicker.title.select': '關聯 Gitea Issue',
  'session.giteaIssuePicker.title.createSession': '從 Gitea Issue 新增會話',
  'session.giteaIssuePicker.description.select': '選擇一個 Issue 關聯到目前會話。',
  'session.giteaIssuePicker.description.createSession': '使用隱藏的 Issue 上下文（標題/內文/標籤/留言）初始化新會話。',
  'session.giteaIssuePicker.searchPlaceholder': '按標題搜尋，或貼上 Issue URL',
  'session.giteaIssuePicker.empty.noActiveProject': '未選擇活動專案。',
  'session.giteaIssuePicker.empty.runtimeUnavailable': 'Gitea 執行時 API 無法使用。',
  'session.giteaIssuePicker.empty.notConnected': 'Gitea 未連線。請在設定中連接 Gitea 帳號。',
  'session.giteaIssuePicker.empty.noIssuesFound': '找不到 Issue',
  'session.giteaIssuePicker.empty.noOpenIssuesFound': '沒有未關閉的 Issue',
  'session.giteaIssuePicker.loading.issues': '正在載入 Issue...',
  'session.giteaIssuePicker.loading.more': '載入中...',
  'session.giteaIssuePicker.actions.openSettings': '開啟設定',
  'session.giteaIssuePicker.actions.useIssue': '使用 Issue #{number}',
  'session.giteaIssuePicker.actions.openInGiteaAria': '在 Gitea 中開啟',
  'session.giteaIssuePicker.actions.loadMore': '載入更多',
  'session.giteaIssuePicker.actions.sectionTitle': '操作',
  'session.giteaIssuePicker.actions.toggleWorktreeAria': '切換 worktree',
  'session.giteaIssuePicker.actions.createInWorktree': '在 worktree 中建立',
  'session.giteaIssuePicker.actions.openRepo': '開啟儲存庫',
  'session.giteaIssuePicker.actions.refresh': '重新整理',
  ...
  'session.gitlabMrPicker.error.mrNotFound': '找不到 Merge Request',
  ...
  'session.gitlabMrPicker.searchPlaceholder': '按標題搜尋，或貼上 Merge Request URL',
  ...
  'session.gitlabMrPicker.empty.noMergeRequestsFound': '找不到 Merge Request',
  'session.gitlabMrPicker.empty.noOpenMergeRequestsFound': '沒有未關閉的 Merge Request',
  'session.gitlabMrPicker.loading.mergeRequests': '正在載入 Merge Request...',
  'session.gitlabMrPicker.loading.more': '載入中...',
  'session.gitlabMrPicker.actions.openSettings': '開啟設定',
  'session.gitlabMrPicker.actions.useMergeRequest': '使用 Merge Request !{number}',
  'session.gitlabMrPicker.actions.openInGitLabAria': '在 GitLab 中開啟',
  'session.gitlabMrPicker.actions.loadMore': '載入更多',
  'session.giteaPrPicker.error.noActiveProject': '沒有活動專案',
  'session.giteaPrPicker.error.runtimeUnavailable': 'Gitea 執行時 API 無法使用',
  'session.giteaPrPicker.error.notConnected': 'Gitea 未連線',
  'session.giteaPrPicker.error.prNotFound': '找不到 Pull Request',
  'session.giteaPrPicker.error.repoNotResolvable': '無法解析儲存庫',
  'session.giteaPrPicker.error.repoMustBeGitea': 'origin 遠端儲存庫必須是 Gitea URL',
  'session.giteaPrPicker.toast.loadMoreFailed': '載入更多 Pull Request 失敗',
  'session.giteaPrPicker.toast.loadDetailsFailed': '載入 Pull Request 詳情失敗',
  'session.giteaPrPicker.title': '關聯 Gitea Pull Request',
  'session.giteaPrPicker.description': '選擇一個 Pull Request，將審查上下文附加到此訊息。',
  'session.giteaPrPicker.searchPlaceholder': '按標題搜尋，或貼上 Pull Request URL',
  'session.giteaPrPicker.includeDiffAria': '在附加上下文中包含 PR diff',
  'session.giteaPrPicker.includeDiff': '包含 PR diff',
  'session.giteaPrPicker.empty.noActiveProject': '未選擇活動專案。',
  'session.giteaPrPicker.empty.runtimeUnavailable': 'Gitea 執行時 API 無法使用。',
  'session.giteaPrPicker.empty.notConnected': 'Gitea 未連線。請在設定中連接 Gitea 帳號。',
  'session.giteaPrPicker.empty.noPullRequestsFound': '找不到 Pull Request',
  'session.giteaPrPicker.empty.noOpenPullRequestsFound': '沒有未關閉的 Pull Request',
  'session.giteaPrPicker.loading.pullRequests': '正在載入 Pull Request...',
  'session.giteaPrPicker.loading.more': '載入中...',
  'session.giteaPrPicker.actions.openSettings': '開啟設定',
  'session.giteaPrPicker.actions.usePullRequest': '使用 Pull Request #{number}',
  'session.giteaPrPicker.actions.openInGiteaAria': '在 Gitea 中開啟',
  'session.giteaPrPicker.actions.loadMore': '載入更多',
  ...
  'session.newWorktree.actions.startFromGitLabIssueMr': '從 GitLab Issue/MR 開始',
  'session.newWorktree.usingPrBranch': '使用 PR 分支：{branch}',
  'session.newWorktree.usingMrBranch': '使用 MR 分支：{branch}',
  ...
  'session.newWorktree.toast.sessionFromMr': '已從 Merge Request 建立會話',
  ...
  'session.gitlabIntegration.search.issuesPlaceholder': '搜尋 GitLab Issue',
  'session.gitlabIntegration.search.mrsPlaceholder': '搜尋 GitLab Merge Request',
  'session.gitlabIntegration.empty.noIssuesFound': '找不到 Issue',
  'session.gitlabIntegration.empty.noMergeRequestsFound': '找不到 Merge Request',
  ...
  'session.gitlabIntegration.draftBadge': '草稿',
  'session.giteaIntegration.title': '從 Gitea 選擇',
  'session.giteaIntegration.tabs.issues': 'Issues',
  'session.giteaIntegration.tabs.pullRequests': 'Pull Requests',
  'session.giteaIntegration.connect.title': '連接到 Gitea',
  'session.giteaIntegration.connect.description': '關聯 Issue 或 Pull Request 以自動填入 worktree 詳情',
  'session.giteaIntegration.connect.action': '連接 Gitea',
  'session.giteaIntegration.search.issuesPlaceholder': '搜尋 Gitea Issue',
  'session.giteaIntegration.search.prsPlaceholder': '搜尋 Gitea Pull Request',
  'session.giteaIntegration.empty.noIssuesFound': '找不到 Issue',
  'session.giteaIntegration.empty.noPullRequestsFound': '找不到 Pull Request',
  'session.giteaIntegration.actions.loadMore': '載入更多',
  'session.giteaIntegration.actions.cancel': '取消',
  'session.giteaIntegration.actions.select': '選擇',
  'session.giteaIntegration.selected.issueNumber': 'Issue #{number}',
  'session.giteaIntegration.selected.prNumber': 'PR #{number}',
  'session.giteaIntegration.includeDiffAria': '在會話上下文中包含 PR diff',
  'session.giteaIntegration.includeDiff': '包含 PR diff',
  'session.giteaIntegration.error.notConnected': 'Gitea 未連線',
  'session.giteaIntegration.error.loadDataFailed': '載入資料失敗',
  'session.giteaIntegration.validation.branchAlreadyCheckedOut': '該分支已在某個 worktree 中簽出',
  'session.giteaIntegration.validation.branchAlreadyExists': '該分支已在本地存在',
  'session.giteaIntegration.validation.failed': '驗證失敗',
  'session.giteaIntegration.draftBadge': '草稿',
  ...
  'chat.chatInput.actions.linkGiteaIssue': '關聯 Gitea Issue',
  'chat.chatInput.actions.linkGiteaPr': '關聯 Gitea PR',
