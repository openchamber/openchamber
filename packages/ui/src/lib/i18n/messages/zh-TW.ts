...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.notifications.empty': '還沒有通知',
  'layout.notifications.emptyFiltered': '沒有符合目前篩選的通知',
  'layout.notifications.markAllRead': '全部標為已讀',
  'layout.notifications.clearAll': '全部清除',
  'layout.notifications.remove': '移除通知',
  'layout.notifications.sessionSubtaskFinished': '子工作已完成',
  'layout.notifications.sessionSubtaskError': '子工作錯誤',
  'layout.notifications.openSettings': '通知設定',
  'layout.notifications.unreadCountAria': '{count} 則未讀通知',
  'layout.notifications.sessionFinished': '工作階段已結束',
  'layout.notifications.sessionError': '工作階段出錯',
  'layout.notifications.permissionNeeded': '需要許可',
  'layout.notifications.permissionFallback': 'Agent 需要你的核准',
  'layout.notifications.inputNeeded': '需要回覆',
  'layout.notifications.questionFallback': 'Agent 正在等待你的回覆',
  'layout.notifications.openSession': '開啟工作階段',
  'layout.notifications.occurrenceCount': '×{count}',
  'layout.notifications.time.justNow': '剛剛',
  'layout.notifications.time.minutesAgo': '{count} 分鐘',
  'layout.notifications.time.hoursAgo': '{count} 小時',
  'layout.notifications.time.daysAgo': '{count} 天',
  'toast.action.ok': '確定',
  'toast.action.copy': '複製',
