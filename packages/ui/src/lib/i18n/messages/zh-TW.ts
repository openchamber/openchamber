...
export const dict: Record<I18nKey, string> = {
  ...
  'header.actions.unstickLatestQuestion': '取消固定最新問題',
  'header.actions.unstickLatestQuestionAria': '從聊天畫面取消固定最新問題',
  'header.actions.stickLatestQuestion': '固定最新問題',
  'header.actions.stickLatestQuestionAria': '將最新問題固定到聊天畫面',
  ...
  'chat.mobileStatus.expandPanelAria': '展開工作階段面板',
  'chat.mobileStatus.collapsePanelAria': '收合工作階段面板',
