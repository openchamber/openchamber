...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 Sharpie 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'Sharpie 已安裝',
  ...
  'mobile.connect.welcome.title': '連線至 Sharpie',
  ...
  'mobile.connect.password.placeholder': 'Sharpie 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 Sharpie 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 Sharpie Relay 連線',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 Sharpie 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 Sharpie。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 Sharpie，但與此應用程式版本不相容。請更新伺服器上的 Sharpie 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 Sharpie 伺服器與此應用程式版本不相容。請更新伺服器上的 Sharpie 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '關於 Sharpie',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此應用程式連線的 Sharpie 伺服器沒有回應 walkthrough API，代表它比應用程式更舊。請將伺服器升級到 1.18 或更新版本後重新整理。',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 Sharpie 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此檔案為二進位檔案，無法在 Sharpie 中編輯。請下載後使用其他應用程式開啟。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Sharpie 需要存取此資料夾。',
  ...
  'aboutDialog.openChamberVersionLabel': 'Sharpie 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Sharpie 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 Sharpie',
  ...
  'header.actions.openAppMenu': 'Sharpie 選單',
  'header.actions.openAppMenuAria': '開啟 Sharpie 選單',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 Sharpie，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 Sharpie',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 Sharpie 伺服器之間切換',
  ...
  'multiRun.window.description': 'Sharpie 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 Sharpie',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Sharpie 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 Sharpie 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 Sharpie 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 Sharpie 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 Sharpie 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 Sharpie。請確認位址是否指向 Sharpie 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 Sharpie。請確認位址是否指向 Sharpie 伺服器。',
  ...
  'startup.initRecovery.description': 'Sharpie 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 Sharpie...',
  ...
  'mobileUpdate.toast.available.title': 'Sharpie 更新可用',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 Sharpie 開啟。',
  ...
  'openChamberLogo.aria.logo': 'Sharpie 標誌',
