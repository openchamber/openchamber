...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.operation.recovery.storage': 'Git 復原儲存空間無法使用。請恢復瀏覽器儲存空間並重新整理。新的變更操作已被阻擋。',
  'gitView.operation.recovery.capacity': 'Git 復原儲存空間已滿。請先處理已儲存的操作，再開始新操作。',
  'gitView.operation.recovery.reconciling': '正在檢查已儲存的 Git 操作參照…',
  'gitView.operation.recovery.repository': '無法驗證儲存庫。請在開始其他 Git 操作前重新整理。',
  'gitView.operation.recovery.inspect': '如果伺服器不再識別此 ID，請在 OpenChamber 外檢查本機儲存庫和遠端儲存庫。儲存的參照仍會阻擋新操作；缺少狀態絕不代表可以重複傳輸。',
  'gitView.operation.localCommit': '本機提交已建立並保留。',
  'gitView.operation.unknownHint': '結果未知。開始另一次傳輸前，請重新整理此操作的狀態。系統不會自動重複執行。',
  'gitView.operation.refresh': '重新整理操作',
  'gitView.operation.cancel': '取消操作',
  'gitView.operation.state.unavailable': '無法取得操作狀態',
  'gitView.operation.state.planned': '已規劃',
  'gitView.operation.state.running': '執行中',
  'gitView.operation.state.succeeded': '成功',
  'gitView.operation.state.partial': '部分完成',
  'gitView.operation.state.failed': '失敗',
  'gitView.operation.state.cancelled': '已取消',
  'gitView.operation.state.outcome-unknown': '結果未知',
  'gitView.operation.state.conflicted': '衝突',
  'gitView.operation.state.skipped': '已略過',
  'gitView.operation.completed.validated': '儲存庫和目標已驗證',
  'gitView.operation.completed.authenticated': '身分驗證已完成',
  'gitView.operation.completed.transferred': '傳輸已完成',
  'gitView.operation.completed.updated-local-repository': '本機儲存庫已更新',
  'gitView.operation.completed.checked-out': '簽出已完成',
  'gitView.operation.completed.cleaned-up': '清理已完成',
  'gitView.remotes.title': '其他遠端',
  'gitView.remotes.description': '除了套用身分的那個位址之外，這個儲存庫還有的位址。在授權之前，OpenChamber 既不從它拉取，也不向它推送。',
  'gitView.remotes.grant': '以 {identity} 的身分回應',
  'gitView.hydration.title': '補全簽出內容',
  'gitView.hydration.description': '為每個端點個別授權，以初始化子模組並擷取 Git LFS 內容。',
  'gitView.hydration.parentRemote': '上層遠端儲存庫',
  'gitView.hydration.retry': '重試內容補全',
  'gitView.hydration.endpoint': '輔助端點',
  'gitView.hydration.identity': '此端點使用的身分',
  'gitView.hydration.authorizationNeeded': '這些端點還沒有身分，水合已停止。請分別為它們選擇身分，然後重試水合。',
  'gitView.hydration.chooseEndpoint': '選擇端點',
  'gitView.hydration.systemConfirmation': '允許 Git 對此端點使用系統環境中的憑證。OpenChamber 無法驗證 Git 將使用哪些憑證。',
  'gitView.hydration.lfsMissing': '尚未安裝 Git LFS。請安裝 git-lfs，然後重試內容補全。',
  'gitView.hydration.kind.submodule': '子模組',
  'gitView.hydration.kind.lfs': 'Git LFS',
  'gitView.hydration.status.succeeded': '已完成',
  'gitView.hydration.status.failed': '失敗',
  'gitView.hydration.status.cancelled': '已取消',
  'gitView.hydration.status.authorization-required': '需要授權',
  'gitView.hydration.status.invalid': '設定無效',
  'gitView.hydration.status.client-missing': '缺少用戶端',
  'gitView.hydration.status.not-needed': '無需處理',
  'gitView.publish.title': '發佈',
  'gitView.publish.commitKept': '本機提交已建立並保留。發佈未成功完成。',
  'gitView.publish.syncTitle': '選擇同步目標',
  'gitView.publish.description': '將 {branch} 發佈至指定的 Git 目標。供應商帳號不會決定發佈目標。',
  'gitView.publish.fetchSource': '擷取來源遠端儲存庫',
  'gitView.publish.sourceBranch': '來源分支',
  'gitView.publish.fetchFirst': '此遠端儲存庫沒有快取的分支。請取消並先執行擷取。',
  'gitView.publish.pushDestination': '推送目標遠端儲存庫',
  'gitView.publish.selectRemote': '選擇已綁定的遠端儲存庫',
  'gitView.publish.destinationBranch': '目標分支',
  'gitView.publish.noGrants': '發佈前請設定 Git 傳輸綁定。',
  'gitView.publish.contributorCommitFirst': '此貢獻者工作樹需要在提交後核准目標。是否繼續？稍後取消發佈仍會保留本機提交。',
  'gitView.publish.detached': '不支援發佈分離的 HEAD。請先簽出本機分支。',
  'gitView.publish.stale': '分支或 Git 授權已變更。未進行任何重試。請重新選擇目標。',
  'gitView.publish.cancelled': '已取消發佈。未啟動 Git 傳輸。',
  'gitView.publish.succeeded': '已發佈至所選目標',
  ...
  'chat.shellBoundary.status': '未驗證 · 在受管邊界之外',
  'chat.shellBoundary.agentAria': '代理程式的 Shell 執行未經驗證，且位於受管 Git 邊界之外',
  'chat.shellBoundary.userAria': '使用者的 Shell 執行未經驗證，且位於受管 Git 邊界之外',
  ...
  'gitView.context.description': '單靠身分定不下來的事：代理的 shell、儲存庫的其他位址，以及子模組和 Git LFS 需要的個別授權。身分在 Git 設定裡管理。',
  ...
  'gitView.identity.unavailableScheme': '需要 {scheme} 遠端儲存庫',
  ...
  'worktree.bootstrap.toast.authorizationRequired': '請授權簽出儲存庫及其子模組，然後重試。',
  ...
  'gitView.pr.actions.openOnProvider': '在 {provider} 中開啟',
  'gitView.pr.actions.openOnProviderAria': '在 {provider} 中開啟 Pull Request',
  ...
  'gitView.pr.providerNotConnected': '{provider} 未連線',
  ...
  'gitView.pr.capabilitiesUnavailable': '無法載入提供者功能',
  ...
  'gitView.contributor.chooseDestination': '選擇此貢獻者分支的確切推送目標。',
  'gitView.contributor.destination.contributor-fork': '貢獻者分支儲存庫',
  'gitView.contributor.destination.own-fork': '你的分支儲存庫',
  'gitView.contributor.destination.bound-repository': '已綁定儲存庫',
  'gitView.contributor.destination.other': '其他遠端儲存庫',
  'gitView.toast.contributorPublishCancelled': '已取消發佈。未變更任何遠端儲存庫。',
  'gitView.toast.contributorPublishCancelledAfterUpdate': '變更已在本機更新，但發佈已取消。',
  'gitView.toast.unstageFileFailed': '取消暫存更改失敗',
  'gitView.confirm.systemTransport': '系統 Git 可能會使用此電腦上設定的憑證。是否繼續此 Git 操作？',
  ...
  'session.changeRequestPicker.error.noProvider': '找不到支援的原始碼控制遠端儲存庫',
  'session.changeRequestPicker.title': '關聯變更請求',
  'session.changeRequestPicker.description': '選擇 Pull Request 或 Merge Request，將審查內容附加到此訊息。',
  'session.changeRequestPicker.searchPlaceholder': '依標題或編號搜尋，或貼上變更請求 URL',
  'session.changeRequestPicker.includeDiffAria': '在附加內容中包含變更請求差異',
  'session.changeRequestPicker.includeDiff': '包含差異',
  'session.changeRequestPicker.loading.changeRequests': '正在載入變更請求...',
  'session.changeRequestPicker.actions.useChangeRequest': '使用變更請求 {reference}',
  'session.changeRequestPicker.empty.noneFound': '找不到變更請求',
  'session.changeRequestPicker.empty.noneOpen': '找不到開啟中的變更請求',
  'session.issuePicker.title': '關聯議題',
  'session.issuePicker.description': '選擇一個議題，將其內容附加到此訊息。',
  'session.issuePicker.searchPlaceholder': '依標題或編號搜尋，或貼上議題 URL',
  'session.issuePicker.loading.issues': '正在載入議題...',
  'session.issuePicker.actions.useIssue': '使用議題 #{number}',
  'session.issuePicker.empty.noneFound': '找不到議題',
  'session.issuePicker.empty.noneOpen': '找不到開啟中的議題',
  ...
  'session.newWorktree.error.changeRequestAuthorityMissing': '變更請求授權已無法使用。請重新選取。',
  'session.newWorktree.trust.confirmation': '此簽出包含可執行動作：\n\n{actions}\n\n現在執行嗎？取消將保留可供 Git 使用的簽出，且不執行這些動作。',
