...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.scheduledTasks.dialog.actions.lastRunAria': '開啟 {taskName} 的上次執行工作階段',
  ...
  'sessions.scheduledTasks.editor.lifecycle.title': '生命週期',
  'sessions.scheduledTasks.editor.archiveOnSuccess.label': '封存成功的執行',
  'sessions.scheduledTasks.editor.archiveOnSuccess.aria': '在執行成功後封存工作階段',
