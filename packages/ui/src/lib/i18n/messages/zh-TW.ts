...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.history.actions.conflictToastDescription': '衝突檔案：{files}。請手動解決並提交，或使用操作橫幅中的中止按鈕。',
  'gitView.history.actions.conflictToastTitle': '衝突',
  'gitView.history.actions.unknownFiles': '未知檔案',
  ...
  'gitView.history.actions.resetHardDirtyTitle': '捨棄未提交的變更？',
  'gitView.history.actions.resetHardDirtyDescription': '工作樹中有未提交的變更。硬重置會永久捨棄它們。',
  'gitView.history.actions.resetHardDirtyConfirmButton': '捨棄並重置',
  'gitView.history.actions.resetMixed': '重置（混合）',
  'gitView.history.actions.resetMixedConfirm': 'Mixed reset — HEAD 會移動，變更將取消暫存。',
  'gitView.history.actions.resetSoft': '重置（軟）',
  ...
  'gitView.graph.tags': '標籤',
  'gitView.graph.manualSelection': '選擇要包含在圖譜中的參照。',
  'gitView.graph.incomingChanges': '傳入變更',
  'gitView.graph.outgoingChanges': '傳出變更',
  'gitView.graph.outdated': '圖譜歷史已過期，請重新整理。',
  'gitView.graph.mergeBaseLookupFailed': '無法比較此圖譜的傳入與傳出變更。',
  'gitView.graph.resizeAria': '調整圖譜面板大小',
  'gitView.preview.overlayAnnouncement': '差異預覽已開啟。按 Escape 關閉。',
  'gitView.preview.resizeAria': '調整差異預覽大小',
  'gitView.preview.submodulePointer': '子模組指標',
  'gitView.preview.tooLargeDescription': '此差異為 {totalSize}，已超過 {maxSize} 預覽限制。',
  ...
  'gitView.operation.cherryPickInProgress': '精選進行中',
  'gitView.operation.revertInProgress': '還原進行中',
  ...
  'gitView.toast.cherryPickCompleted': '精選已完成',
  'gitView.toast.cherryPickAborted': '精選已中止',
  'gitView.toast.cherryPickConflictsDetected': '偵測到精選衝突',
  'gitView.toast.revertCompleted': '還原已完成',
  'gitView.toast.revertAborted': '還原已中止',
  'gitView.toast.revertConflictsDetected': '偵測到還原衝突',
  ...
  'gitView.history.actions.createBranchEllipsis': '建立分支…',
  'gitView.history.actions.createTagConfirm': '建立',
  'gitView.history.actions.createTagEllipsis': '建立標籤…',
  'gitView.history.actions.createTagPlaceholder': '標籤名稱',
  'gitView.history.actions.checkoutDetached': '檢出（分離）',
  'gitView.history.actions.compareWithMergeBase': '與合併基準比較',
  'gitView.history.actions.compareWithRef': '比較…',
  'gitView.history.actions.compareWithRemote': '與遠端比較',
  'gitView.history.actions.comparingWith': '正在與 {name} 比較',
  'gitView.history.actions.copyMessage': '複製提交訊息',
  'gitView.history.actions.clearComparison': '清除比較',
  'gitView.history.actions.openChanges': '開啟變更',
  'gitView.toast.commitMessageCopied': '提交訊息已複製',
  'gitView.toast.tagCreated': '已建立標籤 {name}',
  'gitView.graph.mergeBaseLabel': '合併基準',
};
