...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.toolGroup.context.title.active': '正在探索',
  'chat.toolGroup.context.title.done': '已探索',
  'chat.toolGroup.context.title.failed': '探索失敗',
  'chat.toolGroup.context.summary.readSingle': '{count} 次讀取',
  'chat.toolGroup.context.summary.searchSingle': '{count} 次搜尋',
  'chat.toolGroup.context.summary.listSingle': '{count} 個目錄',
  'chat.toolGroup.context.summary.readPluralFew': '{count} 次讀取',
  'chat.toolGroup.context.summary.readPluralMany': '{count} 次讀取',
  'chat.toolGroup.context.summary.searchPluralFew': '{count} 次搜尋',
  'chat.toolGroup.context.summary.searchPluralMany': '{count} 次搜尋',
  'chat.toolGroup.context.summary.listPluralFew': '{count} 個目錄',
  'chat.toolGroup.context.summary.listPluralMany': '{count} 個目錄',
  'chat.toolGroup.context.child.active': '進行中',
  'chat.toolGroup.context.child.error': '錯誤',
  'chat.toolGroup.context.child.read': '讀取',
  'chat.toolGroup.context.child.search': '搜尋',
  'chat.toolGroup.context.child.list': '清單',
  'chat.toolGroup.context.actions.expandWithSummary': '展開上下文工具詳細資料：{summary}',
  'chat.toolGroup.context.actions.collapseWithSummary': '收合上下文工具詳細資料：{summary}',
  'chat.todo.total': '總計',
