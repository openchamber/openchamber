...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'contextPanel.mode.agentBrowser': '代理瀏覽器',
  'contextRail.surface.agentBrowser.description': '由代理操控的即時瀏覽器',
  'agentBrowser.viewport.desktop': '桌面',
  'agentBrowser.viewport.laptop': '筆電',
  'agentBrowser.viewport.tablet': '平板',
  'agentBrowser.viewport.mobile': '手機',
  'agentBrowser.actions.newTab': '新增分頁',
  'agentBrowser.actions.reload': '重新載入',
  'agentBrowser.actions.go': '前往',
  'agentBrowser.actions.screenshot': '擷取螢幕截圖',
  'agentBrowser.actions.startRecording': '開始錄製',
  'agentBrowser.actions.stopRecording': '停止錄製',
  'agentBrowser.recording.active': '錄製中',
  'agentBrowser.urlBar.placeholder': '輸入要開啟的網址',
  'agentBrowser.tab.untitled': '新增分頁',
  'agentBrowser.tab.close': '關閉分頁',
  'agentBrowser.preview.aria': '即時瀏覽器預覽',
  'agentBrowser.preview.waitingFrame': '正在等待第一個畫面…',
  'agentBrowser.preview.connecting': '正在連線至瀏覽器…',
  'agentBrowser.empty.noTabs': '沒有開啟的分頁',
  'agentBrowser.empty.title': '沒有開啟的瀏覽器分頁',
  'agentBrowser.empty.description': '開啟一個分頁，讓代理在你觀看時瀏覽並操作 Web 應用程式。',
  'agentBrowser.unsupported.title': '瀏覽器介面無法使用',
  'agentBrowser.unsupported.description': '伺服器上找不到相容於 Chrome 的瀏覽器。請在設定 → 代理瀏覽器安裝 Chrome，或設定路徑 / OPENCHAMBER_BROWSER_PATH。',
  'agentBrowser.artifacts.title': '擷取',
  'agentBrowser.artifacts.screenshot': '螢幕截圖',
  'agentBrowser.artifacts.recording': '錄製',
  'agentBrowser.control.agentActive': '代理正在控制',
  'agentBrowser.takeover.title': '要接管瀏覽器嗎？',
  'agentBrowser.takeover.description': '代理正在使用瀏覽器。接管後將停止該代理。',
  'agentBrowser.takeover.confirm': '接管',
  'agentBrowser.takeover.cancel': '取消',
