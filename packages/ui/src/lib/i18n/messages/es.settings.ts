...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.visual.field.worktreeDiscovery": "Detectar worktrees de Git automáticamente",
  "settings.openchamber.visual.field.worktreeDiscoveryAria": "Activar la detección automática de worktrees de Git",
  "settings.openchamber.visual.field.worktreeDiscoveryInfo": "Cuando está activado, la barra lateral detecta worktrees de Git para el proyecto activo y los proyectos con sesiones activas.",
  "settings.openchamber.visual.field.worktreeDiscoveryInterval": "Intervalo de actualización de detección de worktrees",
  "settings.openchamber.visual.field.worktreeDiscoveryIntervalAria": "Seleccionar intervalo de actualización de worktrees",
  "settings.openchamber.visual.field.worktreeDiscoveryIntervalInfo": "Tiempo mínimo entre ejecuciones de detección automática.",
  "settings.openchamber.visual.option.worktreeDiscoveryInterval.0": "Inmediatamente",
  ...
  "settings.openchamber.visual.field.backgroundProjectSessionLoading": "Cargar sesiones de todos los proyectos en segundo plano",
  "settings.openchamber.visual.field.backgroundProjectSessionLoadingAria": "Activar la carga de sesiones de todos los proyectos en segundo plano",
  "settings.openchamber.visual.field.backgroundProjectSessionLoadingInfo": "Cuando está activado, OpenChamber carga los datos de sesión de todos los proyectos de la barra lateral.",
