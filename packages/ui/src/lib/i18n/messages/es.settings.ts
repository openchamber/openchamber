...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.defaults.field.defaultDirectory": "Directorio predeterminado",
  "settings.openchamber.defaults.field.defaultDirectoryHint": "Las nuevas sesiones se inician en este directorio cuando no se elige ninguno. Déjalo vacío para mantener el comportamiento actual.",
  "settings.openchamber.defaults.field.defaultDirectoryPlaceholder": "Déjalo vacío para usar el directorio actual",
  "settings.openchamber.defaults.actions.browseDirectory": "Examinar",
  "settings.openchamber.defaults.actions.browseDirectoryAria": "Examinar un directorio",
