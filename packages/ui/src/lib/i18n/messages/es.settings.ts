...
export const settingsDict = {
  ...
  "settings.page.fusion.title": "Fusión",
  "settings.page.fusion.description": "Paneles de modelos seleccionados para fusión de modelos.",
  "settings.fusion.empty": "Aún no hay presets. Añade el primero.",
  "settings.fusion.add": "Añadir preset",
  "settings.fusion.edit": "Editar",
  "settings.fusion.delete": "Eliminar",
  "settings.fusion.deleteTitle": "Eliminar preset de fusión",
  "settings.fusion.deleteConfirm": "¿Eliminar el preset {name}?",
  "settings.fusion.dialogTitleNew": "Nuevo preset de fusión",
  "settings.fusion.dialogTitleEdit": "Editar preset de fusión",
  "settings.fusion.dialogDescription": "Un panel con nombre de 2-4 modelos.",
  "settings.fusion.nameLabel": "Nombre",
  "settings.fusion.descriptionLabel": "Descripción",
  "settings.fusion.modelsLabel": "Modelos ({count}/4)",
  "settings.fusion.modelsHint": "Elige de 2 a 4 modelos.",
  "settings.fusion.searchModels": "Buscar modelos",
  "settings.fusion.noModelResults": "Ningún modelo coincide con tu búsqueda.",
  "settings.fusion.save": "Guardar",
  "settings.fusion.cancel": "Cancelar",
  "settings.fusion.loading": "Cargando…",
  "settings.fusion.loadError": "No se pudieron cargar los presets: {error}",
  "settings.fusion.noModels": "No hay modelos configurados para este directorio.",
  "settings.fusion.required": "Se requieren nombre + 2-4 modelos.",
