...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.visual.field.showMessageSpeedMetricsAria": "Mostrar métricas de velocidad del mensaje",
  "settings.openchamber.visual.field.showMessageSpeedMetrics": "Mostrar métricas de velocidad del mensaje",
  "settings.openchamber.visual.field.showMessageSpeedMetricsInfo": "Muestra el tiempo hasta el primer token, el rendimiento de salida y el desglose de entrada no cacheada / caché / salida en cada mensaje del asistente. El tiempo hasta el primer token se mide en el servidor de OpenCode desde el inicio del mensaje hasta la primera parte de razonamiento o texto.",
