...
export const settingsDict = {
  ...
  "settings.magicPrompts.sidebar.item.gitlabPrReview": "Revisión de MR",
  "settings.magicPrompts.sidebar.item.gitlabIssueReview": "Revisión de issue",
  "settings.magicPrompts.sidebar.item.giteaPrReview": "Revisión de PR",
  "settings.magicPrompts.sidebar.item.giteaIssueReview": "Revisión de issue",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.gitea.page.title": "Token de acceso personal de Gitea / Forgejo",
  "settings.gitea.page.description": "Pega un token de acceso personal de Gitea o Forgejo para conectarte. Establece la URL base cuando uses una instancia de Gitea o Forgejo autoalojada.",
  "settings.gitea.page.tooltip.connectAccount": "Conecta una cuenta de Gitea o Forgejo para los flujos de trabajo de issues y pull requests en la aplicación.",
  "settings.gitea.page.accessToken.label": "Token de acceso personal",
  "settings.gitea.page.accessToken.placeholder": "Pega tu token de acceso personal de Gitea",
  ...
  "settings.gitea.page.actions.switch": "Cambiar a",
  "settings.gitea.page.status.notConnected": "No conectado",
  "settings.gitea.page.label.unknownUser": "desconocido",
  "settings.gitea.page.label.otherAccounts": "Otras cuentas",
  "settings.gitea.page.avatarAlt.withLogin": "Avatar de {login}",
  "settings.gitea.page.avatarAlt.fallback": "Avatar de Gitea",
  "settings.gitea.page.connectedAs": "Conectado como",
  "settings.gitea.page.errors.invalidToken": "Introduce un token de acceso personal de Gitea válido",
  "settings.gitea.page.errors.failed": "No se pudo conectar Gitea",
  ...
  "settings.magicPrompts.page.group.gitlabPrReview.title": "Revisión de MR",
  "settings.magicPrompts.page.group.gitlabPrReview.description": "Prompts usados para el flujo de revisión de MR de GitLab: mensaje visible del usuario + carga de instrucciones ocultas.",
  "settings.magicPrompts.page.group.gitlabIssueReview.title": "Revisión de issue",
  "settings.magicPrompts.page.group.gitlabIssueReview.description": "Prompts usados para el flujo de revisión de issue de GitLab: mensaje visible del usuario + carga de instrucciones ocultas.",
  "settings.magicPrompts.page.group.giteaPrReview.title": "Revisión de PR",
  "settings.magicPrompts.page.group.giteaPrReview.description": "Prompts usados para el flujo de revisión de PR de Gitea: mensaje visible del usuario + carga de instrucciones ocultas.",
  "settings.magicPrompts.page.group.giteaIssueReview.title": "Revisión de issue",
  "settings.magicPrompts.page.group.giteaIssueReview.description": "Prompts usados para el flujo de revisión de issue de Gitea: mensaje visible del usuario + carga de instrucciones ocultas.",
