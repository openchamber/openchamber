...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.scrollBehavior.title": "Posición de desplazamiento",
  "settings.openchamber.scrollBehavior.description": "Elige dónde se reabre una sesión cuando vuelves a ella. El valor predeterminado es restaurar tu posición anterior.",
  "settings.openchamber.scrollBehavior.option.restore.label": "Restaurar posición anterior",
  "settings.openchamber.scrollBehavior.option.jumpToEnd.label": "Saltar siempre al final",
  "settings.openchamber.scrollBehavior.sectionAria": "Comportamiento de desplazamiento de sesión al cambiar",
  "settings.openchamber.scrollBehavior.field.modeAria": "Comportamiento de desplazamiento: {option}",
