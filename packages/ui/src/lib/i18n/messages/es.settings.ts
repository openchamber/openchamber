export const settingsDict = {
  ...
  "settings.page.harness.description": "Elige y administra los harnesses de ejecución.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.harness.sidebar.subtitle": "Backends de ejecución para sesiones de chat",
  "settings.harness.sidebar.harness.opencode": "OpenCode",
  "settings.harness.sidebar.harness.claudeCode": "Claude Code",
  "settings.harness.sidebar.status.ready": "Listo",
  "settings.harness.sidebar.status.needsLogin": "Requiere inicio de sesión",
  "settings.harness.sidebar.status.missingCli": "Falta la CLI",
  "settings.harness.sidebar.status.unsupportedHost": "No disponible aquí",
  "settings.harness.sidebar.status.error": "Error",
  "settings.harness.sidebar.status.unknown": "Desconocido",
  "settings.harness.sidebar.status.loading": "Comprobando…",
  "settings.harness.page.empty.selectHarness": "Selecciona un harness en la barra lateral",
  "settings.harness.page.loadError": "No se pudo cargar el estado del harness",
  "settings.harness.opencode.title": "OpenCode",
  "settings.harness.opencode.description": "Harness predeterminado. Usa proveedores y agentes de OpenCode.",
  "settings.harness.opencode.section.about": "Acerca de",
  "settings.harness.opencode.about.body": "OpenCode ejecuta modelos a través de tus proveedores configurados. Administra las claves API en Proveedores y la configuración de agentes en Agentes.",
  "settings.harness.opencode.link.providers": "Abrir Proveedores",
  "settings.harness.opencode.link.agents": "Abrir Agentes",
  "settings.harness.claudeCode.title": "Claude Code",
  "settings.harness.claudeCode.description": "CLI nativa de Claude Code con límites de uso de la suscripción.",
  "settings.harness.claudeCode.section.status": "Estado",
  "settings.harness.claudeCode.field.status": "Estado",
  "settings.harness.claudeCode.field.version": "Versión",
  "settings.harness.claudeCode.status.version": "{version}",
  "settings.harness.claudeCode.status.versionUnknown": "Desconocida",
  "settings.harness.claudeCode.actions.redetect": "Volver a detectar",
  "settings.harness.claudeCode.actions.redetectAria": "Volver a detectar el estado de Claude Code",
  "settings.harness.claudeCode.actions.openDocs": "Abrir documentación",
  "settings.harness.claudeCode.actions.openDocsAria": "Abrir la documentación de Claude Code",
  "settings.harness.claudeCode.login.title": "Inicia sesión con Claude",
  "settings.harness.claudeCode.login.body": "Instala la CLI de Claude y ejecuta claude login en este host para que OpenChamber use tu suscripción de Claude.",
  "settings.harness.claudeCode.section.capabilities": "Capacidades",
  "settings.harness.claudeCode.capabilities.empty": "Las capacidades aparecen tras una detección correcta.",
  "settings.harness.claudeCode.capability.full": "Completa",
  "settings.harness.claudeCode.capability.partial": "Parcial",
  "settings.harness.claudeCode.capability.none": "No disponible",
  "settings.harness.claudeCode.section.agents": "Agentes",
  "settings.harness.claudeCode.agentsMode.label": "Agentes a usar",
  "settings.harness.claudeCode.agentsMode.aria": "Elegir agentes de Claude o OpenCode para sesiones de Claude Code",
  "settings.harness.claudeCode.agentsMode.info": "Claude usa sus propios agentes, prompts y ajustes de permisos. OpenCode hace que las sesiones de Claude ejecuten en su lugar el agente de OpenCode seleccionado: sus reglas de permisos deciden cada llamada a herramienta, su prompt se añade al de Claude, y tus subagentes personalizados de OpenCode quedan disponibles para Claude. El selector de agente del compositor cambia para coincidir.",
...
"settings.harness.claudeCode.warnHandoff.label": "Confirmar al cambiar de harness",
"settings.harness.claudeCode.warnHandoff.aria": "Confirmar al cambiar de harness",
"settings.harness.claudeCode.warnHandoff.info": "Muestra un diálogo antes de iniciar una nueva sesión al cambiar de harness. Si está desactivado, el cambio se aplica silenciosamente con tu próximo mensaje.",
  "settings.harness.claudeCode.section.import": "Importar",
  "settings.harness.claudeCode.import.note": "Importa proyectos y chats locales de Claude Code a OpenChamber. Los chats se reanudan en Claude Code; las transcripciones no se copian al historial de OpenCode.",
  "settings.harness.claudeCode.import.actions.open": "Importar desde Claude Code",
  "settings.harness.claudeCode.import.actions.openAria": "Abrir el diálogo de importación de Claude Code",
  "settings.harness.claudeCode.import.dialog.title": "Importar desde Claude Code",
  "settings.harness.claudeCode.import.dialog.description": "Selecciona chats guardados en la carpeta de proyectos de Claude Code en este host. Los chats ya importados se omiten.",
  "settings.harness.claudeCode.import.dialog.loading": "Analizando proyectos de Claude Code…",
  "settings.harness.claudeCode.import.dialog.empty": "No se encontraron chats de Claude Code en este host.",
  "settings.harness.claudeCode.import.dialog.selectAll": "Seleccionar todo",
  "settings.harness.claudeCode.import.dialog.selectAllAria": "Seleccionar todos los chats de Claude Code importables",
  "settings.harness.claudeCode.import.dialog.selectedCount": "{count} seleccionados",
  "settings.harness.claudeCode.import.dialog.projectAria": "Seleccionar todos los chats en {name}",
  "settings.harness.claudeCode.import.dialog.sessionAria": "Seleccionar chat {title}",
  "settings.harness.claudeCode.import.dialog.sessionCount": "{count} chats",
  "settings.harness.claudeCode.import.dialog.directoryMissing": "Carpeta ausente",
  "settings.harness.claudeCode.import.dialog.alreadyImported": "Ya importado",
  "settings.harness.claudeCode.import.dialog.untitled": "Chat sin título",
  ...
  "settings.harness.claudeCode.import.error.load": "No se pudieron analizar los proyectos de Claude Code.",
  "settings.harness.claudeCode.import.error.import": "Error al importar.",
  "settings.harness.claudeCode.import.toast.success": "Se importaron {count} chats de Claude Code.",
  "settings.harness.claudeCode.import.toast.skippedOnly": "Se omitieron {count} chats que ya estaban importados.",
  "settings.harness.claudeCode.import.toast.partialFail": "Importados: {imported}; fallidos: {failed}.",
  "settings.harness.claudeCode.import.toast.none": "No se importó nada.",
  "settings.harness.claudeCode.section.apiKeys": "Claves API",
  "settings.harness.claudeCode.apiKeys.note": "Las claves API de Anthropic permanecen en Proveedores de OpenCode. Claude Code usa el inicio de sesión de suscripción de Claude en el host.",
  "settings.harness.capability.prompt": "Prompt",
  "settings.harness.capability.abort": "Abortar",
  "settings.harness.capability.resume": "Reanudar",
  "settings.harness.capability.streaming-text": "Texto en streaming",
  "settings.harness.capability.streaming-tools": "Herramientas en streaming",
  "settings.harness.capability.permissions": "Permisos",
  "settings.harness.capability.images": "Imágenes",
  "settings.harness.capability.file-attachments": "Archivos adjuntos",
  ...
  "settings.harness.capability.openchamber-tool": "Herramienta OpenChamber",
