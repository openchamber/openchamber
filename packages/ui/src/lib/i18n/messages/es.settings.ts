...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.engines.claudeCode.agentsMode.aria": "Elegir agentes de Claude o OpenCode para sesiones de Claude Code",
  "settings.engines.claudeCode.agentsMode.info": "Claude usa los prompts de sistema y permisos nativos de Claude Code. OpenCode usa los agentes de OpenChamber para permisos y prompts de sistema en las sesiones de Claude.",
  ...
  "settings.engines.claudeCode.import.note": "Importa proyectos y chats locales de Claude Code a OpenChamber. Los chats se reanudan en Claude Code; las transcripciones no se copian al historial de OpenCode.",
  "settings.engines.claudeCode.import.actions.open": "Importar desde Claude Code",
  "settings.engines.claudeCode.import.actions.openAria": "Abrir el diálogo de importación de Claude Code",
  "settings.engines.claudeCode.import.dialog.title": "Importar desde Claude Code",
  "settings.engines.claudeCode.import.dialog.description": "Selecciona chats guardados en la carpeta de proyectos de Claude Code en este host. Los chats ya importados se omiten.",
  "settings.engines.claudeCode.import.dialog.loading": "Analizando proyectos de Claude Code…",
  "settings.engines.claudeCode.import.dialog.empty": "No se encontraron chats de Claude Code en este host.",
  "settings.engines.claudeCode.import.dialog.selectAll": "Seleccionar todo",
  "settings.engines.claudeCode.import.dialog.selectAllAria": "Seleccionar todos los chats de Claude Code importables",
  "settings.engines.claudeCode.import.dialog.selectedCount": "{count} seleccionados",
  "settings.engines.claudeCode.import.dialog.projectAria": "Seleccionar todos los chats en {name}",
  "settings.engines.claudeCode.import.dialog.sessionAria": "Seleccionar chat {title}",
  "settings.engines.claudeCode.import.dialog.sessionCount": "{count} chats",
  "settings.engines.claudeCode.import.dialog.directoryMissing": "Carpeta ausente",
  "settings.engines.claudeCode.import.dialog.alreadyImported": "Ya importado",
  "settings.engines.claudeCode.import.dialog.untitled": "Chat sin título",
  ...
  "settings.engines.claudeCode.import.error.load": "No se pudieron analizar los proyectos de Claude Code.",
  "settings.engines.claudeCode.import.error.import": "Error al importar.",
  "settings.engines.claudeCode.import.toast.success": "Se importaron {count} chats de Claude Code.",
  "settings.engines.claudeCode.import.toast.skippedOnly": "Se omitieron {count} chats que ya estaban importados.",
  "settings.engines.claudeCode.import.toast.partialFail": "Importados: {imported}; fallidos: {failed}.",
  "settings.engines.claudeCode.import.toast.none": "No se importó nada.",
