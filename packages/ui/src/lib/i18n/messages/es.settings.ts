...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'Pega la cookie de sesión de ollama.com (busca __Secure-session=... en las herramientas del navegador). Esta no es tu clave API ni tu endpoint local de Ollama. OpenChamber nunca examina las cookies del navegador.',
