...
export const settingsDict = {
  ...
  "settings.openchamber.tunnel.field.tailscaleHttpsPort": "Puerto HTTPS de Tailscale",
  "settings.openchamber.tunnel.field.tailscaleHttpsPortDescription": "Puerto frontend de Tailscale. Serve acepta cualquier puerto del 1 al 65535; Funnel admite 443, 8443 o 10000.",
  "settings.openchamber.tunnel.field.tailscaleServeHttpsPortDescription": "Serve acepta cualquier número entero del 1 al 65535.",
  "settings.openchamber.tunnel.field.tailscaleFunnelHttpsPortDescription": "Funnel solo admite 443, 8443 o 10000.",
  "settings.openchamber.tunnel.field.tailscaleHttpsPortError": "Introduce un número entero del 1 al 65535.",
  ...
  "settings.openchamber.tunnel.notAvailable.tailscaleInstallHint": "Instala Tailscale e inicia sesión en este dispositivo antes de comenzar:",
  "settings.openchamber.tunnel.option.mode.privateNetwork.label": "Solo tailnet (Serve)",
  "settings.openchamber.tunnel.option.mode.privateNetwork.tooltip": "Tailscale Serve mantiene el acceso dentro de tu tailnet.",
  "settings.openchamber.tunnel.option.mode.tailscaleQuick.label": "Público (Funnel)",
  "settings.openchamber.tunnel.option.mode.tailscaleQuick.tooltip": "Tailscale Funnel permite acceder a esta instancia desde Internet.",
  "settings.openchamber.tunnel.warning.tailscaleFunnelPublic": "Tailscale Funnel expone esta instancia a Internet. Úsalo solo cuando quieras que el acceso sea público.",
  "settings.openchamber.tunnel.badge.privateNetwork": "Tailnet",
  "settings.openchamber.tunnel.toast.startedButNoUrl": "El túnel se inició, pero no devolvió una URL de acceso.",
  "settings.openchamber.tunnel.field.tailnetUrlHint": "URL de tailnet",
