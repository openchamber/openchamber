...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.providers.sidebar.section.customProviders": "Proveedores personalizados",
  ...
  "settings.providers.page.connect.availableProvidersSection": "Proveedores disponibles",
  "settings.providers.page.connect.configureCustomProvider": "Configurar proveedor personalizado",
  ...
  "settings.providers.page.custom.description": "Añade un proveedor con protocolo de API, URL base, credenciales y lista de modelos. Se guarda en la configuración de OpenCode para usarlo en el chat como cualquier otro proveedor.",
  ...
  "settings.providers.page.custom.protocol.info": "Selecciona el formato de solicitud y respuesta compatible con este proveedor. El adaptador añade el endpoint del protocolo a la URL base.",
  ...
  "settings.providers.page.custom.field.baseURL.info": "URL base de la API sin el endpoint del protocolo. Debe empezar por http:// o https://.",
  ...
  "settings.providers.page.custom.models.contextLimitLabel": "Ventana de contexto",
  "settings.providers.page.custom.models.contextLimitInfo": "Número máximo de tokens que el modelo puede tener en cuenta en una solicitud.",
  ...
  "settings.providers.page.custom.models.inputLimitInfo": "Límite opcional de tokens del prompt cuando difiere de la ventana de contexto total.",
  "settings.providers.page.custom.models.inputLimitPlaceholder": "Opcional",
  "settings.providers.page.custom.models.outputLimitLabel": "Salida máxima",
  "settings.providers.page.custom.models.outputLimitInfo": "Número máximo de tokens que el modelo puede generar en una respuesta.",
  "settings.providers.page.custom.models.outputLimitPlaceholder": "8192",
  "settings.providers.page.custom.models.imageInputLabel": "Entrada de imagen",
  "settings.providers.page.custom.models.imageInputInfo": "Indica si este modelo acepta imágenes. «Compatible» añade las modalidades de entrada de texto e imagen.",
  "settings.providers.page.custom.models.reasoningInfo": "Indica si este modelo admite razonamiento.",
  "settings.providers.page.custom.models.toolCallingInfo": "Indica si este modelo admite llamadas a herramientas.",
  "settings.providers.page.custom.models.thinkingLevelsInfo": "Valores de esfuerzo de razonamiento, separados por comas, compatibles con el protocolo y modelo seleccionados. Cada valor se convierte en una variante de modelo seleccionable.",
  "settings.providers.page.custom.models.thinkingLevelsPlaceholder": "low, medium, high",
  "settings.providers.page.custom.models.capability.default": "Usar valor predeterminado de OpenCode",
  "settings.providers.page.custom.models.capability.supported": "Compatible",
  "settings.providers.page.custom.models.capability.unsupported": "No compatible",
  ...
  "settings.providers.page.custom.error.positiveInteger": "Introduce un número entero positivo",
  ...
  "settings.providers.page.models.capability.imageInputUnsupported": "Sin entrada de imagen",
  "settings.providers.page.models.thinkingLevels": "Niveles de razonamiento",
  "settings.providers.page.models.tokenBadge.context": "contexto",
  "settings.providers.page.models.tokenBadge.output": "salida máxima",
