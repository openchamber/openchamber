...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.page.analytics.title": "Análisis",
  "settings.analytics.scope.project": "Este proyecto",
  "settings.analytics.scope.all": "Todos los proyectos",
  "settings.analytics.period.groupLabel": "Rango de tiempo",
  "settings.analytics.period.7d": "7 días",
  "settings.analytics.period.30d": "30 días",
  "settings.analytics.period.90d": "90 días",
  "settings.analytics.period.all": "Todo el tiempo",
  "settings.analytics.action.refresh": "Actualizar",
  "settings.analytics.state.errorTitle": "No se pudieron cargar los análisis",
  "settings.analytics.state.empty":
      "No hay datos de sesiones para el rango seleccionado",
  "settings.analytics.kpi.sectionTitle": "Resumen",
  "settings.analytics.kpi.tokens": "Tokens",
  "settings.analytics.kpi.cost": "Coste",
  "settings.analytics.kpi.sessions": "Sesiones",
  "settings.analytics.kpi.activeDays": "Días activos",
  "settings.analytics.kpi.streak": "Racha de días",
  "settings.analytics.quota.title": "Cuotas de proveedores",
  "settings.analytics.quota.none": "No hay proveedores configurados",
  "settings.analytics.quota.manage": "Gestionar límites",
  "settings.analytics.topSessions.title": "Sesiones principales",
  "settings.analytics.topSessions.open": "Abrir sesión",
  "settings.analytics.topSessions.empty":
      "No hay sesiones en el rango seleccionado",
  "settings.analytics.tab.trends": "Tendencias",
  "settings.analytics.kpi.deltaUp": "↑ {value}% vs período anterior",
  "settings.analytics.kpi.deltaDown": "↓ {value}% vs período anterior",
  "settings.analytics.kpi.deltaNew": "Nuevo",
  "settings.analytics.kpi.deltaFlat": "—",
  "settings.analytics.kpi.cacheHitRate": "Tasa de caché",
  "settings.analytics.trends.metric.tokens": "Tokens",
  "settings.analytics.trends.metric.cost": "Coste",
  "settings.analytics.trends.metric.sessions": "Sesiones",
  "settings.analytics.trends.tokenBreakdown.title": "Desglose de tokens",
  "settings.analytics.trends.tokenBreakdown.ariaLabel":
      "Desglose de tokens en el tiempo",
  ...
  "settings.analytics.trends.tokenBreakdown.cached": "En caché",
  "settings.analytics.trends.cache.title": "Caché de prompts",
  "settings.analytics.trends.cache.ariaLabel": "Caché de prompts en el tiempo",
  "settings.analytics.trends.cache.cached": "En caché",
  "settings.analytics.trends.cache.uncached": "Sin caché",
  "settings.analytics.trends.byModel.other": "Otros",
  "settings.analytics.yearHeatmap.title": "Actividad",
  "settings.analytics.yearHeatmap.less": "Menos",
  "settings.analytics.yearHeatmap.more": "Más",
  "settings.analytics.summary.title": "Resumen de uso",
  "settings.analytics.summary.dailyByModel": "Diario · por modelo",
  "settings.analytics.summary.topModels": "Modelos principales",
  "settings.analytics.summary.view.daily": "Diario",
  "settings.analytics.summary.view.total": "Total",
  "settings.analytics.summary.view.aria": "Vista",
  "settings.analytics.summary.chartToggleAria": "Alternar entre gráfico de barras y de líneas",
  "settings.analytics.summary.chartType.bar": "Gráfico de barras",
  "settings.analytics.summary.chartType.line": "Gráfico de líneas",
  "settings.analytics.activity.longestStreak": "Racha más larga",
  "settings.analytics.activity.avgPerDay": "Prom. / día",
  "settings.analytics.activity.avgPerWeek": "Prom. / semana",
  "settings.analytics.activity.total": "Total",
  "settings.analytics.activity.days": "días",
  "settings.analytics.chart.sessionsPerDay": "Sesiones por día",
  "settings.analytics.chart.costPerDay": "Costo por día",
  "settings.analytics.efficiency.title": "Eficiencia",
  "settings.analytics.efficiency.costPerMillion": "$ / 1M tokens",
  "settings.analytics.efficiency.costPerSession": "Costo / sesión",
  "settings.analytics.efficiency.tokensPerSession": "Tokens / sesión",
  "settings.analytics.efficiency.reasoningShare": "Proporción de razonamiento",
  "settings.analytics.efficiency.avgDuration": "Duración media",
  "settings.analytics.efficiency.medianDuration": "Duración mediana",
  "settings.analytics.efficiency.longestDuration": "Duración más larga",
  "settings.analytics.agents.title": "Uso de agentes",
  "settings.analytics.agents.empty": "Sin datos de agentes",
  "settings.analytics.rhythm.title": "Ritmo de actividad",
  "settings.analytics.rhythm.hoursAria": "Actividad por hora",
} as const;
