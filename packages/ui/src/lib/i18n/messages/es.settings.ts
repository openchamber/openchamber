...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.worktrees.list.archiveWorktreeAria": "Archivar worktree {name}",
  "settings.openchamber.worktrees.list.archiveSuccess": "Worktree archivado",
  "settings.openchamber.worktrees.list.archiveFailed": "No se pudo archivar el worktree",
  "settings.openchamber.worktrees.list.archivePartial": "Worktree archivado, pero {fail}/{total} sesiones no se pudieron archivar",
  "settings.openchamber.worktrees.archived.title": "Worktrees archivados",
  ...
  "settings.openchamber.worktrees.archived.restoreFailed": "No se pudo restaurar el worktree",
  "settings.openchamber.worktrees.archived.restorePartial": "Worktree restaurado, pero {fail}/{total} sesiones no se pudieron restaurar",
