...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.providers.copilotGhe.serverUrlLabel": "URL del servidor",
  ...
  "settings.providers.copilotGhe.clientIdPlaceholder": "Déjalo en blanco para usar el valor predeterminado",
  "settings.providers.copilotGhe.clientIdHint": "Deja Client ID en blanco para usar el valor predeterminado de OpenChamber ({clientId}).",
  "settings.providers.copilotGhe.status.authorizationPending": "La autorización aún está pendiente. Completa el flujo de dispositivo en tu navegador y luego haz clic en Completar de nuevo.",
  "settings.providers.copilotGhe.status.slowDown": "GitHub Enterprise Server pidió reducir la frecuencia de sondeo. Espera un momento y luego haz clic en Completar de nuevo.",
  "settings.providers.copilotGhe.toast.serverUrlRequired": "La URL del servidor es obligatoria",
  "settings.providers.copilotGhe.toast.startFirst": "Primero inicia el flujo de dispositivo",
  "settings.providers.copilotGhe.toast.startFailed": "No se pudo iniciar el flujo de autenticación de GitHub Enterprise Server",
  "settings.providers.copilotGhe.toast.completeFailed": "No se pudo completar el flujo de autenticación de GitHub Enterprise Server",
  "settings.providers.copilotGhe.toast.authorizationPending": "La autorización sigue pendiente",
  "settings.providers.copilotGhe.toast.slowDown": "GitHub Enterprise Server solicitó reducir la velocidad",
