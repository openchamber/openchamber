...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.agents.sidebar.error.title": "No se pudieron cargar los agentes",
  "settings.agents.sidebar.error.description": "Backend de OpenCode no disponible. Comprueba la conexión e inténtalo de nuevo.",
  "settings.agents.sidebar.error.retry": "Reintentar",
