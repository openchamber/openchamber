...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.visual.field.messageSpeedMetrics": "Mostrar métricas de velocidad de respuesta",
  "settings.openchamber.visual.field.messageSpeedMetricsAria": "Mostrar métricas de velocidad bajo las respuestas completadas",
  "settings.openchamber.visual.field.messageSpeedMetricsInfo": "Muestra el TTFT (tiempo hasta el primer token) y los tokens de salida por segundo bajo las respuestas completadas. Útil para comparar proveedores y relés.",
