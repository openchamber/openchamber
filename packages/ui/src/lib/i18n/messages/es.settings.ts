export const settingsDict = {
  ...
  "settings.page.vision.description": "Permite que los modelos que no pueden ver imágenes las describan mediante un modelo de visión configurado.",
  "settings.vision.section.title": "Herramienta de visión",
  "settings.vision.section.info": "Cuando tu modelo actual no puede ver imágenes, el agente puede invocar una herramienta de visión que lee un archivo de imagen y pide a tu modelo de visión configurado que la describa: contenido, diseño, estilo y todo el texto visible. La descripción se devuelve a tu modelo para que pueda razonar sobre la imagen sin verla. Cada llamada se factura al modelo de visión que elijas aquí.",
  "settings.vision.model.label": "Modelo de visión",
  "settings.vision.model.info": "El modelo que describe las imágenes para la herramienta de visión. Solo se muestran los modelos que aceptan entrada de imágenes; los modelos que el catálogo no puede juzgar permanecen visibles y el servidor los vuelve a validar antes de cada ejecución.",
  "settings.vision.model.notSelected": "Selecciona un modelo de visión",
  "settings.vision.model.required": "Selecciona un modelo de visión para habilitar la herramienta de visión.",
  "settings.vision.prompt.label": "Prompt de descripción",
  "settings.vision.prompt.info": "El prompt que se envía con cada imagen al modelo de visión. Un buen prompt pide contenido, diseño, estilo, colores y texto literal para que tu modelo obtenga una imagen completa. Déjalo vacío para usar el predeterminado integrado.",
  "settings.vision.prompt.placeholder": "Déjalo vacío para usar el prompt predeterminado.",
  "settings.vision.prompt.save": "Guardar",
  "settings.vision.prompt.reset": "Restablecer al predeterminado",
  "settings.vision.toast.saved": "Ajustes de visión guardados",
  "settings.vision.toast.saveFailed": "No se pudieron guardar los ajustes de visión",
  "settings.vision.toast.loadFailed": "No se pudieron cargar los ajustes de visión",
