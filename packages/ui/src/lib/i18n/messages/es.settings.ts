...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.projects.codexImport.action": "Importar conversaciones de Codex",
  "settings.projects.codexImport.title": "Importar desde Codex",
  "settings.projects.codexImport.description": "Añade proyectos de Codex y guarda cada conversación como una transcripción legible de OpenCode. Los datos de Codex no se modifican.",
  "settings.projects.codexImport.loading": "Leyendo proyectos y conversaciones de Codex...",
  "settings.projects.codexImport.error.inspect": "No se pudieron leer los datos de Codex.",
  "settings.projects.codexImport.error.apply": "No se pudieron importar los datos de Codex.",
  "settings.projects.codexImport.config.model": "Modelo: {model}",
  "settings.projects.codexImport.config.provider": "Proveedor: {provider}",
  "settings.projects.codexImport.config.unset": "Sin configurar",
  "settings.projects.codexImport.projects.title": "Proyectos que importar",
  "settings.projects.codexImport.projects.conversations": "Conversaciones: {count}",
  "settings.projects.codexImport.projects.missing": "El directorio ya no está disponible",
  "settings.projects.codexImport.empty": "No se encontraron proyectos ni conversaciones de Codex.",
  "settings.projects.codexImport.actions.retry": "Reintentar",
  "settings.projects.codexImport.actions.selectAll": "Seleccionar todo",
  "settings.projects.codexImport.actions.selectNone": "Deseleccionar todo",
  "settings.projects.codexImport.actions.importing": "Importando...",
  "settings.projects.codexImport.result.summary": "Importadas: {imported}; omitidas: {skipped}; fallidas: {failed}.",
  "settings.projects.codexImport.toast.partial": "Importación de Codex finalizada: {imported} importadas, {skipped} omitidas y {failed} fallidas.",
  "settings.projects.codexImport.toast.complete": "Importación de Codex finalizada: {imported} importadas y {skipped} ya existentes.",
