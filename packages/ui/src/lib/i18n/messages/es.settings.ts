export const settingsDict = {
  ...
  "settings.page.sessions.description": "Define valores predeterminados, gestión de permisos y retención de sesiones.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.permissionAutoAccept.title": "Aceptación automática de permisos",
  "settings.openchamber.permissionAutoAccept.info": "Se aplica a todas las sesiones de este runtime salvo que una sesión active o desactive explícitamente su propia política de permisos. Al activarlo también se resuelven las solicitudes de permisos que ya estén pendientes.",
  "settings.openchamber.permissionAutoAccept.field.globalLabel": "Aprobar automáticamente las solicitudes de permisos para todas las sesiones de este runtime",
  "settings.openchamber.permissionAutoAccept.field.globalAria": "Aprobar automáticamente las solicitudes de permisos para todas las sesiones de este runtime",
  "settings.openchamber.permissionAutoAccept.field.globalWarning": "Seguridad: OpenChamber aprobará las solicitudes de permisos pendientes y futuras sin preguntarte hasta que una sesión anule explícitamente esta política.",
  "settings.openchamber.permissionAutoAccept.dialog.title": "¿Activar la aceptación automática de permisos para todas las sesiones?",
  "settings.openchamber.permissionAutoAccept.dialog.description": "OpenChamber aprobará de inmediato las solicitudes de permisos que ya estén pendientes y seguirá aprobando las nuevas en este runtime hasta que una sesión anule explícitamente la política. Actívalo solo en un runtime de confianza.",
  "settings.openchamber.permissionAutoAccept.dialog.confirm": "Activar aceptación automática",
