...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.remoteInstances.clientAuth.relayEndpoint.info": "Punto de conexión usado para los enlaces de emparejamiento «Desde cualquier lugar» y el acceso por Relay. Apúntalo a un Relay autoalojado para mantener ese tráfico en tu propia infraestructura; un host de Relay en ejecución se reconecta de inmediato. Los enlaces de emparejamiento creados antes conservan su punto de conexión original.",
  "settings.remoteInstances.clientAuth.relayEndpoint.option.default": "Predeterminado",
  "settings.remoteInstances.clientAuth.relayEndpoint.option.custom": "Personalizado",
  "settings.remoteInstances.clientAuth.relayEndpoint.field.placeholder": "wss://tu-relay.example/ws",
  "settings.remoteInstances.clientAuth.relayEndpoint.actions.save": "Guardar",
  "settings.remoteInstances.clientAuth.relayEndpoint.locked": "Fijado por la variable de entorno OPENCHAMBER_RELAY_URL:",
