...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.worktrees.start.label": "Comandos de inicio",
  "settings.openchamber.worktrees.start.commandPlaceholder": "p. ej., ./scripts/run.sh",
  "settings.openchamber.worktrees.start.addCommand": "Añadir comando",
  "settings.openchamber.worktrees.start.removeCommandAria": "Eliminar comando",
  "settings.openchamber.worktrees.start.toast.saveFailed": "Error al guardar los comandos de inicio",
  "settings.openchamber.worktrees.shutdown.label": "Comandos de apagado",
  "settings.openchamber.worktrees.shutdown.commandPlaceholder": "p. ej., ./scripts/stop.sh",
  "settings.openchamber.worktrees.shutdown.addCommand": "Añadir comando",
  "settings.openchamber.worktrees.shutdown.removeCommandAria": "Eliminar comando",
  "settings.openchamber.worktrees.shutdown.toast.saveFailed": "Error al guardar los comandos de apagado",
  "settings.openchamber.worktrees.commands.runStartAria": "Ejecutar comandos de inicio para {name}",
  "settings.openchamber.worktrees.commands.runShutdownAria": "Ejecutar comandos de apagado para {name}",
  "settings.openchamber.worktrees.commands.viewSetupLogAria": "Ver salida de configuración para {name}",
  "settings.openchamber.worktrees.commands.noCommands": "No hay {kind} configurados para este proyecto.",
  "settings.openchamber.worktrees.commands.dialogTitleStart": "Comandos de inicio — {name}",
  "settings.openchamber.worktrees.commands.dialogTitleShutdown": "Comandos de apagado — {name}",
  "settings.openchamber.worktrees.commands.dialogTitleSetup": "Salida de configuración — {name}",
  "settings.openchamber.worktrees.commands.dialogRunning": "Ejecutando...",
  "settings.openchamber.worktrees.commands.dialogFailed": "El comando falló",
  "settings.openchamber.worktrees.commands.dialogTimedOut": "El comando superó el límite de tiempo; se muestra la salida parcial.",
  "settings.openchamber.worktrees.commands.dialogEmptyOutput": "Sin salida.",
  "settings.openchamber.worktrees.commands.dialogClose": "Cerrar",
