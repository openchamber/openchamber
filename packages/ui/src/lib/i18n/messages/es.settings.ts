export const settingsDict = {
  ...
  "settings.openchamber.tunnel.readOnly.title": "Estado del túnel de solo lectura",
  "settings.openchamber.tunnel.readOnly.description": "La gestión del túnel está disponible desde el escritorio del host o una sesión de navegador autenticada.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.remoteInstances.clientAuth.state.viaManagedDirectE2ee": "E2EE directo gestionado",
  "settings.remoteInstances.clientAuth.state.connectedManagedDirectE2ee": "Conectado · E2EE directo gestionado",
  "settings.remoteInstances.clientAuth.addDevice.transport.managedE2ee": "E2EE directo gestionado",
  "settings.remoteInstances.clientAuth.addDevice.transport.managedE2eeHint": "Túnel con cifrado de extremo a extremo gestionado por este servidor. Administre desde el escritorio del host o una sesión de navegador autenticada.",
  ...
  'settings.openchamber.tunnel.field.directE2eeLabel': 'Cifrado de extremo a extremo de la aplicación nativa',
  'settings.openchamber.tunnel.field.directE2eeDescription': 'El tráfico a través de Cloudflare está cifrado entre la aplicación nativa y este host de OpenChamber.',
  'settings.openchamber.tunnel.field.directE2eeUnsupported': 'Requiere una versión de cliente que admita E2EE directo.',
  'settings.openchamber.tunnel.field.nativePairingLabel': 'Emparejamiento de aplicación nativa',
  'settings.openchamber.tunnel.field.nativePairingDescription': 'Empareje una aplicación móvil o de escritorio nativa mediante cifrado de extremo a extremo.',
  'settings.openchamber.tunnel.actions.openAddDevice': 'Añadir un dispositivo',
  'settings.openchamber.tunnel.field.browserAccessLabel': 'Acceso desde el navegador',
  'settings.openchamber.tunnel.field.browserQrAlt': 'Código QR de acceso desde el navegador',
  'settings.openchamber.tunnel.note.scanQrToConnectBrowser': 'Escanee este código QR con su navegador móvil para conectarse.',
  'settings.openchamber.tunnel.toast.directE2eeSaved': 'Configuración de E2EE directo guardada',
  'settings.openchamber.tunnel.toast.directE2eeSaveFailed': 'Error al guardar la configuración de E2EE directo',
  'settings.remoteInstances.transport.managedE2ee.label': 'Túnel gestionado (E2EE)',
  'settings.remoteInstances.transport.managedE2ee.description': 'Conéctese de forma segura a través de su túnel gestionado de Cloudflare.',
  'settings.remoteInstances.transport.managedE2ee.note': 'Esta conexión utiliza cifrado de extremo a extremo a través de su túnel gestionado.',
} as const;
