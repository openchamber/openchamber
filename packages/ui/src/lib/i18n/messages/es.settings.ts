...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.visual.field.contextPanelDock": "Posición del panel de contexto",
  "settings.openchamber.visual.field.contextPanelDockAria": "Posición del panel de contexto",
  "settings.openchamber.visual.field.contextPanelDockHint": "Mueve todo el panel de contexto, no solo la terminal: todas las superficies (terminal, cambios, diferencias, archivos, notas) se anclan al borde elegido de la columna de chat.",
  "settings.openchamber.visual.option.contextPanelDock.right": "Derecha",
  "settings.openchamber.visual.option.contextPanelDock.bottom": "Abajo",
