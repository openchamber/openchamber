export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copia el ID desde la URL del panel y la cookie auth desde las herramientas del navegador. Sharpie nunca examina las cookies del navegador.',
  ...
  "settings.window.description": "Ventana de configuración de Sharpie.",
  ...
  "settings.page.appearance.description": "Personaliza el aspecto y la sensación de Sharpie.",
  ...
  "settings.remoteInstances.direct.title": "Otros servidores de Sharpie",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Añade otro servidor de Sharpie por URL. Úsalo cuando el servidor ya esté en marcha y tengas un token de conexión.",
  ...
  "settings.remoteInstances.direct.import.description": "Pega un enlace de conexión de otro servidor de Sharpie.",
  ...
  "settings.remoteInstances.direct.error.invalidConnectLink": "Enlace de conexión de Sharpie no válido.",
  ...
  "settings.remoteInstances.clientAuth.description": "Crea un enlace o token seguro para que Sharpie Desktop pueda conectarse a este servidor.",
  ...
  "settings.remoteInstances.clientAuth.qrScanHint": "Escanéalo con la app de Sharpie en tu otro dispositivo. Es de un solo uso y caduca.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Funciona en casa y fuera. Fuera de casa el tráfico pasa por Sharpie Private Relay, un túnel cifrado de extremo a extremo. Sin configuración.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Escanea este código QR con la app de Sharpie en tu otro dispositivo.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Elige si Sharpie debe iniciar el servidor por ti o conectarse a uno que ya está en marcha.",
  ...
  "settings.openchamber.about.title": "Acerca de Sharpie",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Añade un repositorio Git como nuevo origen de catálogo. Sharpie escaneará para encontrar carpetas que contengan",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Iniciar Sharpie al iniciar sesión",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Iniciar Sharpie al iniciar sesión",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Mostrar Sharpie en la barra de menús de macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Mostrar Sharpie en la barra de menús",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Requiere reiniciar la aplicación. Al desactivarlo, Sharpie no crea el elemento de la barra de menús ni ejecuta sus actualizaciones de sesiones, aprobaciones y uso.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Minimizar y cerrar Sharpie a la bandeja del sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Minimizar y cerrar a la bandeja del sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Mantiene Sharpie en ejecución en la bandeja del sistema cuando la ventana principal se minimiza o se cierra.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Mantener el ordenador activo mientras Sharpie está en ejecución",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Mantener el ordenador activo mientras Sharpie está en ejecución",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "Sharpie la pide después del reinicio y luego cuando vence la sesión: tras 12 horas, o 7 días con Confiar en este dispositivo. Déjalo vacío para desactivar el inicio de sesión.",
  ...
  "settings.remoteInstances.page.description": "Conéctate a otra máquina por SSH y abre Sharpie allí.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "Sharpie en la máquina remota",
  "settings.remoteInstances.page.section.remoteServerDescription": "Elige cómo debe ejecutarse Sharpie después de conectar por SSH.",
  "settings.remoteInstances.page.section.mainTunnel": "Acceso local",
  "settings.remoteInstances.page.section.mainTunnelDescription": "Elige la dirección local que se usará para abrir este servidor remoto de Sharpie.",
  "settings.remoteInstances.page.section.authentication": "Autenticación",
  "settings.remoteInstances.page.section.authenticationDescription": "Credenciales opcionales para SSH y la interfaz de usuario de Sharpie remoto.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Cómo debe colocarse Sharpie en la máquina remota cuando esta app lo inicia por ti.",
  ...
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Actualizando Sharpie",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Se guarda en la autenticación de OpenCode, no en Sharpie. Usa {env:VAR_NAME} para leer una clave del entorno.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Las claves se envían directamente a OpenCode y nunca se almacenan en Sharpie.",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Disponible como respaldo si se elimina la autenticación de Sharpie",
  ...
  "settings.notifications.page.testNotification.body": "Esta es una notificación de prueba de Sharpie.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Transcripción local en el servidor de Sharpie. Los modelos se descargan automáticamente; no se necesita clave de API.",
  "settings.voice.page.tooltip.localTts": "Síntesis local en el servidor de Sharpie (Kokoro, inglés). El modelo se descarga automáticamente; no se necesita clave de API.",
