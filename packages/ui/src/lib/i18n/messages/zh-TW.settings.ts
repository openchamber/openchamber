...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.visual.field.messageSpeedMetrics': '顯示回應速度指標',
  'settings.openchamber.visual.field.messageSpeedMetricsAria': '在完成的回應下方顯示回應速度指標',
  'settings.openchamber.visual.field.messageSpeedMetricsInfo': '在完成的回應下方顯示 TTFT（首 token 延遲）和每秒輸出 token 數，便於對比不同服務商和中轉。',
