...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': '貼上 ollama.com 的工作階段 Cookie（在瀏覽器開發者工具中尋找 __Secure-session=...）。這不是您的本機 Ollama API 金鑰或端點。OpenChamber 絕不會掃描瀏覽器 Cookie 儲存空間。',
