...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.agents.sidebar.error.title': '無法載入 agents',
  'settings.agents.sidebar.error.description': 'OpenCode 後端無法使用。請檢查連線後重試。',
  'settings.agents.sidebar.error.retry': '重試',
