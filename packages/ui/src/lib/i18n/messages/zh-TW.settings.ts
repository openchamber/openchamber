...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.providers.sidebar.actions.reorderProviderTitle': '拖曳以重新排序提供商',
  'settings.providers.sidebar.actions.reorderProviderAria': '重新排序提供商',
  'settings.providers.sidebar.actions.enableProvider': '啟用',
  'settings.providers.sidebar.section.disabled': '已停用',
  ...
  'settings.providers.page.actions.disableProvider': '停用',
  'settings.providers.page.actions.enableProvider': '啟用',
  'settings.providers.page.badge.disabled': '已停用',
  'settings.providers.page.badge.disabledHint': '啟用前不會出現在模型選擇器中。',
