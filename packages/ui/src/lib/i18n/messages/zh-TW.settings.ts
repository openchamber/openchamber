...
export const settingsDict = {
  ...
  'settings.page.fusion.title': '融合',
  'settings.page.fusion.description': '用於模型融合的精選模型面板。',
  'settings.fusion.empty': '還沒有預設。新增第一個。',
  'settings.fusion.add': '新增預設',
  'settings.fusion.edit': '編輯',
  'settings.fusion.delete': '刪除',
  'settings.fusion.deleteTitle': '刪除融合預設',
  'settings.fusion.deleteConfirm': '刪除預設 {name}？',
  'settings.fusion.dialogTitleNew': '新增融合預設',
  'settings.fusion.dialogTitleEdit': '編輯融合預設',
  'settings.fusion.dialogDescription': '包含 2-4 個模型的命名面板。',
  'settings.fusion.nameLabel': '名稱',
  'settings.fusion.descriptionLabel': '描述',
  'settings.fusion.modelsLabel': '模型（{count}/4）',
  'settings.fusion.modelsHint': '選擇 2-4 個模型。',
  'settings.fusion.searchModels': '搜尋模型',
  'settings.fusion.noModelResults': '沒有符合搜尋條件的模型。',
  'settings.fusion.save': '儲存',
  'settings.fusion.cancel': '取消',
  'settings.fusion.loading': '載入中…',
  'settings.fusion.loadError': '載入預設失敗：{error}',
  'settings.fusion.noModels': '此目錄未設定任何模型。',
  'settings.fusion.required': '需要名稱 + 2-4 個模型。',
