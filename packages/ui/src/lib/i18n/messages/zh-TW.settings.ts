export const settingsDict = {
  ...
  'settings.openchamber.tunnel.field.tailscaleHttpsPort': 'Tailscale HTTPS 連接埠',
  'settings.openchamber.tunnel.field.tailscaleHttpsPortDescription': 'Tailscale 前端連接埠。Serve 可使用 1 到 65535 的任意連接埠；Funnel 僅支援 443、8443 或 10000。',
  'settings.openchamber.tunnel.field.tailscaleServeHttpsPortDescription': 'Serve 可使用 1 到 65535 的任意整數。',
  'settings.openchamber.tunnel.field.tailscaleFunnelHttpsPortDescription': 'Funnel 僅支援 443、8443 或 10000。',
  'settings.openchamber.tunnel.field.tailscaleHttpsPortError': '請輸入 1 到 65535 之間的整數。',
  ...
  'settings.openchamber.tunnel.notAvailable.tailscaleInstallHint': '啟動前請安裝 Tailscale 並在此裝置上登入：',
  'settings.openchamber.tunnel.option.mode.privateNetwork.label': '僅限 Tailnet (Serve)',
  'settings.openchamber.tunnel.option.mode.privateNetwork.tooltip': 'Tailscale Serve 將存取限制在你的 Tailnet 內。',
  'settings.openchamber.tunnel.option.mode.tailscaleQuick.label': '公開 (Funnel)',
  'settings.openchamber.tunnel.option.mode.tailscaleQuick.tooltip': 'Tailscale Funnel 讓此執行個體可從公開網際網路存取。',
  'settings.openchamber.tunnel.warning.tailscaleFunnelPublic': 'Tailscale Funnel 將此執行個體暴露在公開網際網路上。僅在確實需要公開存取時使用。',
  'settings.openchamber.tunnel.badge.privateNetwork': 'Tailnet',
  'settings.openchamber.tunnel.toast.startedButNoUrl': 'Tunnel 已啟動，但未傳回存取 URL。',
