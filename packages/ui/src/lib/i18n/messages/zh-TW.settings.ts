...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.remoteInstances.clientAuth.relayEndpoint.title': '中繼伺服器',
  'settings.remoteInstances.clientAuth.relayEndpoint.info': '「隨處可用」配對連結與中繼存取所使用的端點。指向自架中繼即可讓這部分流量留在你自己的基礎設施內;執行中的中繼主機會立即重新連線到新端點。先前簽發的配對連結仍使用原端點。',
  'settings.remoteInstances.clientAuth.relayEndpoint.option.default': '預設',
  'settings.remoteInstances.clientAuth.relayEndpoint.option.custom': '自訂',
  'settings.remoteInstances.clientAuth.relayEndpoint.field.placeholder': 'wss://your-relay.example/ws',
  'settings.remoteInstances.clientAuth.relayEndpoint.actions.save': '儲存',
  'settings.remoteInstances.clientAuth.relayEndpoint.locked': '由環境變數 OPENCHAMBER_RELAY_URL 固定:',
