...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.visual.field.showMessageSpeedMetricsAria': '顯示訊息速度指標',
  'settings.openchamber.visual.field.showMessageSpeedMetrics': '顯示訊息速度指標',
  'settings.openchamber.visual.field.showMessageSpeedMetricsInfo': '在每則助理訊息上顯示第一個 token 耗時、輸出吞吐，以及未快取 / 快取 / 輸出的 token 拆分。第一個 token 耗時在 OpenCode 伺服器上從訊息開始量到第一段推理或正文。',
