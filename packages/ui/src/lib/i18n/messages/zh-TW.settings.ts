...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  "settings.analytics.scope.project": "此專案",
  "settings.analytics.scope.all": "所有專案",
  "settings.analytics.period.groupLabel": "時間範圍",
  "settings.analytics.period.7d": "7 天",
  "settings.analytics.period.30d": "30 天",
  "settings.analytics.period.90d": "90 天",
  "settings.analytics.period.all": "全部時間",
  "settings.analytics.action.refresh": "重新整理",
  "settings.analytics.state.errorTitle": "分析載入失敗",
  "settings.analytics.state.empty": "所選範圍內沒有工作階段資料",
  "settings.analytics.kpi.sectionTitle": "概覽",
  "settings.analytics.kpi.tokens": "權杖",
  "settings.analytics.kpi.cost": "費用",
  "settings.analytics.kpi.sessions": "工作階段",
  "settings.analytics.kpi.activeDays": "活躍天數",
  "settings.analytics.kpi.streak": "連續天數",
  "settings.analytics.quota.title": "提供者配額",
  "settings.analytics.quota.none": "未設定提供者",
  "settings.analytics.quota.manage": "管理速率限制",
  "settings.analytics.topSessions.title": "熱門工作階段",
  "settings.analytics.topSessions.open": "開啟工作階段",
  "settings.analytics.topSessions.empty": "所選範圍內沒有工作階段",
  "settings.analytics.tab.trends": "趨勢",
  "settings.analytics.kpi.deltaUp": "↑ +{value}% 較上一週期",
  "settings.analytics.kpi.deltaDown": "↓ {value}% 較上一週期",
  "settings.analytics.kpi.deltaNew": "新增",
  "settings.analytics.kpi.deltaFlat": "—",
  "settings.analytics.kpi.cacheHitRate": "快取命中率",
  "settings.analytics.trends.metric.tokens": "權杖",
  "settings.analytics.trends.metric.cost": "費用",
  "settings.analytics.trends.metric.sessions": "工作階段",
  "settings.analytics.trends.tokenBreakdown.title": "權杖明細",
  "settings.analytics.trends.tokenBreakdown.ariaLabel": "權杖明細隨時間變化",
  "settings.analytics.trends.tokenBreakdown.prompt": "提示",
  "settings.analytics.trends.tokenBreakdown.completion": "補全",
  "settings.analytics.trends.tokenBreakdown.reasoning": "推論",
  "settings.analytics.trends.tokenBreakdown.cached": "已快取",
  "settings.analytics.trends.cache.title": "提示快取",
  "settings.analytics.trends.cache.ariaLabel": "提示快取隨時間變化",
  "settings.analytics.trends.cache.cached": "已快取",
  "settings.analytics.trends.cache.uncached": "未快取",
  "settings.analytics.trends.byModel.other": "其他",
  "settings.analytics.yearHeatmap.title": "活動",
  ...
  "settings.analytics.summary.view.aria": "檢視",
  "settings.analytics.summary.chartToggleAria": "在長條圖與折線圖之間切換",
  "settings.analytics.summary.chartType.bar": "長條圖",
  "settings.analytics.summary.chartType.line": "折線圖",
  "settings.analytics.activity.longestStreak": "最長連續",
  "settings.analytics.activity.avgPerDay": "平均 / 天",
  "settings.analytics.activity.avgPerWeek": "平均 / 週",
  "settings.analytics.activity.total": "總計",
  "settings.analytics.activity.days": "天",
  "settings.analytics.chart.sessionsPerDay": "每日工作階段",
  "settings.analytics.chart.costPerDay": "每日費用",
  "settings.analytics.efficiency.title": "效率",
  "settings.analytics.efficiency.costPerMillion": "$ / 百萬 tokens",
  "settings.analytics.efficiency.costPerSession": "費用 / 工作階段",
  "settings.analytics.efficiency.tokensPerSession": "Tokens / 工作階段",
  "settings.analytics.efficiency.reasoningShare": "推理佔比",
  "settings.analytics.efficiency.avgDuration": "平均時長",
  "settings.analytics.efficiency.medianDuration": "中位數時長",
  "settings.analytics.efficiency.longestDuration": "最長時長",
  "settings.analytics.agents.title": "代理使用",
  "settings.analytics.agents.empty": "無代理資料",
  "settings.analytics.rhythm.title": "活動節奏",
  "settings.analytics.rhythm.hoursAria": "依小時統計活動",
