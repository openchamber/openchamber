...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.visual.field.worktreeDiscovery': '自動探索 Git worktree',
  'settings.openchamber.visual.field.worktreeDiscoveryAria': '切換自動探索 Git worktree',
  'settings.openchamber.visual.field.worktreeDiscoveryInfo': '啟用後，側邊欄會為目前專案及有使用中工作階段的專案探索 Git worktree。',
  'settings.openchamber.visual.field.worktreeDiscoveryInterval': 'Worktree 探索更新間隔',
  'settings.openchamber.visual.field.worktreeDiscoveryIntervalAria': '選擇 Worktree 探索更新間隔',
  'settings.openchamber.visual.field.worktreeDiscoveryIntervalInfo': '自動探索兩次執行之間的最短時間。',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.0': '立即',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.30000': '30 秒',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.60000': '1 分鐘',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.300000': '5 分鐘',
  'settings.openchamber.visual.field.backgroundProjectSessionLoading': '在背景載入所有專案的工作階段',
  'settings.openchamber.visual.field.backgroundProjectSessionLoadingAria': '切換在背景載入所有專案工作階段',
  'settings.openchamber.visual.field.backgroundProjectSessionLoadingInfo': '啟用後，OpenChamber 會載入側邊欄中所有專案的工作階段資料。',
