...
export const settingsDict = {
  ...
  'settings.magicPrompts.sidebar.item.gitlabPrReview': 'MR 審查',
  'settings.magicPrompts.sidebar.item.gitlabIssueReview': 'Issue 審查',
  'settings.magicPrompts.sidebar.item.giteaPrReview': 'PR 審查',
  'settings.magicPrompts.sidebar.item.giteaIssueReview': 'Issue 審查',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.gitea.page.title': 'Gitea / Forgejo 個人存取權杖',
  'settings.gitea.page.description': '貼上 Gitea 或 Forgejo 個人存取權杖以連線。使用自架 Gitea 或 Forgejo 執行個體時，請設定基礎 URL。',
  'settings.gitea.page.tooltip.connectAccount': '連線 Gitea 或 Forgejo 帳號，以在應用程式內使用 Issue 與 Pull Request 工作流程。',
  'settings.gitea.page.accessToken.label': '個人存取權杖',
  'settings.gitea.page.accessToken.placeholder': '貼上你的 Gitea 個人存取權杖',
  'settings.gitea.page.baseUrl.label': '基礎 URL（選用）',
  'settings.gitea.page.baseUrl.placeholder': 'https://gitea.example.com',
  'settings.gitea.page.actions.connect': '連線 Gitea',
  'settings.gitea.page.actions.disconnect': '中斷連線',
  'settings.gitea.page.actions.switch': '切換到',
  'settings.gitea.page.status.notConnected': '未連線',
  'settings.gitea.page.label.unknownUser': '未知',
  'settings.gitea.page.label.otherAccounts': '其他帳號',
  'settings.gitea.page.avatarAlt.withLogin': '{login} 頭像',
  'settings.gitea.page.avatarAlt.fallback': 'Gitea 頭像',
  'settings.gitea.page.connectedAs': '已連線為',
  'settings.gitea.page.errors.invalidToken': '請輸入有效的 Gitea 個人存取權杖',
  'settings.gitea.page.errors.failed': '連線 Gitea 失敗',
  'settings.gitea.page.toast.connected': 'Gitea 已連線',
  'settings.gitea.page.toast.disconnected': 'Gitea 已中斷連線',
  ...
  'settings.magicPrompts.page.group.gitlabPrReview.title': 'MR 審查',
  'settings.magicPrompts.page.group.gitlabPrReview.description': '用於 GitLab MR 審查流程的提示詞：可見使用者訊息 + 隱藏指令負載。',
  'settings.magicPrompts.page.group.gitlabIssueReview.title': 'Issue 審查',
  'settings.magicPrompts.page.group.gitlabIssueReview.description': '用於 GitLab Issue 審查流程的提示詞：可見使用者訊息 + 隱藏指令負載。',
  'settings.magicPrompts.page.group.giteaPrReview.title': 'PR 審查',
  'settings.magicPrompts.page.group.giteaPrReview.description': '用於 Gitea PR 審查流程的提示詞：可見使用者訊息 + 隱藏指令負載。',
  'settings.magicPrompts.page.group.giteaIssueReview.title': 'Issue 審查',
  'settings.magicPrompts.page.group.giteaIssueReview.description': '用於 Gitea Issue 審查流程的提示詞：可見使用者訊息 + 隱藏指令負載。',
