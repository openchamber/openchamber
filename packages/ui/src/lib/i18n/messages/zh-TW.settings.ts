...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.defaults.field.defaultDirectory': '預設目錄',
  'settings.openchamber.defaults.field.defaultDirectoryHint': '未選擇目錄時，新對話會在此目錄中開始。留空以維持目前行為。',
  'settings.openchamber.defaults.field.defaultDirectoryPlaceholder': '留空則使用目前目錄',
  'settings.openchamber.defaults.actions.browseDirectory': '瀏覽',
  'settings.openchamber.defaults.actions.browseDirectoryAria': '瀏覽目錄',
