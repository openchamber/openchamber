export const settingsDict = {
  ...
  'settings.appearance.language.description': 'اختر لغة الواجهة.',
  'settings.appearance.language.label': 'اللغة',
  'settings.appearance.language.select': 'اختر اللغة',
  ...
  'settings.openchamber.tunnel.field.hostnameLabel': 'اسم المضيف:',
  ...
  'settings.openchamber.tunnel.field.pasteTokenPlaceholder': 'الصق رمز هذا النفق',
  'settings.openchamber.tunnel.field.provider': 'المزوّد',
  'settings.openchamber.tunnel.field.providerPlaceholder': 'اختر مزوّدًا',
  ...
  'settings.openchamber.tunnel.field.tunnelType': 'نوع النفق',
  'settings.openchamber.tunnel.notAvailable.cloudflaredNotFound': 'لم يتم العثور على cloudflared',
  ...
  'settings.openchamber.tunnel.section.redeemedAccessLinks': 'روابط الوصول المستخدمة',
  'settings.openchamber.tunnel.section.savedManagedRemoteTunnels': 'الأنفاق البعيدة المدارة المحفوظة',
  ...
  'settings.openchamber.tunnel.title': 'النفق الخارجي',
  ...
  'settings.openchamber.visual.actions.reloadThemes': 'إعادة تحميل المظاهر',
  'settings.openchamber.visual.actions.reloadingThemes': 'جارٍ إعادة تحميل المظاهر...',
  'settings.openchamber.visual.actions.resetCodeFontAria': 'إعادة ضبط خط الكود',
  'settings.openchamber.visual.actions.resetEditorFontSizeAria': 'إعادة ضبط حجم خط المحرر',
  'settings.openchamber.visual.actions.resetFontSizeAria': 'إعادة ضبط حجم الخط',
  'settings.openchamber.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.openchamber.visual.actions.resetInstallAppNameAria': 'إعادة ضبط اسم التطبيق المثبّت',
  'settings.openchamber.visual.actions.resetInstallOrientationAria': 'إعادة ضبط اتجاه التثبيت',
  'settings.openchamber.visual.actions.resetInterfaceFontAria': 'إعادة ضبط خط الواجهة',
  'settings.openchamber.visual.actions.resetMobileKeyboardModeAria': 'إعادة ضبط سلوك لوحة مفاتيح الجوال',
  'settings.openchamber.visual.actions.resetSpacingAria': 'إعادة ضبط المسافات',
  'settings.openchamber.visual.actions.resetTerminalFontSizeAria': 'إعادة ضبط حجم خط الطرفية',
  'settings.openchamber.visual.actions.restarting': 'جارٍ إعادة التشغيل...',
  'settings.openchamber.visual.actions.saveAndRestart': 'حفظ وإعادة التشغيل',
  'settings.openchamber.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.openchamber.visual.field.allowPromptingSubagentSessions': 'السماح بموجهة جلسات العوامل الفرعية',
  'settings.openchamber.visual.field.allowPromptingSubagentSessionsAria': 'السماح بموجهة جلسات العوامل الفرعية',
  'settings.openchamber.visual.field.autoSaveEnabled': 'الحفظ التلقائي للملفات',
  'settings.openchamber.visual.field.autoSaveEnabledAria': 'الحفظ التلقائي للملفات',
  ...
  'settings.openchamber.visual.field.codeBlockLineWrap': 'التفاف أسطر كتل الكود',
  'settings.openchamber.visual.field.codeBlockLineWrapAria': 'التفاف أسطر كتل الكود',
  'settings.openchamber.visual.field.codeFont': 'خط الكود',
  'settings.openchamber.visual.field.collapsibleThinkingBlocks': 'تفعيل كتل التفكير القابلة للطي',
  'settings.openchamber.visual.field.collapsibleThinkingBlocksAria': 'تفعيل كتل التفكير القابلة للطي',
  'settings.openchamber.visual.field.collapsibleUserMessages': 'طي رسائل المستخدم الطويلة',
  'settings.openchamber.visual.field.collapsibleUserMessagesAria': 'طي رسائل المستخدم الطويلة',
  'settings.openchamber.visual.field.darkTheme': 'المظهر الداكن',
  'settings.openchamber.visual.field.diffLayoutAria': 'Diff layout: {option}',
  'settings.openchamber.visual.field.dockBadge': 'شارة الإرساء',
  'settings.openchamber.visual.field.dockBadgeHint': 'Show a count of chats with unseen activity on the macOS dock icon.',
  'settings.openchamber.visual.field.draftStartersVisible': 'إظهار البدايات في شاشة الجلسة الجديدة',
  'settings.openchamber.visual.field.draftStartersVisibleAria': 'إظهار البدايات في شاشة الجلسة الجديدة',
  'settings.openchamber.visual.field.editTools': 'أدوات التحرير',
  'settings.openchamber.visual.field.editorFontSize': 'حجم خط المحرر',
  'settings.openchamber.visual.field.enableSpellcheckInTextInputs': 'تفعيل التدقيق الإملائي في حقول النص',
  'settings.openchamber.visual.field.enableSpellcheckInTextInputsAria': 'تفعيل التدقيق الإملائي في حقول النص',
  'settings.openchamber.visual.field.expandedEditorToolbar': 'إظهار شريط أدوات المحرر دائمًا (مثبّت أسفل تبويبات الملفات)',
  'settings.openchamber.visual.field.expandedEditorToolbarAria': 'إظهار شريط أدوات المحرر دائمًا',
  'settings.openchamber.visual.field.fileEditorKeymap': 'خريطة مفاتيح محرر الملفات',
  'settings.openchamber.visual.field.followUpBehaviorAria': 'Follow-up behavior: {option}',
  'settings.openchamber.visual.field.followUpBehaviorDescription': 'اختر ما يحدث عند الضغط على Enter في رسالة متابعة بينما العامل ما زال يستجيب.',
  'settings.openchamber.visual.field.fontSizePercentageAria': 'نسبة حجم الخط',
  ...
  'settings.openchamber.visual.field.installAppName': 'اسم التطبيق المثبّت',
  'settings.openchamber.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.openchamber.visual.field.installOrientation': 'اتجاه التثبيت',
  ...
  'settings.openchamber.visual.field.interfaceFont': 'خط الواجهة',
  'settings.openchamber.visual.field.interfaceFontSize': 'حجم خط الواجهة',
  'settings.openchamber.visual.field.lightTheme': 'المظهر الفاتح',
  'settings.openchamber.visual.field.macVibrancy': 'شفافية النافذة',
  ...
  'settings.openchamber.visual.field.mobileKeyboardMode': 'سلوك لوحة مفاتيح الجوال',
  'settings.openchamber.visual.field.mobileKeyboardModeAria': 'سلوك لوحة مفاتيح الجوال',
  ...
  'settings.openchamber.visual.field.persistDraftMessages': 'الاحتفاظ برسائل المسودة',
  'settings.openchamber.visual.field.persistDraftMessagesAria': 'الاحتفاظ برسائل المسودة',
  'settings.openchamber.visual.field.promptNavigatorEnabled': 'مستكشف الموجهات',
  'settings.openchamber.visual.field.promptNavigatorEnabledAria': 'مستكشف الموجهات',
  'settings.openchamber.visual.field.pwaInstallAppNameAria': 'اسم تثبيت PWA',
  'settings.openchamber.visual.field.pwaInstallOrientationAria': 'اتجاه تثبيت PWA',
  'settings.openchamber.visual.field.queueMessagesByDefault': 'طابور الرسائل افتراضيًا',
  'settings.openchamber.visual.field.queueMessagesByDefaultAria': 'طابور الرسائل افتراضيًا',
  ...
  'settings.openchamber.visual.field.selectCodeFontAria': 'اختر خط الكود',
  'settings.openchamber.visual.field.selectDarkThemeAria': 'اختر المظهر الداكن',
  'settings.openchamber.visual.field.selectInterfaceFontAria': 'اختر خط الواجهة',
  'settings.openchamber.visual.field.selectLightThemeAria': 'اختر المظهر الفاتح',
  'settings.openchamber.visual.field.selectMobileKeyboardModePlaceholder': 'اختر سلوك لوحة المفاتيح',
  'settings.openchamber.visual.field.selectOrientationPlaceholder': 'اختر الاتجاه',
  'settings.openchamber.visual.field.selectThemePlaceholder': 'اختر المظهر',
  'settings.openchamber.visual.field.selectTimeFormatAria': 'اختر تنسيق الوقت',
  'settings.openchamber.visual.field.selectWeekStartAria': 'اختر بداية الأسبوع',
  'settings.openchamber.visual.field.sendAnonymousUsageReports': 'إرسال تقارير استخدام مجهولة',
  'settings.openchamber.visual.field.sendAnonymousUsageReportsAria': 'إرسال تقارير استخدام مجهولة',
  ...
  'settings.openchamber.visual.field.sessionGoal': 'تفعيل أهداف الجلسة',
  'settings.openchamber.visual.field.sessionGoalAria': 'Keep the session working toward a goal automatically',
  'settings.openchamber.visual.field.sessionRecap': 'إنشاء ملخص الجلسة',
  'settings.openchamber.visual.field.sessionRecapAria': 'Generate a recap after the agent finishes',
  'settings.openchamber.visual.field.sessionSuggestion': 'اقتراح رسالة المستخدم التالية',
  'settings.openchamber.visual.field.sessionSuggestionAria': 'Generate a suggested next user message after the agent finishes',
  'settings.openchamber.visual.field.showDotfiles': 'إظهار ملفات النقاط',
  'settings.openchamber.visual.field.showDotfilesAria': 'إظهار ملفات النقاط',
  ...
  'settings.openchamber.visual.field.showReasoningTraces': 'إظهار آثار التفكير',
  'settings.openchamber.visual.field.showReasoningTracesAria': 'إظهار آثار التفكير',
  'settings.openchamber.visual.field.showSplitAssistantMessageActions': 'إجراءات مساعد مضمّنة',
  'settings.openchamber.visual.field.showSplitAssistantMessageActionsAria': 'إجراءات مساعد مضمّنة',
  ...
  'settings.openchamber.visual.field.showToolFileIcons': 'إظهار أيقونات ملفات الأدوات',
  'settings.openchamber.visual.field.showToolFileIconsAria': 'إظهار أيقونات ملفات الأدوات',
  ...
  'settings.openchamber.visual.field.spacingDensity': 'كثافة المسافات',
  'settings.openchamber.visual.field.stickyUserHeader': 'رأس مستخدم ثابت',
  'settings.openchamber.visual.field.stickyUserHeaderAria': 'رأس مستخدم ثابت',
  'settings.openchamber.visual.field.terminalFontSize': 'حجم خط الطرفية',
  'settings.openchamber.visual.field.terminalLoginShell': 'البدء كقشرة دخول',
  'settings.openchamber.visual.field.terminalQuickKeys': 'مفاتيح الطرفية السريعة',
  'settings.openchamber.visual.field.terminalQuickKeysAria': 'مفاتيح الطرفية السريعة',
  'settings.openchamber.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.openchamber.visual.field.terminalShell': 'قشرة الطرفية',
  'settings.openchamber.visual.field.terminalShellAria': 'اختر قشرة الطرفية',
  ...
  'settings.openchamber.visual.field.timeFormat': 'تنسيق الوقت',
  'settings.openchamber.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  'settings.openchamber.visual.field.weekStartsOn': 'بداية الأسبوع',
  'settings.openchamber.visual.field.wideChatLayout': 'تخطيط محادثة عريض',
  'settings.openchamber.visual.field.wideChatLayoutAria': 'تخطيط محادثة عريض',
  'settings.openchamber.visual.goal.budgetAria': 'Apply a default token budget to new goals',
  'settings.openchamber.visual.goal.budgetLabel': 'ميزانية الرموز الافتراضية',
  ...
  'settings.openchamber.visual.goal.sectionTitle': 'الهدف',
  ...
  'settings.openchamber.visual.option.chatRenderMode.live.description': 'بث نص المساعد وأدواته أثناء وصولها.',
  'settings.openchamber.visual.option.chatRenderMode.live.label': 'مباشر',
  'settings.openchamber.visual.option.chatRenderMode.sorted.description': 'عرض رسائل المساعد المكتملة دون بث مباشر.',
  'settings.openchamber.visual.option.chatRenderMode.sorted.label': 'مرتّب',
  'settings.openchamber.visual.option.diffLayout.dynamic.description': 'الملف الجديد inline، والتعديل جنبًا إلى جنب.',
  'settings.openchamber.visual.option.diffLayout.dynamic.label': 'ديناميكي',
  'settings.openchamber.visual.option.diffLayout.inline.description': 'إظهار كعرض موحد واحد.',
  'settings.openchamber.visual.option.diffLayout.inline.label': 'inline دائمًا',
  'settings.openchamber.visual.option.diffLayout.sideBySide.description': 'مقارنة الملف الأصلي والمعدّل.',
  'settings.openchamber.visual.option.diffLayout.sideBySide.label': 'جنبًا إلى جنب دائمًا',
  'settings.openchamber.visual.option.fileEditorKeymap.default': 'افتراضي',
  'settings.openchamber.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.openchamber.visual.option.followUpBehavior.queue.label': 'طابور',
  'settings.openchamber.visual.option.followUpBehavior.steer.label': 'توجيه',
  'settings.openchamber.visual.option.mermaidRendering.ascii.description': 'عرض الرسوم ككتل نصية.',
  'settings.openchamber.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.openchamber.visual.option.mermaidRendering.svg.description': 'عرض الرسوم كرسومات متجهة قابلة للتوسع.',
  'settings.openchamber.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.openchamber.visual.option.messageTransport.auto.description': 'فضّل WebSocket وتراجع إلى SSE عند الحاجة.',
  'settings.openchamber.visual.option.messageTransport.auto.label': 'تلقائي',
  'settings.openchamber.visual.option.messageTransport.sse.description': 'استخدم أحداث الخادم (SSE) لبث الرسائل.',
  'settings.openchamber.visual.option.messageTransport.sse.label': 'SSE',
  'settings.openchamber.visual.option.messageTransport.ws.description': 'استخدم WebSocket لبث الرسائل.',
  'settings.openchamber.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.openchamber.visual.option.mobileKeyboardMode.native.description': 'استخدم سلوك المتصفح الافتراضي للتمرير وتغيير المنفذ عند فتح لوحة المفاتيح.',
  'settings.openchamber.visual.option.mobileKeyboardMode.native.label': 'اتبع المتصفح',
  'settings.openchamber.visual.option.mobileKeyboardMode.resizeContent.description': 'اطلب من المتصفحات الداعمة تصغير تخطيط التطبيق بدلًا من الاعتماد على التمرير فقط.',
  'settings.openchamber.visual.option.mobileKeyboardMode.resizeContent.label': 'تصغير المحتوى',
  'settings.openchamber.visual.option.mobileLayout.default': 'قديم',
  'settings.openchamber.visual.option.mobileLayout.new': 'جديد',
  'settings.openchamber.visual.option.pwaOrientation.landscape.description': 'تثبيت التطبيق مقفولًا على الوضع الأفقي.',
  'settings.openchamber.visual.option.pwaOrientation.landscape.label': 'قفل أفقي',
  'settings.openchamber.visual.option.pwaOrientation.portrait.description': 'تثبيت التطبيق مقفولًا على الوضع العمودي.',
  'settings.openchamber.visual.option.pwaOrientation.portrait.label': 'قفل عمودي',
  'settings.openchamber.visual.option.pwaOrientation.system.description': 'احترم إعداد دوران الجهاز.',
  'settings.openchamber.visual.option.pwaOrientation.system.label': 'اتبع النظام',
  'settings.openchamber.visual.option.terminalShell.auto': 'تلقائي',
  'settings.openchamber.visual.option.themeMode.dark': 'داكن',
  'settings.openchamber.visual.option.themeMode.dark.description': 'استخدم المظهر الداكن دائمًا',
  'settings.openchamber.visual.option.themeMode.light': 'فاتح',
  'settings.openchamber.visual.option.themeMode.light.description': 'استخدم المظهر الفاتح دائمًا',
  'settings.openchamber.visual.option.themeMode.system': 'النظام',
  'settings.openchamber.visual.option.themeMode.system.description': 'اتبع إعداد النظام',
  'settings.openchamber.visual.option.timeFormat.12h.description': 'إظهار الوقت كـ 02:15 مساءً.',
  'settings.openchamber.visual.option.timeFormat.12h.label': '12 ساعة',
  'settings.openchamber.visual.option.timeFormat.24h.description': 'إظهار الوقت كـ 14:15.',
  'settings.openchamber.visual.option.timeFormat.24h.label': '24 ساعة',
  'settings.openchamber.visual.option.timeFormat.auto.description': 'استخدم تفضيل لغة النظام.',
  'settings.openchamber.visual.option.timeFormat.auto.label': 'تلقائي',
  'settings.openchamber.visual.option.userMessageRendering.markdown.description': 'عرض نص المستخدم بتنسيق markdown.',
  'settings.openchamber.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.openchamber.visual.option.userMessageRendering.plain.description': 'عرض نص المستخدم مع الحفاظ على المسافات والروابط.',
  'settings.openchamber.visual.option.userMessageRendering.plain.label': 'نص عادي',
  'settings.openchamber.visual.option.weekStart.auto.description': 'استخدم بداية الأسبوع حسب اللغة.',
  'settings.openchamber.visual.option.weekStart.auto.label': 'تلقائي',
  'settings.openchamber.visual.option.weekStart.monday.label': 'الاثنين',
  'settings.openchamber.visual.option.weekStart.sunday.label': 'الأحد',
  'settings.openchamber.visual.section.activityDefault': 'الوضع الافتراضي للنشاط',
  'settings.openchamber.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.openchamber.visual.section.appInstall': 'تثبيت التطبيق',
  'settings.openchamber.visual.section.chatDisplay': 'العرض',
  'settings.openchamber.visual.section.chatFeatures': 'الميزات',
  'settings.openchamber.visual.section.chatMessageOptions': 'خيارات الرسائل',
  'settings.openchamber.visual.section.chatRenderMode': 'وضع عرض المحادثة',
  'settings.openchamber.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.openchamber.visual.section.colorMode': 'وضع الألوان',
  'settings.openchamber.visual.section.colorModeAndTheme': 'وضع الألوان والمظهر',
  'settings.openchamber.visual.section.composer': 'المحرر',
  'settings.openchamber.visual.section.densityAndType': 'الكثافة والخطوط',
  'settings.openchamber.visual.section.diffLayout': 'تخطيط الفروقات',
  'settings.openchamber.visual.section.diffLayoutAria': 'Diff layout',
  'settings.openchamber.visual.section.followUpBehavior': 'سلوك الرسائل اللاحقة',
  'settings.openchamber.visual.section.followUpBehaviorAria': 'Follow-up behavior',
  'settings.openchamber.visual.section.localization': 'الترجمة والتوطين',
  'settings.openchamber.visual.section.mermaidRendering': 'عرض Mermaid',
  'settings.openchamber.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.openchamber.visual.section.messageAppearance': 'مظهر الرسائل',
  'settings.openchamber.visual.section.messageStreamTransport': 'نقل تدفق الرسائل',
  'settings.openchamber.visual.section.mobileLayout': 'تخطيط الجوال',
  'settings.openchamber.visual.section.navigation': 'التنقل',
  'settings.openchamber.visual.section.privacy': 'الخصوصية',
  'settings.openchamber.visual.section.reasoning': 'التفكير',
  'settings.openchamber.visual.section.sessionAssistance': 'مساعدة الجلسة',
  'settings.openchamber.visual.section.showToolsOpenedByDefault': 'Show tools opened by default',
  'settings.openchamber.visual.section.spacingAndLayout': 'المسافات والتخطيط',
  'settings.openchamber.visual.section.toolsAndFiles': 'الأدوات والملفات',
  'settings.openchamber.visual.section.userMessageRendering': 'عرض رسائل المستخدم',
  ...
  'settings.page.about.title': 'حول',
  'settings.page.agents.title': 'العوامل',
  ...
  'settings.page.chat.title': 'المحادثة',
  'settings.page.commands.title': 'الأوامر',
  'settings.page.general.description': 'App startup, security, connection, and privacy.',
  'settings.page.general.title': 'عام',
  'settings.page.git.title': 'Git',
  'settings.page.magicPrompts.title': 'الموجهات السحرية',
  'settings.page.mcp.title': 'MCP',
  'settings.page.notifications.description': 'Choose when and how you get notified.',
  'settings.page.notifications.title': 'الإشعارات',
  'settings.page.plugins.title': 'الإضافات',
  'settings.page.projects.title': 'المشاريع',
  'settings.page.promptTemplates.title': 'قوالب الموجهات',
  'settings.page.providers.title': 'المزوّدون',
  'settings.page.remoteInstances.title': 'المثيلات البعيدة',
  'settings.page.sessions.description': 'Set defaults and retention for sessions.',
  'settings.page.sessions.title': 'الجلسات',
  'settings.page.shortcuts.description': 'Customize keyboard shortcuts.',
  'settings.page.shortcuts.title': 'الاختصارات',
  'settings.page.skills.title': 'المهارات',
  'settings.page.skillsCatalog.title': 'كتالوج المهارات',
  'settings.page.snippets.title': 'المقتطفات',
  'settings.page.tunnel.description': 'Expose this instance over a remote tunnel.',
  'settings.page.tunnel.title': 'النفق الخارجي',
  'settings.page.usage.title': 'الاستخدام',
  'settings.page.voice.description': 'Configure speech and dictation.',
  'settings.page.voice.title': 'الصوت',
  ...
  'settings.promptTemplates.page.field.name': 'الاسم',
  'settings.promptTemplates.page.field.namePlaceholder': 'اسم القالب',
  'settings.promptTemplates.page.field.templatePlaceholder': 'اكتب نص قالب الموجه...',
  'settings.promptTemplates.page.section.identity': 'الهوية',
  'settings.promptTemplates.page.section.template': 'القالب',
  'settings.promptTemplates.page.subtitle.edit': 'تعديل القالب',
  'settings.promptTemplates.page.subtitle.new': 'إنشاء قالب موجه جديد',
  ...
  'settings.promptTemplates.page.title.new': 'قالب جديد',
  ...
  'settings.promptTemplates.sidebar.badge.default': 'افتراضي',
  ...
  'settings.promptTemplates.sidebar.empty.title': 'لا توجد قوالب موجهات',
  ...
  'settings.promptTemplates.sidebar.renameDialog.title': 'إعادة تسمية القالب',
  'settings.promptTemplates.sidebar.title': 'قوالب الموجهات',
  ...
  'settings.providers.page.openCodeGo.authCookie': 'كوكي المصادقة',
  'settings.providers.page.openCodeGo.delete': 'حذف',
  ...
  'settings.providers.page.openCodeGo.replace': 'استبدال',
  'settings.providers.page.openCodeGo.save': 'حفظ والتحقق',
  'settings.providers.page.openCodeGo.saveFailed': 'Could not validate OpenCode Go credentials.',
  'settings.providers.page.openCodeGo.title': 'تتبع استخدام OpenCode Go',
  'settings.providers.page.openCodeGo.valid': 'OpenCode Go credentials are valid.',
  'settings.providers.page.openCodeGo.validate': 'تحقق',
  'settings.providers.page.openCodeGo.workspaceId': 'معرف مساحة العمل',
  'settings.providers.page.quotaCredentials.accessToken': 'رمز الوصول',
  'settings.providers.page.quotaCredentials.refreshToken': 'رمز التحديث',
  'settings.providers.page.quotaCredentials.saved': '{provider} credentials saved.',
  'settings.providers.page.quotaCredentials.tokenPlaceholder': 'الصق الرمز',
  ...
  'settings.snippets.page.field.aliases': 'الأسماء المستعارة',
  'settings.snippets.page.field.aliasesPlaceholder': 'safe, careful',
  'settings.snippets.page.field.content': 'المحتوى',
  'settings.snippets.page.field.contentPlaceholder': 'محتوى المقتطف...',
  ...
  'settings.snippets.page.title.new': 'مقتطف جديد',
  ...
  'settings.snippets.sidebar.actions.create': 'إنشاء مقتطف',
  ...
  'settings.snippets.sidebar.title': 'المقتطفات',
  ...
  'settings.view.actions.back': 'رجوع',
  'settings.view.actions.backToSettings': 'العودة إلى الإعدادات',
  'settings.view.actions.closeSettings': 'إغلاق الإعدادات',
  'settings.view.actions.closeSettingsWithShortcut': 'Close Settings ({shortcut}+,)',
  'settings.view.actions.openSectionList': 'فتح قائمة الأقسام',
  'settings.view.actions.reloadOpenCode': 'إعادة تحميل OpenCode',
  'settings.view.actions.reloadOpenCodeTooltip': 'Restart OpenCode and reload its configuration.',
  'settings.view.actions.resizeNavigation': 'تغيير حجم تنقّل الإعدادات',
  'settings.view.badge.beta': 'تجريبي',
  'settings.view.home.cards.agents.description': 'Prompts, tools, permissions',
  'settings.view.home.cards.agents.title': 'العوامل',
  ...
  'settings.view.search.clear': 'مسح بحث الإعدادات',
  'settings.view.search.noResults': 'لا توجد إعدادات مطابقة',
  ...
  'settings.view.unavailable.title': 'غير متاح',
