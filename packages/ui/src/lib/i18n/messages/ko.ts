...
export const dict: Record<I18nKey, string> = {
  ...
  'diffView.state.noBranchChanges': '표시할 브랜치 변경 사항이 없습니다.',
  'diffView.state.noLastTurnChanges': '표시할 마지막 턴 변경 사항이 없습니다.',
  'diffView.state.failedToLoadDiff': '변경사항을 불러오지 못했습니다',
  'diffView.state.failedToLoadBranchChanges': '브랜치 변경 사항을 불러오지 못했습니다',
  'diffView.state.loadingDiff': '변경사항 불러오는 중…',
  'diffView.state.loadingChanges': '변경 사항 로드 중…',
  'diffView.state.loadingBranchChanges': '브랜치 변경 사항을 불러오는 중…',
  'diffView.state.branchPatchUnavailable': '이 파일의 브랜치 패치를 사용할 수 없습니다.',
