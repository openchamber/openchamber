...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.scheduledTasks.dialog.actions.lastRunAria': '{taskName}의 마지막 실행 세션 열기',
  ...
  'sessions.scheduledTasks.editor.lifecycle.title': '수명 주기',
  'sessions.scheduledTasks.editor.archiveOnSuccess.label': '성공한 실행 보관',
  'sessions.scheduledTasks.editor.archiveOnSuccess.aria': '실행이 성공하면 세션을 보관합니다',
