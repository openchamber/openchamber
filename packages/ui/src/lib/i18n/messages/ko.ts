...
export const dict: Record<I18nKey, string> = {
  ...
  'sidebarFilesTree.toast.searchFailed': '파일 검색 실패',
  'sidebarFilesTree.toast.searchTimedOut': '검색 시간이 초과되었습니다. 검색 범위를 좁혀보세요',
  'sidebarFilesTree.search.placeholder': '파일 검색…',
  'sidebarFilesTree.filter.expandTooltip': '필터 옵션 전환',
  'sidebarFilesTree.filter.showHidden': '숨김 파일 표시',
  'sidebarFilesTree.filter.hideHidden': '숨김 파일 숨기기',
  'sidebarFilesTree.filter.showGitignored': 'Git에서 무시한 파일 포함',
  'sidebarFilesTree.filter.hideGitignored': 'Git에서 무시한 파일 제외',
  'sidebarFilesTree.filter.extChipRemoveAria': '{ext} 필터 제거',
  'sidebarFilesTree.filter.pathChipRemoveAria': '{path} 경로 필터 제거',
  'sidebarFilesTree.filter.extAutocompleteLabel': '확장자',
  ...
  'filesView.tree.filter.expandTooltip': '필터 옵션 전환',
  'filesView.tree.filter.showHidden': '숨김 파일 표시',
  'filesView.tree.filter.hideHidden': '숨김 파일 숨기기',
  'filesView.tree.filter.showGitignored': 'Git에서 무시한 파일 포함',
  'filesView.tree.filter.hideGitignored': 'Git에서 무시한 파일 제외',
  'filesView.tree.filter.searchFailed': '파일 검색 실패',
  'filesView.tree.filter.searchTimedOut': '검색 시간이 초과되었습니다. 검색 범위를 좁혀보세요',
  'filesView.tree.filter.extChipRemoveAria': '{ext} 필터 제거',
  'filesView.tree.filter.pathChipRemoveAria': '{path} 경로 필터 제거',
  'filesView.tree.filter.extAutocompleteLabel': '확장자',
