...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.server-browser.description': '서버에서 실행 중인 Chrome',
  ...
  'contextPanel.browser.newServerTab': '새 서버 브라우저 탭',
  'contextPanel.browser.remote.tabLabel': '서버 브라우저',
  'contextPanel.browser.remote.sessionsMenu': '브라우저 세션',
  'contextPanel.browser.remote.savedSessions': '저장된 세션',
  'contextPanel.browser.remote.availableSessions': '실행 중인 세션',
  'contextPanel.browser.remote.openDevTools': 'Chrome DevTools 열기',
  'contextPanel.browser.remote.contextMenuUnavailable': '이 클릭에서는 브라우저 작업을 사용할 수 없습니다. 도구 모음이나 클립보드 버튼을 사용하세요.',
  'contextPanel.browser.remote.devTools': 'Chrome DevTools',
  'contextPanel.browser.remote.simpleInspector': '콘솔 및 네트워크',
  'contextPanel.browser.remote.inspectMode': '검사 모드',
  'contextPanel.browser.remote.maximizeInspector': '검사기 최대화',
  'contextPanel.browser.remote.restoreInspector': '페이지와 검사기 복원',
  'contextPanel.browser.remote.resizeInspector': '검사기 크기 조절',
  'contextPanel.browser.remote.devtoolsLoading': 'Chrome DevTools 연결 중…',
  'contextPanel.browser.remote.devtoolsLoadFailed': 'Chrome DevTools를 불러오지 못했습니다.',
  'contextPanel.browser.remote.devtoolsRetry': 'DevTools 다시 연결',
  'contextPanel.browser.remote.devtoolsControlLost': '다른 뷰어가 제어권을 가져갔습니다. 검사를 계속하려면 다시 연결하세요.',
  'contextPanel.browser.remote.devtoolsConnectionClosed': 'DevTools 연결이 종료되었습니다.',
  'contextPanel.browser.remote.devtoolsMessageTooLarge': 'DevTools 메시지가 크기 제한을 초과했습니다.',
  'contextPanel.browser.remote.devtoolsBackpressure': 'DevTools가 연결 속도에 맞춰 데이터를 처리하지 못했습니다. 계속하려면 다시 연결하세요.',
  'contextPanel.browser.remote.devtoolsInvalidRequest': 'DevTools 연결에서 잘못된 메시지를 받았습니다.',
  'contextPanel.browser.remote.devtoolsProtocolRejected': '이 페이지에서는 이 DevTools 작업을 사용할 수 없습니다.',
  'contextPanel.browser.remote.devtoolsExclusive': '성능을 기록하려면 이 브라우저 세션만 실행 중이어야 합니다.',
  'contextPanel.browser.remote.devtoolsStartFailed': '이 페이지의 DevTools를 열지 못했습니다.',
  'contextPanel.browser.remote.connecting': '서버 브라우저에 연결하는 중…',
  'contextPanel.browser.remote.reconnecting': '연결이 끊어졌습니다. 다시 연결하는 중…',
  'contextPanel.browser.remote.chooseTitle': '서버 브라우저 세션',
  'contextPanel.browser.remote.chooseHint': '실행 중인 세션에 연결하거나 새 세션을 시작하세요.',
  'contextPanel.browser.remote.newSession': '새 세션',
  'contextPanel.browser.remote.noSessions': '이 프로젝트에서 실행 중인 서버 세션이 없습니다.',
  'contextPanel.browser.remote.sessionEphemeral': '에이전트 세션',
  'contextPanel.browser.remote.sessionProject': '프로젝트 세션',
  'contextPanel.browser.remote.errorTitle': '서버 브라우저를 사용할 수 없습니다',
  'contextPanel.browser.remote.endedTitle': '이 서버 브라우저 세션이 종료되었습니다',
  'contextPanel.browser.remote.retry': '다시 시도',
  'contextPanel.browser.remote.canvasAria': '원격 페이지 보기',
  'contextPanel.browser.remote.keyboard': '페이지에 입력',
  'contextPanel.browser.remote.textInputAria': '원격 페이지 텍스트 입력',
  'contextPanel.browser.remote.clipboard.copy': '복사',
  'contextPanel.browser.remote.clipboard.paste': '붙여넣기',
  'contextPanel.browser.remote.clipboard.copied': '클립보드에 복사했습니다',
  'contextPanel.browser.remote.clipboard.pasted': '페이지에 붙여넣었습니다',
  'contextPanel.browser.remote.clipboard.noSelection': '페이지에서 복사할 텍스트를 선택하세요.',
  'contextPanel.browser.remote.clipboard.copyFailed': '선택한 텍스트를 복사하지 못했습니다. 다시 시도하세요.',
  'contextPanel.browser.remote.clipboard.pasteFailed': '페이지에 붙여넣지 못했습니다. 다시 시도하세요.',
  'contextPanel.browser.remote.clipboard.tooLarge': '텍스트가 너무 커서 전송할 수 없습니다.',
  'contextPanel.browser.remote.clipboard.copyFallbackTitle': '선택한 텍스트 복사',
  'contextPanel.browser.remote.clipboard.copyFallbackDescription': '클립보드에 접근할 수 없습니다. 아래 텍스트를 선택해서 복사하세요.',
  'contextPanel.browser.remote.clipboard.copyTextAria': '페이지에서 선택한 텍스트',
  'contextPanel.browser.remote.clipboard.pasteFallbackTitle': '페이지에 붙여넣기',
  'contextPanel.browser.remote.clipboard.pasteFallbackDescription': '아래에 일반 텍스트를 붙여넣은 다음 페이지로 보내세요.',
  'contextPanel.browser.remote.clipboard.pasteTextAria': '페이지에 붙여넣을 텍스트',
  'contextPanel.browser.remote.clipboard.emptyClipboard': '클립보드에 일반 텍스트가 없습니다.',
  'contextPanel.browser.remote.clipboard.cancel': '취소',
  'contextPanel.browser.remote.viewport.auto': '자동',
  'contextPanel.browser.remote.viewport.preset': '뷰포트 프리셋',
  'contextPanel.browser.remote.viewport.custom': '사용자 지정',
  'contextPanel.browser.remote.viewport.width': '너비',
  'contextPanel.browser.remote.viewport.height': '높이',
  'contextPanel.browser.remote.viewport.rotate': '회전',
  'contextPanel.browser.remote.viewport.mobile': '모바일 기기 에뮬레이션',
  'contextPanel.browser.remote.viewport.scale': '표시 배율',
  'contextPanel.browser.remote.viewport.pending': '뷰포트 적용 중…',
  'contextPanel.browser.remote.viewport.error': '뷰포트 크기 변경 실패: {code}',
  'contextPanel.browser.remote.viewport.agentControlled': '에이전트가 이 뷰포트를 제어합니다',
  'contextPanel.browser.remote.viewport.external': '외부 DevTools가 이 뷰포트를 제어합니다',
  'contextPanel.browser.remote.viewport.dimensionsConfirmed': '확인됨: {width} × {height}',
  'contextPanel.browser.remote.inspector.title': '페이지 검사기',
  'contextPanel.browser.remote.inspector.open': '페이지 검사기 열기',
  'contextPanel.browser.remote.inspector.close': '검사기 닫기',
  'contextPanel.browser.remote.inspector.console': '콘솔',
  'contextPanel.browser.remote.inspector.network': '네트워크',
  'contextPanel.browser.remote.inspector.clear': '지우기',
  'contextPanel.browser.remote.inspector.filterPlaceholder': '메시지 또는 요청 필터링',
  'contextPanel.browser.remote.inspector.filterAria': '검사기 항목 필터링',
  'contextPanel.browser.remote.inspector.capturing': '이 탭 캡처 중',
  'contextPanel.browser.remote.inspector.starting': '캡처 시작 중',
  'contextPanel.browser.remote.inspector.captureHint': '검사기를 열면 캡처가 시작됩니다. 닫으면 캡처한 데이터가 지워집니다.',
  'contextPanel.browser.remote.inspector.dropped': '생략된 항목: {count}',
  'contextPanel.browser.remote.inspector.emptyConsole': '콘솔 메시지가 여기에 표시됩니다.',
  'contextPanel.browser.remote.inspector.filteredEmpty': '일치하는 항목이 없습니다.',
  'contextPanel.browser.remote.inspector.expressionAria': '페이지에서 실행할 JavaScript',
  'contextPanel.browser.remote.inspector.expressionPlaceholder': '페이지에서 JavaScript 실행',
  'contextPanel.browser.remote.inspector.run': '실행',
  'contextPanel.browser.remote.inspector.running': '실행 중',
  'contextPanel.browser.remote.inspector.previousCommand': '이전 명령',
  'contextPanel.browser.remote.inspector.nextCommand': '다음 명령',
  'contextPanel.browser.remote.inspector.shortcutHint': 'Ctrl/Cmd+Enter로 실행합니다. Enter는 새 줄을 추가합니다.',
  'contextPanel.browser.remote.inspector.truncated': '일부 생략됨',
  'contextPanel.browser.remote.inspector.errorUnavailable': '페이지 검사기를 사용할 수 없습니다. 다시 열어 시도하세요.',
  'contextPanel.browser.remote.inspector.errorInvalid': 'JavaScript를 최대 16,000자까지 입력하세요.',
  'contextPanel.browser.remote.inspector.errorCaptureGone': '캡처가 종료되었습니다. 다시 시작하려면 검사기를 다시 여세요.',
  'contextPanel.browser.remote.inspector.errorEvaluation': 'JavaScript를 실행하지 못했습니다. 다시 시도하세요.',
  'contextPanel.browser.remote.inspector.errorTimeout': 'JavaScript 실행 시간이 초과되었습니다. 페이지에서는 계속 실행 중일 수 있습니다.',
  'contextPanel.browser.remote.inspector.errorRequestGone': '이 요청은 더 이상 사용할 수 없습니다.',
  'contextPanel.browser.remote.inspector.errorRequest': '이 요청을 불러오지 못했습니다. 다시 시도하세요.',
  'contextPanel.browser.remote.inspector.errorCapture': '캡처를 시작하지 못했습니다. 검사기를 다시 열어 시도하세요.',
  'contextPanel.browser.remote.inspector.resultAria': 'JavaScript 결과',
  'contextPanel.browser.remote.inspector.commandAria': '실행한 JavaScript',
  'contextPanel.browser.remote.inspector.level.debug': '디버그',
  'contextPanel.browser.remote.inspector.level.info': '정보',
  'contextPanel.browser.remote.inspector.level.log': '로그',
  'contextPanel.browser.remote.inspector.level.warning': '경고',
  'contextPanel.browser.remote.inspector.level.error': '오류',
  'contextPanel.browser.remote.inspector.network.empty': '아직 캡처된 요청이 없습니다.',
  'contextPanel.browser.remote.inspector.network.noMatches': '이 필터와 일치하는 요청이 없습니다.',
  'contextPanel.browser.remote.inspector.network.selectRequest': '확인할 요청을 선택하세요.',
  'contextPanel.browser.remote.inspector.network.details': '요청 세부 정보',
  'contextPanel.browser.remote.inspector.network.closeDetails': '요청 세부 정보 닫기',
  'contextPanel.browser.remote.inspector.network.loading': '요청 세부 정보 불러오는 중',
  'contextPanel.browser.remote.inspector.network.loadBodies': '본문 불러오기',
  'contextPanel.browser.remote.inspector.network.requestHeaders': '요청 헤더',
  'contextPanel.browser.remote.inspector.network.responseHeaders': '응답 헤더',
  'contextPanel.browser.remote.inspector.network.requestBody': '요청 본문',
  'contextPanel.browser.remote.inspector.network.responseBody': '응답 본문',
  'contextPanel.browser.remote.inspector.network.noHeaders': '사용 가능한 헤더가 없습니다.',
  'contextPanel.browser.remote.inspector.network.noBody': '사용 가능한 본문이 없습니다.',
  'contextPanel.browser.remote.inspector.network.bodiesNotRequested': '본문은 요청할 때만 불러옵니다.',
  'contextPanel.browser.remote.inspector.network.bodiesUnavailable': '이 요청의 본문은 더 이상 사용할 수 없습니다.',
  'contextPanel.browser.remote.inspector.network.bodiesUnsupported': '이 응답의 본문 미리보기는 지원되지 않습니다.',
  'contextPanel.browser.remote.inspector.network.truncated': '미리보기 일부가 생략되었습니다.',
  'contextPanel.browser.remote.inspector.network.method': '메서드',
  'contextPanel.browser.remote.inspector.network.url': 'URL',
  'contextPanel.browser.remote.inspector.network.status': '상태 코드',
  'contextPanel.browser.remote.inspector.network.duration': '소요 시간',
  'contextPanel.browser.remote.inspector.network.size': '전송량',
  'contextPanel.browser.remote.inspector.network.state': '상태',
  'contextPanel.browser.remote.inspector.network.cached': '캐시에서 가져옴',
  'contextPanel.browser.remote.inspector.network.failure': '오류',
  'contextPanel.browser.remote.inspector.network.resourceType': '유형',
  'contextPanel.browser.remote.inspector.network.mimeType': '콘텐츠 유형',
  'contextPanel.browser.remote.inspector.network.pending': '대기 중',
  'contextPanel.browser.remote.inspector.network.complete': '완료',
  'contextPanel.browser.remote.inspector.network.failed': '실패',
  'contextPanel.browser.remote.inspector.network.unknown': '사용 불가',
  'contextPanel.browser.remote.inspector.network.yes': '예',
  'contextPanel.browser.remote.inspector.network.no': '아니요',
  'contextPanel.browser.remote.inspector.network.failedDetails': '요청 세부 정보를 불러오지 못했습니다. 다시 시도하세요.',
  'contextPanel.browser.remote.inspector.network.requestGone': '이 요청은 더 이상 사용할 수 없습니다.',
  'contextPanel.browser.remote.inspector.network.captureGone': '이 캡처가 종료되었습니다.',
  ...
  'contextPanel.browser.agentControlling': '에이전트 제어 중',
