...
export const dict: Record<I18nKey, string> = {
  ...
  'sideChat.label': '임시',
  'sideChat.promote': '보존',
  'sideChat.promotion.error': '사이드 채팅을 보존하지 못했습니다',
  'sideChat.cleanup.error': '사이드 채팅을 삭제하지 못했습니다',
  'sideChat.discard.title': '이 사이드 채팅을 버릴까요?',
  'sideChat.discard.description': '진행 중인 작업이 중지되고 이 대화가 영구적으로 삭제됩니다.',
  'sideChat.discard.sideEffects': '파일 변경, 명령 및 기타 도구의 부수 효과는 그대로 유지됩니다.',
  'sideChat.discard.cancel': '채팅 유지',
  'sideChat.discard.confirm': '중지하고 삭제',
  'sideChat.recovery.title': '사이드 채팅을 복구할까요?',
  'sideChat.recovery.description': 'OpenChamber가 중단된 정리 과정에서 남겨진 임시 사이드 채팅을 찾았습니다.',
  'sideChat.recovery.sessionLabel': '사이드 채팅 {sessionID}',
  'sideChat.recovery.recover': '복구',
  'sideChat.recovery.delete': '삭제',
  ...
  'chat.commandAutocomplete.command.sideDescription': '임시 사이드 채팅을 엽니다. 보존하지 않으면 닫을 때 삭제됩니다.',
  'chat.commandAutocomplete.command.btwDescription': '/side의 별칭입니다. 이 대화 옆에 임시 채팅을 엽니다.',
