...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.message.speed.input': '입력 {value}',
  'chat.message.speed.cacheRead': '캐시 {value}',
  'chat.message.speed.cacheWrite': '캐시 쓰기 {value}',
  'chat.message.speed.output': '출력 {value}',
  'chat.message.speed.reasoning': '추론 {value}',
  'chat.message.speed.aria': '메시지 속도: 첫 토큰까지 {ttft}, 초당 {throughput} 토큰, 비캐시 입력 {input}, 캐시 읽기 {cache}, 출력 {output}',
