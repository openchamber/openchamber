...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.history.actions.conflictToastDescription': '충돌 파일: {files}. 수동으로 해결한 뒤 커밋하거나 작업 배너의 중단 버튼을 사용하세요.',
  'gitView.history.actions.conflictToastTitle': '충돌',
  'gitView.history.actions.unknownFiles': '알 수 없는 파일',
  ...
  'gitView.history.actions.resetHard': '리셋 (하드)',
  'gitView.history.actions.resetHardConfirmButton': '변경 사항 삭제',
  'gitView.history.actions.resetHardDirtyTitle': '커밋하지 않은 변경사항을 폐기하시겠습니까?',
  'gitView.history.actions.resetHardDirtyDescription': '작업 트리에 커밋하지 않은 변경사항이 있습니다. 하드 리셋은 이를 영구적으로 폐기합니다.',
  'gitView.history.actions.resetHardDirtyConfirmButton': '폐기 및 리셋',
  'gitView.history.actions.resetMixed': '리셋 (혼합)',
  'gitView.history.actions.resetSoft': '리셋 (소프트)',
  ...
  'gitView.graph.localBranches': '로컬 브랜치',
  'gitView.graph.tags': '태그',
  'gitView.graph.manualSelection': '그래프에 포함할 참조를 선택하세요.',
  'gitView.graph.incomingChanges': '들어오는 변경',
  'gitView.graph.outgoingChanges': '나가는 변경',
  'gitView.graph.outdated': '그래프 히스토리가 오래되었습니다. 새로고침하세요.',
  'gitView.graph.mergeBaseLookupFailed': '이 그래프의 들어오는 변경과 나가는 변경을 비교할 수 없습니다.',
  'gitView.graph.resizeAria': '그래프 패널 크기 조정',
  'gitView.preview.overlayAnnouncement': 'diff 미리보기가 열렸습니다. Escape 키로 닫으세요.',
  'gitView.preview.resizeAria': 'diff 미리보기 크기 조정',
  'gitView.preview.submodulePointer': '서브모듈 포인터',
  'gitView.preview.tooLargeDescription': '이 diff는 {totalSize}이며 {maxSize} 미리보기 제한을 넘습니다.',
  ...
  'gitView.operation.cherryPickInProgress': '체리 픽 진행 중',
  'gitView.operation.revertInProgress': '되돌리기 진행 중',
  ...
  'gitView.toast.cherryPickCompleted': 'cherry-pick 완료됨',
  'gitView.toast.cherryPickAborted': 'cherry-pick 중단됨',
  'gitView.toast.cherryPickConflictsDetected': 'cherry-pick 충돌 감지됨',
  'gitView.toast.revertCompleted': 'revert 완료됨',
  'gitView.toast.revertAborted': 'revert 중단됨',
  'gitView.toast.revertConflictsDetected': 'revert 충돌 감지됨',
  ...
  'diffView.actions.backToChat': '채팅으로 돌아가기',
  ...
  'gitView.history.actions.createBranchEllipsis': '브랜치 생성…',
  'gitView.history.actions.createTagConfirm': '생성',
  'gitView.history.actions.createTagEllipsis': '태그 생성…',
  'gitView.history.actions.createTagPlaceholder': '태그 이름',
  'gitView.history.actions.checkoutDetached': '체크아웃 (분리)',
  'gitView.history.actions.compareWithMergeBase': '병합 기준과 비교',
  'gitView.history.actions.compareWithRef': '비교…',
  'gitView.history.actions.compareWithRemote': '원격과 비교',
  'gitView.history.actions.comparingWith': '{name}과(와) 비교 중',
  'gitView.history.actions.copyMessage': '커밋 메시지 복사',
  'gitView.history.actions.clearComparison': '비교 해제',
  'gitView.history.actions.openChanges': '변경사항 열기',
  'gitView.toast.commitMessageCopied': '커밋 메시지 복사됨',
  'gitView.toast.tagCreated': '태그 {name} 생성됨',
  'gitView.graph.mergeBaseLabel': '병합 기준',
};
