...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.messageBody.footer.totalTime': '총 시간',
  'chat.messageBody.footer.totalTimeAria': '총 시간: {{value}}',
  'chat.messageBody.footer.tps': '초당 토큰 수',
  'chat.messageBody.footer.tpsAria': '초당 토큰 수: {{value}}',
  'chat.messageBody.footer.ttft': '첫 토큰까지의 시간',
  'chat.messageBody.footer.ttftAria': '첫 토큰까지의 시간: {{value}}',
  'chat.messageBody.footer.completedAt': '완료 시각',
  'chat.messageBody.footer.completedAtAria': '완료 시각: {{value}}',
