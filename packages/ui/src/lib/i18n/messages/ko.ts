...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.agentCapabilities.fusion.pickerLoadError': '퓨전 프리셋을 불러오지 못했습니다.',
  'chat.agentCapabilities.fusion.pickerEmpty': '퓨전 프리셋이 없습니다. 설정 → 퓨전에서 만드세요.',
  'chat.agentCapabilities.fusion.keyboardHint': '↑↓ 이동 • Enter 선택 • Esc 닫기',
  'chat.agentCapabilities.inline.waitingChildren': '하위 세션이 시작되기를 기다리는 중…',
