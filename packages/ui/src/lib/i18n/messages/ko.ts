...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.browser.agent.handOff': '에이전트에 제어 권한 부여',
  'contextPanel.browser.agent.stop': '에이전트 제어 중지',
  'contextPanel.browser.agent.controlling': '에이전트가 제어 중',
  'contextPanel.browser.agent.ready': '에이전트와 공유됨',
  'contextPanel.browser.agent.popOut': '별도 창에서 열기',
  'contextPanel.browser.agent.lastAction': '마지막 작업: {op}',
  'contextPanel.browser.poppedOut.title': '별도 창에서 브라우저를 열었습니다',
  'contextPanel.browser.poppedOut.bringBack': '되돌리기',
  'contextPanel.browser.poppedOut.focus': '창 포커스',
