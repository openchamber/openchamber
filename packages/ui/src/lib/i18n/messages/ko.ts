...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.toolGroup.context.title.active': '탐색 중',
  'chat.toolGroup.context.title.done': '탐색 완료',
  'chat.toolGroup.context.title.failed': '탐색 실패',
  'chat.toolGroup.context.summary.readSingle': '읽기 {count}회',
  'chat.toolGroup.context.summary.searchSingle': '검색 {count}회',
  'chat.toolGroup.context.summary.listSingle': '디렉터리 {count}개',
  'chat.toolGroup.context.summary.readPluralFew': '읽기 {count}회',
  'chat.toolGroup.context.summary.readPluralMany': '읽기 {count}회',
  'chat.toolGroup.context.summary.searchPluralFew': '검색 {count}회',
  'chat.toolGroup.context.summary.searchPluralMany': '검색 {count}회',
  'chat.toolGroup.context.summary.listPluralFew': '디렉터리 {count}개',
  'chat.toolGroup.context.summary.listPluralMany': '디렉터리 {count}개',
  'chat.toolGroup.context.child.active': '실행 중',
  'chat.toolGroup.context.child.error': '오류',
  'chat.toolGroup.context.child.read': '읽기',
  'chat.toolGroup.context.child.search': '검색',
  'chat.toolGroup.context.child.list': '목록',
  'chat.toolGroup.context.actions.expandWithSummary': '컨텍스트 도구 세부정보 펼치기: {summary}',
  'chat.toolGroup.context.actions.collapseWithSummary': '컨텍스트 도구 세부정보 접기: {summary}',
  'chat.todo.total': '전체',
