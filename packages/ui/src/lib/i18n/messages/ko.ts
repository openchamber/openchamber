...
export const dict: Record<I18nKey, string> = {
  ...
  'dockerInstances.title': 'Docker 인스턴스',
  'dockerInstances.description': '이 머신의 Docker 컨테이너에서 실행되는 OpenCode 인스턴스를 만들고 관리합니다.',
  'dockerInstances.state.creating': '생성 중',
  'dockerInstances.state.starting': '시작 중',
  'dockerInstances.state.probing': '준비 대기 중',
  'dockerInstances.state.running': '실행 중',
  'dockerInstances.state.stopped': '중지됨',
  'dockerInstances.state.error': '오류',
  'dockerInstances.state.removing': '제거 중',
  'dockerInstances.state.removalFailed': '정리 실패',
  'dockerInstances.state.empty': '아직 Docker 인스턴스가 없습니다.',
  'dockerInstances.state.loadFailed': 'Docker 인스턴스를 불러오지 못했습니다.',
  'dockerInstances.actions.addDocker': 'Docker 인스턴스 추가',
  'dockerInstances.actions.switchAria': '{name}(으)로 전환',
  'dockerInstances.actions.stop': '중지',
  'dockerInstances.actions.start': '시작',
  'dockerInstances.actions.cleanup': '정리 재시도',
  'dockerInstances.actions.remove': '제거',
  'dockerInstances.actions.confirmRemove': '제거 확인',
  'dockerInstances.actions.openAria': 'Docker 인스턴스 열기',
  'dockerInstances.create.title': '새 Docker 인스턴스',
  'dockerInstances.create.description': 'OpenChamber가 컨테이너를 만들고 그 안에서 OpenCode를 시작해 준비될 때까지 기다립니다.',
  'dockerInstances.create.field.label': '이름',
  'dockerInstances.create.field.labelPlaceholder': '선택적 표시 이름',
  'dockerInstances.create.field.image': '이미지',
  'dockerInstances.create.field.workspace': '워크스페이스 경로',
  ...
  'dockerInstances.create.sharing.credentialsTitle': '자격 증명 공유',
  'dockerInstances.create.sharing.credentialsHint': '읽기 전용, 기본값은 꺼짐. 공급자 로그인 정보가 컨테이너 안에서 보입니다.',
  'dockerInstances.create.sharing.neverShared': '공유하지 않는 것: Docker 소켓, SSH 키, git 자격 증명. 포트는 이 머신에만 바인딩됩니다.',
  'dockerInstances.create.actions.buildImage': '{image} 빌드',
  'dockerInstances.create.actions.cancel': '취소',
  'dockerInstances.create.actions.create': '인스턴스 만들기',
  'dockerInstances.create.actions.creating': '생성 중…',
  'dockerInstances.create.error.generic': '인스턴스를 만들 수 없습니다.',
  'dockerInstances.create.toast.created': 'Docker 인스턴스가 생성되었습니다.',
  'dockerInstances.create.toast.imageBuilt': '이미지 {image}이(가) 준비되었습니다.',
  'dockerInstances.toast.activated': '{name}(으)로 전환했습니다.',
  'dockerInstances.toast.deactivated': '로컬 인스턴스로 돌아왔습니다.',
