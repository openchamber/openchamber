...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.gitlabMr.createMr.titleLabel': '제목',
  'contextPanel.gitlabMr.createMr.titlePlaceholder': '병합 요청 제목',
  'contextPanel.gitlabMr.createMr.descriptionLabel': '설명',
  ...
  'contextPanel.gitlabMr.updateMr.save': '저장',
  'contextPanel.gitlabMr.updateMr.saving': '저장 중...',
  'contextPanel.gitlabMr.updateMr.toast.updated': '병합 요청이 업데이트되었습니다',
  'contextPanel.gitlabMr.updateMr.toast.updateFailed': '병합 요청 업데이트에 실패했습니다',
  'contextPanel.gitlabMr.mergeMr.action': '병합',
  'contextPanel.gitlabMr.mergeMr.squash': '커밋 스쿼시',
  'contextPanel.gitlabMr.mergeMr.merging': '병합 중...',
  'contextPanel.gitlabMr.mergeMr.toast.merged': '병합 요청이 병합되었습니다',
  'contextPanel.gitlabMr.mergeMr.toast.mergeFailed': '병합 요청 병합에 실패했습니다',
  'contextPanel.giteaPr.title': 'PR',
  'contextPanel.giteaPr.tabs.pullRequests': 'PR',
  'contextPanel.giteaPr.tabs.issues': '이슈',
  'contextPanel.giteaPr.branchSectionTitle': '현재 브랜치',
  'contextPanel.giteaPr.openPrTitle': '열린 PR',
  'contextPanel.giteaPr.listSectionTitle': '이 저장소',
  'contextPanel.giteaPr.openPrEmpty': '열린 PR이 없습니다',
  'contextPanel.giteaPr.noPrForBranch': '이 브랜치에 대한 PR이 없습니다',
  'contextPanel.giteaPr.loadContext': '컨텍스트 불러오기',
  'contextPanel.giteaPr.hideContext': '컨텍스트 숨기기',
  'contextPanel.giteaPr.openInGitea': 'Gitea에서 열기',
  'contextPanel.giteaPr.draft': '초안',
  'contextPanel.giteaPr.state.opened': '열림',
  'contextPanel.giteaPr.state.merged': '병합됨',
  'contextPanel.giteaPr.state.closed': '닫힘',
  'contextPanel.giteaPr.loadMore': '더 불러오기',
  'contextPanel.giteaPr.loading': '불러오는 중...',
  'contextPanel.giteaPr.error.loadFailed': 'PR을 불러오지 못했습니다',
  'contextPanel.giteaPr.error.notConnected': 'Gitea에 연결되지 않았습니다',
  'contextPanel.giteaPr.empty.noActiveProject': '활성 프로젝트가 없습니다',
  'contextPanel.giteaPr.actions.openSettings': '설정 열기',
  'contextPanel.giteaPr.issues.detail.back': '이슈로 돌아가기',
  'contextPanel.giteaPr.issues.detail.commentsEmpty': '댓글 없음',
  'contextPanel.giteaPr.issues.empty': '열린 이슈가 없습니다',
  'contextPanel.giteaPr.issues.error.loadFailed': '이슈를 불러오지 못했습니다',
  'contextPanel.giteaPr.issues.listSectionTitle': '열린 이슈',
  'contextPanel.giteaPr.createPr.title': '새 PR',
  'contextPanel.giteaPr.createPr.sourceBranch': '소스 브랜치',
  'contextPanel.giteaPr.createPr.targetBranch': '대상 브랜치',
  'contextPanel.giteaPr.createPr.titleLabel': '제목',
  'contextPanel.giteaPr.createPr.titlePlaceholder': 'PR 제목',
  'contextPanel.giteaPr.createPr.descriptionLabel': '설명',
  'contextPanel.giteaPr.createPr.removeSourceBranch': '병합 시 소스 브랜치 삭제',
  'contextPanel.giteaPr.createPr.submit': 'PR 만들기',
  'contextPanel.giteaPr.createPr.submitting': '만드는 중...',
  'contextPanel.giteaPr.createPr.branchesLoading': '브랜치 불러오는 중...',
  'contextPanel.giteaPr.createPr.toast.created': 'PR이 생성되었습니다',
  'contextPanel.giteaPr.createPr.toast.createFailed': 'PR 생성에 실패했습니다',
  'contextPanel.giteaPr.updatePr.toggle': '제목 및 설명 편집',
  'contextPanel.giteaPr.updatePr.save': '저장',
  'contextPanel.giteaPr.updatePr.saving': '저장 중...',
  'contextPanel.giteaPr.updatePr.toast.updated': 'PR이 업데이트되었습니다',
  'contextPanel.giteaPr.updatePr.toast.updateFailed': 'PR 업데이트에 실패했습니다',
  'contextPanel.giteaPr.mergePr.action': '병합',
  'contextPanel.giteaPr.mergePr.squash': '커밋 스쿼시',
  'contextPanel.giteaPr.mergePr.merging': '병합 중...',
  'contextPanel.giteaPr.mergePr.toast.merged': 'PR이 병합되었습니다',
  'contextPanel.giteaPr.mergePr.toast.mergeFailed': 'PR 병합에 실패했습니다',
  ...
  'contextRail.surface.mr.description': '현재 브랜치의 병합 요청을 생성, 검토, 병합',
  ...
  'session.gitlabIssuePicker.searchPlaceholder': '제목으로 검색하거나 이슈 URL을 붙여넣으세요',
  ...
  'session.giteaIssuePicker.error.noActiveProject': '활성 프로젝트가 없습니다',
  'session.giteaIssuePicker.error.runtimeUnavailable': 'Gitea 런타임 API를 사용할 수 없습니다',
  'session.giteaIssuePicker.error.notConnected': 'Gitea에 연결되어 있지 않습니다',
  'session.giteaIssuePicker.error.repoNotResolvable': '저장소를 확인할 수 없습니다',
  'session.giteaIssuePicker.error.repoMustBeGitea': 'origin 리모트는 Gitea URL이어야 합니다',
  'session.giteaIssuePicker.error.issueNotFound': '이슈를 찾을 수 없습니다',
  'session.giteaIssuePicker.error.noModelSelected': '선택된 모델이 없습니다',
  'session.giteaIssuePicker.toast.loadMoreFailed': '이슈를 더 불러오지 못했습니다',
  'session.giteaIssuePicker.toast.loadIssueDetailsFailed': '이슈 상세 정보를 불러오지 못했습니다',
  'session.giteaIssuePicker.toast.sendContextFailed': '이슈 컨텍스트 전송에 실패했습니다',
  'session.giteaIssuePicker.toast.sessionCreated': '이슈에서 세션을 생성했습니다',
  'session.giteaIssuePicker.toast.startSessionFailed': '세션 시작에 실패했습니다',
  'session.giteaIssuePicker.title.select': 'Gitea 이슈 연결',
  'session.giteaIssuePicker.title.createSession': 'Gitea 이슈로 새 세션 만들기',
  'session.giteaIssuePicker.description.select': '이 세션에 연결할 이슈를 선택하세요.',
  'session.giteaIssuePicker.description.createSession': '제목, 본문, 라벨, 댓글을 숨겨진 이슈 컨텍스트로 새 세션에 추가합니다.',
  'session.giteaIssuePicker.searchPlaceholder': '제목으로 검색하거나 이슈 URL을 붙여넣으세요',
  'session.giteaIssuePicker.empty.noActiveProject': '선택된 활성 프로젝트가 없습니다',
  'session.giteaIssuePicker.empty.runtimeUnavailable': 'Gitea 런타임 API를 사용할 수 없습니다.',
  'session.giteaIssuePicker.empty.notConnected': 'Gitea에 연결되지 않았습니다. 설정에서 Gitea 계정을 연결하세요.',
  'session.giteaIssuePicker.empty.noIssuesFound': '이슈 없음',
  'session.giteaIssuePicker.empty.noOpenIssuesFound': '열린 이슈가 없습니다',
  'session.giteaIssuePicker.loading.issues': '이슈 로드 중…',
  'session.giteaIssuePicker.loading.more': '로드 중…',
  'session.giteaIssuePicker.actions.openSettings': '설정 열기',
  'session.giteaIssuePicker.actions.useIssue': '이슈 #{number} 사용',
  'session.giteaIssuePicker.actions.openInGiteaAria': 'Gitea에서 열기',
  'session.giteaIssuePicker.actions.loadMore': '더 불러오기',
  'session.giteaIssuePicker.actions.sectionTitle': '작업',
  'session.giteaIssuePicker.actions.toggleWorktreeAria': '토글 워크트리',
  'session.giteaIssuePicker.actions.createInWorktree': '워크트리에서 생성',
  'session.giteaIssuePicker.actions.openRepo': '레포지토리 열기',
  'session.giteaIssuePicker.actions.refresh': '새로고침',
  ...
  'session.gitlabMrPicker.error.mrNotFound': 'MR을 찾을 수 없습니다',
  ...
  'session.gitlabMrPicker.searchPlaceholder': '제목으로 검색하거나 MR URL을 붙여넣으세요',
  ...
  'session.gitlabMrPicker.empty.noMergeRequestsFound': 'MR이 없습니다',
  'session.gitlabMrPicker.empty.noOpenMergeRequestsFound': '열린 MR이 없습니다',
  'session.gitlabMrPicker.loading.mergeRequests': 'MR 불러오는 중…',
  'session.gitlabMrPicker.loading.more': '로드 중…',
  'session.gitlabMrPicker.actions.openSettings': '설정 열기',
  'session.gitlabMrPicker.actions.useMergeRequest': 'MR !{number} 사용',
  'session.gitlabMrPicker.actions.openInGitLabAria': 'GitLab에서 열기',
  'session.gitlabMrPicker.actions.loadMore': '더 불러오기',
  'session.giteaPrPicker.error.noActiveProject': '활성 프로젝트가 없습니다',
  'session.giteaPrPicker.error.runtimeUnavailable': 'Gitea 런타임 API를 사용할 수 없습니다',
  'session.giteaPrPicker.error.notConnected': 'Gitea에 연결되어 있지 않습니다',
  'session.giteaPrPicker.error.prNotFound': 'PR을 찾을 수 없습니다',
  'session.giteaPrPicker.error.repoNotResolvable': '저장소를 확인할 수 없습니다',
  'session.giteaPrPicker.error.repoMustBeGitea': 'origin 리모트는 Gitea URL이어야 합니다',
  'session.giteaPrPicker.toast.loadMoreFailed': 'PR을 더 불러오지 못했습니다',
  'session.giteaPrPicker.toast.loadDetailsFailed': 'PR 상세 정보를 불러오지 못했습니다',
  'session.giteaPrPicker.title': 'Gitea PR 연결',
  'session.giteaPrPicker.description': '이 메시지에 리뷰 컨텍스트로 첨부할 PR을 선택하세요.',
  'session.giteaPrPicker.searchPlaceholder': '제목으로 검색하거나 PR URL을 붙여넣으세요',
  'session.giteaPrPicker.includeDiffAria': 'PR 변경사항을 첨부 컨텍스트에 포함',
  'session.giteaPrPicker.includeDiff': 'PR 변경사항 포함',
  'session.giteaPrPicker.empty.noActiveProject': '선택된 활성 프로젝트가 없습니다',
  'session.giteaPrPicker.empty.runtimeUnavailable': 'Gitea 런타임 API를 사용할 수 없습니다.',
  'session.giteaPrPicker.empty.notConnected': 'Gitea에 연결되지 않았습니다. 설정에서 Gitea 계정을 연결하세요.',
  'session.giteaPrPicker.empty.noPullRequestsFound': 'PR이 없습니다',
  'session.giteaPrPicker.empty.noOpenPullRequestsFound': '열린 PR이 없습니다',
  'session.giteaPrPicker.loading.pullRequests': 'PR 불러오는 중…',
  'session.giteaPrPicker.loading.more': '로드 중…',
  'session.giteaPrPicker.actions.openSettings': '설정 열기',
  'session.giteaPrPicker.actions.usePullRequest': 'PR #{number} 사용',
  'session.giteaPrPicker.actions.openInGiteaAria': 'Gitea에서 열기',
  'session.giteaPrPicker.actions.loadMore': '더 불러오기',
  ...
  'session.newWorktree.actions.startFromGitLabIssueMr': 'GitLab 이슈/MR에서 시작',
  'session.newWorktree.usingPrBranch': 'PR 브랜치 사용 중: {branch}',
  'session.newWorktree.usingMrBranch': 'MR 브랜치 사용 중: {branch}',
  ...
  'session.newWorktree.toast.sessionFromMr': '머지 리퀘스트에서 세션을 생성했습니다',
  ...
  'session.gitlabIntegration.tabs.mergeRequests': '머지 리퀘스트',
  'session.gitlabIntegration.connect.title': 'GitLab에 연결',
  'session.gitlabIntegration.connect.description': '이슈 또는 머지 리퀘스트를 연결해 워크트리 정보를 자동으로 채웁니다',
  'session.gitlabIntegration.connect.action': 'GitLab 연결',
  'session.gitlabIntegration.search.issuesPlaceholder': 'GitLab 이슈 검색',
  'session.gitlabIntegration.search.mrsPlaceholder': 'GitLab 머지 리퀘스트 검색',
  'session.gitlabIntegration.empty.noIssuesFound': '이슈 없음',
  'session.gitlabIntegration.empty.noMergeRequestsFound': '머지 리퀘스트가 없습니다',
  ...
  'session.gitlabIntegration.draftBadge': '초안',
  'session.giteaIntegration.title': 'Gitea에서 선택',
  'session.giteaIntegration.tabs.issues': '이슈',
  'session.giteaIntegration.tabs.pullRequests': 'PR',
  'session.giteaIntegration.connect.title': 'Gitea에 연결',
  'session.giteaIntegration.connect.description': '이슈 또는 PR를 연결해 워크트리 정보를 자동으로 채웁니다',
  'session.giteaIntegration.connect.action': 'Gitea 연결',
  'session.giteaIntegration.search.issuesPlaceholder': 'Gitea 이슈 검색',
  'session.giteaIntegration.search.prsPlaceholder': 'Gitea PR 검색',
  'session.giteaIntegration.empty.noIssuesFound': '이슈 없음',
  'session.giteaIntegration.empty.noPullRequestsFound': 'PR가 없습니다',
  'session.giteaIntegration.actions.loadMore': '더 불러오기',
  'session.giteaIntegration.actions.cancel': '취소',
  'session.giteaIntegration.actions.select': '선택',
  'session.giteaIntegration.selected.issueNumber': '이슈 #{number}',
  'session.giteaIntegration.selected.prNumber': 'PR #{number}',
  'session.giteaIntegration.includeDiffAria': 'PR 변경사항을 세션 컨텍스트에 포함',
  'session.giteaIntegration.includeDiff': 'PR 변경사항 포함',
  'session.giteaIntegration.error.notConnected': 'Gitea에 연결되어 있지 않습니다',
  'session.giteaIntegration.error.loadDataFailed': '데이터를 불러오지 못했습니다',
  'session.giteaIntegration.validation.branchAlreadyCheckedOut': '브랜치가 이미 워크트리에 체크아웃되어 있습니다',
  'session.giteaIntegration.validation.branchAlreadyExists': '브랜치가 이미 로컬에 있습니다',
  'session.giteaIntegration.validation.failed': '유효성 검사에 실패했습니다',
  'session.giteaIntegration.draftBadge': '초안',
  ...
  'chat.chatInput.actions.linkGiteaIssue': 'Gitea 이슈 연결',
  'chat.chatInput.actions.linkGiteaPr': 'Gitea PR 연결',
