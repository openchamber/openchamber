...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.group.pagination.prev': '이전',
  'sessions.sidebar.group.pagination.next': '다음',
  'sessions.sidebar.group.pagination.page': '페이지 {current} / {total}',
  'sessions.sidebar.group.pagination.subagents': '서브에이전트 {current}/{total}',
  'sessions.sidebar.searching': '세션 검색 중...',
