...
export const dict: Record<I18nKey, string> = {
  ...
  'updateDialog.header.updatingRemote': '원격 인스턴스 업데이트 중…',
  'updateDialog.target.desktop.title': 'OpenChamber 데스크톱 앱 업데이트',
  'updateDialog.target.desktop.description': '이 Windows 앱만 업데이트합니다. WSL에는 원격 인스턴스 업데이트를 사용하세요.',
  'updateDialog.target.remote.title': '원격 인스턴스 업데이트',
  'updateDialog.target.remote.description': '선택한 원격 인스턴스를 업데이트합니다.',
  ...
  'updateDialog.status.downloadingDesktopPayload': '데스크톱 업데이트 다운로드 중…',
  'updateDialog.actions.downloadUpdate': '업데이트 다운로드',
  'updateDialog.actions.downloadDesktopUpdate': '데스크톱 업데이트 다운로드',
  'updateDialog.status.downloading': '다운로드 중…',
  'updateDialog.status.downloadingDesktop': '데스크톱 업데이트 다운로드 중…',
  'updateDialog.actions.restartToUpdate': '업데이트를 위해 재시작',
  'updateDialog.actions.restartDesktopToUpdate': '데스크톱 앱을 재시작하여 업데이트',
