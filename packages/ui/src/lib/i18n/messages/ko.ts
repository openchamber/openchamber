...
export const dict: Record<I18nKey, string> = {
  ...
  'desktopHostSwitcher.actions.removeServerAria': '서버 제거',
  'desktopHostSwitcher.actions.removeServer': '서버 제거',
  ...
  'desktopHostSwitcher.toast.sshDisconnected': 'SSH 인스턴스 "{host}" 연결 해제됨',
  'desktopHostSwitcher.toast.instanceUnreachable': '인스턴스 "{host}"에 연결할 수 없음',
  'server.sidebar.status.connectionError': '연결 오류',
  'server.sidebar.status.disconnected': '연결 끊김',
  'server.sidebar.search.searchingServers': '서버 {count}개 검색 중',
  'server.sidebar.localLabel': '로컬',
