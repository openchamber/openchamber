...
export const dict: Record<I18nKey, string> = {
  ...
  'session.githubIssuePicker.error.searchTimedOut': '검색 시간이 초과되었습니다. 더 구체적인 검색어를 사용해 보세요.',
  ...
  'session.githubPrPicker.error.searchTimedOut': '검색 시간이 초과되었습니다. 더 구체적인 검색어를 사용해 보세요.',
  ...
  'session.githubIntegration.error.searchTimedOut': '검색 시간이 초과되었습니다. 더 구체적인 검색어를 사용해 보세요.',
  'session.githubIntegration.error.repoNotResolvable': '저장소를 확인할 수 없습니다',
