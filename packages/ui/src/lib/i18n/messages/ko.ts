...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.telemetry.speed': '생성 속도',
  'chat.workStatus.telemetry.llmDuration': 'LLM 시간',
  'chat.workStatus.telemetry.toolDuration': '도구 시간',
  'chat.workStatus.telemetry.ttft': '첫 번째 토큰까지의 시간',
  'chat.workStatus.telemetry.steps': '턴 내 단계',
  'chat.workStatus.telemetry.tokens': '토큰',
  'chat.workStatus.telemetry.cacheHit': '캐시 적중률',
  'chat.workStatus.telemetry.cost': '턴 비용',
