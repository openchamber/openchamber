...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.toast.messageSendFailed': '메시지 전송에 실패했습니다. 메시지와 첨부 파일이 복원되었습니다.',
  'chat.chatInput.toast.messageSendMaybeFailed': '메시지가 전송되지 않았을 수 있습니다. 메시지가 보존되었습니다 — 다시 시도하기 전에 확인하세요.',
  'chat.chatInput.toast.messageRestoredToInput': '메시지가 입력란에 복원되었습니다.',
