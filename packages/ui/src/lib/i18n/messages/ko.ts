...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.dialogs.worktreeDelete.disposition.label': '연결된 세션',
  'sessions.sidebar.dialogs.worktreeDelete.disposition.archive': '연결된 세션 보관',
  'sessions.sidebar.dialogs.worktreeDelete.disposition.delete': '연결된 세션 영구 삭제',
  'sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionOneLinked': '선택한 워크트리를 제거하고 연결된 세션 {count}개를 영구 삭제합니다.',
  'sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionManyLinked': '선택한 워크트리를 제거하고 연결된 세션 {count}개를 영구 삭제합니다.',
