...
export const dict: Record<I18nKey, string> = {
  ...
  'header.connection.status.connected': '연결됨',
  'header.connection.status.connecting': '연결 중…',
  'header.connection.status.reconnecting': '다시 연결 중…',
  'header.connection.actions.retry': '클릭하여 다시 시도',
