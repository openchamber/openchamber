...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.search.findPlaceholder': '찾기',
  'chat.search.findAria': '채팅에서 찾기',
  'chat.search.replacePlaceholder': '바꾸기',
  'chat.search.replaceAria': '텍스트 바꾸기(채팅에서는 사용할 수 없음)',
  ...
  'chat.search.nextAria': '다음 일치 항목',
  'chat.search.close': '닫기(Escape)',
  'chat.search.closeAria': '검색 닫기',
  'chat.search.selectAllUnavailable': '채팅 검색에서는 모든 일치 항목 선택을 사용할 수 없음',
  'chat.search.replaceUnavailable': '채팅 검색에서는 바꾸기를 사용할 수 없음',
  'chat.search.replaceAllUnavailable': '채팅 검색에서는 모두 바꾸기를 사용할 수 없음',
  'chat.search.noResults': '결과 없음',
  'chat.search.loading': '로딩 중…',
