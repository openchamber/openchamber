...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 Sharpie를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'Sharpie가 설치되었습니다',
  ...
  'mobile.connect.welcome.title': 'Sharpie에 연결',
  ...
  'mobile.connect.password.placeholder': 'Sharpie 비밀번호',
  ...
  'mobile.connect.scan.invalid': '이 QR 코드는 Sharpie 연결 코드가 아닙니다.',
  ...
  'mobile.connect.relay.badge': 'Sharpie Relay 경유',
  ...
  'mobile.connect.error.unreachable': '해당 Sharpie 서버에 연결할 수 없습니다.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'Sharpie 정보',
  ...
  'walkthrough.blocked.serverUnsupported.description': '이 앱이 연결된 Sharpie 서버가 워크스루 API에 응답하지 않았습니다. 즉 앱보다 오래된 버전입니다. 서버를 1.18 이상으로 업데이트한 뒤 새로 고치세요.',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 Sharpie에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'filesView.editor.binaryFileDescription': '이 파일은 바이너리이므로 Sharpie에서 편집할 수 없습니다. 다른 앱으로 열려면 다운로드하세요.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Sharpie에서 이 폴더에 접근해야 합니다.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Sharpie 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Sharpie 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 Sharpie를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'Sharpie 메뉴',
  'header.actions.openAppMenuAria': 'Sharpie 메뉴 열기',
  ...
  'sessionAuth.error.networkDescription': 'UI 세션을 확인할 수 없습니다. 로컬 네트워크의 다른 기기에서 Sharpie를 열고 있다면 데스크톱 앱에서 Desktop Network Access를 활성화하고 설정에 표시되는 LAN 주소를 사용하세요.',
  ...
  'sessionAuth.locked.unlockTitle': 'Sharpie 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 Sharpie 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'Sharpie 멀티런 창.',
  ...
  'onboarding.chooser.title': 'Sharpie에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Sharpie가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 Sharpie의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Sharpie 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
  ...
  'onboarding.remoteConnection.description': '연결할 Sharpie 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 Sharpie 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 Sharpie 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 Sharpie가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 Sharpie를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 Sharpie가 실행 중이 아닙니다. 주소가 Sharpie 서버를 가리키는지 확인하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 Sharpie가 실행 중이 아닙니다. 주소가 Sharpie 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 Sharpie 서버가 이 앱 버전과 호환되지 않습니다. 서버의 Sharpie를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'Sharpie 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'Sharpie 업데이트 중…',
  ...
  'mobileUpdate.toast.available.title': 'Sharpie 업데이트 사용 가능',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Sharpie를 열어 두세요.',
  ...
  'openChamberLogo.aria.logo': 'Sharpie 로고',
