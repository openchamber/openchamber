...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.engine.claudeCodeAria': 'Claude Code 엔진',
  'sessions.sidebar.session.engine.claudeCodeTooltip': 'Claude Code에서 실행 중',
  ...
  'gitView.pr.comments.addAll': '모두 채팅에 추가',
  ...
  'chat.engines.slashUnsupported': '이 OpenCode 슬래시 명령은 Claude Code에서 사용할 수 없습니다. Claude 네이티브 /명령어를 사용하거나 일반 메시지를 보내세요.',
  'chat.engines.effort.label': '추론 강도',
  'chat.engines.effort.default': '기본',
  'chat.engines.effort.low': '낮음',
  'chat.engines.effort.medium': '보통',
  'chat.engines.effort.high': '높음',
  'chat.engines.effort.xhigh': '매우 높음',
  'chat.engines.effort.max': '최대',
  'chat.engines.effort.aria': '추론 강도: {level}',
  'chat.engines.effort.tooltip': '추론 강도: {level}',
  'chat.engines.capability.goalUnsupported': '목표는 이 엔진에서 사용할 수 없습니다.',
  'chat.engines.capability.multirunUnsupported': 'MultiRun은 이 엔진에서 사용할 수 없습니다.',
  'chat.engines.capability.openchamberToolUnsupported': 'OpenChamber 도구는 이 엔진에서 사용할 수 없습니다.',
  'chat.handoff.billingDialog.title': 'Claude Code에서 계속할까요?',
  'chat.handoff.billingDialog.body': 'Claude 구독 사용량 한도를 사용하는 새 Claude Code 세션을 시작합니다. OpenCode API 제공자는 변경되지 않습니다. 대화 텍스트는 컨텍스트로 복사되며 원본 세션은 그대로 유지됩니다.',
  'chat.handoff.billingDialog.continue': '계속',
  'chat.handoff.billingDialog.cancel': '취소',
  'chat.handoff.billingDialog.dontShowAgain': '다시 표시하지 않기',
  'chat.handoff.billingDialog.dontShowAgainAria': '이 핸드오프 결제 안내를 다시 표시하지 않기',
