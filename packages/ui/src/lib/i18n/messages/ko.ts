...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.messageBody.metrics.ttftInfo': '첫 토큰까지의 시간: 요청 후 모델이 응답을 시작하기까지 걸린 시간입니다.',
  'chat.messageBody.metrics.tokensPerSecond': '{rate} tok/s',
  'chat.messageBody.metrics.tokensPerSecondInfo': '도구 실행 시간을 제외한 스트리밍 디코딩 시간 기준 초당 출력 토큰 수입니다.',
