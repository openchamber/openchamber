...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.header.upstreamFetchAria': '{target} fetch',
  'gitView.header.upstreamFetchTooltip': '{target} fetch',
  'gitView.header.upstreamSyncAria': '{target}에서 동기화',
  'gitView.header.upstreamSyncTooltip': '{target}에서 fetch 후 pull',
  ...
  'gitView.operation.inProgressTitle': 'Git 작업 진행 중',
  'gitView.operation.merge': '병합',
  'gitView.operation.mergeInProgressWithHead': '{head} 병합 진행 중',
  'gitView.operation.mergingMessage': '병합 중…',
  'gitView.operation.rebase': '리베이스',
  'gitView.operation.rebaseInProgress': '리베이스 진행 중',
  'gitView.operation.rebasingOnto': '{branch} 위로 리베이스 중',
  'gitView.operation.resolveConflictsHint': '충돌을 해결한 뒤 계속 진행하세요.',
  ...
  'gitView.sync.fetchTrackingTooltip': '추적 브랜치 {tracking} 가져오기',
  'gitView.sync.pull': '풀',
  'gitView.sync.pullTooltip': '변경 사항 풀',
  'gitView.sync.pullTooltipBehind': '변경 사항 풀({count}개 뒤처짐)',
  'gitView.sync.pullTrackingTooltip': '추적 브랜치 {tracking}에서 풀',
  'gitView.sync.pullTrackingTooltipBehind': '추적 브랜치 {tracking}에서 풀({count}개 뒤처짐)',
  'gitView.sync.push': '푸시',
  'gitView.sync.pushTooltip': '변경 사항 푸시',
  'gitView.sync.pushTooltipAhead': '변경 사항 푸시({count}개 앞섬)',
  'gitView.sync.pushTrackingTooltip': '추적 브랜치 {tracking}에 푸시',
  'gitView.sync.pushTrackingTooltipAhead': '추적 브랜치 {tracking}에 푸시({count}개 앞섬)',
  'gitView.sync.upstreamFetch': '업스트림 가져오기',
  'gitView.sync.upstreamSync': '업스트림 동기화',
