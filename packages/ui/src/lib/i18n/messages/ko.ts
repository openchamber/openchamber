...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.sendMode.queue': '이 메시지를 대기열로 보내기',
  'chat.chatInput.sendMode.steer': '이 메시지를 바로 보내기',
  'chat.chatInput.sendMode.switchToQueue': '이 메시지를 대기열 모드로 보내기',
  'chat.chatInput.sendMode.switchToSteer': '이 메시지를 steer 모드로 보내기',
