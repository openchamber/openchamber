...
export const dict: Record<I18nKey, string> = {
  ...
  'usage.status.quotaExhausted': '할당량 소진',
  'usage.status.expired': 'API 키 만료',
  'usage.statistics.title': '사용량 통계',
  'usage.statistics.info': '모델 통계는 최근 30일을 기준으로 합니다.',
  'usage.statistics.requests': '요청 수',
  'usage.statistics.inputTokens': '입력 토큰',
  'usage.statistics.outputTokens': '출력 토큰',
  'usage.statistics.cacheReadTokens': '캐시 읽기 토큰',
  'usage.statistics.totalTokens': '총 토큰',
  'usage.statistics.actualCost': '비용',
  'usage.statistics.today': '오늘',
  'usage.statistics.total': '전체',
  'usage.statistics.empty': '보고된 사용량 통계가 없습니다.',
