...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.queuedMessage.title': '대기 중인 메시지',
  ...
  'chat.queuedMessage.admissionPending': '서버로 전송 중…',
  'chat.queuedMessage.admitted': '서버 대기열에 추가됨 · 닫아도 안전합니다',
  'chat.queuedMessage.localFallback': '로컬 대기열 · 클라이언트를 열어 두세요',
  'chat.queuedMessage.admissionFailed': '대기열 추가 실패',
  'chat.queuedMessage.admissionUnknown': '결과를 알 수 없음 · 중복될 수 있으니 재시도하지 마세요',
  'chat.queuedMessage.retryAdmission': '대기열 추가 재시도',
  'chat.queuedMessage.restore': '컴포저로 이동',
  'chat.queuedMessage.copy': '텍스트 복사',
  'chat.queuedMessage.dismiss': '닫기',
  'chat.queuedMessage.copyFailed': '메시지 텍스트를 복사하지 못했습니다',
  'chat.queuedMessage.selectionLimitation': '서버 대기열 추가에는 세션의 현재 모델, 에이전트 및 변형 설정이 사용됩니다',
