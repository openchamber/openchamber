...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'contextPanel.mode.agentBrowser': '에이전트 브라우저',
  'contextRail.surface.agentBrowser.description': '에이전트가 제어하는 실시간 브라우저',
  'agentBrowser.viewport.desktop': '데스크톱',
  'agentBrowser.viewport.laptop': '노트북',
  'agentBrowser.viewport.tablet': '태블릿',
  'agentBrowser.viewport.mobile': '모바일',
  'agentBrowser.actions.newTab': '새 탭',
  'agentBrowser.actions.reload': '새로 고침',
  'agentBrowser.actions.go': '이동',
  'agentBrowser.actions.screenshot': '스크린샷 캡처',
  'agentBrowser.actions.startRecording': '녹화 시작',
  'agentBrowser.actions.stopRecording': '녹화 중지',
  'agentBrowser.recording.active': '녹화 중',
  'agentBrowser.urlBar.placeholder': '열 URL을 입력하세요',
  'agentBrowser.tab.untitled': '새 탭',
  'agentBrowser.tab.close': '탭 닫기',
  'agentBrowser.preview.aria': '실시간 브라우저 미리 보기',
  'agentBrowser.preview.waitingFrame': '첫 프레임을 기다리는 중…',
  'agentBrowser.preview.connecting': '브라우저에 연결하는 중…',
  'agentBrowser.empty.noTabs': '열린 탭 없음',
  ...
  'agentBrowser.control.agentActive': '에이전트가 제어 중',
  'agentBrowser.takeover.title': '브라우저 제어권을 가져오시겠습니까?',
  'agentBrowser.takeover.description': '에이전트가 지금 브라우저를 사용 중입니다. 제어권을 가져오면 해당 에이전트가 중지됩니다.',
  'agentBrowser.takeover.confirm': '제어권 가져오기',
  'agentBrowser.takeover.cancel': '취소',
