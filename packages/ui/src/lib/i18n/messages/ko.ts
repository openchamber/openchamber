...
export const dict: Record<I18nKey, string> = {
  ...
  ...settingsDict,
  'gitView.operation.title': 'Git 작업',
  'gitView.operation.recovery.storage': 'Git 복구 저장소를 사용할 수 없습니다. 브라우저 저장소를 복원하고 새로고침하세요. 새 변경 작업은 차단됩니다.',
  'gitView.operation.recovery.capacity': 'Git 복구 저장소가 가득 찼습니다. 다른 작업을 시작하기 전에 저장된 작업을 해결하세요.',
  'gitView.operation.recovery.reconciling': '저장된 Git 작업 참조 확인 중…',
  'gitView.operation.recovery.repository': '저장소를 확인할 수 없습니다. 다른 Git 작업을 시작하기 전에 새로고침하세요.',
  'gitView.operation.recovery.inspect': '서버가 이 ID를 더 이상 인식하지 못하면 OpenChamber 외부에서 로컬 저장소와 원격 저장소를 확인하세요. 저장된 참조는 계속 차단됩니다. 상태가 없다고 해서 전송을 반복할 수 있는 것은 아닙니다.',
  'gitView.operation.localCommit': '로컬 커밋이 생성되었으며 유지됩니다.',
  'gitView.operation.unknownHint': '결과를 알 수 없습니다. 다른 전송을 시작하기 전에 이 작업의 상태를 새로고침하세요. 자동으로 다시 실행되지 않습니다.',
  'gitView.operation.refresh': '작업 새로고침',
  'gitView.operation.cancel': '작업 취소',
  'gitView.operation.state.unavailable': '작업 상태를 확인할 수 없음',
  'gitView.operation.state.planned': '계획됨',
  'gitView.operation.state.running': '실행 중',
  'gitView.operation.state.succeeded': '성공',
  'gitView.operation.state.partial': '일부 완료',
  'gitView.operation.state.failed': '실패',
  'gitView.operation.state.cancelled': '취소됨',
  'gitView.operation.state.outcome-unknown': '결과 알 수 없음',
  'gitView.operation.state.conflicted': '충돌',
  'gitView.operation.state.skipped': '건너뜀',
  'gitView.operation.completed.validated': '저장소 및 대상 검증 완료',
  'gitView.operation.completed.authenticated': '인증 완료',
  'gitView.operation.completed.transferred': '전송 완료',
  'gitView.operation.completed.updated-local-repository': '로컬 저장소 업데이트 완료',
  'gitView.operation.completed.checked-out': '체크아웃 완료',
  'gitView.operation.completed.cleaned-up': '정리 완료',
  'gitView.remotes.title': '다른 리모트',
  'gitView.remotes.description': '아이덴티티를 적용한 주소 외에 이 저장소가 가진 주소입니다. 허용하기 전까지 OpenChamber는 이 주소에서 가져오지도, 이 주소로 보내지도 않습니다.',
  'gitView.remotes.grant': '{identity}(으)로 응답하기',
  'gitView.hydration.title': '체크아웃 준비',
  'gitView.hydration.description': '각 엔드포인트를 개별적으로 승인하여 하위 모듈을 초기화하고 Git LFS 콘텐츠를 가져옵니다.',
  ...
  'gitView.hydration.kind.submodule': '하위 모듈',
  'gitView.hydration.kind.lfs': 'Git LFS',
  'gitView.hydration.status.succeeded': '완료됨',
  'gitView.hydration.status.failed': '실패',
  'gitView.hydration.status.cancelled': '취소됨',
  'gitView.hydration.status.authorization-required': '승인 필요',
  'gitView.hydration.status.invalid': '잘못된 구성',
  'gitView.hydration.status.client-missing': '클라이언트 없음',
  'gitView.hydration.status.not-needed': '필요 없음',
  'gitView.publish.title': '게시',
  'gitView.publish.commitKept': '로컬 커밋이 생성되어 유지됩니다. 게시가 정상적으로 완료되지 않았습니다.',
  'gitView.publish.syncTitle': '동기화 대상 선택',
  'gitView.publish.description': '{branch}을 정확한 Git 대상에 게시합니다. 공급자 계정은 대상을 선택하지 않습니다.',
  'gitView.publish.fetchSource': '가져올 원격 저장소',
  'gitView.publish.sourceBranch': '소스 브랜치',
  'gitView.publish.fetchFirst': '이 원격 저장소에 캐시된 브랜치가 없습니다. 취소하고 먼저 가져오기를 실행하세요.',
  'gitView.publish.pushDestination': '푸시할 원격 저장소',
  'gitView.publish.selectRemote': '연결된 원격 저장소 선택',
  'gitView.publish.destinationBranch': '대상 브랜치',
  'gitView.publish.noGrants': '게시하기 전에 Git 전송 연결을 구성하세요.',
  'gitView.publish.contributorCommitFirst': '이 기여자 작업 트리는 커밋 후 대상 승인이 필요합니다. 계속할까요? 나중에 게시를 취소해도 로컬 커밋은 유지됩니다.',
  'gitView.publish.detached': '분리된 HEAD 게시는 지원하지 않습니다. 먼저 로컬 브랜치를 체크아웃하세요.',
  'gitView.publish.stale': '브랜치 또는 Git 권한이 변경되었습니다. 재시도하지 않았습니다. 대상을 다시 선택하세요.',
  'gitView.publish.cancelled': '게시가 취소되었습니다. Git 전송을 시작하지 않았습니다.',
  'gitView.publish.succeeded': '선택한 대상에 게시했습니다',
  ...
  'chat.shellBoundary.status': '확인되지 않음 · 관리 경계 외부',
  'chat.shellBoundary.agentAria': '에이전트 셸 실행은 확인되지 않았으며 관리되는 Git 경계 밖에 있습니다',
  'chat.shellBoundary.userAria': '사용자 셸 실행은 확인되지 않았으며 관리되는 Git 경계 밖에 있습니다',
  ...
  'gitView.context.description': '아이덴티티 하나로는 정해지지 않는 것: 에이전트 셸, 저장소의 다른 주소, 서브모듈과 Git LFS에 필요한 별도 허용. 아이덴티티는 Git 설정에서 관리합니다.',
  ...
  'gitView.identity.unavailableScheme': '{scheme} 원격이 필요함',
  ...
  'worktree.bootstrap.toast.authorizationRequired': '체크아웃 저장소와 하위 모듈을 인증한 후 다시 시도하세요.',
  ...
  'gitView.pr.actions.openOnProvider': '{provider}에서 열기',
  'gitView.pr.actions.openOnProviderAria': '{provider}에서 풀 리퀘스트 열기',
  ...
  'gitView.pr.providerNotConnected': '{provider}에 연결되지 않음',
  ...
  'gitView.pr.capabilitiesUnavailable': '공급자 기능을 불러올 수 없습니다',
  ...
  'gitView.contributor.chooseDestination': '이 기여자 브랜치를 푸시할 정확한 대상을 선택하세요.',
  'gitView.contributor.destination.contributor-fork': '기여자 포크',
  'gitView.contributor.destination.own-fork': '내 포크',
  'gitView.contributor.destination.bound-repository': '연결된 저장소',
  'gitView.contributor.destination.other': '다른 원격 저장소',
  'gitView.toast.contributorPublishCancelled': '게시가 취소되었습니다. 원격 저장소는 변경되지 않았습니다.',
  'gitView.toast.contributorPublishCancelledAfterUpdate': '변경 사항은 로컬에서 업데이트되었지만 게시가 취소되었습니다.',
  'gitView.toast.unstageFileFailed': '변경사항 스테이징 해제 실패',
  'gitView.confirm.systemTransport': '시스템 Git이 이 컴퓨터에 구성된 자격 증명을 사용할 수 있습니다. 이 Git 작업을 계속하시겠습니까?',
  ...
  'session.changeRequestPicker.error.noProvider': '지원되는 소스 제어 리모트를 찾을 수 없습니다',
  'session.changeRequestPicker.title': '변경 요청 연결',
  'session.changeRequestPicker.description': '이 메시지에 리뷰 컨텍스트를 첨부할 풀 리퀘스트 또는 머지 리퀘스트를 선택하세요.',
  'session.changeRequestPicker.searchPlaceholder': '제목이나 번호로 검색하거나 변경 요청 URL을 붙여넣으세요',
  'session.changeRequestPicker.includeDiffAria': '첨부된 컨텍스트에 변경 요청 diff 포함',
  'session.changeRequestPicker.includeDiff': 'diff 포함',
  'session.changeRequestPicker.loading.changeRequests': '변경 요청 불러오는 중...',
  'session.changeRequestPicker.actions.useChangeRequest': '변경 요청 {reference} 사용',
  'session.changeRequestPicker.empty.noneFound': '변경 요청을 찾을 수 없습니다',
  'session.changeRequestPicker.empty.noneOpen': '열린 변경 요청을 찾을 수 없습니다',
  'session.issuePicker.title': '이슈 연결',
  'session.issuePicker.description': '이 메시지에 컨텍스트를 첨부할 이슈를 선택하세요.',
  'session.issuePicker.searchPlaceholder': '제목이나 번호로 검색하거나 이슈 URL을 붙여넣으세요',
  'session.issuePicker.loading.issues': '이슈 불러오는 중...',
  'session.issuePicker.actions.useIssue': '이슈 #{number} 사용',
  'session.issuePicker.empty.noneFound': '이슈를 찾을 수 없습니다',
  'session.issuePicker.empty.noneOpen': '열린 이슈를 찾을 수 없습니다',
  ...
  'session.newWorktree.error.changeRequestAuthorityMissing': '변경 요청 권한을 더 이상 사용할 수 없습니다. 다시 선택하세요.',
  'session.newWorktree.trust.confirmation': '이 체크아웃에는 실행 가능한 작업이 있습니다.\n\n{actions}\n\n지금 실행할까요? 취소하면 실행하지 않고 Git을 사용할 수 있는 상태로 둡니다.',
