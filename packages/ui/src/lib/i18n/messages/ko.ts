...
export const dict: Record<I18nKey, string> = {
  ...
  'walkthrough.scope.basePickerTitle': '베이스 브랜치 선택',
  'walkthrough.scope.basePickerDescription': '이 브랜치의 변경 사항을 선택한 베이스와 비교해 살펴봅니다.',
  'walkthrough.scope.changeBase': '베이스 브랜치 변경...',
