...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.notifications.openAria': '알림',
  'layout.notifications.openTitle': '알림',
  'layout.notifications.title': '알림',
  'layout.notifications.empty': '아직 알림이 없습니다',
  'layout.notifications.emptyFiltered': '현재 필터에 맞는 알림이 없습니다',
  'layout.notifications.markAllRead': '모두 읽음으로 표시',
  'layout.notifications.clearAll': '모두 지우기',
  'layout.notifications.remove': '알림 삭제',
  'layout.notifications.sessionSubtaskFinished': '하위 작업 완료',
  'layout.notifications.sessionSubtaskError': '하위 작업 오류',
  'layout.notifications.openSettings': '알림 설정',
  'layout.notifications.unreadCountAria': '읽지 않은 알림 {count}개',
  'layout.notifications.sessionFinished': '세션이 끝났습니다',
  'layout.notifications.sessionError': '세션 오류',
  'layout.notifications.permissionNeeded': '권한이 필요합니다',
  'layout.notifications.permissionFallback': '에이전트의 승인이 필요합니다',
  'layout.notifications.inputNeeded': '입력이 필요합니다',
  'layout.notifications.questionFallback': '에이전트가 응답을 기다리고 있습니다',
  'layout.notifications.openSession': '세션 열기',
  'layout.notifications.occurrenceCount': '×{count}',
  'layout.notifications.time.justNow': '방금',
  'layout.notifications.time.minutesAgo': '{count}분',
  'layout.notifications.time.hoursAgo': '{count}시간',
  'layout.notifications.time.daysAgo': '{count}일',
  'toast.action.ok': '확인',
  'toast.action.copy': '복사',
