...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.reviewCommentEdit': '댓글 편집',
  'chat.chatInput.reviewCommentEditPlaceholder': '댓글을 편집하세요…',
  'chat.chatInput.reviewCommentSave': '저장',
  'chat.message.inlineComment.expand': '코드 표시',
  'chat.message.inlineComment.collapse': '코드 숨기기',
  'chat.message.inlineComment.lineSingle': '{line}번 줄',
  'chat.message.inlineComment.lineRange': '{start}–{end}번 줄',
  'chat.message.inlineComment.lineSingleOfFile': '{file}의 {line}번 줄',
  'chat.message.inlineComment.lineRangeOfFile': '{file}의 {start}–{end}번 줄',
  'chat.chatInput.reviewCommentCancel': '취소',
