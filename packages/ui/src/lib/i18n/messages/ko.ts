...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.engines.capability.goalUnsupported': '목표는 OpenCode에서만 사용할 수 있습니다. 목표를 쓰려면 이 세션을 OpenCode로 전환하세요.',
  'chat.engines.capability.multirunUnsupported': 'MultiRun은 OpenCode에서만 사용할 수 있습니다. MultiRun을 시작하려면 이 세션을 OpenCode로 전환하세요.',
