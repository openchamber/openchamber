...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.actions.enhancePromptAria': '프롬프트 개선',
  'chat.chatInput.actions.enhancePromptCancel': '프롬프트 개선 취소',
  ...
  'chat.chatInput.toast.enhanceUnavailable': '프롬프트 개선에 사용할 소형 모델이 없습니다. 설정 → 세션 → 소형 모델에서 선택하세요.',
  'chat.chatInput.toast.enhanceContextTooSmall': '프롬프트가 소형 모델의 컨텍스트에 비해 너무 큽니다. 줄이거나 파일로 첨부하세요.',
  'chat.chatInput.toast.enhanceEmptyResult': '소형 모델이 빈 프롬프트를 반환했습니다. 다시 시도하세요.',
  'chat.chatInput.toast.enhanceInvalidResult': '개선된 프롬프트가 @, /, # 참조를 변경할 수 있어 초안은 변경되지 않았습니다.',
  'chat.chatInput.toast.enhanceTimedOut': '프롬프트 개선이 시간 초과되었습니다. 다시 시도하세요.',
