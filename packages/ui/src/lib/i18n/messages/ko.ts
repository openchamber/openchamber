...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.harness.claudeCodeAria': 'Claude Code 하네스',
  'sessions.sidebar.session.harness.claudeCodeTooltip': 'Claude Code에서 실행 중',
  ...
  'chat.statusRow.retrying': '사용 가능한 용량이 생기면 다시 시도합니다',
  'chat.statusRow.retryingIn': '{countdown} 후 다시 시도합니다',
  'chat.statusRow.retryAttempt': '({attempt}번째 시도)',
  'chat.statusRow.recoveryBlocked': '자동 복구가 차단되었습니다. 복구를 취소하려면 이 세션을 중지하세요.',
  'chat.chatInput.toast.queueFull': '이 세션의 후속 메시지 대기열이 가득 찼습니다. 초안은 유지되었습니다.',
  'chat.chatInput.toast.queueTargetsFull': '후속 메시지가 대기 중인 세션이 너무 많습니다. 초안은 유지되었습니다.',
  ...
  'chat.commandAutocomplete.command.claudeNativeDescription': 'Claude Code 명령: /{name}',
  ...
  'chat.modelControls.cacheRead': '캐시 읽기',
  'chat.modelControls.cacheWrite': '캐시 쓰기',
  'chat.modelControls.costInOutShort': '입력 {input} · 출력 {output}',
  'chat.modelControls.modalityInputAria': '{modality} 입력',
  'chat.modelControls.modalityOutputAria': '{modality} 출력',
  ...
  'chat.modelControls.thinkingValue': '추론: {value}',
  ...
  'chat.modelControls.noAgentsFound': '에이전트 없음',
  'chat.modelControls.claudeAgents.defaultAgent': 'Claude 기본값',
  'chat.modelControls.claudeAgents.empty': 'Claude 에이전트 없음',
  ...
  'chat.harness.section': '하네스',
  'chat.harness.opencode': 'OpenCode',
  'chat.harness.claudeCode': 'Claude Code',
  'chat.harness.manageHarnesses': '하네스 관리…',
  'chat.harness.chip.claude': 'Claude · {model}',
  'chat.harness.notReady': 'Claude Code가 준비되지 않았습니다. 설정 → 하네스에서 설치, 로그인 또는 다시 감지하세요.',
  'chat.harness.commandTranslationFailed': '이 OpenCode 명령을 Claude Code에서 실행하지 못했습니다.',
  'chat.harness.effort.label': '추론 강도',
  'chat.harness.effort.default': '기본',
  'chat.harness.effort.low': '낮음',
  'chat.harness.effort.medium': '보통',
  'chat.harness.effort.high': '높음',
  'chat.harness.effort.xhigh': '매우 높음',
  'chat.harness.effort.max': '최대',
  'chat.harness.effort.aria': '추론 강도: {level}',
  'chat.harness.effort.tooltip': '추론 강도: {level}',
  'chat.harness.capability.goalUnsupported': '목표는 이 하네스에서 사용할 수 없습니다.',
  'chat.harness.capability.multirunUnsupported': 'MultiRun은 이 하네스에서 사용할 수 없습니다.',
  'chat.harness.capability.openchamberToolUnsupported': 'OpenChamber 도구는 이 하네스에서 사용할 수 없습니다.',
  'chat.harness.switch.title': '{harness}(으)로 전환할까요?',
  'chat.harness.switch.body': '하네스를 전환하면 새 세션이 시작됩니다. 현재 세션은 그대로 유지됩니다.',
  'chat.harness.switch.billing': '새 세션은 API 과금이 아닌 Claude 구독을 사용합니다.',
  'chat.harness.switch.duplicate.title': '세션 데이터 복제',
  'chat.harness.switch.duplicate.description': '최근 대화를 표시되는 컨텍스트 메시지로 새 세션에 복사합니다.',
  'chat.harness.switch.summarize.title': '세션 요약',
  'chat.harness.switch.summarize.description': '이 세션을 요약하고 요약만 가져갑니다. 현재 세션은 압축됩니다.',
  'chat.harness.switch.optionsAria': '새 세션에 가져갈 내용',
  'chat.harness.switch.dontShowAgain': '다시 표시하지 않기',
  'chat.harness.switch.dontShowAgainAria': '하네스 전환 대화 상자를 다시 표시하지 않기',
  'chat.harness.switch.cancel': '취소',
  'chat.harness.switch.confirm': '하네스 전환',
  'chat.harness.switch.working': '전환 중…',
  'chat.harness.contextCard.title': '이전 세션의 컨텍스트',
  'chat.harness.contextCard.expandAria': '이전된 컨텍스트 펼치기',
  'chat.harness.contextCard.collapseAria': '이전된 컨텍스트 접기',
