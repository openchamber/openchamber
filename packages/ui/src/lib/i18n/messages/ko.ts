...
export const dict: Record<I18nKey, string> = {
  ...
  'workspace.zone.label.right': '오른쪽 영역',
  'workspace.zone.label.bottom': '아래쪽 영역',
  'workspace.zone.resize.left': '왼쪽 영역 크기 조절',
  'workspace.zone.resize.bottom': '아래쪽 영역 크기 조절',
  'workspace.preset.title': '레이아웃',
  'workspace.preset.default': '기본',
  'workspace.preset.developer': '개발자',
  'workspace.preset.codeAgent': '코드 + 에이전트',
  'workspace.preset.reset': '레이아웃 초기화',
};
