...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.branch.actions.delete': '브랜치 삭제',
  'gitView.branch.actions.rename': '브랜치 이름 변경',
  'gitView.branch.actionsAria': '{branch} 작업',
  ...
  'gitView.branch.deleteConfirm': '브랜치 삭제',
  'gitView.branch.deleteDialogDescription': '로컬 브랜치 {branch}을(를) 삭제할까요? 이 작업은 되돌릴 수 없습니다.',
  'gitView.branch.deleteDialogTitle': '브랜치 삭제',
  'gitView.branch.deleting': '삭제 중…',
  ...
  'gitView.branch.renameConfirm': '브랜치 이름 변경',
  'gitView.branch.renameDialogDescription': '{branch}의 새 이름을 입력하세요.',
  'gitView.branch.renameDialogTitle': '브랜치 이름 변경',
  ...
  'gitView.toast.cannotDeleteBranch': '브랜치를 삭제할 수 없음: {reason}',
  ...
  'gitView.toast.deletedBranch': '{branch} 브랜치를 삭제했습니다',
  'gitView.toast.deleteBranchFailed': '{branch} 삭제 실패',
