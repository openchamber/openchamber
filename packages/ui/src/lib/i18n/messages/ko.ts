...
export const dict: Record<I18nKey, string> = {
  ...
  'header.actions.unstickLatestQuestion': '최근 질문 고정 해제',
  'header.actions.unstickLatestQuestionAria': '채팅 화면에서 최근 질문 고정 해제',
  'header.actions.stickLatestQuestion': '최근 질문 고정',
  'header.actions.stickLatestQuestionAria': '채팅 화면에 최근 질문 고정',
  ...
  'chat.mobileStatus.expandPanelAria': '세션 패널 펼치기',
  'chat.mobileStatus.collapsePanelAria': '세션 패널 접기',
