...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.region.aria': '패널 영역',
  ...
  "tiling.splitAnchor.left": "왼쪽으로 패널 분할",
  "tiling.splitAnchor.right": "오른쪽으로 패널 분할",
  "tiling.splitAnchor.top": "위쪽으로 패널 분할",
  "tiling.splitAnchor.bottom": "아래쪽으로 패널 분할",
  "tiling.region.moveTarget": "이 영역으로 타일 이동",
