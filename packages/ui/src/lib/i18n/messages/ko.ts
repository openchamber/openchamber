...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.modelControls.projectDefaultSaved': '이 프로젝트의 기본 모델을 업데이트했습니다',
  'chat.modelControls.projectDefaultSavedDescription': '이 프로젝트의 앞으로의 채팅은 {model} 모델로 시작됩니다.',
  'chat.modelControls.projectDefaultSaveFailed': '프로젝트 기본 모델을 업데이트하지 못했습니다',
  'chat.modelControls.projectDefaultOpenSettings': '프로젝트 설정',
  'chat.modelControls.projectDefaultAction': '이 채팅과 이 프로젝트의 앞으로의 채팅에 사용',
  'chat.modelControls.projectDefaultCurrent': '이 프로젝트의 새 채팅에 사용됩니다',
