...
export const dict: Record<I18nKey, string> = {
  ...
  'contextSidebar.breakdown.segment.systemPrompt': '시스템 프롬프트',
  'contextSidebar.breakdown.segment.skills': '스킬',
  'contextSidebar.breakdown.segment.messages': '메시지',
  'contextSidebar.breakdown.segment.other': '기타',
  'contextSidebar.section.breakdown': '컨텍스트 분석',
