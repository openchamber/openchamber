...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 ALIAS ADE를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'ALIAS ADE가 설치되었습니다',
  ...
  'sessions.sidebar.footer.actions.aboutAliasAde': 'ALIAS ADE 정보',
  ...
  'header.services.shutdownDev': 'ALIAS ADE 종료',
  ...
  'aboutDialog.diagnosticsDescription': 'ALIAS ADE 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 ALIAS ADE를 빠르게 탐색하세요',
  ...
  'sessionAuth.locked.unlockTitle': 'ALIAS ADE 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 ALIAS ADE 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'ALIAS ADE 멀티런 창.',
  ...
  'onboarding.chooser.title': 'ALIAS ADE에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'ALIAS ADE가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 ALIAS ADE의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'ALIAS ADE 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
  ...
  'onboarding.remoteConnection.description': '연결할 ALIAS ADE 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 ALIAS ADE 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 ALIAS ADE가 실행 중이 아닙니다. 주소가 ALIAS ADE 서버를 가리키는지 확인하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 ALIAS ADE가 실행 중이 아닙니다. 주소가 ALIAS ADE 서버를 가리키는지 확인하세요.',
  ...
  'startup.initRecovery.description': 'ALIAS ADE 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'ALIAS ADE 업데이트 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `alias-ade update`를 실행하세요.',
  ...
  'aliasAdeLogo.aria.logo': 'ALIAS ADE 로고',
