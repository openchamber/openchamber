...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.git.description': '변경 사항 검토, 커밋 및 동기화',
  ...
  'contextPanel.actions.backToChanges': '변경 사항으로 돌아가기',
  ...
  'helpDialog.item.openRightSidebarGitTab': '변경 사항 서피스 열기',
