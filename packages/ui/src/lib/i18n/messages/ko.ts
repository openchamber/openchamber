...
export const dict: Record<I18nKey, string> = {
  ...
  'filesView.tree.actions.uploadTitle': '파일 업로드',
  'filesView.tree.drop.uploadHint': '파일을 놓아 업로드하세요',
  'filesView.toast.uploadSuccess': '{count}개 파일 업로드 완료',
  'filesView.toast.uploadSuccessSingle': '{name} 업로드 완료',
  'filesView.toast.uploadFailed': '{count}개 파일 업로드 실패',
  'filesView.toast.uploadFailedSingle': '{name} 업로드 실패',
