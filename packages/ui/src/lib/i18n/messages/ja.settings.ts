...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.voice.page.tooltip.sttBrowser': '対応ブラウザー内蔵の認識。無料、設定不要。',
  'settings.voice.page.browserTest.title': 'マイクをテスト',
  'settings.voice.page.browserTest.stop': 'テストを停止',
  'settings.voice.page.browserTest.transcript': '認識されたテキストがここに表示されます。',
  'settings.voice.page.browserTest.description': '話して音声認識とマイク音量を確認してください。テキストはこのプレビュー内に留まり、チャットには送信されません。ブラウザーが音声を音声認識サービスに送信する場合があります。',
  'settings.voice.page.browserTest.unavailable': 'ここではブラウザーの音声認識を利用できません。対応ブラウザーでHTTPS経由で開くか、ローカルまたはサーバーを選択してください。デスクトップおよびネイティブモバイルアプリは非対応です。',
  'settings.voice.page.browserFallback': 'ブラウザー認識は別のデバイスで選択されました。このデバイスには対応していないため、ここではローカルを使用します。',
  'settings.voice.page.browserTest.error': '音声認識が停止しました（{code}）。マイクの権限と接続を確認して再試行してください。認識されたテキストは保持されます。',
  'settings.voice.page.browserTest.error.busy': 'このページではすでに別の音声入力が録音中です。先に停止してからもう一度お試しください。',
  'settings.voice.page.browserTest.error.network': '音声認識サービスに接続できませんでした。接続を確認してもう一度お試しください。認識済みのテキストは保持されます。',
  'settings.voice.page.browserTest.error.noSpeech': '音声が聞き取れませんでした。マイクに近づいてもう一度お試しください。',
  'settings.voice.page.browserTest.error.audioCapture': 'マイクの音量メーターを利用できません。メーターなしで録音を続行します。',
  'settings.voice.page.browserTest.error.timeout': '音声認識サービスが時間内に応答しませんでした。認識済みのテキストは保持されます。',
  'settings.voice.page.browserTest.error.startFailed': '認識を開始できませんでした。ページを再読み込みしてもう一度お試しください。',
  'settings.voice.page.browserTest.error.permission': 'マイクへのアクセスが拒否されました。アドレスバー横のサイト設定でマイクを許可し、ページを再読み込みしてもう一度お試しください。',
  'settings.voice.page.field.browserMicrophonePermission': 'チャットでマイクボタンを押すか下のテストを開始したとき、ブラウザーから許可を求められたらマイクへのアクセスを許可してください。確認が表示されない場合やアクセスがブロックされている場合は、アドレスバーの横からサイトの設定を開き、マイクを許可してからページを再読み込みし、もう一度お試しください。',
