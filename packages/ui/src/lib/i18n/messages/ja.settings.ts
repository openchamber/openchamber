...
export const settingsDict = {
  ...
  'settings.magicPrompts.sidebar.group.composer': 'コンポーザー',
  ...
  'settings.magicPrompts.sidebar.item.composerEnhance': 'プロンプト強化',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.magicPrompts.page.group.composerEnhance.title': 'プロンプト強化',
  'settings.magicPrompts.page.group.sessionFusion.description': 'マルチランの出力を1つの最終回答に結合する際に使用するプロンプト: ソース結果の前に表示ユーザーメッセージ + 非表示指示。',
  'settings.magicPrompts.page.group.composerEnhance.description': 'コンポーザーの「プロンプトを強化」アクションが使用するプロンプト: 送信前に小型モデルで下書きを書き直す非表示の指示です。',
