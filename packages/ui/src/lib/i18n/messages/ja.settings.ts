...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.openchamber.tools.field.serverBrowser': 'サーバーブラウザー',
  'settings.openchamber.tools.field.serverBrowserAria': 'サーバーブラウザーを有効にする',
  'settings.openchamber.tools.field.serverBrowserInfo': 'このサーバー上で Chrome ブラウザーを実行し、接続されたウィンドウが応答できない場合でもエージェントがブラウジングできるようにします。また、どのデバイスからでも同じページを表示・操作できます。デフォルトはオフで、即時に適用されます。オフにすると Chrome が停止し、そのセッションとビューアーが閉じられます。',
  'settings.openchamber.tools.browserDebugPort.label': 'ブラウザーの CDP ポート',
  'settings.openchamber.tools.browserDebugPort.info': 'ローカル MCP 接続に使用するポートを選択します。保存した設定は次回 Chrome 起動時に適用され、現在のタブは開いたままになります。',
  'settings.openchamber.tools.browserDebugPort.automatic': '自動',
  'settings.openchamber.tools.browserDebugPort.fixed': '固定ポート',
  'settings.openchamber.tools.browserDebugPort.input': '固定 CDP ポート',
  'settings.openchamber.tools.browserDebugPort.invalid': '1 から 65535 までの整数を入力してください。',
  'settings.openchamber.tools.browserDebugPort.save': 'ポートを保存',
  'settings.openchamber.tools.browserDebugPort.configuredAutomatic': '設定ポート: 自動',
  'settings.openchamber.tools.browserDebugPort.configuredFixed': '設定ポート: {port}',
  'settings.openchamber.tools.browserDebugPort.loading': 'ブラウザーの状態を確認中…',
  'settings.openchamber.tools.browserDebugPort.unavailable': 'ブラウザーの状態を取得できません。',
  'settings.openchamber.tools.browserDebugPort.stopped': 'Chrome は起動していません。',
  'settings.openchamber.tools.browserDebugPort.active': '使用中のポート: {port}',
  'settings.openchamber.tools.browserDebugPort.pending': '保存したポートは次回 Chrome 起動時に適用されます。',
  'settings.openchamber.tools.browserDebugPort.refresh': '状態を更新',
  'settings.openchamber.tools.browserDebugPort.copy': 'ブラウザー URL をコピー',
  'settings.openchamber.tools.browserDebugPort.copied': 'ブラウザー URL をコピーしました',
  'settings.openchamber.tools.browserDebugPort.copyFailed': 'ブラウザー URL をコピーできませんでした。',
  'settings.openchamber.tools.browserDebugPort.connectionInfo': 'このループバックアドレスはサーバーマシンのものです。そのマシンで --browserUrl を指定して MCP を実行するか、ご自身で SSH トンネルを設定してください。MCP の直接接続では「制御を引き継ぐ」は使用されません。',
