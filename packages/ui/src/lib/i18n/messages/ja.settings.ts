...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.providers.sidebar.actions.reorderProviderTitle': 'ドラッグしてプロバイダーを並べ替え',
  'settings.providers.sidebar.actions.reorderProviderAria': 'プロバイダーを並べ替え',
  'settings.providers.sidebar.actions.enableProvider': '有効にする',
  'settings.providers.sidebar.section.disabled': '無効',
  ...
  'settings.providers.page.actions.disableProvider': '無効にする',
  'settings.providers.page.actions.enableProvider': '有効にする',
  'settings.providers.page.badge.disabled': '無効',
  'settings.providers.page.badge.disabledHint': '有効にするまでモデルセレクターに表示されません。',
