...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.openchamber.visual.section.updates': '更新',
  'settings.openchamber.visual.field.updateChannel': '更新チャンネル',
  'settings.openchamber.visual.field.updateChannelHint': '公式リリースにはStable、プレリリースビルドにはBetaを選択してください',
  'settings.openchamber.visual.toast.switchedChannel': '更新チャンネルを{channel}に変更しました。',
  'settings.openchamber.visual.toast.latestVersionForChannel': '{channel}チャンネルの最新バージョンを使用しています。',
