...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.voice.page.localTts.availableToDownload': 'ダウンロード可能',
  'settings.voice.page.localTts.filterPlaceholder': '言語または説明で絞り込み',
  'settings.voice.page.localTts.filterNoMatch': '条件に一致するモデルはありません',
