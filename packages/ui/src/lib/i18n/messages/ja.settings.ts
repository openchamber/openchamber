...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.voice.page.field.ttsChunkedMode': 'TTS チャンクモード',
  'settings.voice.page.field.ttsChunkedModeAria': 'TTS チャンクモード',
  'settings.voice.page.tooltip.ttsChunked': '長いテキストを文に分割し、合成が終わった順に再生します。再生開始が大幅に早くなります。オフにすると、テキスト全体を 1 回のリクエストで合成します。',
