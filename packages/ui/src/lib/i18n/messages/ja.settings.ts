...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'ollama.com のブラウザー開発者ツールのリクエストヘッダーから完全な Cookie ヘッダーをコピーして、ここに貼り付けてください。保存・送信されるのはセッション Cookie のみです：wos-session=...（古いアカウントでは __Secure-session=... の場合があります）。ヘッダー内の他の Cookie は転送されません。これはローカルの Ollama API キーやエンドポイントではありません。OpenChamber がブラウザーの Cookie 保存領域を走査することはありません。',
  'settings.providers.page.ollamaCloud.cookie': 'Cookie ヘッダー',
