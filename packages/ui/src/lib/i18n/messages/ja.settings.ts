...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.openchamber.visual.field.activityColorCoding': 'ツールとアクティビティを色分け',
  'settings.openchamber.visual.field.activityColorCodingAria': 'ツールとアクティビティの行を色分け',
  'settings.openchamber.visual.field.activityColorCodingHint': 'ファイル編集、シェルコマンド、検索、思考など、ツールとアクティビティの行にテーマのアクセントカラーを割り当てます。オフにすると単一のニュートラルな色になります。',
