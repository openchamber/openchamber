...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.voice.page.field.browserMicrophonePermission': 'チャットでマイクボタンを押したとき、ブラウザーから許可を求められたらマイクへのアクセスを許可してください。確認が表示されない場合やアクセスがブロックされている場合は、アドレスバーの横からサイトの設定を開き、マイクを許可してからページを再読み込みし、もう一度お試しください。',
