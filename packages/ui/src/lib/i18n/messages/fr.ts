...
export const dict = {
  ...settingsDict,
  'contextPanel.mode.agentBrowser': 'Navigateur agent',
  'contextRail.surface.agentBrowser.description': 'Navigateur en direct piloté par l’agent',
  'agentBrowser.viewport.desktop': 'Bureau',
  'agentBrowser.viewport.laptop': 'Portable',
  'agentBrowser.viewport.tablet': 'Tablette',
  'agentBrowser.viewport.mobile': 'Mobile',
  'agentBrowser.actions.newTab': 'Nouvel onglet',
  'agentBrowser.actions.reload': 'Recharger',
  'agentBrowser.actions.go': 'Aller',
  'agentBrowser.actions.screenshot': 'Capturer une capture d’écran',
  'agentBrowser.actions.startRecording': 'Démarrer l’enregistrement',
  'agentBrowser.actions.stopRecording': 'Arrêter l’enregistrement',
  'agentBrowser.recording.active': 'Enregistrement',
  'agentBrowser.urlBar.placeholder': 'Saisissez une URL à ouvrir',
  'agentBrowser.tab.untitled': 'Nouvel onglet',
  'agentBrowser.tab.close': 'Fermer l’onglet',
  'agentBrowser.preview.aria': 'Aperçu du navigateur en direct',
  'agentBrowser.preview.waitingFrame': 'En attente de la première image…',
  'agentBrowser.preview.connecting': 'Connexion au navigateur…',
  'agentBrowser.empty.noTabs': 'Aucun onglet ouvert',
  ...
  'agentBrowser.control.agentActive': 'L’agent contrôle',
  'agentBrowser.takeover.title': 'Prendre le contrôle du navigateur\u00a0?',
  'agentBrowser.takeover.description': 'Un agent utilise actuellement le navigateur. Prendre le contrôle arrêtera cet agent.',
  'agentBrowser.takeover.confirm': 'Prendre le contrôle',
  'agentBrowser.takeover.cancel': 'Annuler',
