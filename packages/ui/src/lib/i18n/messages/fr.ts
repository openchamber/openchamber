...
export const dict = {
  ...
  'walkthrough.scope.basePickerTitle': 'Choisir une branche de base',
  'walkthrough.scope.basePickerDescription': 'Parcourez les modifications de cette branche par rapport à une base de votre choix.',
  'walkthrough.scope.changeBase': 'Changer de branche de base...',
