...
export const dict = {
  ...
  'chat.workStatus.telemetry.speed': 'Vitesse de génération',
  'chat.workStatus.telemetry.llmDuration': 'Durée LLM',
  'chat.workStatus.telemetry.toolDuration': 'Durée des outils',
  'chat.workStatus.telemetry.ttft': 'Temps jusqu’au premier jeton',
  'chat.workStatus.telemetry.steps': 'Étapes du tour',
  'chat.workStatus.telemetry.tokens': 'Jetons',
  'chat.workStatus.telemetry.cacheHit': 'Taux d’accès au cache',
  'chat.workStatus.telemetry.cost': 'Coût du tour',
