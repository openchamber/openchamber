...
export const dict = {
  ...
  'chat.agentCapabilities.fusion.pickerLoadError': 'Impossible de charger les presets de fusion.',
  'chat.agentCapabilities.fusion.pickerEmpty': 'Aucun preset de fusion. Créez-en un dans Paramètres → Fusion.',
  'chat.agentCapabilities.fusion.keyboardHint': '↑↓ naviguer • Entrée sélectionner • Échap fermer',
  'chat.agentCapabilities.inline.waitingChildren': 'En attente du démarrage des sessions enfants…',
