...
export const dict = {
  ...
  'sessions.sidebar.dialogs.worktreeDelete.disposition.label': 'Sessions liées',
  'sessions.sidebar.dialogs.worktreeDelete.disposition.archive': 'Archiver les sessions liées',
  'sessions.sidebar.dialogs.worktreeDelete.disposition.delete': 'Supprimer définitivement les sessions liées',
  'sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionOneLinked': 'Cela supprime le worktree sélectionné et efface définitivement {count} session liée.',
  'sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionManyLinked': 'Cela supprime le worktree sélectionné et efface définitivement les {count} sessions liées.',
