...
export const dict = {
  ...
  'contextRail.surface.git.description': 'Examiner les modifications, committer et synchroniser',
  ...
  'contextPanel.actions.backToChanges': 'Retour aux modifications',
  ...
  'helpDialog.item.openRightSidebarGitTab': 'Ouvrir la surface Modifications',
