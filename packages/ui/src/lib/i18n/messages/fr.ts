...
export const dict = {
  ...
  'workspace.move.left': 'Déplacer à gauche',
  ...
  'workspace.zone.label.right': 'Zone de droite',
  'workspace.zone.label.bottom': 'Zone du bas',
  'workspace.zone.resize.left': 'Redimensionner la zone de gauche',
  'workspace.zone.resize.bottom': 'Redimensionner la zone du bas',
  'workspace.preset.title': 'Disposition',
  'workspace.preset.default': 'Par défaut',
  'workspace.preset.developer': 'Développeur',
  'workspace.preset.codeAgent': 'Code + agent',
  'workspace.preset.reset': 'Réinitialiser la disposition',
} as const;
