...
export const dict = {
  ...
  'chat.message.speed.input': 'ent {value}',
  'chat.message.speed.cacheRead': 'cache {value}',
  'chat.message.speed.cacheWrite': 'écriture cache {value}',
  'chat.message.speed.output': 'sort {value}',
  'chat.message.speed.reasoning': 'raisonnement {value}',
  'chat.message.speed.aria': 'Vitesse du message : {ttft} jusqu’au premier jeton, {throughput} jetons par seconde, {input} entrée non mise en cache, {cache} lecture du cache, {output} sortie',
