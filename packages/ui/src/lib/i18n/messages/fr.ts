...
export const dict = {
  ...
  'gitView.sync.pullRebase': 'Tirer (rebase)',
  'gitView.sync.pullRebaseBlocked': 'Validez ou cachez vos modifications avant de tirer',
  ...
  'diffView.change.conflicted': 'Fichier en conflit',
