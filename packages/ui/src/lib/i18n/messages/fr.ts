...
export const dict = {
  ...
  'gitView.history.actions.conflictToastDescription': 'Conflits dans : {files}. Résolvez manuellement et validez, ou utilisez le bouton Abandonner dans la bannière d\'opération.',
  'gitView.history.actions.conflictToastTitle': 'Conflit',
  'gitView.history.actions.unknownFiles': 'fichiers inconnus',
  ...
  'gitView.history.actions.resetHard': 'Reset (hard)',
  'gitView.history.actions.resetHardConfirm': 'Réinitialisation matérielle - HEAD se déplace, toutes les modifications non validées sont définitivement supprimées.',
   ...
   'gitView.history.actions.resetHardDirtyTitle': 'Ignorer les modifications non validées?',
   'gitView.history.actions.resetHardDirtyDescription': 'L\'arborescence de travail contient des modifications non validées. La réinitialisation en dur les supprimera définitivement.',
   'gitView.history.actions.resetHardDirtyConfirmButton': 'Ignorer et réinitialiser',
  'gitView.history.actions.resetMixed': 'Reset (mixed)',
  'gitView.history.actions.resetMixedConfirm': 'Réinitialisation mixte - HEAD bouge, change hors index.',
  'gitView.history.actions.resetSoft': 'Reset (soft)',
  ...
  'gitView.graph.localBranches': 'Branches locales',
  'gitView.graph.tags': 'Tags',
  'gitView.graph.manualSelection': 'Sélectionnez les références à inclure dans le graphique.',
  'gitView.graph.incomingChanges': 'Modifications entrantes',
  'gitView.graph.outgoingChanges': 'Modifications sortantes',
  'gitView.graph.outdated': 'L’historique du graphique est obsolète. Actualisez-le.',
  'gitView.graph.mergeBaseLookupFailed': 'Impossible de comparer les changements entrants et sortants pour ce graphique.',
  'gitView.graph.resizeAria': 'Redimensionner le panneau du graphique',
  'gitView.preview.overlayAnnouncement': 'Aperçu du diff ouvert. Appuyez sur Échap pour le fermer.',
  'gitView.preview.resizeAria': 'Redimensionner l’aperçu du diff',
  'gitView.preview.submodulePointer': 'Pointeur de sous-module',
  'gitView.preview.tooLargeDescription': 'Ce diff fait {totalSize} et dépasse la limite d’aperçu de {maxSize}.',
  ...
  'gitView.operation.mergingMessage': 'Fusion : {message}',
   ...
   'gitView.operation.cherryPickInProgress': 'Cherry-pick en cours',
   'gitView.operation.revertInProgress': 'Revert en cours',
  ...
  'gitView.toast.generateCommitMessageFailed': 'Échec de la génération du message de commit',
   ...
   'gitView.toast.cherryPickCompleted': 'Cherry-pick terminé',
   'gitView.toast.cherryPickAborted': 'Cherry-pick interrompu',
   'gitView.toast.cherryPickConflictsDetected': 'Conflits de cherry-pick détectés',
   'gitView.toast.revertCompleted': 'Revert terminé',
   'gitView.toast.revertAborted': 'Revert interrompu',
   'gitView.toast.revertConflictsDetected': 'Conflits de revert détectés',
  ...
  'diffView.actions.backToChat': 'Retour à la discussion',
  ...
  'gitView.history.actions.createBranchEllipsis': 'Créer une branche…',
  'gitView.history.actions.createTagConfirm': 'Créer',
  'gitView.history.actions.createTagEllipsis': 'Créer un tag…',
  'gitView.history.actions.createTagPlaceholder': 'Nom du tag',
  'gitView.history.actions.checkoutDetached': 'Checkout (détaché)',
  'gitView.history.actions.compareWithMergeBase': 'Comparer avec la base de fusion',
  'gitView.history.actions.compareWithRef': 'Comparer avec…',
  'gitView.history.actions.compareWithRemote': 'Comparer avec le remote',
  'gitView.history.actions.comparingWith': 'Comparaison avec {name}',
  'gitView.history.actions.copyMessage': 'Copier le message du commit',
  'gitView.history.actions.clearComparison': 'Effacer la comparaison',
  'gitView.history.actions.openChanges': 'Ouvrir les modifications',
  'gitView.toast.commitMessageCopied': 'Message du commit copié',
  'gitView.toast.tagCreated': 'Tag {name} créé',
  'gitView.graph.mergeBaseLabel': 'base de fusion',
} as const;
