...
export const dict = {
  ...
  'dockerInstances.title': 'Instances Docker',
  'dockerInstances.description': 'Créez et gérez des instances OpenCode exécutées dans des conteneurs Docker sur cette machine.',
  'dockerInstances.state.creating': 'Création',
  'dockerInstances.state.starting': 'Démarrage',
  'dockerInstances.state.probing': 'En attente de disponibilité',
  'dockerInstances.state.running': 'En cours',
  'dockerInstances.state.stopped': 'Arrêtée',
  'dockerInstances.state.error': 'Erreur',
  'dockerInstances.state.removing': 'Suppression',
  'dockerInstances.state.removalFailed': 'Échec du nettoyage',
  'dockerInstances.state.empty': 'Aucune instance Docker pour le moment.',
  'dockerInstances.state.loadFailed': 'Impossible de charger les instances Docker.',
  'dockerInstances.actions.addDocker': 'Ajouter une instance Docker',
  'dockerInstances.actions.switchAria': 'Passer à {name}',
  'dockerInstances.actions.stop': 'Arrêter',
  'dockerInstances.actions.start': 'Démarrer',
  'dockerInstances.actions.cleanup': 'Réessayer le nettoyage',
  'dockerInstances.actions.remove': 'Supprimer',
  'dockerInstances.actions.confirmRemove': 'Confirmer la suppression',
  'dockerInstances.actions.openAria': 'Ouvrir les instances Docker',
  'dockerInstances.create.title': 'Nouvelle instance Docker',
  'dockerInstances.create.description': 'OpenChamber crée un conteneur, y démarre OpenCode et attend qu\'il soit prêt.',
  'dockerInstances.create.field.label': 'Nom',
  'dockerInstances.create.field.labelPlaceholder': 'Nom d\'affichage facultatif',
  'dockerInstances.create.field.image': 'Image',
  'dockerInstances.create.field.workspace': 'Chemin de l\'espace de travail',
  ...
  'dockerInstances.create.sharing.credentialsTitle': 'Partager les identifiants',
  'dockerInstances.create.sharing.credentialsHint': 'Lecture seule, désactivé par défaut. Les données de connexion des fournisseurs deviennent visibles dans le conteneur.',
  'dockerInstances.create.sharing.neverShared': 'Jamais partagés : socket Docker, clés SSH, identifiants git. Les ports sont liés à cette machine uniquement.',
  'dockerInstances.create.actions.buildImage': 'Compiler {image}',
  'dockerInstances.create.actions.cancel': 'Annuler',
  'dockerInstances.create.actions.create': 'Créer l\'instance',
  'dockerInstances.create.actions.creating': 'Création…',
  'dockerInstances.create.error.generic': 'Impossible de créer l\'instance.',
  'dockerInstances.create.toast.created': 'Instance Docker créée.',
  'dockerInstances.create.toast.imageBuilt': 'L\'image {image} est prête.',
  'dockerInstances.toast.activated': 'Passé à {name}.',
  'dockerInstances.toast.deactivated': 'Retour à l\'instance locale.',
