...
export const dict = {
  ...
  'chat.queuedMessage.admissionPending': 'Envoi au serveur…',
  'chat.queuedMessage.admitted': 'En file sur le serveur · fermeture possible',
  'chat.queuedMessage.localFallback': 'File locale · gardez le client ouvert',
  'chat.queuedMessage.admissionFailed': 'Échec de l’admission',
  'chat.queuedMessage.admissionUnknown': 'Résultat inconnu · risque de doublon, ne réessayez pas',
  'chat.queuedMessage.retryAdmission': 'Réessayer l’admission',
  'chat.queuedMessage.restore': 'Déplacer vers le composeur',
  'chat.queuedMessage.copy': 'Copier le texte',
  'chat.queuedMessage.dismiss': 'Ignorer',
  'chat.queuedMessage.copyFailed': 'Impossible de copier le texte du message',
  'chat.queuedMessage.selectionLimitation': 'L’admission serveur utilise les réglages actuels de modèle, d’agent et de variante de la session',
