...
export const dict = {
  ...
  'chat.messageBody.startFromAnswerDialog.instructions.placeholder': 'Ajouter des instructions pour la nouvelle session…',
  'chat.messageBody.startFromAnswerDialog.createWorktree': 'Créer un worktree',
