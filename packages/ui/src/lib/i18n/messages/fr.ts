...
export const dict = {
  ...
  'layout.notifications.openAria': 'Notifications',
  'layout.notifications.openTitle': 'Notifications',
  'layout.notifications.title': 'Notifications',
  'layout.notifications.empty': 'Aucune notification pour l\'instant',
  'layout.notifications.emptyFiltered': 'Rien ne correspond aux filtres actuels',
  'layout.notifications.markAllRead': 'Tout marquer comme lu',
  'layout.notifications.clearAll': 'Tout effacer',
  'layout.notifications.remove': 'Retirer la notification',
  'layout.notifications.sessionSubtaskFinished': 'Sous-tâche terminée',
  'layout.notifications.sessionSubtaskError': 'Erreur de sous-tâche',
  'layout.notifications.openSettings': 'Réglages des notifications',
  'layout.notifications.unreadCountAria': '{count} notifications non lues',
  'layout.notifications.sessionFinished': 'Session terminée',
  'layout.notifications.sessionError': 'Erreur de session',
  'layout.notifications.permissionNeeded': 'Autorisation requise',
  'layout.notifications.permissionFallback': 'L\'agent a besoin de votre accord',
  'layout.notifications.inputNeeded': 'Réponse requise',
  'layout.notifications.questionFallback': 'L\'agent attend votre réponse',
  'layout.notifications.openSession': 'Ouvrir la session',
  'layout.notifications.occurrenceCount': '×{count}',
  'layout.notifications.time.justNow': 'À l\'instant',
  'layout.notifications.time.minutesAgo': '{count} min',
  'layout.notifications.time.hoursAgo': '{count} h',
  'layout.notifications.time.daysAgo': '{count} j',
  'toast.action.ok': 'OK',
  'toast.action.copy': 'Copier',
