...
export const dict = {
  ...
  'chat.chatInput.actions.enhancePromptAria': 'Améliorer le prompt',
  'chat.chatInput.actions.enhancePromptCancel': 'Annuler l’amélioration du prompt',
  ...
  'chat.chatInput.toast.enhanceUnavailable': 'Aucun petit modèle n\'est disponible pour améliorer le prompt. Choisissez-en un dans Réglages → Sessions → Petit modèle.',
  'chat.chatInput.toast.enhanceContextTooSmall': 'Le prompt est trop long pour le contexte du petit modèle. Raccourcissez-le ou joignez-le sous forme de fichier.',
  'chat.chatInput.toast.enhanceEmptyResult': 'Le petit modèle a renvoyé un prompt vide. Réessayez.',
  'chat.chatInput.toast.enhanceInvalidResult': 'Le prompt amélioré modifierait vos références @, / ou #. Le brouillon est resté inchangé.',
  'chat.chatInput.toast.enhanceTimedOut': 'L’amélioration du prompt a expiré. Réessayez.',
