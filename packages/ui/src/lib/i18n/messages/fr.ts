...
export const dict = {
  ...
  'contextRail.surface.server-browser.description': 'Chrome exécuté sur le serveur',
  ...
  'contextPanel.browser.newServerTab': 'Nouvel onglet du navigateur serveur',
  'contextPanel.browser.remote.tabLabel': 'Navigateur serveur',
  'contextPanel.browser.remote.sessionsMenu': 'Sessions du navigateur',
  'contextPanel.browser.remote.savedSessions': 'Sessions enregistrées',
  'contextPanel.browser.remote.availableSessions': 'Sessions en cours',
  'contextPanel.browser.remote.openDevTools': 'Ouvrir Chrome DevTools',
  'contextPanel.browser.remote.contextMenuUnavailable': 'Les actions du navigateur ne sont pas disponibles pour ce clic. Utilisez la barre d’outils ou les boutons du presse-papiers.',
  'contextPanel.browser.remote.devTools': 'Chrome DevTools',
  'contextPanel.browser.remote.simpleInspector': 'Console et réseau',
  'contextPanel.browser.remote.inspectMode': 'Mode d\'inspection',
  'contextPanel.browser.remote.maximizeInspector': 'Agrandir l\'inspecteur',
  'contextPanel.browser.remote.restoreInspector': 'Rétablir la page et l\'inspecteur',
  'contextPanel.browser.remote.resizeInspector': 'Redimensionner l\'inspecteur',
  'contextPanel.browser.remote.devtoolsLoading': 'Connexion de Chrome DevTools…',
  'contextPanel.browser.remote.devtoolsLoadFailed': 'Impossible de charger Chrome DevTools.',
  'contextPanel.browser.remote.devtoolsRetry': 'Reconnecter DevTools',
  'contextPanel.browser.remote.devtoolsControlLost': 'Un autre client a pris le contrôle. Reconnectez-vous pour continuer l\'inspection.',
  'contextPanel.browser.remote.devtoolsConnectionClosed': 'La connexion à DevTools est fermée.',
  'contextPanel.browser.remote.devtoolsMessageTooLarge': 'Un message DevTools a dépassé la taille maximale.',
  'contextPanel.browser.remote.devtoolsBackpressure': 'DevTools n\'a pas pu suivre le rythme de la connexion. Reconnectez-vous pour continuer.',
  'contextPanel.browser.remote.devtoolsInvalidRequest': 'La connexion à DevTools a reçu un message non valide.',
  'contextPanel.browser.remote.devtoolsProtocolRejected': 'Cette action DevTools n\'est pas disponible pour cette page.',
  'contextPanel.browser.remote.devtoolsExclusive': 'L\'enregistrement des performances exige que cette session du navigateur soit la seule en cours.',
  'contextPanel.browser.remote.devtoolsStartFailed': 'Impossible d\'ouvrir DevTools pour cette page.',
  'contextPanel.browser.remote.connecting': 'Connexion au navigateur serveur en cours…',
  'contextPanel.browser.remote.reconnecting': 'Connexion perdue. Reconnexion…',
  'contextPanel.browser.remote.chooseTitle': 'Sessions du navigateur serveur',
  'contextPanel.browser.remote.chooseHint': 'Attachez-vous à une session en cours ou démarrez une nouvelle session.',
  'contextPanel.browser.remote.newSession': 'Nouvelle session',
  'contextPanel.browser.remote.noSessions': 'Aucune session serveur en exécution pour ce projet.',
  'contextPanel.browser.remote.sessionEphemeral': 'Session de l’agent',
  'contextPanel.browser.remote.sessionProject': 'Session du projet',
  'contextPanel.browser.remote.errorTitle': 'Le navigateur serveur est indisponible',
  'contextPanel.browser.remote.endedTitle': 'Cette session du navigateur serveur est terminée',
  'contextPanel.browser.remote.retry': 'Réessayer',
  'contextPanel.browser.remote.canvasAria': 'Vue de la page distante',
  'contextPanel.browser.remote.keyboard': 'Écrire dans la page',
  'contextPanel.browser.remote.textInputAria': 'Saisie de texte pour la page distante',
  'contextPanel.browser.remote.clipboard.copy': 'Copier',
  'contextPanel.browser.remote.clipboard.paste': 'Coller',
  'contextPanel.browser.remote.clipboard.copied': 'Copié dans votre presse-papiers',
  'contextPanel.browser.remote.clipboard.pasted': 'Collé dans la page',
  'contextPanel.browser.remote.clipboard.noSelection': 'Sélectionnez du texte sur la page pour le copier.',
  'contextPanel.browser.remote.clipboard.copyFailed': 'Impossible de copier la sélection. Réessayez.',
  'contextPanel.browser.remote.clipboard.pasteFailed': 'Impossible de coller dans la page. Réessayez.',
  'contextPanel.browser.remote.clipboard.tooLarge': 'Ce texte est trop volumineux pour être transféré.',
  'contextPanel.browser.remote.clipboard.copyFallbackTitle': 'Copier le texte sélectionné',
  'contextPanel.browser.remote.clipboard.copyFallbackDescription': 'L\'accès au presse-papiers est indisponible. Sélectionnez et copiez le texte ci-dessous.',
  'contextPanel.browser.remote.clipboard.copyTextAria': 'Texte sélectionné sur la page',
  'contextPanel.browser.remote.clipboard.pasteFallbackTitle': 'Coller dans la page',
  'contextPanel.browser.remote.clipboard.pasteFallbackDescription': 'Collez du texte brut ci-dessous, puis envoyez-le à la page.',
  'contextPanel.browser.remote.clipboard.pasteTextAria': 'Texte à coller dans la page',
  'contextPanel.browser.remote.clipboard.emptyClipboard': 'Votre presse-papiers ne contient pas de texte brut.',
  'contextPanel.browser.remote.clipboard.cancel': 'Annuler',
  'contextPanel.browser.remote.viewport.auto': 'Automatique',
  'contextPanel.browser.remote.viewport.preset': 'Préréglage de la zone d\'affichage',
  'contextPanel.browser.remote.viewport.custom': 'Personnalisé',
  'contextPanel.browser.remote.viewport.width': 'Largeur',
  'contextPanel.browser.remote.viewport.height': 'Hauteur',
  'contextPanel.browser.remote.viewport.rotate': 'Pivoter',
  'contextPanel.browser.remote.viewport.mobile': 'Émuler un appareil mobile',
  'contextPanel.browser.remote.viewport.scale': 'Échelle d\'affichage',
  'contextPanel.browser.remote.viewport.pending': 'Application de la zone d\'affichage…',
  'contextPanel.browser.remote.viewport.error': 'Échec du redimensionnement de la zone d\'affichage : {code}',
  'contextPanel.browser.remote.viewport.agentControlled': 'L\'agent contrôle cette zone d\'affichage',
  'contextPanel.browser.remote.viewport.external': 'Les DevTools externes contrôlent cette zone d\'affichage',
  'contextPanel.browser.remote.viewport.dimensionsConfirmed': 'Confirmé : {width} × {height}',
  'contextPanel.browser.remote.inspector.title': 'Inspecteur de page',
  'contextPanel.browser.remote.inspector.open': 'Ouvrir l\'inspecteur de page',
  'contextPanel.browser.remote.inspector.close': 'Fermer l\'inspecteur',
  'contextPanel.browser.remote.inspector.console': 'Console',
  'contextPanel.browser.remote.inspector.network': 'Réseau',
  'contextPanel.browser.remote.inspector.clear': 'Effacer',
  'contextPanel.browser.remote.inspector.filterPlaceholder': 'Filtrer les messages ou les requêtes',
  'contextPanel.browser.remote.inspector.filterAria': 'Filtrer les entrées de l\'inspecteur',
  'contextPanel.browser.remote.inspector.capturing': 'Capture de cet onglet en cours',
  'contextPanel.browser.remote.inspector.starting': 'Démarrage de la capture',
  'contextPanel.browser.remote.inspector.captureHint': 'La capture commence à l\'ouverture de l\'inspecteur. Le fermer efface les données capturées.',
  'contextPanel.browser.remote.inspector.dropped': 'Entrées omises : {count}',
  'contextPanel.browser.remote.inspector.emptyConsole': 'Les messages de la console apparaîtront ici.',
  'contextPanel.browser.remote.inspector.filteredEmpty': 'Aucune entrée correspondante.',
  'contextPanel.browser.remote.inspector.expressionAria': 'JavaScript à exécuter dans la page',
  'contextPanel.browser.remote.inspector.expressionPlaceholder': 'Exécuter du JavaScript dans la page',
  'contextPanel.browser.remote.inspector.run': 'Exécuter',
  'contextPanel.browser.remote.inspector.running': 'Exécution en cours',
  'contextPanel.browser.remote.inspector.previousCommand': 'Commande précédente',
  'contextPanel.browser.remote.inspector.nextCommand': 'Commande suivante',
  'contextPanel.browser.remote.inspector.shortcutHint': 'Ctrl/Cmd+Enter pour exécuter. Enter ajoute une nouvelle ligne.',
  'contextPanel.browser.remote.inspector.truncated': 'Tronqué',
  'contextPanel.browser.remote.inspector.errorUnavailable': 'L\'inspecteur de page est indisponible. Rouvrez-le pour réessayer.',
  'contextPanel.browser.remote.inspector.errorInvalid': 'Saisissez du JavaScript de 16 000 caractères maximum.',
  'contextPanel.browser.remote.inspector.errorCaptureGone': 'La capture est terminée. Rouvrez l\'inspecteur pour recommencer.',
  'contextPanel.browser.remote.inspector.errorEvaluation': 'Impossible d\'exécuter le JavaScript. Réessayez.',
  'contextPanel.browser.remote.inspector.errorTimeout': 'Le délai d\'exécution du JavaScript est dépassé. La page peut encore être en train de l\'exécuter.',
  'contextPanel.browser.remote.inspector.errorRequestGone': 'Cette requête n\'est plus disponible.',
  'contextPanel.browser.remote.inspector.errorRequest': 'Impossible de charger cette requête. Réessayez.',
  'contextPanel.browser.remote.inspector.errorCapture': 'Impossible de démarrer la capture. Rouvrez l\'inspecteur pour réessayer.',
  'contextPanel.browser.remote.inspector.resultAria': 'Résultat JavaScript',
  'contextPanel.browser.remote.inspector.commandAria': 'JavaScript exécuté',
  'contextPanel.browser.remote.inspector.level.debug': 'Débogage',
  'contextPanel.browser.remote.inspector.level.info': 'Information',
  'contextPanel.browser.remote.inspector.level.log': 'Journal',
  'contextPanel.browser.remote.inspector.level.warning': 'Avertissement',
  'contextPanel.browser.remote.inspector.level.error': 'Erreur',
  'contextPanel.browser.remote.inspector.network.empty': 'Aucune requête capturée pour l\'instant.',
  'contextPanel.browser.remote.inspector.network.noMatches': 'Aucune requête ne correspond à ce filtre.',
  'contextPanel.browser.remote.inspector.network.selectRequest': 'Sélectionnez une requête pour l\'inspecter.',
  'contextPanel.browser.remote.inspector.network.details': 'Détails de la requête',
  'contextPanel.browser.remote.inspector.network.closeDetails': 'Fermer les détails de la requête',
  'contextPanel.browser.remote.inspector.network.loading': 'Chargement des détails de la requête',
  'contextPanel.browser.remote.inspector.network.loadBodies': 'Charger les corps',
  'contextPanel.browser.remote.inspector.network.requestHeaders': 'En-têtes de la requête',
  'contextPanel.browser.remote.inspector.network.responseHeaders': 'En-têtes de la réponse',
  'contextPanel.browser.remote.inspector.network.requestBody': 'Corps de la requête',
  'contextPanel.browser.remote.inspector.network.responseBody': 'Corps de la réponse',
  'contextPanel.browser.remote.inspector.network.noHeaders': 'Aucun en-tête disponible.',
  'contextPanel.browser.remote.inspector.network.noBody': 'Aucun corps disponible.',
  'contextPanel.browser.remote.inspector.network.bodiesNotRequested': 'Les corps ne sont chargés qu\'à votre demande.',
  'contextPanel.browser.remote.inspector.network.bodiesUnavailable': 'Les corps ne sont plus disponibles pour cette requête.',
  'contextPanel.browser.remote.inspector.network.bodiesUnsupported': 'L\'aperçu du corps n\'est pas pris en charge pour cette réponse.',
  'contextPanel.browser.remote.inspector.network.truncated': 'Aperçu tronqué.',
  'contextPanel.browser.remote.inspector.network.method': 'Méthode',
  'contextPanel.browser.remote.inspector.network.url': 'URL',
  'contextPanel.browser.remote.inspector.network.status': 'Statut',
  'contextPanel.browser.remote.inspector.network.duration': 'Durée',
  'contextPanel.browser.remote.inspector.network.size': 'Transféré',
  'contextPanel.browser.remote.inspector.network.state': 'État',
  'contextPanel.browser.remote.inspector.network.cached': 'Depuis le cache',
  'contextPanel.browser.remote.inspector.network.failure': 'Échec',
  'contextPanel.browser.remote.inspector.network.resourceType': 'Type',
  'contextPanel.browser.remote.inspector.network.mimeType': 'Type de contenu',
  'contextPanel.browser.remote.inspector.network.pending': 'En attente',
  'contextPanel.browser.remote.inspector.network.complete': 'Terminée',
  'contextPanel.browser.remote.inspector.network.failed': 'Échec',
  'contextPanel.browser.remote.inspector.network.unknown': 'Indisponible',
  'contextPanel.browser.remote.inspector.network.yes': 'Oui',
  'contextPanel.browser.remote.inspector.network.no': 'Non',
  'contextPanel.browser.remote.inspector.network.failedDetails': 'Impossible de charger les détails de la requête. Réessayez.',
  'contextPanel.browser.remote.inspector.network.requestGone': 'Cette requête n\'est plus disponible.',
  'contextPanel.browser.remote.inspector.network.captureGone': 'Cette capture est terminée.',
  ...
  'contextPanel.browser.agentControlling': 'Agent en contrôle',
