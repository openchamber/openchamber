...
export const dict = {
  ...
  'header.connection.status.connected': 'Connecté',
  'header.connection.status.connecting': 'Connexion…',
  'header.connection.status.reconnecting': 'Reconnexion…',
  'header.connection.actions.retry': 'Cliquer pour réessayer',
