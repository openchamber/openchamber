...
export const dict = {
  ...
  'gitView.empty.nestedRepositoriesFound': 'Des dépôts Git imbriqués ont été trouvés dans ce dossier',
  'gitView.empty.selectRepositoryPlaceholder': 'Sélectionner un dépôt...',
  'gitView.nestedRepos.pickerLabel': 'Dépôt Git',
