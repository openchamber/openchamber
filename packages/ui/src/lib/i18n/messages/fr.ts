...
export const dict = {
  ...
  'usage.status.quotaExhausted': 'Quota épuisé',
  'usage.status.expired': 'Clé API expirée',
  'usage.statistics.title': 'Statistiques d\'utilisation',
  'usage.statistics.info': 'Les statistiques de modèles couvrent les 30 derniers jours.',
  'usage.statistics.requests': 'Requêtes',
  'usage.statistics.inputTokens': 'Jetons d\'entrée',
  'usage.statistics.outputTokens': 'Jetons de sortie',
  'usage.statistics.cacheReadTokens': 'Jetons de cache lus',
  'usage.statistics.totalTokens': 'Jetons totaux',
  'usage.statistics.actualCost': 'Coût',
  'usage.statistics.today': 'Aujourd\'hui',
  'usage.statistics.total': 'Total',
  'usage.statistics.empty': 'Aucune statistique d\'utilisation signalée.',
