...
export const dict = {
  ...
  'chat.messageBody.metrics.ttftInfo': 'Temps jusqu’au premier token : durée avant que le modèle ne commence à répondre après la requête.',
  'chat.messageBody.metrics.tokensPerSecond': '{rate} tok/s',
  'chat.messageBody.metrics.tokensPerSecondInfo': 'Tokens de sortie par seconde de décodage en streaming, hors exécution des outils.',
