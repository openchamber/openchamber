...
export const dict = {
  ...
  'filesView.tree.actions.uploadTitle': 'Importer des fichiers',
  'filesView.tree.drop.uploadHint': 'Déposez des fichiers pour les importer',
  'filesView.toast.uploadSuccess': '{count} fichiers importés',
  'filesView.toast.uploadSuccessSingle': '{name} importé',
  'filesView.toast.uploadFailed': 'Échec de l\'import de {count} fichiers',
  'filesView.toast.uploadFailedSingle': 'Échec de l\'import de {name}',
