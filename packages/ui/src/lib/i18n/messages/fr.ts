...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Installez Sharpie pour un accès plus rapide',
  'pwa.installPrompt.action': 'Installer',
  'pwa.installPrompt.dismiss': 'Ignorer',
  'pwa.installPrompt.started': 'Installation démarrée',
  'pwa.installPrompt.installed': 'Sharpie installé',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'À propos de Sharpie',
  ...
  'walkthrough.blocked.serverUnsupported.description': "Le serveur Sharpie auquel cette application est connectée n'a pas répondu à l'API walkthrough : il est donc plus ancien que l'application. Mettez le serveur à jour en 1.18 ou plus récent, puis actualisez.",
  ...
  'filesView.editor.binaryFileDescription': 'Ce fichier est binaire et ne peut pas être modifié dans Sharpie. Téléchargez-le pour l’ouvrir avec une autre application.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Sharpie doit accéder à ce dossier.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Version Sharpie {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Comprend l’état Sharpie, l’état de santé OpenCode, les répertoires et les projets.',
  ...
  'helpDialog.description': 'Utilisez ces raccourcis clavier pour naviguer efficacement dans Sharpie',
  ...
  'header.actions.openAppMenu': 'Menu de Sharpie',
  'header.actions.openAppMenuAria': 'Ouvrir le menu Sharpie',
  ...
  'sessionAuth.error.networkDescription': 'Nous n\'avons pas pu vérifier la session d\'interface utilisateur. Si vous ouvrez Sharpie depuis un autre appareil sur votre réseau local, activez l\'accès au réseau du bureau dans l\'application de bureau et utilisez l\'adresse LAN indiquée dans les paramètres.',
  ...
  'sessionAuth.locked.unlockTitle': 'Débloquez Sharpie',
  ...
  'desktopHostSwitcher.description': 'Basculer entre les serveurs Sharpie locaux et distants',
  ...
  'multiRun.window.description': 'Fenêtre multi-exécution Sharpie.',
  ...
  'onboarding.chooser.title': 'Bienvenue sur Sharpie',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Si Sharpie ne détecte pas automatiquement OpenCode, définissez le chemin binaire ci-dessous.',
  'onboarding.localSetup.intro': 'OpenCode est le cœur de Sharpie — installez-le pour commencer.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Enregistre dans les paramètres Sharpie et recharge la configuration OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Saisissez l\'adresse d\'un serveur Sharpie auquel vous connecter.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions : vérifiez que l’URL pointe vers un serveur Sharpie ou contactez l\'administrateur du serveur.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Le serveur a répondu mais n\'exécute pas Sharpie. Vérifiez que l\'adresse pointe vers un serveur Sharpie.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Le serveur « {host} » n\'exécute pas Sharpie. Vérifiez que l\'adresse pointe vers un serveur Sharpie.',
  ...
  'startup.initRecovery.description': 'Sharpie n\'a pas pu terminer l\'initialisation. Vérifiez que le serveur est en cours d\'exécution, puis réessayez.',
  ...
  'updateDialog.header.updating': 'Mise à jour de Sharpie...',
  ...
  'mobileUpdate.toast.available.title': 'Mise à jour Sharpie disponible',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Gardez Sharpie ouvert.',
  ...
  'mobile.connect.welcome.title': 'Se connecter à Sharpie',
  ...
  'mobile.connect.password.placeholder': 'Mot de passe Sharpie',
  ...
  'mobile.connect.scan.invalid': 'Ce code QR n\'est pas un code de connexion Sharpie.',
  ...
  'mobile.connect.relay.badge': 'via Sharpie Relay',
  ...
  'mobile.connect.error.unreachable': 'Impossible de joindre ce serveur Sharpie.',
  ...
  'contextPanel.browser.trustNotice': 'Les pages ouvertes ici s’exécutent avec un accès complet à Sharpie — nécessaire pour l’inspection et les captures d’écran. N’ouvrez que des sites de confiance : une page malveillante pourrait lire vos données ou agir en votre nom.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Cette instance utilise une version différente d’Sharpie. Vous pouvez vous connecter, mais mettez les deux applications à jour si quelque chose ne fonctionne pas.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Le serveur exécute Sharpie mais n’est pas compatible avec cette version de l’application. Mettez Sharpie à jour sur le serveur, puis réessayez.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Mise à jour du serveur requise',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Le serveur Sharpie à l’adresse « {host} » n’est pas compatible avec cette version de l’application. Mettez Sharpie à jour sur le serveur, puis réessayez.',
