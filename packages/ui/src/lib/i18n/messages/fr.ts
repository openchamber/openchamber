...
export const dict = {
  ...
  'session.githubIssuePicker.overridesHelper': 'Ces sélections s\'appliquent à cette session (pas à vos paramètres enregistrés)',
  ...
  'session.newWorktree.overridesHelper': 'Ces sélections s\'appliquent à cette session (pas à vos paramètres enregistrés)',
