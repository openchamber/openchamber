...
export const dict = {
  ...
  'gitView.pr.field.headBranch': 'Branche source',
  ...
  'contextPanel.mode.mr': 'Demande de fusion',
  ...
  'contextPanel.gitlabMr.createMr.titleLabel': 'Titre',
  'contextPanel.gitlabMr.createMr.titlePlaceholder': 'Titre de la demande de fusion',
  ...
  'contextPanel.gitlabMr.updateMr.save': 'Enregistrer',
  'contextPanel.gitlabMr.updateMr.saving': 'Enregistrement...',
  'contextPanel.gitlabMr.updateMr.toast.updated': 'Demande de fusion mise à jour',
  'contextPanel.gitlabMr.updateMr.toast.updateFailed': 'Échec de la mise à jour de la demande de fusion',
  'contextPanel.gitlabMr.mergeMr.action': 'Fusionner',
  'contextPanel.gitlabMr.mergeMr.squash': 'Écraser les commits',
  'contextPanel.gitlabMr.mergeMr.merging': 'Fusion en cours...',
  'contextPanel.gitlabMr.mergeMr.toast.merged': 'La demande de fusion a été fusionnée',
  'contextPanel.gitlabMr.mergeMr.toast.mergeFailed': 'Échec de la fusion de la demande de fusion',
  'contextPanel.giteaPr.title': 'PR',
  'contextPanel.giteaPr.tabs.pullRequests': 'PR',
  'contextPanel.giteaPr.tabs.issues': 'Problèmes',
  'contextPanel.giteaPr.branchSectionTitle': 'Branche actuelle',
  'contextPanel.giteaPr.openPrTitle': 'PR ouvertes',
  'contextPanel.giteaPr.listSectionTitle': 'Dans ce dépôt',
  'contextPanel.giteaPr.openPrEmpty': 'Aucune PR ouverte',
  'contextPanel.giteaPr.noPrForBranch': 'Aucune PR pour cette branche',
  'contextPanel.giteaPr.loadContext': 'Charger le contexte',
  'contextPanel.giteaPr.hideContext': 'Masquer le contexte',
  'contextPanel.giteaPr.openInGitea': 'Ouvrir dans Gitea',
  'contextPanel.giteaPr.draft': 'Brouillon',
  'contextPanel.giteaPr.state.opened': 'Ouverte',
  'contextPanel.giteaPr.state.merged': 'Fusionnée',
  'contextPanel.giteaPr.state.closed': 'Fermée',
  'contextPanel.giteaPr.loadMore': 'Charger plus',
  'contextPanel.giteaPr.loading': 'Chargement...',
  'contextPanel.giteaPr.error.loadFailed': 'Échec du chargement des PR',
  'contextPanel.giteaPr.error.notConnected': 'Gitea n\'est pas connecté',
  'contextPanel.giteaPr.empty.noActiveProject': 'Aucun projet actif',
  'contextPanel.giteaPr.actions.openSettings': 'Ouvrir les paramètres',
  'contextPanel.giteaPr.issues.detail.back': 'Retour aux problèmes',
  'contextPanel.giteaPr.issues.detail.commentsEmpty': 'Aucun commentaire',
  'contextPanel.giteaPr.issues.empty': 'Aucun problème ouvert',
  'contextPanel.giteaPr.issues.error.loadFailed': 'Échec du chargement des problèmes',
  'contextPanel.giteaPr.issues.listSectionTitle': 'Problèmes ouverts',
  'contextPanel.giteaPr.createPr.title': 'Nouvelle PR',
  'contextPanel.giteaPr.createPr.sourceBranch': 'Branche source',
  'contextPanel.giteaPr.createPr.targetBranch': 'Branche cible',
  'contextPanel.giteaPr.createPr.titleLabel': 'Titre',
  'contextPanel.giteaPr.createPr.titlePlaceholder': 'Titre de la PR',
  'contextPanel.giteaPr.createPr.descriptionLabel': 'Description',
  'contextPanel.giteaPr.createPr.removeSourceBranch': 'Supprimer la branche source lors de la fusion',
  'contextPanel.giteaPr.createPr.submit': 'Créer une PR',
  'contextPanel.giteaPr.createPr.submitting': 'Création...',
  'contextPanel.giteaPr.createPr.branchesLoading': 'Chargement des branches...',
  'contextPanel.giteaPr.createPr.toast.created': 'PR créée',
  'contextPanel.giteaPr.createPr.toast.createFailed': 'Échec de la création de la PR',
  'contextPanel.giteaPr.updatePr.toggle': 'Modifier le titre et la description',
  'contextPanel.giteaPr.updatePr.save': 'Enregistrer',
  'contextPanel.giteaPr.updatePr.saving': 'Enregistrement...',
  'contextPanel.giteaPr.updatePr.toast.updated': 'PR mise à jour',
  'contextPanel.giteaPr.updatePr.toast.updateFailed': 'Échec de la mise à jour de la PR',
  'contextPanel.giteaPr.mergePr.action': 'Fusionner',
  'contextPanel.giteaPr.mergePr.squash': 'Écraser les commits',
  'contextPanel.giteaPr.mergePr.merging': 'Fusion en cours...',
  'contextPanel.giteaPr.mergePr.toast.merged': 'La PR a été fusionnée',
  'contextPanel.giteaPr.mergePr.toast.mergeFailed': 'Échec de la fusion de la PR',
  ...
  'contextRail.surface.mr.description': 'Créer, relire et fusionner la demande de fusion de la branche actuelle',
  ...
  'session.gitlabIssuePicker.title.createSession': 'Nouvelle session du problème GitLab',
  ...
  'session.gitlabIssuePicker.searchPlaceholder': 'Recherchez par titre ou collez l\'URL du problème',
  ...
  'session.gitlabIssuePicker.loading.issues': 'Chargement des problèmes...',
  'session.gitlabIssuePicker.loading.more': 'Chargement...',
  'session.gitlabIssuePicker.actions.openSettings': 'Ouvrir les paramètres',
  'session.gitlabIssuePicker.actions.useIssue': 'Utilisez le problème #{number}',
  ...
  'session.giteaIssuePicker.error.noActiveProject': 'Aucun projet actif',
  'session.giteaIssuePicker.error.runtimeUnavailable': 'Exécution Gitea API indisponible',
  'session.giteaIssuePicker.error.notConnected': 'Gitea non connecté',
  'session.giteaIssuePicker.error.repoNotResolvable': 'Repo non résoluble',
  'session.giteaIssuePicker.error.repoMustBeGitea': 'Le dépôt distant origin doit pointer vers une URL Gitea',
  'session.giteaIssuePicker.error.issueNotFound': 'Problème introuvable',
  'session.giteaIssuePicker.error.noModelSelected': 'Aucun modèle sélectionné',
  'session.giteaIssuePicker.toast.loadMoreFailed': 'Échec du chargement d\'autres problèmes',
  'session.giteaIssuePicker.toast.loadIssueDetailsFailed': 'Échec du chargement des détails du problème',
  'session.giteaIssuePicker.toast.sendContextFailed': 'Échec de l\'envoi du contexte du problème',
  'session.giteaIssuePicker.toast.sessionCreated': 'Session créée à partir du problème',
  'session.giteaIssuePicker.toast.startSessionFailed': 'Échec du démarrage de la session',
  'session.giteaIssuePicker.title.select': 'Lien vers le problème Gitea',
  'session.giteaIssuePicker.title.createSession': 'Nouvelle session du problème Gitea',
  'session.giteaIssuePicker.description.select': 'Sélectionnez un problème à lier à cette session.',
  'session.giteaIssuePicker.description.createSession': 'Lance une nouvelle session avec un contexte de problème masqué (titre/corps/étiquettes/commentaires).',
  'session.giteaIssuePicker.searchPlaceholder': 'Recherchez par titre ou collez l\'URL du problème',
  'session.giteaIssuePicker.empty.noActiveProject': 'Aucun projet actif sélectionné.',
  'session.giteaIssuePicker.empty.runtimeUnavailable': 'L\'environnement d\'exécution Gitea API n\'est pas disponible.',
  'session.giteaIssuePicker.empty.notConnected': 'Gitea non connecté. Connectez votre compte Gitea dans les paramètres.',
  'session.giteaIssuePicker.empty.noIssuesFound': 'Aucun problème trouvé',
  'session.giteaIssuePicker.empty.noOpenIssuesFound': 'Aucun problème ouvert trouvé',
  'session.giteaIssuePicker.loading.issues': 'Chargement des problèmes...',
  'session.giteaIssuePicker.loading.more': 'Chargement...',
  'session.giteaIssuePicker.actions.openSettings': 'Ouvrir les paramètres',
  'session.giteaIssuePicker.actions.useIssue': 'Utilisez le problème #{number}',
  'session.giteaIssuePicker.actions.openInGiteaAria': 'Ouvrir dans Gitea',
  'session.giteaIssuePicker.actions.loadMore': 'Charger plus',
  'session.giteaIssuePicker.actions.sectionTitle': 'Actions',
  'session.giteaIssuePicker.actions.toggleWorktreeAria': 'Basculer le worktree',
  'session.giteaIssuePicker.actions.createInWorktree': 'Créer dans le worktree',
  'session.giteaIssuePicker.actions.openRepo': 'Ouvrir le dépôt',
  'session.giteaIssuePicker.actions.refresh': 'Rafraîchir',
  ...
  'session.gitlabMrPicker.error.mrNotFound': 'Demande de fusion introuvable',
  ...
  'session.gitlabMrPicker.toast.loadMoreFailed': 'Échec du chargement d\'autres demandes de fusion',
  'session.gitlabMrPicker.toast.loadDetailsFailed': 'Échec du chargement des détails de la demande de fusion',
  'session.gitlabMrPicker.title': 'Lier le MR GitLab',
  'session.gitlabMrPicker.description': 'Sélectionnez un MR pour joindre un contexte de revue à ce message.',
  'session.gitlabMrPicker.searchPlaceholder': 'Recherchez par titre ou collez l\'URL du MR',
  'session.gitlabMrPicker.includeDiffAria': 'Inclure le diff du MR dans le contexte ci-joint',
  'session.gitlabMrPicker.includeDiff': 'Inclure le diff du MR',
  ...
  'session.gitlabMrPicker.empty.noMergeRequestsFound': 'Aucune demande de fusion trouvée',
  'session.gitlabMrPicker.empty.noOpenMergeRequestsFound': 'Aucune demande de fusion ouverte trouvée',
  'session.gitlabMrPicker.loading.mergeRequests': 'Chargement des demandes de fusion...',
  'session.gitlabMrPicker.loading.more': 'Chargement...',
  'session.gitlabMrPicker.actions.openSettings': 'Ouvrir les paramètres',
  'session.gitlabMrPicker.actions.useMergeRequest': 'Utiliser le MR !{number}',
  'session.gitlabMrPicker.actions.openInGitLabAria': 'Ouvrir dans GitLab',
  'session.gitlabMrPicker.actions.loadMore': 'Charger plus',
  'session.giteaPrPicker.error.noActiveProject': 'Aucun projet actif',
  'session.giteaPrPicker.error.runtimeUnavailable': 'Exécution Gitea API indisponible',
  'session.giteaPrPicker.error.notConnected': 'Gitea non connecté',
  'session.giteaPrPicker.error.prNotFound': 'PR introuvable',
  'session.giteaPrPicker.error.repoNotResolvable': 'Repo non résoluble',
  'session.giteaPrPicker.error.repoMustBeGitea': 'Le dépôt distant origin doit pointer vers une URL Gitea',
  'session.giteaPrPicker.toast.loadMoreFailed': 'Échec du chargement d\'autres PR',
  'session.giteaPrPicker.toast.loadDetailsFailed': 'Échec du chargement des détails de la PR',
  'session.giteaPrPicker.title': 'Lier la PR Gitea',
  'session.giteaPrPicker.description': 'Sélectionnez une PR pour joindre un contexte de revue à ce message.',
  'session.giteaPrPicker.searchPlaceholder': 'Recherchez par titre ou collez l\'URL de la PR',
  'session.giteaPrPicker.includeDiffAria': 'Inclure le diff de la PR dans le contexte ci-joint',
  'session.giteaPrPicker.includeDiff': 'Inclure le diff de la PR',
  'session.giteaPrPicker.empty.noActiveProject': 'Aucun projet actif sélectionné.',
  'session.giteaPrPicker.empty.runtimeUnavailable': 'L\'environnement d\'exécution Gitea API n\'est pas disponible.',
  'session.giteaPrPicker.empty.notConnected': 'Gitea non connecté. Connectez votre compte Gitea dans les paramètres.',
  'session.giteaPrPicker.empty.noPullRequestsFound': 'Aucune PR trouvée',
  'session.giteaPrPicker.empty.noOpenPullRequestsFound': 'Aucune PR ouverte trouvée',
  'session.giteaPrPicker.loading.pullRequests': 'Chargement des PR...',
  'session.giteaPrPicker.loading.more': 'Chargement...',
  'session.giteaPrPicker.actions.openSettings': 'Ouvrir les paramètres',
  'session.giteaPrPicker.actions.usePullRequest': 'Utiliser la PR #{number}',
  'session.giteaPrPicker.actions.openInGiteaAria': 'Ouvrir dans Gitea',
  'session.giteaPrPicker.actions.loadMore': 'Charger plus',
  ...
  'session.newWorktree.actions.startFromGitLabIssueMr': 'À partir de GitLab Issue/MR',
  'session.newWorktree.usingPrBranch': 'Utilisation de la branche PR : {branch}',
  'session.newWorktree.usingMrBranch': 'Utilisation de la branche MR : {branch}',
  ...
  'session.newWorktree.toast.sessionFromMr': 'Session créée à partir de la merge request',
  ...
  'session.gitlabIntegration.connect.description': 'Lier des issues ou des merge requests pour remplir automatiquement les détails du worktree',
  'session.gitlabIntegration.connect.action': 'Connectez GitLab',
  'session.gitlabIntegration.search.issuesPlaceholder': 'Recherchez des problèmes GitLab',
  'session.gitlabIntegration.search.mrsPlaceholder': 'Recherchez les merge requests GitLab',
  'session.gitlabIntegration.empty.noIssuesFound': 'Aucun problème trouvé',
  'session.gitlabIntegration.empty.noMergeRequestsFound': 'Aucune merge request trouvée',
  ...
  'session.gitlabIntegration.draftBadge': 'Brouillon',
  'session.giteaIntegration.title': 'Sélectionnez parmi Gitea',
  'session.giteaIntegration.tabs.issues': 'Problèmes',
  'session.giteaIntegration.tabs.pullRequests': 'PR',
  'session.giteaIntegration.connect.title': 'Connectez-vous à Gitea',
  'session.giteaIntegration.connect.description': 'Lier des issues ou des PR pour remplir automatiquement les détails du worktree',
  'session.giteaIntegration.connect.action': 'Connectez Gitea',
  'session.giteaIntegration.search.issuesPlaceholder': 'Recherchez des problèmes Gitea',
  'session.giteaIntegration.search.prsPlaceholder': 'Recherchez les PR Gitea',
  'session.giteaIntegration.empty.noIssuesFound': 'Aucun problème trouvé',
  'session.giteaIntegration.empty.noPullRequestsFound': 'Aucune PR trouvée',
  'session.giteaIntegration.actions.loadMore': 'Charger plus',
  'session.giteaIntegration.actions.cancel': 'Annuler',
  'session.giteaIntegration.actions.select': 'Sélectionner',
  'session.giteaIntegration.selected.issueNumber': 'Numéro {number}',
  'session.giteaIntegration.selected.prNumber': 'PR #{number}',
  'session.giteaIntegration.includeDiffAria': 'Inclure la différence PR dans le contexte de la session',
  'session.giteaIntegration.includeDiff': 'Inclure la différence PR',
  'session.giteaIntegration.error.notConnected': 'Gitea non connecté',
  'session.giteaIntegration.error.loadDataFailed': 'Échec du chargement des données',
  'session.giteaIntegration.validation.branchAlreadyCheckedOut': 'La branche est déjà checkout dans un worktree',
  'session.giteaIntegration.validation.branchAlreadyExists': 'Une branche existe déjà localement',
  'session.giteaIntegration.validation.failed': 'Échec de la validation',
  'session.giteaIntegration.draftBadge': 'Brouillon',
  ...
  'chat.chatInput.actions.linkGiteaIssue': 'Lien vers le problème Gitea',
  'chat.chatInput.actions.linkGiteaPr': 'Lien Gitea PR',
