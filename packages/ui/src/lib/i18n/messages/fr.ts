...
export const dict = {
  ...
  'chat.messageBody.actions.forkSessionWithContext': 'Forker la session ici avec tout le contexte',
  ...
  'chat.messageBody.toast.forkSessionFailed': 'Impossible de forker la session',
