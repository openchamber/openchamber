...
export const dict = {
  ...
  'sessions.scheduledTasks.dialog.actions.lastRunAria': 'Ouvrir la session de la dernière exécution de {taskName}',
  ...
  'sessions.scheduledTasks.editor.lifecycle.title': 'Cycle de vie',
  'sessions.scheduledTasks.editor.archiveOnSuccess.label': 'Archiver les exécutions réussies',
  'sessions.scheduledTasks.editor.archiveOnSuccess.aria': 'Archiver la session après une exécution réussie',
