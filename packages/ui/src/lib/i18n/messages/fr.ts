...
export const dict = {
  ...
  ...settingsDict,
  'gitView.operation.title': 'Opération Git',
  'gitView.operation.recovery.storage': 'Le stockage de récupération Git est indisponible. Rétablissez le stockage du navigateur et actualisez. Les nouvelles modifications sont bloquées.',
  'gitView.operation.recovery.capacity': 'Le stockage de récupération Git est plein. Résolvez les opérations enregistrées avant d\'en lancer une autre.',
  'gitView.operation.recovery.reconciling': 'Vérification des références Git enregistrées…',
  'gitView.operation.recovery.repository': 'Le dépôt n\'a pas pu être vérifié. Actualisez avant de lancer une autre opération Git.',
  'gitView.operation.recovery.inspect': 'Si le serveur ne reconnaît plus cet ID, inspectez le dépôt local et le dépôt distant hors d\'OpenChamber. La référence enregistrée reste bloquée ; l\'absence de statut n\'autorise jamais un nouveau transfert.',
  'gitView.operation.localCommit': 'Le commit local a été créé et est conservé.',
  'gitView.operation.unknownHint': 'Le résultat est inconnu. Actualisez cette opération avant de lancer un autre transfert. Rien ne sera relancé automatiquement.',
  'gitView.operation.refresh': 'Actualiser l\'opération',
  'gitView.operation.cancel': 'Annuler l\'opération',
  'gitView.operation.state.unavailable': 'État de l\'opération indisponible',
  'gitView.operation.state.planned': 'Planifiée',
  'gitView.operation.state.running': 'En cours',
  'gitView.operation.state.succeeded': 'Réussie',
  'gitView.operation.state.partial': 'Partiellement terminée',
  'gitView.operation.state.failed': 'Échec',
  'gitView.operation.state.cancelled': 'Annulée',
  'gitView.operation.state.outcome-unknown': 'Résultat inconnu',
  'gitView.operation.state.conflicted': 'Conflit',
  'gitView.operation.state.skipped': 'Ignorée',
  'gitView.operation.completed.validated': 'Dépôt et destination validés',
  'gitView.operation.completed.authenticated': 'Authentification terminée',
  'gitView.operation.completed.transferred': 'Transfert terminé',
  'gitView.operation.completed.updated-local-repository': 'Dépôt local mis à jour',
  'gitView.operation.completed.checked-out': 'Checkout terminé',
  'gitView.operation.completed.cleaned-up': 'Nettoyage terminé',
  'gitView.remotes.title': 'Autres dépôts distants',
  'gitView.remotes.description': "Adresses que ce dépôt possède en plus de celle à laquelle son identité a été appliquée. Tant qu'une adresse n'est pas autorisée, OpenChamber n'y récupère ni n'y pousse rien.",
  'gitView.remotes.grant': 'Répondre en tant que {identity}',
  'gitView.hydration.title': 'Finaliser le checkout',
  'gitView.hydration.description': 'Initialisez les sous-modules et récupérez le contenu Git LFS avec une autorisation distincte pour chaque destination.',
  ...
  'gitView.hydration.kind.submodule': 'Sous-module',
  'gitView.hydration.kind.lfs': 'Git LFS',
  'gitView.hydration.status.succeeded': 'Terminé',
  'gitView.hydration.status.failed': 'Échec',
  'gitView.hydration.status.cancelled': 'Annulé',
  'gitView.hydration.status.authorization-required': 'Autorisation requise',
  'gitView.hydration.status.invalid': 'Configuration incorrecte',
  'gitView.hydration.status.client-missing': 'Client manquant',
  'gitView.hydration.status.not-needed': 'Non nécessaire',
  'gitView.publish.title': 'Publier',
  'gitView.publish.commitKept': 'Le commit local a été créé et conservé. La publication ne s’est pas terminée correctement.',
  'gitView.publish.syncTitle': 'Choisir les cibles de synchronisation',
  'gitView.publish.description': 'Publiez {branch} vers une destination Git exacte. Les comptes du fournisseur ne choisissent pas la destination.',
  'gitView.publish.fetchSource': 'Dépôt distant source de récupération',
  'gitView.publish.sourceBranch': 'Branche source',
  'gitView.publish.fetchFirst': 'Aucune branche en cache pour ce dépôt distant. Annulez et récupérez les branches au préalable.',
  'gitView.publish.pushDestination': 'Dépôt distant de destination',
  'gitView.publish.selectRemote': 'Sélectionner un dépôt distant lié',
  'gitView.publish.destinationBranch': 'Branche de destination',
  'gitView.publish.noGrants': 'Configurez une liaison de transport Git avant de publier.',
  'gitView.publish.contributorCommitFirst': 'Cet arbre de travail de contributeur exige une approbation de la destination après le commit. Continuer ? Annuler la publication ensuite conservera le commit local.',
  'gitView.publish.detached': 'La publication avec HEAD détaché est indisponible. Basculez sur une branche locale au préalable.',
  'gitView.publish.stale': 'La branche ou les autorisations Git ont changé. Aucune nouvelle tentative. Choisissez à nouveau la cible.',
  'gitView.publish.cancelled': 'Publication annulée. Aucun transfert Git lancé.',
  'gitView.publish.succeeded': 'Publié vers la destination sélectionnée',
  ...
  'chat.shellBoundary.status': 'Non vérifiée · hors du périmètre géré',
  'chat.shellBoundary.agentAria': 'L’exécution shell de l’agent n’est pas vérifiée et se situe hors de la limite Git gérée',
  'chat.shellBoundary.userAria': 'L’exécution shell de l’utilisateur n’est pas vérifiée et se situe hors de la limite Git gérée',
  ...
  'gitView.context.description': "Ce qu'une identité ne règle pas à elle seule : le shell de l'agent, les autres adresses du dépôt et les autorisations distinctes dont ont besoin les sous-modules et Git LFS. Les identités se gèrent dans les réglages Git.",
  ...
  'gitView.identity.unavailableScheme': 'Nécessite un dépôt distant {scheme}',
  ...
  'gitView.pr.actions.openOnProvider': 'Ouvrir sur {provider}',
  'gitView.pr.actions.openOnProviderAria': 'Ouvrir la demande de fusion sur {provider}',
  ...
  'gitView.pr.providerNotConnected': '{provider} n\'est pas connecté',
  ...
  'gitView.pr.capabilitiesUnavailable': 'Impossible de charger les fonctionnalités du fournisseur',
  ...
  'gitView.contributor.chooseDestination': 'Sélectionnez la destination exacte de cette branche contributrice.',
  'gitView.contributor.destination.contributor-fork': 'Fork du contributeur',
  'gitView.contributor.destination.own-fork': 'Votre fork',
  'gitView.contributor.destination.bound-repository': 'Dépôt lié',
  'gitView.contributor.destination.other': 'Autre dépôt distant',
  'gitView.toast.contributorPublishCancelled': 'La publication a été annulée. Aucun dépôt distant n’a été modifié.',
  'gitView.toast.contributorPublishCancelledAfterUpdate': 'Les modifications ont été mises à jour localement, mais la publication a été annulée.',
  'gitView.toast.unstageFileFailed': 'Échec de l\'annulation du transfert des modifications',
  'gitView.confirm.systemTransport': 'Git système peut utiliser les identifiants configurés sur cet ordinateur. Continuer cette opération Git ?',
  ...
  'session.changeRequestPicker.error.noProvider': 'Aucun dépôt distant de contrôle de version pris en charge n’a été trouvé',
  'session.changeRequestPicker.title': 'Lier une demande de modification',
  'session.changeRequestPicker.description': 'Sélectionnez une pull request ou une merge request pour joindre son contexte de revue à ce message.',
  'session.changeRequestPicker.searchPlaceholder': 'Recherchez par titre ou numéro, ou collez l’URL d’une demande de modification',
  'session.changeRequestPicker.includeDiffAria': 'Inclure le diff de la demande de modification dans le contexte joint',
  'session.changeRequestPicker.includeDiff': 'Inclure le diff',
  'session.changeRequestPicker.loading.changeRequests': 'Chargement des demandes de modification...',
  'session.changeRequestPicker.actions.useChangeRequest': 'Utiliser la demande de modification {reference}',
  'session.changeRequestPicker.empty.noneFound': 'Aucune demande de modification trouvée',
  'session.changeRequestPicker.empty.noneOpen': 'Aucune demande de modification ouverte trouvée',
  'session.issuePicker.title': 'Lier un ticket',
  'session.issuePicker.description': 'Sélectionnez un ticket pour joindre son contexte à ce message.',
  'session.issuePicker.searchPlaceholder': 'Recherchez par titre ou numéro, ou collez l’URL d’un ticket',
  'session.issuePicker.loading.issues': 'Chargement des tickets...',
  'session.issuePicker.actions.useIssue': 'Utiliser le ticket #{number}',
  'session.issuePicker.empty.noneFound': 'Aucun ticket trouvé',
  'session.issuePicker.empty.noneOpen': 'Aucun ticket ouvert trouvé',
  ...
  'session.newWorktree.error.changeRequestAuthorityMissing': 'L’autorisation de la demande de modification n’est plus disponible. Sélectionnez-la à nouveau.',
  'session.newWorktree.trust.confirmation': 'Ce checkout contient des actions exécutables :\n\n{actions}\n\nLes exécuter maintenant ? Annuler laisse le checkout prêt pour Git sans les exécuter.',
  ...
  'worktree.bootstrap.toast.authorizationRequired': 'Autorisez le dépôt extrait et ses sous-modules, puis réessayez.',
