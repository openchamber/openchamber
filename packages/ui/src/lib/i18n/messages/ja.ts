...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.scheduledTasks.dialog.actions.lastRunAria': '{taskName}の前回の実行セッションを開く',
  ...
  'sessions.scheduledTasks.editor.lifecycle.title': 'ライフサイクル',
  'sessions.scheduledTasks.editor.archiveOnSuccess.label': '成功した実行をアーカイブ',
  'sessions.scheduledTasks.editor.archiveOnSuccess.aria': '実行が成功した後にセッションをアーカイブ',
