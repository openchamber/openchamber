...
export const dict: Record<I18nKey, string> = {
  ...
  'workspace.zone.label.right': '右の領域',
  'workspace.zone.label.bottom': '下の領域',
  'workspace.zone.resize.left': '左の領域のサイズを変更',
  'workspace.zone.resize.bottom': '下の領域のサイズを変更',
  'workspace.preset.title': 'レイアウト',
  'workspace.preset.default': 'デフォルト',
  'workspace.preset.developer': '開発者',
  'workspace.preset.codeAgent': 'コード + エージェント',
  'workspace.preset.reset': 'レイアウトをリセット',
};
