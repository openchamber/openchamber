...
export const dict: Record<I18nKey, string> = {
  ...
  'contextSidebar.breakdown.segment.systemPrompt': 'システムプロンプト',
  'contextSidebar.breakdown.segment.skills': 'スキル',
  'contextSidebar.breakdown.segment.messages': 'メッセージ',
  'contextSidebar.breakdown.segment.other': 'その他',
  'contextSidebar.section.breakdown': 'コンテキストの内訳',
