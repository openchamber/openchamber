...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.messageBody.metrics.ttft': 'TTFT {duration}',
  'chat.messageBody.metrics.ttftInfo': '最初のトークンまでの時間：リクエスト後、モデルが応答を始めるまでにかかった時間。',
  'chat.messageBody.metrics.tokensPerSecond': '{rate} tok/s',
  'chat.messageBody.metrics.tokensPerSecondInfo': 'ツール実行時間を除く、ストリーミング生成中の1秒あたりの出力トークン数。',
