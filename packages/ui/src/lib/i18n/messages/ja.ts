...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.queuedMessage.admissionPending': 'サーバーに送信中…',
  'chat.queuedMessage.admitted': 'サーバーのキューに追加済み · 閉じても安全',
  'chat.queuedMessage.localFallback': 'ローカルキュー · クライアントを開いたままにしてください',
  'chat.queuedMessage.admissionFailed': 'キューへの追加に失敗しました',
  'chat.queuedMessage.admissionUnknown': '結果不明 · 重複する可能性があるため再送しないでください',
  'chat.queuedMessage.retryAdmission': 'キューへの追加を再試行',
  'chat.queuedMessage.restore': 'コンポーザーに移動',
  'chat.queuedMessage.copy': 'テキストをコピー',
  'chat.queuedMessage.dismiss': '閉じる',
  'chat.queuedMessage.copyFailed': 'メッセージ本文をコピーできませんでした',
  'chat.queuedMessage.selectionLimitation': 'サーバーへの追加ではセッションの現在のモデル、エージェント、バリアント設定が使われます',
