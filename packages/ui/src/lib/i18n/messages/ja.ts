...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.server-browser.description': 'サーバー上で実行中のChrome',
  ...
  'contextPanel.browser.newServerTab': '新しいサーバーブラウザタブ',
  'contextPanel.browser.remote.tabLabel': 'サーバーブラウザ',
  'contextPanel.browser.remote.sessionsMenu': 'ブラウザセッション',
  'contextPanel.browser.remote.savedSessions': '保存済みセッション',
  'contextPanel.browser.remote.availableSessions': '実行中のセッション',
  'contextPanel.browser.remote.openDevTools': 'Chrome DevToolsを開く',
  'contextPanel.browser.remote.contextMenuUnavailable': 'このクリックではブラウザーの操作を利用できません。ツールバーまたはクリップボードのボタンを使用してください。',
  'contextPanel.browser.remote.devTools': 'Chrome DevTools',
  'contextPanel.browser.remote.simpleInspector': 'コンソールとネットワーク',
  'contextPanel.browser.remote.inspectMode': '検査モード',
  'contextPanel.browser.remote.maximizeInspector': 'インスペクターを最大化',
  'contextPanel.browser.remote.restoreInspector': 'ページとインスペクターを元に戻す',
  'contextPanel.browser.remote.resizeInspector': 'インスペクターのサイズを変更',
  'contextPanel.browser.remote.devtoolsLoading': 'Chrome DevToolsに接続中…',
  'contextPanel.browser.remote.devtoolsLoadFailed': 'Chrome DevToolsを読み込めませんでした。',
  'contextPanel.browser.remote.devtoolsRetry': 'DevToolsに再接続',
  'contextPanel.browser.remote.devtoolsControlLost': '別のビューアーが制御を引き継ぎました。検査を続けるには再接続してください。',
  'contextPanel.browser.remote.devtoolsConnectionClosed': 'DevToolsの接続が閉じられました。',
  'contextPanel.browser.remote.devtoolsMessageTooLarge': 'DevToolsのメッセージがサイズ制限を超えました。',
  'contextPanel.browser.remote.devtoolsBackpressure': 'DevToolsが接続からのデータ処理に追いつきませんでした。続行するには再接続してください。',
  'contextPanel.browser.remote.devtoolsInvalidRequest': 'DevToolsの接続で無効なメッセージを受信しました。',
  'contextPanel.browser.remote.devtoolsProtocolRejected': 'このページでは、このDevToolsの操作は利用できません。',
  'contextPanel.browser.remote.devtoolsExclusive': 'パフォーマンスを記録するには、実行中のブラウザセッションをこのセッションだけにする必要があります。',
  'contextPanel.browser.remote.devtoolsStartFailed': 'このページのDevToolsを開けませんでした。',
  'contextPanel.browser.remote.connecting': 'サーバーブラウザに接続しています…',
  'contextPanel.browser.remote.reconnecting': '接続が切れました。再接続しています…',
  'contextPanel.browser.remote.chooseTitle': 'サーバーブラウザセッション',
  'contextPanel.browser.remote.chooseHint': '実行中のセッションにアタッチするか、新しいセッションを開始します。',
  'contextPanel.browser.remote.newSession': '新しいセッション',
  'contextPanel.browser.remote.noSessions': 'このプロジェクトで実行中のサーバーセッションはありません。',
  'contextPanel.browser.remote.sessionEphemeral': 'エージェントセッション',
  'contextPanel.browser.remote.sessionProject': 'プロジェクトセッション',
  'contextPanel.browser.remote.errorTitle': 'サーバーブラウザを利用できません',
  'contextPanel.browser.remote.endedTitle': 'このサーバーブラウザセッションは終了しました',
  'contextPanel.browser.remote.retry': '再試行',
  'contextPanel.browser.remote.canvasAria': 'リモートページビュー',
  'contextPanel.browser.remote.keyboard': 'ページに入力',
  'contextPanel.browser.remote.textInputAria': 'リモートページへのテキスト入力',
  'contextPanel.browser.remote.clipboard.copy': 'コピー',
  'contextPanel.browser.remote.clipboard.paste': '貼り付け',
  'contextPanel.browser.remote.clipboard.copied': 'クリップボードにコピーしました',
  'contextPanel.browser.remote.clipboard.pasted': 'ページに貼り付けました',
  'contextPanel.browser.remote.clipboard.noSelection': 'ページ上でコピーするテキストを選択してください。',
  'contextPanel.browser.remote.clipboard.copyFailed': '選択したテキストをコピーできませんでした。もう一度お試しください。',
  'contextPanel.browser.remote.clipboard.pasteFailed': 'ページに貼り付けできませんでした。もう一度お試しください。',
  'contextPanel.browser.remote.clipboard.tooLarge': 'テキストが大きすぎるため転送できません。',
  'contextPanel.browser.remote.clipboard.copyFallbackTitle': '選択したテキストをコピー',
  'contextPanel.browser.remote.clipboard.copyFallbackDescription': 'クリップボードにアクセスできません。下のテキストを選択してコピーしてください。',
  'contextPanel.browser.remote.clipboard.copyTextAria': 'ページ上で選択したテキスト',
  'contextPanel.browser.remote.clipboard.pasteFallbackTitle': 'ページに貼り付け',
  'contextPanel.browser.remote.clipboard.pasteFallbackDescription': '下にプレーンテキストを貼り付けてから、ページに送信してください。',
  'contextPanel.browser.remote.clipboard.pasteTextAria': 'ページに貼り付けるテキスト',
  'contextPanel.browser.remote.clipboard.emptyClipboard': 'クリップボードにプレーンテキストがありません。',
  'contextPanel.browser.remote.clipboard.cancel': 'キャンセル',
  'contextPanel.browser.remote.viewport.auto': '自動',
  'contextPanel.browser.remote.viewport.preset': 'ビューポートのプリセット',
  'contextPanel.browser.remote.viewport.custom': 'カスタム',
  'contextPanel.browser.remote.viewport.width': '幅',
  'contextPanel.browser.remote.viewport.height': '高さ',
  'contextPanel.browser.remote.viewport.rotate': '回転',
  'contextPanel.browser.remote.viewport.mobile': 'モバイルデバイスをエミュレート',
  'contextPanel.browser.remote.viewport.scale': '表示倍率',
  'contextPanel.browser.remote.viewport.pending': 'ビューポートを適用中…',
  'contextPanel.browser.remote.viewport.error': 'ビューポートのサイズ変更に失敗しました: {code}',
  'contextPanel.browser.remote.viewport.agentControlled': 'エージェントがこのビューポートを制御しています',
  'contextPanel.browser.remote.viewport.external': '外部のDevToolsがこのビューポートを制御しています',
  'contextPanel.browser.remote.viewport.dimensionsConfirmed': '確認済み: {width} × {height}',
  'contextPanel.browser.remote.inspector.title': 'ページインスペクター',
  'contextPanel.browser.remote.inspector.open': 'ページインスペクターを開く',
  'contextPanel.browser.remote.inspector.close': 'インスペクターを閉じる',
  'contextPanel.browser.remote.inspector.console': 'コンソール',
  'contextPanel.browser.remote.inspector.network': 'ネットワーク',
  'contextPanel.browser.remote.inspector.clear': 'クリア',
  'contextPanel.browser.remote.inspector.filterPlaceholder': 'メッセージやリクエストを絞り込む',
  'contextPanel.browser.remote.inspector.filterAria': 'インスペクターの項目を絞り込む',
  'contextPanel.browser.remote.inspector.capturing': 'このタブを記録中',
  'contextPanel.browser.remote.inspector.starting': '記録を開始中',
  'contextPanel.browser.remote.inspector.captureHint': 'インスペクターを開くと記録が始まります。閉じると記録したデータは消去されます。',
  'contextPanel.browser.remote.inspector.dropped': '省略した項目: {count}',
  'contextPanel.browser.remote.inspector.emptyConsole': 'コンソールのメッセージがここに表示されます。',
  'contextPanel.browser.remote.inspector.filteredEmpty': '一致する項目がありません。',
  'contextPanel.browser.remote.inspector.expressionAria': 'ページで実行するJavaScript',
  'contextPanel.browser.remote.inspector.expressionPlaceholder': 'ページでJavaScriptを実行',
  'contextPanel.browser.remote.inspector.run': '実行',
  'contextPanel.browser.remote.inspector.running': '実行中',
  'contextPanel.browser.remote.inspector.previousCommand': '前のコマンド',
  'contextPanel.browser.remote.inspector.nextCommand': '次のコマンド',
  'contextPanel.browser.remote.inspector.shortcutHint': 'Ctrl/Cmd+Enterで実行します。Enterで改行します。',
  'contextPanel.browser.remote.inspector.truncated': '一部省略',
  'contextPanel.browser.remote.inspector.errorUnavailable': 'ページインスペクターを利用できません。開き直してもう一度お試しください。',
  'contextPanel.browser.remote.inspector.errorInvalid': 'JavaScriptを16,000文字以内で入力してください。',
  'contextPanel.browser.remote.inspector.errorCaptureGone': '記録が終了しました。再開するにはインスペクターを開き直してください。',
  'contextPanel.browser.remote.inspector.errorEvaluation': 'JavaScriptを実行できませんでした。もう一度お試しください。',
  'contextPanel.browser.remote.inspector.errorTimeout': 'JavaScriptがタイムアウトしました。ページでは実行が続いている可能性があります。',
  'contextPanel.browser.remote.inspector.errorRequestGone': 'このリクエストは利用できなくなりました。',
  'contextPanel.browser.remote.inspector.errorRequest': 'このリクエストを読み込めませんでした。もう一度お試しください。',
  'contextPanel.browser.remote.inspector.errorCapture': '記録を開始できませんでした。インスペクターを開き直してもう一度お試しください。',
  'contextPanel.browser.remote.inspector.resultAria': 'JavaScriptの結果',
  'contextPanel.browser.remote.inspector.commandAria': '実行したJavaScript',
  'contextPanel.browser.remote.inspector.level.debug': 'デバッグ',
  'contextPanel.browser.remote.inspector.level.info': '情報',
  'contextPanel.browser.remote.inspector.level.log': 'ログ',
  'contextPanel.browser.remote.inspector.level.warning': '警告',
  'contextPanel.browser.remote.inspector.level.error': 'エラー',
  'contextPanel.browser.remote.inspector.network.empty': 'まだリクエストが記録されていません。',
  'contextPanel.browser.remote.inspector.network.noMatches': 'このフィルターに一致するリクエストはありません。',
  'contextPanel.browser.remote.inspector.network.selectRequest': 'リクエストを選択して詳細を確認してください。',
  'contextPanel.browser.remote.inspector.network.details': 'リクエストの詳細',
  'contextPanel.browser.remote.inspector.network.closeDetails': 'リクエストの詳細を閉じる',
  'contextPanel.browser.remote.inspector.network.loading': 'リクエストの詳細を読み込み中',
  'contextPanel.browser.remote.inspector.network.loadBodies': '本文を読み込む',
  'contextPanel.browser.remote.inspector.network.requestHeaders': 'リクエストヘッダー',
  'contextPanel.browser.remote.inspector.network.responseHeaders': 'レスポンスヘッダー',
  'contextPanel.browser.remote.inspector.network.requestBody': 'リクエスト本文',
  'contextPanel.browser.remote.inspector.network.responseBody': 'レスポンス本文',
  'contextPanel.browser.remote.inspector.network.noHeaders': '利用可能なヘッダーがありません。',
  'contextPanel.browser.remote.inspector.network.noBody': '利用可能な本文がありません。',
  'contextPanel.browser.remote.inspector.network.bodiesNotRequested': '本文は要求したときにだけ読み込まれます。',
  'contextPanel.browser.remote.inspector.network.bodiesUnavailable': 'このリクエストの本文は利用できなくなりました。',
  'contextPanel.browser.remote.inspector.network.bodiesUnsupported': 'このレスポンスの本文プレビューはサポートされていません。',
  'contextPanel.browser.remote.inspector.network.truncated': 'プレビューは一部省略されています。',
  'contextPanel.browser.remote.inspector.network.method': 'メソッド',
  'contextPanel.browser.remote.inspector.network.url': 'URL',
  'contextPanel.browser.remote.inspector.network.status': 'ステータス',
  'contextPanel.browser.remote.inspector.network.duration': '所要時間',
  'contextPanel.browser.remote.inspector.network.size': '転送量',
  'contextPanel.browser.remote.inspector.network.state': '状態',
  'contextPanel.browser.remote.inspector.network.cached': 'キャッシュから',
  'contextPanel.browser.remote.inspector.network.failure': 'エラー',
  'contextPanel.browser.remote.inspector.network.resourceType': '種類',
  'contextPanel.browser.remote.inspector.network.mimeType': 'コンテンツタイプ',
  'contextPanel.browser.remote.inspector.network.pending': '待機中',
  'contextPanel.browser.remote.inspector.network.complete': '完了',
  'contextPanel.browser.remote.inspector.network.failed': '失敗',
  'contextPanel.browser.remote.inspector.network.unknown': '利用不可',
  'contextPanel.browser.remote.inspector.network.yes': 'はい',
  'contextPanel.browser.remote.inspector.network.no': 'いいえ',
  'contextPanel.browser.remote.inspector.network.failedDetails': 'リクエストの詳細を読み込めませんでした。もう一度お試しください。',
  'contextPanel.browser.remote.inspector.network.requestGone': 'このリクエストは利用できなくなりました。',
  'contextPanel.browser.remote.inspector.network.captureGone': 'この記録は終了しました。',
  ...
  'contextPanel.browser.agentControlling': 'エージェントが操作中',
