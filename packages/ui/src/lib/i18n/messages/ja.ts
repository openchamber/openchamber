...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.sync.pullRebase': 'プル（リベース）',
  'gitView.sync.pullRebaseBlocked': 'プルする前に変更をコミットまたはスタッシュしてください',
  ...
  'diffView.change.conflicted': '競合しているファイル',
  ...
  'chat.chatInput.toast.skippedMissingAttachments': '存在しないファイルの添付をスキップし、残りを送信します：{names}',
