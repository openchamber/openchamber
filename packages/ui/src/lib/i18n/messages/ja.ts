...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.telemetry.speed': '生成速度',
  'chat.workStatus.telemetry.llmDuration': 'LLM時間',
  'chat.workStatus.telemetry.toolDuration': 'ツール時間',
  'chat.workStatus.telemetry.ttft': '最初のトークンまでの時間',
  'chat.workStatus.telemetry.steps': 'ターン内のステップ数',
  'chat.workStatus.telemetry.tokens': 'トークン',
  'chat.workStatus.telemetry.cacheHit': 'キャッシュヒット率',
  'chat.workStatus.telemetry.cost': 'ターンのコスト',
