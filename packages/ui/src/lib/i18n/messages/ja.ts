...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.actions.enhancePromptAria': 'プロンプトを強化',
  'chat.chatInput.actions.enhancePromptCancel': 'プロンプトの強化をキャンセル',
  ...
  'chat.chatInput.toast.enhanceUnavailable': 'プロンプトの強化に使用できる小型モデルがありません。設定 → セッション → 小型モデルで選択してください。',
  'chat.chatInput.toast.enhanceContextTooSmall': 'プロンプトが小型モデルのコンテキストに対して大きすぎます。短くするか、ファイルとして添付してください。',
  'chat.chatInput.toast.enhanceEmptyResult': '小型モデルが空のプロンプトを返しました。もう一度お試しください。',
  'chat.chatInput.toast.enhanceInvalidResult': '強化されたプロンプトは @、/、# の参照を変更するおそれがあるため、下書きは変更されていません。',
  'chat.chatInput.toast.enhanceTimedOut': 'プロンプトの強化がタイムアウトしました。もう一度お試しください。',
