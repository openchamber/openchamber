...
export const dict: Record<I18nKey, string> = {
  ...
  'usage.status.quotaExhausted': '割り当てを使い切りました',
  'usage.status.expired': 'APIキーが期限切れです',
  'usage.statistics.title': '使用量統計',
  'usage.statistics.info': 'モデル統計は直近30日間を対象としています。',
  'usage.statistics.requests': 'リクエスト数',
  'usage.statistics.inputTokens': '入力トークン',
  'usage.statistics.outputTokens': '出力トークン',
  'usage.statistics.cacheReadTokens': 'キャッシュ読み取りトークン',
  'usage.statistics.totalTokens': '合計トークン',
  'usage.statistics.actualCost': '費用',
  'usage.statistics.today': '今日',
  'usage.statistics.total': '合計',
  'usage.statistics.empty': '使用量統計は報告されていません。',
