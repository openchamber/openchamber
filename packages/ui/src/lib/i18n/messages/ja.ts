...
export const dict: Record<I18nKey, string> = {
  ...
  'session.githubIssuePicker.overridesHelper': 'これらの選択はこのセッションに適用されます（保存済みのデフォルトではありません）',
  ...
  'session.newWorktree.overridesHelper': 'これらの選択はこのセッションに適用されます（保存済みのデフォルトではありません）',
