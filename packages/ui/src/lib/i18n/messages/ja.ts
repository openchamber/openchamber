...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.history.actions.conflictToastDescription': '競合ファイル: {files}。手動で解決してコミットするか、オペレーションバナーの「中止」ボタンを使用してください。',
  'gitView.history.actions.conflictToastTitle': '競合',
  'gitView.history.actions.unknownFiles': '不明なファイル',
  ...
  'gitView.history.actions.resetHard': 'リセット (ハード)',
  ...
  'gitView.history.actions.resetHardDirtyTitle': 'コミットされていない変更を破棄しますか？',
  'gitView.history.actions.resetHardDirtyDescription': 'ワーキングツリーにコミットされていない変更があります。ハードリセットは永久に破棄します。',
  'gitView.history.actions.resetHardDirtyConfirmButton': '破棄してリセット',
  'gitView.history.actions.resetMixed': 'リセット (ミックス)',
  'gitView.history.actions.resetMixedConfirm': 'ミックスリセット — HEADが移動し、変更はアンステージされます。',
  'gitView.history.actions.resetSoft': 'リセット (ソフト)',
  ...
  'gitView.graph.localBranches': 'ローカルブランチ',
  'gitView.graph.tags': 'タグ',
  'gitView.graph.manualSelection': 'グラフに含める参照を選択します。',
  'gitView.graph.incomingChanges': '受信した変更',
  'gitView.graph.outgoingChanges': '送信した変更',
  'gitView.graph.outdated': 'グラフ履歴が古くなっています。更新してください。',
  'gitView.graph.mergeBaseLookupFailed': 'このグラフの受信変更と送信変更を比較できませんでした。',
  'gitView.graph.resizeAria': 'グラフペインのサイズを変更',
  'gitView.preview.overlayAnnouncement': '差分プレビューを開きました。Escapeキーで閉じます。',
  'gitView.preview.resizeAria': '差分プレビューのサイズを変更',
  'gitView.preview.submodulePointer': 'サブモジュール参照',
  'gitView.preview.tooLargeDescription': 'この差分は{totalSize}で、{maxSize}のプレビュー上限を超えています。',
  ...
  'gitView.operation.cherryPickInProgress': 'チェリーピック進行中',
  'gitView.operation.revertInProgress': 'リバート進行中',
  ...
  'gitView.toast.cherryPickCompleted': 'チェリーピックが完了しました',
  'gitView.toast.cherryPickAborted': 'チェリーピックが中止されました',
  'gitView.toast.cherryPickConflictsDetected': 'チェリーピックコンフリクトが検出されました',
  'gitView.toast.revertCompleted': 'リバートが完了しました',
  'gitView.toast.revertAborted': 'リバートが中止されました',
  'gitView.toast.revertConflictsDetected': 'リバートコンフリクトが検出されました',
  ...
  'diffView.actions.backToChat': 'チャットに戻る',
  ...
  'gitView.history.actions.createBranchEllipsis': 'ブランチを作成…',
  'gitView.history.actions.createTagConfirm': '作成',
  'gitView.history.actions.createTagEllipsis': 'タグを作成…',
  'gitView.history.actions.createTagPlaceholder': 'タグ名',
  'gitView.history.actions.checkoutDetached': 'チェックアウト (デタッチ)',
  'gitView.history.actions.compareWithMergeBase': 'マージベースと比較',
  'gitView.history.actions.compareWithRef': '比較…',
  'gitView.history.actions.compareWithRemote': 'リモートと比較',
  'gitView.history.actions.comparingWith': '{name} と比較中',
  'gitView.history.actions.copyMessage': 'コミットメッセージをコピー',
  'gitView.history.actions.clearComparison': '比較を解除',
  'gitView.history.actions.openChanges': '変更を開く',
  'gitView.toast.commitMessageCopied': 'コミットメッセージをコピーしました',
  'gitView.toast.tagCreated': 'タグ {name} を作成しました',
  'gitView.graph.mergeBaseLabel': 'マージベース',
};
