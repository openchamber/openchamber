...
export const dict: Record<I18nKey, string> = {
  ...
  'walkthrough.scope.basePickerTitle': 'ベースブランチを選択',
  'walkthrough.scope.basePickerDescription': 'このブランチの変更を、選択したベースと比較しながら確認します。',
  'walkthrough.scope.changeBase': 'ベースブランチを変更...',
