...
export const dict: Record<I18nKey, string> = {
  ...
  ...settingsDict,
  'gitView.operation.title': 'Git 操作',
  'gitView.operation.recovery.storage': 'Git 復旧用ストレージを利用できません。ブラウザのストレージを復旧して更新してください。新しい変更操作はブロックされています。',
  'gitView.operation.recovery.capacity': 'Git 復旧用ストレージがいっぱいです。別の操作を開始する前に保存済みの操作を解決してください。',
  'gitView.operation.recovery.reconciling': '保存済みの Git 操作参照を確認中…',
  'gitView.operation.recovery.repository': 'リポジトリを確認できませんでした。別の Git 操作を開始する前に更新してください。',
  'gitView.operation.recovery.inspect': 'サーバーがこの ID を認識しなくなった場合は、OpenChamber の外でローカルリポジトリとリモートを確認してください。保存済みの参照はブロックされたままです。状態が不明でも転送を繰り返す許可にはなりません。',
  'gitView.operation.localCommit': 'ローカルコミットは作成され、保持されています。',
  'gitView.operation.unknownHint': '結果は不明です。別の転送を開始する前に、この操作の状態を更新してください。自動的に再実行されることはありません。',
  'gitView.operation.refresh': '操作の状態を更新',
  'gitView.operation.cancel': '操作をキャンセル',
  'gitView.operation.state.unavailable': '操作の状態を取得できません',
  'gitView.operation.state.planned': '計画済み',
  'gitView.operation.state.running': '実行中',
  'gitView.operation.state.succeeded': '成功',
  'gitView.operation.state.partial': '一部完了',
  'gitView.operation.state.failed': '失敗',
  'gitView.operation.state.cancelled': 'キャンセル済み',
  'gitView.operation.state.outcome-unknown': '結果不明',
  'gitView.operation.state.conflicted': '競合',
  'gitView.operation.state.skipped': 'スキップ済み',
  'gitView.operation.completed.validated': 'リポジトリと転送先を検証済み',
  'gitView.operation.completed.authenticated': '認証完了',
  'gitView.operation.completed.transferred': '転送完了',
  'gitView.operation.completed.updated-local-repository': 'ローカルリポジトリを更新済み',
  'gitView.operation.completed.checked-out': 'チェックアウト完了',
  'gitView.operation.completed.cleaned-up': 'クリーンアップ完了',
  'gitView.remotes.title': 'ほかのリモート',
  'gitView.remotes.description': 'アイデンティティを適用したアドレスのほかに、このリポジトリが持っているアドレスです。許可するまで、OpenChamber はそこから取得も送信もしません。',
  'gitView.remotes.grant': '{identity} として応答する',
  'gitView.hydration.title': 'チェックアウトの準備',
  'gitView.hydration.description': 'エンドポイントごとに個別に認証して、サブモジュールを初期化し Git LFS コンテンツを取得します。',
  'gitView.hydration.parentRemote': '親リモート',
  'gitView.hydration.retry': '準備を再試行',
  'gitView.hydration.endpoint': '補助エンドポイント',
  'gitView.hydration.identity': 'このエンドポイントのアイデンティティ',
  'gitView.hydration.authorizationNeeded': 'これらのエンドポイントにまだアイデンティティがないため、ハイドレーションを中止しました。それぞれにアイデンティティを選んでから再試行してください。',
  'gitView.hydration.chooseEndpoint': 'エンドポイントを選択',
  'gitView.hydration.systemConfirmation': 'このエンドポイントに対して、システム環境の認証情報を Git が使用することを許可します。Git が使用する認証情報を OpenChamber で確認することはできません。',
  'gitView.hydration.lfsMissing': 'Git LFS がインストールされていません。git-lfs をインストールしてから、準備を再試行してください。',
  'gitView.hydration.kind.submodule': 'サブモジュール',
  'gitView.hydration.kind.lfs': 'Git LFS',
  'gitView.hydration.status.succeeded': '完了',
  'gitView.hydration.status.failed': '失敗',
  'gitView.hydration.status.cancelled': 'キャンセル済み',
  'gitView.hydration.status.authorization-required': '認証が必要',
  'gitView.hydration.status.invalid': '無効な設定',
  'gitView.hydration.status.client-missing': 'クライアントがありません',
  'gitView.hydration.status.not-needed': '不要',
  'gitView.publish.title': '公開',
  'gitView.publish.commitKept': 'ローカルのコミットは作成され、保持されています。公開は正常に完了しませんでした。',
  'gitView.publish.syncTitle': '同期先を選択',
  'gitView.publish.description': '{branch} を指定した Git の宛先に公開します。プロバイダーのアカウントによって宛先が選ばれることはありません。',
  'gitView.publish.fetchSource': 'フェッチ元のリモート',
  'gitView.publish.sourceBranch': '取得元ブランチ',
  'gitView.publish.fetchFirst': 'このリモートのブランチはキャッシュされていません。キャンセルして先にフェッチしてください。',
  'gitView.publish.pushDestination': 'プッシュ先のリモート',
  'gitView.publish.selectRemote': '連携済みリモートを選択',
  'gitView.publish.destinationBranch': '宛先ブランチ',
  'gitView.publish.noGrants': '公開する前に Git 転送の連携を設定してください。',
  'gitView.publish.contributorCommitFirst': 'このコントリビューターの作業ツリーでは、コミット後に宛先の承認が必要です。続行しますか？後で公開をキャンセルしても、ローカルのコミットは残ります。',
  'gitView.publish.detached': '切り離された HEAD の公開には対応していません。先にローカルブランチをチェックアウトしてください。',
  'gitView.publish.stale': 'ブランチまたは Git の権限が変更されました。再試行は行っていません。宛先を選び直してください。',
  'gitView.publish.cancelled': '公開をキャンセルしました。Git 転送は開始されていません。',
  'gitView.publish.succeeded': '選択した宛先に公開しました',
  ...
  'chat.shellBoundary.status': '未検証 · 管理境界の外',
  'chat.shellBoundary.agentAria': 'エージェントによるシェル実行は未検証で、管理対象の Git 境界外です',
  'chat.shellBoundary.userAria': 'ユーザーによるシェル実行は未検証で、管理対象の Git 境界外です',
  ...
  'gitView.context.description': 'アイデンティティだけでは決まらないもの: エージェントのシェル、リポジトリのほかのアドレス、サブモジュールと Git LFS に必要な個別の許可。アイデンティティは Git 設定で管理します。',
  ...
  'gitView.identity.unavailableScheme': '{scheme} のリモートが必要',
  ...
  'worktree.bootstrap.toast.authorizationRequired': 'チェックアウト元のリポジトリとサブモジュールを認証してから、再試行してください。',
  ...
  'gitView.pr.actions.openOnProvider': '{provider}で開く',
  'gitView.pr.actions.openOnProviderAria': 'プルリクエストを{provider}で開く',
  ...
  'gitView.pr.providerNotConnected': '{provider}は接続されていません',
  ...
  'gitView.pr.capabilitiesUnavailable': 'プロバイダーの機能を読み込めませんでした',
  ...
  'gitView.contributor.chooseDestination': 'コントリビューターブランチの正確なプッシュ先を選択してください。',
  'gitView.contributor.destination.contributor-fork': 'コントリビューターのフォーク',
  'gitView.contributor.destination.own-fork': '自分のフォーク',
  'gitView.contributor.destination.bound-repository': '連携済みリポジトリ',
  'gitView.contributor.destination.other': 'その他のリモート',
  'gitView.toast.contributorPublishCancelled': '公開をキャンセルしました。リモートは変更されていません。',
  'gitView.toast.contributorPublishCancelledAfterUpdate': '変更はローカルで更新されましたが、公開はキャンセルされました。',
  'gitView.toast.unstageFileFailed': '変更のアンステージに失敗しました',
  'gitView.confirm.systemTransport': 'システム Git はこのコンピューターに設定された認証情報を使用する場合があります。この Git 操作を続行しますか？',
  ...
  'session.changeRequestPicker.error.noProvider': '対応するソース管理リモートが見つかりません',
  'session.changeRequestPicker.title': '変更リクエストをリンク',
  'session.changeRequestPicker.description': 'レビューコンテキストをこのメッセージに添付するプルリクエストまたはマージリクエストを選択します。',
  'session.changeRequestPicker.searchPlaceholder': 'タイトルまたは番号で検索するか、変更リクエストのURLを貼り付けます',
  'session.changeRequestPicker.includeDiffAria': '添付するコンテキストに変更リクエストの差分を含める',
  'session.changeRequestPicker.includeDiff': '差分を含める',
  'session.changeRequestPicker.loading.changeRequests': '変更リクエストを読み込み中...',
  'session.changeRequestPicker.actions.useChangeRequest': '変更リクエスト {reference} を使用',
  'session.changeRequestPicker.empty.noneFound': '変更リクエストが見つかりません',
  'session.changeRequestPicker.empty.noneOpen': 'オープンな変更リクエストが見つかりません',
  'session.issuePicker.title': 'Issueをリンク',
  'session.issuePicker.description': 'コンテキストをこのメッセージに添付するIssueを選択します。',
  'session.issuePicker.searchPlaceholder': 'タイトルまたは番号で検索するか、IssueのURLを貼り付けます',
  'session.issuePicker.loading.issues': 'Issueを読み込み中...',
  'session.issuePicker.actions.useIssue': 'Issue #{number}を使用',
  'session.issuePicker.empty.noneFound': 'Issueが見つかりません',
  'session.issuePicker.empty.noneOpen': 'オープンなIssueが見つかりません',
  ...
  'session.newWorktree.error.changeRequestAuthorityMissing': '変更リクエストの認証情報を利用できなくなりました。もう一度選択してください。',
  'session.newWorktree.trust.confirmation': 'このチェックアウトには実行可能なアクションがあります。\n\n{actions}\n\n今すぐ実行しますか？キャンセルすると、実行せずに Git を使用できる状態のままになります。',
