...
export const dict: Record<I18nKey, string> = {
  ...
  // Docker-backed OpenCode instances (managed by OpenChamber)
  'dockerInstances.title': 'Dockerインスタンス',
  'dockerInstances.description': 'このマシンのDockerコンテナ内で動くOpenCodeインスタンスを作成・管理します。',
  'dockerInstances.state.creating': '作成中',
  'dockerInstances.state.starting': '起動中',
  'dockerInstances.state.probing': '準備完了を待機中',
  'dockerInstances.state.running': '実行中',
  'dockerInstances.state.stopped': '停止中',
  'dockerInstances.state.error': 'エラー',
  'dockerInstances.state.removing': '削除中',
  'dockerInstances.state.removalFailed': 'クリーンアップ失敗',
  'dockerInstances.state.empty': 'Dockerインスタンスはまだありません。',
  'dockerInstances.state.loadFailed': 'Dockerインスタンスを読み込めませんでした。',
  'dockerInstances.actions.addDocker': 'Dockerインスタンスを追加',
  'dockerInstances.actions.switchAria': '{name} に切り替え',
  'dockerInstances.actions.stop': '停止',
  'dockerInstances.actions.start': '起動',
  'dockerInstances.actions.cleanup': 'クリーンアップを再試行',
  'dockerInstances.actions.remove': '削除',
  'dockerInstances.actions.confirmRemove': '削除を確認',
  'dockerInstances.actions.openAria': 'Dockerインスタンスを開く',
  'dockerInstances.create.title': '新しいDockerインスタンス',
  'dockerInstances.create.description': 'OpenChamberがコンテナを作成し、内部でOpenCodeを起動して準備ができるまで待機します。',
  'dockerInstances.create.field.label': '名前',
  'dockerInstances.create.field.labelPlaceholder': '任意の表示名',
  'dockerInstances.create.field.image': 'イメージ',
  'dockerInstances.create.field.workspace': 'ワークスペースのパス',
  ...
  'dockerInstances.create.sharing.credentialsTitle': '認証情報を共有',
  'dockerInstances.create.sharing.credentialsHint': '読み取り専用、デフォルトはオフ。プロバイダーのサインイン情報がコンテナ内で表示されます。',
  'dockerInstances.create.sharing.neverShared': '共有されないもの: Dockerソケット、SSH鍵、git認証情報。ポートはこのマシンのみにバインドされます。',
  'dockerInstances.create.actions.buildImage': '{image} をビルド',
  'dockerInstances.create.actions.cancel': 'キャンセル',
  'dockerInstances.create.actions.create': 'インスタンスを作成',
  'dockerInstances.create.actions.creating': '作成中…',
  'dockerInstances.create.error.generic': 'インスタンスを作成できませんでした。',
  'dockerInstances.create.toast.created': 'Dockerインスタンスを作成しました。',
  'dockerInstances.create.toast.imageBuilt': 'イメージ {image} の準備ができました。',
  'dockerInstances.toast.activated': '{name} に切り替えました。',
  'dockerInstances.toast.deactivated': 'ローカルインスタンスに戻りました。',
