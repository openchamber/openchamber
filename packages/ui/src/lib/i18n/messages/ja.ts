...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.dialogs.worktreeDelete.disposition.label': 'リンクされたセッション',
  'sessions.sidebar.dialogs.worktreeDelete.disposition.archive': 'リンクされたセッションをアーカイブ',
  'sessions.sidebar.dialogs.worktreeDelete.disposition.delete': 'リンクされたセッションを完全に削除',
  'sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionOneLinked': '選択したワークツリーを削除し、{count}件のリンクされたセッションを完全に削除します。',
  'sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionManyLinked': '選択したワークツリーを削除し、{count}件のリンクされたセッションを完全に削除します。',
