...
export const dict: Record<I18nKey, string> = {
  ...
  'session.githubIssuePicker.error.searchTimedOut': '検索がタイムアウトしました。より具体的なクエリをお試しください。',
  ...
  'session.githubPrPicker.error.searchTimedOut': '検索がタイムアウトしました。より具体的なクエリをお試しください。',
  ...
  'session.githubIntegration.error.searchTimedOut': '検索がタイムアウトしました。より具体的なクエリをお試しください。',
  'session.githubIntegration.error.repoNotResolvable': 'リポジトリを解決できません',
