...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.agentCapabilities.fusion.pickerLoadError': 'フュージョンプリセットを読み込めませんでした。',
  'chat.agentCapabilities.fusion.pickerEmpty': 'フュージョンプリセットがありません。設定 → フュージョンで作成してください。',
  'chat.agentCapabilities.fusion.keyboardHint': '↑↓ 移動 • Enter 選択 • Esc 閉じる',
  'chat.agentCapabilities.inline.waitingChildren': '子セッションの開始を待っています…',
