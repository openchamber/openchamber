...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.notifications.openAria': '通知',
  'layout.notifications.openTitle': '通知',
  'layout.notifications.title': '通知',
  'layout.notifications.empty': '通知はまだありません',
  'layout.notifications.emptyFiltered': '現在のフィルターに合う通知はありません',
  'layout.notifications.markAllRead': 'すべて既読にする',
  'layout.notifications.clearAll': 'すべて削除',
  'layout.notifications.remove': '通知を削除',
  'layout.notifications.sessionSubtaskFinished': 'サブタスクが完了しました',
  'layout.notifications.sessionSubtaskError': 'サブタスクエラー',
  'layout.notifications.openSettings': '通知の設定',
  'layout.notifications.unreadCountAria': '未読の通知が {count} 件',
  'layout.notifications.sessionFinished': 'セッションが完了しました',
  'layout.notifications.sessionError': 'セッションエラー',
  'layout.notifications.permissionNeeded': '許可が必要です',
  'layout.notifications.permissionFallback': 'エージェントの承認が必要です',
  'layout.notifications.inputNeeded': '入力が必要です',
  'layout.notifications.questionFallback': 'エージェントが応答を待っています',
  'layout.notifications.openSession': 'セッションを開く',
  'layout.notifications.occurrenceCount': '×{count}',
  'layout.notifications.time.justNow': 'たった今',
  'layout.notifications.time.minutesAgo': '{count}分',
  'layout.notifications.time.hoursAgo': '{count}時間',
  'layout.notifications.time.daysAgo': '{count}日',
  'toast.action.ok': 'OK',
  'toast.action.copy': 'コピー',
