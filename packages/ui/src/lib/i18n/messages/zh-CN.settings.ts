...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.providers.sidebar.actions.reorderProviderTitle': '拖拽以重新排序提供商',
  'settings.providers.sidebar.actions.reorderProviderAria': '重新排序提供商',
  'settings.providers.sidebar.actions.enableProvider': '启用',
  'settings.providers.sidebar.section.disabled': '已禁用',
  ...
  'settings.providers.page.actions.disableProvider': '禁用',
  'settings.providers.page.actions.enableProvider': '启用',
  'settings.providers.page.badge.disabled': '已禁用',
  'settings.providers.page.badge.disabledHint': '启用前不会出现在模型选择器中。',
