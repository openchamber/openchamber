...
export const settingsDict = {
  ...
  'settings.openchamber.tunnel.field.tailscaleHttpsPort': 'Tailscale HTTPS 端口',
  'settings.openchamber.tunnel.field.tailscaleHttpsPortDescription': 'Tailscale 前端端口。Serve 可使用 1 到 65535 的任意端口；Funnel 仅支持 443、8443 或 10000。',
  'settings.openchamber.tunnel.field.tailscaleServeHttpsPortDescription': 'Serve 可使用 1 到 65535 的任意整数。',
  'settings.openchamber.tunnel.field.tailscaleFunnelHttpsPortDescription': 'Funnel 仅支持 443、8443 或 10000。',
  'settings.openchamber.tunnel.field.tailscaleHttpsPortError': '请输入 1 到 65535 之间的整数。',
  ...
  'settings.openchamber.tunnel.notAvailable.tailscaleInstallHint': '启动前请安装 Tailscale 并在此设备上登录：',
  'settings.openchamber.tunnel.option.mode.privateNetwork.label': '仅限 Tailnet (Serve)',
  'settings.openchamber.tunnel.option.mode.privateNetwork.tooltip': 'Tailscale Serve 将访问限制在你的 Tailnet 内。',
  'settings.openchamber.tunnel.option.mode.tailscaleQuick.label': '公开 (Funnel)',
  'settings.openchamber.tunnel.option.mode.tailscaleQuick.tooltip': 'Tailscale Funnel 使此实例可从公共互联网访问。',
  'settings.openchamber.tunnel.warning.tailscaleFunnelPublic': 'Tailscale Funnel 将此实例暴露在公共互联网上。仅在确实需要公开访问时使用。',
  'settings.openchamber.tunnel.badge.privateNetwork': 'Tailnet',
  'settings.openchamber.tunnel.toast.startedButNoUrl': '隧道已启动，但未返回访问 URL。',
