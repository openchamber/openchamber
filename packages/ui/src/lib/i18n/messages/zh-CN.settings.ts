...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.usage.page.window.giftResetAria': '赠送额度重置',
  'settings.usage.page.window.giftResetExpires': '赠送额度重置有效期至 {time}',
  'settings.usage.page.window.giftResetActivated': '赠送额度重置已激活',
  'settings.usage.page.window.giftResetActivateFailed': '激活赠送额度重置失败',
  'settings.usage.page.window.giftResetNotNeeded': '目前无需赠送额度重置',
