...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.field.showMessageSpeedMetricsAria': '显示消息速度指标',
  'settings.openchamber.visual.field.showMessageSpeedMetrics': '显示消息速度指标',
  'settings.openchamber.visual.field.showMessageSpeedMetricsInfo': '在每条助手消息上显示首个 token 耗时、输出吞吐，以及未缓存 / 缓存 / 输出的 token 拆分。首个 token 耗时在 OpenCode 服务器上从消息开始测到第一段推理或正文。',
