...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.scrollBehavior.title': '滚动位置',
  'settings.openchamber.scrollBehavior.description': '选择切换回会话时会话重新打开的位置。默认恢复到您上次的位置。',
  'settings.openchamber.scrollBehavior.option.restore.label': '恢复上次位置',
  'settings.openchamber.scrollBehavior.option.jumpToEnd.label': '始终跳转到最后',
  'settings.openchamber.scrollBehavior.sectionAria': '切换时会话滚动行为',
  'settings.openchamber.scrollBehavior.field.modeAria': '滚动行为：{option}',
