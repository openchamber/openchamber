...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': '粘贴 ollama.com 的会话 Cookie（在浏览器开发者工具中查找 __Secure-session=...）。这不是您的本地 Ollama API 密钥或端点。OpenChamber 绝不会扫描浏览器 Cookie 存储。',
