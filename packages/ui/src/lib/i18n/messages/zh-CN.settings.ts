...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.voice.page.field.ttsChunkedMode': 'TTS 分句模式',
  'settings.voice.page.field.ttsChunkedModeAria': 'TTS 分句模式',
  'settings.voice.page.tooltip.ttsChunked': '将长文本拆分为句子，每句合成完毕后立即播放，大幅提前开始播放的时间。关闭后则将整段文本在一次请求中合成。',
