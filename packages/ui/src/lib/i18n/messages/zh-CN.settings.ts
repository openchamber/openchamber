...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.remoteInstances.clientAuth.relayEndpoint.title': '中继服务器',
  'settings.remoteInstances.clientAuth.relayEndpoint.info': '「随处可用」配对链接与中继访问所使用的端点。指向自托管中继即可让这部分流量留在你自己的基础设施内;运行中的中继主机会立即重连到新端点。此前签发的配对链接仍使用原端点。',
  'settings.remoteInstances.clientAuth.relayEndpoint.option.default': '默认',
  'settings.remoteInstances.clientAuth.relayEndpoint.option.custom': '自定义',
  ...
  'settings.remoteInstances.clientAuth.relayEndpoint.locked': '由环境变量 OPENCHAMBER_RELAY_URL 固定:',
