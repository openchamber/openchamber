export const settingsDict = {
  ...
  'settings.page.harness.description': '选择并管理执行 Harness。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.harness.sidebar.subtitle': '聊天会话的执行后端',
  'settings.harness.sidebar.harness.opencode': 'OpenCode',
  'settings.harness.sidebar.harness.claudeCode': 'Claude Code',
  'settings.harness.sidebar.status.ready': '就绪',
  'settings.harness.sidebar.status.needsLogin': '需要登录',
  'settings.harness.sidebar.status.missingCli': '缺少 CLI',
  'settings.harness.sidebar.status.unsupportedHost': '此主机不可用',
  'settings.harness.sidebar.status.error': '错误',
  'settings.harness.sidebar.status.unknown': '未知',
  'settings.harness.sidebar.status.loading': '正在检查…',
  'settings.harness.page.empty.selectHarness': '请从侧边栏选择 Harness',
  'settings.harness.page.loadError': '无法加载Harness 状态',
  'settings.harness.opencode.title': 'OpenCode',
  'settings.harness.opencode.description': '默认 Harness。使用 OpenCode 提供商和智能体。',
  'settings.harness.opencode.section.about': '关于',
  'settings.harness.opencode.about.body': 'OpenCode 通过已配置的提供商运行模型。请在“提供商”中管理 API 密钥，在“智能体”中管理智能体设置。',
  'settings.harness.opencode.link.providers': '打开提供商',
  'settings.harness.opencode.link.agents': '打开智能体',
  'settings.harness.claudeCode.title': 'Claude Code',
  'settings.harness.claudeCode.description': '使用订阅用量限额的原生 Claude Code CLI。',
  'settings.harness.claudeCode.section.status': '状态',
  'settings.harness.claudeCode.field.status': '状态',
  ...
  'settings.harness.claudeCode.actions.redetect': '重新检测',
  'settings.harness.claudeCode.actions.redetectAria': '重新检测 Claude Code 状态',
  'settings.harness.claudeCode.actions.openDocs': '打开文档',
  'settings.harness.claudeCode.actions.openDocsAria': '打开 Claude Code 文档',
  'settings.harness.claudeCode.login.title': '登录 Claude',
  'settings.harness.claudeCode.login.body': '在此主机上安装 Claude CLI 并运行 claude login，以便 OpenChamber 使用你的 Claude 订阅。',
  'settings.harness.claudeCode.section.capabilities': '能力',
  'settings.harness.claudeCode.capabilities.empty': '成功检测后将显示能力列表。',
  'settings.harness.claudeCode.capability.full': '完全支持',
  'settings.harness.claudeCode.capability.partial': '部分支持',
  'settings.harness.claudeCode.capability.none': '不可用',
...
'settings.harness.claudeCode.warnHandoff.label': '切换 Harness 时确认',
'settings.harness.claudeCode.warnHandoff.aria': '切换 Harness 时确认',
'settings.harness.claudeCode.warnHandoff.info': '切换 Harness 时，在开始新会话之前显示对话框。关闭后，将在发送下一条消息时静默切换。',
  'settings.harness.claudeCode.section.import': '导入',
  'settings.harness.claudeCode.import.note': '将本地 Claude Code 项目和聊天导入 OpenChamber。聊天会在 Claude Code 中恢复；不会将记录复制到 OpenCode 历史中。',
  'settings.harness.claudeCode.import.actions.open': '从 Claude Code 导入',
  'settings.harness.claudeCode.import.actions.openAria': '打开 Claude Code 导入对话框',
  'settings.harness.claudeCode.import.dialog.title': '从 Claude Code 导入',
  'settings.harness.claudeCode.import.dialog.description': '选择此主机上 Claude Code 项目文件夹中的聊天。已导入的聊天会被跳过。',
  'settings.harness.claudeCode.import.dialog.loading': '正在扫描 Claude Code 项目…',
  'settings.harness.claudeCode.import.dialog.empty': '此主机上未找到 Claude Code 聊天。',
  'settings.harness.claudeCode.import.dialog.selectAll': '全选',
  'settings.harness.claudeCode.import.dialog.selectAllAria': '选择所有可导入的 Claude Code 聊天',
  'settings.harness.claudeCode.import.dialog.selectedCount': '已选择 {count} 项',
  'settings.harness.claudeCode.import.dialog.projectAria': '选择 {name} 中的所有聊天',
  'settings.harness.claudeCode.import.dialog.sessionAria': '选择聊天 {title}',
  'settings.harness.claudeCode.import.dialog.sessionCount': '{count} 个聊天',
  'settings.harness.claudeCode.import.dialog.directoryMissing': '文件夹缺失',
  'settings.harness.claudeCode.import.dialog.alreadyImported': '已导入',
  'settings.harness.claudeCode.import.dialog.untitled': '未命名聊天',
  'settings.harness.claudeCode.import.dialog.cancel': '取消',
  'settings.harness.claudeCode.import.dialog.import': '导入（{count}）',
  'settings.harness.claudeCode.import.dialog.importing': '正在导入…',
  'settings.harness.claudeCode.import.error.load': '无法扫描 Claude Code 项目。',
  'settings.harness.claudeCode.import.error.import': '导入失败。',
  'settings.harness.claudeCode.import.toast.success': '已导入 {count} 个 Claude Code 聊天。',
  'settings.harness.claudeCode.import.toast.skippedOnly': '已跳过 {count} 个已导入的聊天。',
  'settings.harness.claudeCode.import.toast.partialFail': '已导入 {imported} 个；失败 {failed} 个。',
  'settings.harness.claudeCode.import.toast.none': '未导入任何内容。',
  'settings.harness.claudeCode.section.apiKeys': 'API 密钥',
  'settings.harness.claudeCode.apiKeys.note': 'Anthropic API 密钥仍在 OpenCode 的“提供商”中配置。Claude Code 使用主机上的 Claude 订阅登录。',
  'settings.harness.capability.prompt': '提示',
  'settings.harness.capability.abort': '中止',
  'settings.harness.capability.resume': '恢复',
  'settings.harness.capability.streaming-text': '文本流式传输',
  'settings.harness.capability.streaming-tools': '工具流式传输',
  'settings.harness.capability.permissions': '权限',
  'settings.harness.capability.images': '图片',
  'settings.harness.capability.file-attachments': '文件附件',
  'settings.harness.capability.shell': 'Shell',
  'settings.harness.capability.slash-commands': '斜杠命令',
  'settings.harness.capability.mcp': 'MCP',
  'settings.harness.capability.subagents': '子智能体',
