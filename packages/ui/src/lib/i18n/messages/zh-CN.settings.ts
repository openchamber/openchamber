...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.worktrees.list.archiveWorktreeAria': '归档工作树 {name}',
  'settings.openchamber.worktrees.list.archiveSuccess': '工作树已归档',
  'settings.openchamber.worktrees.list.archiveFailed': '归档工作树失败',
  'settings.openchamber.worktrees.list.archivePartial': '工作树已归档，但 {fail}/{total} 个会话归档失败',
  'settings.openchamber.worktrees.archived.title': '已归档的工作树',
  'settings.openchamber.worktrees.archived.restoreWorktreeAria': '恢复工作树 {name}',
  'settings.openchamber.worktrees.archived.restoreSuccess': '工作树已恢复',
  'settings.openchamber.worktrees.archived.restoreFailed': '恢复工作树失败',
  'settings.openchamber.worktrees.archived.restorePartial': '工作树已恢复，但 {fail}/{total} 个会话恢复失败',
