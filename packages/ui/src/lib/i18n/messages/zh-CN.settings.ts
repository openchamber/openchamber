...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.field.worktreeDiscovery': '自动检查 Git worktree',
  'settings.openchamber.visual.field.worktreeDiscoveryAria': '切换自动检查 Git worktree',
  'settings.openchamber.visual.field.worktreeDiscoveryInfo': '开启后，OpenChamber 会检查当前项目和存在活跃会话的项目。关闭后，已有 worktree 仍可继续使用。',
  'settings.openchamber.visual.field.worktreeDiscoveryInterval': 'Git worktree 自动检查最短间隔',
