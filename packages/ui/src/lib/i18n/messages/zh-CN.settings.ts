export const settingsDict = {
  ...
  'settings.openchamber.tunnel.readOnly.title': '只读隧道状态',
  'settings.openchamber.tunnel.readOnly.description': '隧道管理可从主机桌面或经过身份验证的浏览器会话中进行。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.remoteInstances.clientAuth.state.viaManagedDirectE2ee': '托管直连 E2EE',
  'settings.remoteInstances.clientAuth.state.connectedManagedDirectE2ee': '已连接 · 托管直连 E2EE',
  'settings.remoteInstances.clientAuth.addDevice.transport.managedE2ee': '托管直连 E2EE',
  'settings.remoteInstances.clientAuth.addDevice.transport.managedE2eeHint': '由该服务器管理的端到端加密隧道。从主机桌面或经过身份验证的浏览器会话进行管理。',
  ...
  'settings.openchamber.tunnel.field.directE2eeLabel': '原生应用端到端加密',
  'settings.openchamber.tunnel.field.directE2eeDescription': '通过 Cloudflare 的流量在原生应用和此 OpenChamber 主机之间进行加密。',
  'settings.openchamber.tunnel.field.directE2eeUnsupported': '需要支持直接 E2EE 的客户端版本。',
  'settings.openchamber.tunnel.field.nativePairingLabel': '原生应用配对',
  'settings.openchamber.tunnel.field.nativePairingDescription': '使用端到端加密配对原生移动或桌面应用。',
  'settings.openchamber.tunnel.actions.openAddDevice': '添加设备',
  'settings.openchamber.tunnel.field.browserAccessLabel': '浏览器访问',
  'settings.openchamber.tunnel.field.browserQrAlt': '浏览器访问二维码',
  'settings.openchamber.tunnel.note.scanQrToConnectBrowser': '使用移动浏览器扫描此二维码进行连接。',
  'settings.openchamber.tunnel.toast.directE2eeSaved': '直接 E2EE 设置已保存',
  'settings.openchamber.tunnel.toast.directE2eeSaveFailed': '保存直接 E2EE 设置失败',
  'settings.remoteInstances.transport.managedE2ee.label': '托管隧道 (E2EE)',
  'settings.remoteInstances.transport.managedE2ee.description': '通过托管的 Cloudflare 隧道安全连接。',
  'settings.remoteInstances.transport.managedE2ee.note': '此连接在您的托管隧道上使用端到端加密。',
} as const;
