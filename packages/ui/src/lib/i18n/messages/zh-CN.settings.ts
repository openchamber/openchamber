...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.field.messageSpeedMetrics': '显示响应速度指标',
  'settings.openchamber.visual.field.messageSpeedMetricsAria': '在完成的回复下方显示响应速度指标',
  'settings.openchamber.visual.field.messageSpeedMetricsInfo': '在完成的回复下方显示 TTFT（首 token 延迟）和每秒输出 token 数，便于对比不同服务商和中转。',
