...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.field.contextPanelDockHint': '移动整个上下文面板，而不仅仅是终端：终端、更改、差异、文件、笔记等所有视图都会停靠到聊天栏所选的一侧。',
  'settings.openchamber.visual.option.contextPanelDock.right': '右侧',
