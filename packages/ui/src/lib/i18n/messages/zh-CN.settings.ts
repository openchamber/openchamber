...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.projects.codexImport.action': '导入 Codex 对话',
  'settings.projects.codexImport.title': '从 Codex 导入',
  'settings.projects.codexImport.description': '添加 Codex 项目，并将每条对话保存为可阅读的 OpenCode 记录。不会修改 Codex 原始数据。',
  'settings.projects.codexImport.loading': '正在读取 Codex 项目和对话...',
  'settings.projects.codexImport.error.inspect': '读取 Codex 数据失败。',
  'settings.projects.codexImport.error.apply': '导入 Codex 数据失败。',
  'settings.projects.codexImport.config.model': '模型：{model}',
  'settings.projects.codexImport.config.provider': '提供商：{provider}',
  'settings.projects.codexImport.config.unset': '未设置',
  'settings.projects.codexImport.projects.title': '要导入的项目',
  'settings.projects.codexImport.projects.conversations': '对话数：{count}',
  'settings.projects.codexImport.projects.missing': '目录已不可用',
  'settings.projects.codexImport.empty': '未找到 Codex 项目或对话。',
  'settings.projects.codexImport.actions.retry': '重试',
  'settings.projects.codexImport.actions.selectAll': '全选',
  'settings.projects.codexImport.actions.selectNone': '全不选',
  'settings.projects.codexImport.actions.importing': '正在导入...',
  'settings.projects.codexImport.result.summary': '已导入 {imported} 条，跳过 {skipped} 条，失败 {failed} 条。',
  'settings.projects.codexImport.toast.partial': 'Codex 导入完成：导入 {imported} 条，跳过 {skipped} 条，失败 {failed} 条。',
  'settings.projects.codexImport.toast.complete': 'Codex 导入完成：导入 {imported} 条，已有 {skipped} 条。',
