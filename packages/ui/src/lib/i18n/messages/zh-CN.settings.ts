...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  "settings.analytics.scope.project": "此项目",
  "settings.analytics.scope.all": "所有项目",
  "settings.analytics.period.groupLabel": "时间范围",
  "settings.analytics.period.7d": "7 天",
  "settings.analytics.period.30d": "30 天",
  "settings.analytics.period.90d": "90 天",
  "settings.analytics.period.all": "全部时间",
  "settings.analytics.action.refresh": "刷新",
  "settings.analytics.state.errorTitle": "分析加载失败",
  "settings.analytics.state.empty": "所选范围内没有会话数据",
  "settings.analytics.kpi.sectionTitle": "概览",
  "settings.analytics.kpi.tokens": "令牌",
  "settings.analytics.kpi.cost": "费用",
  "settings.analytics.kpi.sessions": "会话",
  "settings.analytics.kpi.activeDays": "活跃天数",
  "settings.analytics.kpi.streak": "连续天数",
  "settings.analytics.quota.title": "提供商配额",
  "settings.analytics.quota.none": "未配置提供商",
  "settings.analytics.quota.manage": "管理速率限制",
  "settings.analytics.topSessions.title": "热门会话",
  "settings.analytics.topSessions.open": "打开会话",
  "settings.analytics.topSessions.empty": "所选范围内没有会话",
  "settings.analytics.tab.trends": "趋势",
  "settings.analytics.kpi.deltaUp": "↑ +{value}% 较上一周期",
  "settings.analytics.kpi.deltaDown": "↓ {value}% 较上一周期",
  "settings.analytics.kpi.deltaNew": "新增",
  "settings.analytics.kpi.deltaFlat": "—",
  "settings.analytics.kpi.cacheHitRate": "缓存命中率",
  "settings.analytics.trends.metric.tokens": "令牌",
  "settings.analytics.trends.metric.cost": "费用",
  "settings.analytics.trends.metric.sessions": "会话",
  "settings.analytics.trends.tokenBreakdown.title": "令牌明细",
  "settings.analytics.trends.tokenBreakdown.ariaLabel": "令牌明细随时间变化",
  "settings.analytics.trends.tokenBreakdown.prompt": "提示",
  "settings.analytics.trends.tokenBreakdown.completion": "补全",
  "settings.analytics.trends.tokenBreakdown.reasoning": "推理",
  "settings.analytics.trends.tokenBreakdown.cached": "已缓存",
  "settings.analytics.trends.cache.title": "提示缓存",
  "settings.analytics.trends.cache.ariaLabel": "提示缓存随时间变化",
  "settings.analytics.trends.cache.cached": "已缓存",
  "settings.analytics.trends.cache.uncached": "未缓存",
  "settings.analytics.trends.byModel.other": "其他",
  "settings.analytics.yearHeatmap.title": "活动",
  ...
  "settings.analytics.summary.view.aria": "视图",
  "settings.analytics.summary.chartToggleAria": "在柱状图和折线图之间切换",
  "settings.analytics.summary.chartType.bar": "柱状图",
  "settings.analytics.summary.chartType.line": "折线图",
  "settings.analytics.activity.longestStreak": "最长连续",
  "settings.analytics.activity.avgPerDay": "平均 / 天",
  "settings.analytics.activity.avgPerWeek": "平均 / 周",
  "settings.analytics.activity.total": "总计",
  "settings.analytics.activity.days": "天",
  "settings.analytics.chart.sessionsPerDay": "每日会话",
  "settings.analytics.chart.costPerDay": "每日费用",
  "settings.analytics.efficiency.title": "效率",
  "settings.analytics.efficiency.costPerMillion": "$ / 100万 tokens",
  "settings.analytics.efficiency.costPerSession": "费用 / 会话",
  "settings.analytics.efficiency.tokensPerSession": "Tokens / 会话",
  "settings.analytics.efficiency.reasoningShare": "推理占比",
  "settings.analytics.efficiency.avgDuration": "平均时长",
  "settings.analytics.efficiency.medianDuration": "中位时长",
  "settings.analytics.efficiency.longestDuration": "最长时长",
  "settings.analytics.agents.title": "代理使用",
  "settings.analytics.agents.empty": "暂无代理数据",
  "settings.analytics.rhythm.title": "活动节奏",
  "settings.analytics.rhythm.hoursAria": "按小时统计活动",
