export const settingsDict = {
  ...
  'settings.page.sessions.description': '设置会话默认值、权限处理和保留策略。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.permissionAutoAccept.title': '权限自动接受',
  'settings.openchamber.permissionAutoAccept.info': '它会应用到此运行时中的所有会话，除非某个会话显式启用或禁用自己的权限策略。开启后也会立即处理已经待定的权限请求。',
  'settings.openchamber.permissionAutoAccept.field.globalLabel': '自动批准此运行时中所有会话的权限请求',
  'settings.openchamber.permissionAutoAccept.field.globalAria': '自动批准此运行时中所有会话的权限请求',
  'settings.openchamber.permissionAutoAccept.field.globalWarning': '安全性：在某个会话显式覆盖此策略之前，OpenChamber 会在不询问你的情况下批准当前待定和后续的权限请求。',
  'settings.openchamber.permissionAutoAccept.dialog.title': '为所有会话开启权限自动接受？',
  'settings.openchamber.permissionAutoAccept.dialog.description': 'OpenChamber 会立即批准已经待定的权限请求，并会继续在此运行时中批准新的请求，直到某个会话显式覆盖该策略。仅应在受信任的运行时中开启。',
  'settings.openchamber.permissionAutoAccept.dialog.confirm': '开启自动接受',
