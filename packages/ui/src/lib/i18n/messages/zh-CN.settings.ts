...
export const settingsDict = {
  ...
  'settings.magicPrompts.sidebar.item.gitlabPrReview': 'MR 审查',
  'settings.magicPrompts.sidebar.item.gitlabIssueReview': 'Issue 审查',
  'settings.magicPrompts.sidebar.item.giteaPrReview': 'PR 审查',
  'settings.magicPrompts.sidebar.item.giteaIssueReview': 'Issue 审查',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.gitea.page.title': 'Gitea / Forgejo 个人访问令牌',
  'settings.gitea.page.description': '粘贴 Gitea 或 Forgejo 个人访问令牌以连接。使用自托管 Gitea 或 Forgejo 实例时，请设置基础 URL。',
  'settings.gitea.page.tooltip.connectAccount': '连接 Gitea 或 Forgejo 账户，以便在应用内使用 Issue 和 Pull Request 工作流。',
  'settings.gitea.page.accessToken.label': '个人访问令牌',
  'settings.gitea.page.accessToken.placeholder': '粘贴你的 Gitea 个人访问令牌',
  'settings.gitea.page.baseUrl.label': '基础 URL（可选）',
  'settings.gitea.page.baseUrl.placeholder': 'https://gitea.example.com',
  'settings.gitea.page.actions.connect': '连接 Gitea',
  'settings.gitea.page.actions.disconnect': '断开连接',
  'settings.gitea.page.actions.switch': '切换到',
  'settings.gitea.page.status.notConnected': '未连接',
  'settings.gitea.page.label.unknownUser': '未知',
  'settings.gitea.page.label.otherAccounts': '其他账户',
  'settings.gitea.page.avatarAlt.withLogin': '{login} 的头像',
  'settings.gitea.page.avatarAlt.fallback': 'Gitea 头像',
  'settings.gitea.page.connectedAs': '已连接为',
  'settings.gitea.page.errors.invalidToken': '请输入有效的 Gitea 个人访问令牌',
  'settings.gitea.page.errors.failed': '连接 Gitea 失败',
  'settings.gitea.page.toast.connected': 'Gitea 已连接',
  'settings.gitea.page.toast.disconnected': 'Gitea 已断开连接',
  ...
  'settings.magicPrompts.page.group.gitlabPrReview.title': 'MR 审查',
  'settings.magicPrompts.page.group.gitlabPrReview.description': '用于 GitLab MR 审查流程的提示词：可见用户消息 + 隐藏指令负载。',
  'settings.magicPrompts.page.group.gitlabIssueReview.title': 'Issue 审查',
  'settings.magicPrompts.page.group.gitlabIssueReview.description': '用于 GitLab Issue 审查流程的提示词：可见用户消息 + 隐藏指令负载。',
  'settings.magicPrompts.page.group.giteaPrReview.title': 'PR 审查',
  'settings.magicPrompts.page.group.giteaPrReview.description': '用于 Gitea PR 审查流程的提示词：可见用户消息 + 隐藏指令负载。',
  'settings.magicPrompts.page.group.giteaIssueReview.title': 'Issue 审查',
  'settings.magicPrompts.page.group.giteaIssueReview.description': '用于 Gitea Issue 审查流程的提示词：可见用户消息 + 隐藏指令负载。',
