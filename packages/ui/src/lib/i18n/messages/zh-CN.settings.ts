...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.keyboardShortcuts.action.cycle_session_previous.label': '上一个会话',
  'settings.openchamber.keyboardShortcuts.action.cycle_session_next.label': '下一个会话',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_1.label': '切换到第 1 个最近会话',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_2.label': '切换到第 2 个最近会话',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_3.label': '切换到第 3 个最近会话',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_4.label': '切换到第 4 个最近会话',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_5.label': '切换到第 5 个最近会话',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_6.label': '切换到第 6 个最近会话',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_7.label': '切换到第 7 个最近会话',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_8.label': '切换到第 8 个最近会话',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_9.label': '切换到第 9 个最近会话',
  'settings.openchamber.keyboardShortcuts.action.cycle_instance_previous.label': '上一个实例',
  'settings.openchamber.keyboardShortcuts.action.cycle_instance_next.label': '下一个实例',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_1.label': '切换到实例 1',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_2.label': '切换到实例 2',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_3.label': '切换到实例 3',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_4.label': '切换到实例 4',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_5.label': '切换到实例 5',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_6.label': '切换到实例 6',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_7.label': '切换到实例 7',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_8.label': '切换到实例 8',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_9.label': '切换到实例 9',
