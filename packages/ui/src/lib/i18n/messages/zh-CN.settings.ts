...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.worktrees.start.label': '启动命令',
  'settings.openchamber.worktrees.start.commandPlaceholder': '例如：./scripts/run.sh',
  'settings.openchamber.worktrees.start.addCommand': '添加命令',
  'settings.openchamber.worktrees.start.removeCommandAria': '移除命令',
  'settings.openchamber.worktrees.start.toast.saveFailed': '保存启动命令失败',
  'settings.openchamber.worktrees.shutdown.label': '关闭命令',
  'settings.openchamber.worktrees.shutdown.commandPlaceholder': '例如：./scripts/stop.sh',
  'settings.openchamber.worktrees.shutdown.addCommand': '添加命令',
  'settings.openchamber.worktrees.shutdown.removeCommandAria': '移除命令',
  'settings.openchamber.worktrees.shutdown.toast.saveFailed': '保存关闭命令失败',
  'settings.openchamber.worktrees.commands.runStartAria': '为 {name} 运行启动命令',
  'settings.openchamber.worktrees.commands.runShutdownAria': '为 {name} 运行关闭命令',
  'settings.openchamber.worktrees.commands.viewSetupLogAria': '查看 {name} 的初始化输出',
  'settings.openchamber.worktrees.commands.noCommands': '此项目未配置{kind}。',
  'settings.openchamber.worktrees.commands.dialogTitleStart': '启动命令 — {name}',
  'settings.openchamber.worktrees.commands.dialogTitleShutdown': '关闭命令 — {name}',
  'settings.openchamber.worktrees.commands.dialogTitleSetup': '初始化输出 — {name}',
  'settings.openchamber.worktrees.commands.dialogRunning': '正在运行...',
  'settings.openchamber.worktrees.commands.dialogFailed': '命令执行失败',
  'settings.openchamber.worktrees.commands.dialogTimedOut': '命令超出时间限制 — 显示已产生的输出。',
  'settings.openchamber.worktrees.commands.dialogEmptyOutput': '无输出。',
  'settings.openchamber.worktrees.commands.dialogClose': '关闭',
