export const settingsDict = {
  ...
  'settings.page.fusion.description': '用于模型融合的精选模型面板。',
  'settings.fusion.empty': '还没有预设。添加第一个。',
  'settings.fusion.add': '添加预设',
  'settings.fusion.edit': '编辑',
  'settings.fusion.delete': '删除',
  'settings.fusion.deleteTitle': '删除融合预设',
  'settings.fusion.deleteConfirm': '删除预设 {name}？',
  'settings.fusion.dialogTitleNew': '新建融合预设',
  'settings.fusion.dialogTitleEdit': '编辑融合预设',
  'settings.fusion.dialogDescription': '包含 2-4 个模型的命名面板。',
  'settings.fusion.nameLabel': '名称',
  'settings.fusion.descriptionLabel': '描述',
  'settings.fusion.modelsLabel': '模型（{count}/4）',
  'settings.fusion.modelsHint': '选择 2-4 个模型。',
  'settings.fusion.searchModels': '搜索模型',
  'settings.fusion.noModelResults': '没有匹配搜索条件的模型。',
  'settings.fusion.save': '保存',
  'settings.fusion.cancel': '取消',
  'settings.fusion.loading': '加载中…',
  'settings.fusion.loadError': '加载预设失败：{error}',
  'settings.fusion.noModels': '此目录未配置任何模型。',
  'settings.fusion.required': '需要名称 + 2-4 个模型。',
