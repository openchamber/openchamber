...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.field.worktreeDiscovery': '自动发现 Git worktree',
  'settings.openchamber.visual.field.worktreeDiscoveryAria': '切换自动发现 Git worktree',
  'settings.openchamber.visual.field.worktreeDiscoveryInfo': '开启后，侧边栏会为当前项目和存在活跃会话的项目发现 Git worktree。',
  'settings.openchamber.visual.field.worktreeDiscoveryInterval': 'Worktree 发现刷新间隔',
  'settings.openchamber.visual.field.worktreeDiscoveryIntervalAria': '选择 Worktree 发现刷新间隔',
  'settings.openchamber.visual.field.worktreeDiscoveryIntervalInfo': '自动发现两次运行之间的最短间隔。新的项目或会话事件会等到间隔结束后再处理。',
