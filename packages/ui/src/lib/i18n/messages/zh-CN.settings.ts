...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.field.worktreeDiscovery': '自动检查项目 Git 状态和 worktree',
  'settings.openchamber.visual.field.worktreeDiscoveryAria': '切换自动检查项目 Git 状态',
  'settings.openchamber.visual.field.worktreeDiscoveryInfo': '默认关闭。开启后，OpenChamber 会检查当前项目和存在活跃会话的项目。关闭后，已有 Git 信息仍可继续使用。',
  'settings.openchamber.visual.field.worktreeDiscoveryInterval': '自动 Git 检查最短间隔',
  'settings.openchamber.visual.field.worktreeDiscoveryIntervalAria': '选择 Worktree 发现刷新间隔',
  'settings.openchamber.visual.field.worktreeDiscoveryIntervalInfo': '自动检查两次运行之间的最短时间；“立即（不额外等待）”表示事件触发后不会再增加等待。',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.0': '立即（不额外等待）',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.30000': '30 秒',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.60000': '1 分钟',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.300000': '5 分钟',
  'settings.openchamber.visual.field.backgroundProjectSessionLoading': '后台加载所有项目的会话',
  'settings.openchamber.visual.field.backgroundProjectSessionLoadingAria': '切换后台加载所有项目会话',
  'settings.openchamber.visual.field.backgroundProjectSessionLoadingInfo': '默认关闭。开启后，OpenChamber 会在后台加载侧边栏中所有项目的会话数据。关闭后只加载当前项目、已展开项目或存在活跃会话的项目。',
