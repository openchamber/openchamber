...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.field.worktreeDiscoveryInfo': '开启后，OpenChamber 会检查当前项目和存在活跃会话的项目。关闭后，已有 Git 信息仍可继续使用。',
  ...
  'settings.openchamber.visual.field.backgroundProjectSessionLoadingInfo': '开启后，OpenChamber 会在后台加载侧边栏中所有项目的会话数据。关闭后只加载当前项目、已展开项目或存在活跃会话的项目。',
