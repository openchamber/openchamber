...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.defaults.field.defaultDirectory': '默认目录',
  'settings.openchamber.defaults.field.defaultDirectoryHint': '未选择目录时，新会话将在此目录中开始。留空以保持当前行为。',
  'settings.openchamber.defaults.field.defaultDirectoryPlaceholder': '留空则使用当前目录',
  'settings.openchamber.defaults.actions.browseDirectory': '浏览',
  'settings.openchamber.defaults.actions.browseDirectoryAria': '浏览目录',
