...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.providers.copilotGhe.clientIdPlaceholder': '留空以使用默认值',
  'settings.providers.copilotGhe.clientIdHint': '将 Client ID 留空可使用 OpenChamber 默认值（{clientId}）。',
  'settings.providers.copilotGhe.status.authorizationPending': '授权仍在等待中。请在浏览器中完成设备流程，然后再次点击“完成”。',
  'settings.providers.copilotGhe.status.slowDown': 'GitHub Enterprise Server 要求降低轮询频率。请稍候后再次点击“完成”。',
  'settings.providers.copilotGhe.toast.serverUrlRequired': '服务器 URL 为必填项',
  'settings.providers.copilotGhe.toast.startFirst': '请先启动设备流程',
  'settings.providers.copilotGhe.toast.startFailed': '启动 GitHub Enterprise Server 认证流程失败',
  'settings.providers.copilotGhe.toast.completeFailed': '完成 GitHub Enterprise Server 认证流程失败',
  'settings.providers.copilotGhe.toast.authorizationPending': '授权仍在等待中',
  'settings.providers.copilotGhe.toast.slowDown': 'GitHub Enterprise Server 请求减慢速度',
  'settings.providers.copilotGhe.toast.connected': 'GitHub Enterprise Server 已连接',
