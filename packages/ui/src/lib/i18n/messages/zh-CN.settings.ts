...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.engines.claudeCode.agentsMode.aria': '为 Claude Code 会话选择 Claude 或 OpenCode 代理',
  'settings.engines.claudeCode.agentsMode.info': 'Claude 使用 Claude Code 原生系统提示与权限。OpenCode 在 Claude 会话中使用 OpenChamber 代理的权限与系统提示。',
  ...
  'settings.engines.claudeCode.section.import': '导入',
  'settings.engines.claudeCode.import.note': '将本地 Claude Code 项目和聊天导入 OpenChamber。聊天会在 Claude Code 中恢复；不会将记录复制到 OpenCode 历史中。',
  'settings.engines.claudeCode.import.actions.open': '从 Claude Code 导入',
  'settings.engines.claudeCode.import.actions.openAria': '打开 Claude Code 导入对话框',
  'settings.engines.claudeCode.import.dialog.title': '从 Claude Code 导入',
  'settings.engines.claudeCode.import.dialog.description': '选择此主机上 Claude Code 项目文件夹中的聊天。已导入的聊天会被跳过。',
  'settings.engines.claudeCode.import.dialog.loading': '正在扫描 Claude Code 项目…',
  'settings.engines.claudeCode.import.dialog.empty': '此主机上未找到 Claude Code 聊天。',
  'settings.engines.claudeCode.import.dialog.selectAll': '全选',
  'settings.engines.claudeCode.import.dialog.selectAllAria': '选择所有可导入的 Claude Code 聊天',
  'settings.engines.claudeCode.import.dialog.selectedCount': '已选择 {count} 项',
  'settings.engines.claudeCode.import.dialog.projectAria': '选择 {name} 中的所有聊天',
  'settings.engines.claudeCode.import.dialog.sessionAria': '选择聊天 {title}',
  'settings.engines.claudeCode.import.dialog.sessionCount': '{count} 个聊天',
  'settings.engines.claudeCode.import.dialog.directoryMissing': '文件夹缺失',
  'settings.engines.claudeCode.import.dialog.alreadyImported': '已导入',
  'settings.engines.claudeCode.import.dialog.untitled': '未命名聊天',
  'settings.engines.claudeCode.import.dialog.cancel': '取消',
  'settings.engines.claudeCode.import.dialog.import': '导入（{count}）',
  'settings.engines.claudeCode.import.dialog.importing': '正在导入…',
  'settings.engines.claudeCode.import.error.load': '无法扫描 Claude Code 项目。',
  'settings.engines.claudeCode.import.error.import': '导入失败。',
  'settings.engines.claudeCode.import.toast.success': '已导入 {count} 个 Claude Code 聊天。',
  'settings.engines.claudeCode.import.toast.skippedOnly': '已跳过 {count} 个已导入的聊天。',
  'settings.engines.claudeCode.import.toast.partialFail': '已导入 {imported} 个；失败 {failed} 个。',
  'settings.engines.claudeCode.import.toast.none': '未导入任何内容。',
