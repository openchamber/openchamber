export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': '从控制面板网址复制工作区 ID，并从浏览器开发者工具复制 auth Cookie。Sharpie 绝不会扫描浏览器 Cookie 存储。',
  ...
  'settings.window.description': 'Sharpie 设置窗口。',
  ...
  'settings.page.appearance.description': '自定义 Sharpie 的外观与体验。',
  ...
  'settings.remoteInstances.direct.title': '其他 Sharpie 服务器',
  'settings.remoteInstances.direct.description': '此应用可切换到的服务器。从另一台服务器导入配对链接，或通过地址添加。',
  'settings.remoteInstances.direct.addDialog.description': '通过 URL 添加另一个 Sharpie 服务器。适用于服务器已在运行且你拥有连接令牌的情况。',
  ...
  'settings.remoteInstances.direct.import.description': '粘贴来自另一个 Sharpie 服务器的连接链接。',
  'settings.remoteInstances.direct.import.placeholder': 'openchamber://connect?...',
  'settings.remoteInstances.direct.import.action': '导入链接',
  'settings.remoteInstances.direct.error.invalidConnectLink': '无效的 Sharpie 连接链接。',
  ...
  'settings.remoteInstances.clientAuth.description': '创建安全链接或令牌，让 Sharpie Desktop 可以连接到此服务器。',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': '用另一台设备上的 Sharpie 应用扫描。一次性使用且会过期。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': '在家和外出都可用。外出时流量经由 Sharpie Private Relay(端到端加密隧道)传输，无需配置。',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': '用其他设备上的 Sharpie 应用扫描此二维码。',
  ...
  'settings.remoteInstances.page.field.modeHint': '选择是由 Sharpie 为你启动服务器，还是连接到已在运行的服务器。',
  ...
  'settings.remoteInstances.page.field.keepServerRunningHint': '断开连接后仍让 Sharpie 在远程机器上运行。',
  ...
  'settings.openchamber.about.title': '关于 Sharpie',
  ...
  'settings.skills.catalog.add.descriptionPrefix': '将 Git 仓库添加为新的目录来源。Sharpie 会扫描其中包含',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '登录时启动 Sharpie',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '登录时启动 Sharpie',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '在后台启动应用且不打开窗口。可通过桌面状态图标打开。',
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': '在 macOS 菜单栏中显示 Sharpie',
  'settings.openchamber.desktopNetwork.field.macMenuBar': '在菜单栏中显示 Sharpie',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': '需要重启应用。关闭后，Sharpie 不会创建菜单栏项目，也不会运行相关的会话、审批和用量更新。',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': '将 Sharpie 最小化和关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '最小化和关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '主窗口最小化或关闭时，让 Sharpie 继续在系统托盘中运行。',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Sharpie 运行时保持电脑唤醒',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Sharpie 运行时保持电脑唤醒',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Sharpie 会在重启后要求输入密码，之后在登录会话过期时再次要求：12 小时后，或选择“信任此设备”后 7 天。留空可关闭登录。',
  ...
  'settings.remoteInstances.page.description': '通过 SSH 连接到另一台机器，并在那里打开 Sharpie。',
  ...
  'settings.remoteInstances.page.section.remoteServer': '远程机器上的 Sharpie',
  'settings.remoteInstances.page.section.remoteServerDescription': '选择 SSH 连接后 Sharpie 的运行方式。',
  'settings.remoteInstances.page.section.mainTunnel': '本地访问',
  'settings.remoteInstances.page.section.mainTunnelDescription': '选择用于打开此远程 Sharpie 服务器的本地地址。',
  'settings.remoteInstances.page.section.authentication': '认证',
  'settings.remoteInstances.page.section.authenticationDescription': 'SSH 和远程 Sharpie UI 的可选凭据。',
  ...
  'settings.remoteInstances.page.field.installMethodHint': '当此应用为你启动 Sharpie 时，如何将它放到远程机器上。',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': '正在安装 Sharpie',
  'settings.remoteInstances.page.phase.updatingOpenChamber': '正在更新 Sharpie',
  ...
  'settings.providers.page.custom.field.apiKey.info': '保存在 OpenCode 认证中，而非 Sharpie。使用 {env:VAR_NAME} 可从环境变量读取密钥。',
  ...
  'settings.providers.page.auth.apiKeyTooltip': '密钥将直接发送给 OpenCode，不会被 Sharpie 存储。',
  ...
  'settings.github.page.flow.title': '授权 Sharpie',
  ...
  'settings.github.page.ghCli.fallbackDescription': '在 Sharpie 认证被移除时可作为备用',
  ...
  'settings.notifications.page.testNotification.body': '这是来自 Sharpie 的测试通知。',
  ...
  'settings.voice.page.tooltip.sttLocal': '在 Sharpie 服务器上本地转写。模型自动下载，无需 API 密钥。',
  'settings.voice.page.tooltip.localTts': '在 Sharpie 服务器上本地合成语音（Kokoro，英语）。模型自动下载，无需 API 密钥。',
