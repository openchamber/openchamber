...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'Paste the session cookie from ollama.com (look for __Secure-session=... in your browser developer tools). This is not your local Ollama API key or endpoint. OpenChamber never scans browser cookie storage.',
