...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'Copy the full Cookie header from the request headers in your browser developer tools on ollama.com, then paste it here. Only the session cookie is stored and sent: wos-session=..., or __Secure-session=... on older accounts. Other cookies in the header are not forwarded. This is not a local Ollama API key or endpoint. OpenChamber never scans browser cookie storage.',
  'settings.providers.page.ollamaCloud.cookie': 'Cookie header',
