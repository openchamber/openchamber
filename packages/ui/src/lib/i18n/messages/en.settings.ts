...
export const settingsDict = {
  ...
  'settings.openchamber.agentBrowser.title': 'Agent Browser',
  'settings.openchamber.agentBrowser.status.loading': 'Checking browser…',
  'settings.openchamber.agentBrowser.status.unknown': 'Browser status is unavailable.',
  'settings.openchamber.agentBrowser.status.ready': 'Ready: {path}',
  'settings.openchamber.agentBrowser.status.missing': 'No Chrome-compatible browser found on this host.',
  'settings.openchamber.agentBrowser.status.missingPath': 'The configured browser path does not exist.',
  'settings.openchamber.agentBrowser.status.host': 'Host: {platform}/{arch}',
  'settings.openchamber.agentBrowser.field.binaryPath': 'Browser executable',
  'settings.openchamber.agentBrowser.field.binaryPathPlaceholder': '/usr/bin/google-chrome-stable',
  'settings.openchamber.agentBrowser.field.binaryPathInfo': 'Absolute path to Chrome, Chromium, Edge, or Brave. Leave empty to use a managed install, OPENCHAMBER_BROWSER_PATH, or automatic discovery. Applies after Save.',
  'settings.openchamber.agentBrowser.field.noSandbox': 'Disable browser sandbox',
  'settings.openchamber.agentBrowser.field.noSandboxAria': 'Disable Chromium sandbox for headless hosts',
  'settings.openchamber.agentBrowser.field.noSandboxInfo': 'Required on many headless servers, containers, and root environments where Chromium user-namespace sandboxing is unavailable. Equivalent to OPENCHAMBER_BROWSER_NO_SANDBOX=true.',
  'settings.openchamber.agentBrowser.field.noSandboxRecommended': 'Recommended on this host (container or root).',
  'settings.openchamber.agentBrowser.actions.browseAria': 'Browse for browser executable',
  'settings.openchamber.agentBrowser.actions.save': 'Save',
  'settings.openchamber.agentBrowser.actions.saving': 'Saving…',
  'settings.openchamber.agentBrowser.actions.install': 'Install Chrome',
  'settings.openchamber.agentBrowser.actions.installing': 'Installing…',
  'settings.openchamber.agentBrowser.actions.installUnsupported': 'Managed install is not available on this platform.',
