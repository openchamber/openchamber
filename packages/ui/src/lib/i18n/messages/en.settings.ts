export const settingsDict = {
  ...
  'settings.openchamber.sidebar.emptyState.title': 'Sidebar Empty State',
  'settings.openchamber.sidebar.emptyState.hide': 'Hide "No sessions" messages in sidebar',
  'settings.openchamber.sidebar.emptyState.hideAria': 'Toggle hide empty sidebar messages',
  'settings.openchamber.sidebar.emptyState.hideDesc': 'When no sessions exist in a workspace, hide the empty state text instead of showing it.',
