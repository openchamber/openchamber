export const settingsDict = {
  ...
  'settings.mcp.page.meteordroid.title': 'MeteorDroid (Browser)',
  'settings.mcp.page.meteordroid.description': 'Add Playwright-backed browser tools via a local MCP server. Default configuration runs in ephemeral mode (no setup required).',
  'settings.mcp.page.meteordroid.actions.add': 'Add MeteorDroid',
  'settings.mcp.page.meteordroid.field.mode': 'Mode',
  'settings.mcp.page.meteordroid.mode.cdp': 'CDP (attach Chrome)',
  'settings.mcp.page.meteordroid.mode.persistent': 'Persistent',
  'settings.mcp.page.meteordroid.mode.ephemeral': 'Ephemeral',
  ...
  'settings.mcp.page.meteordroid.field.profileDir': 'Profile Dir',
  'settings.mcp.page.meteordroid.field.profileDirPlaceholder': '$HOME/.minicomet/profile',
  'settings.mcp.page.meteordroid.cdpHint': 'CDP mode requires launching Chrome with remote debugging enabled (recommended: a separate user-data-dir).',
