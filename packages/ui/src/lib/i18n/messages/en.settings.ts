...
export const settingsDict = {
  ...
  'settings.openchamber.git.reviewLayoutTitle': 'Review layout',
  'settings.openchamber.git.reviewLayoutAria': 'Review layout',
  'settings.openchamber.git.reviewLayout.option.separate': 'Separate views',
  'settings.openchamber.git.reviewLayout.option.combined': 'Combined Git + Changes',
  'settings.openchamber.git.reviewLayout.optionAria': 'Review layout: {option}',
