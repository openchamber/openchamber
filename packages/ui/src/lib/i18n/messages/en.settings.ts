...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.worktreeDiscovery': 'Discover Git worktrees automatically',
  'settings.openchamber.visual.field.worktreeDiscoveryAria': 'Toggle automatic Git worktree discovery',
  'settings.openchamber.visual.field.worktreeDiscoveryInfo': 'When enabled, the sidebar discovers Git worktrees for the active project and projects with active sessions.',
  'settings.openchamber.visual.field.worktreeDiscoveryInterval': 'Worktree discovery refresh interval',
  'settings.openchamber.visual.field.worktreeDiscoveryIntervalAria': 'Select worktree discovery refresh interval',
  'settings.openchamber.visual.field.worktreeDiscoveryIntervalInfo': 'Minimum time between automatic discovery runs. New project and session events wait until this interval has elapsed.',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.0': 'Immediately',
