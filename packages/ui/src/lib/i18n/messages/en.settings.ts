export const settingsDict = {
  ...
  'settings.workspaces.reauth.prompt': 'Confirm this privileged workspace action with your OpenChamber password. Leave blank if this host has no password.',
  ...
  'settings.workspaces.export.review': 'Review changes',
  ...
  'settings.workspaces.status.connected': 'Connected',
  'settings.workspaces.status.connecting': 'Connecting',
  'settings.workspaces.status.disconnected': 'Disconnected',
  'settings.workspaces.status.error': 'Error',
  'settings.workspaces.status.unknown': 'Unknown status',
  ...
  'settings.workspaces.handoff.title': 'Review context handoff',
  'settings.workspaces.handoff.description': 'Review and edit the text that will start a new target session.',
