export const settingsDict = {
  ...
  'settings.openchamber.scrollBehavior.title': 'Scroll Position',
  'settings.openchamber.scrollBehavior.description': 'Choose where a session reopens when you switch back to it. The default is to restore your previous position.',
  'settings.openchamber.scrollBehavior.option.restore.label': 'Restore previous position',
  'settings.openchamber.scrollBehavior.option.jumpToEnd.label': 'Always jump to end',
  'settings.openchamber.scrollBehavior.sectionAria': 'Session scroll behavior on switch',
  'settings.openchamber.scrollBehavior.field.modeAria': 'Scroll behavior: {option}',
