export const settingsDict = {
  ...
  'settings.usage.card.showInHeaderAria': 'Show in header menu',
  'settings.usage.card.resetsAt': 'Resets {time}',
  'settings.usage.card.bar.used': 'used',
  'settings.usage.card.bar.remaining': 'remaining',
