export const settingsDict = {
  ...
  'settings.openchamber.defaults.field.questionAutoAnswerAria': 'Auto-answer questions',
  'settings.openchamber.defaults.field.questionAutoAnswer': 'Auto-Answer Questions',
  'settings.openchamber.defaults.field.questionAutoAnswerDelay': 'Auto-Answer Delay (seconds)',
  'settings.openchamber.defaults.field.questionAutoAnswerHint': 'When the agent asks a question, the first option is selected automatically after this delay. Interacting with the question card cancels the countdown.',
