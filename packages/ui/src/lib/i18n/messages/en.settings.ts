export const settingsDict = {
  ...
  'settings.openchamber.visual.section.reasoningTraces': 'Reasoning Traces',
  'settings.openchamber.visual.section.reasoningTracesAria': 'Reasoning traces display mode',
  'settings.openchamber.visual.option.reasoningMode.off.label': 'Off',
  'settings.openchamber.visual.option.reasoningMode.off.description': 'Hide all reasoning / thinking blocks.',
  'settings.openchamber.visual.option.reasoningMode.off.aria': 'Reasoning traces: off',
  'settings.openchamber.visual.option.reasoningMode.collapsibleHidden.label': 'Collapsible (hidden by default)',
  'settings.openchamber.visual.option.reasoningMode.collapsibleHidden.description': 'Reasoning collapses by default and stays collapsed while streaming. Click to expand.',
  'settings.openchamber.visual.option.reasoningMode.collapsibleHidden.aria': 'Reasoning traces: collapsible, hidden by default',
  'settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.label': 'Collapsible (dynamic)',
  'settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.description': 'Reasoning auto-expands while streaming and collapses when it ends. Click to override.',
  'settings.openchamber.visual.option.reasoningMode.collapsibleDynamic.aria': 'Reasoning traces: collapsible, dynamic',
  'settings.openchamber.visual.option.reasoningMode.full.label': 'Full (inline)',
  'settings.openchamber.visual.option.reasoningMode.full.description': 'Show reasoning as plain inline text, not collapsible.',
  'settings.openchamber.visual.option.reasoningMode.full.aria': 'Reasoning traces: full inline',
