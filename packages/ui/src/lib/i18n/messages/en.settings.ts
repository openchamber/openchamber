export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. Sharpie never scans browser cookie storage.',
  ...
  'settings.window.description': 'Sharpie settings window.',
  ...
  'settings.page.appearance.description': 'Customize how Sharpie looks and feels.',
  ...
  'settings.remoteInstances.direct.title': 'Other Sharpie servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another Sharpie server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another Sharpie server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid Sharpie connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so Sharpie Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the Sharpie app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through Sharpie Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the Sharpie app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether Sharpie should start the server for you, or connect to one that is already running.',
  ...
  'settings.openchamber.about.title': 'About Sharpie',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. Sharpie will scan it for folders containing',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start Sharpie at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start Sharpie when you log in',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Show Sharpie in the macOS menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Show Sharpie in the menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, Sharpie does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Minimize and close Sharpie to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Minimize and close to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps Sharpie running in the system tray when the main window is minimized or closed.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while Sharpie is running',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Keep computer awake while Sharpie is running',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Sharpie asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open Sharpie there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'Sharpie on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how Sharpie should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote Sharpie server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote Sharpie UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How Sharpie should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing Sharpie',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating Sharpie',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OpenCode auth, not by Sharpie. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by Sharpie.',
  ...
  'settings.github.page.flow.title': 'Authorize Sharpie',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if Sharpie auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from Sharpie.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the Sharpie server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the Sharpie server (Kokoro, English). The model downloads automatically; no API key needed.',
