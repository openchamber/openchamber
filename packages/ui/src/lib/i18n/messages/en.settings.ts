...
export const settingsDict = {
  ...
  'settings.openchamber.visual.section.chatMessageWidth': 'Message Width',
  'settings.openchamber.visual.section.chatMessageWidthAria': 'Message width',
  'settings.openchamber.visual.field.chatMessageWidthAria': 'Message width: {option}',
  'settings.openchamber.visual.option.chatMessageWidth.narrow.label': 'Narrow',
  'settings.openchamber.visual.option.chatMessageWidth.wide.label': 'Wide',
  'settings.openchamber.visual.option.chatMessageWidth.fluid.label': 'Full width',
