...
export const settingsDict = {
  ...
  'settings.openchamber.defaults.field.defaultDirectory': 'Default Directory',
  'settings.openchamber.defaults.field.defaultDirectoryHint': 'New sessions start in this directory when none is chosen. Leave empty to keep the current behavior.',
  'settings.openchamber.defaults.field.defaultDirectoryPlaceholder': 'Leave empty for the current directory',
  'settings.openchamber.defaults.actions.browseDirectory': 'Browse',
  'settings.openchamber.defaults.actions.browseDirectoryAria': 'Browse for a directory',
