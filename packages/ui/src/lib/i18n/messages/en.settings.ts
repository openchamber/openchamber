export const settingsDict = {
  ...
  'settings.notifications.page.events.hint': 'Controls which agent events trigger notifications and sounds. These settings apply to both native notifications and the sound system.',
  ...
  'settings.notifications.page.sounds.title': 'Notification Sounds',
  'settings.notifications.page.sounds.enableLabel': 'Play sounds for agent events',
  'settings.notifications.page.sounds.enableAria': 'Play sounds for agent events',
  'settings.notifications.page.sounds.hint': 'Plays audio cues for completion, errors, and questions. Uses the focus and event settings above.',
  'settings.notifications.page.sounds.volumeLabel': 'Volume',
  'settings.notifications.page.sounds.previewAction': 'Preview sound',
  'settings.notifications.page.sounds.previewAria': 'Preview notification sound',
