export const settingsDict = {
  ...
  "settings.page.analytics.title": "Analytics",
  "settings.analytics.scope.project": "This project",
  "settings.analytics.scope.all": "All projects",
  "settings.analytics.period.groupLabel": "Time range",
  "settings.analytics.period.7d": "7 days",
  "settings.analytics.period.30d": "30 days",
  "settings.analytics.period.90d": "90 days",
  "settings.analytics.period.all": "All time",
  "settings.analytics.action.refresh": "Refresh",
  "settings.analytics.state.errorTitle": "Failed to load analytics",
  "settings.analytics.state.empty": "No session data for the selected range",
  "settings.analytics.kpi.sectionTitle": "Overview",
  "settings.analytics.kpi.tokens": "Tokens",
  "settings.analytics.kpi.cost": "Cost",
  "settings.analytics.kpi.sessions": "Sessions",
  "settings.analytics.kpi.activeDays": "Active days",
  "settings.analytics.kpi.streak": "Day streak",
  "settings.analytics.quota.title": "Provider quotas",
  "settings.analytics.quota.none": "No providers configured",
  "settings.analytics.quota.manage": "Manage rate limits",
  "settings.analytics.topSessions.title": "Top sessions",
  "settings.analytics.topSessions.open": "Open session",
  "settings.analytics.topSessions.empty": "No sessions in the selected range",
  "settings.analytics.tab.trends": "Trends",
  "settings.analytics.kpi.deltaUp": "↑ {value}% vs prev period",
  "settings.analytics.kpi.deltaDown": "↓ {value}% vs prev period",
  "settings.analytics.kpi.deltaNew": "New",
  "settings.analytics.kpi.deltaFlat": "—",
  "settings.analytics.kpi.cacheHitRate": "Cache hit rate",
  "settings.analytics.trends.metric.tokens": "Tokens",
  "settings.analytics.trends.metric.cost": "Cost",
  "settings.analytics.trends.metric.sessions": "Sessions",
  "settings.analytics.trends.tokenBreakdown.title": "Token breakdown",
  "settings.analytics.trends.tokenBreakdown.ariaLabel":
      "Token breakdown over time",
  "settings.analytics.trends.tokenBreakdown.prompt": "Prompt",
  "settings.analytics.trends.tokenBreakdown.completion": "Completion",
  "settings.analytics.trends.tokenBreakdown.reasoning": "Reasoning",
  "settings.analytics.trends.tokenBreakdown.cached": "Cached",
  "settings.analytics.trends.cache.title": "Prompt caching",
  "settings.analytics.trends.cache.ariaLabel": "Prompt caching over time",
  "settings.analytics.trends.cache.cached": "Cached",
  "settings.analytics.trends.cache.uncached": "Uncached",
  "settings.analytics.trends.byModel.other": "Other",
  "settings.analytics.yearHeatmap.title": "Activity",
  "settings.analytics.yearHeatmap.less": "Less",
  "settings.analytics.yearHeatmap.more": "More",
  "settings.analytics.summary.title": "Usage summary",
  "settings.analytics.summary.dailyByModel": "Daily · by model",
  "settings.analytics.summary.topModels": "Top models",
  "settings.analytics.summary.view.daily": "Daily",
  "settings.analytics.summary.view.total": "Total",
  "settings.analytics.summary.view.aria": "View",
  "settings.analytics.summary.chartToggleAria": "Toggle between bar and line chart",
  "settings.analytics.summary.chartType.bar": "Bar chart",
  "settings.analytics.summary.chartType.line": "Line chart",
  "settings.analytics.activity.longestStreak": "Longest streak",
  "settings.analytics.activity.avgPerDay": "Avg / day",
  "settings.analytics.activity.avgPerWeek": "Avg / week",
  "settings.analytics.activity.total": "Total",
  "settings.analytics.activity.days": "days",
  "settings.analytics.chart.sessionsPerDay": "Sessions per day",
  "settings.analytics.chart.costPerDay": "Cost per day",
  "settings.analytics.efficiency.title": "Efficiency",
  "settings.analytics.efficiency.costPerMillion": "$ / 1M tokens",
  "settings.analytics.efficiency.costPerSession": "Cost / session",
  "settings.analytics.efficiency.tokensPerSession": "Tokens / session",
  "settings.analytics.efficiency.reasoningShare": "Reasoning share",
  "settings.analytics.efficiency.avgDuration": "Avg duration",
  "settings.analytics.efficiency.medianDuration": "Median duration",
  "settings.analytics.efficiency.longestDuration": "Longest duration",
  "settings.analytics.agents.title": "Agent usage",
  "settings.analytics.agents.empty": "No agent data",
  "settings.analytics.rhythm.title": "Activity rhythm",
  "settings.analytics.rhythm.hoursAria": "Activity by hour",
} as const;
