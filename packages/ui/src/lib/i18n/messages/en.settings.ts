export const settingsDict = {
  ...
  'settings.page.engines.title': 'Engines',
  'settings.page.engines.description': 'Choose and manage execution engines.',
  ...
  'settings.usage.page.state.claudeNotConfiguredDescription': 'Sign in with Claude Code on this host (`claude auth login`), then refresh. This tracks Claude subscription usage windows, not Anthropic API credits.',
  ...
  'settings.engines.sidebar.title': 'Engines',
  'settings.engines.sidebar.subtitle': 'Execution backends for chat sessions',
  'settings.engines.sidebar.engine.opencode': 'OpenCode',
  'settings.engines.sidebar.engine.claudeCode': 'Claude Code',
  'settings.engines.sidebar.status.ready': 'Ready',
  'settings.engines.sidebar.status.needsLogin': 'Needs login',
  'settings.engines.sidebar.status.missingCli': 'Missing CLI',
  'settings.engines.sidebar.status.unsupportedHost': 'Unavailable here',
  'settings.engines.sidebar.status.error': 'Error',
  'settings.engines.sidebar.status.unknown': 'Unknown',
  'settings.engines.sidebar.status.loading': 'Checking…',
  'settings.engines.page.empty.selectEngine': 'Select an engine from the sidebar',
  'settings.engines.page.loadError': 'Could not load engine status',
  'settings.engines.opencode.title': 'OpenCode',
  'settings.engines.opencode.description': 'Default engine. Uses OpenCode providers and agents.',
  'settings.engines.opencode.section.about': 'About',
  'settings.engines.opencode.about.body': 'OpenCode runs models through your configured providers. Manage API keys under Providers and agent settings under Agents.',
  'settings.engines.opencode.link.providers': 'Open Providers',
  'settings.engines.opencode.link.agents': 'Open Agents',
  'settings.engines.claudeCode.title': 'Claude Code',
  'settings.engines.claudeCode.description': 'Native Claude Code CLI with subscription usage limits.',
  'settings.engines.claudeCode.section.status': 'Status',
  'settings.engines.claudeCode.field.status': 'Status',
  'settings.engines.claudeCode.field.version': 'Version',
  'settings.engines.claudeCode.status.version': '{version}',
  'settings.engines.claudeCode.status.versionUnknown': 'Unknown',
  'settings.engines.claudeCode.actions.redetect': 'Re-detect',
  'settings.engines.claudeCode.actions.redetectAria': 'Re-detect Claude Code status',
  'settings.engines.claudeCode.actions.openDocs': 'Open docs',
  'settings.engines.claudeCode.actions.openDocsAria': 'Open Claude Code documentation',
  'settings.engines.claudeCode.login.title': 'Sign in with Claude',
  'settings.engines.claudeCode.login.body': 'Install the Claude CLI and run claude login on this host so OpenChamber can use your Claude subscription.',
  'settings.engines.claudeCode.section.capabilities': 'Capabilities',
  'settings.engines.claudeCode.capabilities.empty': 'Capabilities appear after a successful detect.',
  'settings.engines.claudeCode.capability.full': 'Full',
  'settings.engines.claudeCode.capability.partial': 'Partial',
  'settings.engines.claudeCode.capability.none': 'Not available',
  'settings.engines.claudeCode.section.agents': 'Agents',
  'settings.engines.claudeCode.agentsMode.label': 'Agents to use',
  'settings.engines.claudeCode.agentsMode.aria': 'Choose Claude or OpenCode agents for Claude Code sessions',
  'settings.engines.claudeCode.agentsMode.info': 'Claude uses native Claude Code system prompts and permissions. OpenCode uses OpenChamber agents for permissions and system prompts on Claude sessions.',
  'settings.engines.claudeCode.agentsMode.claude': 'Claude',
  'settings.engines.claudeCode.agentsMode.opencode': 'OpenCode',
  'settings.engines.claudeCode.section.warnings': 'Warnings',
  'settings.engines.claudeCode.warnHandoff.label': 'Warn when switching from OpenCode to Claude Code',
  'settings.engines.claudeCode.warnHandoff.aria': 'Warn when switching from OpenCode to Claude Code',
  'settings.engines.claudeCode.warnHandoff.info': 'Explains that the new session uses your Claude subscription, not API billing.',
  'settings.engines.claudeCode.section.import': 'Import',
  'settings.engines.claudeCode.import.note': 'Import local Claude Code projects and chats into OpenChamber. Chats resume on Claude Code; transcripts are not copied into OpenCode history.',
  'settings.engines.claudeCode.import.actions.open': 'Import from Claude Code',
  'settings.engines.claudeCode.import.actions.openAria': 'Open Claude Code import dialog',
  'settings.engines.claudeCode.import.dialog.title': 'Import from Claude Code',
  'settings.engines.claudeCode.import.dialog.description': 'Select chats stored under your Claude Code projects folder on this host. Already imported chats are skipped.',
  'settings.engines.claudeCode.import.dialog.loading': 'Scanning Claude Code projects…',
  'settings.engines.claudeCode.import.dialog.empty': 'No Claude Code chats found on this host.',
  'settings.engines.claudeCode.import.dialog.selectAll': 'Select all',
  'settings.engines.claudeCode.import.dialog.selectAllAria': 'Select all importable Claude Code chats',
  'settings.engines.claudeCode.import.dialog.selectedCount': '{count} selected',
  'settings.engines.claudeCode.import.dialog.projectAria': 'Select all chats in {name}',
  'settings.engines.claudeCode.import.dialog.sessionAria': 'Select chat {title}',
  'settings.engines.claudeCode.import.dialog.sessionCount': '{count} chats',
  'settings.engines.claudeCode.import.dialog.directoryMissing': 'Folder missing',
  'settings.engines.claudeCode.import.dialog.alreadyImported': 'Already imported',
  'settings.engines.claudeCode.import.dialog.untitled': 'Untitled chat',
  'settings.engines.claudeCode.import.dialog.cancel': 'Cancel',
  'settings.engines.claudeCode.import.dialog.import': 'Import ({count})',
  'settings.engines.claudeCode.import.dialog.importing': 'Importing…',
  'settings.engines.claudeCode.import.error.load': 'Could not scan Claude Code projects.',
  'settings.engines.claudeCode.import.error.import': 'Import failed.',
  'settings.engines.claudeCode.import.toast.success': 'Imported {count} Claude Code chats.',
  'settings.engines.claudeCode.import.toast.skippedOnly': 'Skipped {count} chats that were already imported.',
  'settings.engines.claudeCode.import.toast.partialFail': 'Imported {imported}; {failed} failed.',
  'settings.engines.claudeCode.import.toast.none': 'Nothing was imported.',
  'settings.engines.claudeCode.section.apiKeys': 'API keys',
  'settings.engines.claudeCode.apiKeys.note': 'Anthropic API keys stay under Providers on OpenCode. Claude Code uses your Claude subscription login on the host.',
  'settings.engines.capability.prompt': 'Prompt',
  'settings.engines.capability.abort': 'Abort',
  'settings.engines.capability.resume': 'Resume',
  'settings.engines.capability.streaming-text': 'Streaming text',
  'settings.engines.capability.streaming-tools': 'Streaming tools',
  'settings.engines.capability.permissions': 'Permissions',
  'settings.engines.capability.images': 'Images',
  'settings.engines.capability.file-attachments': 'File attachments',
  'settings.engines.capability.shell': 'Shell',
  'settings.engines.capability.slash-commands': 'Slash commands',
  'settings.engines.capability.mcp': 'MCP',
  'settings.engines.capability.subagents': 'Subagents',
  'settings.engines.capability.multirun': 'MultiRun',
  'settings.engines.capability.goal': 'Goal Mode',
  'settings.engines.capability.openchamber-tool': 'OpenChamber tool',
} as const;
