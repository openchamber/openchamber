export const settingsDict = {
  ...
  'settings.usage.sidebar.activeTotal': '{count} active',
  'settings.usage.sidebar.overview': 'Overview',
  'settings.usage.sidebar.activeProviders': 'Active providers',
  'settings.usage.sidebar.addProvider': 'Add Provider',
  'settings.usage.sidebar.availableCount': '{count} available',
  'settings.usage.sidebar.removeProviderAria': 'Remove {provider} from Usage',
  'settings.usage.sidebar.removeProviderTitle': 'Remove from Usage',
  'settings.usage.sidebar.remainingPct': '{percent}% remaining',
  'settings.usage.sidebar.usedPct': '{percent}% used',
  ...
  'settings.usage.overview.description': 'Monitor your LLM usage and costs across all providers.',
  'settings.usage.overview.period.aria': 'Usage period',
  'settings.usage.overview.period.7d': '7 days',
  'settings.usage.overview.period.30d': '30 days',
  'settings.usage.overview.metric.totalSpend': 'Total Spend',
  'settings.usage.overview.metric.totalTokens': 'Total Tokens',
  'settings.usage.overview.metric.requests': 'Requests',
  'settings.usage.overview.metric.avgCost': 'Avg. Cost / 1K Tokens',
  'settings.usage.overview.chart.usageOverTime': 'Usage Over Time',
  'settings.usage.overview.chart.topProviders': 'Top Providers by Spend',
  'settings.usage.overview.chart.metricAria': 'Chart metric',
  'settings.usage.overview.chart.metric.tokens': 'Tokens',
  'settings.usage.overview.chart.metric.cost': 'Cost',
  'settings.usage.overview.chart.metric.requests': 'Requests',
  'settings.usage.overview.chart.empty': 'No session usage in this period yet.',
  'settings.usage.overview.providers.title': 'Providers',
  'settings.usage.overview.providers.col.provider': 'Provider',
  'settings.usage.overview.providers.col.spend': 'Spend',
  'settings.usage.overview.providers.col.tokens': 'Tokens',
  'settings.usage.overview.providers.col.requests': 'Requests',
  'settings.usage.overview.providers.col.remaining': 'Remaining / Limit',
  'settings.usage.overview.providers.col.status': 'Status',
  'settings.usage.overview.providers.remainingPct': '{percent}% left',
  'settings.usage.overview.providers.status.active': 'Active',
  'settings.usage.overview.providers.status.error': 'Error',
  'settings.usage.overview.providers.openDetailAria': 'Open {provider} usage details',
  'settings.usage.overview.providers.removeAria': 'Remove {provider} from Usage',
  'settings.usage.overview.empty.title': 'No providers in Usage yet',
  'settings.usage.overview.empty.description': 'Configured providers appear here automatically. Add a provider or restore one you removed.',
  'settings.usage.overview.actions.title': 'Quick Actions',
  'settings.usage.overview.actions.addProvider': 'Add Provider',
  'settings.usage.overview.actions.addProviderDescription': 'Connect a new LLM provider',
  'settings.usage.overview.actions.manageLimits': 'Manage Limits',
  'settings.usage.overview.actions.manageLimitsDescription': 'Review remaining quotas and limits',
  'settings.usage.overview.available.title': 'Available providers',
  'settings.usage.overview.available.description': 'Providers you can connect, or restore to the Usage block after removing them.',
  'settings.usage.overview.available.hiddenConfigured': 'Configured — removed from Usage',
  'settings.usage.overview.available.notConfigured': 'Not connected yet',
  'settings.usage.overview.available.restore': 'Restore',
  'settings.usage.overview.available.connect': 'Connect',
  'settings.usage.add.title': 'Add Provider',
  'settings.usage.add.description': 'Choose from available providers: connect a new one, or restore a configured provider you removed from Usage.',
  'settings.usage.add.backAria': 'Back to usage overview',
  'settings.usage.add.empty': 'Every supported provider is already shown in Usage.',
  'settings.usage.add.viaCredentials': 'Configure usage credentials here',
  'settings.usage.add.viaProviders': 'Connect in Providers settings',
  'settings.usage.add.restoreHint': 'Already configured — restore to Usage',
  'settings.usage.add.openProviders': 'Open Providers settings',
  'settings.usage.add.credentialsTitle': '{provider} credentials',
  'settings.usage.add.viewProvider': 'View provider usage',
  'settings.usage.page.empty.selectProvider': 'Select a provider to view usage details.',
  'settings.usage.page.backToOverviewAria': 'Back to usage overview',
  ...
  'settings.usage.page.actions.removeFromUsage': 'Remove from Usage',
  ...
  'settings.usage.page.section.periodUsage': 'Usage this period',
  'settings.usage.page.section.remainingLimits': 'Remaining limits',
