export const settingsDict = {
  ...
  'settings.openchamber.tunnel.readOnly.title': 'Read-only tunnel status',
  'settings.openchamber.tunnel.readOnly.description': 'Tunnel management is available from the host desktop or an authenticated browser session.',
  ...
  'settings.remoteInstances.clientAuth.state.viaManagedDirectE2ee': 'Managed Direct E2EE',
  'settings.remoteInstances.clientAuth.state.connectedManagedDirectE2ee': 'Connected · Managed Direct E2EE',
  'settings.remoteInstances.clientAuth.addDevice.transport.managedE2ee': 'Managed Direct E2EE',
  'settings.remoteInstances.clientAuth.addDevice.transport.managedE2eeHint': 'End-to-end encrypted tunnel managed by this server. Administer from the host desktop or an authenticated browser session.',
  ...
  'settings.openchamber.tunnel.field.directE2eeLabel': 'Native app end-to-end encryption',
  'settings.openchamber.tunnel.field.directE2eeDescription': 'Traffic through Cloudflare is encrypted between the native app and this OpenChamber host.',
  'settings.openchamber.tunnel.field.directE2eeUnsupported': 'Requires a client version that supports direct E2EE.',
  'settings.openchamber.tunnel.field.nativePairingLabel': 'Native app pairing',
  'settings.openchamber.tunnel.field.nativePairingDescription': 'Pair a native mobile or desktop app using end-to-end encryption.',
  'settings.openchamber.tunnel.actions.openAddDevice': 'Add a device',
  'settings.openchamber.tunnel.field.browserAccessLabel': 'Browser access',
  'settings.openchamber.tunnel.field.browserQrAlt': 'Browser access QR code',
  'settings.openchamber.tunnel.note.scanQrToConnectBrowser': 'Scan this QR code with your mobile browser to connect.',
  'settings.openchamber.tunnel.toast.directE2eeSaved': 'Direct E2EE setting saved',
  'settings.openchamber.tunnel.toast.directE2eeSaveFailed': 'Failed to save direct E2EE setting',
  'settings.remoteInstances.transport.managedE2ee.label': 'Managed tunnel (E2EE)',
  'settings.remoteInstances.transport.managedE2ee.description': 'Connect securely through your managed Cloudflare tunnel.',
  'settings.remoteInstances.transport.managedE2ee.note': 'This connection uses end-to-end encryption over your managed tunnel.',
} as const;
