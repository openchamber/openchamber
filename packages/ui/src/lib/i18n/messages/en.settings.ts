...
export const settingsDict = {
  ...
  'settings.notifications.page.delivery.info': 'These are system alerts outside the app. Desktop uses native notifications. Browser and installed app use web push, so they can arrive when the tab is in the background. The bell keeps a separate in-app list.',
  ...
  'settings.notifications.page.inbox.title': 'In-app history',
  'settings.notifications.page.inbox.info': 'Turn the list off to hide every row and the badge. Uncheck a kind to hide only that kind. Rows stay saved, so turning them back on brings them back.',
  'settings.notifications.page.inbox.enableLabel': 'Enable In-app History',
  ...
  'settings.notifications.page.inbox.soundInfo': 'A short chime when a notice lands in the list, including when this window is in the background. If a system banner also sounds, the chime stays quiet.',
  ...
  'settings.notifications.page.inbox.sessionErrorAria': 'Show session errors in the in-app history',
  'settings.notifications.page.inbox.sessionSubtaskLabel': 'Subtasks',
  'settings.notifications.page.inbox.sessionSubtaskAria': 'Show subtask session notices in the in-app history',
  'settings.notifications.page.inbox.permissionQuestionLabel': 'Permissions and questions',
  'settings.notifications.page.inbox.permissionQuestionAria': 'Show permission and question notices in the in-app history',
  'settings.notifications.page.inbox.appErrorWarningLabel': 'App errors and warnings',
  'settings.notifications.page.inbox.appErrorWarningAria': 'Show app errors and warnings in the in-app history',
  'settings.notifications.page.inbox.infoLabel': 'Info',
  'settings.notifications.page.inbox.infoAria': 'Show info notices in the in-app history',
  'settings.notifications.page.inbox.successLabel': 'Success',
  'settings.notifications.page.inbox.successAria': 'Show success notices in the in-app history',
