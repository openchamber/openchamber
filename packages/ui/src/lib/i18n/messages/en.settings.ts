export const settingsDict = {
  ...
  'settings.openchamber.keyboardShortcuts.action.cycle_session_previous.label': 'Previous session',
  'settings.openchamber.keyboardShortcuts.action.cycle_session_next.label': 'Next session',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_1.label': 'Switch to 1st recent session',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_2.label': 'Switch to 2nd recent session',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_3.label': 'Switch to 3rd recent session',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_4.label': 'Switch to 4th recent session',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_5.label': 'Switch to 5th recent session',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_6.label': 'Switch to 6th recent session',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_7.label': 'Switch to 7th recent session',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_8.label': 'Switch to 8th recent session',
  'settings.openchamber.keyboardShortcuts.action.switch_recent_session_9.label': 'Switch to 9th recent session',
  'settings.openchamber.keyboardShortcuts.action.cycle_instance_previous.label': 'Previous instance',
  'settings.openchamber.keyboardShortcuts.action.cycle_instance_next.label': 'Next instance',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_1.label': 'Switch to instance 1',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_2.label': 'Switch to instance 2',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_3.label': 'Switch to instance 3',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_4.label': 'Switch to instance 4',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_5.label': 'Switch to instance 5',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_6.label': 'Switch to instance 6',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_7.label': 'Switch to instance 7',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_8.label': 'Switch to instance 8',
  'settings.openchamber.keyboardShortcuts.action.switch_instance_9.label': 'Switch to instance 9',
