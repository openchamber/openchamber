...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.worktreeDiscovery': 'Check Git worktrees automatically',
  'settings.openchamber.visual.field.worktreeDiscoveryAria': 'Toggle automatic Git worktree checks',
  'settings.openchamber.visual.field.worktreeDiscoveryInfo': 'When enabled, OpenChamber checks the active project and projects with active sessions. Existing worktrees remain usable when this is off.',
  'settings.openchamber.visual.field.worktreeDiscoveryInterval': 'Minimum interval between Git worktree checks',
