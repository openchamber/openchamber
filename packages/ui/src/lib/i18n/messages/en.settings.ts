...
export const settingsDict = {
  ...
  'settings.openchamber.appLinks.title': 'App links',
  'settings.openchamber.appLinks.info': 'Application links from chat (such as obsidian://) open in another application after confirmation. Trusted schemes open without asking again.',
  'settings.openchamber.appLinks.empty': 'No trusted app links yet. Choose "Trust and open" when opening a link to add it here.',
