export const settingsDict = {
  ...
  'settings.workspaces.export.description': 'Review an isolated workspace patch, check it against the project, then apply it explicitly.',
  'settings.workspaces.export.directory': 'Target project directory',
  'settings.workspaces.export.load': 'Load workspaces',
  'settings.workspaces.export.review': 'Review patch',
  'settings.workspaces.export.summary': '{files} files, +{additions} -{deletions}',
  'settings.workspaces.export.patch': 'Workspace patch',
  'settings.workspaces.export.check': 'Check patch',
  'settings.workspaces.export.apply': 'Apply patch',
  ...
  'settings.workspaces.export.fileToggle': 'Include this file in the workspace patch apply',
  'settings.workspaces.export.failed': 'Failed to export workspace changes.',
  'settings.workspaces.export.checkPassed': 'Patch applies cleanly.',
  'settings.workspaces.export.confirmApply': 'Apply this workspace patch to the target project directory?',
  'settings.workspaces.export.applied': 'Patch applied.',
