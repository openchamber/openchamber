...
export const settingsDict = {
  ...
  'settings.workspaces.title': 'Secure Workspaces',
  'settings.workspaces.allowedImages': 'Exact image allowlist',
  'settings.workspaces.allowedImagesHint': 'Comma-separated digest-pinned images. Empty allows only the selected runtime image.',
  'settings.workspaces.docker.memory': 'Docker memory limit',
  'settings.workspaces.docker.cpu': 'Docker CPU limit',
  'settings.workspaces.docker.pids': 'Docker PID limit',
  'settings.workspaces.apple.memory': 'Apple Container memory limit',
  'settings.workspaces.apple.cpu': 'Apple Container CPU limit',
  'settings.workspaces.kubernetes.storage': 'Storage',
  'settings.workspaces.kubernetes.cpuRequest': 'CPU request',
  'settings.workspaces.kubernetes.memoryRequest': 'Memory request',
  'settings.workspaces.kubernetes.cpuLimit': 'CPU limit',
  'settings.workspaces.kubernetes.memoryLimit': 'Memory limit',
  'settings.workspaces.kubernetes.connectivity': 'Connectivity',
  'settings.workspaces.kubernetes.portForward': 'Port forward',
  'settings.workspaces.kubernetes.ingress': 'Ingress',
  'settings.workspaces.kubernetes.ingressClass': 'Ingress class',
  'settings.workspaces.kubernetes.hostTemplate': 'HTTPS host template',
  'settings.workspaces.kubernetes.pathTemplate': 'Path template',
  'settings.workspaces.kubernetes.namespaceSelector': 'Controller namespace selector (JSON)',
  'settings.workspaces.kubernetes.podSelector': 'Controller pod selector (JSON)',
  'settings.workspaces.kubernetes.annotations': 'Allowed annotations (JSON)',
  'settings.workspaces.kubernetes.tlsMode': 'TLS certificate',
  'settings.workspaces.kubernetes.existingSecret': 'Existing secret',
  'settings.workspaces.kubernetes.certManager': 'cert-manager',
  'settings.workspaces.kubernetes.tlsSecret': 'TLS secret name',
  'settings.workspaces.kubernetes.clusterIssuer': 'Cluster issuer',
  'settings.workspaces.egress.mode': 'Egress mode',
  'settings.workspaces.egress.managed': 'Managed',
  'settings.workspaces.egress.external': 'External proxy',
  'settings.workspaces.egress.gatewayImage': 'Gateway image digest',
  'settings.workspaces.egress.preset': 'Managed preset',
  'settings.workspaces.egress.restricted': 'Restricted',
  'settings.workspaces.egress.custom': 'Custom',
  'settings.workspaces.egress.allowedDomains': 'Allowed domains',
  'settings.workspaces.egress.allowedCIDRs': 'Allowed CIDRs',
  'settings.workspaces.egress.allowedPorts': 'Allowed ports',
  'settings.workspaces.policy.title': 'Credentials and retention',
  'settings.workspaces.credentials.modelAuth': 'Model authentication grant',
  'settings.workspaces.credentials.modelAuthHint': 'Credentials are granted explicitly and stored in provider-backed files, never inherited automatically.',
  'settings.workspaces.credentials.none': 'No grant',
  'settings.workspaces.credentials.explicit': 'Grant OpenCode model auth',
  'settings.workspaces.retention.preserve': 'Preserve storage when deleting a workspace',
  'settings.workspaces.retention.warning': 'Warning: deleting the workspace will leave provider storage behind and requires separate administrator cleanup.',
  'settings.workspaces.lifecycle.reconcile': 'Reconcile',
  'settings.workspaces.lifecycle.reconnect': "Try to reconnect",
  'settings.workspaces.lifecycle.reconciled': 'Workspace reconciliation completed.',
  ...
  'settings.workspaces.export.downloadFailed': 'Could not download the workspace artifact.',
  'settings.workspaces.export.discardFailed': 'Could not discard the workspace artifact.',
  'settings.workspaces.description': 'Run OpenCode sessions in isolated Docker or Kubernetes runtimes with explicit change export.',
  'settings.workspaces.reauth.prompt': 'Confirm this privileged workspace action with your OpenChamber password.',
  'settings.workspaces.reauth.title': 'Confirm workspace action',
  'settings.workspaces.reauth.confirm': 'Confirm',
  'settings.workspaces.reauth.failed': 'Could not confirm this privileged workspace action.',
  'settings.workspaces.reauth.windowHint': 'After confirming, related privileged actions will not ask again for a few minutes.',
  'settings.workspaces.newSession.notConfigured': 'Secure Workspaces are not set up yet. Configure and activate them in Settings first.',
  'settings.workspaces.actions.close': 'Back to chat',
  'settings.workspaces.setup.done': "Done",
  'settings.workspaces.safety.filesLabel': "Your project files",
  'settings.workspaces.safety.filesValue': "Untouched until you apply",
  'settings.workspaces.safety.internetLabel': "Internet access",
  'settings.workspaces.safety.internetValueRestricted': "Limited",
  'settings.workspaces.safety.internetValueProxy': "Through your proxy",
  'settings.workspaces.advanced.hide': "Hide advanced settings",
  'settings.workspaces.advanced.credentialsGroup': "Model credentials",
  'settings.workspaces.advanced.imagesGroup': "Container images",
  'settings.workspaces.advanced.limitsGroup': "Resource limits",
  'settings.workspaces.advanced.limitsHint': "Caps applied to each workspace. Empty means the provider default.",
  'settings.workspaces.advanced.networkGroup': "Network access",
  'settings.workspaces.advanced.clusterGroup': "Cluster connection",
  'settings.workspaces.advanced.clusterHint': "How OpenChamber reaches your Kubernetes cluster and workspaces inside it.",
  'settings.workspaces.credentials.explicitHint': "The assistant can use your models inside the workspace.",
  'settings.workspaces.credentials.noneHint': "The assistant cannot answer inside the workspace.",
  'settings.workspaces.setup.readyTitle': 'Ready to use',
  'settings.workspaces.setup.readyHint': 'Start a new session and choose Secure Workspace to work in an isolated copy of your project.',
  'settings.workspaces.setup.notReadyTitle': 'Setup needed',
  'settings.workspaces.setup.notReadyHint': 'Finish the steps below to run sessions in an isolated environment.',
  'settings.workspaces.setup.title': 'Setup status',
  'settings.workspaces.setup.stepRuntime': 'Container runtime available',
  'settings.workspaces.setup.pathTitle': "Getting {provider} ready",
  'settings.workspaces.setup.pathHint': "Work through these in order. Each one is checked automatically, and the app does the steps it can.",
  'settings.workspaces.setup.pathReadyTitle': "{provider} is ready",
  'settings.workspaces.setup.pathReadyHint': "Every requirement is met. They stay listed so you can confirm the setup at a glance.",
  'settings.workspaces.setup.working': "Working…",
  'settings.workspaces.setup.action.create-namespace': "Create it",
  'settings.workspaces.setup.action.check-isolation': "Check now",
  'settings.workspaces.setup.namespaceCreated': "Namespace created.",
  'settings.workspaces.setup.namespaceExists': "That namespace already exists.",
  'settings.workspaces.setup.isolationEnforced': "Your cluster enforces network isolation. Workspaces will be properly contained.",
  'settings.workspaces.setup.isolationMissing': "This cluster accepts network rules but does not enforce them, so workspaces would not be isolated. Ask for a cluster with Calico or Cilium, or use Docker instead.",
  ...
  'settings.workspaces.setup.step.kubernetes.cluster': "Cluster connection",
  'settings.workspaces.setup.step.kubernetes.namespace': "Namespace",
  'settings.workspaces.setup.step.kubernetes.permissions': "Permissions",
  'settings.workspaces.setup.step.kubernetes.isolation': "Network isolation",
  'settings.workspaces.setup.step.apple-container.platform': "Supported system",
  'settings.workspaces.setup.step.apple-container.cli': "Apple Container installed",
  'settings.workspaces.setup.step.apple-container.egress': "External proxy",
  'settings.workspaces.setup.stepInfo.docker.cli': "Docker provides the container each isolated workspace runs in.",
  'settings.workspaces.setup.stepInfo.docker.daemon': "The Docker engine has to be running before a workspace can start.",
  'settings.workspaces.setup.stepInfo.kubernetes.cli': "kubectl is the tool the app uses to talk to your cluster.",
  'settings.workspaces.setup.stepInfo.kubernetes.cluster': "Choose one of the clusters this computer can already reach. Its namespace comes with it.",
  'settings.workspaces.setup.stepInfo.kubernetes.namespace': "Workspaces get their own namespace so they never mix with the rest of the cluster.",
  'settings.workspaces.setup.stepInfo.kubernetes.permissions': "Your account has to be allowed to create workspace resources in that namespace.",
  'settings.workspaces.setup.stepInfo.kubernetes.isolation': "A cluster can accept network rules without applying them. This check proves yours applies them, so an isolated workspace really is isolated.",
  'settings.workspaces.setup.stepInfo.apple-container.platform': "Apple Container workspaces run on macOS only.",
  'settings.workspaces.setup.stepInfo.apple-container.cli': "The Apple Container command line tool provides the isolated container.",
  'settings.workspaces.setup.stepInfo.apple-container.egress': "Apple Container requires an external proxy because managed egress is unavailable.",
  'settings.workspaces.setup.stepEnable': 'Secure Workspaces turned on',
  'settings.workspaces.setup.stepEnableHint': 'Off — sessions still run directly on your computer.',
  'settings.workspaces.setup.stepActivate': 'Ready to create workspaces',
  'settings.workspaces.setup.stepActivateHint': 'Activate to load the workspace runtime.',
  'settings.workspaces.setup.turnOn': 'Turn on',
  'settings.workspaces.setup.recheck': 'Check again',
  'settings.workspaces.setup.checking': 'Checking…',
  'settings.workspaces.where.title': 'Where workspaces run',
  'settings.workspaces.where.description': 'Pick the runtime that hosts your isolated workspaces. Availability is checked automatically.',
  'settings.workspaces.where.dockerRecommended': "Docker is the right choice on your own computer: it isolates workspaces just as strictly, starts faster, and needs nothing set up beyond Docker itself.",
  'settings.workspaces.where.kubernetesWhen': "Choose Kubernetes when the work should run somewhere other than this computer — a cluster your workplace gave you, a bigger machine, or one with a GPU. A cluster running on this same computer offers nothing Docker does not.",
  'settings.workspaces.safety.title': 'What a workspace can do',
  'settings.workspaces.safety.description': 'The isolation rules that apply to every workspace you create.',
  'settings.workspaces.safety.filesText': 'Your files stay untouched: the workspace works on its own copy, and nothing reaches your project until you review the changes and apply them.',
  'settings.workspaces.safety.internetRestricted': 'Internet access is limited to your model providers, package registries, and any domains you add below.',
  'settings.workspaces.safety.internetProxy': 'Internet access goes through the external proxy configured under Advanced.',
  'settings.workspaces.safety.credentialsHint': 'Whether a workspace gets a copy of your model credentials. Without them the assistant cannot answer inside the workspace.',
  'settings.workspaces.advanced.title': 'Advanced',
  'settings.workspaces.advanced.description': 'Infrastructure details. The defaults are the certified ones — change them only if you know you need to.',
  'settings.workspaces.advanced.reveal': 'Show advanced settings',
  'settings.workspaces.advanced.imagesHint': 'Container images are pinned by digest. Leave empty to use the signed release images.',
  'settings.workspaces.advanced.customImages': "Using your own images",
  'settings.workspaces.advanced.customImagesHint': "Anything running a workspace has to be able to reach them. Clear these to go back to the images that ship with OpenChamber.",
  'settings.workspaces.advanced.useBuiltInImages': "Use built-in images",
  'settings.workspaces.setup.imageUnpullable': "The cluster cannot download the workspace image. Isolation was not checked, because nothing could start. Check the image settings under Advanced — a registry only reachable from this computer will not work for a cluster.",
  'settings.workspaces.advanced.egressHint': 'Outbound network rules for workspaces.',
  'settings.workspaces.advanced.domainsHint': 'Extra domains, comma-separated. Your model providers are allowed automatically.',
  'settings.workspaces.export.alreadyApplied': 'Already on your files',
  'settings.workspaces.export.hostChanged': 'Your file changed — review before applying',
  'settings.workspaces.lifecycle.advanced': 'Advanced actions',
  'settings.workspaces.lifecycle.connectHint': 'The workspace is not connected yet. Wait a moment, or run Repair to reconnect it.',
  'settings.workspaces.lifecycle.chooseProject': 'Choose a project to manage its Secure Workspaces.',
  'settings.workspaces.lifecycle.sourceIsHome': 'This is your home directory. A workspace copies the project into a container, and copying a home directory would take your SSH keys, cloud credentials and shell history with it.',
  'settings.workspaces.lifecycle.sourceIsRoot': 'This is a filesystem root. A workspace copies the project into a container, and copying a root would take every account on this machine with it.',
  'settings.workspaces.lifecycle.sourceChooseProject': 'Choose a project directory instead.',
  'settings.workspaces.lifecycle.createWith': "Create {provider} workspace",
  'settings.workspaces.progress.creating': "Creating the workspace — this can take a minute…",
  'settings.workspaces.progress.deleting': "Removing the workspace and its containers…",
  'settings.workspaces.progress.repairing': "Repairing the workspace…",
  'settings.workspaces.progress.exporting': "Collecting changes for review…",
  'settings.workspaces.progress.checking': "Checking the changes against your files…",
  'settings.workspaces.progress.applying': "Applying the changes to your files…",
  'settings.workspaces.lifecycle.noProject': "No project selected",
  'settings.workspaces.lifecycle.emptyHint': 'A Secure Workspace runs your project in an isolated container, so the AI can work without touching your files until you review and apply its changes.',
  'settings.workspaces.errors.policyMismatch': 'This workspace was created under an older security policy, so its actions are disabled. Delete it and create a new workspace to continue — deletion still works.',
  'settings.workspaces.lifecycle.drifted': "Older settings",
  'settings.workspaces.lifecycle.driftedHint': "Created before the current workspace settings. It still runs and can be deleted, but its changes cannot be exported until it is recreated.",
  'settings.workspaces.remediation.policyIncomplete': "This provider needs more configuration before it can be used. Open Advanced below to complete it.",
  'settings.workspaces.remediation.docker.cliMissing': 'Docker is not installed or not on PATH. Install Docker Desktop, start it, and validate again.',
  'settings.workspaces.remediation.docker.daemonUnavailable': 'Docker is installed but not responding. Start Docker Desktop and validate again.',
  'settings.workspaces.remediation.kubernetes.cliMissing': 'kubectl is not installed or not on PATH. Install kubectl and validate again.',
  'settings.workspaces.remediation.kubernetes.notConfigured': "No Kubernetes cluster is connected. Enable Kubernetes in Docker Desktop, or point kubectl at an existing cluster, then check again.",
  'settings.workspaces.remediation.kubernetes.clusterUnreachable': 'kubectl cannot reach the configured cluster. Check the kubeconfig, context, and cluster availability.',
  'settings.workspaces.remediation.kubernetes.namespaceMissing': 'The configured namespace does not exist in the cluster. Create it or choose another namespace.',
  'settings.workspaces.remediation.apple.cliMissing': 'The Apple Container CLI is not installed. Install Apple Container and validate again.',
  'settings.workspaces.remediation.apple.daemonUnavailable': 'Apple Container is installed but its system service is not running. Start it and validate again.',
  ...
  'settings.workspaces.reauth.op.configure': 'Change Secure Workspace settings',
  'settings.workspaces.reauth.op.validate': 'Check a provider',
  'settings.workspaces.reauth.op.setup': "complete a setup step",
  'settings.workspaces.reauth.op.reconcile': 'Repair a workspace',
  'settings.workspaces.reauth.op.export': 'Export workspace changes for review',
  'settings.workspaces.reauth.op.hostApply': 'Apply reviewed changes to your files',
  'settings.workspaces.reauth.op.hostCapabilities': 'Change device permissions',
  'settings.workspaces.newSession.groupLabel': "Where should the assistant work?",
  'settings.workspaces.newSession.host': "My computer",
  'settings.workspaces.newSession.secureHint': "The assistant works on a copy of your project in a container. Your files change only after you review and apply.",
  'settings.workspaces.newSession.secureHintWithRuntime': "Runs in {runtime}. The assistant works on a copy of your project; your files change only after you review and apply.",
  'settings.workspaces.newSession.secure': "Isolated workspace",
  'settings.workspaces.newSession.chooseProject': 'Choose a project before using Secure Workspace.',
  'settings.workspaces.newSession.progress': '{phase}',
  'settings.workspaces.newSession.partial': 'The workspace session was partially created. Retry to recover it without creating a duplicate.',
  'settings.workspaces.newSession.phasePreparing': 'Preparing the secure workspace…',
  'settings.workspaces.newSession.phaseConnecting': 'Connecting the secure workspace…',
  'settings.workspaces.newSession.phaseCreating': 'Creating the secure session…',
  'settings.workspaces.newSession.phaseOpening': 'Opening the secure session…',
  'settings.workspaces.newSession.retry': 'Retry safely',
  'settings.workspaces.newSession.startFailed': "Could not start the isolated workspace. Check its setup in Settings and try again.",
  'settings.workspaces.enable': 'Enable secure workspaces',
  'settings.workspaces.enableHint': 'Allows creating isolated workspace runtimes for safer agent execution.',
  'settings.workspaces.image': 'Runtime image',
  'settings.workspaces.requirePinnedImage': 'Require pinned image tags or digests',
  'settings.workspaces.provider.docker': 'Docker',
  'settings.workspaces.provider.dockerHint': 'Local isolated container and volume for developer sandboxes.',
  ...
  'settings.workspaces.actions.validating': 'Checking...',
  'settings.workspaces.status.available': 'Available',
  'settings.workspaces.status.unavailable': 'Unavailable',
  'settings.workspaces.status.unsupported': 'Workspace provider management is not available in this runtime.',
  'settings.workspaces.status.notChecked': 'Not checked',
  'settings.workspaces.compatibility.title': 'OpenCode workspace support',
  'settings.workspaces.compatibility.active': 'Secure workspace providers are configured and active in the running OpenCode server.',
  'settings.workspaces.compatibility.configuredInactive': 'Secure workspace providers are configured but not active yet. Activate them before creating workspaces.',
  'settings.workspaces.compatibility.notConfigured': 'Secure workspace providers are not configured yet.',
  'settings.workspaces.compatibility.unsupported': 'The running OpenCode server does not expose the experimental workspace API. Update or restart OpenCode after installing the plugin.',
  'settings.workspaces.compatibility.activate': 'Activate providers',
  'settings.workspaces.compatibility.recheck': 'Recheck support',
  'settings.workspaces.compatibility.activated': 'Workspace providers are active.',
  'settings.workspaces.compatibility.pending': 'Workspace providers are configured. Recheck after OpenCode finishes loading them.',
  'settings.workspaces.compatibility.manualRestart': 'External OpenCode is configured but OpenChamber cannot restart it. Restart that OpenCode server, then recheck support.',
  'settings.workspaces.compatibility.failed': 'Could not inspect workspace support.',
  'settings.workspaces.kubernetes.context': 'Kubernetes context',
  'settings.workspaces.kubernetes.namespace': 'Namespace',
  'settings.workspaces.egress.title': 'Egress proxy',
  'settings.workspaces.egress.description': 'Route model-provider traffic through an explicit proxy before creating isolated workspaces.',
  'settings.workspaces.egress.httpProxy': 'HTTP proxy URL',
  'settings.workspaces.egress.proxyCIDR': 'Proxy CIDR',
  'settings.workspaces.egress.dnsCIDRs': 'DNS CIDRs',
  'settings.workspaces.egress.noProxy': 'No-proxy list',
  'settings.workspaces.egress.apply': 'Apply egress settings',
  'settings.workspaces.saving': 'Saving...',
  'settings.workspaces.saveFailed': 'Could not save secure workspace settings.',
  'settings.workspaces.export.title': 'Export workspace changes',
  'settings.workspaces.export.description': 'Review structured changes from an isolated workspace, check them against the project, then apply them explicitly.',
  'settings.workspaces.export.directory': 'Target project directory',
  'settings.workspaces.export.load': 'Load workspaces',
  'settings.workspaces.export.review': "Check for changes",
  'settings.workspaces.export.nothingChanged': "Nothing has changed in this workspace since it was created.",
  'settings.workspaces.export.summary': '{files} files changed',
  'settings.workspaces.export.check': 'Check changes',
  'settings.workspaces.export.apply': 'Apply changes',
  'settings.workspaces.export.expires': 'Export expires at {time}. Re-export if it expires before applying.',
  'settings.workspaces.export.selectedFiles': '{count} files selected',
  'settings.workspaces.export.selectAll': 'Select all',
  'settings.workspaces.export.clearSelection': 'Clear selection',
  'settings.workspaces.export.fileToggle': 'Include this file operation',
  'settings.workspaces.export.hunkToggle': 'Include this text hunk',
  'settings.workspaces.export.binaryWholeFile': 'Binary file: this operation is selected as a whole.',
  'settings.workspaces.export.wholeOperation': 'Rename, symlink, mode, and non-text changes are selected as whole operations.',
  'settings.workspaces.export.failed': 'Failed to export workspace changes.',
  'settings.workspaces.export.checkPassed': 'Selected changes apply without conflicts.',
  'settings.workspaces.export.confirmApply': 'Apply the selected workspace changes to the target project directory?',
  'settings.workspaces.export.confirmDiscard': 'Discard this workspace export artifact?',
  'settings.workspaces.capability.adminRequired': 'A host administrator must grant workspace administration before create, reconcile, cleanup, or export is available. You can still list and use workspaces.',
  'settings.workspaces.capability.hostApplyRequired': 'A host administrator must grant host apply before workspace changes can be applied. You can still list and use workspaces.',
  'settings.workspaces.export.applied': 'Workspace changes applied.',
  'settings.workspaces.lifecycle.title': 'Workspace lifecycle',
  'settings.workspaces.lifecycle.description': 'Create, inspect, delete, or move sessions into isolated workspaces.',
  'settings.workspaces.lifecycle.create': 'Create workspace',
  'settings.workspaces.lifecycle.delete': 'Delete workspace',
  'settings.workspaces.lifecycle.warp': 'Move session',
  'settings.workspaces.lifecycle.sessionPlaceholder': 'Session ID to move into this workspace',
  'settings.workspaces.lifecycle.created': 'Workspace created.',
  'settings.workspaces.lifecycle.deleted': 'Workspace deleted.',
  'settings.workspaces.lifecycle.warped': 'Session moved to workspace.',
  'settings.workspaces.lifecycle.createFailed': 'Could not create workspace.',
  'settings.workspaces.lifecycle.deleteFailed': 'Could not delete workspace.',
  'settings.workspaces.lifecycle.warpFailed': 'Could not move session to workspace.',
  'settings.workspaces.lifecycle.confirmDelete': 'Delete the selected workspace and its managed resources?',
  ...
  'settings.remoteInstances.clientAuth.capabilities.title': 'Capabilities',
  'settings.remoteInstances.clientAuth.capabilities.workspace.read': 'View workspaces',
  'settings.remoteInstances.clientAuth.capabilities.workspace.use': 'Use workspaces',
  'settings.remoteInstances.clientAuth.capabilities.workspace.admin': 'Administer workspaces',
  'settings.remoteInstances.clientAuth.capabilities.host.apply': 'Apply changes to host',
  'settings.remoteInstances.clientAuth.capabilities.grant': 'Grant',
  'settings.remoteInstances.clientAuth.capabilities.revoke': 'Revoke',
  'settings.remoteInstances.clientAuth.capabilities.confirm': '{action} “{capability}” for {client}?',
  'settings.remoteInstances.clientAuth.capabilities.passwordPrompt': 'Confirm with your UI password, or cancel.',
  ...
  'settings.workspaces.status.refreshFailed': 'Could not refresh workspace status.',
  'settings.workspaces.status.connected': "Ready",
  'settings.workspaces.status.connecting': "Starting…",
  'settings.workspaces.status.disconnected': "Stopped",
  'settings.workspaces.status.error': "Needs attention",
  'settings.workspaces.status.unknown': "Checking…",
  'settings.workspaces.lifecycle.empty': 'No workspaces found for this project.',
  'settings.workspaces.lifecycle.startSession': 'Start session',
  'settings.workspaces.lifecycle.startFailed': 'Could not start a session in this workspace.',
  'settings.workspaces.lifecycle.detach': 'Detach session',
  'settings.workspaces.lifecycle.detached': 'Session detached from the workspace.',
  'settings.workspaces.lifecycle.detachFailed': 'Could not detach the session.',
  'settings.workspaces.lifecycle.confirmDetach': 'Detach the current session without copying workspace file changes? Export any changes you want to keep first.',
  'settings.workspaces.lifecycle.noCurrentSession': 'Open a session to move or detach it.',
  'settings.workspaces.handoff.continueWorkspace': 'Continue in workspace',
  'settings.workspaces.handoff.continueHost': 'Continue on host',
  'settings.workspaces.handoff.moveTitle': "Move this chat",
  'settings.workspaces.handoff.moveHint': "Starts a new chat that carries a summary of this one. This chat stays exactly as it is.",
  'settings.workspaces.handoff.chatAlreadyHere': "This chat already runs in this workspace. You can move it back to your computer.",
  'settings.workspaces.handoff.moveIntoWorkspace': "Into this workspace",
  'settings.workspaces.handoff.moveToHost': "To my computer",
  'settings.workspaces.handoff.noCurrentSession': 'Open a session to continue it in a new session.',
  'settings.workspaces.handoff.title': "Review what carries over",
  'settings.workspaces.handoff.description': "Edit the summary that will open the new chat. Files, tools and attachments are not carried over.",
  'settings.workspaces.handoff.fidelityWarning': 'This is a limited text context, not an exact history copy.',
  'settings.workspaces.handoff.sourceUnchanged': 'The source session remains unchanged and can still be opened.',
  'settings.workspaces.handoff.filesWarning': 'File changes are not included. Use the workspace export flow separately.',
  'settings.workspaces.handoff.omissions': '{count} unsupported or sensitive items were omitted.',
  'settings.workspaces.handoff.contextAria': 'Editable context for the new session',
  'settings.workspaces.handoff.confirm': 'Confirm and continue',
  'settings.workspaces.handoff.draftFailed': 'Could not create a handoff draft.',
  'settings.workspaces.handoff.commitFailed': 'Could not complete the context handoff.',
  'settings.workspaces.handoff.verifyFailed': 'The new session context could not be verified.',
  'settings.workspaces.handoff.completed': 'The new session was created and its context was verified.',
  'settings.workspaces.handoff.openSource': 'Open source',
  'settings.workspaces.handoff.openTarget': 'Open new session',
  'settings.workspaces.handoff.cleanupTarget': 'Clean orphan session',
  'settings.workspaces.handoff.cleanupComplete': 'The orphan target session was removed.',
  'settings.workspaces.handoff.cleanupFailed': 'The orphan target session could not be removed.',
