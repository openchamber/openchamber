...
export const settingsDict = {
  ...
  'settings.magicPrompts.sidebar.group.composer': 'Composer',
  ...
  'settings.magicPrompts.sidebar.item.composerEnhance': 'Prompt Enhancer',
  ...
  'settings.magicPrompts.page.group.composerEnhance.title': 'Prompt Enhancer',
  'settings.magicPrompts.page.group.composerEnhance.description': 'Prompt used by the composer\'s Enhance Prompt action: hidden instructions that rewrite your draft with the Small Model before sending.',
