...
export const settingsDict = {
  ...
  'settings.remoteInstances.clientAuth.relayEndpoint.title': 'Relay server',
  'settings.remoteInstances.clientAuth.relayEndpoint.info': 'Endpoint used for "Anywhere" pairing links and relay access. Point it at a self-hosted relay to keep that traffic on your infrastructure; a running relay host reconnects immediately. Pairing links issued earlier keep their original endpoint.',
  'settings.remoteInstances.clientAuth.relayEndpoint.option.default': 'Default',
  'settings.remoteInstances.clientAuth.relayEndpoint.option.custom': 'Custom',
  'settings.remoteInstances.clientAuth.relayEndpoint.field.placeholder': 'wss://your-relay.example/ws',
  'settings.remoteInstances.clientAuth.relayEndpoint.actions.save': 'Save',
  'settings.remoteInstances.clientAuth.relayEndpoint.locked': 'Pinned by the OPENCHAMBER_RELAY_URL environment variable:',
