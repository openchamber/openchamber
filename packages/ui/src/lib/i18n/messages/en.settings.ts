export const settingsDict = {
  ...
  'settings.page.harness.description': 'Choose and manage execution harnesses.',
  ...
  'settings.harness.sidebar.subtitle': 'Execution backends for chat sessions',
  'settings.harness.sidebar.harness.opencode': 'OpenCode',
  'settings.harness.sidebar.harness.claudeCode': 'Claude Code',
  'settings.harness.sidebar.status.ready': 'Ready',
  'settings.harness.sidebar.status.needsLogin': 'Needs login',
  'settings.harness.sidebar.status.missingCli': 'Missing CLI',
  'settings.harness.sidebar.status.unsupportedHost': 'Unavailable here',
  'settings.harness.sidebar.status.error': 'Error',
  'settings.harness.sidebar.status.unknown': 'Unknown',
  'settings.harness.sidebar.status.loading': 'Checking…',
  'settings.harness.page.empty.selectHarness': 'Select a harness from the sidebar',
  'settings.harness.page.loadError': 'Could not load harness status',
  'settings.harness.opencode.title': 'OpenCode',
  'settings.harness.opencode.description': 'Default harness. Uses OpenCode providers and agents.',
  'settings.harness.opencode.section.about': 'About',
  'settings.harness.opencode.about.body': 'OpenCode runs models through your configured providers. Manage API keys under Providers and agent settings under Agents.',
  'settings.harness.opencode.link.providers': 'Open Providers',
  'settings.harness.opencode.link.agents': 'Open Agents',
  'settings.harness.claudeCode.title': 'Claude Code',
  'settings.harness.claudeCode.description': 'Native Claude Code CLI with subscription usage limits.',
  ...
  'settings.harness.claudeCode.status.versionUnknown': 'Unknown',
  'settings.harness.claudeCode.actions.redetect': 'Re-detect',
  'settings.harness.claudeCode.actions.redetectAria': 'Re-detect Claude Code status',
  'settings.harness.claudeCode.actions.openDocs': 'Open docs',
  'settings.harness.claudeCode.actions.openDocsAria': 'Open Claude Code documentation',
  'settings.harness.claudeCode.login.title': 'Sign in with Claude',
  'settings.harness.claudeCode.login.body': 'Install the Claude CLI and run claude login on this host so OpenChamber can use your Claude subscription.',
  'settings.harness.claudeCode.section.capabilities': 'Capabilities',
  'settings.harness.claudeCode.capabilities.empty': 'Capabilities appear after a successful detect.',
  'settings.harness.claudeCode.capability.full': 'Full',
  'settings.harness.claudeCode.capability.partial': 'Partial',
  'settings.harness.claudeCode.capability.none': 'Not available',
  'settings.harness.claudeCode.section.agents': 'Agents',
  'settings.harness.claudeCode.agentsMode.label': 'Agents to use',
  'settings.harness.claudeCode.agentsMode.aria': 'Choose Claude or OpenCode agents for Claude Code sessions',
  'settings.harness.claudeCode.agentsMode.info': 'Claude uses its own agents, prompts and permission settings. OpenCode makes Claude sessions run the selected OpenCode agent instead: its permission rules decide every tool call, its prompt is added to Claude\'s, and your custom OpenCode subagents become available to Claude. The composer agent picker switches to match.',
  'settings.harness.claudeCode.agentsMode.claude': 'Claude',
  'settings.harness.claudeCode.agentsMode.opencode': 'OpenCode',
  'settings.harness.claudeCode.section.warnings': 'Warnings',
'settings.harness.claudeCode.warnHandoff.label': 'Confirm when switching harness',
'settings.harness.claudeCode.warnHandoff.aria': 'Confirm when switching harness',
'settings.harness.claudeCode.warnHandoff.info': 'Shows a dialog before starting a new session on harness switch. When off, the switch applies silently on your next message.',
  'settings.harness.claudeCode.section.import': 'Import',
  'settings.harness.claudeCode.import.note': 'Import local Claude Code projects and chats into OpenChamber. Chats resume on Claude Code; transcripts are not copied into OpenCode history.',
  'settings.harness.claudeCode.import.actions.open': 'Import from Claude Code',
  'settings.harness.claudeCode.import.actions.openAria': 'Open Claude Code import dialog',
  'settings.harness.claudeCode.import.dialog.title': 'Import from Claude Code',
  'settings.harness.claudeCode.import.dialog.description': 'Select chats stored under your Claude Code projects folder on this host. Already imported chats are skipped.',
  'settings.harness.claudeCode.import.dialog.loading': 'Scanning Claude Code projects…',
  'settings.harness.claudeCode.import.dialog.empty': 'No Claude Code chats found on this host.',
  'settings.harness.claudeCode.import.dialog.selectAll': 'Select all',
  'settings.harness.claudeCode.import.dialog.selectAllAria': 'Select all importable Claude Code chats',
  'settings.harness.claudeCode.import.dialog.selectedCount': '{count} selected',
  'settings.harness.claudeCode.import.dialog.projectAria': 'Select all chats in {name}',
  'settings.harness.claudeCode.import.dialog.sessionAria': 'Select chat {title}',
  'settings.harness.claudeCode.import.dialog.sessionCount': '{count} chats',
  'settings.harness.claudeCode.import.dialog.directoryMissing': 'Folder missing',
  'settings.harness.claudeCode.import.dialog.alreadyImported': 'Already imported',
  'settings.harness.claudeCode.import.dialog.untitled': 'Untitled chat',
  'settings.harness.claudeCode.import.dialog.cancel': 'Cancel',
  'settings.harness.claudeCode.import.dialog.import': 'Import ({count})',
  'settings.harness.claudeCode.import.dialog.importing': 'Importing…',
  'settings.harness.claudeCode.import.error.load': 'Could not scan Claude Code projects.',
  'settings.harness.claudeCode.import.error.import': 'Import failed.',
  'settings.harness.claudeCode.import.toast.success': 'Imported {count} Claude Code chats.',
  'settings.harness.claudeCode.import.toast.skippedOnly': 'Skipped {count} chats that were already imported.',
  'settings.harness.claudeCode.import.toast.partialFail': 'Imported {imported}; {failed} failed.',
  'settings.harness.claudeCode.import.toast.none': 'Nothing was imported.',
  'settings.harness.claudeCode.section.apiKeys': 'API keys',
  'settings.harness.claudeCode.apiKeys.note': 'Anthropic API keys stay under Providers on OpenCode. Claude Code uses your Claude subscription login on the host.',
  'settings.harness.capability.prompt': 'Prompt',
  'settings.harness.capability.abort': 'Abort',
  'settings.harness.capability.resume': 'Resume',
  'settings.harness.capability.streaming-text': 'Streaming text',
  'settings.harness.capability.streaming-tools': 'Streaming tools',
  'settings.harness.capability.permissions': 'Permissions',
  'settings.harness.capability.images': 'Images',
  'settings.harness.capability.file-attachments': 'File attachments',
  'settings.harness.capability.shell': 'Shell',
  'settings.harness.capability.slash-commands': 'Slash commands',
  'settings.harness.capability.mcp': 'MCP',
  'settings.harness.capability.subagents': 'Subagents',
