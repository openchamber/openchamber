export const settingsDict = {
  ...
  'settings.openchamber.visual.field.contextPanelDock': 'Context panel position',
  'settings.openchamber.visual.field.contextPanelDockAria': 'Context panel position',
  'settings.openchamber.visual.field.contextPanelDockHint': 'Moves the whole context panel, not just the terminal: every surface (terminal, changes, diff, files, notes) docks to the chosen edge of the chat column.',
  'settings.openchamber.visual.option.contextPanelDock.right': 'Right',
  'settings.openchamber.visual.option.contextPanelDock.bottom': 'Bottom',
