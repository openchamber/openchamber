export const settingsDict = {
  ...
  'settings.openchamber.visual.field.showSubagentSessionsInSidebarAria': 'Show subagent sessions in the sidebar',
  'settings.openchamber.visual.field.showSubagentSessionsInSidebar': 'Show Subagent Sessions in the Sidebar',
  'settings.openchamber.visual.field.showSubagentSessionsInSidebarDescription': 'Display subagent sessions as independent rows. When off, subagents are hidden from the sidebar and only accessible from the parent session chat.',
