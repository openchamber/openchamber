...
export const settingsDict = {
  ...
  'settings.projects.shellEnv.title': 'Shell environment',
  'settings.projects.shellEnv.state.loading': 'Loading...',
  'settings.projects.shellEnv.state.loadFailed': 'Could not read this project\'s configuration. Nothing is changed until it loads.',
  'settings.projects.shellEnv.description': 'Load this project\'s development environment (devenv, direnv, a shell script) and apply it to Git, the terminal, and Project Actions.',
  'settings.projects.shellEnv.enabled': 'Enable for this project',
  'settings.projects.shellEnv.disabledWarning': 'Saved but off: the command will not run until you enable it.',
  'settings.projects.shellEnv.command.label': 'Environment command',
  'settings.projects.shellEnv.command.placeholder': 'devenv print-dev-env --json',
  'settings.projects.shellEnv.command.info': 'A command whose output describes the environment. Supported: devenv print-dev-env --json, direnv export json, or export/NAME=value lines. It runs from the project root.',
  'settings.projects.shellEnv.mode.label': 'PATH handling',
  'settings.projects.shellEnv.mode.overlay': 'Prepend to system PATH',
  'settings.projects.shellEnv.mode.replace': 'Replace system PATH',
  'settings.projects.shellEnv.mode.info': 'Prepend keeps system tools reachable and puts the project\'s tools first. Replace uses the project\'s PATH exactly.',
  'settings.projects.shellEnv.vars.label': 'Extra variables',
  'settings.projects.shellEnv.vars.info': 'Optional NAME=value pairs, one per line, applied on top of the command output. They win over parsed values.',
  'settings.projects.shellEnv.vars.placeholder': 'GOFLAGS=-mod=vendor',
  'settings.projects.shellEnv.vars.invalid': 'Not a valid NAME=value line: {names}',
  'settings.projects.shellEnv.trustInfo': 'The command runs locally from your own settings, never from the repository. Nothing runs until you enable it here.',
  'settings.projects.shellEnv.toast.saveFailed': 'Failed to save the project shell environment',
