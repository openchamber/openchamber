...
export const settingsDict = {
  ...
  'settings.page.fusion.title': 'Fusion',
  'settings.page.fusion.description': 'Curated model panels for model fusion.',
  'settings.fusion.empty': 'No presets yet. Add your first one.',
  'settings.fusion.add': 'Add preset',
  'settings.fusion.edit': 'Edit',
  'settings.fusion.delete': 'Delete',
  'settings.fusion.deleteTitle': 'Delete fusion preset',
  'settings.fusion.deleteConfirm': 'Delete preset {name}?',
  'settings.fusion.dialogTitleNew': 'New fusion preset',
  'settings.fusion.dialogTitleEdit': 'Edit fusion preset',
  'settings.fusion.dialogDescription': 'A named panel of 2-4 models.',
  'settings.fusion.nameLabel': 'Name',
  'settings.fusion.descriptionLabel': 'Description',
  'settings.fusion.modelsLabel': 'Models ({count}/4)',
  'settings.fusion.modelsHint': 'Pick 2-4 models.',
  'settings.fusion.searchModels': 'Search models',
  'settings.fusion.noModelResults': 'No models match your search.',
  'settings.fusion.save': 'Save',
  'settings.fusion.cancel': 'Cancel',
  'settings.fusion.loading': 'Loading…',
  'settings.fusion.loadError': 'Failed to load presets: {error}',
  'settings.fusion.noModels': 'No models are configured for this directory.',
  'settings.fusion.required': 'Name + 2-4 models required.',
