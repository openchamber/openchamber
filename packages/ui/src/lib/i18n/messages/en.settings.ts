...
export const settingsDict = {
  ...
  'settings.providers.page.custom.models.capabilities.title': 'Capabilities',
  'settings.providers.page.custom.models.capabilities.attachment.label': 'Attachments',
  'settings.providers.page.custom.models.capabilities.attachment.info': 'Whether this model accepts file attachments.',
  'settings.providers.page.custom.models.capabilities.attachment.unset': 'Not set',
  'settings.providers.page.custom.models.capabilities.attachment.enabled': 'Supported',
  'settings.providers.page.custom.models.capabilities.attachment.disabled': 'Not supported',
  'settings.providers.page.custom.models.capabilities.modalities.input.label': 'Input modalities',
  'settings.providers.page.custom.models.capabilities.modalities.output.label': 'Output modalities',
  'settings.providers.page.custom.models.capabilities.modalities.info': 'Select the content types this model supports.',
  'settings.providers.page.custom.models.capabilities.limit.title': 'Token limits',
  'settings.providers.page.custom.models.capabilities.limit.context': 'Context',
  'settings.providers.page.custom.models.capabilities.limit.input': 'Input',
  'settings.providers.page.custom.models.capabilities.limit.output': 'Output',
  'settings.providers.page.custom.models.capabilities.variants.title': 'Variants',
  'settings.providers.page.custom.models.capabilities.variants.info': 'Select the reasoning efforts this model supports. Variants authored by hand in the config are preserved.',
