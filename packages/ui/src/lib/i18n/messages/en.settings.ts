...
export const settingsDict = {
  ...
  'settings.openchamber.tunnel.field.tailscaleHttpsPort': 'Tailscale HTTPS port',
  'settings.openchamber.tunnel.field.tailscaleHttpsPortDescription': 'Tailscale frontend port. Serve accepts any port from 1 to 65535; Funnel supports 443, 8443, or 10000.',
  'settings.openchamber.tunnel.field.tailscaleServeHttpsPortDescription': 'Serve accepts any integer from 1 to 65535.',
  'settings.openchamber.tunnel.field.tailscaleFunnelHttpsPortDescription': 'Funnel supports only 443, 8443, or 10000.',
  'settings.openchamber.tunnel.field.tailscaleHttpsPortError': 'Enter a whole number from 1 to 65535.',
  ...
  'settings.openchamber.tunnel.notAvailable.tailscaleInstallHint': 'Install Tailscale and sign in on this device before starting:',
  'settings.openchamber.tunnel.option.mode.privateNetwork.label': 'Tailnet only (Serve)',
  'settings.openchamber.tunnel.option.mode.privateNetwork.tooltip': 'Tailscale Serve keeps access inside your tailnet.',
  'settings.openchamber.tunnel.option.mode.tailscaleQuick.label': 'Public (Funnel)',
  'settings.openchamber.tunnel.option.mode.tailscaleQuick.tooltip': 'Tailscale Funnel makes this instance reachable from the public internet.',
  'settings.openchamber.tunnel.warning.tailscaleFunnelPublic': 'Tailscale Funnel exposes this instance to the public internet. Use it only when public exposure is intended.',
  'settings.openchamber.tunnel.badge.privateNetwork': 'Tailnet',
  'settings.openchamber.tunnel.toast.startedButNoUrl': 'The tunnel started but did not return an access URL.',
