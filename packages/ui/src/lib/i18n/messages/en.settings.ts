...
export const settingsDict = {
  ...
  'settings.voice.page.field.browserMicrophonePermission': 'When you press the microphone in chat, allow microphone access if the browser asks. If no prompt appears or access is blocked, open the site controls beside the address bar, allow Microphone in site settings, then reload and try again.',
