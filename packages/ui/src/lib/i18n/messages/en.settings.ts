export const settingsDict = {
  ...
  'settings.openchamber.visual.field.showMessageSpeedMetricsAria': 'Show message speed metrics',
  'settings.openchamber.visual.field.showMessageSpeedMetrics': 'Show Message Speed Metrics',
  'settings.openchamber.visual.field.showMessageSpeedMetricsInfo': 'Show time to first token, output throughput, and the uncached / cache / output token split on each assistant message. Time to first token is measured on the OpenCode server from message start to the first reasoning or text part.',
