export const settingsDict = {
  ...
  'settings.openchamber.worktrees.start.label': 'Start commands',
  'settings.openchamber.worktrees.start.commandPlaceholder': 'e.g., ./scripts/run.sh',
  'settings.openchamber.worktrees.start.addCommand': 'Add command',
  'settings.openchamber.worktrees.start.removeCommandAria': 'Remove command',
  'settings.openchamber.worktrees.start.toast.saveFailed': 'Failed to save start commands',
  'settings.openchamber.worktrees.shutdown.label': 'Shutdown commands',
  'settings.openchamber.worktrees.shutdown.commandPlaceholder': 'e.g., ./scripts/stop.sh',
  'settings.openchamber.worktrees.shutdown.addCommand': 'Add command',
  'settings.openchamber.worktrees.shutdown.removeCommandAria': 'Remove command',
  'settings.openchamber.worktrees.shutdown.toast.saveFailed': 'Failed to save shutdown commands',
  'settings.openchamber.worktrees.commands.runStartAria': 'Run start commands for {name}',
  'settings.openchamber.worktrees.commands.runShutdownAria': 'Run shutdown commands for {name}',
  'settings.openchamber.worktrees.commands.viewSetupLogAria': 'View setup output for {name}',
  'settings.openchamber.worktrees.commands.noCommands': 'No {kind} configured for this project.',
  'settings.openchamber.worktrees.commands.dialogTitleStart': 'Start commands — {name}',
  'settings.openchamber.worktrees.commands.dialogTitleShutdown': 'Shutdown commands — {name}',
  'settings.openchamber.worktrees.commands.dialogTitleSetup': 'Setup output — {name}',
  'settings.openchamber.worktrees.commands.dialogRunning': 'Running...',
  'settings.openchamber.worktrees.commands.dialogFailed': 'Command failed',
  'settings.openchamber.worktrees.commands.dialogTimedOut': 'Command exceeded the time limit — showing output so far.',
  'settings.openchamber.worktrees.commands.dialogEmptyOutput': 'No output.',
  'settings.openchamber.worktrees.commands.dialogClose': 'Close',
