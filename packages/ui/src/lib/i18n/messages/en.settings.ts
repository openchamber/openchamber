export const settingsDict = {
  ...
  'settings.page.sessions.description': 'Set session defaults, permission handling, and retention.',
  ...
  'settings.openchamber.permissionAutoAccept.title': 'Permission auto-accept',
  'settings.openchamber.permissionAutoAccept.info': 'Applies to every session on this runtime unless a session explicitly enables or disables its own permission policy. Turning it on also resolves already pending permission requests.',
  'settings.openchamber.permissionAutoAccept.field.globalLabel': 'Automatically approve permission requests for all sessions on this runtime',
  'settings.openchamber.permissionAutoAccept.field.globalAria': 'Automatically approve permission requests for all sessions on this runtime',
  'settings.openchamber.permissionAutoAccept.field.globalWarning': 'Security: OpenChamber will approve pending and future permission requests without asking you until a session explicitly overrides it.',
  'settings.openchamber.permissionAutoAccept.dialog.title': 'Enable permission auto-accept for every session?',
  'settings.openchamber.permissionAutoAccept.dialog.description': 'OpenChamber will immediately approve already pending permission requests and will keep approving new ones on this runtime until a session explicitly overrides the policy. Only enable this on a trusted runtime.',
  'settings.openchamber.permissionAutoAccept.dialog.confirm': 'Enable auto-accept',
