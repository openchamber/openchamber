...
export const settingsDict = {
  ...
  'settings.openchamber.tools.field.serverBrowser': 'Server browser',
  'settings.openchamber.tools.field.serverBrowserAria': 'Enable the server browser',
  'settings.openchamber.tools.field.serverBrowserInfo': 'Run a Chrome browser on this server so agents can browse even when no connected window can serve them, and so you can view and drive the same pages from any device. Off by default and applies immediately; turning it off stops Chrome and closes its sessions and viewers.',
  'settings.openchamber.tools.browserDebugPort.label': 'Browser CDP port',
  'settings.openchamber.tools.browserDebugPort.info': 'Choose the port used for local MCP connections. Saving applies when Chrome next starts and keeps current tabs open.',
  'settings.openchamber.tools.browserDebugPort.automatic': 'Automatic',
  'settings.openchamber.tools.browserDebugPort.fixed': 'Fixed port',
  'settings.openchamber.tools.browserDebugPort.input': 'Fixed CDP port',
  'settings.openchamber.tools.browserDebugPort.invalid': 'Enter a whole number from 1 to 65535.',
  'settings.openchamber.tools.browserDebugPort.save': 'Save port',
  'settings.openchamber.tools.browserDebugPort.configuredAutomatic': 'Configured port: automatic',
  'settings.openchamber.tools.browserDebugPort.configuredFixed': 'Configured port: {port}',
  'settings.openchamber.tools.browserDebugPort.loading': 'Checking browser status…',
  'settings.openchamber.tools.browserDebugPort.unavailable': 'Browser status is unavailable.',
  'settings.openchamber.tools.browserDebugPort.stopped': 'Chrome is not running.',
  'settings.openchamber.tools.browserDebugPort.active': 'Active port: {port}',
  'settings.openchamber.tools.browserDebugPort.pending': 'The saved port will apply when Chrome next starts.',
  'settings.openchamber.tools.browserDebugPort.refresh': 'Refresh status',
  'settings.openchamber.tools.browserDebugPort.copy': 'Copy browser URL',
  'settings.openchamber.tools.browserDebugPort.copied': 'Browser URL copied',
  'settings.openchamber.tools.browserDebugPort.copyFailed': 'Could not copy the browser URL.',
  'settings.openchamber.tools.browserDebugPort.connectionInfo': 'This loopback address belongs to the server machine. Run MCP there with --browserUrl, or use your own SSH tunnel. Direct MCP connections do not use Take control.',
