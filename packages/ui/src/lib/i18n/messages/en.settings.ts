export const settingsDict = {
  ...
  'settings.openchamber.defaults.backgroundAutoAccept.label': 'Background Auto-Accept',
  'settings.openchamber.defaults.backgroundAutoAccept.description': 'Keep your existing permission auto-accept policies active when no UI client is connected.',
  'settings.openchamber.defaults.backgroundAutoAccept.warning': 'Warning: OpenChamber will automatically approve matching permissions while this is enabled.',
  'settings.openchamber.defaults.backgroundAutoAccept.saveFailed': 'Failed to save background auto-accept setting',
