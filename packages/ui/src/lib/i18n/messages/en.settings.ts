export const settingsDict = {
  'settings.openchamber.pet.create.title': 'Create a pet',
  'settings.openchamber.pet.create.description': 'Upload a spritesheet image and name your pet.',
  'settings.openchamber.pet.create.nameLabel': 'Name',
  'settings.openchamber.pet.create.descriptionLabel': 'Description',
  'settings.openchamber.pet.create.chooseImage': 'Choose spritesheet…',
  'settings.openchamber.pet.create.submit': 'Create',
  'settings.openchamber.pet.create.cancel': 'Cancel',
  'settings.openchamber.pet.create.changeImage': 'Change spritesheet…',
  'settings.openchamber.pet.create.namePlaceholder': 'My pet',
  'settings.openchamber.pet.create.descriptionPlaceholder': 'Optional',
  'settings.openchamber.pet.create.previewEmpty': 'Choose a spritesheet to preview it here',
  'settings.openchamber.pet.create.previewFailed': 'Could not load that image',
  'settings.openchamber.pet.create.creating': 'Creating…',
  'settings.openchamber.pet.createFailed': 'Failed to create pet',
  'settings.openchamber.pet.createSuccess': 'Pet created',
  'settings.openchamber.pet.section': 'Desktop Pet',
  'settings.openchamber.pet.enable.label': 'Show floating pet',
  'settings.openchamber.pet.enable.hint': 'A small companion that floats on top and reflects session status.',
  'settings.openchamber.pet.select.label': 'Pet',
  'settings.openchamber.pet.empty': 'No pets installed yet. Create your own to get started.',
  'settings.openchamber.pet.createOwn': 'Create your own pet',
  'settings.openchamber.pet.refresh': 'Refresh',
  'settings.openchamber.pet.wake': 'Wake Pet',
  'settings.openchamber.pet.sleep': 'Sleep Pet',
  'settings.openchamber.pet.selectAction': 'Select',
  'settings.openchamber.pet.selectAria': 'Select {name}',
  'settings.openchamber.pet.selected': 'Selected',
  'settings.openchamber.pet.customPets': 'Custom pets',
  'settings.openchamber.pet.openFolder': 'Open folder',
  'settings.openchamber.pet.openFolderFailed': 'Failed to open the pets folder',
  'settings.openchamber.pet.edit.aria': 'Edit {name}',
  'settings.openchamber.pet.edit.title': 'Edit pet',
  'settings.openchamber.pet.edit.description': 'Update the name, description, or spritesheet.',
  'settings.openchamber.pet.edit.submit': 'Save',
  'settings.openchamber.pet.edit.saving': 'Saving…',
  'settings.openchamber.pet.editSuccess': 'Pet updated',
  'settings.openchamber.pet.editFailed': 'Failed to update pet',
  'settings.openchamber.pet.delete.aria': 'Delete {name}',
  'settings.openchamber.pet.delete.title': 'Delete pet?',
  'settings.openchamber.pet.delete.description': 'This permanently deletes {name}.',
  'settings.openchamber.pet.delete.confirm': 'Delete',
  'settings.openchamber.pet.deleteSuccess': 'Pet deleted',
  'settings.openchamber.pet.deleteFailed': 'Failed to delete pet',
