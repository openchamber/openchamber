export const settingsDict = {
  ...
  'settings.providers.page.models.tokenBadge.effectiveContext': 'effective ctx',
  'settings.providers.page.models.contextCap.description': 'Review each model\'s advertised context window and set a smaller custom user limit only when needed.',
  'settings.providers.page.models.contextCap.searchTitle': 'Model context limits',
  'settings.providers.page.models.contextCap.label': 'Context',
  'settings.providers.page.models.contextCap.advertised': '(advertised {tokens})',
  'settings.providers.page.models.contextCap.placeholder': 'e.g. 80k',
  'settings.providers.page.models.contextCap.placeholderMax': 'Max {tokens}',
  'settings.providers.page.models.contextCap.aria': 'Custom context limit for {model}',
  'settings.providers.page.models.contextCap.save': 'Save',
  'settings.providers.page.models.contextCap.valueAdvertised': '{tokens} advertised',
  'settings.providers.page.models.contextCap.valueModelMax': '{tokens} model max',
  'settings.providers.page.models.contextCap.valueCustom': '{tokens} custom',
  'settings.providers.page.models.contextCap.advertisedMax': 'Advertised max: {tokens}',
  'settings.providers.page.models.contextCap.modelMax': 'Model max: {tokens}',
  'settings.providers.page.models.contextCap.usingModelMax': 'Using model max',
  'settings.providers.page.models.contextCap.maxUnavailable': 'Advertised max unavailable',
  'settings.providers.page.models.contextCap.unknown': 'Unknown',
  'settings.providers.page.models.contextCap.customLimitLabel': 'Custom context limit',
  'settings.providers.page.models.contextCap.helperWithMax': 'Must be {tokens} tokens or less. Supports 200000, 200k, or 1.5m.',
  'settings.providers.page.models.contextCap.setCustom': 'Set custom limit',
  'settings.providers.page.models.contextCap.edit': 'Edit',
  'settings.providers.page.models.contextCap.useModelMax': 'Use model max',
  'settings.providers.page.models.contextCap.remove': 'Remove custom limit',
  ...
  'settings.providers.page.toast.contextCapLoadFailed': 'Failed to load model context caps',
  'settings.providers.page.toast.contextCapInvalid': 'Enter a positive token limit, for example 200k.',
  'settings.providers.page.toast.contextCapTooHigh': 'Enter {tokens} or less for this model.',
  'settings.providers.page.toast.contextCapSaveFailed': 'Failed to save model context cap',
  'settings.providers.page.toast.contextCapSaved': 'Model context cap saved',
  'settings.providers.page.toast.contextCapCleared': 'Model context cap cleared',
