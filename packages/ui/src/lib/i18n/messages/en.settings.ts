export const settingsDict = {
  ...
  'settings.providers.sidebar.section.customProviders': 'Custom Providers',
  ...
  'settings.providers.page.connect.availableProvidersSection': 'Available providers',
  'settings.providers.page.connect.configureCustomProvider': 'Configure custom provider',
  ...
  'settings.providers.page.custom.description': 'Add a provider with an API protocol, base URL, credentials, and model list. Saved to OpenCode config so it works in chat like any other provider.',
  ...
  'settings.providers.page.custom.protocol.label': 'API protocol',
  'settings.providers.page.custom.protocol.info': 'Select the request and response format supported by this provider. The adapter appends the protocol endpoint to the base URL.',
  ...
  'settings.providers.page.custom.field.baseURL.info': 'API base URL without the protocol endpoint. Must start with http:// or https://.',
  ...
  'settings.providers.page.custom.models.contextLimitLabel': 'Context window',
  'settings.providers.page.custom.models.contextLimitInfo': 'Maximum number of tokens the model can consider in one request.',
  'settings.providers.page.custom.models.contextLimitPlaceholder': '128000',
  'settings.providers.page.custom.models.inputLimitLabel': 'Maximum input',
  'settings.providers.page.custom.models.inputLimitInfo': 'Optional prompt-token limit when it differs from the total context window.',
  'settings.providers.page.custom.models.inputLimitPlaceholder': 'Optional',
  'settings.providers.page.custom.models.outputLimitLabel': 'Maximum output',
  'settings.providers.page.custom.models.outputLimitInfo': 'Maximum number of tokens the model can generate in one response.',
  'settings.providers.page.custom.models.outputLimitPlaceholder': '8192',
  'settings.providers.page.custom.models.imageInputLabel': 'Image input',
  ...
  'settings.providers.page.custom.models.capability.unsupported': 'Unsupported',
  ...
  'settings.providers.page.custom.error.positiveInteger': 'Enter a positive whole number',
  ...
  'settings.providers.page.models.capability.imageInputUnsupported': 'No image input',
  'settings.providers.page.models.thinkingLevels': 'Thinking levels',
  'settings.providers.page.models.tokenBadge.context': 'context',
  'settings.providers.page.models.tokenBadge.output': 'max output',
