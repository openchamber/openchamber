export const settingsDict = {
  ...
  'settings.agents.sidebar.error.title': "Couldn't load agents",
  'settings.agents.sidebar.error.description': 'OpenCode backend unavailable. Check the connection and try again.',
  'settings.agents.sidebar.error.retry': 'Retry',
