...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.worktreeDiscovery': 'Check project Git status and worktrees automatically',
  'settings.openchamber.visual.field.worktreeDiscoveryAria': 'Toggle automatic project Git checks',
  'settings.openchamber.visual.field.worktreeDiscoveryInfo': 'Off by default. When enabled, OpenChamber checks the active project and projects with active sessions. Existing Git data remains usable when this is off.',
  'settings.openchamber.visual.field.worktreeDiscoveryInterval': 'Minimum interval between automatic Git checks',
  'settings.openchamber.visual.field.worktreeDiscoveryIntervalAria': 'Select worktree discovery refresh interval',
  'settings.openchamber.visual.field.worktreeDiscoveryIntervalInfo': 'Minimum time between automatic checks. Immediately means the event adds no extra delay.',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.0': 'Immediately (no extra delay)',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.30000': '30 seconds',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.60000': '1 minute',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.300000': '5 minutes',
  'settings.openchamber.visual.field.backgroundProjectSessionLoading': 'Load sessions from all projects in the background',
  'settings.openchamber.visual.field.backgroundProjectSessionLoadingAria': 'Toggle background session loading for all projects',
  'settings.openchamber.visual.field.backgroundProjectSessionLoadingInfo': 'Off by default. When enabled, OpenChamber loads session data for every project in the sidebar. Turn it off to load only the active, expanded, or active-session projects.',
