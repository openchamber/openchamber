export const settingsDict = {
  ...
  'settings.projects.codexImport.action': 'Import Codex conversations',
  'settings.projects.codexImport.title': 'Import from Codex',
  'settings.projects.codexImport.description': 'Add Codex projects and save each conversation as a readable OpenCode transcript. Codex data is not modified.',
  'settings.projects.codexImport.loading': 'Reading Codex projects and conversations...',
  'settings.projects.codexImport.error.inspect': 'Failed to read Codex data.',
  'settings.projects.codexImport.error.apply': 'Failed to import Codex data.',
  'settings.projects.codexImport.config.model': 'Model: {model}',
  'settings.projects.codexImport.config.provider': 'Provider: {provider}',
  'settings.projects.codexImport.config.unset': 'Not set',
  'settings.projects.codexImport.projects.title': 'Projects to import',
  'settings.projects.codexImport.projects.conversations': 'Conversations: {count}',
  'settings.projects.codexImport.projects.missing': 'Directory is no longer available',
  'settings.projects.codexImport.empty': 'No Codex projects or conversations were found.',
  'settings.projects.codexImport.actions.retry': 'Try again',
  'settings.projects.codexImport.actions.selectAll': 'Select all',
  'settings.projects.codexImport.actions.selectNone': 'Select none',
  'settings.projects.codexImport.actions.importing': 'Importing...',
  'settings.projects.codexImport.result.summary': 'Imported {imported}, skipped {skipped}, failed {failed}.',
  'settings.projects.codexImport.toast.partial': 'Codex import finished: {imported} imported, {skipped} skipped, {failed} failed.',
  'settings.projects.codexImport.toast.complete': 'Codex import finished: {imported} imported, {skipped} already present.',
