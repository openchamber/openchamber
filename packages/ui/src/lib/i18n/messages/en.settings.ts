...
export const settingsDict = {
  'settings.sourceControl.ssh.title': 'Managed SSH credentials',
  'settings.sourceControl.ssh.load': 'Load server keys',
  'settings.sourceControl.ssh.discover': 'Discover host keys',
  'settings.sourceControl.ssh.empty': 'No managed SSH keys are configured on this server.',
  'settings.sourceControl.ssh.hostSetup': 'Discovery checks only immediate private-key files in the connected server user\'s ~/.ssh directory. It does not inspect subdirectories, symlinks, SSH config, or agents. Imported copies stay in the server data directory. For passphrase-protected or agent-only keys, explicitly select System transport instead; its credentials are unverified.',
  'settings.sourceControl.ssh.unreadable': 'Key is unreadable on the server. Repair host setup or select System.',
  'settings.sourceControl.ssh.changed': 'Key fingerprint changed. Repair host setup or select System.',
  'settings.sourceControl.ssh.unverifiable': 'Key is encrypted or cannot be verified. Repair host setup or select System.',
  'settings.sourceControl.ssh.insecurePermissions': 'Key permissions allow access by other users. Restrict the host file before importing it.',
  'settings.sourceControl.ssh.discoveredEmpty': 'No importable private keys were found in the approved server directory.',
  'settings.sourceControl.ssh.discoveryTruncated': 'The directory contains more entries than the discovery limit. Some files were not inspected.',
  'settings.sourceControl.ssh.confirmFingerprint': 'I verified this fingerprint: {fingerprint}',
  'settings.sourceControl.ssh.import': 'Import key',
  'settings.sourceControl.ssh.imported': 'The key was copied into managed server storage. No repository binding was changed.',
  'settings.sourceControl.ssh.candidateExpired': 'This discovery result expired. Discover host keys again.',
  'settings.sourceControl.ssh.candidateChanged': 'The host key changed after discovery. Discover it again before importing.',
  'settings.sourceControl.ssh.confirmationMismatch': 'The confirmed fingerprint does not match this discovery result.',
  ...
  'settings.gitIdentities.editor.field.account': 'Source control account',
  'settings.gitIdentities.editor.field.accountNone': 'No account',
  'settings.gitIdentities.editor.auth.label': 'Auth Method',
  'settings.gitIdentities.editor.auth.oauth': 'OAuth',
  'settings.gitIdentities.editor.auth.token': 'Token',
  'settings.gitIdentities.editor.auth.anonymous': 'Anonymous',
  'settings.gitIdentities.editor.auth.ssh': 'SSH',
  'settings.gitIdentities.editor.auth.oauthHint': 'Pushes and pulls with the account\'s OAuth sign-in.',
  'settings.gitIdentities.editor.auth.tokenHint': 'Pushes and pulls with the account\'s personal access token.',
  ...
  'settings.openchamber.git.agentAuthority': 'Apply identities in agent shells',
  'settings.openchamber.git.agentAuthorityAria': 'Apply identities in agent shells',
  'settings.openchamber.git.agentAuthorityInfo': 'Git the agent runs itself gets the repository\'s identity instead of this computer\'s own setup, and the agent is asked to use the OpenChamber tool instead of a raw transfer. Repositories on System Git keep this computer\'s setup. Applies on the next OpenCode restart, and never to your own terminal.',
  ...
  'settings.gitlab.info': 'Connect GitLab.com or a self-managed GitLab instance for merge requests, issues, and CI.',
  'settings.gitlab.instance.customLabel': 'GitLab instance',
  'settings.gitlab.instance.customInfo': 'Use an HTTPS origin. HTTP is allowed only for loopback addresses.',
  ...
  'settings.gitlab.status.tokenRejected': 'GitLab did not accept that token. Check that it belongs to this instance and has API access.',
  ...
  'settings.gitlab.device.label': 'Device code',
  'settings.gitlab.cli.label': 'glab CLI',
  'settings.gitlab.cli.info': 'Use credentials from glab when no saved account is active.',
  'settings.gitlab.actions.enableCli': 'Enable glab',
  'settings.gitlab.actions.disableCli': 'Disable glab',
  'settings.gitlab.instances.title': 'Instances',
  'settings.gitlab.actions.addInstance': 'Add instance',
  'settings.gitlab.device.waiting': 'Authorize the device in GitLab, then return to OpenChamber. This page updates automatically.',
  'settings.gitlab.actions.openGitLab': 'Open GitLab',
  'settings.sourceControl.accounts.inUse': 'In use',
  'settings.sourceControl.accounts.available': 'Available',
  'settings.sourceControl.accounts.configured': 'Configured accounts',
  'settings.sourceControl.accounts.connectedCount': '{count} accounts',
  'settings.sourceControl.accounts.needsAuthentication': 'Needs authentication',
  'settings.sourceControl.actions.reauthenticate': 'Re-authenticate',
  'settings.sourceControl.actions.remove': 'Remove',
  'settings.sourceControl.binding.accountLabel': 'Source control account',
  'settings.sourceControl.agentAuthority.title': 'Agent shell',
  'settings.sourceControl.agentAuthority.label': 'Apply this repository\'s identity in the agent\'s shell',
  'settings.sourceControl.agentAuthority.info': 'Off means Git the agent runs here keeps this computer\'s own setup, and raw transfers in the shell are not refused. Applies on the next OpenCode restart.',
  'settings.sourceControl.agentAuthority.machineOff': 'Identities are not applied in agent shells on this computer. Turn that on in Settings → Git.',
  'settings.sourceControl.binding.accountAriaLabel': 'Source control account for the active repository',
  'settings.sourceControl.binding.noAccounts': 'No matching accounts',
  'settings.sourceControl.binding.noRepository': 'Open a Git repository to configure its source control account.',
  'settings.sourceControl.binding.loading': 'Loading repository binding…',
  'settings.sourceControl.binding.suggested': 'Confirm the suggested account before OpenChamber uses it for this repository.',
  'settings.sourceControl.binding.configured': 'This account is used for source control API actions in the active repository.',
  'settings.sourceControl.binding.confirm': 'Confirm account',
  'settings.sourceControl.transport.credentialAccount': 'HTTPS credential account',
  'settings.sourceControl.transport.retry': 'Reload and retry',
  'settings.sourceControl.transport.unverifiedConfirmation': 'I understand that System Git uses credentials on the connected Git host. OpenChamber cannot verify which account they belong to.',
  'settings.sourceControl.transport.info': 'Bind a repository remote to System Git or a host-managed credential. Provider API accounts remain separate.',
  ...
  'settings.sourceControl.transport.anonymous': 'Anonymous HTTPS, read-only',
  'settings.sourceControl.transport.https': 'Managed HTTPS',
  'settings.sourceControl.transport.ssh': 'Managed SSH key',
  'settings.sourceControl.transport.bind': 'Bind repository',
  'settings.sourceControl.transport.noRepository': 'Open a Git repository to configure its transport.',
  'settings.sourceControl.transport.loading': 'Loading repository transport…',
  'settings.sourceControl.transport.missing': 'Choose a remote and transport to bind this repository.',
  'settings.sourceControl.transport.needsAttention': 'The Git configuration changed. Review and save the transport binding again.',
  'settings.sourceControl.transport.configured': 'The selected remote has an explicit Git transport binding.',
  'settings.sourceControl.transport.remove': 'Remove transport grant',
