export const settingsDict = {
  ...
  'settings.openchamber.visual.field.stripSlashOnSubmitAria': 'Strip leading slash on submit so slash commands are not expanded',
  'settings.openchamber.visual.field.stripSlashOnSubmit': 'Strip Slash on Submit',
  'settings.openchamber.visual.field.stripSlashOnSubmitDescription': 'When enabled, submitting a slash command or skill strips the leading slash and sends the text as a plain message. The command/skill will not be invoked and the conversation will show what you typed.',
