export const settingsDict = {
  ...
  'settings.providers.copilotGhe.toggle': 'Connect GitHub Enterprise Server',
  'settings.providers.copilotGhe.serverUrlLabel': 'Server URL',
  'settings.providers.copilotGhe.serverUrlPlaceholder': 'ghe.example.com',
  'settings.providers.copilotGhe.clientIdLabel': 'Client ID (optional)',
  'settings.providers.copilotGhe.clientIdPlaceholder': 'Leave blank to use default',
  'settings.providers.copilotGhe.clientIdHint': 'Leave Client ID blank to use the OpenChamber default ({clientId}).',
  'settings.providers.copilotGhe.status.authorizationPending': 'Authorization is still pending. Complete the device flow in your browser, then click Complete again.',
  'settings.providers.copilotGhe.status.slowDown': 'GitHub Enterprise Server asked to slow down polling. Wait a moment, then click Complete again.',
  'settings.providers.copilotGhe.toast.serverUrlRequired': 'Server URL is required',
  'settings.providers.copilotGhe.toast.startFirst': 'Start the device flow first',
  'settings.providers.copilotGhe.toast.startFailed': 'Failed to start GitHub Enterprise Server auth flow',
  'settings.providers.copilotGhe.toast.completeFailed': 'Failed to complete GitHub Enterprise Server auth flow',
  'settings.providers.copilotGhe.toast.authorizationPending': 'Authorization is still pending',
  'settings.providers.copilotGhe.toast.slowDown': 'Slow down requested by GitHub Enterprise Server',
  'settings.providers.copilotGhe.toast.connected': 'GitHub Enterprise Server connected',
