...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.worktreeDiscoveryInfo': 'When enabled, OpenChamber checks the active project and projects with active sessions. Existing Git data remains usable when this is off.',
  ...
  'settings.openchamber.visual.field.backgroundProjectSessionLoadingInfo': 'When enabled, OpenChamber loads session data for every project in the sidebar. Turn it off to load only the active, expanded, or active-session projects.',
