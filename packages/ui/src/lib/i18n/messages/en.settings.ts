...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.updateChannel': 'Update Channel',
  'settings.openchamber.visual.field.updateChannelHint': 'Choose Stable for official releases or Beta for pre-release builds',
  'settings.openchamber.visual.toast.switchedChannel': 'Switched update channel to {channel}.',
  'settings.openchamber.visual.toast.latestVersionForChannel': 'You are using the latest version for the {channel} channel.',
