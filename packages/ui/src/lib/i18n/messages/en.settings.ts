export const settingsDict = {
  ...
  'settings.window.description': 'ALIAS ADE settings window.',
  ...
  'settings.aliasAde.tunnel.title': 'Remote Tunnel',
  'settings.aliasAde.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.aliasAde.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.aliasAde.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.aliasAde.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.aliasAde.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.aliasAde.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.aliasAde.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.aliasAde.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.aliasAde.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.aliasAde.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.aliasAde.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.aliasAde.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.aliasAde.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.aliasAde.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.aliasAde.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.aliasAde.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.aliasAde.tunnel.field.provider': 'Provider',
  'settings.aliasAde.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.aliasAde.tunnel.field.tunnelType': 'Tunnel type',
  'settings.aliasAde.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.aliasAde.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.aliasAde.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.aliasAde.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.aliasAde.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.aliasAde.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.aliasAde.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.aliasAde.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.aliasAde.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.aliasAde.tunnel.field.configurationFile': 'Configuration file',
  'settings.aliasAde.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.aliasAde.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.aliasAde.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.aliasAde.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.aliasAde.tunnel.field.connectLink': 'Connect link',
  'settings.aliasAde.tunnel.field.expires': 'Expires',
  'settings.aliasAde.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.aliasAde.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.aliasAde.tunnel.actions.saveToken': 'Save token',
  'settings.aliasAde.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.aliasAde.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.aliasAde.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.aliasAde.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.aliasAde.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.aliasAde.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.aliasAde.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.aliasAde.tunnel.actions.stopping': 'Stopping...',
  'settings.aliasAde.tunnel.actions.newConnectLink': 'New connect link',
  'settings.aliasAde.tunnel.actions.copied': 'Copied',
  'settings.aliasAde.tunnel.actions.retry': 'Retry',
  'settings.aliasAde.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.aliasAde.tunnel.option.mode.quick.label': 'Quick',
  'settings.aliasAde.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and Cloudflare does not guarantee uptime.',
  'settings.aliasAde.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.aliasAde.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.aliasAde.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.aliasAde.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.aliasAde.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.aliasAde.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  ...
  'settings.aliasAde.tunnel.state.loading': 'Loading',
  'settings.aliasAde.tunnel.state.expired': 'Expired',
  'settings.aliasAde.tunnel.state.revoked': 'Revoked',
  'settings.aliasAde.tunnel.state.inactive': 'Inactive',
  'settings.aliasAde.tunnel.state.noExpiry': 'No expiry',
  'settings.aliasAde.tunnel.state.never': 'Never',
  'settings.aliasAde.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.aliasAde.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.aliasAde.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.aliasAde.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.aliasAde.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.aliasAde.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/alias-ade/cloudflare-managed-remote-tunnels.json.',
  'settings.aliasAde.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.aliasAde.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.aliasAde.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.aliasAde.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.aliasAde.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.aliasAde.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.aliasAde.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.aliasAde.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.aliasAde.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.aliasAde.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.aliasAde.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.aliasAde.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.aliasAde.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.aliasAde.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.aliasAde.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.aliasAde.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.aliasAde.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.aliasAde.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.aliasAde.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.aliasAde.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.aliasAde.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.aliasAde.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.aliasAde.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.aliasAde.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.aliasAde.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.aliasAde.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Managed installs/updates and starts ALIAS ADE remotely. External assumes it is already running.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port ALIAS ADE should use on the remote host. Leave empty to let the runtime choose.',
  'settings.remoteInstances.page.field.keepServerRunning': 'Keep server running',
  'settings.remoteInstances.page.field.keepServerRunningHint': 'If enabled, ALIAS ADE daemon is left running remotely when you disconnect.',
  ...
  'settings.remoteInstances.page.field.preferredLocalPortHint': 'Preferred local port for the main ALIAS ADE tunnel. Leave empty for auto-select.',
  ...
  'settings.aliasAde.about.title': 'About ALIAS ADE',
  'settings.aliasAde.about.field.version': 'Version',
  'settings.aliasAde.about.state.checking': 'Checking...',
  'settings.aliasAde.about.state.upToDate': 'Up to date',
  'settings.aliasAde.about.actions.checkUpdates': 'Check updates',
  'settings.aliasAde.about.actions.update': 'Update',
  'settings.aliasAde.about.actions.updateToVersion': 'Update to {version}',
  'settings.aliasAde.about.actions.checkForUpdates': 'Check for updates',
  'settings.aliasAde.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. ALIAS ADE will scan it for folders containing',
  ...
  'settings.aliasAde.passkeys.title': 'Passkeys',
  'settings.aliasAde.passkeys.field.currentDevice': 'Current device',
  'settings.aliasAde.passkeys.actions.add': 'Add passkey',
  'settings.aliasAde.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.aliasAde.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.aliasAde.passkeys.actions.signingOut': 'Signing out…',
  'settings.aliasAde.passkeys.actions.removing': 'Removing…',
  'settings.aliasAde.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.aliasAde.passkeys.state.loading': 'Loading passkeys…',
  'settings.aliasAde.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.aliasAde.passkeys.item.lastUsed': 'Last used {time}',
  'settings.aliasAde.passkeys.item.added': 'Added {time}',
  'settings.aliasAde.passkeys.time.neverUsed': 'Never used',
  'settings.aliasAde.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.aliasAde.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.aliasAde.passkeys.toast.added': 'Passkey added',
  'settings.aliasAde.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.aliasAde.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.aliasAde.passkeys.toast.removed': 'Passkey removed',
  'settings.aliasAde.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.aliasAde.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.aliasAde.sessionRetention.title': 'Session Retention',
  'settings.aliasAde.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.aliasAde.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.aliasAde.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.aliasAde.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.aliasAde.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.aliasAde.sessionRetention.field.days': 'days',
  'settings.aliasAde.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.aliasAde.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.aliasAde.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.aliasAde.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.aliasAde.sessionRetention.action.archive': 'Archive',
  'settings.aliasAde.sessionRetention.action.delete': 'Delete',
  'settings.aliasAde.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.aliasAde.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.aliasAde.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.aliasAde.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.aliasAde.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.aliasAde.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.aliasAde.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.aliasAde.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.aliasAde.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.aliasAde.desktopNetwork.title': 'Desktop Network Access',
  'settings.aliasAde.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.aliasAde.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.aliasAde.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.aliasAde.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.aliasAde.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.aliasAde.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.aliasAde.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.aliasAde.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.aliasAde.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.aliasAde.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.aliasAde.opencodeCli.title': 'OpenCode CLI',
  'settings.aliasAde.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.aliasAde.opencodeCli.tooltipSuffix': 'binary.',
  'settings.aliasAde.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.aliasAde.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.aliasAde.opencodeCli.actions.browseAria': 'Browse for OpenCode binary path',
  'settings.aliasAde.opencodeCli.actions.browse': 'Browse',
  'settings.aliasAde.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.aliasAde.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.aliasAde.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.aliasAde.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.aliasAde.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.aliasAde.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.aliasAde.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.aliasAde.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.aliasAde.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.aliasAde.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.aliasAde.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.aliasAde.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.aliasAde.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.aliasAde.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.aliasAde.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.aliasAde.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.aliasAde.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.aliasAde.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.aliasAde.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.aliasAde.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.aliasAde.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle right sidebar',
  'settings.aliasAde.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open right sidebar Git tab',
  'settings.aliasAde.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open right sidebar Files tab',
  'settings.aliasAde.keyboardShortcuts.action.cycle_right_sidebar_tab.label': 'Cycle right sidebar tab',
  'settings.aliasAde.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.aliasAde.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.aliasAde.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.aliasAde.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.aliasAde.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.aliasAde.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.aliasAde.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.aliasAde.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.aliasAde.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.aliasAde.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.aliasAde.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.aliasAde.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  ...
  'settings.remoteInstances.page.section.remoteServerDescription': 'How ALIAS ADE is managed and started on the remote host.',
  ...
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote ALIAS ADE UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How ALIAS ADE is installed when running in managed mode.',
  ...
  'settings.remoteInstances.page.phase.installingAliasAde': 'Installing ALIAS ADE',
  'settings.remoteInstances.page.phase.updatingAliasAde': 'Updating ALIAS ADE',
  ...
  'settings.aliasAde.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.aliasAde.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.aliasAde.worktrees.setup.title': 'Setup commands',
  'settings.aliasAde.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.aliasAde.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.aliasAde.worktrees.setup.loading': 'Loading...',
  'settings.aliasAde.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.aliasAde.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.aliasAde.worktrees.setup.addCommand': 'Add command',
  'settings.aliasAde.worktrees.list.title': 'Existing worktrees',
  'settings.aliasAde.worktrees.list.tooltip': 'Worktrees live outside the repo (OpenCode-managed). Deleting a worktree also removes linked sessions.',
  'settings.aliasAde.worktrees.list.loading': 'Loading worktrees...',
  'settings.aliasAde.worktrees.list.empty': 'No worktrees found for this project',
  'settings.aliasAde.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.aliasAde.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by ALIAS ADE.',
  ...
  'settings.aliasAde.defaults.title': 'Session Defaults',
  'settings.aliasAde.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.aliasAde.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
  'settings.aliasAde.defaults.field.defaultModel': 'Default Model',
  'settings.aliasAde.defaults.field.defaultThinking': 'Default Thinking',
  'settings.aliasAde.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.aliasAde.defaults.field.defaultAgent': 'Default Agent',
  'settings.aliasAde.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.aliasAde.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.aliasAde.defaults.field.openFilesPreviewAria': 'Open files in preview mode',
  'settings.aliasAde.defaults.field.openFilesPreview': 'Open files in preview mode',
  'settings.aliasAde.defaults.option.default': 'Default',
  'settings.aliasAde.defaults.option.defaultLowercase': 'default',
  'settings.aliasAde.git.title': 'Git Preferences',
  'settings.aliasAde.git.changesViewTitle': 'Changes View',
  'settings.aliasAde.git.changesViewAria': 'Git changes view mode',
  'settings.aliasAde.git.option.flatList': 'Flat List',
  'settings.aliasAde.git.option.treeView': 'Tree View',
  'settings.aliasAde.git.optionAria': 'Git changes view mode: {option}',
  'settings.aliasAde.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.aliasAde.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.aliasAde.git.showGitignoredAria': 'Display gitignored files',
  'settings.aliasAde.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize ALIAS ADE',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from ALIAS ADE.',
  ...
  'settings.aliasAde.visual.section.colorMode': 'Color Mode',
  'settings.aliasAde.visual.section.localization': 'Localization',
  'settings.aliasAde.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.aliasAde.visual.section.navigation': 'Navigation',
  'settings.aliasAde.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.aliasAde.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.aliasAde.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.aliasAde.visual.section.activityDefault': 'Activity Default',
  'settings.aliasAde.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.aliasAde.visual.section.showToolsOpenedByDefault': 'Show tools opened by default:',
  'settings.aliasAde.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.aliasAde.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.aliasAde.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.aliasAde.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.aliasAde.visual.section.diffLayout': 'Diff Layout',
  'settings.aliasAde.visual.section.diffLayoutAria': 'Diff layout',
  'settings.aliasAde.visual.section.diffViewMode': 'Diff View Mode',
  'settings.aliasAde.visual.section.diffViewModeAria': 'Diff view mode',
  'settings.aliasAde.visual.section.privacy': 'Privacy',
  'settings.aliasAde.visual.field.lightTheme': 'Light Theme',
  'settings.aliasAde.visual.field.darkTheme': 'Dark Theme',
  'settings.aliasAde.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.aliasAde.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.aliasAde.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.aliasAde.visual.field.timeFormat': 'Time Format',
  'settings.aliasAde.visual.field.weekStartsOn': 'Week Starts On',
  'settings.aliasAde.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.aliasAde.visual.field.selectWeekStartAria': 'Select week start',
  'settings.aliasAde.visual.actions.reloadThemes': 'Reload themes',
  'settings.aliasAde.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.aliasAde.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.aliasAde.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/alias-ade/themes/',
  'settings.aliasAde.visual.field.installAppName': 'Install App Name',
  'settings.aliasAde.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.aliasAde.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.aliasAde.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.aliasAde.visual.field.installOrientation': 'Install Orientation',
  'settings.aliasAde.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.aliasAde.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.aliasAde.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.aliasAde.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.aliasAde.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.aliasAde.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.aliasAde.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.aliasAde.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.aliasAde.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.aliasAde.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.aliasAde.visual.field.interfaceFont': 'Interface Font',
  'settings.aliasAde.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.aliasAde.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.aliasAde.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.aliasAde.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.aliasAde.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.aliasAde.visual.field.codeFont': 'Code Font',
  'settings.aliasAde.visual.field.selectCodeFontAria': 'Select code font',
  'settings.aliasAde.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.aliasAde.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.aliasAde.visual.field.spacingDensity': 'Spacing Density',
  'settings.aliasAde.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.aliasAde.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.aliasAde.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.aliasAde.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.aliasAde.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.aliasAde.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.aliasAde.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.aliasAde.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.aliasAde.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.aliasAde.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.aliasAde.visual.field.bash': 'Bash',
  'settings.aliasAde.visual.field.editTools': 'Edit tools',
  'settings.aliasAde.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  'settings.aliasAde.visual.field.mermaidRenderingAria': 'Mermaid rendering: {option}',
  'settings.aliasAde.visual.field.diffLayoutAria': 'Diff layout: {option}',
  'settings.aliasAde.visual.field.diffViewModeAria': 'Diff view mode: {option}',
  'settings.aliasAde.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.aliasAde.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.aliasAde.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.aliasAde.visual.field.stickyUserHeader': 'Sticky User Header',
  'settings.aliasAde.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.aliasAde.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.aliasAde.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.aliasAde.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.aliasAde.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.aliasAde.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.aliasAde.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.aliasAde.visual.field.showMobileStatusBarAria': 'Show mobile status bar',
  'settings.aliasAde.visual.field.showMobileStatusBar': 'Show Mobile Status Bar',
  'settings.aliasAde.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.aliasAde.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.aliasAde.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.aliasAde.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.aliasAde.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.aliasAde.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.aliasAde.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.aliasAde.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.aliasAde.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.aliasAde.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.aliasAde.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.aliasAde.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.aliasAde.visual.option.themeMode.system': 'System',
  'settings.aliasAde.visual.option.themeMode.light': 'Light',
  'settings.aliasAde.visual.option.themeMode.dark': 'Dark',
  'settings.aliasAde.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.aliasAde.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.aliasAde.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.aliasAde.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.aliasAde.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.aliasAde.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.aliasAde.visual.option.diffViewMode.single.label': 'Single file',
  'settings.aliasAde.visual.option.diffViewMode.single.description': 'Show one file at a time.',
  'settings.aliasAde.visual.option.diffViewMode.stacked.label': 'All files',
  'settings.aliasAde.visual.option.diffViewMode.stacked.description': 'Stack all changed files together.',
  'settings.aliasAde.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.aliasAde.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.aliasAde.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.aliasAde.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.aliasAde.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.aliasAde.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.aliasAde.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.aliasAde.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.aliasAde.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.aliasAde.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.aliasAde.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.aliasAde.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.aliasAde.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.aliasAde.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.aliasAde.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.aliasAde.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.aliasAde.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.aliasAde.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'settings.aliasAde.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.aliasAde.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.aliasAde.visual.option.chatRenderMode.live.label': 'Live',
  'settings.aliasAde.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.aliasAde.visual.option.messageTransport.auto.label': 'Auto',
  'settings.aliasAde.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.aliasAde.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.aliasAde.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.aliasAde.visual.option.messageTransport.sse.label': 'SSE',
  'settings.aliasAde.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.aliasAde.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.aliasAde.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.aliasAde.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.aliasAde.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.aliasAde.visual.option.timeFormat.auto.label': 'Auto',
  'settings.aliasAde.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.aliasAde.visual.option.timeFormat.24h.label': '24-hour',
  'settings.aliasAde.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.aliasAde.visual.option.timeFormat.12h.label': '12-hour',
  'settings.aliasAde.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.aliasAde.visual.option.weekStart.auto.label': 'Auto',
  'settings.aliasAde.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.aliasAde.visual.option.weekStart.monday.label': 'Monday',
  'settings.aliasAde.visual.option.weekStart.sunday.label': 'Sunday',
