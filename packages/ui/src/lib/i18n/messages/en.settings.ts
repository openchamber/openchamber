export const settingsDict = {
  ...
  'settings.openchamber.worktrees.list.archiveWorktreeAria': 'Archive worktree {name}',
  'settings.openchamber.worktrees.list.archiveSuccess': 'Worktree archived',
  'settings.openchamber.worktrees.list.archiveFailed': 'Failed to archive worktree',
  'settings.openchamber.worktrees.list.archivePartial': 'Worktree archived, but {fail}/{total} sessions failed to archive',
  'settings.openchamber.worktrees.archived.title': 'Archived worktrees',
  'settings.openchamber.worktrees.archived.restoreWorktreeAria': 'Restore worktree {name}',
  'settings.openchamber.worktrees.archived.restoreSuccess': 'Worktree restored',
  'settings.openchamber.worktrees.archived.restoreFailed': 'Failed to restore worktree',
  'settings.openchamber.worktrees.archived.restorePartial': 'Worktree restored, but {fail}/{total} sessions failed to restore',
