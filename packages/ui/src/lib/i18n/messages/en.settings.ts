...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.activityColorCoding': 'Color-code tools & activity',
  'settings.openchamber.visual.field.activityColorCodingAria': 'Color-code tools and activity rows',
  'settings.openchamber.visual.field.activityColorCodingHint': 'Give each kind of tool and activity row its own theme accent — file edits, shell commands, searches, thinking and more. Turn off for a single neutral tone.',
