...
export const settingsDict = {
  ...
  'settings.plugins.registry.badge.missingPackage.tooltip': 'Package {name} not found in the registry',
  ...
  'settings.plugins.registry.badge.network.tooltip': 'Could not reach the package registry',
  ...
  'settings.plugins.registry.banner.invalid.missingPackage': 'Package not found in the registry',
  ...
  'settings.voice.page.browserTest.title': 'Test microphone',
  'settings.voice.page.browserTest.stop': 'Stop test',
  'settings.voice.page.browserTest.transcript': 'Recognized speech will appear here.',
  'settings.voice.page.browserTest.description': 'Speak to check recognition and microphone volume. Text stays in this preview and is not sent to chat. Your browser may send audio to its speech service.',
  'settings.voice.page.browserTest.unavailable': 'Browser speech recognition is unavailable here. Open this site in a supported browser over HTTPS, or choose Local or Server. Desktop and native mobile apps are not supported.',
  'settings.voice.page.browserFallback': 'Browser recognition was chosen on another device. This device does not support it, so Local is used here instead.',
  'settings.voice.page.browserTest.error': 'Speech recognition stopped ({code}). Check microphone permissions and your connection, then try again. Any recognized text is kept.',
  'settings.voice.page.browserTest.error.busy': 'Another dictation is already recording on this page. Stop it first, then try again.',
  'settings.voice.page.browserTest.error.network': 'The speech service could not be reached. Check your connection, then try again. Any recognized text is kept.',
  'settings.voice.page.browserTest.error.noSpeech': 'No speech was heard. Move closer to the microphone and try again.',
  'settings.voice.page.browserTest.error.audioCapture': 'The microphone volume meter is unavailable. Recording continues without it.',
  'settings.voice.page.browserTest.error.timeout': 'The speech service did not finish in time. Any recognized text is kept.',
  'settings.voice.page.browserTest.error.startFailed': 'Recognition could not start. Reload the page and try again.',
  'settings.voice.page.browserTest.error.permission': 'Microphone access was denied. Allow the microphone in the site controls beside the address bar, reload the page, then try again.',
  ...
  'settings.voice.page.tooltip.sttBrowser': 'Built-in recognition in supported browsers. Free, no setup.',
  'settings.voice.page.field.browserMicrophonePermission': 'When you press the microphone in chat or start the test below, allow microphone access if the browser asks. If no prompt appears or access is blocked, open the site controls beside the address bar, allow Microphone in site settings, then reload and try again.',
