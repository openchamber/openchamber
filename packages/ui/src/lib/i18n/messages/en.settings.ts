...
export const settingsDict = {
  ...
  'settings.voice.page.localTts.availableToDownload': 'Available to download',
  'settings.voice.page.localTts.filterPlaceholder': 'Filter by language or description',
  'settings.voice.page.localTts.filterNoMatch': 'No models match this filter',
