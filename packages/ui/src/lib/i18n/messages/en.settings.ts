export const settingsDict = {
  ...
  'settings.notifications.page.messengers.title': 'Messenger Notifications',
  'settings.notifications.page.messengers.info': 'Post agent notifications to Slack or Discord channels through incoming webhooks. Webhook URLs are stored on this server and are never shown again after saving.',
  'settings.notifications.page.messengers.loadFailed': 'Failed to load messenger settings.',
  'settings.notifications.page.messengers.retryAction': 'Retry',
  'settings.notifications.page.messengers.enableLabel': 'Enable {messenger} notifications',
  'settings.notifications.page.messengers.enableAria': 'Enable {messenger} notifications',
  'settings.notifications.page.messengers.webhookLabel': 'Webhook URL',
  'settings.notifications.page.messengers.webhookAria': '{messenger} webhook URL',
  'settings.notifications.page.messengers.webhookConfigured': 'Webhook configured.',
  'settings.notifications.page.messengers.replacePlaceholder': 'Paste a new webhook URL to replace the saved one',
  'settings.notifications.page.messengers.saveAction': 'Save webhook',
  'settings.notifications.page.messengers.removeAction': 'Remove webhook',
  'settings.notifications.page.messengers.testAction': 'Send test message',
  'settings.notifications.page.messengers.toast.saveFailed': 'Failed to save messenger settings',
  'settings.notifications.page.messengers.toast.invalidUrl': 'Enter a valid {messenger} webhook URL',
  'settings.notifications.page.messengers.toast.testSent': 'Test message sent to {messenger}',
  'settings.notifications.page.messengers.toast.testFailed': 'Failed to send test message to {messenger}',
