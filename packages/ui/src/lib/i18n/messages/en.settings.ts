...
export const settingsDict = {
  ...
  'settings.page.vision.title': 'Vision',
  'settings.page.vision.description': 'Let models that cannot see images describe them through a configured vision model.',
  'settings.vision.section.title': 'Vision tool',
  'settings.vision.section.info': 'When your current model cannot see images, the agent can call a vision tool that reads an image file and asks your configured vision model to describe it — content, layout, style, and any visible text. The description is returned to your model so it can reason about the image without seeing it. Each call is billed against the vision model you choose here.',
  'settings.vision.model.label': 'Vision model',
  'settings.vision.model.info': 'The model that describes images for the vision tool. Only models that accept image input are listed; models the catalog cannot judge stay visible and are re-validated by the server before every run.',
  'settings.vision.model.notSelected': 'Select a vision model',
  'settings.vision.model.required': 'Select a vision model to enable the vision tool.',
  'settings.vision.prompt.label': 'Description prompt',
  'settings.vision.prompt.info': 'The prompt sent with each image to the vision model. A good prompt asks for content, layout, style, colors, and verbatim text so your model gets a complete picture. Leave empty to use the built-in default.',
  'settings.vision.prompt.placeholder': 'Leave empty to use the default prompt.',
  'settings.vision.prompt.save': 'Save',
  'settings.vision.prompt.reset': 'Reset to default',
  'settings.vision.toast.saved': 'Vision settings saved',
  'settings.vision.toast.saveFailed': 'Failed to save vision settings',
  'settings.vision.toast.loadFailed': 'Failed to load vision settings',
