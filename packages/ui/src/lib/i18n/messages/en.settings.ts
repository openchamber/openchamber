export const settingsDict = {
  ...
  'settings.behavior.page.description': 'Define absolute global rules that apply across all providers, sessions, and projects. These instructions override any project-level AGENTS.md.',
  'settings.behavior.page.warning.title': 'Overrides project-level rules',
  'settings.behavior.page.warning.description': 'Changes made here will overwrite {path}. Any project-level AGENTS.md will be ignored in favor of these global instructions.',
  'settings.behavior.page.section.systemPrompt': 'System Prompt',
