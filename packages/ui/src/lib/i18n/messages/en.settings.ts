...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.messageSpeedMetrics': 'Show response speed metrics',
  'settings.openchamber.visual.field.messageSpeedMetricsAria': 'Show response speed metrics under completed replies',
  'settings.openchamber.visual.field.messageSpeedMetricsInfo': 'Shows TTFT (time to first token) and output tokens per second under completed replies. Useful for comparing providers and relays.',
