...
const requiredKeys = [
  ...
  'settings.extensions.agent.socket.path',
  'settings.extensions.agent.socket.path.aria',
  'settings.extensions.agent.socket.resolved',
  'settings.extensions.agent.socket.unresolved',
  'settings.extensions.agent.socket.save',
  'settings.extensions.agent.socket.save.aria',
  'settings.extensions.agent.socket.clear',
  'settings.extensions.agent.socket.clear.aria',
  'settings.extensions.agent.socket.edit',
  'settings.extensions.agent.socket.edit.aria',
  'settings.extensions.agent.socket.cancel',
  'settings.extensions.agent.socket.cancel.aria',
