...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.search.findPlaceholder': 'Znajdź',
  'chat.search.findAria': 'Znajdź w czacie',
  'chat.search.replacePlaceholder': 'Zastąp',
  'chat.search.replaceAria': 'Zastąp tekst (niedostępne w czacie)',
  ...
  'chat.search.nextAria': 'Następne dopasowanie',
  'chat.search.close': 'Zamknij (Escape)',
  'chat.search.closeAria': 'Zamknij wyszukiwanie',
  'chat.search.selectAllUnavailable': 'Zaznaczanie wszystkich dopasowań jest niedostępne w wyszukiwaniu czatu',
  'chat.search.replaceUnavailable': 'Zastępowanie jest niedostępne w wyszukiwaniu czatu',
  'chat.search.replaceAllUnavailable': 'Zastąpienie wszystkiego jest niedostępne w wyszukiwaniu czatu',
  'chat.search.noResults': 'Brak wyników',
  'chat.search.loading': 'Ładowanie…',
