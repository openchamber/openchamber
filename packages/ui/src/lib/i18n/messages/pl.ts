...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.toast.messageSendFailed': 'Nie udało się wysłać wiadomości. Wiadomość i załączniki zostały przywrócone.',
  'chat.chatInput.toast.messageSendMaybeFailed': 'Wiadomość mogła nie zostać wysłana. Wiadomość została zachowana — sprawdź przed ponowną próbą.',
  'chat.chatInput.toast.messageRestoredToInput': 'Twoja wiadomość została przywrócona do pola wprowadzania.',
