...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.harness.claudeCodeAria': 'Harness Claude Code',
  'sessions.sidebar.session.harness.claudeCodeTooltip': 'Działa na Claude Code',
  ...
  'chat.statusRow.retrying': 'Ponowna próba, gdy będzie dostępna przepustowość',
  'chat.statusRow.retryingIn': 'Ponowna próba za {countdown}',
  'chat.statusRow.retryAttempt': '(próba {attempt})',
  'chat.statusRow.recoveryBlocked': 'Automatyczne wznawianie jest zablokowane. Zatrzymaj tę sesję, aby anulować wznawianie.',
  'chat.chatInput.toast.queueFull': 'Kolejka dalszych wiadomości w tej sesji jest pełna. Szkic został zachowany.',
  'chat.chatInput.toast.queueTargetsFull': 'Zbyt wiele sesji ma dalsze wiadomości w kolejce. Szkic został zachowany.',
  ...
  'chat.commandAutocomplete.command.claudeNativeDescription': 'Polecenie Claude Code: /{name}',
  ...
  'chat.harness.section': 'Harnessy',
  'chat.harness.opencode': 'OpenCode',
  'chat.harness.claudeCode': 'Claude Code',
  'chat.harness.manageHarnesses': 'Zarządzaj harnessami…',
  'chat.harness.chip.claude': 'Claude · {model}',
  'chat.harness.notReady': 'Claude Code nie jest gotowy. Otwórz Ustawienia → Harnessy, aby zainstalować, zalogować się lub wykryć ponownie.',
  'chat.harness.commandTranslationFailed': 'Nie udało się uruchomić tego polecenia OpenCode w Claude Code.',
  'chat.harness.effort.label': 'Wysiłek',
  'chat.harness.effort.default': 'Domyślny',
  'chat.harness.effort.low': 'Niski',
  'chat.harness.effort.medium': 'Średni',
  'chat.harness.effort.high': 'Wysoki',
  'chat.harness.effort.xhigh': 'Bardzo wysoki',
  'chat.harness.effort.max': 'Maksymalny',
  'chat.harness.effort.aria': 'Wysiłek: {level}',
  'chat.harness.effort.tooltip': 'Wysiłek: {level}',
  'chat.harness.capability.goalUnsupported': 'Cele nie są dostępne w tym harnessie.',
  'chat.harness.capability.multirunUnsupported': 'MultiRun nie jest dostępny w tym harnessie.',
  'chat.harness.capability.openchamberToolUnsupported': 'Narzędzie OpenChamber nie jest dostępne w tym harnessie.',
  'chat.harness.switch.title': 'Przełączyć na {harness}?',
  'chat.harness.switch.body': 'Zmiana harnessu rozpoczyna nową sesję. Bieżąca sesja pozostaje bez zmian.',
  'chat.harness.switch.billing': 'Nowa sesja korzysta z subskrypcji Claude, a nie z rozliczeń API.',
  'chat.harness.switch.duplicate.title': 'Duplikuj dane sesji',
  'chat.harness.switch.duplicate.description': 'Kopiuje ostatnią rozmowę do nowej sesji jako widoczną wiadomość kontekstową.',
  'chat.harness.switch.summarize.title': 'Podsumuj sesję',
  'chat.harness.switch.summarize.description': 'Podsumowuje tę sesję i przenosi tylko podsumowanie. Bieżąca sesja zostanie skompaktowana.',
  'chat.harness.switch.optionsAria': 'Co przenieść do nowej sesji',
  'chat.harness.switch.dontShowAgain': 'Nie pokazuj ponownie',
  'chat.harness.switch.dontShowAgainAria': 'Nie pokazuj ponownie okna zmiany harnessu',
  'chat.harness.switch.cancel': 'Anuluj',
  'chat.harness.switch.confirm': 'Przełącz harness',
  'chat.harness.switch.working': 'Przełączanie…',
  'chat.harness.contextCard.title': 'Kontekst z poprzedniej sesji',
  'chat.harness.contextCard.expandAria': 'Rozwiń przeniesiony kontekst',
  'chat.harness.contextCard.collapseAria': 'Zwiń przeniesiony kontekst',
  ...
  'chat.modelControls.cacheRead': 'Odczyt cache',
  'chat.modelControls.cacheWrite': 'Zapis cache',
  'chat.modelControls.costInOutShort': 'Wej. {input} · Wyj. {output}',
  'chat.modelControls.modalityInputAria': '{modality} (wejście)',
  'chat.modelControls.modalityOutputAria': '{modality} (wyjście)',
  ...
  'chat.modelControls.noAgentsFound': 'Nie znaleziono agentów',
  'chat.modelControls.claudeAgents.defaultAgent': 'Domyślny Claude',
  'chat.modelControls.claudeAgents.empty': 'Nie znaleziono agentów Claude',
  ...
  'chat.modelControls.thinkingValue': 'Myślenie: {value}',
