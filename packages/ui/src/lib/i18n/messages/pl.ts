...
export const dict: Record<I18nKey, string> = {
  ...
  'usage.status.quotaExhausted': 'Limit wyczerpany',
  'usage.status.expired': 'Klucz API wygasł',
  'usage.statistics.title': 'Statystyki użycia',
  'usage.statistics.info': 'Statystyki modeli obejmują ostatnie 30 dni.',
  'usage.statistics.requests': 'Żądania',
  'usage.statistics.inputTokens': 'Tokeny wejściowe',
  'usage.statistics.outputTokens': 'Tokeny wyjściowe',
  'usage.statistics.cacheReadTokens': 'Tokeny odczytu z pamięci podręcznej',
  'usage.statistics.totalTokens': 'Łącznie tokenów',
  'usage.statistics.actualCost': 'Koszt',
  'usage.statistics.today': 'Dziś',
  'usage.statistics.total': 'Łącznie',
  'usage.statistics.empty': 'Nie zgłoszono statystyk użycia.',
