...
export const dict: Record<I18nKey, string> = {
  ...
  'session.githubIssuePicker.overridesHelper': 'Te wybory dotyczą tej sesji (nie zapisanych ustawień domyślnych)',
  ...
  'session.newWorktree.overridesHelper': 'Te wybory dotyczą tej sesji (nie zapisanych ustawień domyślnych)',
