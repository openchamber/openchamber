...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.engines.capability.goalUnsupported': 'Cele są dostępne tylko w OpenCode. Przełącz tę sesję na OpenCode, aby używać celów.',
  'chat.engines.capability.multirunUnsupported': 'MultiRun jest dostępny tylko w OpenCode. Przełącz tę sesję na OpenCode, aby uruchomić MultiRun.',
