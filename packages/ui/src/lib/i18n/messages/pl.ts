...
export const dict: Record<I18nKey, string> = {
  ...
  'session.githubIntegration.error.searchTimedOut': 'Przekroczono czas wyszukiwania. Spróbuj bardziej konkretnego zapytania.',
  'session.githubIntegration.error.repoNotResolvable': 'Nie udało się rozpoznać repozytorium',
  ...
  'session.githubIssuePicker.error.searchTimedOut': 'Przekroczono czas wyszukiwania. Spróbuj bardziej konkretnego zapytania.',
  ...
  'session.githubPrPicker.error.searchTimedOut': 'Przekroczono czas wyszukiwania. Spróbuj bardziej konkretnego zapytania.',
