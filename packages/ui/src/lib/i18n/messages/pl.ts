...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.browser.agent.handOff': 'Przekaż kontrolę agentowi',
  'contextPanel.browser.agent.stop': 'Zatrzymaj kontrolę agenta',
  'contextPanel.browser.agent.controlling': 'Agent steruje',
  'contextPanel.browser.agent.ready': 'Udostępniono agentowi',
  'contextPanel.browser.agent.popOut': 'Otwórz w osobnym oknie',
  'contextPanel.browser.agent.lastAction': 'Ostatnia akcja: {op}',
  'contextPanel.browser.poppedOut.title': 'Przeglądarka otwarta w osobnym oknie',
  'contextPanel.browser.poppedOut.bringBack': 'Przywróć',
  'contextPanel.browser.poppedOut.focus': 'Pokaż okno',
