...
export const dict: Record<I18nKey, string> = {
  ...
  'diffView.actions.backToChat': 'Wróć do czatu',
  ...
  'gitView.history.actions.conflictToastDescription': 'Konflikty w: {files}. Rozwiąż je ręcznie i wykonaj commit albo użyj przycisku Przerwij na banerze operacji.',
  'gitView.history.actions.conflictToastTitle': 'Konflikt',
  'gitView.history.actions.unknownFiles': 'nieznane pliki',
  ...
  'gitView.history.actions.resetHard': 'Reset (twardy)',
  'gitView.history.actions.resetHardConfirmButton': 'Usuń zmiany',
  'gitView.history.actions.resetHardDirtyTitle': 'Czy usunąć niezatwierdzone zmiany?',
  'gitView.history.actions.resetHardDirtyDescription': 'Drzewo robocze ma niezatwierdzone zmiany. Twardy reset je na trwałe usunie.',
  'gitView.history.actions.resetHardDirtyConfirmButton': 'Usuń i resetuj',
  'gitView.history.actions.resetMixed': 'Reset (mieszany)',
  'gitView.history.actions.resetSoft': 'Reset (miękki)',
  ...
  'gitView.graph.localBranches': 'Lokalne gałęzie',
  'gitView.graph.tags': 'Tagi',
  'gitView.graph.manualSelection': 'Wybierz referencje, które mają pojawić się na grafie.',
  'gitView.graph.incomingChanges': 'Zmiany przychodzące',
  'gitView.graph.outgoingChanges': 'Zmiany wychodzące',
  'gitView.graph.outdated': 'Historia grafu jest nieaktualna. Odśwież ją.',
  'gitView.graph.mergeBaseLookupFailed': 'Nie udało się porównać zmian przychodzących i wychodzących dla tego grafu.',
  'gitView.graph.resizeAria': 'Zmień rozmiar panelu grafu',
  'gitView.preview.overlayAnnouncement': 'Podgląd diffu został otwarty. Naciśnij Escape, aby go zamknąć.',
  'gitView.preview.resizeAria': 'Zmień rozmiar podglądu diffu',
  'gitView.preview.submodulePointer': 'Wskaźnik submodułu',
  'gitView.preview.tooLargeDescription': 'Ten diff ma {totalSize} i przekracza limit podglądu {maxSize}.',
  ...
  'gitView.operation.cherryPickInProgress': 'Trwa cherry-pick',
  'gitView.operation.revertInProgress': 'Trwa revert',
  ...
  'gitView.toast.cherryPickCompleted': 'Cherry-pick zakończony',
  'gitView.toast.cherryPickAborted': 'Cherry-pick przerwany',
  'gitView.toast.cherryPickConflictsDetected': 'Wykryto konflikty cherry-pick',
  'gitView.toast.revertCompleted': 'Revert zakończony',
  'gitView.toast.revertAborted': 'Revert przerwany',
  'gitView.toast.revertConflictsDetected': 'Wykryto konflikty revert',
  ...
  'gitView.history.actions.createBranchEllipsis': 'Utwórz gałąź…',
  'gitView.history.actions.createTagConfirm': 'Utwórz',
  'gitView.history.actions.createTagEllipsis': 'Utwórz tag…',
  'gitView.history.actions.createTagPlaceholder': 'Nazwa tagu',
  'gitView.history.actions.checkoutDetached': 'Checkout (odłączony)',
  'gitView.history.actions.compareWithMergeBase': 'Porównaj z bazą scalania',
  'gitView.history.actions.compareWithRef': 'Porównaj z…',
  'gitView.history.actions.compareWithRemote': 'Porównaj ze zdalnym',
  'gitView.history.actions.comparingWith': 'Porównywanie z {name}',
  'gitView.history.actions.copyMessage': 'Kopiuj wiadomość commita',
  'gitView.history.actions.clearComparison': 'Wyczyść porównanie',
  'gitView.history.actions.openChanges': 'Otwórz zmiany',
  'gitView.toast.commitMessageCopied': 'Skopiowano wiadomość commita',
  'gitView.toast.tagCreated': 'Utworzono tag {name}',
  'gitView.graph.mergeBaseLabel': 'baza scalania',
} as const;
