...
export const dict: Record<I18nKey, string> = {
  ...
  'connectionStatus.hop1.connected': 'Frontend ↔ OpenChamber: connected',
  'connectionStatus.hop1.connecting': 'Frontend ↔ OpenChamber: connecting…',
  'connectionStatus.hop1.reconnecting': 'Frontend ↔ OpenChamber: reconnecting',
  'connectionStatus.hop1.disconnected': 'Frontend ↔ OpenChamber: disconnected',
  'connectionStatus.hop2.healthy': 'OpenChamber ↔ OpenCode: ready',
  'connectionStatus.hop2.unhealthy': 'OpenChamber ↔ OpenCode: unavailable',
  'connectionStatus.hop2.unknown': 'OpenChamber ↔ OpenCode: checking…',
  'connectionStatus.reason.offline': 'Offline',
  'connectionStatus.reason.authRequired': 'Auth/config issue',
  'connectionStatus.reason.unavailable': 'OpenCode unavailable',
  'connectionStatus.reason.timeout': 'Connection timed out',
  'connectionStatus.overall.connected': 'Connected',
  'connectionStatus.overall.reconnecting': 'Reconnecting',
  'connectionStatus.overall.degraded': 'Degraded',
