...
export const dict: Record<I18nKey, string> = {
  ...
  'diffView.change.conflicted': 'Plik z konfliktem',
  ...
  'gitView.sync.pullRebase': 'Pobierz (rebase)',
  'gitView.sync.pullRebaseBlocked': 'Zacommituj lub schowaj zmiany przed pobraniem',
