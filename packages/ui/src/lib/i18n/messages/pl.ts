...
export const dict: Record<I18nKey, string> = {
  ...
  'filesView.tree.filter.expandTooltip': 'Przełącz opcje filtrowania',
  'filesView.tree.filter.showHidden': 'Pokaż ukryte pliki',
  'filesView.tree.filter.hideHidden': 'Ukryj ukryte pliki',
  'filesView.tree.filter.showGitignored': 'Uwzględnij pliki ignorowane przez Git',
  'filesView.tree.filter.hideGitignored': 'Wyklucz pliki ignorowane przez Git',
  'filesView.tree.filter.searchFailed': 'Wyszukiwanie plików nie powiodło się',
  'filesView.tree.filter.searchTimedOut': 'Wyszukiwanie przekroczyło limit czasu; spróbuj zawęzić zakres',
  'filesView.tree.filter.extChipRemoveAria': 'Usuń filtr {ext}',
  'filesView.tree.filter.pathChipRemoveAria': 'Usuń filtr ścieżki {path}',
  'filesView.tree.filter.extAutocompleteLabel': 'Rozszerzenia',
  ...
  'sidebarFilesTree.filter.expandTooltip': 'Przełącz opcje filtrowania',
  'sidebarFilesTree.filter.showHidden': 'Pokaż ukryte pliki',
  'sidebarFilesTree.filter.hideHidden': 'Ukryj ukryte pliki',
  'sidebarFilesTree.filter.showGitignored': 'Uwzględnij pliki ignorowane przez Git',
  'sidebarFilesTree.filter.hideGitignored': 'Wyklucz pliki ignorowane przez Git',
  'sidebarFilesTree.filter.extChipRemoveAria': 'Usuń filtr {ext}',
  'sidebarFilesTree.filter.pathChipRemoveAria': 'Usuń filtr ścieżki {path}',
  'sidebarFilesTree.filter.extAutocompleteLabel': 'Rozszerzenia',
  ...
  'sidebarFilesTree.toast.searchFailed': 'Wyszukiwanie plików nie powiodło się',
  'sidebarFilesTree.toast.searchTimedOut': 'Wyszukiwanie przekroczyło limit czasu; spróbuj zawęzić zakres',
