...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.progressSummary.aria': 'Podsumowanie postępu na żywo',
  'chat.progressSummary.label': 'Postęp na żywo',
  'chat.progressSummary.generating': 'Podsumowywanie bieżącego postępu…',
