...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.actions.enhancePromptAria': 'Ulepsz prompt',
  'chat.chatInput.actions.enhancePromptCancel': 'Anuluj ulepszanie promptu',
  ...
  'chat.chatInput.toast.enhanceUnavailable': 'Brak małego modelu do ulepszania promptów. Wybierz go w Ustawieniach → Sesje → Mały model.',
  'chat.chatInput.toast.enhanceContextTooSmall': 'Prompt jest zbyt duży dla kontekstu małego modelu. Skróć go albo załącz jako plik.',
  'chat.chatInput.toast.enhanceEmptyResult': 'Mały model zwrócił pusty prompt. Spróbuj ponownie.',
  'chat.chatInput.toast.enhanceInvalidResult': 'Ulepszony prompt zmieniłby odwołania @, / lub #. Szkic pozostał bez zmian.',
  'chat.chatInput.toast.enhanceTimedOut': 'Ulepszanie promptu przekroczyło limit czasu. Spróbuj ponownie.',
