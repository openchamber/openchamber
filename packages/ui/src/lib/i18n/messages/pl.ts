...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.queuedMessage.title': 'Wiadomości w kolejce',
  ...
  'chat.queuedMessage.admissionPending': 'Wysyłanie na serwer…',
  'chat.queuedMessage.admitted': 'Dodano do kolejki serwera · można bezpiecznie zamknąć',
  'chat.queuedMessage.localFallback': 'Kolejka lokalna · pozostaw klienta otwartego',
  'chat.queuedMessage.admissionFailed': 'Nie udało się dodać do kolejki',
  'chat.queuedMessage.admissionUnknown': 'Nieznany wynik · nie ponawiaj, aby uniknąć duplikatu',
  'chat.queuedMessage.retryAdmission': 'Ponów dodawanie do kolejki',
  'chat.queuedMessage.restore': 'Przenieś do edytora',
  'chat.queuedMessage.copy': 'Kopiuj tekst',
  'chat.queuedMessage.dismiss': 'Odrzuć',
  'chat.queuedMessage.copyFailed': 'Nie udało się skopiować tekstu wiadomości',
  'chat.queuedMessage.selectionLimitation': 'Dodanie do kolejki serwera używa bieżących ustawień modelu, agenta i wariantu sesji',
