...
export const dict: Record<I18nKey, string> = {
  ...
  ...settingsDict,
  'gitView.operation.title': 'Operacja Git',
  'gitView.operation.recovery.storage': 'Pamięć odzyskiwania Git jest niedostępna. Przywróć pamięć przeglądarki i odśwież. Nowe zmiany są zablokowane.',
  'gitView.operation.recovery.capacity': 'Pamięć odzyskiwania Git jest pełna. Rozwiąż zapisane operacje przed rozpoczęciem kolejnej.',
  'gitView.operation.recovery.reconciling': 'Sprawdzanie zapisanych odwołań do operacji Git…',
  'gitView.operation.recovery.repository': 'Nie udało się zweryfikować repozytorium. Odśwież przed rozpoczęciem kolejnej operacji Git.',
  'gitView.operation.recovery.inspect': 'Jeśli serwer nie rozpoznaje już tego ID, sprawdź lokalne i zdalne repozytorium poza OpenChamber. Zapisane odwołanie pozostaje zablokowane; brak stanu nigdy nie upoważnia do powtórzenia transferu.',
  'gitView.operation.localCommit': 'Lokalny commit został utworzony i zachowany.',
  'gitView.operation.unknownHint': 'Wynik jest nieznany. Odśwież tę operację przed rozpoczęciem kolejnego transferu. Nic nie zostanie automatycznie powtórzone.',
  'gitView.operation.refresh': 'Odśwież operację',
  'gitView.operation.cancel': 'Anuluj operację',
  'gitView.operation.state.unavailable': 'Stan operacji niedostępny',
  'gitView.operation.state.planned': 'Zaplanowana',
  'gitView.operation.state.running': 'W toku',
  'gitView.operation.state.succeeded': 'Zakończona pomyślnie',
  'gitView.operation.state.partial': 'Częściowo ukończona',
  'gitView.operation.state.failed': 'Niepowodzenie',
  'gitView.operation.state.cancelled': 'Anulowana',
  'gitView.operation.state.outcome-unknown': 'Nieznany wynik',
  'gitView.operation.state.conflicted': 'Konflikt',
  'gitView.operation.state.skipped': 'Pominięta',
  'gitView.operation.completed.validated': 'Repozytorium i cel zweryfikowane',
  'gitView.operation.completed.authenticated': 'Uwierzytelnianie ukończone',
  'gitView.operation.completed.transferred': 'Transfer ukończony',
  'gitView.operation.completed.updated-local-repository': 'Lokalne repozytorium zaktualizowane',
  'gitView.operation.completed.checked-out': 'Checkout ukończony',
  'gitView.operation.completed.cleaned-up': 'Sprzątanie ukończone',
  'gitView.remotes.title': 'Pozostałe zdalne repozytoria',
  'gitView.remotes.description': 'Adresy, które to repozytorium ma obok tego, do którego zastosowano jego tożsamość. Dopóki adres nie zostanie dopuszczony, OpenChamber ani z niego nie pobiera, ani do niego nie wysyła.',
  'gitView.remotes.grant': 'Odpowiadaj jako {identity}',
  'gitView.hydration.title': 'Uzupełnienie checkoutu',
  'gitView.hydration.description': 'Zainicjuj podmoduły i pobierz zawartość Git LFS z oddzielną autoryzacją każdego punktu końcowego.',
  ...
  'gitView.hydration.kind.submodule': 'Podmoduł',
  'gitView.hydration.kind.lfs': 'Git LFS',
  'gitView.hydration.status.succeeded': 'Ukończono',
  'gitView.hydration.status.failed': 'Niepowodzenie',
  'gitView.hydration.status.cancelled': 'Anulowano',
  'gitView.hydration.status.authorization-required': 'Wymagana autoryzacja',
  'gitView.hydration.status.invalid': 'Nieprawidłowa konfiguracja',
  'gitView.hydration.status.client-missing': 'Brak klienta',
  'gitView.hydration.status.not-needed': 'Niewymagane',
  'gitView.publish.title': 'Opublikuj',
  'gitView.publish.commitKept': 'Lokalny commit został utworzony i zachowany. Publikacja nie zakończyła się pomyślnie.',
  'gitView.publish.syncTitle': 'Wybierz cele synchronizacji',
  'gitView.publish.description': 'Opublikuj {branch} w dokładnie wskazanym miejscu docelowym Git. Konta dostawcy nie wybierają celu.',
  'gitView.publish.fetchSource': 'Zdalne repozytorium źródłowe',
  'gitView.publish.sourceBranch': 'Gałąź źródłowa',
  'gitView.publish.fetchFirst': 'Brak zapisanych gałęzi tego repozytorium zdalnego. Anuluj i najpierw pobierz zmiany.',
  'gitView.publish.pushDestination': 'Zdalne repozytorium docelowe',
  'gitView.publish.selectRemote': 'Wybierz powiązane repozytorium zdalne',
  'gitView.publish.destinationBranch': 'Gałąź docelowa',
  'gitView.publish.noGrants': 'Przed publikacją skonfiguruj powiązanie transportu Git.',
  'gitView.publish.contributorCommitFirst': 'To drzewo robocze współtwórcy wymaga zatwierdzenia celu po utworzeniu commita. Kontynuować? Późniejsze anulowanie publikacji zachowa lokalny commit.',
  'gitView.publish.detached': 'Publikowanie odłączonego HEAD nie jest obsługiwane. Najpierw przełącz się na lokalną gałąź.',
  'gitView.publish.stale': 'Gałąź lub uprawnienia Git uległy zmianie. Nie ponowiono próby. Wybierz cel ponownie.',
  'gitView.publish.cancelled': 'Anulowano publikację. Nie rozpoczęto transferu Git.',
  'gitView.publish.succeeded': 'Opublikowano we wskazanym miejscu docelowym',
  ...
  'chat.shellBoundary.status': 'Niezweryfikowane · poza zarządzaną granicą',
  'chat.shellBoundary.agentAria': 'Wykonanie powłoki przez agenta jest niezweryfikowane i znajduje się poza zarządzaną granicą Git',
  'chat.shellBoundary.userAria': 'Wykonanie powłoki przez użytkownika jest niezweryfikowane i znajduje się poza zarządzaną granicą Git',
  ...
  'worktree.bootstrap.toast.authorizationRequired': 'Autoryzuj repozytorium źródłowe i jego podmoduły, a następnie spróbuj ponownie.',
  ...
  'gitView.context.description': 'Czego sama tożsamość nie rozstrzyga: powłoka agenta, pozostałe adresy repozytorium oraz osobne uprawnienia potrzebne podmodułom i Git LFS. Tożsamościami zarządza się w ustawieniach Git.',
  ...
  'gitView.identity.unavailableScheme': 'Wymaga zdalnego repozytorium {scheme}',
  ...
  'gitView.pr.actions.openOnProvider': 'Otwórz w {provider}',
  'gitView.pr.actions.openOnProviderAria': 'Otwórz pull request w {provider}',
  ...
  'gitView.pr.providerNotConnected': '{provider} nie jest połączony',
  ...
  'gitView.pr.capabilitiesUnavailable': 'Nie udało się wczytać możliwości dostawcy',
  ...
  'gitView.contributor.chooseDestination': 'Wybierz dokładne miejsce docelowe dla tej gałęzi współtwórcy.',
  'gitView.contributor.destination.contributor-fork': 'Fork współtwórcy',
  'gitView.contributor.destination.own-fork': 'Twój fork',
  'gitView.contributor.destination.bound-repository': 'Powiązane repozytorium',
  'gitView.contributor.destination.other': 'Inne repozytorium zdalne',
  'gitView.toast.contributorPublishCancelled': 'Publikowanie anulowano. Nie zmieniono żadnego repozytorium zdalnego.',
  'gitView.toast.contributorPublishCancelledAfterUpdate': 'Zmiany zaktualizowano lokalnie, ale publikowanie anulowano.',
  'gitView.toast.unstageFileFailed': 'Nie udało się usunąć zmian z indeksu',
  'gitView.confirm.systemTransport': 'Systemowy Git może użyć danych logowania skonfigurowanych na tym komputerze. Kontynuować tę operację Git?',
  ...
  'session.changeRequestPicker.error.noProvider': 'Nie znaleziono obsługiwanego zdalnego repozytorium kontroli źródła',
  'session.changeRequestPicker.title': 'Połącz żądanie zmiany',
  'session.changeRequestPicker.description': 'Wybierz pull request lub merge request, aby dołączyć kontekst przeglądu do tej wiadomości.',
  'session.changeRequestPicker.searchPlaceholder': 'Szukaj według tytułu lub numeru albo wklej adres URL żądania zmiany',
  'session.changeRequestPicker.includeDiffAria': 'Dołącz diff żądania zmiany do załączonego kontekstu',
  'session.changeRequestPicker.includeDiff': 'Dołącz diff',
  'session.changeRequestPicker.loading.changeRequests': 'Ładowanie żądań zmiany...',
  'session.changeRequestPicker.actions.useChangeRequest': 'Użyj żądania zmiany {reference}',
  'session.changeRequestPicker.empty.noneFound': 'Nie znaleziono żądań zmiany',
  'session.changeRequestPicker.empty.noneOpen': 'Nie znaleziono otwartych żądań zmiany',
  'session.issuePicker.title': 'Połącz zgłoszenie',
  'session.issuePicker.description': 'Wybierz zgłoszenie, aby dołączyć jego kontekst do tej wiadomości.',
  'session.issuePicker.searchPlaceholder': 'Szukaj według tytułu lub numeru albo wklej adres URL zgłoszenia',
  'session.issuePicker.loading.issues': 'Ładowanie zgłoszeń...',
  'session.issuePicker.actions.useIssue': 'Użyj zgłoszenia #{number}',
  'session.issuePicker.empty.noneFound': 'Nie znaleziono zgłoszeń',
  'session.issuePicker.empty.noneOpen': 'Nie znaleziono otwartych zgłoszeń',
  ...
  'session.newWorktree.error.changeRequestAuthorityMissing': 'Uprawnienie żądania zmiany nie jest już dostępne. Wybierz je ponownie.',
  'session.newWorktree.trust.confirmation': 'Ten checkout zawiera działania wykonywalne:\n\n{actions}\n\nUruchomić je teraz? Anulowanie pozostawi checkout gotowy do pracy z Git bez ich uruchamiania.',
