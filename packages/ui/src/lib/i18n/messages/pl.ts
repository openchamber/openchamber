...
export const dict: Record<I18nKey, string> = {
  ...
  'dockerInstances.title': 'Instancje Docker',
  'dockerInstances.description': 'Twórz instancje OpenCode w kontenerach Docker na tym komputerze i zarządzaj nimi.',
  'dockerInstances.state.creating': 'Tworzenie',
  'dockerInstances.state.starting': 'Uruchamianie',
  'dockerInstances.state.probing': 'Oczekiwanie na gotowość',
  'dockerInstances.state.running': 'Działa',
  'dockerInstances.state.stopped': 'Zatrzymana',
  'dockerInstances.state.error': 'Błąd',
  'dockerInstances.state.removing': 'Usuwanie',
  'dockerInstances.state.removalFailed': 'Czyszczenie nie powiodło się',
  'dockerInstances.state.empty': 'Nie ma jeszcze instancji Docker.',
  'dockerInstances.state.loadFailed': 'Nie udało się wczytać instancji Docker.',
  'dockerInstances.actions.addDocker': 'Dodaj instancję Docker',
  'dockerInstances.actions.switchAria': 'Przełącz na {name}',
  'dockerInstances.actions.stop': 'Zatrzymaj',
  'dockerInstances.actions.start': 'Uruchom',
  'dockerInstances.actions.cleanup': 'Ponów czyszczenie',
  'dockerInstances.actions.remove': 'Usuń',
  'dockerInstances.actions.confirmRemove': 'Potwierdź usunięcie',
  'dockerInstances.actions.openAria': 'Otwórz instancje Docker',
  'dockerInstances.create.title': 'Nowa instancja Docker',
  'dockerInstances.create.description': 'OpenChamber tworzy kontener, uruchamia w nim OpenCode i czeka na gotowość.',
  'dockerInstances.create.field.label': 'Nazwa',
  'dockerInstances.create.field.labelPlaceholder': 'Opcjonalna nazwa wyświetlana',
  'dockerInstances.create.field.image': 'Obraz',
  'dockerInstances.create.field.workspace': 'Ścieżka obszaru roboczego',
  ...
  'dockerInstances.create.sharing.credentialsTitle': 'Udostępnij poświadczenia',
  'dockerInstances.create.sharing.credentialsHint': 'Tylko odczyt, domyślnie wyłączone. Dane logowania dostawców stają się widoczne w kontenerze.',
  'dockerInstances.create.sharing.neverShared': 'Nigdy nie udostępniane: gniazdo Docker, klucze SSH, poświadczenia git. Porty są wiązane tylko z tym komputerem.',
  'dockerInstances.create.actions.buildImage': 'Zbuduj {image}',
  'dockerInstances.create.actions.cancel': 'Anuluj',
  'dockerInstances.create.actions.create': 'Utwórz instancję',
  'dockerInstances.create.actions.creating': 'Tworzenie…',
  'dockerInstances.create.error.generic': 'Nie udało się utworzyć instancji.',
  'dockerInstances.create.toast.created': 'Utworzono instancję Docker.',
  'dockerInstances.create.toast.imageBuilt': 'Obraz {image} jest gotowy.',
  'dockerInstances.toast.activated': 'Przełączono na {name}.',
  'dockerInstances.toast.deactivated': 'Powrót do instancji lokalnej.',
