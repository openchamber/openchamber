...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj Sharpie, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'Sharpie został zainstalowany',
  ...
  'mobile.connect.welcome.title': 'Połącz z Sharpie',
  ...
  'mobile.connect.password.placeholder': 'Hasło Sharpie',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia Sharpie.',
  ...
  'mobile.connect.relay.badge': 'przez Sharpie Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem Sharpie.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'O Sharpie',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia Sharpie.',
  ...
  'onboarding.chooser.title': 'Witaj w Sharpie',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli Sharpie nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień Sharpie i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera Sharpie aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer Sharpie, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji Sharpie. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia Sharpie, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj Sharpie na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim Sharpie. Zweryfikuj czy adres wskazuje na serwer Sharpie.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia Sharpie. Zweryfikuj czy adres wskazuje na serwer Sharpie.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer Sharpie pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj Sharpie na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'Sharpie nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan Sharpie, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja Sharpie {version}',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'Serwer Sharpie, z którym połączona jest ta aplikacja, nie odpowiedział na API walkthroughu — jest więc starszy niż aplikacja. Zaktualizuj serwer do wersji 1.18 lub nowszej i odśwież.',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do Sharpie — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami Sharpie',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Sharpie potrzebuje dostępu do tego folderu.',
  ...
  'filesView.editor.binaryFileDescription': 'Ten plik jest binarny i nie można go edytować w Sharpie. Pobierz go, aby otworzyć w innej aplikacji.',
  ...
  'header.actions.openAppMenu': 'Menu Sharpie',
  'header.actions.openAppMenuAria': 'Otwórz menu Sharpie',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po Sharpie.',
  ...
  'openChamberLogo.aria.logo': 'Logo Sharpie',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz Sharpie z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj Sharpie',
  ...
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja Sharpie',
  ...
  'updateDialog.header.updating': 'Aktualizowanie Sharpie...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw Sharpie otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce Sharpie — zainstaluj je, aby zacząć.',
