...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.toolGroup.context.title.active': 'Eksplorowanie',
  'chat.toolGroup.context.title.done': 'Eksploracja zakończona',
  'chat.toolGroup.context.title.failed': 'Eksploracja nie powiodła się',
  'chat.toolGroup.context.summary.readSingle': '{count} odczyt',
  'chat.toolGroup.context.summary.searchSingle': '{count} wyszukiwanie',
  'chat.toolGroup.context.summary.listSingle': '{count} katalog',
  'chat.toolGroup.context.summary.readPluralFew': '{count} odczyty',
  'chat.toolGroup.context.summary.readPluralMany': '{count} odczytów',
  'chat.toolGroup.context.summary.searchPluralFew': '{count} wyszukiwania',
  'chat.toolGroup.context.summary.searchPluralMany': '{count} wyszukiwań',
  'chat.toolGroup.context.summary.listPluralFew': '{count} katalogi',
  'chat.toolGroup.context.summary.listPluralMany': '{count} katalogów',
  'chat.toolGroup.context.child.active': 'Aktywne',
  'chat.toolGroup.context.child.error': 'Błąd',
  'chat.toolGroup.context.child.read': 'Odczyt',
  'chat.toolGroup.context.child.search': 'Wyszukiwanie',
  'chat.toolGroup.context.child.list': 'Lista',
  'chat.toolGroup.context.actions.expandWithSummary': 'Rozwiń szczegóły narzędzi kontekstowych: {summary}',
  'chat.toolGroup.context.actions.collapseWithSummary': 'Zwiń szczegóły narzędzi kontekstowych: {summary}',
