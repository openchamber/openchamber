...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.engine.claudeCodeAria': 'Silnik Claude Code',
  'sessions.sidebar.session.engine.claudeCodeTooltip': 'Działa na Claude Code',
  ...
  'chat.engines.slashUnsupported': 'To polecenie slash OpenCode nie jest dostępne w Claude Code. Użyj natywnego polecenia / Claude albo wyślij zwykłą wiadomość.',
  'chat.engines.effort.label': 'Wysiłek',
  'chat.engines.effort.default': 'Domyślny',
  'chat.engines.effort.low': 'Niski',
  'chat.engines.effort.medium': 'Średni',
  'chat.engines.effort.high': 'Wysoki',
  'chat.engines.effort.xhigh': 'Bardzo wysoki',
  'chat.engines.effort.max': 'Maksymalny',
  'chat.engines.effort.aria': 'Wysiłek: {level}',
  'chat.engines.effort.tooltip': 'Wysiłek: {level}',
  'chat.engines.capability.goalUnsupported': 'Cele nie są dostępne w tym silniku.',
  'chat.engines.capability.multirunUnsupported': 'MultiRun nie jest dostępny w tym silniku.',
  'chat.engines.capability.openchamberToolUnsupported': 'Narzędzie OpenChamber nie jest dostępne w tym silniku.',
  'chat.handoff.billingDialog.title': 'Kontynuować w Claude Code?',
  'chat.handoff.billingDialog.body': 'To rozpocznie nową sesję w Claude Code, korzystając z limitów użycia subskrypcji Claude. Dostawcy API OpenCode pozostają bez zmian. Tekst rozmowy jest kopiowany jako kontekst; oryginalna sesja pozostaje nietknięta.',
  'chat.handoff.billingDialog.continue': 'Kontynuuj',
  'chat.handoff.billingDialog.cancel': 'Anuluj',
  'chat.handoff.billingDialog.dontShowAgain': 'Nie pokazuj ponownie',
  'chat.handoff.billingDialog.dontShowAgainAria': 'Nie pokazuj ponownie tego powiadomienia o rozliczeniach przy przekazaniu',
  ...
  'gitView.pr.comments.addAll': 'Dodaj wszystko do czatu',
