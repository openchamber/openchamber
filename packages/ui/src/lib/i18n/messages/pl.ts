...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.chatInput.reviewCommentEdit': 'Edytuj komentarz',
  'chat.chatInput.reviewCommentEditPlaceholder': 'Edytuj swój komentarz…',
  'chat.chatInput.reviewCommentSave': 'Zapisz',
  'chat.message.inlineComment.expand': 'Pokaż kod',
  'chat.message.inlineComment.collapse': 'Ukryj kod',
  'chat.message.inlineComment.lineSingle': 'Wiersz {line}',
  'chat.message.inlineComment.lineRange': 'Wiersze {start}–{end}',
  'chat.message.inlineComment.lineSingleOfFile': 'Wiersz {line} w {file}',
  'chat.message.inlineComment.lineRangeOfFile': 'Wiersze {start}–{end} w {file}',
  'chat.chatInput.reviewCommentCancel': 'Anuluj',
