...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.messageBody.metrics.ttftInfo': 'Czas do pierwszego tokena: ile minęło od zapytania do momentu, gdy model zaczął odpowiadać.',
  'chat.messageBody.metrics.tokensPerSecond': '{rate} tok/s',
  'chat.messageBody.metrics.tokensPerSecondInfo': 'Tokeny wyjściowe na sekundę dekodowania strumieniowego, bez czasu wykonywania narzędzi.',
