...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.server-browser.description': 'Chrome uruchomiony na serwerze',
  ...
  'contextPanel.browser.newServerTab': 'Nowa karta przeglądarki serwera',
  'contextPanel.browser.remote.tabLabel': 'Przeglądarka serwera',
  'contextPanel.browser.remote.sessionsMenu': 'Sesje przeglądarki',
  'contextPanel.browser.remote.savedSessions': 'Zapisane sesje',
  'contextPanel.browser.remote.availableSessions': 'Działające sesje',
  'contextPanel.browser.remote.openDevTools': 'Otwórz Chrome DevTools',
  'contextPanel.browser.remote.contextMenuUnavailable': 'Działania przeglądarki są niedostępne dla tego kliknięcia. Użyj paska narzędzi lub przycisków schowka.',
  'contextPanel.browser.remote.devTools': 'Chrome DevTools',
  'contextPanel.browser.remote.simpleInspector': 'Konsola i sieć',
  'contextPanel.browser.remote.inspectMode': 'Tryb inspekcji',
  'contextPanel.browser.remote.maximizeInspector': 'Maksymalizuj inspektor',
  'contextPanel.browser.remote.restoreInspector': 'Przywróć stronę i inspektor',
  'contextPanel.browser.remote.resizeInspector': 'Zmień rozmiar inspektora',
  'contextPanel.browser.remote.devtoolsLoading': 'Łączenie z Chrome DevTools…',
  'contextPanel.browser.remote.devtoolsLoadFailed': 'Nie udało się wczytać Chrome DevTools.',
  'contextPanel.browser.remote.devtoolsRetry': 'Połącz ponownie z DevTools',
  'contextPanel.browser.remote.devtoolsControlLost': 'Inna sesja podglądu przejęła kontrolę. Połącz się ponownie, aby kontynuować inspekcję.',
  'contextPanel.browser.remote.devtoolsConnectionClosed': 'Połączenie z DevTools zostało zamknięte.',
  'contextPanel.browser.remote.devtoolsMessageTooLarge': 'Wiadomość DevTools przekroczyła limit rozmiaru.',
  'contextPanel.browser.remote.devtoolsBackpressure': 'DevTools nie nadążały z przetwarzaniem danych połączenia. Połącz się ponownie, aby kontynuować.',
  'contextPanel.browser.remote.devtoolsInvalidRequest': 'Połączenie z DevTools otrzymało nieprawidłową wiadomość.',
  'contextPanel.browser.remote.devtoolsProtocolRejected': 'Ta czynność DevTools nie jest dostępna dla tej strony.',
  'contextPanel.browser.remote.devtoolsExclusive': 'Rejestrowanie wydajności wymaga, aby ta sesja przeglądarki była jedyną uruchomioną.',
  'contextPanel.browser.remote.devtoolsStartFailed': 'Nie udało się otworzyć DevTools dla tej strony.',
  'contextPanel.browser.remote.connecting': 'Łączenie z przeglądarką serwera…',
  'contextPanel.browser.remote.reconnecting': 'Połączenie utracone. Ponowne łączenie…',
  'contextPanel.browser.remote.chooseTitle': 'Sesje przeglądarki serwera',
  'contextPanel.browser.remote.chooseHint': 'Dołącz do działającej sesji lub rozpocznij nową.',
  'contextPanel.browser.remote.newSession': 'Nowa sesja',
  'contextPanel.browser.remote.noSessions': 'Brak działających sesji serwera dla tego projektu.',
  'contextPanel.browser.remote.sessionEphemeral': 'Sesja agenta',
  'contextPanel.browser.remote.sessionProject': 'Sesja projektu',
  'contextPanel.browser.remote.errorTitle': 'Przeglądarka serwera jest niedostępna',
  'contextPanel.browser.remote.endedTitle': 'Ta sesja przeglądarki serwera została zakończona',
  'contextPanel.browser.remote.retry': 'Spróbuj ponownie',
  'contextPanel.browser.remote.canvasAria': 'Widok strony zdalnej',
  'contextPanel.browser.remote.keyboard': 'Pisz na stronie',
  'contextPanel.browser.remote.textInputAria': 'Wprowadzanie tekstu na zdalnej stronie',
  'contextPanel.browser.remote.clipboard.copy': 'Kopiuj',
  'contextPanel.browser.remote.clipboard.paste': 'Wklej',
  'contextPanel.browser.remote.clipboard.copied': 'Skopiowano do schowka',
  'contextPanel.browser.remote.clipboard.pasted': 'Wklejono na stronie',
  'contextPanel.browser.remote.clipboard.noSelection': 'Zaznacz tekst na stronie, aby go skopiować.',
  'contextPanel.browser.remote.clipboard.copyFailed': 'Nie udało się skopiować zaznaczenia. Spróbuj ponownie.',
  'contextPanel.browser.remote.clipboard.pasteFailed': 'Nie udało się wkleić tekstu na stronie. Spróbuj ponownie.',
  'contextPanel.browser.remote.clipboard.tooLarge': 'Ten tekst jest zbyt duży, aby go przesłać.',
  'contextPanel.browser.remote.clipboard.copyFallbackTitle': 'Kopiuj zaznaczony tekst',
  'contextPanel.browser.remote.clipboard.copyFallbackDescription': 'Brak dostępu do schowka. Zaznacz i skopiuj poniższy tekst.',
  'contextPanel.browser.remote.clipboard.copyTextAria': 'Zaznaczony tekst strony',
  'contextPanel.browser.remote.clipboard.pasteFallbackTitle': 'Wklej na stronie',
  'contextPanel.browser.remote.clipboard.pasteFallbackDescription': 'Wklej poniżej zwykły tekst, a następnie wyślij go na stronę.',
  'contextPanel.browser.remote.clipboard.pasteTextAria': 'Tekst do wklejenia na stronie',
  'contextPanel.browser.remote.clipboard.emptyClipboard': 'Schowek nie zawiera zwykłego tekstu.',
  'contextPanel.browser.remote.clipboard.cancel': 'Anuluj',
  'contextPanel.browser.remote.viewport.auto': 'Automatycznie',
  'contextPanel.browser.remote.viewport.preset': 'Ustawienie wstępne widoku',
  'contextPanel.browser.remote.viewport.custom': 'Własne',
  'contextPanel.browser.remote.viewport.width': 'Szerokość',
  'contextPanel.browser.remote.viewport.height': 'Wysokość',
  'contextPanel.browser.remote.viewport.rotate': 'Obróć',
  'contextPanel.browser.remote.viewport.mobile': 'Emuluj urządzenie mobilne',
  'contextPanel.browser.remote.viewport.scale': 'Skala wyświetlania',
  'contextPanel.browser.remote.viewport.pending': 'Dostosowywanie obszaru widoku…',
  'contextPanel.browser.remote.viewport.error': 'Nie udało się zmienić rozmiaru obszaru widoku: {code}',
  'contextPanel.browser.remote.viewport.agentControlled': 'Agent steruje tym obszarem widoku',
  'contextPanel.browser.remote.viewport.external': 'Zewnętrzne DevTools sterują tym obszarem widoku',
  'contextPanel.browser.remote.viewport.dimensionsConfirmed': 'Potwierdzono: {width} × {height}',
  'contextPanel.browser.remote.inspector.title': 'Inspektor strony',
  'contextPanel.browser.remote.inspector.open': 'Otwórz inspektor strony',
  'contextPanel.browser.remote.inspector.close': 'Zamknij inspektor',
  'contextPanel.browser.remote.inspector.console': 'Konsola',
  'contextPanel.browser.remote.inspector.network': 'Sieć',
  'contextPanel.browser.remote.inspector.clear': 'Wyczyść',
  'contextPanel.browser.remote.inspector.filterPlaceholder': 'Filtruj komunikaty lub żądania',
  'contextPanel.browser.remote.inspector.filterAria': 'Filtruj wpisy inspektora',
  'contextPanel.browser.remote.inspector.capturing': 'Zbieranie danych z tej karty',
  'contextPanel.browser.remote.inspector.starting': 'Rozpoczynanie zbierania danych',
  'contextPanel.browser.remote.inspector.captureHint': 'Zbieranie danych rozpoczyna się po otwarciu inspektora. Zamknięcie go usuwa zebrane dane.',
  'contextPanel.browser.remote.inspector.dropped': 'Pominięte wpisy: {count}',
  'contextPanel.browser.remote.inspector.emptyConsole': 'Tutaj pojawią się komunikaty konsoli.',
  'contextPanel.browser.remote.inspector.filteredEmpty': 'Brak pasujących wpisów.',
  'contextPanel.browser.remote.inspector.expressionAria': 'JavaScript do uruchomienia na stronie',
  'contextPanel.browser.remote.inspector.expressionPlaceholder': 'Uruchom JavaScript na stronie',
  'contextPanel.browser.remote.inspector.run': 'Uruchom',
  'contextPanel.browser.remote.inspector.running': 'Wykonywanie',
  'contextPanel.browser.remote.inspector.previousCommand': 'Poprzednie polecenie',
  'contextPanel.browser.remote.inspector.nextCommand': 'Następne polecenie',
  'contextPanel.browser.remote.inspector.shortcutHint': 'Ctrl/Cmd+Enter uruchamia kod. Enter dodaje nowy wiersz.',
  'contextPanel.browser.remote.inspector.truncated': 'Skrócono',
  'contextPanel.browser.remote.inspector.errorUnavailable': 'Inspektor strony jest niedostępny. Otwórz go ponownie, aby spróbować jeszcze raz.',
  'contextPanel.browser.remote.inspector.errorInvalid': 'Wprowadź kod JavaScript o długości najwyżej 16 000 znaków.',
  'contextPanel.browser.remote.inspector.errorCaptureGone': 'Zbieranie danych zakończone. Otwórz inspektor ponownie, aby zacząć od nowa.',
  'contextPanel.browser.remote.inspector.errorEvaluation': 'Nie udało się uruchomić kodu JavaScript. Spróbuj ponownie.',
  'contextPanel.browser.remote.inspector.errorTimeout': 'Przekroczono limit czasu wykonania kodu JavaScript. Strona może nadal go wykonywać.',
  'contextPanel.browser.remote.inspector.errorRequestGone': 'To żądanie nie jest już dostępne.',
  'contextPanel.browser.remote.inspector.errorRequest': 'Nie udało się wczytać tego żądania. Spróbuj ponownie.',
  'contextPanel.browser.remote.inspector.errorCapture': 'Nie udało się rozpocząć zbierania danych. Otwórz inspektor ponownie, aby spróbować jeszcze raz.',
  'contextPanel.browser.remote.inspector.resultAria': 'Wynik kodu JavaScript',
  'contextPanel.browser.remote.inspector.commandAria': 'Wykonany kod JavaScript',
  'contextPanel.browser.remote.inspector.level.debug': 'Debugowanie',
  'contextPanel.browser.remote.inspector.level.info': 'Informacja',
  'contextPanel.browser.remote.inspector.level.log': 'Log',
  'contextPanel.browser.remote.inspector.level.warning': 'Ostrzeżenie',
  'contextPanel.browser.remote.inspector.level.error': 'Błąd',
  'contextPanel.browser.remote.inspector.network.empty': 'Nie zarejestrowano jeszcze żadnych żądań.',
  'contextPanel.browser.remote.inspector.network.noMatches': 'Żadne żądania nie pasują do tego filtra.',
  'contextPanel.browser.remote.inspector.network.selectRequest': 'Wybierz żądanie, aby je sprawdzić.',
  'contextPanel.browser.remote.inspector.network.details': 'Szczegóły żądania',
  'contextPanel.browser.remote.inspector.network.closeDetails': 'Zamknij szczegóły żądania',
  'contextPanel.browser.remote.inspector.network.loading': 'Wczytywanie szczegółów żądania',
  'contextPanel.browser.remote.inspector.network.loadBodies': 'Wczytaj treść',
  'contextPanel.browser.remote.inspector.network.requestHeaders': 'Nagłówki żądania',
  'contextPanel.browser.remote.inspector.network.responseHeaders': 'Nagłówki odpowiedzi',
  'contextPanel.browser.remote.inspector.network.requestBody': 'Treść żądania',
  'contextPanel.browser.remote.inspector.network.responseBody': 'Treść odpowiedzi',
  'contextPanel.browser.remote.inspector.network.noHeaders': 'Brak dostępnych nagłówków.',
  'contextPanel.browser.remote.inspector.network.noBody': 'Brak dostępnej treści.',
  'contextPanel.browser.remote.inspector.network.bodiesNotRequested': 'Treść jest wczytywana tylko na żądanie.',
  'contextPanel.browser.remote.inspector.network.bodiesUnavailable': 'Treść żądania i odpowiedzi nie jest już dostępna.',
  'contextPanel.browser.remote.inspector.network.bodiesUnsupported': 'Podgląd treści tej odpowiedzi nie jest obsługiwany.',
  'contextPanel.browser.remote.inspector.network.truncated': 'Podgląd skrócono.',
  'contextPanel.browser.remote.inspector.network.method': 'Metoda',
  'contextPanel.browser.remote.inspector.network.url': 'URL',
  'contextPanel.browser.remote.inspector.network.status': 'Status',
  'contextPanel.browser.remote.inspector.network.duration': 'Czas trwania',
  'contextPanel.browser.remote.inspector.network.size': 'Przesłano',
  'contextPanel.browser.remote.inspector.network.state': 'Stan',
  'contextPanel.browser.remote.inspector.network.cached': 'Z pamięci podręcznej',
  'contextPanel.browser.remote.inspector.network.failure': 'Błąd',
  'contextPanel.browser.remote.inspector.network.resourceType': 'Typ',
  'contextPanel.browser.remote.inspector.network.mimeType': 'Typ zawartości',
  'contextPanel.browser.remote.inspector.network.pending': 'Oczekujące',
  'contextPanel.browser.remote.inspector.network.complete': 'Zakończone',
  'contextPanel.browser.remote.inspector.network.failed': 'Nieudane',
  'contextPanel.browser.remote.inspector.network.unknown': 'Niedostępne',
  'contextPanel.browser.remote.inspector.network.yes': 'Tak',
  'contextPanel.browser.remote.inspector.network.no': 'Nie',
  'contextPanel.browser.remote.inspector.network.failedDetails': 'Nie udało się wczytać szczegółów żądania. Spróbuj ponownie.',
  'contextPanel.browser.remote.inspector.network.requestGone': 'To żądanie nie jest już dostępne.',
  'contextPanel.browser.remote.inspector.network.captureGone': 'To zbieranie danych zostało zakończone.',
  ...
  'contextPanel.browser.agentControlling': 'Agent steruje',
