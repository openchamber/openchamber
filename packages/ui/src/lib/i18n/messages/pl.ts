...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj ALIAS ADE, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'ALIAS ADE został zainstalowany',
  ...
  'sessions.sidebar.footer.actions.aboutAliasAde': 'O ALIAS ADE',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia ALIAS ADE.',
  ...
  'onboarding.chooser.title': 'Witaj w ALIAS ADE',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli ALIAS ADE nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień ALIAS ADE i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera ALIAS ADE aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer ALIAS ADE, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim ALIAS ADE. Zweryfikuj czy adres wskazuje na serwer ALIAS ADE.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia ALIAS ADE. Zweryfikuj czy adres wskazuje na serwer ALIAS ADE.',
  ...
  'startup.initRecovery.description': 'ALIAS ADE nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan ALIAS ADE, kondycję OpenCode, katalogi i projekty.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami ALIAS ADE',
  ...
  'header.services.shutdownDev': 'Zatrzymaj ALIAS ADE',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po ALIAS ADE.',
  ...
  'aliasAdeLogo.aria.logo': 'Logo ALIAS ADE',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj ALIAS ADE',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: alias-ade update',
  ...
  'updateDialog.header.updating': 'Aktualizowanie ALIAS ADE...',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce ALIAS ADE — zainstaluj je, aby zacząć.',
  ...
  'settings.aliasAde.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  'settings.aliasAde.visual.field.mobileKeyboardMode': 'Tryb klawiatury mobilnej',
  'settings.aliasAde.visual.field.mobileKeyboardModeHint': 'Wybierz sposób zachowania widoku podczas otwartej klawiatury.',
  'settings.aliasAde.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.aliasAde.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.aliasAde.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.aliasAde.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.aliasAde.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.aliasAde.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.aliasAde.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
