...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.modelControls.projectDefaultSaved': 'Zaktualizowano domyślny model projektu',
  'chat.modelControls.projectDefaultSavedDescription': 'Przyszłe czaty w tym projekcie będą rozpoczynać się z modelem {model}.',
  'chat.modelControls.projectDefaultSaveFailed': 'Nie udało się zaktualizować domyślnego modelu projektu',
  'chat.modelControls.projectDefaultOpenSettings': 'Ustawienia projektu',
  'chat.modelControls.projectDefaultAction': 'Użyj w tym czacie i przyszłych czatach w tym projekcie',
  'chat.modelControls.projectDefaultCurrent': 'Używany dla nowych czatów w tym projekcie',
