...
export const dict: Record<I18nKey, string> = {
  ...
  'session.gitlabIntegration.tabs.mergeRequests': 'Merge requesty',
  'session.gitlabIntegration.connect.title': 'Połącz z GitLab',
  'session.gitlabIntegration.connect.description': 'Połącz zagadnienia lub merge requesty aby auto-wypełnić szczegóły drzewa pracy',
  'session.gitlabIntegration.connect.action': 'Połącz GitLab',
  'session.gitlabIntegration.search.issuesPlaceholder': 'Szukaj zagadnień GitLab',
  'session.gitlabIntegration.search.mrsPlaceholder': 'Szukaj merge requestów GitLab',
  'session.gitlabIntegration.empty.noIssuesFound': 'Nie znaleziono zagadnień',
  'session.gitlabIntegration.empty.noMergeRequestsFound': 'Nie znaleziono merge requestów',
  ...
  'session.gitlabIntegration.draftBadge': 'Szkic',
  'session.giteaIntegration.title': 'Wybierz z Gitea',
  'session.giteaIntegration.tabs.issues': 'Zagadnienia',
  'session.giteaIntegration.tabs.pullRequests': 'Pull requesty',
  'session.giteaIntegration.connect.title': 'Połącz z Gitea',
  'session.giteaIntegration.connect.description': 'Połącz zagadnienia lub pull requesty aby auto-wypełnić szczegóły drzewa pracy',
  'session.giteaIntegration.connect.action': 'Połącz Gitea',
  'session.giteaIntegration.search.issuesPlaceholder': 'Szukaj zagadnień Gitea',
  'session.giteaIntegration.search.prsPlaceholder': 'Szukaj pull requestów Gitea',
  'session.giteaIntegration.empty.noIssuesFound': 'Nie znaleziono zagadnień',
  'session.giteaIntegration.empty.noPullRequestsFound': 'Nie znaleziono pull requestów',
  'session.giteaIntegration.actions.loadMore': 'Załaduj więcej',
  'session.giteaIntegration.actions.cancel': 'Anuluj',
  'session.giteaIntegration.actions.select': 'Wybierz',
  'session.giteaIntegration.selected.issueNumber': 'Zagadnienie #{number}',
  'session.giteaIntegration.selected.prNumber': 'PR #{number}',
  'session.giteaIntegration.includeDiffAria': 'Dołącz diff PR do kontekstu sesji',
  'session.giteaIntegration.includeDiff': 'Dołącz diff PR',
  'session.giteaIntegration.error.notConnected': 'Gitea nie jest połączony',
  'session.giteaIntegration.error.loadDataFailed': 'Nie udało się załadować danych',
  'session.giteaIntegration.validation.branchAlreadyCheckedOut': 'Gałąź jest już wyewidencjonowana w drzewie pracy',
  'session.giteaIntegration.validation.branchAlreadyExists': 'Gałąź już istnieje lokalnie',
  'session.giteaIntegration.validation.failed': 'Walidacja nie powiodła się',
  'session.giteaIntegration.draftBadge': 'Szkic',
  ...
  'chat.chatInput.actions.linkGitlabIssue': 'Połącz zgłoszenie GitLab',
  'chat.chatInput.actions.linkGitlabMr': 'Połącz merge request GitLab',
  'chat.chatInput.actions.linkGiteaIssue': 'Połącz zgłoszenie Gitea',
  'chat.chatInput.actions.linkGiteaPr': 'Połącz pull request Gitea',
  ...
  'contextPanel.mode.mr': 'Żądanie scalenia',
  ...
  'contextPanel.gitlabMr.createMr.titleLabel': 'Tytuł',
  'contextPanel.gitlabMr.createMr.titlePlaceholder': 'Tytuł żądania scalenia',
  'contextPanel.gitlabMr.createMr.descriptionLabel': 'Opis',
  ...
  'contextPanel.gitlabMr.updateMr.save': 'Zapisz',
  'contextPanel.gitlabMr.updateMr.saving': 'Zapisywanie...',
  'contextPanel.gitlabMr.updateMr.toast.updated': 'Zaktualizowano żądanie scalenia',
  'contextPanel.gitlabMr.updateMr.toast.updateFailed': 'Nie udało się zaktualizować żądania scalenia',
  'contextPanel.gitlabMr.mergeMr.action': 'Scal',
  'contextPanel.gitlabMr.mergeMr.squash': 'Składuj commity',
  'contextPanel.gitlabMr.mergeMr.merging': 'Scalanie...',
  'contextPanel.gitlabMr.mergeMr.toast.merged': 'Żądanie scalenia scalone',
  'contextPanel.gitlabMr.mergeMr.toast.mergeFailed': 'Nie udało się scalić żądania scalenia',
  'contextPanel.giteaPr.title': 'Pull requesty',
  'contextPanel.giteaPr.tabs.pullRequests': 'Pull requesty',
  'contextPanel.giteaPr.tabs.issues': 'Zgłoszenia',
  'contextPanel.giteaPr.branchSectionTitle': 'Bieżąca gałąź',
  'contextPanel.giteaPr.openPrTitle': 'Otwarte pull requesta',
  'contextPanel.giteaPr.listSectionTitle': 'W tym repozytorium',
  'contextPanel.giteaPr.openPrEmpty': 'Brak otwartych pull requestów',
  'contextPanel.giteaPr.noPrForBranch': 'Brak pull requesta dla tej gałęzi',
  'contextPanel.giteaPr.loadContext': 'Wczytaj kontekst',
  'contextPanel.giteaPr.hideContext': 'Ukryj kontekst',
  'contextPanel.giteaPr.openInGitea': 'Otwórz w Gitea',
  'contextPanel.giteaPr.draft': 'Wersja robocza',
  'contextPanel.giteaPr.state.opened': 'Otwarte',
  'contextPanel.giteaPr.state.merged': 'Scalone',
  'contextPanel.giteaPr.state.closed': 'Zamknięte',
  'contextPanel.giteaPr.loadMore': 'Wczytaj więcej',
  'contextPanel.giteaPr.loading': 'Wczytywanie...',
  'contextPanel.giteaPr.error.loadFailed': 'Nie udało się wczytać pull requestów',
  'contextPanel.giteaPr.error.notConnected': 'Gitea nie jest połączony',
  'contextPanel.giteaPr.empty.noActiveProject': 'Brak aktywnego projektu',
  'contextPanel.giteaPr.actions.openSettings': 'Otwórz ustawienia',
  'contextPanel.giteaPr.issues.detail.back': 'Wróć do zgłoszeń',
  'contextPanel.giteaPr.issues.detail.commentsEmpty': 'Brak komentarzy',
  'contextPanel.giteaPr.issues.empty': 'Brak otwartych zgłoszeń',
  'contextPanel.giteaPr.issues.error.loadFailed': 'Nie udało się załadować zgłoszeń',
  'contextPanel.giteaPr.issues.listSectionTitle': 'Otwarte zgłoszenia',
  'contextPanel.giteaPr.createPr.title': 'Nowe pull request',
  'contextPanel.giteaPr.createPr.sourceBranch': 'Gałąź źródłowa',
  'contextPanel.giteaPr.createPr.targetBranch': 'Gałąź docelowa',
  'contextPanel.giteaPr.createPr.titleLabel': 'Tytuł',
  'contextPanel.giteaPr.createPr.titlePlaceholder': 'Tytuł pull requesta',
  'contextPanel.giteaPr.createPr.descriptionLabel': 'Opis',
  'contextPanel.giteaPr.createPr.removeSourceBranch': 'Usuń gałąź źródłową po scaleniu',
  'contextPanel.giteaPr.createPr.submit': 'Utwórz pull request',
  'contextPanel.giteaPr.createPr.submitting': 'Tworzenie...',
  'contextPanel.giteaPr.createPr.branchesLoading': 'Wczytywanie gałęzi...',
  'contextPanel.giteaPr.createPr.toast.created': 'Utworzono pull request',
  'contextPanel.giteaPr.createPr.toast.createFailed': 'Nie udało się utworzyć pull requesta',
  'contextPanel.giteaPr.updatePr.toggle': 'Edytuj tytuł i opis',
  'contextPanel.giteaPr.updatePr.save': 'Zapisz',
  'contextPanel.giteaPr.updatePr.saving': 'Zapisywanie...',
  'contextPanel.giteaPr.updatePr.toast.updated': 'Zaktualizowano pull request',
  'contextPanel.giteaPr.updatePr.toast.updateFailed': 'Nie udało się zaktualizować pull requesta',
  'contextPanel.giteaPr.mergePr.action': 'Scal',
  'contextPanel.giteaPr.mergePr.squash': 'Składuj commity',
  'contextPanel.giteaPr.mergePr.merging': 'Scalanie...',
  'contextPanel.giteaPr.mergePr.toast.merged': 'Pull request scalone',
  'contextPanel.giteaPr.mergePr.toast.mergeFailed': 'Nie udało się scalić pull requesta',
  ...
  'contextRail.surface.mr.description': 'Twórz, przeglądaj i scalaj żądanie scalenia bieżącej gałęzi',
  ...
  'session.giteaIssuePicker.error.noActiveProject': 'Brak aktywnego projektu',
  'session.giteaIssuePicker.error.runtimeUnavailable': 'API środowiska Gitea jest niedostępne',
  'session.giteaIssuePicker.error.notConnected': 'Gitea nie jest połączony',
  'session.giteaIssuePicker.error.repoNotResolvable': 'Nie udało się rozpoznać repozytorium',
  'session.giteaIssuePicker.error.repoMustBeGitea': 'remote origin musi być adresem URL Gitea',
  'session.giteaIssuePicker.error.issueNotFound': 'Nie znaleziono zgłoszenia',
  'session.giteaIssuePicker.error.noModelSelected': 'Nie wybrano modelu',
  'session.giteaIssuePicker.toast.loadMoreFailed': 'Nie udało się załadować kolejnych zgłoszeń',
  'session.giteaIssuePicker.toast.loadIssueDetailsFailed': 'Nie udało się załadować szczegółów zgłoszenia',
  'session.giteaIssuePicker.toast.sendContextFailed': 'Nie udało się wysłać kontekstu zgłoszenia',
  'session.giteaIssuePicker.toast.sessionCreated': 'Sesja utworzona ze zgłoszenia',
  'session.giteaIssuePicker.toast.startSessionFailed': 'Nie udało się uruchomić sesji',
  'session.giteaIssuePicker.title.select': 'Połącz zgłoszenie Gitea',
  'session.giteaIssuePicker.title.createSession': 'Nowa sesja ze zgłoszenia Gitea',
  'session.giteaIssuePicker.description.select': 'Wybierz zgłoszenie, które chcesz powiązać z tą sesją.',
  'session.giteaIssuePicker.description.createSession': 'Tworzy nową sesję z ukrytym kontekstem zgłoszenia (tytuł/treść/etykiety/komentarze).',
  'session.giteaIssuePicker.searchPlaceholder': 'Szukaj po tytule lub wklej adres URL zgłoszenia',
  'session.giteaIssuePicker.empty.noActiveProject': 'Nie wybrano aktywnego projektu.',
  'session.giteaIssuePicker.empty.runtimeUnavailable': 'API środowiska Gitea jest niedostępne.',
  'session.giteaIssuePicker.empty.notConnected': 'Gitea nie jest połączony. Połącz konto Gitea w ustawieniach.',
  'session.giteaIssuePicker.empty.noIssuesFound': 'Nie znaleziono zgłoszeń',
  'session.giteaIssuePicker.empty.noOpenIssuesFound': 'Nie znaleziono otwartych zgłoszeń',
  'session.giteaIssuePicker.loading.issues': 'Ładowanie zgłoszeń...',
  'session.giteaIssuePicker.loading.more': 'Ładowanie...',
  'session.giteaIssuePicker.actions.openSettings': 'Otwórz ustawienia',
  'session.giteaIssuePicker.actions.useIssue': 'Użyj zgłoszenia #{number}',
  'session.giteaIssuePicker.actions.openInGiteaAria': 'Otwórz w Gitea',
  'session.giteaIssuePicker.actions.loadMore': 'Załaduj więcej',
  'session.giteaIssuePicker.actions.sectionTitle': 'Akcje',
  'session.giteaIssuePicker.actions.toggleWorktreeAria': 'Przełącz drzewo pracy',
  'session.giteaIssuePicker.actions.createInWorktree': 'Utwórz w drzewie pracy',
  'session.giteaIssuePicker.actions.openRepo': 'Otwórz repozytorium',
  'session.giteaIssuePicker.actions.refresh': 'Odśwież',
  ...
  'session.gitlabIssuePicker.searchPlaceholder': 'Szukaj po tytule lub wklej adres URL zgłoszenia',
  ...
  'session.giteaPrPicker.error.noActiveProject': 'Brak aktywnego projektu',
  'session.giteaPrPicker.error.runtimeUnavailable': 'API środowiska Gitea jest niedostępne',
  'session.giteaPrPicker.error.notConnected': 'Gitea nie jest połączony',
  'session.giteaPrPicker.error.prNotFound': 'Nie znaleziono pull requesta',
  'session.giteaPrPicker.error.repoNotResolvable': 'Nie udało się rozpoznać repozytorium',
  'session.giteaPrPicker.error.repoMustBeGitea': 'remote origin musi być adresem URL Gitea',
  'session.giteaPrPicker.toast.loadMoreFailed': 'Nie udało się załadować kolejnych pull requestów',
  'session.giteaPrPicker.toast.loadDetailsFailed': 'Nie udało się załadować szczegółów pull requesta',
  'session.giteaPrPicker.title': 'Połącz pull request Gitea',
  'session.giteaPrPicker.description': 'Wybierz pull request, aby dołączyć kontekst recenzji do tej wiadomości.',
  'session.giteaPrPicker.searchPlaceholder': 'Szukaj po tytule lub wklej adres URL pull requesta',
  'session.giteaPrPicker.includeDiffAria': 'Dołącz diff PR do załączonego kontekstu',
  'session.giteaPrPicker.includeDiff': 'Dołącz diff PR',
  'session.giteaPrPicker.empty.noActiveProject': 'Nie wybrano aktywnego projektu.',
  'session.giteaPrPicker.empty.runtimeUnavailable': 'API środowiska Gitea jest niedostępne.',
  'session.giteaPrPicker.empty.notConnected': 'Gitea nie jest połączony. Połącz konto Gitea w ustawieniach.',
  'session.giteaPrPicker.empty.noPullRequestsFound': 'Nie znaleziono pull requestów',
  'session.giteaPrPicker.empty.noOpenPullRequestsFound': 'Nie znaleziono otwartych pull requestów',
  'session.giteaPrPicker.loading.pullRequests': 'Ładowanie pull requestów...',
  'session.giteaPrPicker.loading.more': 'Ładowanie...',
  'session.giteaPrPicker.actions.openSettings': 'Otwórz ustawienia',
  'session.giteaPrPicker.actions.usePullRequest': 'Użyj pull requesta #{number}',
  'session.giteaPrPicker.actions.openInGiteaAria': 'Otwórz w Gitea',
  'session.giteaPrPicker.actions.loadMore': 'Załaduj więcej',
  ...
  'session.gitlabMrPicker.actions.useMergeRequest': 'Użyj merge requesta !{number}',
  ...
  'session.gitlabMrPicker.empty.noMergeRequestsFound': 'Nie znaleziono merge requestów',
  'session.gitlabMrPicker.empty.noOpenMergeRequestsFound': 'Nie znaleziono otwartych merge requestów',
  ...
  'session.gitlabMrPicker.error.mrNotFound': 'Nie znaleziono merge requesta',
  ...
  'session.gitlabMrPicker.loading.mergeRequests': 'Ładowanie merge requestów...',
  'session.gitlabMrPicker.loading.more': 'Ładowanie...',
  'session.gitlabMrPicker.searchPlaceholder': 'Szukaj po tytule lub wklej adres URL merge requesta',
  'session.gitlabMrPicker.title': 'Połącz merge request GitLab',
  'session.gitlabMrPicker.toast.loadDetailsFailed': 'Nie udało się załadować szczegółów merge requesta',
  ...
  'session.newWorktree.actions.startFromGitLabIssueMr': 'Rozpocznij z GitLab zagadnienia/MR',
  ...
  'session.newWorktree.toast.sessionFromMr': 'Sesja utworzona z merge requesta',
  ...
  'session.newWorktree.usingMrBranch': 'Używana gałąź MR: {branch}',
