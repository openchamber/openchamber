...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.messageBody.footer.totalTime': 'Łączny czas',
  'chat.messageBody.footer.totalTimeAria': 'Łączny czas: {{value}}',
  'chat.messageBody.footer.tps': 'Tokenów na sekundę',
  'chat.messageBody.footer.tpsAria': 'Tokenów na sekundę: {{value}}',
  'chat.messageBody.footer.ttft': 'Czas do pierwszego tokena',
  'chat.messageBody.footer.ttftAria': 'Czas do pierwszego tokena: {{value}}',
  'chat.messageBody.footer.completedAt': 'Zakończono o',
  'chat.messageBody.footer.completedAtAria': 'Zakończono o: {{value}}',
