...
export const dict: Record<I18nKey, string> = {
  ...
  'desktopHostSwitcher.actions.removeServerAria': 'Usuń serwer',
  'desktopHostSwitcher.actions.removeServer': 'Usuń serwer',
  ...
  'server.sidebar.status.connectionError': 'Błąd połączenia',
  'server.sidebar.status.disconnected': 'Rozłączono',
  'server.sidebar.search.searchingServers': 'Przeszukiwanie {count} serwerów',
  'server.sidebar.localLabel': 'Lokalny',
  ...
  'desktopHostSwitcher.toast.sshDisconnected': 'Instancja SSH „{host}” rozłączona',
