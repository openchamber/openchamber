...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.message.speed.input': 'we {value}',
  'chat.message.speed.cacheRead': 'cache {value}',
  'chat.message.speed.cacheWrite': 'zapis cache {value}',
  'chat.message.speed.output': 'wy {value}',
  'chat.message.speed.reasoning': 'rozumowanie {value}',
  'chat.message.speed.aria': 'Szybkość wiadomości: {ttft} do pierwszego tokena, {throughput} tokenów na sekundę, {input} wejścia bez pamięci podręcznej, {cache} odczytu cache, {output} wyjścia',
