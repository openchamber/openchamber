...
export const dict: Record<I18nKey, string> = {
  ...
  'filesView.tree.actions.uploadTitle': 'Prześlij pliki',
  'filesView.tree.drop.uploadHint': 'Upuść pliki, aby je przesłać',
  'filesView.toast.uploadSuccess': 'Przesłano {count} plików',
  'filesView.toast.uploadSuccessSingle': 'Przesłano {name}',
  'filesView.toast.uploadFailed': 'Nie udało się przesłać {count} plików',
  'filesView.toast.uploadFailedSingle': 'Nie udało się przesłać {name}',
