...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.notifications.openAria': 'Powiadomienia',
  'layout.notifications.openTitle': 'Powiadomienia',
  'layout.notifications.title': 'Powiadomienia',
  'layout.notifications.empty': 'Nie ma jeszcze powiadomień',
  'layout.notifications.emptyFiltered': 'Nic nie pasuje do bieżących filtrów',
  'layout.notifications.markAllRead': 'Oznacz wszystkie jako przeczytane',
  'layout.notifications.clearAll': 'Wyczyść wszystko',
  'layout.notifications.remove': 'Usuń powiadomienie',
  'layout.notifications.sessionSubtaskFinished': 'Podzadanie zakończone',
  'layout.notifications.sessionSubtaskError': 'Błąd podzadania',
  'layout.notifications.openSettings': 'Ustawienia powiadomień',
  'layout.notifications.unreadCountAria': '{count} nieprzeczytanych powiadomień',
  'layout.notifications.sessionFinished': 'Sesja zakończona',
  'layout.notifications.sessionError': 'Błąd sesji',
  'layout.notifications.permissionNeeded': 'Potrzebne uprawnienie',
  'layout.notifications.permissionFallback': 'Agent czeka na twoją zgodę',
  'layout.notifications.inputNeeded': 'Potrzebna odpowiedź',
  'layout.notifications.questionFallback': 'Agent czeka na twoją odpowiedź',
  'layout.notifications.openSession': 'Otwórz sesję',
  'layout.notifications.occurrenceCount': '×{count}',
  'layout.notifications.time.justNow': 'Przed chwilą',
  'layout.notifications.time.minutesAgo': '{count} min',
  'layout.notifications.time.hoursAgo': '{count} godz.',
  'layout.notifications.time.daysAgo': '{count} d.',
  'toast.action.ok': 'OK',
  'toast.action.copy': 'Kopiuj',
