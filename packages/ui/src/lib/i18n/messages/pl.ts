...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.workStatus.telemetry.speed': 'Prędkość generowania',
  'chat.workStatus.telemetry.llmDuration': 'Czas LLM',
  'chat.workStatus.telemetry.toolDuration': 'Czas narzędzi',
  'chat.workStatus.telemetry.ttft': 'Czas do pierwszego tokena',
  'chat.workStatus.telemetry.steps': 'Kroki w turze',
  'chat.workStatus.telemetry.tokens': 'Tokeny',
  'chat.workStatus.telemetry.cacheHit': 'Wskaźnik trafień pamięci podręcznej',
  'chat.workStatus.telemetry.cost': 'Koszt tury',
