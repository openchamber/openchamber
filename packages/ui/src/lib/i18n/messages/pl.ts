...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.agentCapabilities.fusion.pickerLoadError': 'Nie udało się wczytać presetów fuzji.',
  'chat.agentCapabilities.fusion.pickerEmpty': 'Brak presetów fuzji. Utwórz jeden w Ustawienia → Fuzja.',
  'chat.agentCapabilities.fusion.keyboardHint': '↑↓ nawigacja • Enter wybierz • Esc zamknij',
  'chat.agentCapabilities.inline.waitingChildren': 'Czekanie na start sesji podrzędnych…',
