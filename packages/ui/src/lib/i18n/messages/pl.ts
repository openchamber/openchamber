...
export const dict: Record<I18nKey, string> = {
  ...
  'header.connection.status.connected': 'Połączono',
  'header.connection.status.connecting': 'Łączenie…',
  'header.connection.status.reconnecting': 'Ponowne łączenie…',
  'header.connection.actions.retry': 'Kliknij, aby ponowić próbę',
