...
export const dict: Record<I18nKey, string> = {
  ...
  'workspace.move.left': 'Przenieś w lewo',
  ...
  'workspace.zone.label.right': 'Prawa strefa',
  'workspace.zone.label.bottom': 'Dolna strefa',
  'workspace.zone.resize.left': 'Zmień rozmiar lewej strefy',
  'workspace.zone.resize.bottom': 'Zmień rozmiar dolnej strefy',
  'workspace.preset.title': 'Układ',
  'workspace.preset.default': 'Domyślny',
  'workspace.preset.developer': 'Programista',
  'workspace.preset.codeAgent': 'Kod + agent',
  'workspace.preset.reset': 'Przywróć domyślny układ',
} as const;
