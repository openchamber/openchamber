...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.dialogs.worktreeDelete.disposition.label': 'Powiązane sesje',
  'sessions.sidebar.dialogs.worktreeDelete.disposition.archive': 'Archiwizuj powiązane sesje',
  'sessions.sidebar.dialogs.worktreeDelete.disposition.delete': 'Trwale usuń powiązane sesje',
  'sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionOneLinked': 'To usuwa wybrane drzewo pracy i trwale usuwa {count} powiązaną sesję.',
  'sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionManyLinked': 'To usuwa wybrane drzewo pracy i trwale usuwa {count} powiązane sesje.',
