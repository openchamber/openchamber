...
export const dict: Record<I18nKey, string> = {
  ...
  'filesView.tree.filter.expandTooltip': 'Toggle filter options',
  'filesView.tree.filter.showHidden': 'Show hidden files',
  'filesView.tree.filter.hideHidden': 'Hide hidden files',
  'filesView.tree.filter.showGitignored': 'Include gitignored files',
  'filesView.tree.filter.hideGitignored': 'Exclude gitignored files',
  'filesView.tree.filter.searchFailed': 'File search failed',
  'filesView.tree.filter.extChipRemoveAria': 'Remove {ext} filter',
  'filesView.tree.filter.pathChipRemoveAria': 'Remove {path} path filter',
  'filesView.tree.filter.extAutocompleteLabel': 'Extensions',
  ...
  'sidebarFilesTree.filter.expandTooltip': 'Toggle filter options',
  'sidebarFilesTree.filter.showHidden': 'Show hidden files',
  'sidebarFilesTree.filter.hideHidden': 'Hide hidden files',
  'sidebarFilesTree.filter.showGitignored': 'Include gitignored files',
  'sidebarFilesTree.filter.hideGitignored': 'Exclude gitignored files',
  'sidebarFilesTree.filter.extChipRemoveAria': 'Remove {ext} filter',
  'sidebarFilesTree.filter.pathChipRemoveAria': 'Remove {path} path filter',
  'sidebarFilesTree.filter.extAutocompleteLabel': 'Extensions',
  ...
  'sidebarFilesTree.toast.searchFailed': 'File search failed',
