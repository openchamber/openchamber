...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.commandAutocomplete.command.sideDescription': 'Otwórz tymczasowy czat boczny. Zostanie usunięty po zamknięciu, chyba że go zachowasz.',
  'chat.commandAutocomplete.command.btwDescription': 'Alias /side. Otwiera tymczasowy czat obok tej rozmowy.',
  ...
  'sideChat.label': 'Tymczasowy',
  'sideChat.promote': 'Zachowaj',
  'sideChat.promotion.error': 'Nie udało się zachować czatu bocznego',
  'sideChat.cleanup.error': 'Nie udało się usunąć czatu bocznego',
  'sideChat.discard.title': 'Odrzucić ten czat boczny?',
  'sideChat.discard.description': 'Aktywna praca zostanie zatrzymana, a ta rozmowa trwale usunięta.',
  'sideChat.discard.sideEffects': 'Zmiany plików, polecenia i inne skutki działania narzędzi pozostaną.',
  'sideChat.discard.cancel': 'Zachowaj czat',
  'sideChat.discard.confirm': 'Zatrzymaj i usuń',
  'sideChat.recovery.title': 'Odzyskać czat boczny?',
  'sideChat.recovery.description': 'OpenChamber znalazł tymczasowy czat boczny pozostały po przerwanym czyszczeniu.',
  'sideChat.recovery.sessionLabel': 'Czat boczny {sessionID}',
  'sideChat.recovery.recover': 'Odzyskaj',
  'sideChat.recovery.delete': 'Usuń',
