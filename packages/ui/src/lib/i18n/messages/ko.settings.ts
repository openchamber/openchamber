...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.projects.codexImport.action': 'Codex 대화 가져오기',
  'settings.projects.codexImport.title': 'Codex에서 가져오기',
  'settings.projects.codexImport.description': 'Codex 프로젝트를 추가하고 각 대화를 읽을 수 있는 OpenCode 기록으로 저장합니다. Codex 원본 데이터는 변경되지 않습니다.',
  'settings.projects.codexImport.loading': 'Codex 프로젝트와 대화를 읽는 중...',
  'settings.projects.codexImport.error.inspect': 'Codex 데이터를 읽지 못했습니다.',
  'settings.projects.codexImport.error.apply': 'Codex 데이터를 가져오지 못했습니다.',
  'settings.projects.codexImport.config.model': '모델: {model}',
  'settings.projects.codexImport.config.provider': '제공자: {provider}',
  'settings.projects.codexImport.config.unset': '설정 안 됨',
  'settings.projects.codexImport.projects.title': '가져올 프로젝트',
  'settings.projects.codexImport.projects.conversations': '대화 수: {count}',
  'settings.projects.codexImport.projects.missing': '디렉터리를 더 이상 사용할 수 없음',
  'settings.projects.codexImport.empty': 'Codex 프로젝트 또는 대화를 찾지 못했습니다.',
  'settings.projects.codexImport.actions.retry': '다시 시도',
  'settings.projects.codexImport.actions.selectAll': '모두 선택',
  'settings.projects.codexImport.actions.selectNone': '모두 선택 해제',
  'settings.projects.codexImport.actions.importing': '가져오는 중...',
  'settings.projects.codexImport.result.summary': '가져옴 {imported}개, 건너뜀 {skipped}개, 실패 {failed}개.',
  'settings.projects.codexImport.toast.partial': 'Codex 가져오기 완료: {imported}개 가져옴, {skipped}개 건너뜀, {failed}개 실패.',
  'settings.projects.codexImport.toast.complete': 'Codex 가져오기 완료: {imported}개 가져옴, {skipped}개는 이미 존재함.',
