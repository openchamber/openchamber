...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.notifications.page.sounds.packLabel': '사운드 팩',
  'settings.notifications.page.sounds.packBipBop': 'Bip Bop',
  'settings.notifications.page.sounds.packAlert': '알림',
  ...
  'settings.notifications.page.sounds.focusOnlyHint': '켜짐: 모든 소리가 창이 포커스되지 않았을 때만 재생됩니다. 꺼짐: 완료·오류·하위 작업 소리는 포커스 중에도 재생됩니다.',
