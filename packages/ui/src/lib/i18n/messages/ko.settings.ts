...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.worktrees.list.archiveWorktreeAria': 'worktree {name} 보관',
  'settings.openchamber.worktrees.list.archiveSuccess': 'worktree 보관됨',
  'settings.openchamber.worktrees.list.archiveFailed': 'worktree 보관 실패',
  'settings.openchamber.worktrees.list.archivePartial': 'worktree 보관됨, 그러나 {fail}/{total} 세션 보관 실패',
  'settings.openchamber.worktrees.archived.title': '보관된 worktree',
  'settings.openchamber.worktrees.archived.restoreWorktreeAria': 'worktree {name} 복원',
  'settings.openchamber.worktrees.archived.restoreSuccess': 'worktree 복원됨',
  'settings.openchamber.worktrees.archived.restoreFailed': 'worktree 복원 실패',
  'settings.openchamber.worktrees.archived.restorePartial': 'worktree 복원됨, 그러나 {fail}/{total} 세션 복원 실패',
