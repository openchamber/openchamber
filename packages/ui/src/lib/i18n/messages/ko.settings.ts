...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.agents.sidebar.error.title': '에이전트를 불러올 수 없습니다',
  'settings.agents.sidebar.error.description': 'OpenCode 백엔드를 사용할 수 없습니다. 연결을 확인한 후 다시 시도하세요.',
  'settings.agents.sidebar.error.retry': '다시 시도',
