export const settingsDict = {
  ...
  'settings.page.harness.title': '하네스',
  'settings.page.harness.description': '실행 하네스를 선택하고 관리합니다.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.harness.sidebar.title': '하네스',
  'settings.harness.sidebar.subtitle': '채팅 세션용 실행 백엔드',
  'settings.harness.sidebar.harness.opencode': 'OpenCode',
  'settings.harness.sidebar.harness.claudeCode': 'Claude Code',
  'settings.harness.sidebar.status.ready': '준비됨',
  'settings.harness.sidebar.status.needsLogin': '로그인 필요',
  'settings.harness.sidebar.status.missingCli': 'CLI 없음',
  'settings.harness.sidebar.status.unsupportedHost': '이 호스트에서 사용 불가',
  'settings.harness.sidebar.status.error': '오류',
  'settings.harness.sidebar.status.unknown': '알 수 없음',
  'settings.harness.sidebar.status.loading': '확인 중…',
  'settings.harness.page.empty.selectHarness': '사이드바에서 하네스를 선택하세요',
  'settings.harness.page.loadError': '하네스 상태를 불러올 수 없습니다',
  'settings.harness.opencode.title': 'OpenCode',
  'settings.harness.opencode.description': '기본 하네스입니다. OpenCode 프로바이더와 에이전트를 사용합니다.',
  'settings.harness.opencode.section.about': '정보',
  'settings.harness.opencode.about.body': 'OpenCode는 구성된 프로바이더를 통해 모델을 실행합니다. API 키는 프로바이더에서, 에이전트 설정은 에이전트에서 관리하세요.',
  'settings.harness.opencode.link.providers': '프로바이더 열기',
  'settings.harness.opencode.link.agents': '에이전트 열기',
  'settings.harness.claudeCode.title': 'Claude Code',
  'settings.harness.claudeCode.description': '구독 사용량 한도를 사용하는 네이티브 Claude Code CLI입니다.',
  'settings.harness.claudeCode.section.status': '상태',
  'settings.harness.claudeCode.field.status': '상태',
  'settings.harness.claudeCode.field.version': '버전',
  'settings.harness.claudeCode.status.version': '{version}',
  'settings.harness.claudeCode.status.versionUnknown': '알 수 없음',
  'settings.harness.claudeCode.actions.redetect': '다시 감지',
  'settings.harness.claudeCode.actions.redetectAria': 'Claude Code 상태 다시 감지',
  'settings.harness.claudeCode.actions.openDocs': '문서 열기',
  'settings.harness.claudeCode.actions.openDocsAria': 'Claude Code 문서 열기',
  'settings.harness.claudeCode.login.title': 'Claude로 로그인',
  'settings.harness.claudeCode.login.body': '이 호스트에 Claude CLI를 설치하고 claude login을 실행하면 OpenChamber가 Claude 구독을 사용할 수 있습니다.',
  'settings.harness.claudeCode.section.capabilities': '기능',
  'settings.harness.claudeCode.capabilities.empty': '감지에 성공하면 기능 목록이 표시됩니다.',
  'settings.harness.claudeCode.capability.full': '완전 지원',
  'settings.harness.claudeCode.capability.partial': '부분 지원',
  'settings.harness.claudeCode.capability.none': '사용 불가',
...
'settings.harness.claudeCode.warnHandoff.label': '하네스 전환 시 확인',
'settings.harness.claudeCode.warnHandoff.aria': '하네스 전환 시 확인',
'settings.harness.claudeCode.warnHandoff.info': '하네스 전환 시 새 세션을 시작하기 전에 대화 상자를 표시합니다. 끄면 다음 메시지에서 자동으로 전환됩니다.',
  'settings.harness.claudeCode.section.import': '가져오기',
  'settings.harness.claudeCode.import.note': '로컬 Claude Code 프로젝트와 채팅을 OpenChamber로 가져옵니다. 채팅은 Claude Code에서 이어지며, 대화 기록은 OpenCode 히스토리로 복사되지 않습니다.',
  'settings.harness.claudeCode.import.actions.open': 'Claude Code에서 가져오기',
  'settings.harness.claudeCode.import.actions.openAria': 'Claude Code 가져오기 대화 상자 열기',
  'settings.harness.claudeCode.import.dialog.title': 'Claude Code에서 가져오기',
  'settings.harness.claudeCode.import.dialog.description': '이 호스트의 Claude Code 프로젝트 폴더에 저장된 채팅을 선택하세요. 이미 가져온 채팅은 건너뜁니다.',
  'settings.harness.claudeCode.import.dialog.loading': 'Claude Code 프로젝트를 검색하는 중…',
  'settings.harness.claudeCode.import.dialog.empty': '이 호스트에서 Claude Code 채팅을 찾지 못했습니다.',
  'settings.harness.claudeCode.import.dialog.selectAll': '모두 선택',
  'settings.harness.claudeCode.import.dialog.selectAllAria': '가져올 수 있는 Claude Code 채팅 모두 선택',
  'settings.harness.claudeCode.import.dialog.selectedCount': '{count}개 선택됨',
  'settings.harness.claudeCode.import.dialog.projectAria': '{name}의 모든 채팅 선택',
  'settings.harness.claudeCode.import.dialog.sessionAria': '채팅 {title} 선택',
  'settings.harness.claudeCode.import.dialog.sessionCount': '채팅 {count}개',
  'settings.harness.claudeCode.import.dialog.directoryMissing': '폴더 없음',
  'settings.harness.claudeCode.import.dialog.alreadyImported': '이미 가져옴',
  'settings.harness.claudeCode.import.dialog.untitled': '제목 없는 채팅',
  'settings.harness.claudeCode.import.dialog.cancel': '취소',
  'settings.harness.claudeCode.import.dialog.import': '가져오기 ({count})',
  'settings.harness.claudeCode.import.dialog.importing': '가져오는 중…',
  'settings.harness.claudeCode.import.error.load': 'Claude Code 프로젝트를 검색할 수 없습니다.',
  'settings.harness.claudeCode.import.error.import': '가져오기에 실패했습니다.',
  'settings.harness.claudeCode.import.toast.success': 'Claude Code 채팅 {count}개를 가져왔습니다.',
  'settings.harness.claudeCode.import.toast.skippedOnly': '이미 가져온 채팅 {count}개를 건너뛰었습니다.',
  'settings.harness.claudeCode.import.toast.partialFail': '{imported}개 가져옴, {failed}개 실패.',
  'settings.harness.claudeCode.import.toast.none': '가져온 항목이 없습니다.',
  'settings.harness.claudeCode.section.apiKeys': 'API 키',
  'settings.harness.claudeCode.apiKeys.note': 'Anthropic API 키는 OpenCode의 프로바이더에 그대로 둡니다. Claude Code는 호스트의 Claude 구독 로그인을 사용합니다.',
  'settings.harness.capability.prompt': '프롬프트',
  'settings.harness.capability.abort': '중단',
  'settings.harness.capability.resume': '재개',
  'settings.harness.capability.streaming-text': '텍스트 스트리밍',
  'settings.harness.capability.streaming-tools': '도구 스트리밍',
  'settings.harness.capability.permissions': '권한',
  'settings.harness.capability.images': '이미지',
  'settings.harness.capability.file-attachments': '파일 첨부',
  'settings.harness.capability.shell': '셸',
  'settings.harness.capability.slash-commands': '슬래시 명령',
  'settings.harness.capability.mcp': 'MCP',
  'settings.harness.capability.subagents': '서브에이전트',
  'settings.harness.capability.multirun': 'MultiRun',
  'settings.harness.capability.goal': 'Goal 모드',
  'settings.harness.capability.openchamber-tool': 'OpenChamber 도구',
