export const settingsDict = {
  ...
  'settings.openchamber.tunnel.readOnly.title': '읽기 전용 터널 상태',
  'settings.openchamber.tunnel.readOnly.description': '터널 관리는 호스트 데스크톱 또는 인증된 브라우저 세션에서 사용할 수 있습니다.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.remoteInstances.clientAuth.state.viaManagedDirectE2ee': '관리형 다이렉트 E2EE',
  'settings.remoteInstances.clientAuth.state.connectedManagedDirectE2ee': '연결됨 · 관리형 다이렉트 E2EE',
  'settings.remoteInstances.clientAuth.addDevice.transport.managedE2ee': '관리형 다이렉트 E2EE',
  'settings.remoteInstances.clientAuth.addDevice.transport.managedE2eeHint': '이 서버에서 관리하는 종단 간 암호화 터널입니다. 호스트 데스크톱 또는 인증된 브라우저 세션에서 관리하세요.',
  ...
  'settings.openchamber.tunnel.field.directE2eeLabel': '네이티브 앱 종단 간 암호화',
  'settings.openchamber.tunnel.field.directE2eeDescription': 'Cloudflare를 통과하는 트래픽은 네이티브 앱과 이 OpenChamber 호스트 간에 암호화됩니다.',
  'settings.openchamber.tunnel.field.directE2eeUnsupported': '직접 E2EE를 지원하는 클라이언트 버전이 필요합니다.',
  'settings.openchamber.tunnel.field.nativePairingLabel': '네이티브 앱 페어링',
  'settings.openchamber.tunnel.field.nativePairingDescription': '종단 간 암호화를 사용하여 네이티브 모바일 또는 데스크톱 앱을 페어링합니다.',
  'settings.openchamber.tunnel.actions.openAddDevice': '기기 추가',
  'settings.openchamber.tunnel.field.browserAccessLabel': '브라우저 액세스',
  'settings.openchamber.tunnel.field.browserQrAlt': '브라우저 액세스 QR 코드',
  'settings.openchamber.tunnel.note.scanQrToConnectBrowser': '모바일 브라우저로 이 QR 코드를 스캔하여 연결하세요.',
  'settings.openchamber.tunnel.toast.directE2eeSaved': '직접 E2EE 설정이 저장되었습니다',
  'settings.openchamber.tunnel.toast.directE2eeSaveFailed': '직접 E2EE 설정을 저장하지 못했습니다',
  'settings.remoteInstances.transport.managedE2ee.label': '관리형 터널 (E2EE)',
  'settings.remoteInstances.transport.managedE2ee.description': '관리형 Cloudflare 터널을 통해 안전하게 연결합니다.',
  'settings.remoteInstances.transport.managedE2ee.note': '이 연결은 관리형 터널을 통해 종단 간 암호화를 사용합니다.',
} as const;
