...
export const settingsDict = {
  ...
  'settings.magicPrompts.sidebar.item.gitlabPrReview': 'MR 리뷰',
  'settings.magicPrompts.sidebar.item.gitlabIssueReview': '이슈 리뷰',
  'settings.magicPrompts.sidebar.item.giteaPrReview': 'PR 리뷰',
  'settings.magicPrompts.sidebar.item.giteaIssueReview': '이슈 리뷰',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.gitea.page.title': 'Gitea / Forgejo 개인 액세스 토큰',
  'settings.gitea.page.description': '연결하려면 Gitea 또는 Forgejo 개인 액세스 토큰을 붙여넣으세요. 자체 호스팅 Gitea 또는 Forgejo 인스턴스를 사용하는 경우 기본 URL을 설정하세요.',
  'settings.gitea.page.tooltip.connectAccount': '앱 내 이슈 및 PR 워크플로에 Gitea 또는 Forgejo 계정을 연결합니다.',
  'settings.gitea.page.accessToken.label': '개인 액세스 토큰',
  'settings.gitea.page.accessToken.placeholder': 'Gitea 개인 액세스 토큰을 붙여넣으세요',
  'settings.gitea.page.baseUrl.label': '기본 URL(선택 사항)',
  'settings.gitea.page.baseUrl.placeholder': 'https://gitea.example.com',
  'settings.gitea.page.actions.connect': 'Gitea 연결',
  'settings.gitea.page.actions.disconnect': '연결 해제',
  'settings.gitea.page.actions.switch': '전환',
  'settings.gitea.page.status.notConnected': '연결되지 않음',
  'settings.gitea.page.label.unknownUser': '알 수 없음',
  'settings.gitea.page.label.otherAccounts': '기타 계정',
  'settings.gitea.page.avatarAlt.withLogin': '{login} 아바타',
  'settings.gitea.page.avatarAlt.fallback': 'Gitea 아바타',
  'settings.gitea.page.connectedAs': '연결된 계정:',
  'settings.gitea.page.errors.invalidToken': '유효한 Gitea 개인 액세스 토큰을 입력하세요',
  'settings.gitea.page.errors.failed': 'Gitea에 연결하지 못했습니다',
  'settings.gitea.page.toast.connected': 'Gitea에 연결되었습니다',
  'settings.gitea.page.toast.disconnected': 'Gitea 연결이 해제되었습니다',
  ...
  'settings.magicPrompts.page.group.gitlabPrReview.title': 'MR 리뷰',
  'settings.magicPrompts.page.group.gitlabPrReview.description': 'GitLab MR 리뷰 flow에 사용하는 프롬프트입니다: 표시 사용자 메시지 + 숨겨진 지침 payload.',
  'settings.magicPrompts.page.group.gitlabIssueReview.title': '이슈 리뷰',
  'settings.magicPrompts.page.group.gitlabIssueReview.description': 'GitLab issue 리뷰 flow에 사용하는 프롬프트입니다: 표시 사용자 메시지 + 숨겨진 지침 payload.',
  'settings.magicPrompts.page.group.giteaPrReview.title': 'PR 리뷰',
  'settings.magicPrompts.page.group.giteaPrReview.description': 'Gitea PR 리뷰 flow에 사용하는 프롬프트입니다: 표시 사용자 메시지 + 숨겨진 지침 payload.',
  'settings.magicPrompts.page.group.giteaIssueReview.title': '이슈 리뷰',
  'settings.magicPrompts.page.group.giteaIssueReview.description': 'Gitea issue 리뷰 flow에 사용하는 프롬프트입니다: 표시 사용자 메시지 + 숨겨진 지침 payload.',
