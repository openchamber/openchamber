...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.visual.field.contextPanelDock': '컨텍스트 패널 위치',
  'settings.openchamber.visual.field.contextPanelDockAria': '컨텍스트 패널 위치',
  'settings.openchamber.visual.field.contextPanelDockHint': '터미널만이 아니라 컨텍스트 패널 전체가 이동합니다. 터미널, 변경 사항, 차이, 파일, 메모 등 모든 화면이 채팅 열의 선택한 가장자리에 고정됩니다.',
  'settings.openchamber.visual.option.contextPanelDock.right': '오른쪽',
  'settings.openchamber.visual.option.contextPanelDock.bottom': '아래쪽',
