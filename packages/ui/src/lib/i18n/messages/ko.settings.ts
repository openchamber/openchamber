...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.providers.copilotGhe.clientIdPlaceholder': '기본값을 사용하려면 비워 두세요',
  'settings.providers.copilotGhe.clientIdHint': 'Client ID를 비워 두면 OpenChamber 기본값({clientId})을 사용합니다.',
  'settings.providers.copilotGhe.status.authorizationPending': '인증이 아직 대기 중입니다. 브라우저에서 디바이스 플로우를 완료한 다음 다시 완료를 누르세요.',
  'settings.providers.copilotGhe.status.slowDown': 'GitHub Enterprise Server에서 폴링 속도를 줄이도록 요청했습니다. 잠시 기다린 후 다시 완료를 누르세요.',
  'settings.providers.copilotGhe.toast.serverUrlRequired': '서버 URL은 필수입니다',
  'settings.providers.copilotGhe.toast.startFirst': '먼저 디바이스 플로우를 시작하세요',
  'settings.providers.copilotGhe.toast.startFailed': 'GitHub Enterprise Server 인증 플로우를 시작하지 못했습니다',
  'settings.providers.copilotGhe.toast.completeFailed': 'GitHub Enterprise Server 인증 플로우를 완료하지 못했습니다',
  'settings.providers.copilotGhe.toast.authorizationPending': '인증이 아직 대기 중입니다',
  'settings.providers.copilotGhe.toast.slowDown': 'GitHub Enterprise Server에서 속도 조절을 요청했습니다',
  'settings.providers.copilotGhe.toast.connected': 'GitHub Enterprise Server에 연결되었습니다',
