...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.engines.claudeCode.section.agents': '에이전트',
  'settings.engines.claudeCode.agentsMode.label': '사용할 에이전트',
  'settings.engines.claudeCode.agentsMode.aria': 'Claude Code 세션에 Claude 또는 OpenCode 에이전트 선택',
  'settings.engines.claudeCode.agentsMode.info': 'Claude는 Claude Code 네이티브 시스템 프롬프트와 권한을 사용합니다. OpenCode는 Claude 세션에서 OpenChamber 에이전트의 권한과 시스템 프롬프트를 사용합니다.',
  ...
  'settings.engines.claudeCode.section.import': '가져오기',
  'settings.engines.claudeCode.import.note': '로컬 Claude Code 프로젝트와 채팅을 OpenChamber로 가져옵니다. 채팅은 Claude Code에서 이어지며, 대화 기록은 OpenCode 히스토리로 복사되지 않습니다.',
  'settings.engines.claudeCode.import.actions.open': 'Claude Code에서 가져오기',
  'settings.engines.claudeCode.import.actions.openAria': 'Claude Code 가져오기 대화 상자 열기',
  'settings.engines.claudeCode.import.dialog.title': 'Claude Code에서 가져오기',
  'settings.engines.claudeCode.import.dialog.description': '이 호스트의 Claude Code 프로젝트 폴더에 저장된 채팅을 선택하세요. 이미 가져온 채팅은 건너뜁니다.',
  'settings.engines.claudeCode.import.dialog.loading': 'Claude Code 프로젝트를 검색하는 중…',
  'settings.engines.claudeCode.import.dialog.empty': '이 호스트에서 Claude Code 채팅을 찾지 못했습니다.',
  'settings.engines.claudeCode.import.dialog.selectAll': '모두 선택',
  'settings.engines.claudeCode.import.dialog.selectAllAria': '가져올 수 있는 Claude Code 채팅 모두 선택',
  'settings.engines.claudeCode.import.dialog.selectedCount': '{count}개 선택됨',
  'settings.engines.claudeCode.import.dialog.projectAria': '{name}의 모든 채팅 선택',
  'settings.engines.claudeCode.import.dialog.sessionAria': '채팅 {title} 선택',
  'settings.engines.claudeCode.import.dialog.sessionCount': '채팅 {count}개',
  'settings.engines.claudeCode.import.dialog.directoryMissing': '폴더 없음',
  'settings.engines.claudeCode.import.dialog.alreadyImported': '이미 가져옴',
  'settings.engines.claudeCode.import.dialog.untitled': '제목 없는 채팅',
  'settings.engines.claudeCode.import.dialog.cancel': '취소',
  'settings.engines.claudeCode.import.dialog.import': '가져오기 ({count})',
  'settings.engines.claudeCode.import.dialog.importing': '가져오는 중…',
  'settings.engines.claudeCode.import.error.load': 'Claude Code 프로젝트를 검색할 수 없습니다.',
  'settings.engines.claudeCode.import.error.import': '가져오기에 실패했습니다.',
  'settings.engines.claudeCode.import.toast.success': 'Claude Code 채팅 {count}개를 가져왔습니다.',
  'settings.engines.claudeCode.import.toast.skippedOnly': '이미 가져온 채팅 {count}개를 건너뛰었습니다.',
  'settings.engines.claudeCode.import.toast.partialFail': '{imported}개 가져옴, {failed}개 실패.',
  'settings.engines.claudeCode.import.toast.none': '가져온 항목이 없습니다.',
