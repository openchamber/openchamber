...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.remoteInstances.clientAuth.relayEndpoint.title': 'Relay 서버',
  'settings.remoteInstances.clientAuth.relayEndpoint.info': '"어디서나" 페어링 링크와 Relay 접속에 사용되는 엔드포인트입니다. 셀프 호스팅 Relay를 지정하면 해당 트래픽을 자신의 인프라로 유지할 수 있습니다. 실행 중인 Relay 호스트는 즉시 다시 연결됩니다. 이전에 발급된 페어링 링크는 기존 엔드포인트를 유지합니다.',
  'settings.remoteInstances.clientAuth.relayEndpoint.option.default': '기본값',
  'settings.remoteInstances.clientAuth.relayEndpoint.option.custom': '사용자 지정',
  'settings.remoteInstances.clientAuth.relayEndpoint.field.placeholder': 'wss://your-relay.example/ws',
  'settings.remoteInstances.clientAuth.relayEndpoint.actions.save': '저장',
  'settings.remoteInstances.clientAuth.relayEndpoint.locked': '환경 변수 OPENCHAMBER_RELAY_URL로 고정됨:',
