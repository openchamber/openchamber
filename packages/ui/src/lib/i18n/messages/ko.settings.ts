...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.worktrees.start.label': '시작 명령',
  'settings.openchamber.worktrees.start.commandPlaceholder': '예: ./scripts/run.sh',
  'settings.openchamber.worktrees.start.addCommand': '명령 추가',
  'settings.openchamber.worktrees.start.removeCommandAria': '명령 제거',
  'settings.openchamber.worktrees.start.toast.saveFailed': '시작 명령 저장에 실패했습니다',
  'settings.openchamber.worktrees.shutdown.label': '종료 명령',
  'settings.openchamber.worktrees.shutdown.commandPlaceholder': '예: ./scripts/stop.sh',
  'settings.openchamber.worktrees.shutdown.addCommand': '명령 추가',
  'settings.openchamber.worktrees.shutdown.removeCommandAria': '명령 제거',
  'settings.openchamber.worktrees.shutdown.toast.saveFailed': '종료 명령 저장에 실패했습니다',
  'settings.openchamber.worktrees.commands.runStartAria': '{name} 시작 명령 실행',
  'settings.openchamber.worktrees.commands.runShutdownAria': '{name} 종료 명령 실행',
  'settings.openchamber.worktrees.commands.viewSetupLogAria': '{name} 셋업 출력 보기',
  'settings.openchamber.worktrees.commands.noCommands': '이 프로젝트에는 {kind}이(가) 설정되어 있지 않습니다.',
  'settings.openchamber.worktrees.commands.dialogTitleStart': '시작 명령 — {name}',
  'settings.openchamber.worktrees.commands.dialogTitleShutdown': '종료 명령 — {name}',
  'settings.openchamber.worktrees.commands.dialogTitleSetup': '셋업 출력 — {name}',
  'settings.openchamber.worktrees.commands.dialogRunning': '실행 중...',
  'settings.openchamber.worktrees.commands.dialogFailed': '명령이 실패했습니다',
  'settings.openchamber.worktrees.commands.dialogTimedOut': '명령이 시간 제한을 초과했습니다. 지금까지의 출력을 표시합니다.',
  'settings.openchamber.worktrees.commands.dialogEmptyOutput': '출력이 없습니다.',
  'settings.openchamber.worktrees.commands.dialogClose': '닫기',
