...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'ollama.com의 세션 쿠키를 붙여넣으세요(브라우저 개발자 도구에서 __Secure-session=...을 찾으세요). 이는 로컬 Ollama API 키나 엔드포인트가 아닙니다. OpenChamber는 브라우저 쿠키 저장소를 검색하지 않습니다.',
