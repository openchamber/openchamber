...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.scrollBehavior.title': '스크롤 위치',
  'settings.openchamber.scrollBehavior.description': '세션으로 다시 전환할 때 열리는 위치를 선택하세요. 기본값은 이전 위치를 복원하는 것입니다.',
  'settings.openchamber.scrollBehavior.option.restore.label': '이전 위치 복원',
  'settings.openchamber.scrollBehavior.option.jumpToEnd.label': '항상 끝으로 이동',
  'settings.openchamber.scrollBehavior.sectionAria': '전환 시 세션 스크롤 동작',
  'settings.openchamber.scrollBehavior.field.modeAria': '스크롤 동작: {option}',
