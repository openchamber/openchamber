...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.visual.field.worktreeDiscovery': 'Git worktree 자동 검색',
  'settings.openchamber.visual.field.worktreeDiscoveryAria': 'Git worktree 자동 검색 전환',
  'settings.openchamber.visual.field.worktreeDiscoveryInfo': '켜면 사이드바가 현재 프로젝트와 활성 세션이 있는 프로젝트의 Git worktree를 검색합니다.',
  'settings.openchamber.visual.field.worktreeDiscoveryInterval': 'Worktree 검색 새로고침 간격',
  'settings.openchamber.visual.field.worktreeDiscoveryIntervalAria': 'Worktree 검색 새로고침 간격 선택',
  'settings.openchamber.visual.field.worktreeDiscoveryIntervalInfo': '자동 검색 실행 사이의 최소 시간입니다.',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.0': '즉시',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.30000': '30초',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.60000': '1분',
  'settings.openchamber.visual.option.worktreeDiscoveryInterval.300000': '5분',
  'settings.openchamber.visual.field.backgroundProjectSessionLoading': '모든 프로젝트의 세션을 백그라운드에서 로드',
  'settings.openchamber.visual.field.backgroundProjectSessionLoadingAria': '모든 프로젝트의 백그라운드 세션 로드 전환',
  'settings.openchamber.visual.field.backgroundProjectSessionLoadingInfo': '켜면 사이드바의 모든 프로젝트에서 세션 데이터를 로드합니다.',
