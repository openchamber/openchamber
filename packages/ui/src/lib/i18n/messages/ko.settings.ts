export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': '대시보드 URL에서 워크스페이스 ID를, 브라우저 개발자 도구에서 auth 쿠키를 복사하세요. Sharpie는 브라우저 쿠키 저장소를 검색하지 않습니다.',
  ...
  'settings.window.description': 'Sharpie 설정 창입니다.',
  ...
  'settings.page.appearance.description': 'Sharpie의 모양과 느낌을 맞춤 설정하세요.',
  ...
  'settings.remoteInstances.direct.title': '다른 Sharpie 서버',
  'settings.remoteInstances.direct.description': '이 앱이 전환할 수 있는 서버입니다. 다른 서버의 페어링 링크를 가져오거나 주소로 추가하세요.',
  'settings.remoteInstances.direct.addDialog.description': 'URL로 다른 Sharpie 서버를 추가합니다. 서버가 이미 실행 중이고 연결 토큰이 있을 때 사용하세요.',
  ...
  'settings.remoteInstances.direct.import.description': '다른 Sharpie 서버에서 만든 연결 링크를 붙여넣으세요.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': '잘못된 Sharpie 연결 링크입니다.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Sharpie Desktop이 이 서버에 연결할 수 있도록 안전한 링크나 토큰을 만듭니다.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': '다른 기기의 Sharpie 앱으로 스캔하세요. 일회용이며 만료됩니다.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': '집과 밖 어디서나 작동합니다. 밖에서는 종단간 암호화 터널인 Sharpie Private Relay를 통해 연결됩니다. 설정이 필요 없습니다.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': '다른 기기의 Sharpie 앱으로 이 QR 코드를 스캔하세요.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Sharpie가 서버를 대신 시작할지, 이미 실행 중인 서버에 연결할지 선택하세요.',
  ...
  'settings.remoteInstances.page.field.keepServerRunningHint': '연결을 끊은 뒤에도 원격 컴퓨터에서 Sharpie를 계속 실행합니다.',
  ...
  'settings.openchamber.about.title': 'Sharpie 정보',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Git 저장소를 새 카탈로그 소스로 추가합니다. Sharpie는 다음을 포함하는 폴더를 스캔합니다:',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '로그인 시 Sharpie 시작',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '로그인 시 Sharpie 시작',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '창을 열지 않고 백그라운드에서 앱을 시작합니다. 데스크톱 상태 아이콘으로 열 수 있습니다.',
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'macOS 메뉴 막대에 Sharpie 표시',
  'settings.openchamber.desktopNetwork.field.macMenuBar': '메뉴 막대에 Sharpie 표시',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': '앱을 다시 시작해야 합니다. 끄면 Sharpie가 메뉴 막대 항목을 만들지 않으며 세션, 승인 및 사용량 업데이트도 실행하지 않습니다.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Sharpie를 시스템 트레이로 최소화하거나 닫기',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '시스템 트레이로 최소화하고 닫기',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '메인 창을 최소화하거나 닫아도 Sharpie가 시스템 트레이에서 계속 실행됩니다.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Sharpie가 실행되는 동안 컴퓨터 절전 방지',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Sharpie가 실행되는 동안 컴퓨터 절전 방지',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Sharpie는 다시 시작 후 비밀번호를 요청하고, 이후 로그인 세션이 만료되면 다시 요청합니다. 기본 12시간, 이 디바이스 신뢰 선택 시 7일입니다. 로그인을 끄려면 비워 두세요.',
  ...
  'settings.remoteInstances.page.description': 'SSH로 다른 컴퓨터에 연결하고 그곳에서 Sharpie를 엽니다.',
  ...
  'settings.remoteInstances.page.section.remoteServer': '원격 컴퓨터의 Sharpie',
  'settings.remoteInstances.page.section.remoteServerDescription': 'SSH 연결 후 Sharpie를 어떻게 실행할지 선택하세요.',
  'settings.remoteInstances.page.section.mainTunnel': '로컬 접근',
  'settings.remoteInstances.page.section.mainTunnelDescription': '이 원격 Sharpie 서버를 열 때 사용할 로컬 주소를 선택하세요.',
  'settings.remoteInstances.page.section.authentication': '인증',
  'settings.remoteInstances.page.section.authenticationDescription': 'SSH와 원격 Sharpie UI를 위한 인증 정보입니다.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': '이 앱이 대신 시작할 때 Sharpie를 원격 컴퓨터에 배치하는 방법입니다.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Sharpie 설치 중',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Sharpie 업데이트 중',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Sharpie가 아니라 OpenCode 인증에 저장됩니다. 환경 변수에서 읽으려면 {env:VAR_NAME}을 사용하세요.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': '키는 OpenCode로 직접 전송되며 Sharpie에 저장되지 않습니다.',
  ...
  'settings.github.page.flow.title': 'Sharpie 권한 부여',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Sharpie 인증이 제거된 경우 대체로 사용 가능',
  ...
  'settings.notifications.page.testNotification.body': 'Sharpie의 테스트 알림입니다.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'Sharpie 서버에서 로컬로 변환합니다. 모델은 자동으로 다운로드되며 API 키가 필요 없습니다.',
  'settings.voice.page.tooltip.localTts': 'Sharpie 서버에서 로컬로 음성을 합성합니다(Kokoro, 영어). 모델은 자동으로 다운로드되며 API 키가 필요 없습니다.',
