export const settingsDict = {
  ...
  'settings.page.vision.title': '비전',
  'settings.page.vision.description': '이미지를 볼 수 없는 모델이 설정된 비전 모델을 통해 이미지를 설명할 수 있게 합니다.',
  'settings.vision.section.title': '비전 도구',
  'settings.vision.section.info': '현재 모델이 이미지를 볼 수 없을 때 에이전트는 이미지 파일을 읽고 설정된 비전 모델에 설명을 요청하는 비전 도구를 호출할 수 있습니다(내용, 레이아웃, 스타일, 표시된 텍스트). 설명은 모델로 돌아가 이미지를 보지 않고도 추론할 수 있습니다. 각 호출은 여기서 선택한 비전 모델로 과금됩니다.',
  'settings.vision.model.label': '비전 모델',
  'settings.vision.model.info': '비전 도구에서 이미지를 설명하는 모델입니다. 이미지 입력을 지원하는 모델만 나열되며, 카탈로그가 판단할 수 없는 모델은 표시를 유지하고 실행 전에 서버가 다시 검증합니다.',
  'settings.vision.model.notSelected': '비전 모델 선택',
  'settings.vision.model.required': '비전 도구를 활성화하려면 비전 모델을 선택하세요.',
  'settings.vision.prompt.label': '설명 프롬프트',
  'settings.vision.prompt.info': '각 이미지와 함께 비전 모델로 보내는 프롬프트입니다. 좋은 프롬프트는 내용, 레이아웃, 스타일, 색상, 원문 텍스트를 요청하여 모델이 전체 그림을 얻도록 합니다. 비워 두면 내장 기본값이 사용됩니다.',
  'settings.vision.prompt.placeholder': '비워 두면 기본 프롬프트가 사용됩니다.',
  'settings.vision.prompt.save': '저장',
  'settings.vision.prompt.reset': '기본값으로 재설정',
  'settings.vision.toast.saved': '비전 설정이 저장되었습니다',
  'settings.vision.toast.saveFailed': '비전 설정을 저장하지 못했습니다',
  'settings.vision.toast.loadFailed': '비전 설정을 불러오지 못했습니다',
