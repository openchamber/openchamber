...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.defaults.field.defaultDirectory': '기본 디렉터리',
  'settings.openchamber.defaults.field.defaultDirectoryHint': '디렉터리를 선택하지 않으면 새 세션이 이 디렉터리에서 시작됩니다. 비워 두면 현재 동작이 유지됩니다.',
  'settings.openchamber.defaults.field.defaultDirectoryPlaceholder': '비워 두면 현재 디렉터리 사용',
  'settings.openchamber.defaults.actions.browseDirectory': '찾아보기',
  'settings.openchamber.defaults.actions.browseDirectoryAria': '디렉터리 찾아보기',
