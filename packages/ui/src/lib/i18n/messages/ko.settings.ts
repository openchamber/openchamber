...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.voice.page.field.ttsChunkedMode': 'TTS 청크 모드',
  'settings.voice.page.field.ttsChunkedModeAria': 'TTS 청크 모드',
  'settings.voice.page.tooltip.ttsChunked': '긴 텍스트를 문장 단위로 나눠 합성이 끝나는 대로 재생해 재생 시작이 훨씬 빨라집니다. 끄면 전체 텍스트를 한 번의 요청으로 합성합니다.',
