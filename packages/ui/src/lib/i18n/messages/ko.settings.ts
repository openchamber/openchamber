...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  "settings.page.analytics.title": "분석",
  "settings.analytics.scope.project": "이 프로젝트",
  "settings.analytics.scope.all": "모든 프로젝트",
  "settings.analytics.period.groupLabel": "기간",
  "settings.analytics.period.7d": "7일",
  "settings.analytics.period.30d": "30일",
  "settings.analytics.period.90d": "90일",
  "settings.analytics.period.all": "전체 기간",
  "settings.analytics.action.refresh": "새로 고침",
  "settings.analytics.state.errorTitle": "분석을 불러오지 못했습니다",
  "settings.analytics.state.empty": "선택한 기간의 세션 데이터가 없습니다",
  "settings.analytics.kpi.sectionTitle": "개요",
  "settings.analytics.kpi.tokens": "토큰",
  "settings.analytics.kpi.cost": "비용",
  "settings.analytics.kpi.sessions": "세션",
  "settings.analytics.kpi.activeDays": "활성 일수",
  "settings.analytics.kpi.streak": "연속 일수",
  "settings.analytics.quota.title": "공급자 할당량",
  "settings.analytics.quota.none": "구성된 공급자가 없습니다",
  "settings.analytics.quota.manage": "사용 한도 관리",
  "settings.analytics.topSessions.title": "상위 세션",
  "settings.analytics.topSessions.open": "세션 열기",
  "settings.analytics.topSessions.empty": "선택한 기간에 세션이 없습니다",
  "settings.analytics.tab.trends": "추세",
  "settings.analytics.kpi.deltaUp": "↑ 이전 대비 +{value}%",
  "settings.analytics.kpi.deltaDown": "↓ 이전 대비 {value}%",
  "settings.analytics.kpi.deltaNew": "신규",
  "settings.analytics.kpi.deltaFlat": "—",
  "settings.analytics.kpi.cacheHitRate": "캐시 적중률",
  "settings.analytics.trends.metric.tokens": "토큰",
  "settings.analytics.trends.metric.cost": "비용",
  "settings.analytics.trends.metric.sessions": "세션",
  "settings.analytics.trends.tokenBreakdown.title": "토큰 분석",
  "settings.analytics.trends.tokenBreakdown.ariaLabel": "시간별 토큰 분석",
  "settings.analytics.trends.tokenBreakdown.prompt": "프롬프트",
  "settings.analytics.trends.tokenBreakdown.completion": "완성",
  "settings.analytics.trends.tokenBreakdown.reasoning": "추론",
  "settings.analytics.trends.tokenBreakdown.cached": "캐시됨",
  "settings.analytics.trends.cache.title": "프롬프트 캐싱",
  "settings.analytics.trends.cache.ariaLabel": "시간별 프롬프트 캐싱",
  "settings.analytics.trends.cache.cached": "캐시됨",
  "settings.analytics.trends.cache.uncached": "미캐시",
  "settings.analytics.trends.byModel.other": "기타",
  "settings.analytics.yearHeatmap.title": "활동",
  ...
  "settings.analytics.summary.view.aria": "보기",
  "settings.analytics.summary.chartToggleAria": "막대 차트와 꺾은선 차트 전환",
  "settings.analytics.summary.chartType.bar": "막대 차트",
  "settings.analytics.summary.chartType.line": "꺾은선 차트",
  "settings.analytics.activity.longestStreak": "최장 연속",
  "settings.analytics.activity.avgPerDay": "평균 / 일",
  "settings.analytics.activity.avgPerWeek": "평균 / 주",
  "settings.analytics.activity.total": "합계",
  "settings.analytics.activity.days": "일",
  "settings.analytics.chart.sessionsPerDay": "일별 세션",
  "settings.analytics.chart.costPerDay": "일별 비용",
  "settings.analytics.efficiency.title": "효율",
  "settings.analytics.efficiency.costPerMillion": "$ / 1M 토큰",
  "settings.analytics.efficiency.costPerSession": "비용 / 세션",
  "settings.analytics.efficiency.tokensPerSession": "토큰 / 세션",
  "settings.analytics.efficiency.reasoningShare": "추론 비율",
  "settings.analytics.efficiency.avgDuration": "평균 소요 시간",
  "settings.analytics.efficiency.medianDuration": "중앙값 소요 시간",
  "settings.analytics.efficiency.longestDuration": "최장 소요 시간",
  "settings.analytics.agents.title": "에이전트 사용량",
  "settings.analytics.agents.empty": "에이전트 데이터 없음",
  "settings.analytics.rhythm.title": "활동 리듬",
  "settings.analytics.rhythm.hoursAria": "시간대별 활동",
} as const;
