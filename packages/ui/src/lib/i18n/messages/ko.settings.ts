export const settingsDict = {
  ...
  'settings.openchamber.tunnel.field.tailscaleHttpsPort': 'Tailscale HTTPS 포트',
  'settings.openchamber.tunnel.field.tailscaleHttpsPortDescription': 'Tailscale 프런트엔드 포트입니다. Serve는 1~65535의 모든 포트를, Funnel은 443, 8443, 10000을 지원합니다.',
  'settings.openchamber.tunnel.field.tailscaleServeHttpsPortDescription': 'Serve에는 1~65535의 정수를 사용할 수 있습니다.',
  'settings.openchamber.tunnel.field.tailscaleFunnelHttpsPortDescription': 'Funnel은 443, 8443, 10000만 지원합니다.',
  'settings.openchamber.tunnel.field.tailscaleHttpsPortError': '1~65535의 정수를 입력하세요.',
  ...
  'settings.openchamber.tunnel.notAvailable.tailscaleInstallHint': '시작하기 전에 Tailscale을 설치하고 이 기기에서 로그인하세요:',
  'settings.openchamber.tunnel.option.mode.privateNetwork.label': 'Tailnet 전용 (Serve)',
  'settings.openchamber.tunnel.option.mode.privateNetwork.tooltip': 'Tailscale Serve는 tailnet 내부에서만 접근할 수 있게 합니다.',
  'settings.openchamber.tunnel.option.mode.tailscaleQuick.label': '공개 (Funnel)',
  'settings.openchamber.tunnel.option.mode.tailscaleQuick.tooltip': 'Tailscale Funnel은 인터넷에서 이 인스턴스에 접근할 수 있게 합니다.',
  'settings.openchamber.tunnel.warning.tailscaleFunnelPublic': 'Tailscale Funnel은 이 인스턴스를 인터넷에 공개합니다. 공개 접근이 필요할 때만 사용하세요.',
  'settings.openchamber.tunnel.badge.privateNetwork': 'Tailnet',
  'settings.openchamber.tunnel.toast.startedButNoUrl': '터널이 시작되었지만 접근 URL을 반환하지 않았습니다.',
