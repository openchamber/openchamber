...
export const settingsDict = {
  ...
  'settings.page.fusion.title': '퓨전',
  'settings.page.fusion.description': '모델 퓨전용 선별 모델 패널.',
  'settings.fusion.empty': '아직 프리셋이 없습니다. 첫 번째를 추가하세요.',
  'settings.fusion.add': '프리셋 추가',
  'settings.fusion.edit': '편집',
  'settings.fusion.delete': '삭제',
  'settings.fusion.deleteTitle': '퓨전 프리셋 삭제',
  'settings.fusion.deleteConfirm': '프리셋 {name}을(를) 삭제할까요?',
  'settings.fusion.dialogTitleNew': '새 퓨전 프리셋',
  'settings.fusion.dialogTitleEdit': '퓨전 프리셋 편집',
  'settings.fusion.dialogDescription': '2-4개 모델의 이름 있는 패널.',
  'settings.fusion.nameLabel': '이름',
  'settings.fusion.descriptionLabel': '설명',
  'settings.fusion.modelsLabel': '모델 ({count}/4)',
  'settings.fusion.modelsHint': '모델 2-4개 선택.',
  'settings.fusion.searchModels': '모델 검색',
  'settings.fusion.noModelResults': '검색어와 일치하는 모델이 없습니다.',
  'settings.fusion.save': '저장',
  'settings.fusion.cancel': '취소',
  'settings.fusion.loading': '불러오는 중…',
  'settings.fusion.loadError': '프리셋을 불러오지 못했습니다: {error}',
  'settings.fusion.noModels': '이 디렉터리에 설정된 모델이 없습니다.',
  'settings.fusion.required': '이름 + 모델 2-4개 필요.',
