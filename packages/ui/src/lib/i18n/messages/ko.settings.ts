...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.providers.sidebar.actions.reorderProviderTitle': '끌어서 공급자 순서 변경',
  'settings.providers.sidebar.actions.reorderProviderAria': '공급자 순서 변경',
  'settings.providers.sidebar.actions.enableProvider': '활성화',
  'settings.providers.sidebar.section.disabled': '비활성화됨',
  ...
  'settings.providers.page.actions.disableProvider': '비활성화',
  'settings.providers.page.actions.enableProvider': '활성화',
  'settings.providers.page.badge.disabled': '비활성화됨',
  'settings.providers.page.badge.disabledHint': '활성화할 때까지 모델 선택기에서 숨겨집니다.',
