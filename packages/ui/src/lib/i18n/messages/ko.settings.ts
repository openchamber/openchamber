export const settingsDict = {
  ...
  'settings.page.sessions.description': '세션 기본값, 권한 처리, 보관 기간을 설정합니다.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.permissionAutoAccept.title': '권한 자동 승인',
  'settings.openchamber.permissionAutoAccept.info': '이 런타임의 모든 세션에 적용되며, 세션별로 권한 정책을 명시적으로 켜거나 끄면 그 설정이 우선합니다. 켜면 이미 대기 중인 권한 요청도 즉시 처리합니다.',
  'settings.openchamber.permissionAutoAccept.field.globalLabel': '이 런타임의 모든 세션에서 권한 요청을 자동으로 승인',
  'settings.openchamber.permissionAutoAccept.field.globalAria': '이 런타임의 모든 세션에서 권한 요청을 자동으로 승인',
  'settings.openchamber.permissionAutoAccept.field.globalWarning': '보안: 세션이 이 정책을 명시적으로 재정의할 때까지 OpenChamber가 대기 중이거나 앞으로 들어오는 권한 요청을 확인 없이 승인합니다.',
  'settings.openchamber.permissionAutoAccept.dialog.title': '모든 세션에 권한 자동 승인을 사용할까요?',
  'settings.openchamber.permissionAutoAccept.dialog.description': 'OpenChamber가 이미 대기 중인 권한 요청을 즉시 승인하고, 이 런타임에서 새로 들어오는 요청도 세션이 정책을 명시적으로 재정의할 때까지 계속 승인합니다. 신뢰할 수 있는 런타임에서만 사용하세요.',
  'settings.openchamber.permissionAutoAccept.dialog.confirm': '자동 승인 켜기',
