...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.visual.field.messageSpeedMetrics': '응답 속도 지표 표시',
  'settings.openchamber.visual.field.messageSpeedMetricsAria': '완료된 응답 아래에 응답 속도 지표 표시',
  'settings.openchamber.visual.field.messageSpeedMetricsInfo': '완료된 응답 아래에 TTFT(첫 토큰까지의 시간)와 초당 출력 토큰 수를 표시합니다. 공급자나 릴레이를 비교할 때 유용합니다.',
