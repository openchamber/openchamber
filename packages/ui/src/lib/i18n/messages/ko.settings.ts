...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.visual.field.showMessageSpeedMetricsAria': '메시지 속도 지표 표시',
  'settings.openchamber.visual.field.showMessageSpeedMetrics': '메시지 속도 지표 표시',
  'settings.openchamber.visual.field.showMessageSpeedMetricsInfo': '각 어시스턴트 메시지에 첫 토큰까지 걸린 시간, 출력 처리량, 비캐시 / 캐시 / 출력 토큰 내역을 표시합니다. 첫 토큰 시간은 OpenCode 서버에서 메시지 시작부터 첫 추론 또는 텍스트 부분까지 측정합니다.',
