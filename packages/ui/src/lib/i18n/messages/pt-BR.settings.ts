...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.page.analytics.title": "Análises",
  "settings.analytics.scope.project": "Este projeto",
  "settings.analytics.scope.all": "Todos os projetos",
  "settings.analytics.period.groupLabel": "Intervalo de tempo",
  "settings.analytics.period.7d": "7 dias",
  "settings.analytics.period.30d": "30 dias",
  "settings.analytics.period.90d": "90 dias",
  "settings.analytics.period.all": "Todo o período",
  "settings.analytics.action.refresh": "Atualizar",
  "settings.analytics.state.errorTitle": "Falha ao carregar análises",
  "settings.analytics.state.empty":
      "Sem dados de sessão para o período selecionado",
  "settings.analytics.kpi.sectionTitle": "Visão geral",
  "settings.analytics.kpi.tokens": "Tokens",
  "settings.analytics.kpi.cost": "Custo",
  "settings.analytics.kpi.sessions": "Sessões",
  "settings.analytics.kpi.activeDays": "Dias ativos",
  "settings.analytics.kpi.streak": "Sequência de dias",
  "settings.analytics.quota.title": "Cotas de provedores",
  "settings.analytics.quota.none": "Nenhum provedor configurado",
  "settings.analytics.quota.manage": "Gerenciar limites",
  "settings.analytics.topSessions.title": "Principais sessões",
  "settings.analytics.topSessions.open": "Abrir sessão",
  "settings.analytics.topSessions.empty":
      "Nenhuma sessão no período selecionado",
  "settings.analytics.tab.trends": "Tendências",
  "settings.analytics.kpi.deltaUp": "↑ {value}% vs período anterior",
  "settings.analytics.kpi.deltaDown": "↓ {value}% vs período anterior",
  "settings.analytics.kpi.deltaNew": "Novo",
  "settings.analytics.kpi.deltaFlat": "—",
  "settings.analytics.kpi.cacheHitRate": "Taxa de cache",
  "settings.analytics.trends.metric.tokens": "Tokens",
  "settings.analytics.trends.metric.cost": "Custo",
  "settings.analytics.trends.metric.sessions": "Sessões",
  "settings.analytics.trends.tokenBreakdown.title": "Detalhamento de tokens",
  "settings.analytics.trends.tokenBreakdown.ariaLabel":
      "Detalhamento de tokens ao longo do tempo",
  "settings.analytics.trends.tokenBreakdown.prompt": "Prompt",
  "settings.analytics.trends.tokenBreakdown.completion": "Conclusão",
  "settings.analytics.trends.tokenBreakdown.reasoning": "Raciocínio",
  "settings.analytics.trends.tokenBreakdown.cached": "Em cache",
  "settings.analytics.trends.cache.title": "Cache de prompts",
  "settings.analytics.trends.cache.ariaLabel":
      "Cache de prompts ao longo do tempo",
  "settings.analytics.trends.cache.cached": "Em cache",
  "settings.analytics.trends.cache.uncached": "Sem cache",
  "settings.analytics.trends.byModel.other": "Outros",
  "settings.analytics.yearHeatmap.title": "Atividade",
  ...
  "settings.analytics.summary.view.aria": "Visualização",
  "settings.analytics.summary.chartToggleAria": "Alternar entre gráfico de barras e linha",
  "settings.analytics.summary.chartType.bar": "Gráfico de barras",
  "settings.analytics.summary.chartType.line": "Gráfico de linha",
  "settings.analytics.activity.longestStreak": "Sequência mais longa",
  "settings.analytics.activity.avgPerDay": "Média / dia",
  "settings.analytics.activity.avgPerWeek": "Média / semana",
  "settings.analytics.activity.total": "Total",
  "settings.analytics.activity.days": "dias",
  "settings.analytics.chart.sessionsPerDay": "Sessões por dia",
  "settings.analytics.chart.costPerDay": "Custo por dia",
  "settings.analytics.efficiency.title": "Eficiência",
  "settings.analytics.efficiency.costPerMillion": "$ / 1M tokens",
  "settings.analytics.efficiency.costPerSession": "Custo / sessão",
  "settings.analytics.efficiency.tokensPerSession": "Tokens / sessão",
  "settings.analytics.efficiency.reasoningShare": "Proporção de raciocínio",
  "settings.analytics.efficiency.avgDuration": "Duração média",
  "settings.analytics.efficiency.medianDuration": "Duração mediana",
  "settings.analytics.efficiency.longestDuration": "Duração mais longa",
  "settings.analytics.agents.title": "Uso de agentes",
  "settings.analytics.agents.empty": "Sem dados de agentes",
  "settings.analytics.rhythm.title": "Ritmo de atividade",
  "settings.analytics.rhythm.hoursAria": "Atividade por hora",
