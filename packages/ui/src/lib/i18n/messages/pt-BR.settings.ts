...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.appLinks.title": "Links de aplicativos",
  "settings.openchamber.appLinks.info": "Os links de aplicativos do chat (ex.: obsidian://) são abertos em outro aplicativo após confirmação. Protocolos confiáveis abrem sem perguntar novamente.",
  "settings.openchamber.appLinks.empty": "Nenhum link de aplicativo confiável ainda. Escolha \"Confiar e abrir\" ao abrir um link para adicioná-lo aqui.",
