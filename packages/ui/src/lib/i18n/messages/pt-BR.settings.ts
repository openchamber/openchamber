...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.git.reviewLayoutTitle": "Layout de revisão",
  "settings.openchamber.git.reviewLayoutAria": "Layout de revisão",
  "settings.openchamber.git.reviewLayout.option.separate": "Visualizações separadas",
  "settings.openchamber.git.reviewLayout.option.combined": "Git + alterações combinados",
  "settings.openchamber.git.reviewLayout.optionAria": "Layout de revisão: {option}",
