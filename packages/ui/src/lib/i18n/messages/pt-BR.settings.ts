...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'Copie o cabeçalho Cookie completo dos cabeçalhos da solicitação nas ferramentas de desenvolvedor do navegador em ollama.com e cole-o aqui. Apenas o cookie de sessão é armazenado e enviado: wos-session=... (contas antigas podem usar __Secure-session=...). Os outros cookies do cabeçalho não são encaminhados. Isso não é uma chave de API nem um endpoint local do Ollama. O OpenChamber nunca examina o armazenamento de cookies do navegador.',
  'settings.providers.page.ollamaCloud.cookie': 'Cabeçalho Cookie',
