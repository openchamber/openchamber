...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.voice.page.field.browserMicrophonePermission": "Ao pressionar o microfone no chat, permita o acesso se o navegador solicitar. Se a solicitação não aparecer ou o acesso estiver bloqueado, abra as configurações do site ao lado da barra de endereço, permita o microfone, recarregue a página e tente novamente.",
