...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.usage.sidebar.activeTotal": "{count} ativos",
  "settings.usage.sidebar.overview": "Visão geral",
  "settings.usage.sidebar.activeProviders": "Provedores ativos",
  "settings.usage.sidebar.addProvider": "Adicionar provedor",
  "settings.usage.sidebar.availableCount": "{count} disponíveis",
  "settings.usage.sidebar.removeProviderAria": "Remover {provider} de Uso",
  "settings.usage.sidebar.removeProviderTitle": "Remover de Uso",
  "settings.usage.sidebar.remainingPct": "{percent}% restante",
  "settings.usage.sidebar.usedPct": "{percent}% usado",
  ...
  "settings.usage.sidebar.field.display": "Exibição",
  ...
  "settings.usage.overview.title": "Visão geral de uso",
  "settings.usage.overview.description": "Monitore o uso e os custos de LLM em todos os provedores.",
  "settings.usage.overview.period.aria": "Período de uso",
  "settings.usage.overview.period.7d": "7 dias",
  "settings.usage.overview.period.30d": "30 dias",
  "settings.usage.overview.metric.totalSpend": "Gasto total",
  "settings.usage.overview.metric.totalTokens": "Total de tokens",
  "settings.usage.overview.metric.requests": "Solicitações",
  "settings.usage.overview.metric.avgCost": "Custo médio / 1K tokens",
  "settings.usage.overview.chart.usageOverTime": "Uso ao longo do tempo",
  "settings.usage.overview.chart.topProviders": "Principais provedores por gasto",
  "settings.usage.overview.chart.metricAria": "Métrica do gráfico",
  "settings.usage.overview.chart.metric.tokens": "Tokens",
  "settings.usage.overview.chart.metric.cost": "Custo",
  "settings.usage.overview.chart.metric.requests": "Solicitações",
  "settings.usage.overview.chart.empty": "Ainda não há uso de sessão neste período.",
  "settings.usage.overview.providers.title": "Provedores",
  "settings.usage.overview.providers.col.provider": "Provedor",
  "settings.usage.overview.providers.col.spend": "Gasto",
  "settings.usage.overview.providers.col.tokens": "Tokens",
  "settings.usage.overview.providers.col.requests": "Solicitações",
  "settings.usage.overview.providers.col.remaining": "Restante / Limite",
  "settings.usage.overview.providers.col.status": "Status",
  "settings.usage.overview.providers.remainingPct": "{percent}% restante",
  "settings.usage.overview.providers.status.active": "Ativo",
  "settings.usage.overview.providers.status.error": "Erro",
  "settings.usage.overview.providers.openDetailAria": "Abrir detalhes de uso de {provider}",
  "settings.usage.overview.providers.removeAria": "Remover {provider} de Uso",
  "settings.usage.overview.empty.title": "Nenhum provedor em Uso ainda",
  "settings.usage.overview.empty.description": "Provedores configurados aparecem aqui automaticamente. Adicione um provedor ou restaure um que você removeu.",
  "settings.usage.overview.actions.title": "Ações rápidas",
  "settings.usage.overview.actions.addProvider": "Adicionar provedor",
  "settings.usage.overview.actions.addProviderDescription": "Conectar um novo provedor de LLM",
  "settings.usage.overview.actions.manageLimits": "Gerenciar limites",
  "settings.usage.overview.actions.manageLimitsDescription": "Revisar cotas e limites restantes",
  "settings.usage.overview.available.title": "Provedores disponíveis",
  "settings.usage.overview.available.description": "Provedores que você pode conectar ou restaurar ao bloco de Uso após removê-los.",
  "settings.usage.overview.available.hiddenConfigured": "Configurado — removido de Uso",
  "settings.usage.overview.available.notConfigured": "Ainda não conectado",
  "settings.usage.overview.available.restore": "Restaurar",
  "settings.usage.overview.available.connect": "Conectar",
  "settings.usage.add.title": "Adicionar provedor",
  "settings.usage.add.description": "Escolha entre os provedores disponíveis: conecte um novo ou restaure um provedor configurado que você removeu de Uso.",
  "settings.usage.add.backAria": "Voltar à visão geral de uso",
  "settings.usage.add.empty": "Todos os provedores compatíveis já são exibidos em Uso.",
  "settings.usage.add.viaCredentials": "Configurar credenciais de uso aqui",
  "settings.usage.add.viaProviders": "Conectar nas configurações de Provedores",
  "settings.usage.add.restoreHint": "Já configurado — restaurar em Uso",
  "settings.usage.add.openProviders": "Abrir configurações de Provedores",
  "settings.usage.add.credentialsTitle": "Credenciais de {provider}",
  "settings.usage.add.viewProvider": "Ver uso do provedor",
  "settings.usage.page.empty.selectProvider": "Selecione um provedor para ver detalhes de uso.",
  "settings.usage.page.backToOverviewAria": "Voltar à visão geral de uso",
  ...
  "settings.usage.page.actions.removeFromUsage": "Remover de Uso",
  ...
  "settings.usage.page.state.providerNotConfiguredDescription": "Adicione credenciais na aba de Provedores para habilitar o acompanhamento de uso.",
  "settings.usage.page.section.periodUsage": "Uso neste período",
  "settings.usage.page.section.remainingLimits": "Limites restantes",
  "settings.usage.page.section.modelQuotas": "Cotas de modelo",
  "settings.usage.page.section.otherModels": "Outros modelos",
  "settings.usage.page.state.noQuotaWindowsTitle": "Nenhuma janela de cota relatada",
  ...
  "settings.usage.pace.status.onTrack": "No ritmo",
  "settings.usage.pace.status.slightlyFast": "Um pouco rápido",
  "settings.usage.pace.status.tooFast": "Rápido demais",
  "settings.usage.pace.status.usedUp": "Esgotado",
  "settings.usage.pace.predictionTooltip": "Uso previsto ao final da janela com base no ritmo atual: {prediction}",
  "settings.usage.pace.wait": "Aguardar {duration}",
  "settings.usage.pace.prediction": "Prev.: {prediction}",
  "settings.usage.pace.rate": "Ritmo: {rate}",
  "settings.usage.pace.waitSeparator": " · Aguardar ",
  "settings.usage.pace.predictionLabel": "Prev.: ",
