...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.mobileLanding.title": "Tela inicial móvel",
  "settings.openchamber.mobileLanding.recents.label": "Abrir nas sessões recentes",
  "settings.openchamber.mobileLanding.recents.description": "Em telefones, quando não houver nenhuma sessão aberta, mostra a lista de sessões recentes de todos os projetos em vez de um rascunho de nova sessão.",
