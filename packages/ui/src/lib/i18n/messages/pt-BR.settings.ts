...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.remoteInstances.clientAuth.relayEndpoint.title": "Servidor Relay",
  "settings.remoteInstances.clientAuth.relayEndpoint.info": "Endpoint usado para links de pareamento «De qualquer lugar» e acesso via Relay. Aponte para um Relay auto-hospedado para manter esse tráfego na sua infraestrutura; um host de Relay em execução reconecta imediatamente. Links de pareamento criados antes mantêm o endpoint original.",
  "settings.remoteInstances.clientAuth.relayEndpoint.option.default": "Padrão",
  "settings.remoteInstances.clientAuth.relayEndpoint.option.custom": "Personalizado",
  "settings.remoteInstances.clientAuth.relayEndpoint.field.placeholder": "wss://seu-relay.example/ws",
  "settings.remoteInstances.clientAuth.relayEndpoint.actions.save": "Salvar",
  "settings.remoteInstances.clientAuth.relayEndpoint.locked": "Fixado pela variável de ambiente OPENCHAMBER_RELAY_URL:",
  "settings.remoteInstances.clientAuth.relayEndpoint.error.invalid": "Insira uma URL WebSocket ws:// ou wss:// válida.",
  "settings.remoteInstances.clientAuth.relayEndpoint.error.saveFailed": "Falha ao salvar a URL do servidor Relay.",
  "settings.remoteInstances.clientAuth.relayEndpoint.error.loadFailed": "Falha ao carregar a configuração do servidor Relay.",
  "settings.remoteInstances.clientAuth.relayEndpoint.state.loading": "Verificando o servidor Relay…",
  "settings.remoteInstances.clientAuth.relayEndpoint.error.locked": "O endpoint do Relay está fixado no servidor pela variável de ambiente OPENCHAMBER_RELAY_URL e não pode ser alterado aqui.",
