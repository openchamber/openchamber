...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.visual.field.worktreeDiscovery": "Detectar worktrees Git automaticamente",
  "settings.openchamber.visual.field.worktreeDiscoveryAria": "Alternar detecção automática de worktrees Git",
  "settings.openchamber.visual.field.worktreeDiscoveryInfo": "Quando ativado, o painel lateral detecta worktrees Git para o projeto ativo e projetos com sessões ativas.",
  "settings.openchamber.visual.field.worktreeDiscoveryInterval": "Intervalo de atualização da detecção de worktrees",
  "settings.openchamber.visual.field.worktreeDiscoveryIntervalAria": "Selecionar intervalo de atualização de worktrees",
  "settings.openchamber.visual.field.worktreeDiscoveryIntervalInfo": "Tempo mínimo entre detecções automáticas.",
  "settings.openchamber.visual.option.worktreeDiscoveryInterval.0": "Imediatamente",
  "settings.openchamber.visual.option.worktreeDiscoveryInterval.30000": "30 segundos",
  "settings.openchamber.visual.option.worktreeDiscoveryInterval.60000": "1 minuto",
  "settings.openchamber.visual.option.worktreeDiscoveryInterval.300000": "5 minutos",
  "settings.openchamber.visual.field.backgroundProjectSessionLoading": "Carregar sessões de todos os projetos em segundo plano",
  "settings.openchamber.visual.field.backgroundProjectSessionLoadingAria": "Alternar carregamento de sessões de todos os projetos em segundo plano",
  "settings.openchamber.visual.field.backgroundProjectSessionLoadingInfo": "Quando ativado, o OpenChamber carrega dados de sessão de todos os projetos da barra lateral.",
