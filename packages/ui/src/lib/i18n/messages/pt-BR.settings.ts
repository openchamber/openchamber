...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.voice.page.localTts.availableToDownload": "Disponíveis para baixar",
  "settings.voice.page.localTts.filterPlaceholder": "Filtrar por idioma ou descrição",
  "settings.voice.page.localTts.filterNoMatch": "Nenhum modelo corresponde ao filtro",
