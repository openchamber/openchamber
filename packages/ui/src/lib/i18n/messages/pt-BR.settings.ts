...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.tools.field.serverBrowser": "Navegador do servidor",
  "settings.openchamber.tools.field.serverBrowserAria": "Ativar o navegador do servidor",
  "settings.openchamber.tools.field.serverBrowserInfo": "Executa um navegador Chrome neste servidor para que agentes possam navegar mesmo quando nenhuma janela conectada puder atendê-los, e para que você possa ver e controlar as mesmas páginas de qualquer dispositivo. Desativado por padrão e aplicado imediatamente; ao desativar, o Chrome é interrompido e suas sessões e visualizadores são fechados.",
  "settings.openchamber.tools.browserDebugPort.label": "Porta CDP do navegador",
  "settings.openchamber.tools.browserDebugPort.info": "Escolha a porta para conexões MCP locais. A alteração salva será aplicada na próxima vez que o Chrome iniciar e mantém as abas atuais abertas.",
  "settings.openchamber.tools.browserDebugPort.automatic": "Automática",
  "settings.openchamber.tools.browserDebugPort.fixed": "Porta fixa",
  "settings.openchamber.tools.browserDebugPort.input": "Porta CDP fixa",
  "settings.openchamber.tools.browserDebugPort.invalid": "Digite um número inteiro de 1 a 65535.",
  "settings.openchamber.tools.browserDebugPort.save": "Salvar porta",
  "settings.openchamber.tools.browserDebugPort.configuredAutomatic": "Porta configurada: automática",
  "settings.openchamber.tools.browserDebugPort.configuredFixed": "Porta configurada: {port}",
  "settings.openchamber.tools.browserDebugPort.loading": "Verificando o status do navegador…",
  "settings.openchamber.tools.browserDebugPort.unavailable": "O status do navegador está indisponível.",
  "settings.openchamber.tools.browserDebugPort.stopped": "O Chrome não está em execução.",
  "settings.openchamber.tools.browserDebugPort.active": "Porta ativa: {port}",
  "settings.openchamber.tools.browserDebugPort.pending": "A porta salva será aplicada na próxima vez que o Chrome iniciar.",
  "settings.openchamber.tools.browserDebugPort.refresh": "Atualizar status",
  "settings.openchamber.tools.browserDebugPort.copy": "Copiar URL do navegador",
  "settings.openchamber.tools.browserDebugPort.copied": "URL do navegador copiada",
  "settings.openchamber.tools.browserDebugPort.copyFailed": "Não foi possível copiar a URL do navegador.",
  "settings.openchamber.tools.browserDebugPort.connectionInfo": "Este endereço de loopback pertence à máquina do servidor. Execute o MCP nela com --browserUrl ou use seu próprio túnel SSH. As conexões MCP diretas não usam Assumir o controle.",
