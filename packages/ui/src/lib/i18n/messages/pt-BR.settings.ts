...
export const settingsDict = {
  ...
  "settings.page.fusion.title": "Fusão",
  "settings.page.fusion.description": "Painéis de modelos selecionados para fusão de modelos.",
  "settings.fusion.empty": "Ainda não há presets. Adicione o primeiro.",
  "settings.fusion.add": "Adicionar preset",
  "settings.fusion.edit": "Editar",
  "settings.fusion.delete": "Excluir",
  "settings.fusion.deleteTitle": "Excluir preset de fusão",
  "settings.fusion.deleteConfirm": "Excluir o preset {name}?",
  "settings.fusion.dialogTitleNew": "Novo preset de fusão",
  "settings.fusion.dialogTitleEdit": "Editar preset de fusão",
  "settings.fusion.dialogDescription": "Um painel nomeado de 2-4 modelos.",
  "settings.fusion.nameLabel": "Nome",
  "settings.fusion.descriptionLabel": "Descrição",
  "settings.fusion.modelsLabel": "Modelos ({count}/4)",
  "settings.fusion.modelsHint": "Escolha de 2 a 4 modelos.",
  "settings.fusion.searchModels": "Buscar modelos",
  "settings.fusion.noModelResults": "Nenhum modelo corresponde à sua pesquisa.",
  "settings.fusion.save": "Salvar",
  "settings.fusion.cancel": "Cancelar",
  "settings.fusion.loading": "Carregando…",
  "settings.fusion.loadError": "Falha ao carregar presets: {error}",
  "settings.fusion.noModels": "Nenhum modelo configurado para este diretório.",
  "settings.fusion.required": "Nome + 2-4 modelos obrigatórios.",
