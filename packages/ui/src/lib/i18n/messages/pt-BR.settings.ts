...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.visual.field.contextPanelDock": "Posição do painel de contexto",
  "settings.openchamber.visual.field.contextPanelDockAria": "Posição do painel de contexto",
  "settings.openchamber.visual.field.contextPanelDockHint": "Move o painel de contexto inteiro, não apenas o terminal: todas as superfícies (terminal, alterações, diferenças, arquivos, notas) são ancoradas na borda escolhida da coluna de conversa.",
  "settings.openchamber.visual.option.contextPanelDock.right": "Direita",
  "settings.openchamber.visual.option.contextPanelDock.bottom": "Abaixo",
