...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.visual.section.chatMessageWidth": "Largura das mensagens",
  "settings.openchamber.visual.section.chatMessageWidthAria": "Largura das mensagens",
  "settings.openchamber.visual.field.chatMessageWidthAria": "Largura das mensagens: {option}",
  "settings.openchamber.visual.option.chatMessageWidth.narrow.label": "Estreita",
  "settings.openchamber.visual.option.chatMessageWidth.wide.label": "Ampla",
  "settings.openchamber.visual.option.chatMessageWidth.fluid.label": "Largura total",
