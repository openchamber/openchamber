...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  'settings.openchamber.visual.field.activityColorCoding': 'Colorir ferramentas e atividades',
  'settings.openchamber.visual.field.activityColorCodingAria': 'Colorir as linhas de ferramentas e atividades',
  'settings.openchamber.visual.field.activityColorCodingHint': 'Atribui uma cor de destaque do tema a cada tipo de linha de ferramenta e atividade — edições de arquivos, comandos de shell, pesquisas, raciocínio e mais. Desative para usar um único tom neutro.',
