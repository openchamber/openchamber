...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.visual.field.showMessageSpeedMetricsAria": "Mostrar métricas de velocidade da mensagem",
  "settings.openchamber.visual.field.showMessageSpeedMetrics": "Mostrar métricas de velocidade da mensagem",
  "settings.openchamber.visual.field.showMessageSpeedMetricsInfo": "Mostra o tempo até o primeiro token, o desempenho de saída e a divisão entrada sem cache / cache / saída em cada mensagem do assistente. O tempo até o primeiro token é medido no servidor OpenCode do início da mensagem até a primeira parte de raciocínio ou texto.",
