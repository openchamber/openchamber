...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.defaults.field.defaultDirectory": "Diretório padrão",
  "settings.openchamber.defaults.field.defaultDirectoryHint": "Novas sessões iniciam neste diretório quando nenhum é escolhido. Deixe vazio para manter o comportamento atual.",
  "settings.openchamber.defaults.field.defaultDirectoryPlaceholder": "Deixe vazio para usar o diretório atual",
  "settings.openchamber.defaults.actions.browseDirectory": "Procurar",
  "settings.openchamber.defaults.actions.browseDirectoryAria": "Procurar um diretório",
