...
export const settingsDict = {
  'settings.sourceControl.ssh.title': 'Credenciais SSH gerenciadas',
  'settings.sourceControl.ssh.load': 'Carregar chaves do servidor',
  'settings.sourceControl.ssh.discover': 'Buscar chaves do host',
  'settings.sourceControl.ssh.empty': 'Nenhuma chave SSH gerenciada está configurada neste servidor.',
  'settings.sourceControl.ssh.hostSetup': 'A busca verifica apenas arquivos de chave privada diretamente no diretório ~/.ssh do usuário do servidor conectado. Ela não inspeciona subdiretórios, links simbólicos, configurações SSH nem agentes. As cópias importadas permanecem no diretório de dados do servidor. Para chaves protegidas por frase secreta ou disponíveis apenas por agente, selecione explicitamente o transporte do sistema; suas credenciais não são verificadas.',
  'settings.sourceControl.ssh.unreadable': 'Não é possível ler a chave no servidor. Corrija a configuração do host ou selecione Sistema.',
  'settings.sourceControl.ssh.changed': 'A impressão digital da chave mudou. Corrija a configuração do host ou selecione Sistema.',
  'settings.sourceControl.ssh.unverifiable': 'A chave está criptografada ou não pode ser verificada. Corrija a configuração do host ou selecione Sistema.',
  'settings.sourceControl.ssh.insecurePermissions': 'As permissões da chave permitem acesso de outros usuários. Restrinja o arquivo do host antes de importá-lo.',
  'settings.sourceControl.ssh.discoveredEmpty': 'Nenhuma chave privada importável foi encontrada no diretório aprovado do servidor.',
  'settings.sourceControl.ssh.discoveryTruncated': 'O diretório contém mais entradas que o limite de busca. Alguns arquivos não foram inspecionados.',
  'settings.sourceControl.ssh.confirmFingerprint': 'Verifiquei esta impressão digital: {fingerprint}',
  'settings.sourceControl.ssh.import': 'Importar chave',
  'settings.sourceControl.ssh.imported': 'A chave foi copiada para o armazenamento gerenciado do servidor. Nenhum vínculo de repositório foi alterado.',
  'settings.sourceControl.ssh.candidateExpired': 'Este resultado de busca expirou. Busque as chaves do host novamente.',
  'settings.sourceControl.ssh.candidateChanged': 'A chave do host mudou após a busca. Busque-a novamente antes de importar.',
  'settings.sourceControl.ssh.confirmationMismatch': 'A impressão digital confirmada não corresponde a este resultado de busca.',
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.gitIdentities.editor.field.account": "Conta de controle de código",
  "settings.gitIdentities.editor.field.accountNone": "Sem conta",
  'settings.gitIdentities.editor.auth.label': 'Autenticação',
  'settings.gitIdentities.editor.auth.oauth': 'OAuth',
  'settings.gitIdentities.editor.auth.token': 'Token',
  'settings.gitIdentities.editor.auth.anonymous': 'Anônimo',
  'settings.gitIdentities.editor.auth.ssh': 'SSH',
  'settings.gitIdentities.editor.auth.oauthHint': 'Push e pull com o login OAuth da conta.',
  'settings.gitIdentities.editor.auth.tokenHint': 'Push e pull com o token de acesso pessoal da conta.',
  'settings.gitIdentities.editor.auth.anonymousHint': 'HTTPS público sem credenciais, somente leitura. A conta continua respondendo por issues e solicitações de mudança.',
  'settings.gitIdentities.page.incomplete': 'Precisa de uma conta antes que um repositório possa usá-la',
  'settings.gitIdentities.page.accountGone': 'A conta usada por esta identidade não está mais conectada',
  'settings.gitIdentities.page.signatureOnly': 'Apenas assinatura, de uma versão anterior',
  "settings.gitIdentities.editor.toast.accountRequired": "Escolha a conta com que esta identidade age, ou outra forma de autenticar.",
  "settings.gitIdentities.editor.toast.sshKeyRequired": "Escolha a chave SSH gerenciada que esta identidade usa.",
  ...
  'settings.openchamber.git.agentAuthority': 'Aplicar identidades nos shells do agente',
  'settings.openchamber.git.agentAuthorityAria': 'Aplicar identidades nos shells do agente',
  'settings.openchamber.git.agentAuthorityInfo': 'O Git que o próprio agente executa recebe a identidade do repositório em vez da configuração deste computador, e o agente é orientado a usar a ferramenta do OpenChamber em vez de uma transferência direta. Repositórios no Git do sistema mantêm a configuração deste computador. Vale a partir do próximo reinício do OpenCode e nunca para o seu próprio terminal.',
  ...
  'settings.gitlab.info': 'Conecte o GitLab.com ou uma instância autogerenciada para merge requests, issues e CI.',
  'settings.gitlab.instance.customLabel': 'Instância do GitLab',
  'settings.gitlab.instance.customInfo': 'Use uma origem HTTPS. HTTP é permitido apenas para endereços locais.',
  'settings.gitlab.actions.useInstance': 'Usar instância',
  'settings.gitlab.status.checking': 'Verificando conexão…',
  'settings.gitlab.status.operationFailed': 'Falha na operação',
  'settings.gitlab.status.tokenRejected': 'O GitLab não aceitou esse token. Verifique se ele pertence a esta instância e tem acesso à API.',
  'settings.gitlab.status.notConnected': 'Não conectado',
  'settings.gitlab.status.connected': 'Conectado',
  'settings.gitlab.actions.connect': 'Conectar GitLab',
  'settings.gitlab.token.label': 'Token de acesso pessoal',
  'settings.gitlab.token.info': 'O token é armazenado pelo servidor OpenChamber e nunca é devolvido à interface.',
  'settings.gitlab.device.label': 'Código do dispositivo',
  'settings.gitlab.cli.label': 'glab CLI',
  'settings.gitlab.cli.info': 'Use as credenciais do glab quando nenhuma conta salva estiver ativa.',
  'settings.gitlab.actions.enableCli': 'Ativar glab',
  'settings.gitlab.actions.disableCli': 'Desativar glab',
  'settings.gitlab.instances.title': 'Instâncias',
  'settings.gitlab.actions.addInstance': 'Adicionar instância',
  'settings.gitlab.device.waiting': 'Autorize o dispositivo no GitLab e volte ao OpenChamber. Esta página será atualizada automaticamente.',
  'settings.gitlab.actions.openGitLab': 'Abrir GitLab',
  'settings.sourceControl.accounts.inUse': 'Em uso',
  'settings.sourceControl.accounts.available': 'Disponível',
  'settings.sourceControl.accounts.configured': 'Contas configuradas',
  'settings.sourceControl.accounts.connectedCount': '{count} contas',
  'settings.sourceControl.accounts.needsAuthentication': 'Requer autenticação',
  'settings.sourceControl.actions.reauthenticate': 'Autenticar novamente',
  'settings.sourceControl.actions.remove': 'Remover',
  'settings.sourceControl.binding.accountLabel': 'Conta de controle de código',
  'settings.sourceControl.agentAuthority.title': 'Shell do agente',
  'settings.sourceControl.agentAuthority.label': 'Aplicar a identidade deste repositório no shell do agente',
  'settings.sourceControl.agentAuthority.info': 'Desligado significa que o Git que o agente executa aqui mantém a configuração deste computador, e transferências diretas no shell não são recusadas. Vale a partir do próximo reinício do OpenCode.',
  'settings.sourceControl.agentAuthority.machineOff': 'Identidades não são aplicadas nos shells do agente neste computador. Ative em Configurações → Git.',
  'settings.sourceControl.binding.accountAriaLabel': 'Conta de controle de código do repositório ativo',
  'settings.sourceControl.binding.noAccounts': 'Nenhuma conta correspondente',
  'settings.sourceControl.binding.noRepository': 'Abra um repositório Git para configurar sua conta de controle de código.',
  'settings.sourceControl.binding.loading': 'Carregando vínculo do repositório…',
  'settings.sourceControl.binding.suggested': 'Confirme a conta sugerida antes que o OpenChamber a use neste repositório.',
  'settings.sourceControl.binding.configured': 'Esta conta é usada nas ações da API de controle de código no repositório ativo.',
  'settings.sourceControl.binding.confirm': 'Confirmar conta',
  'settings.sourceControl.transport.credentialAccount': 'Conta das credenciais HTTPS',
  'settings.sourceControl.transport.retry': 'Recarregar e tentar novamente',
  'settings.sourceControl.transport.unverifiedConfirmation': 'Entendo que o Git do sistema usa credenciais no host Git conectado. O OpenChamber não pode verificar a qual conta elas pertencem.',
  'settings.sourceControl.transport.info': 'Vincule um remoto do repositório ao Git do sistema ou a uma credencial gerenciada pelo host. As contas de API do provedor permanecem separadas.',
  'settings.sourceControl.transport.remoteLabel': 'Remoto',
  'settings.sourceControl.transport.remoteAriaLabel': 'Remoto Git a configurar',
  'settings.sourceControl.transport.noRemotes': 'Nenhum remoto Git',
  'settings.sourceControl.transport.modeLabel': 'Credenciais',
  'settings.sourceControl.transport.modeAriaLabel': 'Transporte Git do remoto selecionado',
  'settings.sourceControl.transport.choose': 'Escolher transporte',
  'settings.sourceControl.transport.system': 'Git do sistema',
  'settings.sourceControl.transport.anonymous': 'HTTPS anônimo, somente leitura',
  'settings.sourceControl.transport.https': 'HTTPS gerenciado',
  'settings.sourceControl.transport.ssh': 'Chave SSH gerenciada',
  'settings.sourceControl.transport.bind': 'Vincular repositório',
  'settings.sourceControl.transport.noRepository': 'Abra um repositório Git para configurar seu transporte.',
  'settings.sourceControl.transport.loading': 'Carregando transporte do repositório…',
  'settings.sourceControl.transport.missing': 'Escolha um remoto e um transporte para vincular este repositório.',
  'settings.sourceControl.transport.needsAttention': 'A configuração do Git mudou. Revise e salve novamente o vínculo de transporte.',
  'settings.sourceControl.transport.configured': 'O remoto selecionado tem um vínculo explícito de transporte Git.',
  'settings.sourceControl.transport.remove': 'Remover permissão de transporte',
  ...
  'settings.page.integrations.description': 'Conecte o GitHub, o GitLab e o Linear para que o OpenChamber possa trabalhar com suas issues, pull requests e merge requests.',
} as const;
