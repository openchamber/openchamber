...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.projects.shellEnv.title": "Ambiente do shell",
  "settings.projects.shellEnv.state.loading": "Carregando...",
  "settings.projects.shellEnv.state.loadFailed": "Não foi possível ler a configuração deste projeto. Nada será alterado até que ela carregue.",
  "settings.projects.shellEnv.description": "Carrega o ambiente de desenvolvimento deste projeto (devenv, direnv, um script de shell) e o aplica ao Git, ao terminal e às ações do projeto.",
  "settings.projects.shellEnv.enabled": "Ativar para este projeto",
  "settings.projects.shellEnv.disabledWarning": "Salvo mas desativado: o comando não será executado até você ativá-lo.",
  "settings.projects.shellEnv.command.label": "Comando de ambiente",
  "settings.projects.shellEnv.command.placeholder": "devenv print-dev-env --json",
  "settings.projects.shellEnv.command.info": "Um comando cuja saída descreve o ambiente. Compatível com: devenv print-dev-env --json, direnv export json ou linhas export/NOME=valor. Ele roda a partir da raiz do projeto.",
  "settings.projects.shellEnv.mode.label": "Tratamento do PATH",
  "settings.projects.shellEnv.mode.overlay": "Prefixar o PATH do sistema",
  "settings.projects.shellEnv.mode.replace": "Substituir o PATH do sistema",
  "settings.projects.shellEnv.mode.info": "Prefixar mantém as ferramentas do sistema acessíveis e coloca as do projeto em primeiro lugar. Substituir usa o PATH do projeto exatamente.",
  "settings.projects.shellEnv.vars.label": "Variáveis extras",
  "settings.projects.shellEnv.vars.info": "Pares NOME=valor opcionais, um por linha, aplicados sobre a saída do comando. Eles têm prioridade sobre os valores interpretados.",
  "settings.projects.shellEnv.vars.placeholder": "GOFLAGS=-mod=vendor",
  "settings.projects.shellEnv.vars.invalid": "Não é uma linha NOME=valor válida: {names}",
  "settings.projects.shellEnv.trustInfo": "O comando roda localmente a partir das suas próprias configurações, nunca do repositório. Nada roda até você ativá-lo aqui.",
  "settings.projects.shellEnv.toast.saveFailed": "Falha ao salvar o ambiente de shell do projeto",
