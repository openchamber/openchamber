...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  'settings.plugins.registry.badge.missingPackage.tooltip': 'Pacote {name} não encontrado no registro',
  ...
  'settings.plugins.registry.badge.network.tooltip': 'Não foi possível acessar o registro de pacotes',
  ...
  'settings.plugins.registry.banner.invalid.missingPackage': 'Pacote não encontrado no registro',
  ...
  "settings.voice.page.tooltip.sttBrowser": "Reconhecimento integrado em navegadores compatíveis. Grátis, sem configurações.",
  "settings.voice.page.browserTest.title": "Testar microfone",
  "settings.voice.page.browserTest.stop": "Parar teste",
  "settings.voice.page.browserTest.transcript": "O texto reconhecido aparecerá aqui.",
  "settings.voice.page.browserTest.description": "Fale para verificar o reconhecimento e o volume do microfone. O texto fica nesta prévia e não é enviado ao chat. O navegador pode enviar áudio ao serviço de reconhecimento de voz.",
  "settings.voice.page.browserTest.unavailable": "O reconhecimento de voz do navegador não está disponível aqui. Abra este site por HTTPS em um navegador compatível ou escolha Local ou Servidor. Aplicativos desktop e móveis nativos não são compatíveis.",
  "settings.voice.page.browserFallback": "O reconhecimento do navegador foi escolhido em outro dispositivo. Este dispositivo não o suporta, então Local é usado aqui.",
  "settings.voice.page.browserTest.error": "O reconhecimento de voz parou ({code}). Verifique as permissões do microfone e a conexão e tente novamente. O texto reconhecido é mantido.",
  "settings.voice.page.browserTest.error.busy": "Já há um ditado gravando nesta página. Pare-o primeiro e tente de novo.",
  "settings.voice.page.browserTest.error.network": "Não foi possível contatar o serviço de reconhecimento. Verifique sua conexão e tente de novo. O texto reconhecido é mantido.",
  "settings.voice.page.browserTest.error.noSpeech": "Nenhuma fala foi ouvida. Aproxime-se do microfone e tente de novo.",
  "settings.voice.page.browserTest.error.audioCapture": "O medidor de volume do microfone está indisponível. A gravação continua sem ele.",
  "settings.voice.page.browserTest.error.timeout": "O serviço de reconhecimento não terminou a tempo. O texto reconhecido é mantido.",
  "settings.voice.page.browserTest.error.startFailed": "Não foi possível iniciar o reconhecimento. Recarregue a página e tente de novo.",
  "settings.voice.page.browserTest.error.permission": "O acesso ao microfone foi negado. Permita o microfone nos controles do site ao lado da barra de endereços, recarregue a página e tente de novo.",
  "settings.voice.page.field.browserMicrophonePermission": "Ao pressionar o microfone no chat ou iniciar o teste abaixo, permita o acesso se o navegador solicitar. Se a solicitação não aparecer ou o acesso estiver bloqueado, abra as configurações do site ao lado da barra de endereço, permita o microfone, recarregue a página e tente novamente.",
