export const settingsDict = {
  ...
  "settings.openchamber.tunnel.field.tailscaleHttpsPort": "Porta HTTPS do Tailscale",
  "settings.openchamber.tunnel.field.tailscaleHttpsPortDescription": "Porta de frontend do Tailscale. O Serve aceita qualquer porta de 1 a 65535; o Funnel aceita 443, 8443 ou 10000.",
  "settings.openchamber.tunnel.field.tailscaleServeHttpsPortDescription": "O Serve aceita qualquer número inteiro de 1 a 65535.",
  "settings.openchamber.tunnel.field.tailscaleFunnelHttpsPortDescription": "O Funnel aceita somente 443, 8443 ou 10000.",
  "settings.openchamber.tunnel.field.tailscaleHttpsPortError": "Digite um número inteiro de 1 a 65535.",
  ...
  "settings.openchamber.tunnel.notAvailable.tailscaleInstallHint": "Instale o Tailscale e entre na sua conta neste dispositivo antes de iniciar:",
  "settings.openchamber.tunnel.option.mode.privateNetwork.label": "Somente tailnet (Serve)",
  "settings.openchamber.tunnel.option.mode.privateNetwork.tooltip": "Tailscale Serve mantém o acesso dentro da sua tailnet.",
  "settings.openchamber.tunnel.option.mode.tailscaleQuick.label": "Público (Funnel)",
  "settings.openchamber.tunnel.option.mode.tailscaleQuick.tooltip": "Tailscale Funnel torna esta instância acessível pela internet pública.",
  "settings.openchamber.tunnel.warning.tailscaleFunnelPublic": "Tailscale Funnel expõe esta instância à internet pública. Use-o somente quando a exposição pública for intencional.",
  "settings.openchamber.tunnel.badge.privateNetwork": "Tailnet",
  "settings.openchamber.tunnel.toast.startedButNoUrl": "O túnel foi iniciado, mas não retornou uma URL de acesso.",
  "settings.openchamber.tunnel.field.tailnetUrlHint": "URL da tailnet",
