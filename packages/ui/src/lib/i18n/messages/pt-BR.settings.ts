...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.notifications.page.messengers.title": "Notificações de mensageiros",
  "settings.notifications.page.messengers.info": "Publique notificações do agente em canais do Slack ou Discord por meio de webhooks de entrada. As URLs de webhook ficam armazenadas neste servidor e não são exibidas novamente após salvar.",
  "settings.notifications.page.messengers.loadFailed": "Falha ao carregar as configurações de mensageiros.",
  "settings.notifications.page.messengers.retryAction": "Tentar novamente",
  "settings.notifications.page.messengers.enableLabel": "Ativar notificações do {messenger}",
  "settings.notifications.page.messengers.enableAria": "Ativar notificações do {messenger}",
  "settings.notifications.page.messengers.webhookLabel": "URL do webhook",
  "settings.notifications.page.messengers.webhookAria": "URL do webhook do {messenger}",
  "settings.notifications.page.messengers.webhookConfigured": "Webhook configurado.",
  "settings.notifications.page.messengers.replacePlaceholder": "Cole uma nova URL de webhook para substituir a salva",
  "settings.notifications.page.messengers.saveAction": "Salvar webhook",
  "settings.notifications.page.messengers.removeAction": "Remover webhook",
  "settings.notifications.page.messengers.testAction": "Enviar mensagem de teste",
  "settings.notifications.page.messengers.toast.saveFailed": "Falha ao salvar as configurações de mensageiros",
  "settings.notifications.page.messengers.toast.invalidUrl": "Insira uma URL de webhook válida do {messenger}",
  "settings.notifications.page.messengers.toast.testSent": "Mensagem de teste enviada para o {messenger}",
  "settings.notifications.page.messengers.toast.testFailed": "Falha ao enviar a mensagem de teste para o {messenger}",
