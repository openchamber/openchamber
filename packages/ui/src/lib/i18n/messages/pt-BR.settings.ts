export const settingsDict = {
  ...
  "settings.page.vision.title": "Visão",
  "settings.page.vision.description": "Permite que modelos que não conseguem ver imagens as descrevam por meio de um modelo de visão configurado.",
  "settings.vision.section.title": "Ferramenta de visão",
  "settings.vision.section.info": "Quando seu modelo atual não consegue ver imagens, o agente pode chamar uma ferramenta de visão que lê um arquivo de imagem e pede ao seu modelo de visão configurado para descrevê-la — conteúdo, layout, estilo e todo o texto visível. A descrição volta para o seu modelo para que ele possa raciocinar sobre a imagem sem vê-la. Cada chamada é cobrada no modelo de visão escolhido aqui.",
  "settings.vision.model.label": "Modelo de visão",
  "settings.vision.model.info": "O modelo que descreve imagens para a ferramenta de visão. Apenas modelos que aceitam entrada de imagem são listados; modelos que o catálogo não consegue avaliar permanecem visíveis e são revalidados pelo servidor antes de cada execução.",
  "settings.vision.model.notSelected": "Selecionar um modelo de visão",
  "settings.vision.model.required": "Selecione um modelo de visão para habilitar a ferramenta de visão.",
  "settings.vision.prompt.label": "Prompt de descrição",
  "settings.vision.prompt.info": "O prompt enviado com cada imagem ao modelo de visão. Um bom prompt pede conteúdo, layout, estilo, cores e texto literal para que seu modelo tenha uma visão completa. Deixe vazio para usar o padrão integrado.",
  "settings.vision.prompt.placeholder": "Deixe vazio para usar o prompt padrão.",
  "settings.vision.prompt.save": "Salvar",
  "settings.vision.prompt.reset": "Restaurar padrão",
  "settings.vision.toast.saved": "Configurações de visão salvas",
  "settings.vision.toast.saveFailed": "Falha ao salvar as configurações de visão",
  "settings.vision.toast.loadFailed": "Falha ao carregar as configurações de visão",
