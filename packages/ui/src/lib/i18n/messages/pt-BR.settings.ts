...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.visual.section.updates": "Atualizações",
  "settings.openchamber.visual.field.updateChannel": "Canal de atualização",
  "settings.openchamber.visual.field.updateChannelHint": "Escolha Stable para lançamentos oficiais ou Beta para versões pré-lançamento",
  "settings.openchamber.visual.toast.switchedChannel": "Canal de atualização alterado para {channel}.",
  "settings.openchamber.visual.toast.latestVersionForChannel": "Você está usando a versão mais recente para o canal {channel}.",
