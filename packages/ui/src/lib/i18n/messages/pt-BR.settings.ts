export const settingsDict = {
  ...
  "settings.page.sessions.description": "Defina padrões de sessão, tratamento de permissões e retenção.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.permissionAutoAccept.title": "Aceitação automática de permissões",
  "settings.openchamber.permissionAutoAccept.info": "Aplica-se a todas as sessões deste runtime, a menos que uma sessão ative ou desative explicitamente sua própria política de permissões. Ao ativar, também resolve solicitações de permissão já pendentes.",
  "settings.openchamber.permissionAutoAccept.field.globalLabel": "Aprovar automaticamente solicitações de permissão para todas as sessões deste runtime",
  "settings.openchamber.permissionAutoAccept.field.globalAria": "Aprovar automaticamente solicitações de permissão para todas as sessões deste runtime",
  "settings.openchamber.permissionAutoAccept.field.globalWarning": "Segurança: o OpenChamber aprovará solicitações de permissão pendentes e futuras sem perguntar até que uma sessão substitua explicitamente esta política.",
  "settings.openchamber.permissionAutoAccept.dialog.title": "Ativar aceitação automática de permissões para todas as sessões?",
  "settings.openchamber.permissionAutoAccept.dialog.description": "O OpenChamber aprovará imediatamente as solicitações de permissão que já estiverem pendentes e continuará aprovando novas neste runtime até que uma sessão substitua explicitamente a política. Ative isso apenas em um runtime confiável.",
  "settings.openchamber.permissionAutoAccept.dialog.confirm": "Ativar aceitação automática",
