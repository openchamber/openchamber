export const settingsDict = {
  ...
  "settings.page.harness.description": "Escolha e gerencie os harnesses de execução.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.harness.sidebar.subtitle": "Backends de execução para sessões de chat",
  "settings.harness.sidebar.harness.opencode": "OpenCode",
  "settings.harness.sidebar.harness.claudeCode": "Claude Code",
  "settings.harness.sidebar.status.ready": "Pronto",
  "settings.harness.sidebar.status.needsLogin": "Precisa de login",
  "settings.harness.sidebar.status.missingCli": "CLI ausente",
  "settings.harness.sidebar.status.unsupportedHost": "Indisponível aqui",
  "settings.harness.sidebar.status.error": "Erro",
  "settings.harness.sidebar.status.unknown": "Desconhecido",
  "settings.harness.sidebar.status.loading": "Verificando…",
  "settings.harness.page.empty.selectHarness": "Selecione um harness na barra lateral",
  "settings.harness.page.loadError": "Não foi possível carregar o status do harness",
  "settings.harness.opencode.title": "OpenCode",
  "settings.harness.opencode.description": "Harness padrão. Usa provedores e agentes do OpenCode.",
  "settings.harness.opencode.section.about": "Sobre",
  "settings.harness.opencode.about.body": "O OpenCode executa modelos pelos seus provedores configurados. Gerencie chaves de API em Provedores e agentes em Agentes.",
  "settings.harness.opencode.link.providers": "Abrir Provedores",
  "settings.harness.opencode.link.agents": "Abrir Agentes",
  "settings.harness.claudeCode.title": "Claude Code",
  "settings.harness.claudeCode.description": "CLI nativa do Claude Code com limites de uso da assinatura.",
  "settings.harness.claudeCode.section.status": "Status",
  "settings.harness.claudeCode.field.status": "Status",
  "settings.harness.claudeCode.field.version": "Versão",
  "settings.harness.claudeCode.status.version": "{version}",
  "settings.harness.claudeCode.status.versionUnknown": "Desconhecida",
  "settings.harness.claudeCode.actions.redetect": "Detectar novamente",
  "settings.harness.claudeCode.actions.redetectAria": "Detectar novamente o status do Claude Code",
  "settings.harness.claudeCode.actions.openDocs": "Abrir documentação",
  "settings.harness.claudeCode.actions.openDocsAria": "Abrir a documentação do Claude Code",
  "settings.harness.claudeCode.login.title": "Entrar com o Claude",
  "settings.harness.claudeCode.login.body": "Instale a CLI do Claude e execute claude login neste host para o OpenChamber usar sua assinatura Claude.",
  "settings.harness.claudeCode.section.capabilities": "Recursos",
  "settings.harness.claudeCode.capabilities.empty": "Os recursos aparecem após uma detecção bem-sucedida.",
  "settings.harness.claudeCode.capability.full": "Completo",
  "settings.harness.claudeCode.capability.partial": "Parcial",
  "settings.harness.claudeCode.capability.none": "Indisponível",
  "settings.harness.claudeCode.section.agents": "Agentes",
  "settings.harness.claudeCode.agentsMode.label": "Agentes a usar",
  "settings.harness.claudeCode.agentsMode.aria": "Escolher agentes Claude ou OpenCode para sessões Claude Code",
  "settings.harness.claudeCode.agentsMode.info": "Claude usa seus próprios agentes, prompts e configurações de permissão. Em vez disso, o OpenCode faz as sessões do Claude executarem o agente OpenCode selecionado: as regras de permissão dele decidem cada chamada de ferramenta, o prompt dele é adicionado ao do Claude, e seus subagentes personalizados do OpenCode passam a ficar disponíveis para o Claude. O seletor de agente do campo de mensagem muda para acompanhar.",
  "settings.harness.claudeCode.agentsMode.claude": "Claude",
  "settings.harness.claudeCode.agentsMode.opencode": "OpenCode",
  "settings.harness.claudeCode.section.warnings": "Avisos",
"settings.harness.claudeCode.warnHandoff.label": "Confirmar ao mudar de harness",
"settings.harness.claudeCode.warnHandoff.aria": "Confirmar ao mudar de harness",
"settings.harness.claudeCode.warnHandoff.info": "Mostra um diálogo antes de iniciar uma nova sessão ao mudar de harness. Quando desativado, a mudança é aplicada silenciosamente na sua próxima mensagem.",
  "settings.harness.claudeCode.section.import": "Importar",
  "settings.harness.claudeCode.import.note": "Importe projetos e chats locais do Claude Code para o OpenChamber. Os chats são retomados no Claude Code; as transcrições não são copiadas para o histórico do OpenCode.",
  "settings.harness.claudeCode.import.actions.open": "Importar do Claude Code",
  "settings.harness.claudeCode.import.actions.openAria": "Abrir o diálogo de importação do Claude Code",
  "settings.harness.claudeCode.import.dialog.title": "Importar do Claude Code",
  "settings.harness.claudeCode.import.dialog.description": "Selecione chats armazenados na pasta de projetos do Claude Code neste host. Chats já importados são ignorados.",
  "settings.harness.claudeCode.import.dialog.loading": "Verificando projetos do Claude Code…",
  "settings.harness.claudeCode.import.dialog.empty": "Nenhum chat do Claude Code encontrado neste host.",
  "settings.harness.claudeCode.import.dialog.selectAll": "Selecionar tudo",
  "settings.harness.claudeCode.import.dialog.selectAllAria": "Selecionar todos os chats do Claude Code importáveis",
  "settings.harness.claudeCode.import.dialog.selectedCount": "{count} selecionados",
  "settings.harness.claudeCode.import.dialog.projectAria": "Selecionar todos os chats em {name}",
  "settings.harness.claudeCode.import.dialog.sessionAria": "Selecionar chat {title}",
  "settings.harness.claudeCode.import.dialog.sessionCount": "{count} chats",
  "settings.harness.claudeCode.import.dialog.directoryMissing": "Pasta ausente",
  "settings.harness.claudeCode.import.dialog.alreadyImported": "Já importado",
  "settings.harness.claudeCode.import.dialog.untitled": "Chat sem título",
  "settings.harness.claudeCode.import.dialog.cancel": "Cancelar",
  "settings.harness.claudeCode.import.dialog.import": "Importar ({count})",
  "settings.harness.claudeCode.import.dialog.importing": "Importando…",
  "settings.harness.claudeCode.import.error.load": "Não foi possível verificar os projetos do Claude Code.",
  "settings.harness.claudeCode.import.error.import": "Falha na importação.",
  "settings.harness.claudeCode.import.toast.success": "Importados {count} chats do Claude Code.",
  "settings.harness.claudeCode.import.toast.skippedOnly": "Ignorados {count} chats já importados.",
  "settings.harness.claudeCode.import.toast.partialFail": "Importados: {imported}; falhas: {failed}.",
  "settings.harness.claudeCode.import.toast.none": "Nada foi importado.",
  "settings.harness.claudeCode.section.apiKeys": "Chaves de API",
  "settings.harness.claudeCode.apiKeys.note": "As chaves de API da Anthropic ficam em Provedores no OpenCode. O Claude Code usa o login da assinatura Claude no host.",
  "settings.harness.capability.prompt": "Prompt",
  "settings.harness.capability.abort": "Interromper",
  "settings.harness.capability.resume": "Retomar",
  "settings.harness.capability.streaming-text": "Texto em streaming",
  "settings.harness.capability.streaming-tools": "Ferramentas em streaming",
  "settings.harness.capability.permissions": "Permissões",
  "settings.harness.capability.images": "Imagens",
  "settings.harness.capability.file-attachments": "Anexos de arquivo",
  "settings.harness.capability.shell": "Shell",
  "settings.harness.capability.slash-commands": "Comandos slash",
  "settings.harness.capability.mcp": "MCP",
  "settings.harness.capability.subagents": "Subagentes",
  "settings.harness.capability.multirun": "MultiRun",
  "settings.harness.capability.goal": "Modo Goal",
  "settings.harness.capability.openchamber-tool": "Ferramenta OpenChamber",
