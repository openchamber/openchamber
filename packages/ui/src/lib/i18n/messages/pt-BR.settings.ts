...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.visual.field.messageSpeedMetrics": "Mostrar métricas de velocidade de resposta",
  "settings.openchamber.visual.field.messageSpeedMetricsAria": "Mostrar métricas de velocidade sob as respostas concluídas",
  "settings.openchamber.visual.field.messageSpeedMetricsInfo": "Mostra o TTFT (tempo até o primeiro token) e os tokens de saída por segundo sob as respostas concluídas. Útil para comparar provedores e relés.",
