export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copie o ID da URL do painel e o cookie auth das ferramentas do navegador. O Sharpie nunca examina os cookies do navegador.',
  ...
  "settings.window.description": "Janela de configurações do Sharpie.",
  ...
  "settings.page.appearance.description": "Personalize a aparência e a sensação do Sharpie.",
  ...
  "settings.remoteInstances.direct.title": "Outros servidores Sharpie",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Adicione outro servidor Sharpie por URL. Use isto quando o servidor já estiver em execução e você tiver um token de conexão.",
  ...
  "settings.remoteInstances.direct.import.description": "Cole um link de conexão de outro servidor Sharpie.",
  ...
  "settings.remoteInstances.direct.error.invalidConnectLink": "Link de conexão do Sharpie inválido.",
  ...
  "settings.remoteInstances.clientAuth.description": "Crie um link ou token seguro para que o Sharpie Desktop possa se conectar a este servidor.",
  ...
  "settings.remoteInstances.clientAuth.qrAlt": "Sharpie connection QR code",
  "settings.remoteInstances.clientAuth.qrEnlarge": "Ampliar código QR",
  "settings.remoteInstances.clientAuth.qrScanHint": "Escaneie com o app Sharpie no seu outro dispositivo. É de uso único e expira.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Funciona em casa e fora. Fora de casa o tráfego passa pelo Sharpie Private Relay, um túnel criptografado de ponta a ponta. Sem configuração.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Escaneie este código QR com o app Sharpie no seu outro dispositivo.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Escolha se o Sharpie deve iniciar o servidor para você ou se conectar a um que já está em execução.",
  ...
  "settings.remoteInstances.page.field.keepServerRunningHint": "Keep Sharpie running on the remote machine after you disconnect.",
  ...
  "settings.openchamber.about.title": "Sobre o Sharpie",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Adicione um repositório Git como nova origem de catálogo. O Sharpie escaneará para encontrar pastas que contenham",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Iniciar o Sharpie ao fazer login",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Iniciar o Sharpie ao fazer login",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Mostrar o Sharpie na barra de menus do macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Mostrar o Sharpie na barra de menus",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Exige reiniciar o aplicativo. Quando desativado, o Sharpie não cria o item da barra de menus nem executa as atualizações de sessões, aprovações e uso.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Minimizar e fechar o Sharpie na bandeja do sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Minimizar e fechar na bandeja do sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Mantém o Sharpie em execução na bandeja do sistema quando a janela principal é minimizada ou fechada.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Manter o computador ativo enquanto o Sharpie estiver em execução",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Manter o computador ativo enquanto o Sharpie estiver em execução",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "O Sharpie pede após reiniciar e depois quando a sessão expira: em 12 horas, ou 7 dias com Confiar neste dispositivo. Deixe vazio para desativar o login.",
  ...
  "settings.remoteInstances.page.description": "Conecte-se a outra máquina por SSH e abra o Sharpie lá.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "Sharpie na máquina remota",
  "settings.remoteInstances.page.section.remoteServerDescription": "Escolha como o Sharpie deve rodar depois que o SSH conectar.",
  "settings.remoteInstances.page.section.mainTunnel": "Acesso local",
  "settings.remoteInstances.page.section.mainTunnelDescription": "Escolha o endereço local usado para abrir este servidor Sharpie remoto.",
  "settings.remoteInstances.page.section.authentication": "Autenticação",
  "settings.remoteInstances.page.section.authenticationDescription": "Credenciais opcionais para SSH e para a interface de usuário do Sharpie remoto.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Como o Sharpie deve ser colocado na máquina remota quando este app o inicia para você.",
  ...
  "settings.remoteInstances.page.phase.installingOpenChamber": "Instalando Sharpie",
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Atualizando Sharpie",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Armazenada na autenticação do OpenCode, não pelo Sharpie. Use {env:VAR_NAME} para ler uma chave do ambiente.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "As chaves são enviadas diretamente ao OpenCode e nunca são armazenadas no Sharpie.",
  ...
  "settings.github.page.flow.title": "Autorizar Sharpie",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Disponível como alternativa se a autenticação do Sharpie for removida",
  ...
  "settings.notifications.page.testNotification.body": "Esta é uma notificação de teste do Sharpie.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Transcrição local no servidor do Sharpie. Os modelos são baixados automaticamente; não é necessária chave de API.",
  "settings.voice.page.tooltip.localTts": "Síntese local no servidor do Sharpie (Kokoro, inglês). O modelo é baixado automaticamente; não é necessária chave de API.",
