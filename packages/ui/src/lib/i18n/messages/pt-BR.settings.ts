...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.agents.sidebar.error.title": "Não foi possível carregar os agentes",
  "settings.agents.sidebar.error.description": "Backend do OpenCode indisponível. Verifique a conexão e tente novamente.",
  "settings.agents.sidebar.error.retry": "Tentar novamente",
