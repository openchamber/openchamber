...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.worktrees.start.label": "Comandos de início",
  "settings.openchamber.worktrees.start.commandPlaceholder": "ex.: ./scripts/run.sh",
  "settings.openchamber.worktrees.start.addCommand": "Adicionar comando",
  "settings.openchamber.worktrees.start.removeCommandAria": "Remover comando",
  "settings.openchamber.worktrees.start.toast.saveFailed": "Falha ao salvar os comandos de início",
  "settings.openchamber.worktrees.shutdown.label": "Comandos de desligamento",
  "settings.openchamber.worktrees.shutdown.commandPlaceholder": "ex.: ./scripts/stop.sh",
  "settings.openchamber.worktrees.shutdown.addCommand": "Adicionar comando",
  "settings.openchamber.worktrees.shutdown.removeCommandAria": "Remover comando",
  "settings.openchamber.worktrees.shutdown.toast.saveFailed": "Falha ao salvar os comandos de desligamento",
  "settings.openchamber.worktrees.commands.runStartAria": "Executar comandos de início para {name}",
  "settings.openchamber.worktrees.commands.runShutdownAria": "Executar comandos de desligamento para {name}",
  "settings.openchamber.worktrees.commands.viewSetupLogAria": "Ver saída da configuração para {name}",
  "settings.openchamber.worktrees.commands.noCommands": "Nenhum {kind} configurado para este projeto.",
  "settings.openchamber.worktrees.commands.dialogTitleStart": "Comandos de início — {name}",
  "settings.openchamber.worktrees.commands.dialogTitleShutdown": "Comandos de desligamento — {name}",
  "settings.openchamber.worktrees.commands.dialogTitleSetup": "Saída da configuração — {name}",
  "settings.openchamber.worktrees.commands.dialogRunning": "Executando...",
  "settings.openchamber.worktrees.commands.dialogFailed": "O comando falhou",
  "settings.openchamber.worktrees.commands.dialogTimedOut": "O comando excedeu o limite de tempo — mostrando a saída até agora.",
  "settings.openchamber.worktrees.commands.dialogEmptyOutput": "Sem saída.",
  "settings.openchamber.worktrees.commands.dialogClose": "Fechar",
