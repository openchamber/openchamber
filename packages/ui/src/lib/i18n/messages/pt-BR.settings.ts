...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.notifications.page.delivery.info": "São alertas do sistema fora do app. No desktop são notificações nativas. No navegador ou no app instalado é web push, então chegam mesmo com a aba em segundo plano. O sino guarda uma lista separada no app.",
  ...
  "settings.notifications.page.inbox.title": "Histórico no app",
  "settings.notifications.page.inbox.info": "Desligue a lista para ocultar todas as linhas e o distintivo. Desmarque um tipo para ocultar só ele. As linhas continuam salvas, então ligar de novo as traz de volta.",
  "settings.notifications.page.inbox.enableLabel": "Ativar o histórico no app",
  "settings.notifications.page.inbox.enableAria": "Ativar o histórico no app",
  "settings.notifications.page.inbox.soundLabel": "Reproduzir som",
  "settings.notifications.page.inbox.soundAria": "Reproduzir um som no centro de notificações",
  "settings.notifications.page.inbox.soundInfo": "Um toque curto quando um aviso entra na lista, inclusive com esta janela em segundo plano. Se um banner do sistema também tocar, o toque fica quieto.",
  "settings.notifications.page.inbox.sessionFinishedLabel": "Sessão concluída",
  "settings.notifications.page.inbox.sessionFinishedAria": "Mostrar sessões concluídas no histórico do app",
  "settings.notifications.page.inbox.sessionErrorLabel": "Erros da sessão",
  "settings.notifications.page.inbox.sessionErrorAria": "Mostrar erros da sessão no histórico do app",
  "settings.notifications.page.inbox.sessionSubtaskLabel": "Subtarefas",
  "settings.notifications.page.inbox.sessionSubtaskAria": "Mostrar avisos de subtarefas no histórico do app",
  "settings.notifications.page.inbox.permissionQuestionLabel": "Permissões e perguntas",
  "settings.notifications.page.inbox.permissionQuestionAria": "Mostrar avisos de permissão e perguntas no histórico do app",
  "settings.notifications.page.inbox.appErrorWarningLabel": "Erros e avisos do app",
  "settings.notifications.page.inbox.appErrorWarningAria": "Mostrar erros e avisos do app no histórico do app",
  "settings.notifications.page.inbox.infoLabel": "Informação",
  "settings.notifications.page.inbox.infoAria": "Mostrar avisos informativos no histórico do app",
  "settings.notifications.page.inbox.successLabel": "Sucesso",
  "settings.notifications.page.inbox.successAria": "Mostrar avisos de sucesso no histórico do app",
