...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.agentBrowser.title": "Navegador do agente",
  "settings.openchamber.agentBrowser.status.loading": "Verificando o navegador…",
  "settings.openchamber.agentBrowser.status.unknown": "O status do navegador está indisponível.",
  "settings.openchamber.agentBrowser.status.ready": "Pronto: {path}",
  "settings.openchamber.agentBrowser.status.missing": "Nenhum navegador compatível com o Chrome foi encontrado neste host.",
  "settings.openchamber.agentBrowser.status.missingPath": "O caminho de navegador configurado não existe.",
  "settings.openchamber.agentBrowser.status.host": "Host: {platform}/{arch}",
  "settings.openchamber.agentBrowser.field.binaryPath": "Executável do navegador",
  "settings.openchamber.agentBrowser.field.binaryPathPlaceholder": "/usr/bin/google-chrome-stable",
  "settings.openchamber.agentBrowser.field.binaryPathInfo": "Caminho absoluto para Chrome, Chromium, Edge ou Brave. Deixe vazio para usar a instalação gerenciada, OPENCHAMBER_BROWSER_PATH ou a descoberta automática. Aplica-se após Salvar.",
  "settings.openchamber.agentBrowser.field.noSandbox": "Desativar sandbox do navegador",
  "settings.openchamber.agentBrowser.field.noSandboxAria": "Desativar o sandbox do Chromium em hosts headless",
  "settings.openchamber.agentBrowser.field.noSandboxInfo": "Necessário em muitos servidores headless, contêineres e ambientes root onde o sandbox do Chromium não está disponível. Equivale a OPENCHAMBER_BROWSER_NO_SANDBOX=true.",
  "settings.openchamber.agentBrowser.field.noSandboxRecommended": "Recomendado neste host (contêiner ou root).",
  "settings.openchamber.agentBrowser.actions.browseAria": "Procurar o executável do navegador",
  "settings.openchamber.agentBrowser.actions.save": "Salvar",
  "settings.openchamber.agentBrowser.actions.saving": "Salvando…",
  "settings.openchamber.agentBrowser.actions.install": "Instalar Chrome",
  "settings.openchamber.agentBrowser.actions.installing": "Instalando…",
  "settings.openchamber.agentBrowser.actions.installUnsupported": "A instalação gerenciada não está disponível nesta plataforma.",
