...
export const dict = {
  ...
  'chat.messageBody.metrics.ttftInfo': 'Time to first token: how long the model took to start answering after the request.',
  'chat.messageBody.metrics.tokensPerSecond': '{rate} tok/s',
  'chat.messageBody.metrics.tokensPerSecondInfo': 'Output tokens per second of streaming decode time, excluding tool execution.',
