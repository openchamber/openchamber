...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install Sharpie for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'Sharpie installed',
  ...
  'mobile.connect.welcome.title': 'Connect to Sharpie',
  ...
  'mobile.connect.password.placeholder': 'Sharpie password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an Sharpie connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that Sharpie server.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'About Sharpie',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The Sharpie server this app is connected to did not answer the walkthrough API, which means it is older than the app. Update the server to 1.18 or newer, then refresh.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to Sharpie — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in Sharpie. Download it to open with another app.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Sharpie needs access to this folder.',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes Sharpie state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate Sharpie efficiently',
  ...
  'header.actions.openAppMenu': 'Sharpie menu',
  'header.actions.openAppMenuAria': 'Open Sharpie menu',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening Sharpie from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock Sharpie',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote Sharpie servers',
  ...
  'multiRun.window.description': 'Sharpie Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to Sharpie',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If Sharpie does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of Sharpie — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to Sharpie settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an Sharpie server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an Sharpie server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different Sharpie version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running Sharpie but is not compatible with this app version. Update Sharpie on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running Sharpie. Verify the address points to an Sharpie server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running Sharpie. Verify the address points to an Sharpie server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The Sharpie server at "{host}" is not compatible with this app version. Update Sharpie on the server, then try again.',
  ...
  'startup.initRecovery.description': 'Sharpie could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating Sharpie...',
  ...
  'mobileUpdate.toast.available.title': 'Sharpie update available',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep Sharpie open.',
