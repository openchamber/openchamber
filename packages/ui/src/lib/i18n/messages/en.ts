...
export const dict = {
  ...
  'sidebarFilesTree.toast.searchTimedOut': 'Search timed out; try narrowing your scope',
  ...
  'filesView.tree.filter.searchTimedOut': 'Search timed out; try narrowing your scope',
