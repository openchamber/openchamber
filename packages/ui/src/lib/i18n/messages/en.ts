...
export const dict = {
  ...
  'filesView.tree.actions.uploadTitle': 'Upload Files',
  'filesView.tree.drop.uploadHint': 'Drop files to upload',
  'filesView.toast.uploadSuccess': 'Uploaded {count} files',
  'filesView.toast.uploadSuccessSingle': 'Uploaded {name}',
  'filesView.toast.uploadFailed': 'Failed to upload {count} files',
  'filesView.toast.uploadFailedSingle': 'Failed to upload {name}',
