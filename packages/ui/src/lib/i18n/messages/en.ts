...
export const dict = {
  ...
  'agentBrowser.control.agentActive': 'Agent is controlling',
  'agentBrowser.takeover.title': 'Take control of the browser?',
  'agentBrowser.takeover.description': 'An agent is using the browser right now. Taking control will stop that agent.',
  'agentBrowser.takeover.confirm': 'Take control',
  'agentBrowser.takeover.cancel': 'Cancel',
