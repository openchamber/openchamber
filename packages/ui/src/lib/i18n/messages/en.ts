...
export const dict = {
  ...
  'contextPanel.browser.agent.handOff': 'Give agent control',
  'contextPanel.browser.agent.stop': 'Stop agent control',
  'contextPanel.browser.agent.controlling': 'Agent controlling',
  'contextPanel.browser.agent.ready': 'Shared with agent',
  'contextPanel.browser.agent.popOut': 'Open in a separate window',
  'contextPanel.browser.agent.lastAction': 'Last action: {op}',
  'contextPanel.browser.poppedOut.title': 'Browser opened in a separate window',
  'contextPanel.browser.poppedOut.bringBack': 'Bring back',
  'contextPanel.browser.poppedOut.focus': 'Focus window',
