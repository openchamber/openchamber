...
export const dict = {
  ...
  'chat.messageBody.actions.forkSessionWithContext': 'Fork session here with full context',
  ...
  'chat.messageBody.toast.forkSessionFailed': 'Could not fork the session',
