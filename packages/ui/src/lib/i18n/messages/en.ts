...
export const dict = {
  ...
  'gitView.pr.actions.addComment': 'Add comment',
  ...
  'gitView.pr.actions.reply': 'Reply',
  'gitView.pr.actions.replyAria': 'Reply to comment',
  ...
  'gitView.pr.placeholder.comment': 'Add a comment to this pull request...',
  ...
  'gitView.pr.toast.commentAdded': 'Comment added',
  ...
  'gitView.pr.toast.replyAdded': 'Reply added',
  'gitView.pr.toast.replyFailed': 'Failed to add reply',
