...
export const dict = {
  ...
  'contextPanel.region.aria': 'Panel region',
  ...
  'tiling.splitAnchor.left': 'Split panel to the left',
  'tiling.splitAnchor.right': 'Split panel to the right',
  'tiling.splitAnchor.top': 'Split panel to the top',
  'tiling.splitAnchor.bottom': 'Split panel to the bottom',
  'tiling.region.moveTarget': 'Move tile into this region',
