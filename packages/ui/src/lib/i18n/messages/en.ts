...
export const dict = {
  ...
  'gitView.changes.revertAllDescriptionPlural': 'This will discard local changes in {count} files from the list.',
  'gitView.changes.revertAllDescriptionSingle': 'This will discard local changes in {count} file from the list.',
