...
export const dict = {
  ...
  'chat.agentCapabilities.inline.waitingChildren': 'Waiting for child sessions to start…',
  'chat.agentCapabilities.fusion.pickerLoadError': 'Failed to load fusion presets.',
  'chat.agentCapabilities.fusion.pickerEmpty': 'No fusion presets. Create one in Settings → Fusion.',
  'chat.agentCapabilities.fusion.keyboardHint': '↑↓ navigate • Enter select • Esc close',
