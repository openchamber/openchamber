...
export const dict = {
  ...
  'sessions.scheduledTasks.dialog.actions.lastRunAria': 'Open last run session for {taskName}',
  ...
  'sessions.scheduledTasks.editor.lifecycle.title': 'Lifecycle',
  'sessions.scheduledTasks.editor.archiveOnSuccess.label': 'Archive successful runs',
  'sessions.scheduledTasks.editor.archiveOnSuccess.aria': 'Archive the session after a successful run',
