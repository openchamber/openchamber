...
export const dict = {
  ...
  'contextRail.surface.git.description': 'Review changes, commit, and sync',
  ...
  'contextPanel.actions.backToChanges': 'Back to changes',
  ...
  'helpDialog.item.openRightSidebarGitTab': 'Open Changes surface',
