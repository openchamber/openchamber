...
export const dict = {
  ...
  'header.connection.status.connected': 'Connected',
  'header.connection.status.connecting': 'Connecting…',
  'header.connection.status.reconnecting': 'Reconnecting…',
  'header.connection.actions.retry': 'Click to retry',
