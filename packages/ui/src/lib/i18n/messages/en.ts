...
export const dict = {
  ...
  'updateDialog.header.updatingRemote': 'Updating remote instance...',
  'updateDialog.target.desktop.title': 'Update OpenChamber Desktop App',
  'updateDialog.target.desktop.description': 'Updates this Windows app only; use Remote instance update for WSL.',
  'updateDialog.target.remote.title': 'Update Remote Instance',
  'updateDialog.target.remote.description': 'Updates the selected remote instance.',
  ...
  'updateDialog.status.downloadingDesktopPayload': 'Downloading desktop update...',
  'updateDialog.actions.downloadUpdate': 'Download Update',
  'updateDialog.actions.downloadDesktopUpdate': 'Download Desktop Update',
  'updateDialog.status.downloading': 'Downloading...',
  'updateDialog.status.downloadingDesktop': 'Downloading desktop update...',
  'updateDialog.actions.restartToUpdate': 'Restart to Update',
  'updateDialog.actions.restartDesktopToUpdate': 'Restart Desktop App to Update',
