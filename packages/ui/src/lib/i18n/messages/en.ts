...
export const dict = {
  ...
  'chat.chatInput.reviewCommentEdit': 'Edit comment',
  'chat.chatInput.reviewCommentEditPlaceholder': 'Edit your comment…',
  'chat.chatInput.reviewCommentSave': 'Save',
  'chat.message.inlineComment.expand': 'Show code',
  'chat.message.inlineComment.collapse': 'Hide code',
  'chat.message.inlineComment.lineSingle': 'Line {line}',
  'chat.message.inlineComment.lineRange': 'Lines {start}–{end}',
  'chat.message.inlineComment.lineSingleOfFile': 'Line {line} of {file}',
  'chat.message.inlineComment.lineRangeOfFile': 'Lines {start}–{end} of {file}',
  'chat.chatInput.reviewCommentCancel': 'Cancel',
