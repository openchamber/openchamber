...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install ALIAS ADE for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'ALIAS ADE installed',
  ...
  'sessions.sidebar.footer.actions.aboutAliasAde': 'About ALIAS ADE',
  ...
  'header.services.shutdownDev': 'Stop ALIAS ADE',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes ALIAS ADE state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate ALIAS ADE efficiently',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock ALIAS ADE',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote ALIAS ADE servers',
  ...
  'multiRun.window.description': 'ALIAS ADE Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to ALIAS ADE',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If ALIAS ADE does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of ALIAS ADE — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to ALIAS ADE settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an ALIAS ADE server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an ALIAS ADE server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running ALIAS ADE. Verify the address points to an ALIAS ADE server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running ALIAS ADE. Verify the address points to an ALIAS ADE server.',
  ...
  'startup.initRecovery.description': 'ALIAS ADE could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating ALIAS ADE...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: alias-ade update',
  ...
  'aliasAdeLogo.aria.logo': 'ALIAS ADE logo',
