...
export const dict = {
  ...
  'sessions.sidebar.session.harness.claudeCodeTooltip': 'Running on Claude Code',
  ...
  'chat.chatInput.toast.queueFull': 'This session’s follow-up queue is full. Your draft was kept.',
  'chat.chatInput.toast.queueTargetsFull': 'Too many sessions have queued follow-ups. Your draft was kept.',
  ...
  'chat.commandAutocomplete.command.claudeNativeDescription': 'Claude Code command: /{name}',
  ...
  'chat.modelControls.noAgentsFound': 'No agents found',
  'chat.modelControls.claudeAgents.defaultAgent': 'Claude default',
  'chat.modelControls.claudeAgents.empty': 'No Claude agents found',
  ...
  'chat.harness.manageHarnesses': 'Manage harnesses…',
  'chat.harness.chip.claude': 'Claude · {model}',
  'chat.harness.notReady': 'Claude Code is not ready. Open Settings → Harnesses to install, log in, or re-detect.',
  'chat.harness.commandTranslationFailed': 'Could not run this OpenCode command on Claude Code.',
  'chat.harness.effort.label': 'Effort',
  'chat.harness.effort.default': 'Default',
  'chat.harness.effort.low': 'Low',
  'chat.harness.effort.medium': 'Medium',
  'chat.harness.effort.high': 'High',
  'chat.harness.effort.xhigh': 'Extra high',
  'chat.harness.effort.max': 'Max',
  'chat.harness.effort.aria': 'Effort: {level}',
  'chat.harness.effort.tooltip': 'Effort: {level}',
  'chat.harness.capability.goalUnsupported': 'Goals are not available on this harness.',
  'chat.harness.capability.multirunUnsupported': 'MultiRun is not available on this harness.',
  'chat.harness.capability.openchamberToolUnsupported': 'The OpenChamber tool is not available on this harness.',
  'chat.harness.switch.title': 'Switch to {harness}?',
  'chat.harness.switch.body': 'Switching harness starts a new session. Your current session stays untouched.',
  'chat.harness.switch.billing': 'The new session uses your Claude subscription, not API billing.',
  'chat.harness.switch.duplicate.title': 'Duplicate session data',
  'chat.harness.switch.duplicate.description': 'Copy the recent conversation into the new session as a visible context message.',
  'chat.harness.switch.summarize.title': 'Summarize session',
  'chat.harness.switch.summarize.description': 'Summarize this session and carry only the summary over. The current session will be compacted.',
  'chat.harness.switch.optionsAria': 'What to carry into the new session',
  'chat.harness.switch.dontShowAgain': 'Don’t show this again',
  'chat.harness.switch.dontShowAgainAria': 'Don’t show the harness switch dialog again',
  'chat.harness.switch.cancel': 'Cancel',
  'chat.harness.switch.confirm': 'Switch harness',
  'chat.harness.switch.working': 'Switching…',
  'chat.harness.contextCard.title': 'Context from previous session',
  'chat.harness.contextCard.expandAria': 'Expand transferred context',
  'chat.harness.contextCard.collapseAria': 'Collapse transferred context',
