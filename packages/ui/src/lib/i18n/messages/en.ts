...
export const dict = {
  ...
  'chat.workStatus.telemetry.speed': 'Generation speed',
  'chat.workStatus.telemetry.llmDuration': 'LLM duration',
  'chat.workStatus.telemetry.toolDuration': 'Tool duration',
  'chat.workStatus.telemetry.ttft': 'Time to first token',
  'chat.workStatus.telemetry.steps': 'Steps in turn',
  'chat.workStatus.telemetry.tokens': 'Tokens',
  'chat.workStatus.telemetry.cacheHit': 'Cache hit rate',
  'chat.workStatus.telemetry.cost': 'Turn cost',
