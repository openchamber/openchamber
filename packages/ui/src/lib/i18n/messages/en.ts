...
export const dict = {
  ...
  'chat.modelControls.projectDefaultSaved': 'Default model updated for this project',
  'chat.modelControls.projectDefaultSavedDescription': 'Future chats in this project will start with {model}.',
  'chat.modelControls.projectDefaultSaveFailed': 'Failed to update project default model',
  'chat.modelControls.projectDefaultOpenSettings': 'Project settings',
  'chat.modelControls.projectDefaultAction': 'Use for this chat and future chats in this project',
  'chat.modelControls.projectDefaultCurrent': 'Used for new chats in this project',
