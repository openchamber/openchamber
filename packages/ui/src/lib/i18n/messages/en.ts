...
export const dict = {
  ...
  'usage.status.quotaExhausted': 'Quota exhausted',
  'usage.status.expired': 'API key expired',
  'usage.statistics.title': 'Usage statistics',
  'usage.statistics.info': 'Model statistics cover the last 30 days.',
  'usage.statistics.requests': 'Requests',
  'usage.statistics.inputTokens': 'Input tokens',
  'usage.statistics.outputTokens': 'Output tokens',
  'usage.statistics.cacheReadTokens': 'Cache read tokens',
  'usage.statistics.totalTokens': 'Total tokens',
  'usage.statistics.actualCost': 'Cost',
  'usage.statistics.today': 'Today',
  'usage.statistics.total': 'Total',
  'usage.statistics.empty': 'No usage statistics reported.',
