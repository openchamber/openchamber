...
export const dict = {
  ...
  'diffView.state.noBranchChanges': 'No branch changes to display',
  'diffView.state.noLastTurnChanges': 'No last turn changes to display',
  'diffView.state.failedToLoadDiff': 'Failed to load diff',
  'diffView.state.failedToLoadBranchChanges': 'Failed to load branch changes',
  ...
  'diffView.state.branchPatchUnavailable': 'The branch patch is unavailable for this file.',
