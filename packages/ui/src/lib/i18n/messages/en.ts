...
export const dict = {
  ...
  'chat.engines.slashUnsupported': 'This OpenCode slash command is not available on Claude Code. Use a Claude-native /command or send a normal message.',
  ...
  'chat.engines.capability.goalUnsupported': 'Goals are not available on this engine.',
  'chat.engines.capability.multirunUnsupported': 'MultiRun is not available on this engine.',
  'chat.engines.capability.openchamberToolUnsupported': 'The OpenChamber tool is not available on this engine.',
