...
export const dict = {
  ...
  'chat.message.speed.input': 'in {value}',
  'chat.message.speed.cacheRead': 'cache {value}',
  'chat.message.speed.cacheWrite': 'cache write {value}',
  'chat.message.speed.output': 'out {value}',
  'chat.message.speed.reasoning': 'reason {value}',
  'chat.message.speed.aria': 'Message speed: {ttft} to first token, {throughput} tokens per second, {input} uncached input, {cache} cache read, {output} output',
