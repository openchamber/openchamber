...
import aliasAdeLightRaw from './fields-of-the-shire-light.json';
import aliasAdeDarkRaw from './fields-of-the-shire-dark.json';
...
export const aliasAdeLightTheme = withPrColors(aliasAdeLightRaw as Theme);
export const aliasAdeDarkTheme = withPrColors(aliasAdeDarkRaw as Theme);
...
export const themes: Theme[] = [
  ...
  flexokiDarkTheme,
  ...presetThemes.filter(
    (theme) => theme.metadata.id !== 'alias-ade-light' && theme.metadata.id !== 'alias-ade-dark',
  ),
];
