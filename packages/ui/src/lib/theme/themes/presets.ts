...
import aliasAde_dark_Raw from './fields-of-the-shire-dark.json';
import aliasAde_light_Raw from './fields-of-the-shire-light.json';
...
export const presetThemes: Theme[] = [
  aliasAde_dark_Raw as Theme,
  aliasAde_light_Raw as Theme,
