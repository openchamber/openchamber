...
export const withGitMutationRefreshHints = (git: GitAPI): GitAPI => ({
  ...
  abortCherryPick: wrapMutating(git.abortCherryPick),
  continueCherryPick: wrapMutating(git.continueCherryPick),
  abortRevert: wrapMutating(git.abortRevert),
  continueRevert: wrapMutating(git.continueRevert),
