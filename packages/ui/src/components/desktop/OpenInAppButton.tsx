...
export const OpenInAppButton = ({ directory, activeFilePath, className }: OpenInAppButtonProps) => {
  ...
  const handleCopyPath = async () => {
    ...
    toast.success(m.oabCopiedToClipboard());
  };
      ...
      <DropdownMenu>
        ...
        >
          <DropdownMenuItem className="flex items-center gap-2" onClick={() => void handleCopyPath()}>
            ...
            <span className="typography-ui-label text-foreground">{m.oabCopyPath()}</span>
          </DropdownMenuItem>
          <DropdownMenuSeparator />
          ...
          {isCacheStale ? (
            ...
            >
              ...
              <span className="typography-ui-label text-foreground">{m.oabRefreshApps()}</span>
            </DropdownMenuItem>
          ) : null}
        </DropdownMenuContent>
      </DropdownMenu>
