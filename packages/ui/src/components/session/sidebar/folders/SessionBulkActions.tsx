...
export function SessionBulkActions({ getFolderScopesForProject, isSessionArchived, isInlineEditing, sessionTreeRoots, startFolderRename }: Props): React.ReactNode {
