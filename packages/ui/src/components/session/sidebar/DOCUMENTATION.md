...
does not use the fallback. The mobile sheet and the Recent projection use this
same ownership resolver; Recent rows keep the session's own directory while
