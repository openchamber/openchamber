                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        aria-label={t('sessionsSidebar.newWorktree')}
                      >
                        <RiNodeTree className="h-4 w-4" />
                      </button>
                    </TooltipTrigger>
                    <TooltipContent side="bottom" sideOffset={4}>
                      <p>{t('sessionsSidebar.newWorktree')}...</p>
                    </TooltipContent>
                  </Tooltip>
                ) : null}
                ...
                >
                    <DropdownMenuTrigger asChild>
                      <button
                        ...
                        aria-label={t('sessionsSidebar.projectMenu')}
                    ...
                    >
                      ...
                      {t('sessionsSidebar.closeProject')}
                    </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
              </div>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        aria-label={isRepo ? t('sessionsSidebar.newDraftSession') : t('sessionsSidebar.newSession')}
                      >
                        <RiAddLine className="h-4 w-4" />
                      </button>
                    </TooltipTrigger>
                    <TooltipContent side="bottom" sideOffset={4}>
                      <p>{isRepo ? t('sessionsSidebar.newDraftSession') : t('sessionsSidebar.newSession')}</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              ) : null}
