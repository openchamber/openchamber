                ...
                <section className="px-2 pb-2 pt-0 space-y-4">
                  <div className="py-1.5">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 mt-1.5">
                      ...
                      >
                        {authBusyKey === `api:${candidateProviderId}` ? t('providersPage.saving') : t('providersPage.saveKey')}
                      </ButtonSmall>
                    </div>
                  </div>
                            ...
                            <div key={`${candidateProviderId}-${methodLabel}`} className="space-y-3">
                              ...
                              {oauthDetails[codeKey]?.userCode && (
                                <div className="flex items-center gap-2 mt-2">
                                  ...
                                  <ButtonSmall variant="outline" size="xs" className="!font-normal" onClick={() => handleCopyOAuthCode(oauthDetails[codeKey]?.userCode ?? '')}>{t('providersPage.copyCode')}</ButtonSmall>
                                </div>
                              )}
                              ...
                              {oauthDetails[codeKey]?.url && (
                                <div className="flex items-center gap-2 mt-2">
                                  ...
                                  <div className="flex gap-1 shrink-0">
                                    <ButtonSmall variant="outline" size="xs" className="!font-normal" onClick={() => window.open(oauthDetails[codeKey]?.url, '_blank', 'noopener,noreferrer')}>{t('providersPage.open')}</ButtonSmall>
                                    <ButtonSmall variant="outline" size="xs" className="!font-normal" onClick={() => handleCopyOAuthLink(oauthDetails[codeKey]?.url ?? '')}>{t('common.copy')}</ButtonSmall>
                                  </div>
                                </div>
                              )}
                              ...
                              {isPending && (
                                <div className="flex items-center gap-2 mt-2">
                                  ...
                                  >
                                    {authBusyKey === `oauth-complete:${candidateProviderId}:${index}` ? t('providersPage.saving') : t('providersPage.complete')}
                                  </ButtonSmall>
                                </div>
                              )}
                            </div>
