                ...
                {hasNavigationSettings && (
                    <SettingsSection title={t('settings.openchamber.visual.section.navigation')} contentClassName="space-y-4">
                        ...
                        <div className={SETTINGS_OPTION_STACK_CLASS}>
                            ...
                            {shouldShow('worktreeDiscovery') && (
                                <SettingsCheckboxRow
                                    checked={worktreeDiscoveryEnabled}
                                    onChange={(enabled) => {
                                        setWorktreeDiscoveryEnabled(enabled);
                                        void updateDesktopSettings({ worktreeDiscoveryEnabled: enabled });
                                    }}
                                    label={t('settings.openchamber.visual.field.worktreeDiscovery')}
