...
const InlineCommentPart: React.FC<Props> = ({
    ...
    // A file at the repo root has no slash, so its basename equals its path.
    // Requiring the two to differ hid the filename for exactly those files and
    // left the card reading "Line 2021" with nothing to say which file.
