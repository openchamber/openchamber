                                            ...
                                            <div className={cn("gap-1", alwaysShowActions ? "flex" : "hidden group-hover:flex")}>
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <button
                                                            type="button"
                                                            className={cn(
                                                                'h-5 w-5 flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors disabled:opacity-50',
                                                        ...
                                                        >
                                                            <Icon name={revertPending ? 'loader-4' : 'arrow-go-back'} className={cn('h-4 w-4', revertPending && 'animate-spin')} />
                                                        </button>
                                                    </TooltipTrigger>
                                                ...
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        ...
                                                        >
                                                            <Icon name={forkPending ? 'loader-4' : 'git-branch'} className={cn('h-4 w-4', forkPending && 'animate-spin')} />
                                                        </button>
                                                    </TooltipTrigger>
