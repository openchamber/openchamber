          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-3">
              ...
              <div className="flex flex-col gap-1">
                <FieldLabel htmlFor="multirun-project" required>{t('multirun.project')}</FieldLabel>
                {projects.length > 0 ? (
                  <Select
                    ...
                    <SelectTrigger id="multirun-project" size="lg" className="w-fit max-w-full">
                      {selectedProject ? (
                        <SelectValue>{renderProjectLabel(selectedProject)}</SelectValue>
                          ...
                          <SelectValue placeholder={t('multirun.selectProject')} />
                      )}
                    </SelectTrigger>
                  ...
                  <p className="typography-micro text-muted-foreground py-2">{t('multirun.addProjectFirst')}</p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1">
                <FieldLabel
                  htmlFor="group-name"
                  required
                  info={<InfoTip>{t('multirun.groupNameHelp')}</InfoTip>}
                >
              ...
              <div className="flex flex-col gap-1">
                <FieldLabel
                  ...
                  info={<InfoTip>{t('multirun.createsNewBranchesFrom')}</InfoTip>}
                >
              ...
              <div className="flex flex-col gap-1">
                <FieldLabel
                  ...
                  info={<InfoTip>{t('multirun.agentHelp')}</InfoTip>}
                >
                  {t('multirun.agent')}
                </FieldLabel>
                <AgentSelector
              ...
              <CollapsibleContent>
                <div className="pt-2 space-y-1.5">
                  {isLoadingSetupCommands ? (
                    <p className="typography-meta text-muted-foreground/70 px-2">{t('common.loading')}</p>
                  ) : (
                    <>
            ...
            <div className="flex flex-col gap-1.5">
              <FieldLabel htmlFor="prompt" required>{t('multirun.prompt')}</FieldLabel>
              <Textarea
                id="prompt"
                value={prompt}
              ...
              <div className="flex flex-wrap items-center gap-1.5">
                ...
                <Tooltip delayDuration={300}>
                  ...
                  <TooltipContent>{t('multirun.attachmentsHelp')}</TooltipContent>
                </Tooltip>
            ...
            <div className="flex flex-col gap-1.5">
              <FieldLabel
                required
                info={<InfoTip>{t('multirun.modelsHelp', { min: 2, max: MAX_MODELS })}</InfoTip>}
              >
                {t('multirun.models')}
              </FieldLabel>
              <ModelMultiSelect
