...
const SwitcherRow: React.FC<{
  ...
  // active: no spinner/dot. It is distinct from idle, though — the shared
  // SessionStatusIndicator renders a static cloud-off icon for it. Last-known
  // data is preserved for when freshness returns.
