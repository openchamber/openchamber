...
export const assertUpdaterCapability = ({
  ...
  if (!appImagePath) {
    throw new Error(
      'Updates require the packaged Linux AppImage. Start Sharpie from its .AppImage file, not an extracted or repackaged copy.',
    );
  }
  ...
  try {
    ...
    throw new Error(`The running AppImage cannot be found at ${appImagePath}. Start Sharpie from a valid .AppImage file.`);
  }
