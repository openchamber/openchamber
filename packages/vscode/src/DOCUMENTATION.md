...
- `gitService.ts`
  ...
  - Splits large selected stage, unstage, and selected-commit path lists before spawning Git. A later batch failure rejects the bridge operation instead of reporting the full selection as successful.
